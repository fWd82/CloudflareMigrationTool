...
class ImportPrivateKeyKeypairBean implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportPrivateKeyKeypairBean';
    ...
    */
    protected static $openAPITypes = [
            'name' => 'string',
            'userId' => 'string',
            'keyProtection' => '\HuaweiCloud\SDK\Kps\V3\Model\ImportPrivateKeyProtection'
    ];
    ...
    *  keyProtection
    *
    * @return \HuaweiCloud\SDK\Kps\V3\Model\ImportPrivateKeyProtection
    */
    ...
    * Sets keyProtection
    *
    * @param \HuaweiCloud\SDK\Kps\V3\Model\ImportPrivateKeyProtection $keyProtection keyProtection
    *
    * @return $this
    */
