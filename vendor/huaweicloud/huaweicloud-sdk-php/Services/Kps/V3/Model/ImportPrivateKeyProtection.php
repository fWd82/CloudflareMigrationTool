...
class ImportPrivateKeyProtection implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportPrivateKeyProtection';
    ...
    * Sets privateKey
    *
    * @param string $privateKey 导入SSH密钥对的私钥。
    *
    * @return $this
    */
