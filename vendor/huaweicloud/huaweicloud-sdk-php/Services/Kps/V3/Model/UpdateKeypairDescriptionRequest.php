...
class UpdateKeypairDescriptionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateKeypairDescriptionRequest';
    ...
    */
    protected static $openAPITypes = [
            'keypairName' => 'string',
            'body' => '\HuaweiCloud\SDK\Kps\V3\Model\UpdateKeypairDescriptionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Kps\V3\Model\UpdateKeypairDescriptionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Kps\V3\Model\UpdateKeypairDescriptionRequestBody|null $body body
    *
    * @return $this
    */
