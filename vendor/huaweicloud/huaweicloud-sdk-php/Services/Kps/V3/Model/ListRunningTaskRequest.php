...
class ListRunningTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRunningTaskRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * limit  每页显示的条目数量。默认值1000。
    * offset  首个展示的正在处理任务信息的偏移量
    *
    * @var string[]
    */
    ...
    * Sets offset
    *
    * @param int|null $offset 首个展示的正在处理任务信息的偏移量
    *
    * @return $this
    */
