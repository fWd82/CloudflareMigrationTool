...
class RunningTasks implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RunningTasks';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * taskId  虚拟机ID
    * operateType  操作类型。 - FAILED_RESET 重置 - FAILED_REPLACE 替换 - FAILED_UNBIND 解绑
    * taskTime  任务时间
    * serverName  虚拟机名称
    * serverId  虚拟机ID
    * keypairName  密钥对名称
    ...
    * Sets operateType
    *
    * @param string|null $operateType 操作类型。 - FAILED_RESET 重置 - FAILED_REPLACE 替换 - FAILED_UNBIND 解绑
    *
    * @return $this
    */
