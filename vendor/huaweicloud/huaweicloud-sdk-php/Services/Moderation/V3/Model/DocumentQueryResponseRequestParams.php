...
class DocumentQueryResponseRequestParams implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DocumentQueryResponse_request_params';
    ...
    * textCategories  创建作业时传的text_categories参数
    * videoImageCategories  创建作业时传的video_image_categories参数
    ...
    */
    protected static $openAPITypes = [
            'data' => '\HuaweiCloud\SDK\Moderation\V3\Model\DocumentQueryResponseRequestParamsData',
            'eventType' => 'string',
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\Moderation\V3\Model\DocumentQueryResponseRequestParamsData
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\Moderation\V3\Model\DocumentQueryResponseRequestParamsData $data data
    *
    * @return $this
    */
    ...
    *
    * @param string[]|null $imageCategories 创建作业时传的image_categories参数
    *
    * @return $this
    */
    ...
    * Sets textCategories
    *
    * @param string[]|null $textCategories 创建作业时传的text_categories参数
    *
    * @return $this
    */
    ...
    *
    * @param string[]|null $videoImageCategories 创建作业时传的video_image_categories参数
    *
    * @return $this
    */
