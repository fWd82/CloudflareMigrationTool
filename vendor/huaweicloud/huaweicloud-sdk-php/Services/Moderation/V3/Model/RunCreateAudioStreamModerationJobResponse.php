...
class RunCreateAudioStreamModerationJobResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RunCreateAudioStreamModerationJobResponse';
    ...
    * Sets jobId
    *
    * @param string|null $jobId 作业唯一标识。
    *
    * @return $this
    */
