...
class VideoModerationImageDetailListQrLocation implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VideoModerationImageDetailList_qr_location';
