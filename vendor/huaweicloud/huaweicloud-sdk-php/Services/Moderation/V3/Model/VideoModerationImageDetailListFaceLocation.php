...
class VideoModerationImageDetailListFaceLocation implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VideoModerationImageDetailList_face_location';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * topLeftX  检测出人脸的左上角横坐标。
    * topLeftY  检测出人脸的左上角纵坐标。
    * bottomRightX  检测出人脸的右下角横坐标。
    * bottomRightY  检测出人脸的右下角纵坐标。
    *
    * @var string[]
    */
    ...
    * Sets topLeftX
    *
    * @param int|null $topLeftX 检测出人脸的左上角横坐标。
    *
    * @return $this
    */
    ...
    * Sets topLeftY
    *
    * @param int|null $topLeftY 检测出人脸的左上角纵坐标。
    *
    * @return $this
    */
    ...
    * Sets bottomRightX
    *
    * @param int|null $bottomRightX 检测出人脸的右下角横坐标。
    *
    * @return $this
    */
    ...
    * Sets bottomRightY
    *
    * @param int|null $bottomRightY 检测出人脸的右下角纵坐标。
    *
    * @return $this
    */
