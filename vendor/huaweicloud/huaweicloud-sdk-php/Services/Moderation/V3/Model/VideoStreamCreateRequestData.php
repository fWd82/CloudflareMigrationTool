...
class VideoStreamCreateRequestData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VideoStreamCreateRequest_data';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * url  视频流url，支持rtmp、rtmps、hls、http、https等主流协议。
    ...
    * Sets url
    *
    * @param string $url 视频流url，支持rtmp、rtmps、hls、http、https等主流协议。
    *
    * @return $this
    */
