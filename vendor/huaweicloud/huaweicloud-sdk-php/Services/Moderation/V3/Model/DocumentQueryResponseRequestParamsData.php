...
class DocumentQueryResponseRequestParamsData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DocumentQueryResponse_request_params_data';
    ...
    * Sets format
    *
    * @param string $format 创建作业时传的format参数
    *
    * @return $this
    */
    ...
    * Sets frameInterval
    *
    * @param int|null $frameInterval 创建作业时传的frame_interval参数
    *
    * @return $this
    */
