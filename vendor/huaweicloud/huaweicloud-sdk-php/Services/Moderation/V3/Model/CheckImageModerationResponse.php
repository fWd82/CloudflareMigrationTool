...
class CheckImageModerationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CheckImageModerationResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'result' => '\HuaweiCloud\SDK\Moderation\V3\Model\ImageDetectionResult'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\Moderation\V3\Model\ImageDetectionResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\Moderation\V3\Model\ImageDetectionResult|null $result result
    *
    * @return $this
    */
