...
class RunTextModerationResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'result' => '\HuaweiCloud\SDK\Moderation\V3\Model\TextDetectionResult'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\Moderation\V3\Model\TextDetectionResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\Moderation\V3\Model\TextDetectionResult|null $result result
    *
    * @return $this
    */
