...
class CheckTaskJobsItemsBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CheckTaskJobsItemsBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * jobId  任务标识。
    * status  任务状态如下：  - created 已创建  - running 正在处理  - finish 已完成  - failed 处理失败
    ...
    * Sets status
    *
    * @param string|null $status 任务状态如下：  - created 已创建  - running 正在处理  - finish 已完成  - failed 处理失败
    *
    * @return $this
    */
