...
class CompareFaceByFileRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * image1File  本地图片文件，图片不能超过8MB。上传文件时，请求格式为multipart。
    * image2File  本地图片文件，图片不能超过8MB。上传文件时，请求格式为multipart。
    *
    * @var string[]
    */
    ...
    * Sets image1File
    *
    * @param \SplFileObject $image1File 本地图片文件，图片不能超过8MB。上传文件时，请求格式为multipart。
    *
    * @return $this
    */
    ...
    * Sets image2File
    *
    * @param \SplFileObject $image2File 本地图片文件，图片不能超过8MB。上传文件时，请求格式为multipart。
    *
    * @return $this
    */
