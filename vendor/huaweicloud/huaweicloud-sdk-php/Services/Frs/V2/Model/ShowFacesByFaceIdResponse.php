...
class ShowFacesByFaceIdResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowFacesByFaceIdResponse';
    ...
    * Sets faceSetId
    *
    * @param string|null $faceSetId 人脸库ID，随机生成的包含八个字符的字符串。 调用失败时无此字段。
    *
    * @return $this
    */
