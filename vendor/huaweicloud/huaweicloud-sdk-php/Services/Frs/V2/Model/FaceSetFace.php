...
class FaceSetFace implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FaceSetFace';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * boundingBox  boundingBox
    * externalFields  用户添加的额外字段。
    ...
    * Sets externalFields
    *
    * @param object $externalFields 用户添加的额外字段。
    *
    * @return $this
    */
    ...
    *
    * @param string $externalImageId 人脸所在的外部图片ID。
    *
    * @return $this
    */
    ...
    * Sets faceId
    *
    * @param string $faceId 人脸ID，由系统内部生成的唯一ID。
    *
    * @return $this
    */
