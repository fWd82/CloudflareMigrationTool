...
class DetectLiveFaceByBase64Response implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DetectLiveFaceByBase64Response';
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\Frs\V2\Model\LiveDetectFaceRespResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\Frs\V2\Model\LiveDetectFaceRespResult|null $result result
    *
    * @return $this
    */
    ...
    * Sets warningList
    *
    * @param \HuaweiCloud\SDK\Frs\V2\Model\WarningList[]|null $warningList 警告信息列表。 调用失败时无此字段。
    *
    * @return $this
    */
