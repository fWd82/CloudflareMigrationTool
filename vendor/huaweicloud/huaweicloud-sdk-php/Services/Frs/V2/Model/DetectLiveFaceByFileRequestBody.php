...
class DetectLiveFaceByFileRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DetectLiveFaceByFileRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * imageFile  本地图片文件。上传文件时，请求格式为multipart。
    *
    * @var string[]
    */
    ...
    * Sets imageFile
    *
    * @param \SplFileObject $imageFile 本地图片文件。上传文件时，请求格式为multipart。
    *
    * @return $this
    */
