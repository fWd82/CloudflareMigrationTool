...
class LiveDetectBase64Req implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LiveDetectBase64Req';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * videoBase64  视频数据，Base64编码，要求： • Base64编码后大小不超过8MB，建议客户端压缩到200KB~2MB。 • 限制视频时长1～15秒。 • 建议帧率10fps～30fps。 • 封装格式：mp4、avi、flv、webm、asf、mov。 • 视频编码格式： h261、h263、h264、hevc、vc1、vp8、vp9、wmv3。
    ...
    */
    ...
    {
        $this->container['videoBase64'] = isset($data['videoBase64']) ? $data['videoBase64'] : null;
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['videoBase64'] === null) {
            $invalidProperties[] = "'videoBase64' can't be null";
        }
    ...
    */
    ...
    {
        return $this->container['videoBase64'];
    }

    /**
    * Sets videoBase64
    *
    * @param string $videoBase64 视频数据，Base64编码，要求： • Base64编码后大小不超过8MB，建议客户端压缩到200KB~2MB。 • 限制视频时长1～15秒。 • 建议帧率10fps～30fps。 • 封装格式：mp4、avi、flv、webm、asf、mov。 • 视频编码格式： h261、h263、h264、hevc、vc1、vp8、vp9、wmv3。
    *
    * @return $this
    */
    public function setVideoBase64($videoBase64)
    {
        $this->container['videoBase64'] = $videoBase64;
        return $this;
    }
