...
class MongodbErrorLogDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MongodbErrorLogDetail';
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['rawMessage'] = isset($data['rawMessage']) ? $data['rawMessage'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rawMessage'] === null) {
            $invalidProperties[] = "'rawMessage' can't be null";
        }
    ...
    */
    ...
    {
        return $this->container['rawMessage'];
    }

    /**
    * Sets rawMessage
    *
    * @param string $rawMessage 描述信息。
    *
    * @return $this
    */
    public function setRawMessage($rawMessage)
    {
        $this->container['rawMessage'] = $rawMessage;
        return $this;
    }
