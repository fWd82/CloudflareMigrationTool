...
class RedisModifyDbUserPrivilegeRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RedisModifyDbUserPrivilegeRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  账号名称。  小于36个字符，以字母开头，仅包含数字、字母、中划线、下划线。
    * privilege  账号权限。  - 取值\"ReadOnly\"：账号为只读权限； - 取值\"ReadWrite\"：账号为读写权限。
    * databases  账号授权database列表。 不传值则对账号授权的db不做修改。
    *
    * @var string[]
    */
    ...
    * Sets databases
    *
    * @param string[]|null $databases 账号授权database列表。 不传值则对账号授权的db不做修改。
    *
    * @return $this
    */
