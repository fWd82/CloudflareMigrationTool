...
class DifferentDetails implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DifferentDetails';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sourceValue'] === null) {
            $invalidProperties[] = "'sourceValue' can't be null";
        }
        if ($this->container['targetValue'] === null) {
            $invalidProperties[] = "'targetValue' can't be null";
        }
    ...
    * Sets sourceValue
    *
    * @param string $sourceValue 源参数模板中的参数值。
    *
    * @return $this
    */
    ...
    * Sets targetValue
    *
    * @param string $targetValue 目标参数模板中的参数值。
    *
    * @return $this
    */
