...
class ListInstancesByTagsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'limit' => 'string',
            'action' => 'string',
            'matches' => '\HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\MatchOption[]',
            'tags' => '\HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\TagOption[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\MatchOption[]|null
    */
    ...
    * Sets matches
    *
    * @param \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\MatchOption[]|null $matches 搜索字段。   - 该字段值为空，表示不按照实例名称或实例ID查询。   - 该字段值不为空
    *
    * @return $this
    */
    ...
    *  包含标签，最多包含20个key。
    *
    * @return \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\TagOption[]|null
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\TagOption[]|null $tags 包含标签，最多包含20个key。
    *
    * @return $this
    */
