...
class ListJobsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'jobs' => '\HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\JobDetail[]',
            'totalCount' => 'int'
    ];
    ...
    *  任务列表。
    *
    * @return \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\JobDetail[]|null
    */
    ...
    * Sets jobs
    *
    * @param \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\JobDetail[]|null $jobs 任务列表。
    *
    * @return $this
    */
