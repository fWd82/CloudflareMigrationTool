...
class ListCassandraSlowLogsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCassandraSlowLogsRequestBody';
    ...
    * operateType  语句类型，取空值，表示查询所有语句类型。 取值：select
    ...
    * keyspaceKeywords  根据多个键空间关键字模糊搜索日志，表示匹配至少一个关键字。 - 只支持关键字前缀模糊搜索，最多支持10个关键字。 - 每个关键字最大长度不超过48个字符。
    * tableKeywords  根据多个数据库表名关键字模糊搜索日志，表示匹配至少一个关键字。 - 只支持关键字前缀模糊搜索，最多支持10个关键字。 - 每个关键字最大长度不超过48个字符。
    ...
    */
    protected static $attributeMap = [
            ...
            'nodeId' => 'node_id',
            'keywords' => 'keywords',
            'keyspaceKeywords' => 'keyspace_keywords',
    ...
    */
    protected static $setters = [
            ...
            'keyspaceKeywords' => 'setKeyspaceKeywords',
            'tableKeywords' => 'setTableKeywords',
    ...
    */
    protected static $getters = [
            ...
            'keyspaceKeywords' => 'getKeyspaceKeywords',
            'tableKeywords' => 'getTableKeywords',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['keyspaceKeywords'] = isset($data['keyspaceKeywords']) ? $data['keyspaceKeywords'] : null;
        $this->container['tableKeywords'] = isset($data['tableKeywords']) ? $data['tableKeywords'] : null;
    ...
    * Sets operateType
    *
    * @param string|null $operateType 语句类型，取空值，表示查询所有语句类型。 取值：select
    *
    * @return $this
    */
    ...
    */
    ...
    /**
    * Gets keyspaceKeywords
    *  根据多个键空间关键字模糊搜索日志，表示匹配至少一个关键字。 - 只支持关键字前缀模糊搜索，最多支持10个关键字。 - 每个关键字最大长度不超过48个字符。
    *
    * @return string[]|null
    */
    public function getKeyspaceKeywords()
    {
        return $this->container['keyspaceKeywords'];
    }

    /**
    * Sets keyspaceKeywords
    *
    * @param string[]|null $keyspaceKeywords 根据多个键空间关键字模糊搜索日志，表示匹配至少一个关键字。 - 只支持关键字前缀模糊搜索，最多支持10个关键字。 - 每个关键字最大长度不超过48个字符。
    *
    * @return $this
    */
    public function setKeyspaceKeywords($keyspaceKeywords)
    {
        $this->container['keyspaceKeywords'] = $keyspaceKeywords;
        return $this;
    }
    ...
    * @return string[]|null
    */
    public function getTableKeywords()
    {
        return $this->container['tableKeywords'];
    }

    /**
    * Sets tableKeywords
    *
    * @param string[]|null $tableKeywords 根据多个数据库表名关键字模糊搜索日志，表示匹配至少一个关键字。 - 只支持关键字前缀模糊搜索，最多支持10个关键字。 - 每个关键字最大长度不超过48个字符。
    *
    * @return $this
    */
    public function setTableKeywords($tableKeywords)
    {
        $this->container['tableKeywords'] = $tableKeywords;
        return $this;
    }
