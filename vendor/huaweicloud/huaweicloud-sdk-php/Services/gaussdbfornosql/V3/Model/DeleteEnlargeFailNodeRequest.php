...
class DeleteEnlargeFailNodeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteEnlargeFailNodeRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\DeleteEnlargeFailNodeRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\DeleteEnlargeFailNodeRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\DeleteEnlargeFailNodeRequestBody|null $body body
    *
    * @return $this
    */
