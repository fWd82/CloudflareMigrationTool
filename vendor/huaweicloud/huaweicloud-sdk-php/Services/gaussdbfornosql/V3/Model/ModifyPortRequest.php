...
class ModifyPortRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyPortRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\ModifyPortRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\ModifyPortRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\ModifyPortRequestBody|null $body body
    *
    * @return $this
    */
