...
class ListDbUsersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDbUsersRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  实例ID。
    * name  数据库账号名。若传此参数，则查询指定账号的信息，否则返回所有数据库账号信息。
    ...
    * Sets name
    *
    * @param string|null $name 数据库账号名。若传此参数，则查询指定账号的信息，否则返回所有数据库账号信息。
    *
    * @return $this
    */
