...
class CassandraSlowLogDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CassandraSlowLogDetail';
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['keyspace'] = isset($data['keyspace']) ? $data['keyspace'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['keyspace'] === null) {
            $invalidProperties[] = "'keyspace' can't be null";
        }
    ...
    */
    ...
    {
        return $this->container['keyspace'];
    }

    /**
    * Sets keyspace
    *
    * @param string $keyspace 数据库键空间
    *
    * @return $this
    */
    public function setKeyspace($keyspace)
    {
        $this->container['keyspace'] = $keyspace;
        return $this;
    }
