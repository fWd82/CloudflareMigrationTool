...
class ShowErrorLogResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowErrorLogResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'errorLogList' => '\HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\ErrorLogList[]'
    ];
    ...
    *  errorLogList
    *
    * @return \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\ErrorLogList[]|null
    */
    ...
    * Sets errorLogList
    *
    * @param \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\ErrorLogList[]|null $errorLogList errorLogList
    *
    * @return $this
    */
