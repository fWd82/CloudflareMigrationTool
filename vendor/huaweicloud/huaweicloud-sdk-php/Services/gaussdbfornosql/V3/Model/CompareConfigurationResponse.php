...
class CompareConfigurationResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'differences' => '\HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\DifferentDetails[]'
    ];
    ...
    *  参数之间的区别集合。
    *
    * @return \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\DifferentDetails[]|null
    */
    ...
    * Sets differences
    *
    * @param \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\DifferentDetails[]|null $differences 参数之间的区别集合。
    *
    * @return $this
    */
