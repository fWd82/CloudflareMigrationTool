...
class ShowElbIpGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowElbIpGroupResponse';
    ...
    * Sets type
    *
    * @param string|null $type 类型选项，取值： - whiteList：白名单，只允许指定ip或网段访问。 - blackList：黑名单，不允许指定ip或网段访问。
    *
    * @return $this
    */
    ...
    *  IP地址组中包含的IP或网段列表。
    *
    * @return \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\SwitchIpGroupRequestBodyIpGroups[]|null
    */
    ...
    * Sets ipGroups
    *
    * @param \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\SwitchIpGroupRequestBodyIpGroups[]|null $ipGroups IP地址组中包含的IP或网段列表。
    *
    * @return $this
    */
    ...
    * Sets enabled
    *
    * @param bool|null $enabled true：开启，false：关闭。
    *
    * @return $this
    */
