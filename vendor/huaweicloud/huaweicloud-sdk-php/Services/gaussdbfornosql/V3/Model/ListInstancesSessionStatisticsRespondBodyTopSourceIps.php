...
class ListInstancesSessionStatisticsRespondBodyTopSourceIps implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstancesSessionStatisticsRespondBody_top_source_ips';
    ...
    *
    * @param int|null $connectionCount 客户端连接数。
    *
    * @return $this
    */
