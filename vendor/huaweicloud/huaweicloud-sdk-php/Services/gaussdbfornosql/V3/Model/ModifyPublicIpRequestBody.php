...
class ModifyPublicIpRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyPublicIpRequestBody';
    ...
    * Sets publicIpId
    *
    * @param string|null $publicIpId 弹性公网IP的ID。
    *
    * @return $this
    */
