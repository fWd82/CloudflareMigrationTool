...
class ListMongodbErrorLogsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMongodbErrorLogsRequestBody';
    ...
    * severity  日志级别，取空值，表示查询所有日志级别的日志。
    ...
    * Sets severity
    *
    * @param string|null $severity 日志级别，取空值，表示查询所有日志级别的日志。
    *
    * @return $this
    */
