...
class QueryDatabaseTableInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'QueryDatabaseTableInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * databaseName  数据库名称。
    * tableNames  表名称列表。 - table_names为空的时候，表示库级别查询。 - table_names非空的时候，表示表级别查询。
    *
    * @var string[]
    */
    ...
    * Sets tableNames
    *
    * @param string[]|null $tableNames 表名称列表。 - table_names为空的时候，表示库级别查询。 - table_names非空的时候，表示表级别查询。
    *
    * @return $this
    */
