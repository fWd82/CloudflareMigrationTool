...
class ListRestoreTablesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRestoreTablesResponse';
    ...
    * Sets tableNames
    *
    * @param string[]|null $tableNames 数据表名称列表。
    *
    * @return $this
    */
