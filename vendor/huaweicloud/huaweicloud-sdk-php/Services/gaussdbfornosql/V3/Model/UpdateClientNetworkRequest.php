...
class UpdateClientNetworkRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateClientNetworkRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\UpdateClientNetworkRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\UpdateClientNetworkRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\UpdateClientNetworkRequestBody|null $body body
    *
    * @return $this
    */
