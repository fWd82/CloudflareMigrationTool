...
class ApiVersionResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ApiVersionResponse';
    ...
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'links' => '\HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\Links[]',
            'status' => 'string',
            'version' => 'string',
            'minVersion' => 'string',
            'updated' => 'string'
    ...
    *  对应API的链接信息,v3版本该字段为[]。
    *
    * @return \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\Links[]
    */
    ...
    * Sets links
    *
    * @param \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\Links[] $links 对应API的链接信息,v3版本该字段为[]。
    *
    * @return $this
    */
