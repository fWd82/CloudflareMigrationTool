...
class CopyConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'configId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\CopyConfigurationRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\CopyConfigurationRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\CopyConfigurationRequestBody|null $body body
    *
    * @return $this
    */
