...
class UpdateScalingV2PolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateScalingV2PolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\_As\V1\Model\UpdateScalingV2PolicyOption'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\_As\V1\Model\UpdateScalingV2PolicyOption|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\_As\V1\Model\UpdateScalingV2PolicyOption|null $body body
    *
    * @return $this
    */
