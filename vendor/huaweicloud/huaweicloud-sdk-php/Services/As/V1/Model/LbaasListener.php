...
class LbaasListener implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LbaasListener';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * listenerId  监听器ID。
    * poolId  后端云服务器组ID。
    * protocolPort  后端协议端口，指后端云服务器监听的端口。
    * weight  权重，指后端云服务器分发得到请求的数量比例。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['listenerId']) && !preg_match("/[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12}/", $this->container['listenerId'])) {
                $invalidProperties[] = "invalid value for 'listenerId', must be conform to the pattern /[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12}/.";
            }
    ...
    * Sets protocolPort
    *
    * @param int|null $protocolPort 后端协议端口，指后端云服务器监听的端口。
    *
    * @return $this
    */
    ...
    * Sets weight
    *
    * @param int|null $weight 权重，指后端云服务器分发得到请求的数量比例。
    *
    * @return $this
    */
