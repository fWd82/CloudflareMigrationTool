...
class ShowScalingV2PolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowScalingV2PolicyRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  租户标识。
    * scalingPolicyId  伸缩组ID。
    *
    * @var string[]
    */
