...
class BatchExitStandByInstancesOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchExitStandByInstancesOption';
    ...
    */
    ...
    const ACTION_EXIT_STANDBY = 'EXIT_STANDBY';
