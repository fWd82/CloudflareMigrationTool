...
class CreateScalingPolicyV2Option implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateScalingPolicyV2Option';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * scalingPolicyName  策略名称（1-64）字符，可以用中文、字母、数字、下划线、中划线的组合。
    * scalingResourceId  伸缩资源ID，伸缩组唯一标识或带宽唯一标识。如果scaling_resource_type为SCALING_GROUP，对应伸缩组唯一标识。如果scaling_resource_type为BANDWIDTH，对应带宽唯一标识。说明：- 弹性伸缩不支持对包年包月的带宽进行调整。
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['scalingPolicyName'] === null) {
            $invalidProperties[] = "'scalingPolicyName' can't be null";
        }
            if ((mb_strlen($this->container['scalingPolicyName']) > 64)) {
                $invalidProperties[] = "invalid value for 'scalingPolicyName', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['scalingPolicyName']) < 1)) {
        ...
        if ($this->container['scalingResourceType'] === null) {
            $invalidProperties[] = "'scalingResourceType' can't be null";
        }
        ...
        if ($this->container['scalingPolicyType'] === null) {
            $invalidProperties[] = "'scalingPolicyType' can't be null";
        }
    ...
    *
    * @param string $scalingPolicyName 策略名称（1-64）字符，可以用中文、字母、数字、下划线、中划线的组合。
    *
    * @return $this
    */
    ...
    *
    * @param string $scalingResourceId 伸缩资源ID，伸缩组唯一标识或带宽唯一标识。如果scaling_resource_type为SCALING_GROUP，对应伸缩组唯一标识。如果scaling_resource_type为BANDWIDTH，对应带宽唯一标识。说明：- 弹性伸缩不支持对包年包月的带宽进行调整。
    *
    * @return $this
    */
    ...
    *
    * @param string $scalingResourceType 伸缩资源类型。伸缩组：SCALING_GROUP。带宽：BANDWIDTH。
    *
    * @return $this
    */
    ...
    *
    * @param string $scalingPolicyType 策略类型。告警策略：ALARM（与alarm_id对应）；定时策略：SCHEDULED（与scheduled_policy对应）；周期策略：RECURRENCE（与scheduled_policy对应）
    *
    * @return $this
    */
