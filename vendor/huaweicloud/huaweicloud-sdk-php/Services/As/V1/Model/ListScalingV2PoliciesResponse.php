...
class ListScalingV2PoliciesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListScalingV2PoliciesResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'startNumber' => 'int',
            'limit' => 'int',
            'scalingPolicies' => '\HuaweiCloud\SDK\_As\V1\Model\ScalingPoliciesV2[]'
    ];
    ...
    *  伸缩策略列表
    *
    * @return \HuaweiCloud\SDK\_As\V1\Model\ScalingPoliciesV2[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\_As\V1\Model\ScalingPoliciesV2[]|null $scalingPolicies 伸缩策略列表
    *
    * @return $this
    */
