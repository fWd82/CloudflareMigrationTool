...
class BatchEnterStandbyInstancesOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchEnterStandbyInstancesOption';
    ...
    */
    ...
    const ACTION_ENTER_STANDBY = 'ENTER_STANDBY';
