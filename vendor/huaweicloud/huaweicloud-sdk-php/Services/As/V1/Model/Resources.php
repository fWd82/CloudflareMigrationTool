...
class Resources implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'tags' => '\HuaweiCloud\SDK\_As\V1\Model\ResourceTags[]',
            'resourceName' => 'string'
    ];
    ...
    * Sets resourceId
    *
    * @param string|null $resourceId 资源详情ID。
    *
    * @return $this
    */
    ...
    *  标签列表，没有标签默认为空数组。
    *
    * @return \HuaweiCloud\SDK\_As\V1\Model\ResourceTags[]|null
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\_As\V1\Model\ResourceTags[]|null $tags 标签列表，没有标签默认为空数组。
    *
    * @return $this
    */
