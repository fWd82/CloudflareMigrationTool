...
class CreateScheduledTaskOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateScheduledTaskOption';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['scheduledPolicy'] === null) {
            $invalidProperties[] = "'scheduledPolicy' can't be null";
        }
        if ($this->container['instanceNumber'] === null) {
            $invalidProperties[] = "'instanceNumber' can't be null";
        }
    ...
    *  instanceNumber
    *
    * @return \HuaweiCloud\SDK\_As\V1\Model\IntegerRange
    */
    ...
    * Sets instanceNumber
    *
    * @param \HuaweiCloud\SDK\_As\V1\Model\IntegerRange $instanceNumber instanceNumber
    *
    * @return $this
    */
