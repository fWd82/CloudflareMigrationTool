...
class CreateLifeCycleHookOption implements ModelInterface, ArrayAccess
{
    ...
    * defaultTimeout  生命周期挂钩超时时间，取值范围60-86400，默认为3600，单位是秒。默认情况下，实例保持等待状态的时间。您可以延长超时时间，也可以在超时时间结束前进行 CONTINUE 或 ABANDON 操作。
    ...
    * Sets defaultTimeout
    *
    * @param int|null $defaultTimeout 生命周期挂钩超时时间，取值范围60-86400，默认为3600，单位是秒。默认情况下，实例保持等待状态的时间。您可以延长超时时间，也可以在超时时间结束前进行 CONTINUE 或 ABANDON 操作。
    *
    * @return $this
    */
