...
class BatchProtectInstancesOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchProtectInstancesOption';
