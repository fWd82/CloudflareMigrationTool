...
class ListScalingPoliciesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListScalingPoliciesResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'startNumber' => 'int',
            'limit' => 'int',
            'scalingPolicies' => '\HuaweiCloud\SDK\_As\V1\Model\ScalingV1PolicyDetail[]'
    ];
    ...
    *
    * @param \HuaweiCloud\SDK\_As\V1\Model\ScalingV1PolicyDetail[]|null $scalingPolicies 伸缩策略列表
    *
    * @return $this
    */
