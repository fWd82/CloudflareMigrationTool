...
class CreateScalingNotificationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateScalingNotificationRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\_As\V1\Model\CreateNotificationOption'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\_As\V1\Model\CreateNotificationOption|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\_As\V1\Model\CreateNotificationOption|null $body body
    *
    * @return $this
    */
