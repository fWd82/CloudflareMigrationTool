...
class ListScalingGroupsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListScalingGroupsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNumber  总记录数
    * startNumber  查询的开始记录号
    * limit  查询记录数
    * scalingGroups  伸缩组列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'startNumber' => 'int',
            'limit' => 'int',
            'scalingGroups' => '\HuaweiCloud\SDK\_As\V1\Model\ScalingGroups[]'
    ];
    ...
    */
    protected static $getters = [
            ...
            'limit' => 'getLimit',
            'scalingGroups' => 'getScalingGroups'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['scalingGroups'] = isset($data['scalingGroups']) ? $data['scalingGroups'] : null;
    }
    ...
    * Sets startNumber
    *
    * @param int|null $startNumber 查询的开始记录号
    *
    * @return $this
    */
    ...
    */
    ...
    {
        return $this->container['scalingGroups'];
    }

    /**
    * Sets scalingGroups
    *
    * @param \HuaweiCloud\SDK\_As\V1\Model\ScalingGroups[]|null $scalingGroups 伸缩组列表
    *
    * @return $this
    */
    public function setScalingGroups($scalingGroups)
    {
        $this->container['scalingGroups'] = $scalingGroups;
        return $this;
    }
