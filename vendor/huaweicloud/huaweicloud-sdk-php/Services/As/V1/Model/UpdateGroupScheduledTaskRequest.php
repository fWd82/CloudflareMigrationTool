...
class UpdateGroupScheduledTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGroupScheduledTaskRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\_As\V1\Model\UpdateScheduledTaskOption|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\_As\V1\Model\UpdateScheduledTaskOption|null $body body
    *
    * @return $this
    */
