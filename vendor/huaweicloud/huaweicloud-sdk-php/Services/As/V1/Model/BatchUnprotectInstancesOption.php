...
class BatchUnprotectInstancesOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUnprotectInstancesOption';
    ...
    */
    ...
    const ACTION_UNPROTECT = 'UNPROTECT';
