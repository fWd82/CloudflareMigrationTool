...
class ListScalingTagInfosByResourceIdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListScalingTagInfosByResourceIdRequest';
