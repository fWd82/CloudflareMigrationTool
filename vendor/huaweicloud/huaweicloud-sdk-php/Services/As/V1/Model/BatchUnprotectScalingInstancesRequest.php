...
class BatchUnprotectScalingInstancesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUnprotectScalingInstancesRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\_As\V1\Model\BatchUnprotectInstancesOption|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\_As\V1\Model\BatchUnprotectInstancesOption|null $body body
    *
    * @return $this
    */
