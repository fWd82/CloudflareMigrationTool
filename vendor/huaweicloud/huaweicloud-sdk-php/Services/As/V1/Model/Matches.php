...
class Matches implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Matches';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  键。暂限定为resource_name。
    * value  值。为固定字典值。每个值最大长度255个unicode字符。若为空字符串、resource_id时为精确匹配。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key 键。暂限定为resource_name。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value 值。为固定字典值。每个值最大长度255个unicode字符。若为空字符串、resource_id时为精确匹配。
    *
    * @return $this
    */
