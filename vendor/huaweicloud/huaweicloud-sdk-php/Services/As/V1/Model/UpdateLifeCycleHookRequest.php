...
class UpdateLifeCycleHookRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateLifeCycleHookRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\_As\V1\Model\UpdateLifeCycleHookOption|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\_As\V1\Model\UpdateLifeCycleHookOption|null $body body
    *
    * @return $this
    */
