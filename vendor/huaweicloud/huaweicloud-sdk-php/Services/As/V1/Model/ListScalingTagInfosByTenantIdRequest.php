...
class ListScalingTagInfosByTenantIdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListScalingTagInfosByTenantIdRequest';
