...
class LifecycleHookList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LifecycleHookList';
    ...
    * Sets createTime
    *
    * @param string|null $createTime 创建生命周期挂钩时间，遵循UTC时间。
    *
    * @return $this
    */
