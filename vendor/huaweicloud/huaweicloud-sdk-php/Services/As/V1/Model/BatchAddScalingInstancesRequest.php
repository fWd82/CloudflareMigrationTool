...
class BatchAddScalingInstancesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchAddScalingInstancesRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\_As\V1\Model\BatchAddInstancesOption'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\_As\V1\Model\BatchAddInstancesOption|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\_As\V1\Model\BatchAddInstancesOption|null $body body
    *
    * @return $this
    */
