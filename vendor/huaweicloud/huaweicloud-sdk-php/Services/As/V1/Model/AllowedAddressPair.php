...
class AllowedAddressPair implements ModelInterface, ArrayAccess
{
    ...
    * ipAddress  是否开启源/目的检查开关。  默认是开启，不允许置空。  关闭：1.1.1.1/0 开启：除“1.1.1.1/0”以外的其余值均按开启处理
    *
    * @var string[]
    */
    ...
    * Sets ipAddress
    *
    * @param string|null $ipAddress 是否开启源/目的检查开关。  默认是开启，不允许置空。  关闭：1.1.1.1/0 开启：除“1.1.1.1/0”以外的其余值均按开启处理
    *
    * @return $this
    */
