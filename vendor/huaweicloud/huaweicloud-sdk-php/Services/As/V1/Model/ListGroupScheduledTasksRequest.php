...
class ListGroupScheduledTasksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGroupScheduledTasksRequest';
    ...
    * Sets marker
    *
    * @param string|null $marker 查询的分页marker
    *
    * @return $this
    */
