...
class CreateScalingPolicyOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateScalingPolicyOption';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * scalingPolicyName  策略名称(1-64字符)，可以用中文、字母、数字、下划线、中划线的组合。
    * scalingGroupId  伸缩组ID，通过查询弹性伸缩组列表获取，详见查询弹性伸缩组列表。
    ...
    *
    * @param string $scalingPolicyName 策略名称(1-64字符)，可以用中文、字母、数字、下划线、中划线的组合。
    *
    * @return $this
    */
    ...
    * Sets scalingGroupId
    *
    * @param string $scalingGroupId 伸缩组ID，通过查询弹性伸缩组列表获取，详见查询弹性伸缩组列表。
    *
    * @return $this
    */
