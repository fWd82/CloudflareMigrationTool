...
class AttachCallbackInstanceLifeCycleHookRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AttachCallbackInstanceLifeCycleHookRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\_As\V1\Model\CallbackLifeCycleHookOption'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\_As\V1\Model\CallbackLifeCycleHookOption|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\_As\V1\Model\CallbackLifeCycleHookOption|null $body body
    *
    * @return $this
    */
