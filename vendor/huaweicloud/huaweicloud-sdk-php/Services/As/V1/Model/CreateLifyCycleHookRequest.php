...
class CreateLifyCycleHookRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateLifyCycleHookRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\_As\V1\Model\CreateLifeCycleHookOption'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\_As\V1\Model\CreateLifeCycleHookOption|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\_As\V1\Model\CreateLifeCycleHookOption|null $body body
    *
    * @return $this
    */
