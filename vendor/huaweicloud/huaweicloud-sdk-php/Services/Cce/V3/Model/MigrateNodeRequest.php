...
class MigrateNodeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MigrateNodeRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * clusterId  集群ID，获取方式请参见[如何获取接口URI中参数](cce_02_0271.xml)。
    * targetClusterId  集群ID，获取方式请参见[如何获取接口URI中参数](cce_02_0271.xml)。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Cce\V3\Model\MigrateNodesTask'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['targetClusterId'] === null) {
            ...
            if (!preg_match("/^[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12}$/", $this->container['targetClusterId'])) {
                $invalidProperties[] = "invalid value for 'targetClusterId', must be conform to the pattern /^[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12}$/.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\MigrateNodesTask|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\MigrateNodesTask|null $body body
    *
    * @return $this
    */
