...
class ShowClusterConfigurationDetailsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowClusterConfigurationDetailsResponse';
