...
class UpdateNodePoolResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateNodePoolResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'status' => '\HuaweiCloud\SDK\Cce\V3\Model\UpdateNodePoolStatus'
    ];
    ...
    *  status
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\UpdateNodePoolStatus|null
    */
    ...
    * Sets status
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\UpdateNodePoolStatus|null $status status
    *
    * @return $this
    */
