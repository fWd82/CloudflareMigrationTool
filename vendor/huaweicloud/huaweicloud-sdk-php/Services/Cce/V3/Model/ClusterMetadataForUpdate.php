...
class ClusterMetadataForUpdate implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ClusterMetadataForUpdate';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * alias  集群显示名。  命名规则：以小写字母开头，由小写字母、数字、中划线(-)组成，长度范围4-128位，且不能以中划线(-)结尾。  显示名和其他集群的名称、显示名不可以重复。  为空时表示不进行修改。
    *
    * @var string[]
    */
    ...
    * Sets alias
    *
    * @param string|null $alias 集群显示名。  命名规则：以小写字母开头，由小写字母、数字、中划线(-)组成，长度范围4-128位，且不能以中划线(-)结尾。  显示名和其他集群的名称、显示名不可以重复。  为空时表示不进行修改。
    *
    * @return $this
    */
