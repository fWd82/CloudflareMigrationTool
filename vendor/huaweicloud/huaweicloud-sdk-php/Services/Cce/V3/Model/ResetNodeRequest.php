...
class ResetNodeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResetNodeRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cce\V3\Model\ResetNodeList'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\ResetNodeList|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\ResetNodeList|null $body body
    *
    * @return $this
    */
