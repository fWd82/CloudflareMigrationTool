...
class CreateNodePoolRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateNodePoolRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cce\V3\Model\NodePool'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\NodePool|null $body body
    *
    * @return $this
    */
