...
class UpgradeInfoStatus implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpgradeInfoStatus';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * phase  升级任务状态. > Init：初始化 > Running：运行中 > Pause：暂停 > Success：成功 > Failed：失败
    * progress  升级任务进度
    ...
    * Sets phase
    *
    * @param string|null $phase 升级任务状态. > Init：初始化 > Running：运行中 > Pause：暂停 > Success：成功 > Failed：失败
    *
    * @return $this
    */
