...
class UpdateNodePoolConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateNodePoolConfigurationRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'nodepoolId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cce\V3\Model\UpdateClusterConfigurationsBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\UpdateClusterConfigurationsBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\UpdateClusterConfigurationsBody|null $body body
    *
    * @return $this
    */
