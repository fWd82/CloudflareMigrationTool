...
class UpdateClusterResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateClusterResponse';
    ...
    * Sets kind
    *
    * @param string|null $kind API类型，固定值“Cluster”或“cluster”，该值不可修改。
    *
    * @return $this
    */
    ...
    *  metadata
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\ClusterMetadata|null
    */
    ...
    * Sets metadata
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\ClusterMetadata|null $metadata metadata
    *
    * @return $this
    */
    ...
    *  spec
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\ClusterSpec|null
    */
    ...
    * Sets spec
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\ClusterSpec|null $spec spec
    *
    * @return $this
    */
