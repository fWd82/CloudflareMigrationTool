...
class AddonInstance implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddonInstance';
    ...
    *  spec
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\InstanceSpec
    */
    ...
    * Sets spec
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\InstanceSpec $spec spec
    *
    * @return $this
    */
    ...
    *  status
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\AddonInstanceStatus
    */
    ...
    * Sets status
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\AddonInstanceStatus $status status
    *
    * @return $this
    */
