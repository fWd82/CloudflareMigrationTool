...
class Contexts implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Contexts';
    ...
    */
    protected static $openAPITypes = [
            'name' => 'string',
            'context' => '\HuaweiCloud\SDK\Cce\V3\Model\Context'
    ];
    ...
    *  context
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\Context|null
    */
    ...
    * Sets context
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\Context|null $context context
    *
    * @return $this
    */
