...
class CreateUpgradeWorkFlowRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateUpgradeWorkFlowRequestBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['kind'] === null) {
            ...
            if (!preg_match("/WorkFlowTask/", $this->container['kind'])) {
        ...
        if ($this->container['apiVersion'] === null) {
            ...
            if (!preg_match("/v3/", $this->container['apiVersion'])) {
    ...
    * Sets kind
    *
    * @param string $kind API类型，固定值“WorkFlowTask”，该值不可修改。
    *
    * @return $this
    */
    ...
    *  spec
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\WorkFlowSpec
    */
    ...
    * Sets spec
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\WorkFlowSpec $spec spec
    *
    * @return $this
    */
