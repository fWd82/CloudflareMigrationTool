...
class ReinstallServerConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReinstallServerConfig';
    ...
    */
    protected static $openAPITypes = [
            ...
            'rootVolume' => '\HuaweiCloud\SDK\Cce\V3\Model\ReinstallVolumeSpec'
    ];
    ...
    *  rootVolume
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\ReinstallVolumeSpec|null
    */
    ...
    * Sets rootVolume
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\ReinstallVolumeSpec|null $rootVolume rootVolume
    *
    * @return $this
    */
