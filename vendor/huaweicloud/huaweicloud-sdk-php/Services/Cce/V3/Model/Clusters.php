...
class Clusters implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'name' => 'string',
            'cluster' => '\HuaweiCloud\SDK\Cce\V3\Model\ClusterCert'
    ];
    ...
    *  cluster
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\ClusterCert|null
    */
    ...
    * Sets cluster
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\ClusterCert|null $cluster cluster
    *
    * @return $this
    */
