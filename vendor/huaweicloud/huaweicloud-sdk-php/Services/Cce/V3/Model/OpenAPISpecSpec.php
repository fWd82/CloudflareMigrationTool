...
class OpenAPISpecSpec implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OpenAPISpec_spec';
    ...
    */
    protected static $openAPITypes = [
            'eip' => '\HuaweiCloud\SDK\Cce\V3\Model\EipSpec',
            'isDynamic' => 'bool'
    ];
    ...
    *  eip
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\EipSpec|null
    */
    ...
    * Sets eip
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\EipSpec|null $eip eip
    *
    * @return $this
    */
