...
class RemoveNodeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemoveNodeRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\RemoveNodesTask|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\RemoveNodesTask|null $body body
    *
    * @return $this
    */
