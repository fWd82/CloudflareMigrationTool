...
class SnapshotTaskStatus implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SnapshotTaskStatus';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * latestBackupTime  最近一次备份的时间
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $latestBackupTime 最近一次备份的时间
    *
    * @return $this
    */
