...
class UpdateClusterEipResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateClusterEipResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'spec' => '\HuaweiCloud\SDK\Cce\V3\Model\MasterEIPResponseSpec',
    ...
    *  spec
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\MasterEIPResponseSpec|null
    */
    ...
    * Sets spec
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\MasterEIPResponseSpec|null $spec spec
    *
    * @return $this
    */
