...
class UpgradeWorkFlowUpdateRequestBodyStatus implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpgradeWorkFlowUpdateRequestBody_status';
