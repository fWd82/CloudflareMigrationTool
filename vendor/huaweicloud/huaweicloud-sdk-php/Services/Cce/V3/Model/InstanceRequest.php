...
class InstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'spec' => '\HuaweiCloud\SDK\Cce\V3\Model\InstanceRequestSpec'
    ];
    ...
    *  spec
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\InstanceRequestSpec
    */
    ...
    * Sets spec
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\InstanceRequestSpec $spec spec
    *
    * @return $this
    */
