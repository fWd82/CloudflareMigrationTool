...
class ShowQuotasResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'quotas' => '\HuaweiCloud\SDK\Cce\V3\Model\QuotaResource[]'
    ];
    ...
    *  资源
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\QuotaResource[]|null
    */
    ...
    * Sets quotas
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\QuotaResource[]|null $quotas 资源
    *
    * @return $this
    */
