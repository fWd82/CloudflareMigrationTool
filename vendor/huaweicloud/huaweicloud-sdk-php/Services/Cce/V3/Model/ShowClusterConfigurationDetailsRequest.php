...
class ShowClusterConfigurationDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowClusterConfigurationDetailsRequest';
