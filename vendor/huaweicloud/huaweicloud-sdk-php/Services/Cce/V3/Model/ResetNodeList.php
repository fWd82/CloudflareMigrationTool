...
class ResetNodeList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResetNodeList';
    ...
    */
    protected static $openAPITypes = [
            'apiVersion' => 'string',
            'kind' => 'string',
            'nodeList' => '\HuaweiCloud\SDK\Cce\V3\Model\ResetNode[]'
    ];
    ...
    *  重置节点列表
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\ResetNode[]
    */
    ...
    * Sets nodeList
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\ResetNode[] $nodeList 重置节点列表
    *
    * @return $this
    */
