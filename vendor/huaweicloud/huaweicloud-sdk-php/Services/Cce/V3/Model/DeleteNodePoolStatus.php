...
class DeleteNodePoolStatus implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteNodePoolStatus';
    ...
    * Sets jobId
    *
    * @param string|null $jobId 对节点池执行操作时的 JobID。
    *
    * @return $this
    */
