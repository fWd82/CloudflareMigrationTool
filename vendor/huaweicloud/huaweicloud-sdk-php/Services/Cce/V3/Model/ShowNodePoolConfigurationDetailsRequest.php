...
class ShowNodePoolConfigurationDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowNodePoolConfigurationDetailsRequest';
