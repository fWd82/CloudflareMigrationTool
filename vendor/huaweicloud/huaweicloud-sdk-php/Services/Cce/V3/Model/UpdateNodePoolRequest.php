...
class UpdateNodePoolRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateNodePoolRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'nodepoolId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cce\V3\Model\NodePoolUpdate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\NodePoolUpdate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\NodePoolUpdate|null $body body
    *
    * @return $this
    */
