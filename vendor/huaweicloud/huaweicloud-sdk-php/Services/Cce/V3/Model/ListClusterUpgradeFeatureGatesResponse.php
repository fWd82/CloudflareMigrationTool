...
class ListClusterUpgradeFeatureGatesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListClusterUpgradeFeatureGatesResponse';
