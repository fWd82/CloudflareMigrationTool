...
class PrecheckClusterRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrecheckClusterRequestBody';
    ...
    *  spec
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\PrecheckSpec
    */
    ...
    * Sets spec
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\PrecheckSpec $spec spec
    *
    * @return $this
    */
