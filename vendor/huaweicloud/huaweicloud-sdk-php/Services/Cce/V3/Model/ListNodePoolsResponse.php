...
class ListNodePoolsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListNodePoolsResponse';
    ...
    * Sets kind
    *
    * @param string|null $kind API type. The value is fixed to List.
    *
    * @return $this
    */
    ...
    * Sets apiVersion
    *
    * @param string|null $apiVersion API version. The value is fixed to v3.
    *
    * @return $this
    */
