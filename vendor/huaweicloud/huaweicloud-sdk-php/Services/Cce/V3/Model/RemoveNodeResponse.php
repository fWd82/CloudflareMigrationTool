...
class RemoveNodeResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemoveNodeResponse';
    ...
    *  spec
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\RemoveNodesSpec|null
    */
    ...
    * Sets spec
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\RemoveNodesSpec|null $spec spec
    *
    * @return $this
    */
