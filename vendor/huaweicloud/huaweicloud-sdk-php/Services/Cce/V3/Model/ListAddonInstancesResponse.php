...
class ListAddonInstancesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAddonInstancesResponse';
    ...
    */
    protected static $openAPITypes = [
            'kind' => 'string',
            'apiVersion' => 'string',
            'items' => '\HuaweiCloud\SDK\Cce\V3\Model\AddonInstance[]'
    ];
