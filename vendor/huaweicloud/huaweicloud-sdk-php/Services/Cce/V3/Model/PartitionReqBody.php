...
class PartitionReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PartitionReqBody';
    ...
    *  metadata
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\PartitionReqBodyMetadata|null
    */
    ...
    * Sets metadata
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\PartitionReqBodyMetadata|null $metadata metadata
    *
    * @return $this
    */
