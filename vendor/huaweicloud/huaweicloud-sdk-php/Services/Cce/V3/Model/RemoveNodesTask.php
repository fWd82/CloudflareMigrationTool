...
class RemoveNodesTask implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemoveNodesTask';
    ...
    *  spec
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\RemoveNodesSpec
    */
    ...
    * Sets spec
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\RemoveNodesSpec $spec spec
    *
    * @return $this
    */
