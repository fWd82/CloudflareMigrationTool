...
class UpdateNodeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateNodeRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'nodeId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cce\V3\Model\ClusterNodeInformation'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\ClusterNodeInformation|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\ClusterNodeInformation|null $body body
    *
    * @return $this
    */
