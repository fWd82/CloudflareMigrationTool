...
class AddNodeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddNodeRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cce\V3\Model\AddNodeList'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\AddNodeList|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\AddNodeList|null $body body
    *
    * @return $this
    */
