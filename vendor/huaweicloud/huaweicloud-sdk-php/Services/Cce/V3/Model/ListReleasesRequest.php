...
class ListReleasesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListReleasesRequest';
    ...
    * Sets chartId
    *
    * @param string|null $chartId 模板ID
    *
    * @return $this
    */
    ...
    * Sets namespace
    *
    * @param string|null $namespace 模板对应的命名空间
    *
    * @return $this
    */
