...
class ListClusterMasterSnapshotTasksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListClusterMasterSnapshotTasksRequest';
