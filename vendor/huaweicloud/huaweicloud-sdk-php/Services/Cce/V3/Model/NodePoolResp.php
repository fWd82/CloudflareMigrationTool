...
class NodePoolResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NodePoolResp';
    ...
    * Sets kind
    *
    * @param string $kind API类型，固定值“NodePool”。
    *
    * @return $this
    */
    ...
    *  metadata
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\NodePoolMetadata
    */
    ...
    * Sets metadata
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\NodePoolMetadata $metadata metadata
    *
    * @return $this
    */
    ...
    *  spec
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\NodePoolSpec
    */
    ...
    * Sets spec
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\NodePoolSpec $spec spec
    *
    * @return $this
    */
