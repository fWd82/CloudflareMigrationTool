...
class MigrateNodeExtendParam implements ModelInterface, ArrayAccess
{
    ...
    * alphaCceNodeImageId  指定待切换目标操作系统所使用的用户镜像ID。 当指定“alpha.cce/NodeImageID”参数时，“os”参数必须和用户自定义镜像的操作系统一致。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['alphaCcePreInstall']) && (mb_strlen($this->container['alphaCcePreInstall']) > 2048)) {
                $invalidProperties[] = "invalid value for 'alphaCcePreInstall', the character length must be smaller than or equal to 2048.";
            }
            if (!is_null($this->container['alphaCcePostInstall']) && (mb_strlen($this->container['alphaCcePostInstall']) > 2048)) {
                $invalidProperties[] = "invalid value for 'alphaCcePostInstall', the character length must be smaller than or equal to 2048.";
            }
    ...
    *
    * @param string|null $alphaCceNodeImageId 指定待切换目标操作系统所使用的用户镜像ID。 当指定“alpha.cce/NodeImageID”参数时，“os”参数必须和用户自定义镜像的操作系统一致。
    *
    * @return $this
    */
