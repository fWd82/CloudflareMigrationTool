...
class UpdatePrivateSnatRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePrivateSnatRequest';
    ...
    */
    protected static $openAPITypes = [
            'snatRuleId' => 'string',
            'body' => '\HuaweiCloud\SDK\Nat\V2\Model\UpdatePrivateSnatOptionBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Nat\V2\Model\UpdatePrivateSnatOptionBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Nat\V2\Model\UpdatePrivateSnatOptionBody|null $body body
    *
    * @return $this
    */
