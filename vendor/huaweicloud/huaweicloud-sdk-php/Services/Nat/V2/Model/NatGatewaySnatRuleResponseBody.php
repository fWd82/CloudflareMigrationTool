...
class NatGatewaySnatRuleResponseBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NatGatewaySnatRuleResponseBody';
    ...
    * @return string
    */
    public function getFreezedIpAddress()
    {
        return $this->container['freezedIpAddress'];
    }
