...
class UpdateNatGatewaySnatRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateNatGatewaySnatRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            'snatRuleId' => 'string',
            'body' => '\HuaweiCloud\SDK\Nat\V2\Model\UpdateNatGatewaySnatRuleRequestOption'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Nat\V2\Model\UpdateNatGatewaySnatRuleRequestOption|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Nat\V2\Model\UpdateNatGatewaySnatRuleRequestOption|null $body body
    *
    * @return $this
    */
