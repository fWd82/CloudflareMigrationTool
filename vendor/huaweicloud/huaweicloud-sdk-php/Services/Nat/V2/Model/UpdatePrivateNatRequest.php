...
class UpdatePrivateNatRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePrivateNatRequest';
    ...
    */
    protected static $openAPITypes = [
            'gatewayId' => 'string',
            'body' => '\HuaweiCloud\SDK\Nat\V2\Model\UpdatePrivateNatRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Nat\V2\Model\UpdatePrivateNatRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Nat\V2\Model\UpdatePrivateNatRequestBody|null $body body
    *
    * @return $this
    */
