...
class UpdatePrivateDnatResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePrivateDnatResponse';
    ...
    */
    protected static $openAPITypes = [
            'dnatRule' => '\HuaweiCloud\SDK\Nat\V2\Model\PrivateDnat',
            'requestId' => 'string'
    ];
    ...
    * Sets dnatRule
    *
    * @param \HuaweiCloud\SDK\Nat\V2\Model\PrivateDnat|null $dnatRule dnatRule
    *
    * @return $this
    */
