...
class ListPrivateDnatsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPrivateDnatsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dnatRules  查询DNAT规则列表的响应体。
    * requestId  请求ID。
    * pageInfo  pageInfo
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'dnatRules' => '\HuaweiCloud\SDK\Nat\V2\Model\PrivateDnat[]',
            'requestId' => 'string',
    ...
    *  查询DNAT规则列表的响应体。
    *
    * @return \HuaweiCloud\SDK\Nat\V2\Model\PrivateDnat[]|null
    */
    ...
    * Sets dnatRules
    *
    * @param \HuaweiCloud\SDK\Nat\V2\Model\PrivateDnat[]|null $dnatRules 查询DNAT规则列表的响应体。
    *
    * @return $this
    */
