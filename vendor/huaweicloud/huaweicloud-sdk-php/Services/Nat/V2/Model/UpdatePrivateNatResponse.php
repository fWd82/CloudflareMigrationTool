...
class UpdatePrivateNatResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePrivateNatResponse';
    ...
    */
    protected static $openAPITypes = [
            'gateway' => '\HuaweiCloud\SDK\Nat\V2\Model\PrivateNat',
            'requestId' => 'string'
    ];
    ...
    * Sets gateway
    *
    * @param \HuaweiCloud\SDK\Nat\V2\Model\PrivateNat|null $gateway gateway
    *
    * @return $this
    */
