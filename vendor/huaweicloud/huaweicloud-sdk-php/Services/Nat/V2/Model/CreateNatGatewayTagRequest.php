...
class CreateNatGatewayTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateNatGatewayTagRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * natGatewayId  所属公网NAT网关的id。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'natGatewayId' => 'string',
            'body' => '\HuaweiCloud\SDK\Nat\V2\Model\CreateNatTagRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Nat\V2\Model\CreateNatTagRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Nat\V2\Model\CreateNatTagRequestBody|null $body body
    *
    * @return $this
    */
