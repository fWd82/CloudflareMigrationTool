...
class PublicResource implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PublicResource';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceId  资源ID
    * resourceDetail  资源详情。资源对象，用于扩展。默认为空
    * tags  标签列表，没有标签默认为空数组。请参考表ResourceTag字段数据结构说明。
    ...
    */
    protected static $openAPITypes = [
            ...
            'tags' => '\HuaweiCloud\SDK\Nat\V2\Model\PublicResourceTag[]',
            'resourceName' => 'string'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Nat\V2\Model\PublicResourceTag[]
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Nat\V2\Model\PublicResourceTag[] $tags 标签列表，没有标签默认为空数组。请参考表ResourceTag字段数据结构说明。
    *
    * @return $this
    */
