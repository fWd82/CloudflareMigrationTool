...
class DeleteTransitIpRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteTransitIpRequest';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['transitIpId'] === null) {
            $invalidProperties[] = "'transitIpId' can't be null";
        }
            if ((mb_strlen($this->container['transitIpId']) > 36)) {
                $invalidProperties[] = "invalid value for 'transitIpId', the character length must be smaller than or equal to 36.";
            }
            if ((mb_strlen($this->container['transitIpId']) < 1)) {
                $invalidProperties[] = "invalid value for 'transitIpId', the character length must be bigger than or equal to 1.";
            }
