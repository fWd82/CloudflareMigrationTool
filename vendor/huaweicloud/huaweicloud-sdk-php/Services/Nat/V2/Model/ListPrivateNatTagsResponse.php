...
class ListPrivateNatTagsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPrivateNatTagsResponse';
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Nat\V2\Model\Tags[]|null $tags 标签。
    *
    * @return $this
    */
