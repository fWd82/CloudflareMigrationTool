...
class ListPrivateNatsByTagsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPrivateNatsByTagsResponse';
    ...
    */
    protected static $openAPITypes = [
            'resources' => '\HuaweiCloud\SDK\Nat\V2\Model\Resource[]',
            'requestId' => 'string',
            'totalCount' => 'int'
    ];
    ...
    *  资源列表。
    *
    * @return \HuaweiCloud\SDK\Nat\V2\Model\Resource[]|null
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Nat\V2\Model\Resource[]|null $resources 资源列表。
    *
    * @return $this
    */
