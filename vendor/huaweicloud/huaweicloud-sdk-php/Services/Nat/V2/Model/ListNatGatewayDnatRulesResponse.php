...
class ListNatGatewayDnatRulesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListNatGatewayDnatRulesResponse';
    ...
    * Sets dnatRules
    *
    * @param \HuaweiCloud\SDK\Nat\V2\Model\NatGatewayDnatRuleResponseBody[]|null $dnatRules 查询DNAT规则列表的响应体。
    *
    * @return $this
    */
