...
class Quota implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resources' => '\HuaweiCloud\SDK\Ims\V2\Model\QuotaInfo[]'
    ];
    ...
    *  查询的配额信息。
    *
    * @return \HuaweiCloud\SDK\Ims\V2\Model\QuotaInfo[]
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Ims\V2\Model\QuotaInfo[] $resources 查询的配额信息。
    *
    * @return $this
    */
