...
class RegisterImageRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'imageId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ims\V2\Model\RegisterImageRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ims\V2\Model\RegisterImageRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ims\V2\Model\RegisterImageRequestBody|null $body body
    *
    * @return $this
    */
