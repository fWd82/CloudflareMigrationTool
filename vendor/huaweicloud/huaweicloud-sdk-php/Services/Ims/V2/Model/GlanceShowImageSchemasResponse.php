...
class GlanceShowImageSchemasResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'additionalProperties' => '\HuaweiCloud\SDK\Ims\V2\Model\AdditionalProperties',
            'name' => 'string',
            'properties' => 'object',
    ...
    *
    * @param \HuaweiCloud\SDK\Ims\V2\Model\AdditionalProperties|null $additionalProperties additionalProperties
    *
    * @return $this
    */
