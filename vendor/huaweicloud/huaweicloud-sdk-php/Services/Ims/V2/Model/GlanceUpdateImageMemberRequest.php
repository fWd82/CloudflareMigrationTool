...
class GlanceUpdateImageMemberRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'imageId' => 'string',
            'memberId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ims\V2\Model\GlanceUpdateImageMemberRequestBody'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ims\V2\Model\GlanceUpdateImageMemberRequestBody|null $body body
    *
    * @return $this
    */
