...
class UpgradeEngineRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpgradeEngineRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'engineId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cse\V1\Model\EngineUpdateReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cse\V1\Model\EngineUpdateReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cse\V1\Model\EngineUpdateReq|null $body body
    *
    * @return $this
    */
