...
class UpgradeEngineConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpgradeEngineConfigRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'engineId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cse\V1\Model\EngineConfigureReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cse\V1\Model\EngineConfigureReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cse\V1\Model\EngineConfigureReq|null $body body
    *
    * @return $this
    */
