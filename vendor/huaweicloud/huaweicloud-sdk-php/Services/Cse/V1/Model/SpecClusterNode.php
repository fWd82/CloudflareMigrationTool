...
class SpecClusterNode implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'clusterNodes' => '\HuaweiCloud\SDK\Cse\V1\Model\ClusterNode[]'
    ];
    ...
    *  CCE节点信息。
    *
    * @return \HuaweiCloud\SDK\Cse\V1\Model\ClusterNode[]|null
    */
    ...
    * Sets clusterNodes
    *
    * @param \HuaweiCloud\SDK\Cse\V1\Model\ClusterNode[]|null $clusterNodes CCE节点信息。
    *
    * @return $this
    */
