...
class CreateRoute implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'name' => 'string',
            'weight' => 'int',
            'tags' => '\HuaweiCloud\SDK\Cse\V1\Model\CreateRouteTags'
    ];
    ...
    *  tags
    *
    * @return \HuaweiCloud\SDK\Cse\V1\Model\CreateRouteTags|null
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Cse\V1\Model\CreateRouteTags|null $tags tags
    *
    * @return $this
    */
