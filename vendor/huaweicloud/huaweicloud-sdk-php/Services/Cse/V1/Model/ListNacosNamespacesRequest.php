...
class ListNacosNamespacesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListNacosNamespacesRequest';
    ...
    * Sets offset
    *
    * @param int $offset 分页参数，偏移量，从0开始
    *
    * @return $this
    */
    ...
    * Sets limit
    *
    * @param int $limit 分页参数，分页大小，0表示不分页
    *
    * @return $this
    */
