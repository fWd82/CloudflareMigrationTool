...
class UpdateGovernancePolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGovernancePolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'kind' => 'string',
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cse\V1\Model\CreateGovPolicy'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cse\V1\Model\CreateGovPolicy|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cse\V1\Model\CreateGovPolicy|null $body body
    *
    * @return $this
    */
