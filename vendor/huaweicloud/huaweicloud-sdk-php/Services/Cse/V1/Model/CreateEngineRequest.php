...
class CreateEngineRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Cse\V1\Model\EngineCreateReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cse\V1\Model\EngineCreateReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cse\V1\Model\EngineCreateReq|null $body body
    *
    * @return $this
    */
