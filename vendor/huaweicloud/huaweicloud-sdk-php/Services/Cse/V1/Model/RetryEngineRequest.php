...
class RetryEngineRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RetryEngineRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'engineId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cse\V1\Model\EngineAdditionalActionReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cse\V1\Model\EngineAdditionalActionReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cse\V1\Model\EngineAdditionalActionReq|null $body body
    *
    * @return $this
    */
