...
class ResizeEngineRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResizeEngineRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'accept' => 'string',
            'engineId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cse\V1\Model\EngineModifyReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cse\V1\Model\EngineModifyReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cse\V1\Model\EngineModifyReq|null $body body
    *
    * @return $this
    */
