...
class ListGovernancePolicyByPolicyIdResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGovernancePolicyByPolicyIdResponse';
