...
class CreateMicroserviceRouteRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMicroserviceRouteRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'environment' => 'string',
            'appId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cse\V1\Model\CreateRules[]'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cse\V1\Model\CreateRules[]|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cse\V1\Model\CreateRules[]|null $body body
    *
    * @return $this
    */
