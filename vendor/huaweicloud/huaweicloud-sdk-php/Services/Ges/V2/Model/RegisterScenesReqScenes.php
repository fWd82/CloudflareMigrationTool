...
class RegisterScenesReqScenes implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RegisterScenesReq_scenes';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  场景名称。
    * applications  要订阅的application名字列表(当前不支持)。
    *
    * @var string[]
    */
    ...
    * Sets applications
    *
    * @param string[]|null $applications 要订阅的application名字列表(当前不支持)。
    *
    * @return $this
    */
