...
class ImportGraph2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportGraph2Request';
    ...
    */
    protected static $openAPITypes = [
            'graphId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ges\V2\Model\ImportGraphReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ges\V2\Model\ImportGraphReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ges\V2\Model\ImportGraphReq|null $body body
    *
    * @return $this
    */
