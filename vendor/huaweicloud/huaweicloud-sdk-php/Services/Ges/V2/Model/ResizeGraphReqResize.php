...
class ResizeGraphReqResize implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResizeGraphReq_resize';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * graphSizeTypeIndex  图规格类型，当前支持取值为\"2\",\"3\",\"4\",\"5\"分别代表扩容成千万边、一亿边、十亿边、百亿边规格的图。
    *
    * @var string[]
    */
    ...
    *
    * @param string $graphSizeTypeIndex 图规格类型，当前支持取值为\"2\",\"3\",\"4\",\"5\"分别代表扩容成千万边、一亿边、十亿边、百亿边规格的图。
    *
    * @return $this
    */
