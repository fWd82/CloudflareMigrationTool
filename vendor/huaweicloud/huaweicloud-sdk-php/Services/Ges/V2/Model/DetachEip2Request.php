...
class DetachEip2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DetachEip2Request';
    ...
    */
    protected static $openAPITypes = [
            'graphId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ges\V2\Model\DetachEipReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ges\V2\Model\DetachEipReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ges\V2\Model\DetachEipReq|null $body body
    *
    * @return $this
    */
