...
class AttachEip2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AttachEip2Request';
    ...
    */
    protected static $openAPITypes = [
            'graphId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ges\V2\Model\AttachEipReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ges\V2\Model\AttachEipReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ges\V2\Model\AttachEipReq|null $body body
    *
    * @return $this
    */
