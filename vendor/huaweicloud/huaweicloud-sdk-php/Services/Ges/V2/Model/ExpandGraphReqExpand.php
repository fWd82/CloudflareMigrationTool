...
class ExpandGraphReqExpand implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExpandGraphReq_expand';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['replication'] === null) {
            $invalidProperties[] = "'replication' can't be null";
        }
