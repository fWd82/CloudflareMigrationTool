...
class CreateGraphReqGraphEncryption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateGraphReq_graph_encryption';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * enable  是否启动加密特性。取值为“true”或者“false”。默认为“false”。
    * masterKeyId  与建图对应的project下，华为云数据加密服务创建的用户主密钥ID。
    *
    * @var string[]
    */
    ...
    * Sets enable
    *
    * @param bool|null $enable 是否启动加密特性。取值为“true”或者“false”。默认为“false”。
    *
    * @return $this
    */
    ...
    * Sets masterKeyId
    *
    * @param string|null $masterKeyId 与建图对应的project下，华为云数据加密服务创建的用户主密钥ID。
    *
    * @return $this
    */
