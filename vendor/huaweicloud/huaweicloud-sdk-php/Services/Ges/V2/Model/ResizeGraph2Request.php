...
class ResizeGraph2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResizeGraph2Request';
    ...
    */
    protected static $openAPITypes = [
            'graphId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ges\V2\Model\ResizeGraphReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ges\V2\Model\ResizeGraphReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ges\V2\Model\ResizeGraphReq|null $body body
    *
    * @return $this
    */
