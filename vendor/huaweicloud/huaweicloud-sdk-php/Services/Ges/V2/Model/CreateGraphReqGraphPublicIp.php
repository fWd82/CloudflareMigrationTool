...
class CreateGraphReqGraphPublicIp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateGraphReq_graph_public_ip';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * publicBindType  弹性IP绑定类型，取值如下。  - auto_assign：自动绑定。 - bind_existing：使用已有。
    * eipId  弹性IP的id，当publicBindType设置为bind_existing时，该值为用户某个已创建但尚未绑定的EIP的ID；当publicBindType设置为auto_assign时，该值设置为空。
    *
    * @var string[]
    */
    ...
    * Sets publicBindType
    *
    * @param string|null $publicBindType 弹性IP绑定类型，取值如下。  - auto_assign：自动绑定。 - bind_existing：使用已有。
    *
    * @return $this
    */
    ...
    * Sets eipId
    *
    * @param string|null $eipId 弹性IP的id，当publicBindType设置为bind_existing时，该值为用户某个已创建但尚未绑定的EIP的ID；当publicBindType设置为auto_assign时，该值设置为空。
    *
    * @return $this
    */
