...
class ExportGraph2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportGraph2Request';
    ...
    */
    protected static $openAPITypes = [
            'graphId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ges\V2\Model\ExportGraphReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ges\V2\Model\ExportGraphReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ges\V2\Model\ExportGraphReq|null $body body
    *
    * @return $this
    */
