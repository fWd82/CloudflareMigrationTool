...
class TemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    *  vpc
    *
    * @return \HuaweiCloud\SDK\Sms\V3\Model\VpcObject|null
    */
    ...
    * Sets vpc
    *
    * @param \HuaweiCloud\SDK\Sms\V3\Model\VpcObject|null $vpc vpc
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Sms\V3\Model\Nics[]|null
    */
    ...
    * Sets nics
    *
    * @param \HuaweiCloud\SDK\Sms\V3\Model\Nics[]|null $nics 网卡信息，支持多个网卡，如果是自动创建，只填一个，ID使用“autoCreate”
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Sms\V3\Model\SgObject[]|null
    */
    ...
    * Sets securityGroups
    *
    * @param \HuaweiCloud\SDK\Sms\V3\Model\SgObject[]|null $securityGroups 安全组，支持多个安全组，如果是自动创建，只填一个，ID使用“autoCreate”
    *
    * @return $this
    */
    ...
    *  publicip
    *
    * @return \HuaweiCloud\SDK\Sms\V3\Model\PublicIp|null
    */
    ...
    * Sets publicip
    *
    * @param \HuaweiCloud\SDK\Sms\V3\Model\PublicIp|null $publicip publicip
    *
    * @return $this
    */
    ...
    *  磁盘信息
    *
    * @return \HuaweiCloud\SDK\Sms\V3\Model\TemplateDisk[]|null
    */
    ...
    * Sets disk
    *
    * @param \HuaweiCloud\SDK\Sms\V3\Model\TemplateDisk[]|null $disk 磁盘信息
    *
    * @return $this
    */
