...
class UpdateTaskSpeedRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'taskId' => 'string',
            'body' => '\HuaweiCloud\SDK\Sms\V3\Model\UpdateTaskSpeedReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Sms\V3\Model\UpdateTaskSpeedReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Sms\V3\Model\UpdateTaskSpeedReq|null $body body
    *
    * @return $this
    */
