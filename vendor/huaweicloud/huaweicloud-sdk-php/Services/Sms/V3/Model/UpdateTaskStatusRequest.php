...
class UpdateTaskStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'taskId' => 'string',
            'body' => '\HuaweiCloud\SDK\Sms\V3\Model\UpdateTaskStatusReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Sms\V3\Model\UpdateTaskStatusReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Sms\V3\Model\UpdateTaskStatusReq|null $body body
    *
    * @return $this
    */
