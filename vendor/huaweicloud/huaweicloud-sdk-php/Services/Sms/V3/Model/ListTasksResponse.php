...
class ListTasksResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'tasks' => '\HuaweiCloud\SDK\Sms\V3\Model\TasksResponseBody[]'
    ];
    ...
    *  查询到的任务列表
    *
    * @return \HuaweiCloud\SDK\Sms\V3\Model\TasksResponseBody[]|null
    */
    ...
    * Sets tasks
    *
    * @param \HuaweiCloud\SDK\Sms\V3\Model\TasksResponseBody[]|null $tasks 查询到的任务列表
    *
    * @return $this
    */
