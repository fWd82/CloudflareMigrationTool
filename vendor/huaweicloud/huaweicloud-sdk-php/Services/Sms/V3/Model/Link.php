...
class Link implements ModelInterface, ArrayAccess
{
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['href']) && (mb_strlen($this->container['href']) > 1024)) {
            ...
            if (!is_null($this->container['rel']) && (mb_strlen($this->container['rel']) > 1024)) {
                $invalidProperties[] = "invalid value for 'rel', the character length must be smaller than or equal to 1024.";
            }
            if (!is_null($this->container['rel']) && (mb_strlen($this->container['rel']) < 0)) {
                $invalidProperties[] = "invalid value for 'rel', the character length must be bigger than or equal to 0.";
            }
