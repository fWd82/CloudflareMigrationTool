...
class UpdateCommandResultRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'serverId' => 'string',
            'body' => '\HuaweiCloud\SDK\Sms\V3\Model\CommandBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Sms\V3\Model\CommandBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Sms\V3\Model\CommandBody|null $body body
    *
    * @return $this
    */
