...
class UpdateMigprojectRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'migProjectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Sms\V3\Model\MigProject'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Sms\V3\Model\MigProject|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Sms\V3\Model\MigProject|null $body body
    *
    * @return $this
    */
