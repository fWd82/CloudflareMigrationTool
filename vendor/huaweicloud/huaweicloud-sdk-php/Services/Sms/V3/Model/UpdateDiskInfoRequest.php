...
class UpdateDiskInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'sourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Sms\V3\Model\PutDiskInfoReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Sms\V3\Model\PutDiskInfoReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Sms\V3\Model\PutDiskInfoReq|null $body body
    *
    * @return $this
    */
