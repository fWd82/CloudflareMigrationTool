...
class UpdateTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'taskId' => 'string',
            'body' => '\HuaweiCloud\SDK\Sms\V3\Model\PutTaskReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Sms\V3\Model\PutTaskReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Sms\V3\Model\PutTaskReq|null $body body
    *
    * @return $this
    */
