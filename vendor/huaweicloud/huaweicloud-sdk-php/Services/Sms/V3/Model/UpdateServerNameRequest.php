...
class UpdateServerNameRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'sourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Sms\V3\Model\PutSourceServerBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Sms\V3\Model\PutSourceServerBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Sms\V3\Model\PutSourceServerBody|null $body body
    *
    * @return $this
    */
