...
class ListConfigurationsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'configurations' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ConfigurationSummary[]'
    ];
    ...
    *  configurations
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ConfigurationSummary[]|null
    */
    ...
    * Sets configurations
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ConfigurationSummary[]|null $configurations configurations
    *
    * @return $this
    */
