...
class OpenGaussInstanceResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OpenGaussInstanceResponse';
    ...
    *  ha
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\OpenGaussHaResponse|null
    */
    ...
    * Sets ha
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\OpenGaussHaResponse|null $ha ha
    *
    * @return $this
    */
