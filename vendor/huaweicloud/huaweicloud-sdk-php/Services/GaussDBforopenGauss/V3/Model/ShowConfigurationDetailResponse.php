...
class ShowConfigurationDetailResponse implements ModelInterface, ArrayAccess
{
    ...
    * name  参数模板名称。
    * description  参数模板描述。
    * engineVersion  引擎版本。 [数据库版本。支持2.3版本，取值为“2.3”]。
    * instanceMode  实例部署形态。independent：独立；ha：主备。
    ...
    */
    protected static $openAPITypes = [
            ...
            'createdAt' => 'string',
            'updatedAt' => 'string',
            'configurationParameters' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ParaGroupParameterResult[]'
    ];
    ...
    * Sets engineVersion
    *
    * @param string|null $engineVersion 引擎版本。 [数据库版本。支持2.3版本，取值为“2.3”]。
    *
    * @return $this
    */
    ...
    * Sets instanceMode
    *
    * @param string|null $instanceMode 实例部署形态。independent：独立；ha：主备。
    *
    * @return $this
    */
    ...
    * Sets updatedAt
    *
    * @param string|null $updatedAt 修改时间，格式为“yyyy-mm-ddThh:mm:ssZ”。 其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。
    *
    * @return $this
    */
    ...
    *  参数详情。
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ParaGroupParameterResult[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ParaGroupParameterResult[]|null $configurationParameters 参数详情。
    *
    * @return $this
    */
