...
class ShowConfigurationDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowConfigurationDetailRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  语言,默认：en-us。
    * configId  参数模板ID
    *
    * @var string[]
    */
    ...
    * Sets xLanguage
    *
    * @param string|null $xLanguage 语言,默认：en-us。
    *
    * @return $this
    */
