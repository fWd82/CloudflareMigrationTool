...
class Backups implements ModelInterface, ArrayAccess
{
    ...
    *  datastore
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\OpenGaussDatastore|null
    */
    ...
    * Sets datastore
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\OpenGaussDatastore|null $datastore datastore
    *
    * @return $this
    */
