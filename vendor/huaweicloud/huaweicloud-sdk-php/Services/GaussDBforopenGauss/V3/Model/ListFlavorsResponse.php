...
class ListFlavorsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'flavors' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\Flavor[]',
            'total' => 'int'
    ];
    ...
    *  实例规格信息。
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\Flavor[]|null
    */
    ...
    * Sets flavors
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\Flavor[]|null $flavors 实例规格信息。
    *
    * @return $this
    */
