...
class OpenGaussInstanceResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OpenGaussInstanceResult';
    ...
    *  datastore
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\OpenGaussDatastoreResult
    */
    ...
    * Sets datastore
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\OpenGaussDatastoreResult $datastore datastore
    *
    * @return $this
    */
