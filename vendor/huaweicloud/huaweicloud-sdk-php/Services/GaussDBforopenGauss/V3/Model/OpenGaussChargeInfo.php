...
class OpenGaussChargeInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OpenGaussChargeInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * chargeMode  计费模式。postPaid：后付费，即按需付费。prePaid：预付费，即包年/包月。
    * periodType  订购周期类型。month：包月。year：包年。 说明： “charge_mode”为“prePaid”时生效，且为必选值。
    * periodNum  “charge_mode”为“prePaid”时生效，且为必选值，指定订购的时间。  取值范围：  当“period_type”为“month”时，取值为1~9。 当“period_type”为“year”时，取值为1~3。  当传入浮点型时，会自动截取为整型。
    * isAutoRenew  创建包周期实例时可指定，表示是否自动续订，续订时会自动支付。 按月订购时续订周期默认为1个月，按年订购时续订周期默认为1年，续订周期可自定义修改。  true，表示自动续订。 false，表示不自动续订，默认为该方式。
    * isAutoPay  创建包周期实例时可指定，表示是否自动从账户中支付，该字段不影响自动续订的支付方式。  true，表示自动从账户中支付。 false，表示手动从账户中支付，默认为该支付方式。
    *
    * @var string[]
    */
    ...
    * Sets chargeMode
    *
    * @param string $chargeMode 计费模式。postPaid：后付费，即按需付费。prePaid：预付费，即包年/包月。
    *
    * @return $this
    */
    ...
    * Sets periodType
    *
    * @param string|null $periodType 订购周期类型。month：包月。year：包年。 说明： “charge_mode”为“prePaid”时生效，且为必选值。
    *
    * @return $this
    */
    ...
    * Sets periodNum
    *
    * @param int|null $periodNum “charge_mode”为“prePaid”时生效，且为必选值，指定订购的时间。  取值范围：  当“period_type”为“month”时，取值为1~9。 当“period_type”为“year”时，取值为1~3。  当传入浮点型时，会自动截取为整型。
    *
    * @return $this
    */
    ...
    * Sets isAutoRenew
    *
    * @param bool|null $isAutoRenew 创建包周期实例时可指定，表示是否自动续订，续订时会自动支付。 按月订购时续订周期默认为1个月，按年订购时续订周期默认为1年，续订周期可自定义修改。  true，表示自动续订。 false，表示不自动续订，默认为该方式。
    *
    * @return $this
    */
    ...
    * Sets isAutoPay
    *
    * @param bool|null $isAutoPay 创建包周期实例时可指定，表示是否自动从账户中支付，该字段不影响自动续订的支付方式。  true，表示自动从账户中支付。 false，表示手动从账户中支付，默认为该支付方式。
    *
    * @return $this
    */
