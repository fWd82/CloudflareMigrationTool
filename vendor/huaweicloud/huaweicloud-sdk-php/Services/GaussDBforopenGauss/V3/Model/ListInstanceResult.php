...
class ListInstanceResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceResult';
    ...
    * port  数据库端口号。GaussDB数据库端口设置范围为1024~39998（其中2378,2379,2380,4999,5000,5999,6000,6001,8097,8098,20049,20050,21731,21732被系统占用不可设置）。  当不传该参数时，默认端口如下：8000。
    ...
    * flavorRef  规格码。参考[表1](https://support.huaweicloud.com/api-opengauss/opengauss_api_0037.html#opengauss_api_0037__ted9b9d433c8a4c52884e199e17f94479)中GaussDB的“规格编码”列内容获取。
    ...
    */
    protected static $openAPITypes = [
            ...
            'port' => 'int',
            'type' => 'string',
            'ha' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ListHaResult',
            'replicaNum' => 'int',
            'region' => 'string',
            ...
            'nodes' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\NodeResult[]',
    ...
    * Sets port
    *
    * @param int $port 数据库端口号。GaussDB数据库端口设置范围为1024~39998（其中2378,2379,2380,4999,5000,5999,6000,6001,8097,8098,20049,20050,21731,21732被系统占用不可设置）。  当不传该参数时，默认端口如下：8000。
    *
    * @return $this
    */
    ...
    *  ha
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ListHaResult
    */
    ...
    * Sets ha
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ListHaResult $ha ha
    *
    * @return $this
    */
    ...
    * Sets flavorRef
    *
    * @param string $flavorRef 规格码。参考[表1](https://support.huaweicloud.com/api-opengauss/opengauss_api_0037.html#opengauss_api_0037__ted9b9d433c8a4c52884e199e17f94479)中GaussDB的“规格编码”列内容获取。
    *
    * @return $this
    */
    ...
    *  实例节点信息列表。
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\NodeResult[]
    */
    ...
    * Sets nodes
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\NodeResult[] $nodes 实例节点信息列表。
    *
    * @return $this
    */
    ...
    *  标签列表，没有标签不返回该参数。
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\TagResult[]
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\TagResult[] $tags 标签列表，没有标签不返回该参数。
    *
    * @return $this
    */
    ...
    * Sets diskUsage
    *
    * @param string|null $diskUsage 实例磁盘的可使用率，值范围[0-1]，值保留四位小数。
    *
    * @return $this
    */
