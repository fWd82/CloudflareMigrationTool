...
class ListHistoryOperationsResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListHistoryOperationsResult';
    ...
    * oldValue  修改前参数值。
    * newValue  修改后参数值。
    * updateResult  修改状态 (SUCCESS | FAILED)。
    ...
    * Sets updateResult
    *
    * @param string $updateResult 修改状态 (SUCCESS | FAILED)。
    *
    * @return $this
    */
