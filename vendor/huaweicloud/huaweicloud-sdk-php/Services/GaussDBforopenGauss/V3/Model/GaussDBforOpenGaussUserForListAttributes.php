...
class GaussDBforOpenGaussUserForListAttributes implements ModelInterface, ArrayAccess
{
    ...
    * rolsuper  用户是否具有超级用户权限，取值为“true”或“false”。
    * rolinherit  用户是否自动继承其所属角色的权限，取值为“true”或“false”。
    * rolcreaterole  用户是否支持创建其他子用户，取值为“true”或“false”。
    * rolcreatedb  用户是否可以创建数据库，取值为“true”或“false”。
    * rolcanlogin  用户是否可以登录数据库，取值为“true”或“false”。
    ...
    * Sets rolsuper
    *
    * @param bool|null $rolsuper 用户是否具有超级用户权限，取值为“true”或“false”。
    *
    * @return $this
    */
    ...
    * Sets rolinherit
    *
    * @param bool|null $rolinherit 用户是否自动继承其所属角色的权限，取值为“true”或“false”。
    *
    * @return $this
    */
    ...
    * Sets rolcreaterole
    *
    * @param bool|null $rolcreaterole 用户是否支持创建其他子用户，取值为“true”或“false”。
    *
    * @return $this
    */
    ...
    * Sets rolcreatedb
    *
    * @param bool|null $rolcreatedb 用户是否可以创建数据库，取值为“true”或“false”。
    *
    * @return $this
    */
    ...
    * Sets rolcanlogin
    *
    * @param bool|null $rolcanlogin 用户是否可以登录数据库，取值为“true”或“false”。
    *
    * @return $this
    */
    ...
    * Sets rolconnlimit
    *
    * @param int|null $rolconnlimit 用户连接实例的最大并发连接数。-1表示没有限制。
    *
    * @return $this
    */
    ...
    * Sets rolreplication
    *
    * @param bool|null $rolreplication 用户是否属于复制角色，取值为“true”或“false”。
    *
    * @return $this
    */
    ...
    * Sets rolbypassrls
    *
    * @param bool|null $rolbypassrls 用户是否绕过每个行级安全策略，取值为“true”或“false”。
    *
    * @return $this
    */
