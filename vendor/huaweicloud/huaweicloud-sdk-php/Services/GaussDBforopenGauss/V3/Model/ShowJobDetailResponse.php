...
class ShowJobDetailResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'job' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\JobDetail'
    ];
    ...
    *  job
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\JobDetail|null
    */
    ...
    * Sets job
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\JobDetail|null $job job
    *
    * @return $this
    */
