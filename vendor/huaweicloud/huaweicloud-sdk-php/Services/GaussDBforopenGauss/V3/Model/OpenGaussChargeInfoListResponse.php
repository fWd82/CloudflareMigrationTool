...
class OpenGaussChargeInfoListResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OpenGaussChargeInfoListResponse';
    ...
    * Sets chargeMode
    *
    * @param string $chargeMode 计费模式。  取值范围：  postPaid：后付费，即按需付费。  prePaid：预付费，即包年/包月。
    *
    * @return $this
    */
