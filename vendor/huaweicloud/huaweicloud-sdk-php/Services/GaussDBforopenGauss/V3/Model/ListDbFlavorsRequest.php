...
class ListDbFlavorsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDbFlavorsRequest';
    ...
    * version  数据库版本号。
    * specCode  规格编码
    * haMode  实例类型  集中式centralization_standard  分布式enterprise
    ...
    * Sets version
    *
    * @param string|null $version 数据库版本号。
    *
    * @return $this
    */
    ...
    * Sets haMode
    *
    * @param string|null $haMode 实例类型  集中式centralization_standard  分布式enterprise
    *
    * @return $this
    */
