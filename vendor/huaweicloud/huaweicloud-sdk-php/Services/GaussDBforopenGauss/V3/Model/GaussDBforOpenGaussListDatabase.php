...
class GaussDBforOpenGaussListDatabase implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GaussDBforOpenGaussListDatabase';
    ...
    * Sets size
    *
    * @param string|null $size 数据库大小（单位：MB）。
    *
    * @return $this
    */
