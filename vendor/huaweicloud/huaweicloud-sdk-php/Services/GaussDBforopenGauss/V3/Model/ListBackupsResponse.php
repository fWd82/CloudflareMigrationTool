...
class ListBackupsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'backups' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\Backups[]',
            'totalCount' => 'int'
    ];
    ...
    *  备份信息。
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\Backups[]|null
    */
    ...
    * Sets backups
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\Backups[]|null $backups 备份信息。
    *
    * @return $this
    */
