...
class IvsStandardByVideoAndIdCardImageResponseBodyResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IvsStandardByVideoAndIdCardImageResponseBody_result';
    ...
    */
    protected static $openAPITypes = [
            'serviceName' => 'string',
            'count' => 'int',
            'respData' => '\HuaweiCloud\SDK\Ivs\V2\Model\RespDataByVideoAndIdCardImage[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Ivs\V2\Model\RespDataByVideoAndIdCardImage[]
    */
    ...
    * Sets respData
    *
    * @param \HuaweiCloud\SDK\Ivs\V2\Model\RespDataByVideoAndIdCardImage[] $respData 请求列表，用于支持批量调用。目前暂时只支持单个数据查询。
    *
    * @return $this
    */
