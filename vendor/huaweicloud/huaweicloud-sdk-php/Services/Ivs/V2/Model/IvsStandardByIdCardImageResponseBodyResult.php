...
class IvsStandardByIdCardImageResponseBodyResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IvsStandardByIdCardImageResponseBody_result';
    ...
    */
    protected static $openAPITypes = [
            'serviceName' => 'string',
            'count' => 'int',
            'respData' => '\HuaweiCloud\SDK\Ivs\V2\Model\RespDataByIdCardImage[]'
    ];
