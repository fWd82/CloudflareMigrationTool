...
class IvsStandardByNameAndIdResponseBodyResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IvsStandardByNameAndIdResponseBody_result';
    ...
    */
    protected static $openAPITypes = [
            'serviceName' => 'string',
            'count' => 'int',
            'respData' => '\HuaweiCloud\SDK\Ivs\V2\Model\StandardRespDataByNameAndId[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Ivs\V2\Model\StandardRespDataByNameAndId[]
    */
    ...
    * Sets respData
    *
    * @param \HuaweiCloud\SDK\Ivs\V2\Model\StandardRespDataByNameAndId[] $respData 请求列表，用于支持批量调用。目前暂时只支持单个数据查询。
    *
    * @return $this
    */
