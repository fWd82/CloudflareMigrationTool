...
class IvsStandardByVideoAndNameAndIdResponseBodyResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IvsStandardByVideoAndNameAndIdResponseBody_result';
    ...
    */
    protected static $openAPITypes = [
            'serviceName' => 'string',
            'count' => 'int',
            'respData' => '\HuaweiCloud\SDK\Ivs\V2\Model\StandardRespDataByVideoAndNameAndId[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Ivs\V2\Model\StandardRespDataByVideoAndNameAndId[]
    */
    ...
    * Sets respData
    *
    * @param \HuaweiCloud\SDK\Ivs\V2\Model\StandardRespDataByVideoAndNameAndId[] $respData 请求列表，用于支持批量调用。目前暂时只支持单个数据查询。
    *
    * @return $this
    */
