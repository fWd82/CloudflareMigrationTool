...
class CreatePlaybookActionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePlaybookActionResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * code  Error code
    * message  Error message
    * data  list of informations of playbook action
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ActionInfo[]',
            'xRequestId' => 'string'
    ];
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ActionInfo[]|null $data list of informations of playbook action
    *
    * @return $this
    */
