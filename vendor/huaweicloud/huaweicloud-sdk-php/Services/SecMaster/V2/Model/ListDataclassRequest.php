...
class ListDataclassRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDataclassRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['workspaceId'] === null) {
            ...
            if (!is_null($this->container['businessCode']) && (mb_strlen($this->container['businessCode']) < 0)) {
                $invalidProperties[] = "invalid value for 'businessCode', the character length must be bigger than or equal to 0.";
            }
    ...
    * Sets businessCode
    *
    * @param string|null $businessCode 业务编码
    *
    * @return $this
    */
