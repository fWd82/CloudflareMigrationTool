...
class CreateIndicatorDetailDataSource implements ModelInterface, ArrayAccess
{
    ...
    * sourceType  current page count
    * domainId  Id value
    * projectId  Id value
    * regionId  Id value
    * productName  Id value
    * productFeature  Id value
    *
    * @var string[]
    */
    ...
    * Sets sourceType
    *
    * @param int $sourceType current page count
    *
    * @return $this
    */
    ...
    * Sets domainId
    *
    * @param string $domainId Id value
    *
    * @return $this
    */
    ...
    * Sets projectId
    *
    * @param string $projectId Id value
    *
    * @return $this
    */
    ...
    * Sets regionId
    *
    * @param string $regionId Id value
    *
    * @return $this
    */
    ...
    * Sets productName
    *
    * @param string $productName Id value
    *
    * @return $this
    */
    ...
    * Sets productFeature
    *
    * @param string $productFeature Id value
    *
    * @return $this
    */
