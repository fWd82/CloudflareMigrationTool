...
class CreatePlaybookApproveResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePlaybookApproveResponse';
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ApproveOpinionDetail',
            'xRequestId' => 'string'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ApproveOpinionDetail|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ApproveOpinionDetail|null $data data
    *
    * @return $this
    */
