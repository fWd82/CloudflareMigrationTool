...
class ListPlaybookVersionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPlaybookVersionsResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'page' => 'int',
            'total' => 'int',
            'data' => '\HuaweiCloud\SDK\SecMaster\V2\Model\PlaybookVersionListEntity[]',
            'xRequestId' => 'string'
    ];
    ...
    *  剧本版本列表信息
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\PlaybookVersionListEntity[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\PlaybookVersionListEntity[]|null $data 剧本版本列表信息
    *
    * @return $this
    */
