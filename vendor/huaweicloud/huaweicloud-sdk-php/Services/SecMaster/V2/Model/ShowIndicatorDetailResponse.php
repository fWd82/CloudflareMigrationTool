...
class ShowIndicatorDetailResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowIndicatorDetailResponse';
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\IndicatorDetail|null $data data
    *
    * @return $this
    */
