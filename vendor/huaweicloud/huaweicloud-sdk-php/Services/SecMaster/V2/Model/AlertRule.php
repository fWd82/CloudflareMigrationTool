...
class AlertRule implements ModelInterface, ArrayAccess
{
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['createBy'] === null) {
            ...
            if ((mb_strlen($this->container['createBy']) > 255)) {
        ...
        if ($this->container['updateBy'] === null) {
            ...
            if ((mb_strlen($this->container['updateBy']) > 255)) {
    ...
    * Sets pipeName
    *
    * @param string $pipeName 数据管道名称。Pipe name.
    *
    * @return $this
    */
    ...
    * Sets createBy
    *
    * @param string $createBy 创建人。Create by.
    *
    * @return $this
    */
    ...
    * Sets createTime
    *
    * @param int $createTime 创建时间。Create time.
    *
    * @return $this
    */
    ...
    * Sets updateBy
    *
    * @param string $updateBy 更新人。Update by.
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string $status 启用状态，启用、停用。Status, enabled, disabled.
    *
    * @return $this
    */
