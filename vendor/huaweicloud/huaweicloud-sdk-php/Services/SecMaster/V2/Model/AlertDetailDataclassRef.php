...
class AlertDetailDataclassRef implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AlertDetail_dataclass_ref';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  数据类唯一标识，UUID格式，最大36个字符
    * name  数据类名称
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param string|null $id 数据类唯一标识，UUID格式，最大36个字符
    *
    * @return $this
    */
