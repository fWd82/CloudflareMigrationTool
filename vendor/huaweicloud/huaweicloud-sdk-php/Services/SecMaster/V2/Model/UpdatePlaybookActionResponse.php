...
class UpdatePlaybookActionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePlaybookActionResponse';
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ActionInfo|null $data data
    *
    * @return $this
    */
