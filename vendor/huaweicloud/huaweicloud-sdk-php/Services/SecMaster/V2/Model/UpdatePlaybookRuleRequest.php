...
class UpdatePlaybookRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePlaybookRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'versionId' => 'string',
            'ruleId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ModifyRuleInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ModifyRuleInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ModifyRuleInfo|null $body body
    *
    * @return $this
    */
