...
class OperationPlaybookInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OperationPlaybookInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * operation  操作类型。重试： RETRY  终止： TERMINATE
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['operation']) && (mb_strlen($this->container['operation']) > 64)) {
    ...
    * Sets operation
    *
    * @param string|null $operation 操作类型。重试： RETRY  终止： TERMINATE
    *
    * @return $this
    */
