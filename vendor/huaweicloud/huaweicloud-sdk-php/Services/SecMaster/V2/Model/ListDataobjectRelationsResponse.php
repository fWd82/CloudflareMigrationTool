...
class ListDataobjectRelationsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDataobjectRelationsResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'offset' => 'int',
            'success' => 'bool',
            'data' => '\HuaweiCloud\SDK\SecMaster\V2\Model\DataObjectDetail[]',
            'xRequestId' => 'string'
    ];
    ...
    *  告警列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\DataObjectDetail[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\DataObjectDetail[]|null $data 告警列表
    *
    * @return $this
    */
