...
class ListPlaybookAuditLogsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPlaybookAuditLogsResponse';
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'auditLogs' => '\HuaweiCloud\SDK\SecMaster\V2\Model\AuditLogInfo[]',
            'xRequestId' => 'string'
    ];
    ...
    * Sets auditLogs
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\AuditLogInfo[]|null $auditLogs 审计日志列表信息
    *
    * @return $this
    */
