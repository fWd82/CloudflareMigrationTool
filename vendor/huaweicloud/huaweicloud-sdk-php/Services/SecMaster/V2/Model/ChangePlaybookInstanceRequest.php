...
class ChangePlaybookInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangePlaybookInstanceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\OperationPlaybookInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\OperationPlaybookInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\OperationPlaybookInfo|null $body body
    *
    * @return $this
    */
