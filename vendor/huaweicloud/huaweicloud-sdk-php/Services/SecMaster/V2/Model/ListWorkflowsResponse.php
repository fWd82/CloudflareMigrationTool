...
class ListWorkflowsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    */
    protected static $openAPITypes = [
            ...
            'message' => 'string',
            'success' => 'bool',
            'data' => '\HuaweiCloud\SDK\SecMaster\V2\Model\AopWorkflowInfo[]',
            'xRequestId' => 'string'
    ];
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['code']) && (mb_strlen($this->container['code']) > 1000)) {
            ...
            if (!is_null($this->container['message']) && (mb_strlen($this->container['message']) > 36)) {
                $invalidProperties[] = "invalid value for 'message', the character length must be smaller than or equal to 36.";
            }
    ...
    * Sets message
    *
    * @param string|null $message 请求ID
    *
    * @return $this
    */
    ...
    *  流程信息列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\AopWorkflowInfo[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\AopWorkflowInfo[]|null $data 流程信息列表
    *
    * @return $this
    */
