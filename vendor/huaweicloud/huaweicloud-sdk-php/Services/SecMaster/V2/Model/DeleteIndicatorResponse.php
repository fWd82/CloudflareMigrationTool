...
class DeleteIndicatorResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteIndicatorResponse';
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V2\Model\IndicatorBatchOperateResponse',
            'xRequestId' => 'string'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\IndicatorBatchOperateResponse|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\IndicatorBatchOperateResponse|null $data data
    *
    * @return $this
    */
