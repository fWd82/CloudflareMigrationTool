...
class ApproveOpinionDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ApproveOpinionDetail';
    ...
    * Sets content
    *
    * @param string|null $content 审核内容
    *
    * @return $this
    */
