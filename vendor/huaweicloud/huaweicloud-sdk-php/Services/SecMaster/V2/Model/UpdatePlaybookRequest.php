...
class UpdatePlaybookRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePlaybookRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'playbookId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ModifyPlaybookInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ModifyPlaybookInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ModifyPlaybookInfo|null $body body
    *
    * @return $this
    */
