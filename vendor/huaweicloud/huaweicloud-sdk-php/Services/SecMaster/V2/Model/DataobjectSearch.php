...
class DataobjectSearch implements ModelInterface, ArrayAccess
{
    ...
    *  condition
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\DataobjectSearchCondition|null
    */
    ...
    * Sets condition
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\DataobjectSearchCondition|null $condition condition
    *
    * @return $this
    */
