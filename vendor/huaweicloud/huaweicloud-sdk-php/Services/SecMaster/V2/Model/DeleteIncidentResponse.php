...
class DeleteIncidentResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteIncidentResponse';
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V2\Model\DeleteIncidentResponseBodyData',
            'xRequestId' => 'string'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\DeleteIncidentResponseBodyData|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\DeleteIncidentResponseBodyData|null $data data
    *
    * @return $this
    */
