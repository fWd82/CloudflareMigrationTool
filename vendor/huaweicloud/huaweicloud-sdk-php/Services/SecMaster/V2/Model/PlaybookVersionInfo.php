...
class PlaybookVersionInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PlaybookVersionInfo';
    ...
    * playbookId  剧本ID
    * version  版本号
    * enabled  是否启用。（true--已启用，false-未启用）
    ...
    */
    protected static $openAPITypes = [
            ...
            'ruleEnable' => 'bool',
            'rules' => '\HuaweiCloud\SDK\SecMaster\V2\Model\RuleInfo',
            'dataclassId' => 'string',
            'triggerType' => 'string',
    ...
    * Sets enabled
    *
    * @param bool|null $enabled 是否启用。（true--已启用，false-未启用）
    *
    * @return $this
    */
    ...
    * Sets actions
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ActionInfo[]|null $actions 剧本关联流程列表信息
    *
    * @return $this
    */
    ...
    *  rules
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\RuleInfo|null
    */
    ...
    * Sets rules
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\RuleInfo|null $rules rules
    *
    * @return $this
    */
    ...
    * Sets triggerType
    *
    * @param string|null $triggerType 剧本触发方式(EVENT--事件触发，TIMER--定时触发)
    *
    * @return $this
    */
    ...
    * Sets versionType
    *
    * @param int|null $versionType 版本类型（0--草稿版本，1--正式版本)
    *
    * @return $this
    */
