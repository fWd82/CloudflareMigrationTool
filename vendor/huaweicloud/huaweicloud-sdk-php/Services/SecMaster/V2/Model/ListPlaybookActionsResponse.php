...
class ListPlaybookActionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPlaybookActionsResponse';
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ActionInfo[]|null $data 剧本动作列表信息
    *
    * @return $this
    */
