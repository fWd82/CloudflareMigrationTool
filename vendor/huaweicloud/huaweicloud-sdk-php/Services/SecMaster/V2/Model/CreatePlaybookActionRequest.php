...
class CreatePlaybookActionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePlaybookActionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'versionId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\CreateAction[]'
    ];
    ...
    *  Create actions
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\CreateAction[]|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\CreateAction[]|null $body Create actions
    *
    * @return $this
    */
