...
class ListIncidentsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\IncidentDetail[]|null $data 事件列表
    *
    * @return $this
    */
