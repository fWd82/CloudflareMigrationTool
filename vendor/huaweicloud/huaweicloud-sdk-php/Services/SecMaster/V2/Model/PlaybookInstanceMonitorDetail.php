...
class PlaybookInstanceMonitorDetail implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'minRunTimeInstance' => '\HuaweiCloud\SDK\SecMaster\V2\Model\PlaybookInstanceRunStatistics',
            'maxRunTimeInstance' => '\HuaweiCloud\SDK\SecMaster\V2\Model\PlaybookInstanceRunStatistics',
    ...
    *  minRunTimeInstance
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\PlaybookInstanceRunStatistics|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\PlaybookInstanceRunStatistics|null $minRunTimeInstance minRunTimeInstance
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\PlaybookInstanceRunStatistics|null $maxRunTimeInstance maxRunTimeInstance
    *
    * @return $this
    */
