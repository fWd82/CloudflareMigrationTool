...
class IndicatorDataObjectDetailEnvironment implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IndicatorDataObjectDetail_environment';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * vendorType  环境供应商（如HWC,AWS,Azure等）
    * domainId  租户ID
    * regionId  区域ID
    * projectId  项目ID
    *
    ...
    * Sets vendorType
    *
    * @param string|null $vendorType 环境供应商（如HWC,AWS,Azure等）
    *
    * @return $this
    */
