...
class ShowAlertRspDatasource implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAlertRsp_datasource';
    ...
    * Sets sourceType
    *
    * @param int|null $sourceType current page count
    *
    * @return $this
    */
