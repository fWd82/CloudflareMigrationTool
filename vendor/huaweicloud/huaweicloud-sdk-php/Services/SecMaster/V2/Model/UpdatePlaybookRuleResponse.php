...
class UpdatePlaybookRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePlaybookRuleResponse';
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V2\Model\RuleInfo',
            'xRequestId' => 'string'
    ];
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\RuleInfo|null $data data
    *
    * @return $this
    */
