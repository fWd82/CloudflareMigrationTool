...
class CreateIndicatorRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateIndicatorRequest';
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'workspaceId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\IndicatorCreateRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\IndicatorCreateRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\IndicatorCreateRequest|null $body body
    *
    * @return $this
    */
