...
class ListAlertRulesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAlertRulesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * count  总数量。Total count.
    * records  告警模型。Alert rules.
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'records' => '\HuaweiCloud\SDK\SecMaster\V2\Model\AlertRule[]',
            'xRequestId' => 'string'
    ];
    ...
    * Sets records
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\AlertRule[]|null $records 告警模型。Alert rules.
    *
    * @return $this
    */
