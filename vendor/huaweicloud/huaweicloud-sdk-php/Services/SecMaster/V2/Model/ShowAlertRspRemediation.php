...
class ShowAlertRspRemediation implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAlertRsp_remediation';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * recommendation  The name, display only
    * url  The name, display only
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['recommendation']) && (mb_strlen($this->container['recommendation']) > 1024)) {
                $invalidProperties[] = "invalid value for 'recommendation', the character length must be smaller than or equal to 1024.";
            }
    ...
    * Sets recommendation
    *
    * @param string|null $recommendation The name, display only
    *
    * @return $this
    */
    ...
    * Sets url
    *
    * @param string|null $url The name, display only
    *
    * @return $this
    */
