...
class ListDataclassFieldsResponse implements ModelInterface, ArrayAccess
{
    ...
    * fieldDetails  list of informations of field
    * total  数据总量
    ...
    */
    protected static $openAPITypes = [
            'fieldDetails' => '\HuaweiCloud\SDK\SecMaster\V2\Model\FieldResponseBody[]',
            'total' => 'float',
            'xRequestId' => 'string'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\FieldResponseBody[]|null
    */
    ...
    * Sets fieldDetails
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\FieldResponseBody[]|null $fieldDetails list of informations of field
    *
    * @return $this
    */
