...
class ListPlaybookApprovesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPlaybookApprovesRequest';
    ...
    * workspaceId  工作空间ID
    * resourceId  资源ID
    * approveType  审核类型。（PLAYBOOK-剧本, AOP_WORKFLOW--流程)
    *
    * @var string[]
    */
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['approveType'] = isset($data['approveType']) ? $data['approveType'] : null;
    }
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['workspaceId'] === null) {
            ...
            if (!is_null($this->container['approveType']) && (mb_strlen($this->container['approveType']) > 64)) {
                $invalidProperties[] = "invalid value for 'approveType', the character length must be smaller than or equal to 64.";
            }
            if (!is_null($this->container['approveType']) && (mb_strlen($this->container['approveType']) < 0)) {
                $invalidProperties[] = "invalid value for 'approveType', the character length must be bigger than or equal to 0.";
            }
    ...
    */
    ...
    {
        return $this->container['approveType'];
    }

    /**
    * Sets approveType
    *
    * @param string|null $approveType 审核类型。（PLAYBOOK-剧本, AOP_WORKFLOW--流程)
    *
    * @return $this
    */
    public function setApproveType($approveType)
    {
        $this->container['approveType'] = $approveType;
        return $this;
    }
