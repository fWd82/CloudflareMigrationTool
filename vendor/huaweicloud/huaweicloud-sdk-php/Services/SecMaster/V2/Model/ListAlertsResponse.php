...
class ListAlertsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'offset' => 'int',
            'success' => 'bool',
            'data' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ListAlertDetail[]',
            'xRequestId' => 'string'
    ];
    ...
    *  告警列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ListAlertDetail[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ListAlertDetail[]|null $data 告警列表
    *
    * @return $this
    */
