...
class CreatePlaybookVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePlaybookVersionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'playbookId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\CreatePlaybookVersionInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\CreatePlaybookVersionInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\CreatePlaybookVersionInfo|null $body body
    *
    * @return $this
    */
