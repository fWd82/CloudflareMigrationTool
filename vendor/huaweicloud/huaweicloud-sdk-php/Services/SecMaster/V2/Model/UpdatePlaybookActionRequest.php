...
class UpdatePlaybookActionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePlaybookActionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'versionId' => 'string',
            'actionId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ModifyActionInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ModifyActionInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ModifyActionInfo|null $body body
    *
    * @return $this
    */
