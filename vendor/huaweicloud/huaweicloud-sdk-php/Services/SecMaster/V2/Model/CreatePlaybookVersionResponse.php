...
class CreatePlaybookVersionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePlaybookVersionResponse';
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V2\Model\PlaybookVersionInfo',
            'xRequestId' => 'string'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\PlaybookVersionInfo|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\PlaybookVersionInfo|null $data data
    *
    * @return $this
    */
