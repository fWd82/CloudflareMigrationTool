...
class IncidentDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IncidentDetail';
    ...
    * projectId  当前项目的id
    * updateTime  更新时间，格式ISO8601：YYYY-MM-DDTHH:mm:ss.ms+timezone。时区信息为告警发生时区，无法解析时区的时间，默认时区填东八区
    * version  版本
    ...
    */
    protected static $openAPITypes = [
            'createTime' => 'string',
            'dataObject' => '\HuaweiCloud\SDK\SecMaster\V2\Model\Incident',
    ...
    *  dataObject
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\Incident|null
    */
    ...
    * Sets dataObject
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\Incident|null $dataObject dataObject
    *
    * @return $this
    */
    ...
    * Sets updateTime
    *
    * @param string|null $updateTime 更新时间，格式ISO8601：YYYY-MM-DDTHH:mm:ss.ms+timezone。时区信息为告警发生时区，无法解析时区的时间，默认时区填东八区
    *
    * @return $this
    */
