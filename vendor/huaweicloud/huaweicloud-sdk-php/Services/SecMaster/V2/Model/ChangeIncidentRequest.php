...
class ChangeIncidentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeIncidentRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'incidentId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ChangeIncidentRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['incidentId'] === null) {
            ...
            if ((mb_strlen($this->container['incidentId']) > 36)) {
                $invalidProperties[] = "invalid value for 'incidentId', the character length must be smaller than or equal to 36.";
            }
            if ((mb_strlen($this->container['incidentId']) < 32)) {
                $invalidProperties[] = "invalid value for 'incidentId', the character length must be bigger than or equal to 32.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ChangeIncidentRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ChangeIncidentRequestBody|null $body body
    *
    * @return $this
    */
