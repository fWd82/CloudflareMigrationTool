...
class CreatePlaybookInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePlaybookInfo';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['workspaceId'] === null) {
            ...
            if ((mb_strlen($this->container['workspaceId']) > 2097152)) {
