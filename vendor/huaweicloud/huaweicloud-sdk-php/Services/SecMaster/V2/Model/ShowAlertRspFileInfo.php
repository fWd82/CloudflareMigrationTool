...
class ShowAlertRspFileInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAlertRsp_file_info';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * filePath  The name, display only
    * fileContent  The name, display only
    * fileNewPath  The name, display only
    * fileHash  The name, display only
    * fileMd5  The name, display only
    * fileSha256  The name, display only
    * fileAttr  The name, display only
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['fileNewPath']) && (mb_strlen($this->container['fileNewPath']) > 1024)) {
                $invalidProperties[] = "invalid value for 'fileNewPath', the character length must be smaller than or equal to 1024.";
            }
            if (!is_null($this->container['fileNewPath']) && (mb_strlen($this->container['fileNewPath']) < 0)) {
                $invalidProperties[] = "invalid value for 'fileNewPath', the character length must be bigger than or equal to 0.";
            }
            if (!is_null($this->container['fileHash']) && (mb_strlen($this->container['fileHash']) > 1024)) {
                $invalidProperties[] = "invalid value for 'fileHash', the character length must be smaller than or equal to 1024.";
            }
            ...
            if (!is_null($this->container['fileMd5']) && (mb_strlen($this->container['fileMd5']) > 1024)) {
                $invalidProperties[] = "invalid value for 'fileMd5', the character length must be smaller than or equal to 1024.";
            }
            ...
            if (!is_null($this->container['fileSha256']) && (mb_strlen($this->container['fileSha256']) > 1024)) {
                $invalidProperties[] = "invalid value for 'fileSha256', the character length must be smaller than or equal to 1024.";
            }
    ...
    * Sets filePath
    *
    * @param string|null $filePath The name, display only
    *
    * @return $this
    */
    ...
    * Sets fileContent
    *
    * @param string|null $fileContent The name, display only
    *
    * @return $this
    */
    ...
    * Sets fileNewPath
    *
    * @param string|null $fileNewPath The name, display only
    *
    * @return $this
    */
    ...
    * Sets fileHash
    *
    * @param string|null $fileHash The name, display only
    *
    * @return $this
    */
    ...
    * Sets fileMd5
    *
    * @param string|null $fileMd5 The name, display only
    *
    * @return $this
    */
    ...
    * Sets fileSha256
    *
    * @param string|null $fileSha256 The name, display only
    *
    * @return $this
    */
    ...
    * Sets fileAttr
    *
    * @param string|null $fileAttr The name, display only
    *
    * @return $this
    */
