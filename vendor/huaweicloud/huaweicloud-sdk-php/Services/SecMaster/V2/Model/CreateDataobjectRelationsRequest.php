...
class CreateDataobjectRelationsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDataobjectRelationsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * contentType  内容类型
    * workspaceId  工作空间id
    * dataclassType  关联主体dataobject所属数据类，小写复数，如告警为alerts，事件为incidents
    * dataObjectId  关联主体dataobject的id
    * relatedDataclassType  被关联的dataobject所属数据类，小写复数，如告警为alerts，事件为incidents
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\CreateDataobjectRelationsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\CreateDataobjectRelationsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\CreateDataobjectRelationsRequestBody|null $body body
    *
    * @return $this
    */
