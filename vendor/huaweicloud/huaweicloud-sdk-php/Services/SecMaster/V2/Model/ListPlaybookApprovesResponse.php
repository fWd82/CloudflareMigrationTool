...
class ListPlaybookApprovesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPlaybookApprovesResponse';
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ApproveOpinionDetail[]|null $data 剧本审核详情
    *
    * @return $this
    */
