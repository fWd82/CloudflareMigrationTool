...
class Network implements ModelInterface, ArrayAccess
{
    ...
    * srcGeo  srcGeo
    * destIp  目标IP地址。
    * destPort  目标端口，0–65535。
    * destDomain  目标域名，最大128个字符。
    * destGeo  destGeo
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'srcPort' => 'int',
            'srcDomain' => 'string',
            'srcGeo' => '\HuaweiCloud\SDK\SecMaster\V1\Model\Geo',
            'destIp' => 'string',
            'destPort' => 'int',
            'destDomain' => 'string',
            'destGeo' => '\HuaweiCloud\SDK\SecMaster\V1\Model\Geo'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['direction']) && (mb_strlen($this->container['direction']) < 2)) {
                $invalidProperties[] = "invalid value for 'direction', the character length must be bigger than or equal to 2.";
            }
            ...
            if (!is_null($this->container['srcIp']) && (mb_strlen($this->container['srcIp']) > 15)) {
                $invalidProperties[] = "invalid value for 'srcIp', the character length must be smaller than or equal to 15.";
            }
            if (!is_null($this->container['srcIp']) && (mb_strlen($this->container['srcIp']) < 7)) {
                $invalidProperties[] = "invalid value for 'srcIp', the character length must be bigger than or equal to 7.";
            }
            ...
            if (!is_null($this->container['srcDomain']) && (mb_strlen($this->container['srcDomain']) < 1)) {
                $invalidProperties[] = "invalid value for 'srcDomain', the character length must be bigger than or equal to 1.";
            }
            if (!is_null($this->container['destIp']) && (mb_strlen($this->container['destIp']) > 15)) {
                $invalidProperties[] = "invalid value for 'destIp', the character length must be smaller than or equal to 15.";
            }
            if (!is_null($this->container['destIp']) && (mb_strlen($this->container['destIp']) < 7)) {
                $invalidProperties[] = "invalid value for 'destIp', the character length must be bigger than or equal to 7.";
            }
            if (!is_null($this->container['destPort']) && ($this->container['destPort'] > 65535)) {
                $invalidProperties[] = "invalid value for 'destPort', must be smaller than or equal to 65535.";
            }
            if (!is_null($this->container['destPort']) && ($this->container['destPort'] < 0)) {
                $invalidProperties[] = "invalid value for 'destPort', must be bigger than or equal to 0.";
            }
            ...
            if (!is_null($this->container['destDomain']) && (mb_strlen($this->container['destDomain']) < 1)) {
                $invalidProperties[] = "invalid value for 'destDomain', the character length must be bigger than or equal to 1.";
            }
    ...
    *  srcGeo
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\Geo|null
    */
    ...
    * Sets srcGeo
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\Geo|null $srcGeo srcGeo
    *
    * @return $this
    */
    ...
    * Sets destIp
    *
    * @param string|null $destIp 目标IP地址。
    *
    * @return $this
    */
    ...
    * Sets destPort
    *
    * @param int|null $destPort 目标端口，0–65535。
    *
    * @return $this
    */
    ...
    * Sets destDomain
    *
    * @param string|null $destDomain 目标域名，最大128个字符。
    *
    * @return $this
    */
    ...
    * Sets destGeo
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\Geo|null $destGeo destGeo
    *
    * @return $this
    */
