...
class Geo implements ModelInterface, ArrayAccess
{
    ...
    * longitude  经度。
    * cityCode  城市编码。
    * countryCode  国家简码ISO 3166-1 alpha-2，例如：CN、US、DE、IT、SG。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['cityCode']) && (mb_strlen($this->container['cityCode']) > 128)) {
                $invalidProperties[] = "invalid value for 'cityCode', the character length must be smaller than or equal to 128.";
            }
            if (!is_null($this->container['cityCode']) && (mb_strlen($this->container['cityCode']) < 1)) {
                $invalidProperties[] = "invalid value for 'cityCode', the character length must be bigger than or equal to 1.";
            }
    ...
    * Sets countryCode
    *
    * @param string|null $countryCode 国家简码ISO 3166-1 alpha-2，例如：CN、US、DE、IT、SG。
    *
    * @return $this
    */
