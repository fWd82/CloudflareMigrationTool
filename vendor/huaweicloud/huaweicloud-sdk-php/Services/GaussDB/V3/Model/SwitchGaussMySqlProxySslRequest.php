...
class SwitchGaussMySqlProxySslRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SwitchGaussMySqlProxySslRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'proxyId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\SwitchProxySSLRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\SwitchProxySSLRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\SwitchProxySSLRequest|null $body body
    *
    * @return $this
    */
