...
class DeleteGaussMySqlReadonlyNodeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteGaussMySqlReadonlyNodeRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  语言。
    * instanceId  实例ID，严格匹配UUID规则。
    * nodeId  节点ID，严格匹配UUID规则。
    *
    * @var string[]
    */
