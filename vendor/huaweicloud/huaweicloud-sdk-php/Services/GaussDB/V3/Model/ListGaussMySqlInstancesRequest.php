...
class ListGaussMySqlInstancesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGaussMySqlInstancesRequest';
    ...
    * Sets privateIp
    *
    * @param string|null $privateIp 读写内网IP。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $readonlyPrivateIp 读内网IP。
    *
    * @return $this
    */
    ...
    * Sets proxyIp
    *
    * @param string|null $proxyIp 读写分离IP。
    *
    * @return $this
    */
