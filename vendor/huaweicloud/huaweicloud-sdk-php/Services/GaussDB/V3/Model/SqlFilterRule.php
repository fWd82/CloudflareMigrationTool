...
class SqlFilterRule implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SqlFilterRule';
    ...
    */
    protected static $openAPITypes = [
            'sqlType' => 'string',
            'patterns' => '\HuaweiCloud\SDK\GaussDB\V3\Model\SqlFilterRulePattern[]'
    ];
    ...
    *  SQL限流具体规则。
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\SqlFilterRulePattern[]
    */
    ...
    * Sets patterns
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\SqlFilterRulePattern[] $patterns SQL限流具体规则。
    *
    * @return $this
    */
