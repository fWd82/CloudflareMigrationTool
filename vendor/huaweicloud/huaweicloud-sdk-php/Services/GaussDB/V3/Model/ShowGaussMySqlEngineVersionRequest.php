...
class ShowGaussMySqlEngineVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowGaussMySqlEngineVersionRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  语言。
    * databaseName  数据库引擎。支持的引擎如下，不区分大小写：gaussdb-mysql。
    *
    * @var string[]
    */
