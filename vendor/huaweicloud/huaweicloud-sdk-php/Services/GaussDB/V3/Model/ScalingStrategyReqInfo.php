...
class ScalingStrategyReqInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ScalingStrategyReqInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * flavorSwitch  扩缩规格开关。 - ON：开启。 - OFF：关闭。
    * readOnlySwitch  增删只读节点开关。自动增删只读节点功能需要先[开启数据库代理](https://support.huaweicloud.com/api-gaussdbformysql/CreateGaussMySqlProxy.html)，且只能有一个代理。 - ON：开启。 - OFF：关闭。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['flavorSwitch'] === null) {
            $invalidProperties[] = "'flavorSwitch' can't be null";
        }
        if ($this->container['readOnlySwitch'] === null) {
            $invalidProperties[] = "'readOnlySwitch' can't be null";
        }
    ...
    * Sets flavorSwitch
    *
    * @param string $flavorSwitch 扩缩规格开关。 - ON：开启。 - OFF：关闭。
    *
    * @return $this
    */
    ...
    * Sets readOnlySwitch
    *
    * @param string $readOnlySwitch 增删只读节点开关。自动增删只读节点功能需要先[开启数据库代理](https://support.huaweicloud.com/api-gaussdbformysql/CreateGaussMySqlProxy.html)，且只能有一个代理。 - ON：开启。 - OFF：关闭。
    *
    * @return $this
    */
