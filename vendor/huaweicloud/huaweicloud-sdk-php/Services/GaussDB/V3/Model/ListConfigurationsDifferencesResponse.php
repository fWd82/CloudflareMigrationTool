...
class ListConfigurationsDifferencesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListConfigurationsDifferencesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * differences  参数之间的区别集合。
    *
    * @var string[]
    */
    ...
    * Sets differences
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\ParamGroupParameterDifferences[]|null $differences 参数之间的区别集合。
    *
    * @return $this
    */
