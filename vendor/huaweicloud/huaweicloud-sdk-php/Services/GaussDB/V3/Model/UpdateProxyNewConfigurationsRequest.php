...
class UpdateProxyNewConfigurationsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProxyNewConfigurationsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'proxyId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\UpdateProxyNewConfigRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\UpdateProxyNewConfigRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\UpdateProxyNewConfigRequestBody|null $body body
    *
    * @return $this
    */
