...
class LtsLogSlowQueryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LtsLogSlowQueryRequest';
    ...
    * operateType  SQL语句类型，取空值，表示查询所有语句类型，也可指定如下日志类型： - INSERT - UPDATE - SELECT - DELETE - ALTER - DROP - CREATE
    * database  所属数据库。
    *
    * @var string[]
    */
    ...
    * Sets startTime
    *
    * @param string $startTime 开始时间，格式为“yyyy-mm-ddThh:mm:ssZ”。  其中，T指某个时间的开始；Z指时区偏移量，例如偏移1个小时显示为+0100。
    *
    * @return $this
    */
    ...
    * Sets lineNum
    *
    * @param string|null $lineNum 日志单行序列号，第一次查询时不需要此参数,后续分页查询时需要使用,可从上次查询的返回信息中获取。
    *
    * @return $this
    */
    ...
    * Sets operateType
    *
    * @param string|null $operateType SQL语句类型，取空值，表示查询所有语句类型，也可指定如下日志类型： - INSERT - UPDATE - SELECT - DELETE - ALTER - DROP - CREATE
    *
    * @return $this
    */
