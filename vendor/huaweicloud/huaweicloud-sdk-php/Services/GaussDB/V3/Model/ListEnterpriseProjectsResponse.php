...
class ListEnterpriseProjectsResponse implements ModelInterface, ArrayAccess
{
    ...
    * enterpriseProjects  企业项目信息列表。
    * totalCount  总数。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'enterpriseProjects' => '\HuaweiCloud\SDK\GaussDB\V3\Model\EnterpriseProjectItem[]',
            'totalCount' => 'int'
    ];
    ...
    *  企业项目信息列表。
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\EnterpriseProjectItem[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\EnterpriseProjectItem[]|null $enterpriseProjects 企业项目信息列表。
    *
    * @return $this
    */
