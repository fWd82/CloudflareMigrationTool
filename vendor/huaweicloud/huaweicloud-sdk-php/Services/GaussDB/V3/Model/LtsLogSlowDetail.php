...
class LtsLogSlowDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LtsLogSlowDetail';
    ...
    * Sets lockTime
    *
    * @param string|null $lockTime 等待锁时间。
    *
    * @return $this
    */
    ...
    * Sets rowsSent
    *
    * @param string|null $rowsSent 结果行数量。
    *
    * @return $this
    */
    ...
    * Sets rowsExamined
    *
    * @param string|null $rowsExamined 扫描的行数量。
    *
    * @return $this
    */
