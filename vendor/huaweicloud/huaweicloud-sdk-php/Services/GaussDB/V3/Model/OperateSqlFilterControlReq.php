...
class OperateSqlFilterControlReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OperateSqlFilterControlReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * switchStatus  SQL限流开关状态。 取值： - ON，表示开启。 - OFF，表示关闭。
    *
    * @var string[]
    */
    ...
    * Sets switchStatus
    *
    * @param string $switchStatus SQL限流开关状态。 取值： - ON，表示开启。 - OFF，表示关闭。
    *
    * @return $this
    */
