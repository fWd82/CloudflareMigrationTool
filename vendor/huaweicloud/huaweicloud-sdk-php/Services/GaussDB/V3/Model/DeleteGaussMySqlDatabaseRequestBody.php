...
class DeleteGaussMySqlDatabaseRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteGaussMySqlDatabaseRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * databases  准备删除的数据库列表，列表最大长度为50。
    *
    * @var string[]
    */
    ...
    * Sets databases
    *
    * @param string[] $databases 准备删除的数据库列表，列表最大长度为50。
    *
    * @return $this
    */
