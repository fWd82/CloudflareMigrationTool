...
class MysqlUpdateBackupPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MysqlUpdateBackupPolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            'backupPolicy' => '\HuaweiCloud\SDK\GaussDB\V3\Model\MysqlBackupPolicy'
    ];
    ...
    *  backupPolicy
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\MysqlBackupPolicy
    */
    ...
    * Sets backupPolicy
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\MysqlBackupPolicy $backupPolicy backupPolicy
    *
    * @return $this
    */
