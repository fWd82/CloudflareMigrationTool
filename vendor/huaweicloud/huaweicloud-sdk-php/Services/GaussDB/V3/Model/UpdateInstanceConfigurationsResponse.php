...
class UpdateInstanceConfigurationsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInstanceConfigurationsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * jobId  修改指定实例参数的任务ID。
    * restartRequired  是否需要重启。  - true：是。 - false：否。
    *
    * @var string[]
    */
    ...
    *
    * @param bool|null $restartRequired 是否需要重启。  - true：是。 - false：否。
    *
    * @return $this
    */
