...
class CreateAccessControlResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAccessControlResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * openAccessControl  是否已开启访问控制。 取值： - true：开启。 - false：关闭。
    *
    * @var string[]
    */
    ...
    *
    * @param bool|null $openAccessControl 是否已开启访问控制。 取值： - true：开启。 - false：关闭。
    *
    * @return $this
    */
