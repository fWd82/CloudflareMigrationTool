...
class GetJobInfoDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetJobInfoDetail';
    ...
    * ended  结束时间，格式为\"yyyy-mm-ddThh:mm:ssZ\"。 其中，T指某个时间的开始；Z指时区偏移量，例如偏移1个小时显示为+0100。  说明：创建时返回值为空，数据库实例创建成功后该值不为空。
    ...
    */
    protected static $openAPITypes = [
            ...
            'ended' => 'string',
            'process' => 'string',
            'instance' => '\HuaweiCloud\SDK\GaussDB\V3\Model\GetJobInstanceInfoDetail',
            'entities' => '\HuaweiCloud\SDK\GaussDB\V3\Model\GetJobEntitiesInfoDetail',
            'failReason' => 'string'
    ];
    ...
    * Sets status
    *
    * @param string $status 任务执行状态。  取值： - 值为“Pending”，表示延时任务，未执行。 - 值为“Running”，表示任务正在执行。 - 值为“Completed”，表示任务执行成功。 - 值为“Failed”，表示任务执行失败。
    *
    * @return $this
    */
    ...
    * Sets ended
    *
    * @param string|null $ended 结束时间，格式为\"yyyy-mm-ddThh:mm:ssZ\"。 其中，T指某个时间的开始；Z指时区偏移量，例如偏移1个小时显示为+0100。  说明：创建时返回值为空，数据库实例创建成功后该值不为空。
    *
    * @return $this
    */
    ...
    *  instance
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\GetJobInstanceInfoDetail
    */
    ...
    * Sets instance
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\GetJobInstanceInfoDetail $instance instance
    *
    * @return $this
    */
    ...
    *  entities
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\GetJobEntitiesInfoDetail|null
    */
    ...
    * Sets entities
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\GetJobEntitiesInfoDetail|null $entities entities
    *
    * @return $this
    */
