...
class ModifyDnsNameReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyDnsNameReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dnsName  新域名的前缀，取值范围如下：8~63个字符之间，可以包含小写字母、数字，不能包含其他特殊字符。
    *
    * @var string[]
    */
    ...
    * Sets dnsName
    *
    * @param string $dnsName 新域名的前缀，取值范围如下：8~63个字符之间，可以包含小写字母、数字，不能包含其他特殊字符。
    *
    * @return $this
    */
