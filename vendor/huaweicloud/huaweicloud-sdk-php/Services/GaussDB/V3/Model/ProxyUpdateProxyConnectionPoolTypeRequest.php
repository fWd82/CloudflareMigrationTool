...
class ProxyUpdateProxyConnectionPoolTypeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProxyUpdateProxyConnectionPoolTypeRequest';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['connectionPoolType'] === null) {
            $invalidProperties[] = "'connectionPoolType' can't be null";
        }
