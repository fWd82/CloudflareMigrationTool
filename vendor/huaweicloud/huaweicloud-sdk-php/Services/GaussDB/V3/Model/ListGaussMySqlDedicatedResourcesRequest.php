...
class ListGaussMySqlDedicatedResourcesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGaussMySqlDedicatedResourcesRequest';
