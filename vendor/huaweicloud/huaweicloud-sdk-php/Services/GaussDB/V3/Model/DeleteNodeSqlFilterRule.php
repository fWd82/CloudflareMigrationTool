...
class DeleteNodeSqlFilterRule implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteNodeSqlFilterRule';
    ...
    * Sets patterns
    *
    * @param string[] $patterns SQL限流具体规则。
    *
    * @return $this
    */
