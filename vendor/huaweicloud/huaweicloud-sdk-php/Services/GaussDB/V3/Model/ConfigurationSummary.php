...
class ConfigurationSummary implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ConfigurationSummary';
    ...
    *
    * @param string $datastoreVersionName 引擎版本。
    *
    * @return $this
    */
    ...
    * Sets datastoreName
    *
    * @param string $datastoreName 引擎名。
    *
    * @return $this
    */
    ...
    * Sets created
    *
    * @param string $created 创建时间，格式为\"yyyy-MM-ddTHH:mm:ssZ\"。  其中，T指某个时间的开始；Z指时区偏移量，例如偏移1个小时显示为+0100。
    *
    * @return $this
    */
    ...
    * Sets updated
    *
    * @param string $updated 更新时间，格式为\"yyyy-MM-ddTHH:mm:ssZ\"。  其中，T指某个时间的开始；Z指时区偏移量，例如偏移1个小时显示为+0100。
    *
    * @return $this
    */
