...
class ShowSqlFilterControlResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSqlFilterControlResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * switchStatus  sql限流开关状态。  取值：  - ON：已开启 - OFF：已关闭
    *
    * @var string[]
    */
    ...
    * Sets switchStatus
    *
    * @param string|null $switchStatus sql限流开关状态。  取值：  - ON：已开启 - OFF：已关闭
    *
    * @return $this
    */
