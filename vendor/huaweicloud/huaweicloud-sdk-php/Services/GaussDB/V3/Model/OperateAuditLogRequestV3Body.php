...
class OperateAuditLogRequestV3Body implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OperateAuditLogRequestV3Body';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * switchStatus  全量SQL开关状态。 取值： - ON，表示开启 - OFF，表示关闭
    *
    * @var string[]
    */
    ...
    * Sets switchStatus
    *
    * @param string $switchStatus 全量SQL开关状态。 取值： - ON，表示开启 - OFF，表示关闭
    *
    * @return $this
    */
