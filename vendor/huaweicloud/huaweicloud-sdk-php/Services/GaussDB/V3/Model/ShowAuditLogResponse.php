...
class ShowAuditLogResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAuditLogResponse';
    ...
    * Sets switchStatus
    *
    * @param string|null $switchStatus 全量SQL开关状态。 取值： - ON，表示开启 - OFF，表示关闭
    *
    * @return $this
    */
