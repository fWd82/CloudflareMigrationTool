...
class ListGaussMySqlInstanceDetailInfoUnifyStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGaussMySqlInstanceDetailInfoUnifyStatusRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  请求语言类型。默认en-us。 取值范围： - en-us - zh-cn
    * instanceIds  实例ID，严格匹配UUID规则。最多同时输入20个实例ID，用英文逗号分隔。
    *
    * @var string[]
    */
