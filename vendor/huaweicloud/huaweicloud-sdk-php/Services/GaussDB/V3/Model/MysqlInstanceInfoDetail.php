...
class MysqlInstanceInfoDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MysqlInstanceInfoDetail';
    ...
    * status  实例状态。  取值： - 值为“BUILD”，表示实例正在创建。 - 值为“ACTIVE”，表示实例正常。 - 值为“FAILED”，表示实例创建失败。 - 值为“FROZEN”，表示实例冻结。 - 值为“MODIFYING”，表示实例正在扩容。 - 值为“REBOOTING”，表示实例正在重启。 - 值为“RESTORING”，表示实例正在恢复。 - 值为“SWITCHOVER”，表示实例正在主备切换。 - 值为“MIGRATING”，表示实例正在迁移。 - 值为“BACKING UP”，表示实例正在进行备份。 - 值为“MODIFYING DATABASE PORT”，表示实例正在修改数据库端口。 - 值为“STORAGE FULL”，表示实例磁盘空间满。
    * port  数据库端口号。
    * alias  实例备注
    ...
    * timeZone  时区。
    * azMode  可用区模式，单可用区single或多可用区multi。
    * masterAzCode  主可用区。
    ...
    *
    * @param string[]|null $privateWriteIps 实例的写内网IP。
    *
    * @return $this
    */
    ...
    * Sets publicIps
    *
    * @param string|null $publicIps 实例的公网IP。
    *
    * @return $this
    */
    ...
    * Sets nodes
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\MysqlInstanceNodeInfo[]|null $nodes nodes
    *
    * @return $this
    */
    ...
    * Sets azMode
    *
    * @param string|null $azMode 可用区模式，单可用区single或多可用区multi。
    *
    * @return $this
    */
    ...
    * Sets proxies
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\MysqlProxyInfo[]|null $proxies proxies
    *
    * @return $this
    */
