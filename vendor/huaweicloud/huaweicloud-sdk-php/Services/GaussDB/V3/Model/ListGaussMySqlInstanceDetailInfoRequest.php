...
class ListGaussMySqlInstanceDetailInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGaussMySqlInstanceDetailInfoRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  语言。默认英语。
    * instanceIds  实例ID。最多同时输入20个实例ID，用英文逗号分隔。
    *
    * @var string[]
    */
    ...
    * Sets xLanguage
    *
    * @param string|null $xLanguage 语言。默认英语。
    *
    * @return $this
    */
