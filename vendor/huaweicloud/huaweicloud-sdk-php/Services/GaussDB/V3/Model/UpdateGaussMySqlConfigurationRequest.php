...
class UpdateGaussMySqlConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGaussMySqlConfigurationRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\UpdateConfigurationParameterRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\UpdateConfigurationParameterRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\UpdateConfigurationParameterRequestBody|null $body body
    *
    * @return $this
    */
