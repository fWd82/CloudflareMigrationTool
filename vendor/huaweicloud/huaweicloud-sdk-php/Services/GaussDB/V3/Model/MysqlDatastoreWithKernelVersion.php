...
class MysqlDatastoreWithKernelVersion implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MysqlDatastoreWithKernelVersion';
    ...
    * Sets kernelVersion
    *
    * @param string $kernelVersion 数据库内核版本
    *
    * @return $this
    */
