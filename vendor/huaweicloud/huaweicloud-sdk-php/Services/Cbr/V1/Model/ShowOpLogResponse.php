...
class ShowOpLogResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowOpLogResponse';
    ...
    */
    protected static $openAPITypes = [
            'operationLog' => '\HuaweiCloud\SDK\Cbr\V1\Model\OperationLog'
    ];
    ...
    * Sets operationLog
    *
    * @param \HuaweiCloud\SDK\Cbr\V1\Model\OperationLog|null $operationLog operationLog
    *
    * @return $this
    */
