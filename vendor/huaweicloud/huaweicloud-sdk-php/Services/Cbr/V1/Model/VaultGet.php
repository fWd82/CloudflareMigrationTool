...
class VaultGet implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VaultGet';
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Cbr\V1\Model\ResourceResp[] $resources 资源
    *
    * @return $this
    */
    ...
    * Sets updatedAt
    *
    * @param string $updatedAt 更新时间,例如:\"2020-02-05T10:38:34.209782\"
    *
    * @return $this
    */
