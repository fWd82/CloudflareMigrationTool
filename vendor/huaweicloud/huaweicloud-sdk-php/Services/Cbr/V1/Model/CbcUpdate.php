...
class CbcUpdate implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CbcUpdate';
    ...
    */
    protected static $openAPITypes = [
            ...
            'productInfo' => '\HuaweiCloud\SDK\Cbr\V1\Model\CbcProductInfoUpdate',
            'resourceId' => 'string',
    ...
    */
    protected static $attributeMap = [
            'cloudServiceConsoleUrl' => 'cloudServiceConsoleURL',
            'productInfo' => 'productInfo',
    ...
    *  productInfo
    *
    * @return \HuaweiCloud\SDK\Cbr\V1\Model\CbcProductInfoUpdate
    */
    ...
    * Sets productInfo
    *
    * @param \HuaweiCloud\SDK\Cbr\V1\Model\CbcProductInfoUpdate $productInfo productInfo
    *
    * @return $this
    */
