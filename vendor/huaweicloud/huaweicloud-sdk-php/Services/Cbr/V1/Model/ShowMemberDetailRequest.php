...
class ShowMemberDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowMemberDetailRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * backupId  备份副本id
    * memberId  成员id，为接收方的project_id
    *
    * @var string[]
    */
