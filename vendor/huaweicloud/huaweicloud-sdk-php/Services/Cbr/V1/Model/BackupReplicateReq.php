...
class BackupReplicateReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BackupReplicateReq';
    ...
    */
    protected static $openAPITypes = [
            'replicate' => '\HuaweiCloud\SDK\Cbr\V1\Model\BackupReplicateReqBody'
    ];
    ...
    *  replicate
    *
    * @return \HuaweiCloud\SDK\Cbr\V1\Model\BackupReplicateReqBody
    */
    ...
    * Sets replicate
    *
    * @param \HuaweiCloud\SDK\Cbr\V1\Model\BackupReplicateReqBody $replicate replicate
    *
    * @return $this
    */
