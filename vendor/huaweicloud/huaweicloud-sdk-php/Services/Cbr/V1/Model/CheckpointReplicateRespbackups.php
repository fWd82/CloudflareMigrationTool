...
class CheckpointReplicateRespbackups implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CheckpointReplicateRespbackups';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['replicationRecordId'] === null) {
            $invalidProperties[] = "'replicationRecordId' can't be null";
        }
    ...
    * Sets backupId
    *
    * @param string $backupId 待复制的备份ID
    *
    * @return $this
    */
    ...
    *
    * @param string $replicationRecordId 复制记录ID
    *
    * @return $this
    */
