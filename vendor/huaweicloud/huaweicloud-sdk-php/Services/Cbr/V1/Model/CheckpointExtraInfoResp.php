...
class CheckpointExtraInfoResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CheckpointExtraInfoResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  备份名称
    * description  备份描述
    * retentionDuration  备份保留天数
    *
    * @var string[]
    */
    ...
    *
    * @param int|null $retentionDuration 备份保留天数
    *
    * @return $this
    */
