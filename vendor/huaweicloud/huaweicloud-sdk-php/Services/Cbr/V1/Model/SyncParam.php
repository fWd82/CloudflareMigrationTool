...
class SyncParam implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SyncParam';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * autoTrigger  本次同步是否自动触发
    * vaultId  混合云vault id
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['autoTrigger'] === null) {
            $invalidProperties[] = "'autoTrigger' can't be null";
        }
    ...
    * Sets autoTrigger
    *
    * @param bool $autoTrigger 本次同步是否自动触发
    *
    * @return $this
    */
