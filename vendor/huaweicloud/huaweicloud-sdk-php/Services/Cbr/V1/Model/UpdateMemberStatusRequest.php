...
class UpdateMemberStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMemberStatusRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * memberId  成员id，成员id与项目id为同一个。
    * backupId  备份副本id
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'memberId' => 'string',
            'backupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cbr\V1\Model\UpdateMember'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cbr\V1\Model\UpdateMember|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cbr\V1\Model\UpdateMember|null $body body
    *
    * @return $this
    */
