...
class UpdatePolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cbr\V1\Model\PolicyUpdateReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cbr\V1\Model\PolicyUpdateReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cbr\V1\Model\PolicyUpdateReq|null $body body
    *
    * @return $this
    */
