...
class OpExtendInfoCommon implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OpExtendInfoCommon';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * progress  进度，取值为0-100
    * requestId  请求id
    * taskId  备份任务id
    *
    * @var string[]
    ...
    * Sets progress
    *
    * @param int $progress 进度，取值为0-100
    *
    * @return $this
    */
    ...
    * Sets taskId
    *
    * @param string|null $taskId 备份任务id
    *
    * @return $this
    */
