...
class VaultSetResourceReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VaultSetResourceReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceIds  需要设置的资源id。
    * action  设置存储库资源动作
    *
    * @var string[]
    */
    ...
    * Sets resourceIds
    *
    * @param string[] $resourceIds 需要设置的资源id。
    *
    * @return $this
    */
