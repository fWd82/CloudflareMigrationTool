...
class BillingUpdate implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BillingUpdate';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * consistentLevel  存储库规格
    * size  存储库大小，单位为GB
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['size']) && ($this->container['size'] > 10485760)) {
    ...
    *
    * @param string|null $consistentLevel 存储库规格
    *
    * @return $this
    */
    ...
    * Sets size
    *
    * @param int|null $size 存储库大小，单位为GB
    *
    * @return $this
    */
