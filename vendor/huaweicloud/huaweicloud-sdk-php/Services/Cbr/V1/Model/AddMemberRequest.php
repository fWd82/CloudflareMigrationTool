...
class AddMemberRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'backupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cbr\V1\Model\AddMembersReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cbr\V1\Model\AddMembersReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cbr\V1\Model\AddMembersReq|null $body body
    *
    * @return $this
    */
