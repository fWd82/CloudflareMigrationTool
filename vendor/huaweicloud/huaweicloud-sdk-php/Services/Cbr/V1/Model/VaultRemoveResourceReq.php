...
class VaultRemoveResourceReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VaultRemoveResourceReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceIds  要移除的资源ID列表 最小长度：1 最大长度：256
    *
    * @var string[]
    */
    ...
    * Sets resourceIds
    *
    * @param string[] $resourceIds 要移除的资源ID列表 最小长度：1 最大长度：256
    *
    * @return $this
    */
