...
class ShowPostgresqlParamValueResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPostgresqlParamValueResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  参数名称。
    * value  参数值。
    * restartRequired  是否需要重启。 - \"false\"表示否 - \"true\"表示是
    ...
    *
    * @param bool|null $restartRequired 是否需要重启。 - \"false\"表示否 - \"true\"表示是
    *
    * @return $this
    */
