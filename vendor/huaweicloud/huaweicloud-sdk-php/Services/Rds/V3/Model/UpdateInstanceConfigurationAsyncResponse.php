...
class UpdateInstanceConfigurationAsyncResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInstanceConfigurationAsyncResponse';
