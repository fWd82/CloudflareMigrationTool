...
class CreateInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * xLanguage  语言
    * xClientToken  保证客户端请求幂等性的标识。 该标识为32位UUID格式，由客户端生成，且需确保72小时内不同请求之间该标识具有唯一性。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'xClientToken' => 'string',
            'body' => '\HuaweiCloud\SDK\Rds\V3\Model\InstanceRequest'
    ];
    ...
    * Sets xClientToken
    *
    * @param string|null $xClientToken 保证客户端请求幂等性的标识。 该标识为32位UUID格式，由客户端生成，且需确保72小时内不同请求之间该标识具有唯一性。
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\InstanceRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\InstanceRequest|null $body body
    *
    * @return $this
    */
