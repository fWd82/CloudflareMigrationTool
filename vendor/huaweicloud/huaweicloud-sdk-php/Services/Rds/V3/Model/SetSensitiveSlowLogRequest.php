...
class SetSensitiveSlowLogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetSensitiveSlowLogRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  语言
    * instanceId  实例ID，可以调用“查询实例列表”接口获取。如果未申请实例，可以调用“创建实例”接口创建。
    * status  开启或关闭慢日志敏感信息明文，取值为on或off。
    *
    * @var string[]
    */
