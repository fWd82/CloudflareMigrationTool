...
class ShowSecondLevelMonitoringResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSecondLevelMonitoringResponse';
    ...
    * Sets switchOption
    *
    * @param bool|null $switchOption 秒级监控开关
    *
    * @return $this
    */
