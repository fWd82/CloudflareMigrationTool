...
class InstanceInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'name' => 'string',
            'weight' => 'int',
            'availableZones' => '\HuaweiCloud\SDK\Rds\V3\Model\MysqlAvailableZoneInfo[]'
    ];
    ...
    * Sets id
    *
    * @param string|null $id 数据库主实例或只读实例ID。
    *
    * @return $this
    */
    ...
    * Sets weight
    *
    * @param int|null $weight 数据库实例读权重。
    *
    * @return $this
    */
    ...
    *  可用区信息。
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\MysqlAvailableZoneInfo[]|null
    */
    ...
    * Sets availableZones
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\MysqlAvailableZoneInfo[]|null $availableZones 可用区信息。
    *
    * @return $this
    */
