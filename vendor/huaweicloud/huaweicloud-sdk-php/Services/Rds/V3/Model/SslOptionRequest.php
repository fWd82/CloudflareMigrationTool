...
class SslOptionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SslOptionRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * sslOption  - true, 打开ssl开关。 - false, 关闭ssl开关。
    *
    * @var string[]
    */
    ...
    * Sets sslOption
    *
    * @param bool $sslOption - true, 打开ssl开关。 - false, 关闭ssl开关。
    *
    * @return $this
    */
