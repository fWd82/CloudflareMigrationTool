...
class GetTaskDetailListRspJobs implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetTaskDetailListRsp_jobs';
    ...
    * taskDetail  任务执行的具体的参数信息，为空则不返回该字段。
    * instance  instance
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['taskDetail'] = isset($data['taskDetail']) ? $data['taskDetail'] : null;
    ...
    */
    ...
    {
        return $this->container['taskDetail'];
    }

    /**
    * Sets taskDetail
    *
    * @param string|null $taskDetail 任务执行的具体的参数信息，为空则不返回该字段。
    *
    * @return $this
    */
    public function setTaskDetail($taskDetail)
    {
        $this->container['taskDetail'] = $taskDetail;
        return $this;
    }
