...
class ListConfigurationsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'configurations' => '\HuaweiCloud\SDK\Rds\V3\Model\ConfigurationSummary[]'
    ];
    ...
    *  configurations
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\ConfigurationSummary[]|null
    */
    ...
    * Sets configurations
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\ConfigurationSummary[]|null $configurations configurations
    *
    * @return $this
    */
