...
class AddLogConfigs implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddLogConfigs';
    ...
    * Sets ltsGroupId
    *
    * @param string $ltsGroupId LTS日志组ID。
    *
    * @return $this
    */
    ...
    * Sets ltsStreamId
    *
    * @param string $ltsStreamId LTS日志流ID。
    *
    * @return $this
    */
