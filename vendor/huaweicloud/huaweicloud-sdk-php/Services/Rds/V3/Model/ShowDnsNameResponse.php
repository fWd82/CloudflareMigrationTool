...
class ShowDnsNameResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDnsNameResponse';
    ...
    * Sets ipv6Address
    *
    * @param string|null $ipv6Address 实例内网IPv6地址。
    *
    * @return $this
    */
