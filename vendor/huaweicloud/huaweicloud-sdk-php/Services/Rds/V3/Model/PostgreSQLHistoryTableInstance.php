...
class PostgreSQLHistoryTableInstance implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PostgreSQLHistoryTableInstance';
    ...
    */
    protected static $openAPITypes = [
            ...
            'name' => 'string',
            'totalTables' => 'int',
            'databases' => '\HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLHistoryDatabase[]'
    ];
    ...
    *  数据库信息
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLHistoryDatabase[]|null
    */
    ...
    * Sets databases
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLHistoryDatabase[]|null $databases 数据库信息
    *
    * @return $this
    */
