...
class PostgreSQLHistorySchema implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PostgreSQLHistorySchema';
    ...
    */
    protected static $openAPITypes = [
            'name' => 'string',
            'totalTables' => 'int',
            'tables' => '\HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLHistoryTable[]'
    ];
    ...
    *  表信息
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLHistoryTable[]|null
    */
    ...
    * Sets tables
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLHistoryTable[]|null $tables 表信息
    *
    * @return $this
    */
