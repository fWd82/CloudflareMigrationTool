...
class ListBackupsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'backups' => '\HuaweiCloud\SDK\Rds\V3\Model\BackupForList[]',
            'totalCount' => 'int'
    ];
    ...
    *  备份信息。
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\BackupForList[]|null
    */
    ...
    * Sets backups
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\BackupForList[]|null $backups 备份信息。
    *
    * @return $this
    */
