...
class RestoreTablesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RestoreTablesRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'restoreTime' => 'int',
            'restoreTables' => '\HuaweiCloud\SDK\Rds\V3\Model\RestoreDatabasesInfo[]',
            'isFastRestore' => 'bool'
    ];
    ...
    *  表信息
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\RestoreDatabasesInfo[]
    */
    ...
    * Sets restoreTables
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\RestoreDatabasesInfo[] $restoreTables 表信息
    *
    * @return $this
    */
