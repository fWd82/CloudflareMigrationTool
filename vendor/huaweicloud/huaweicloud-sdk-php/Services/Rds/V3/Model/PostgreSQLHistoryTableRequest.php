...
class PostgreSQLHistoryTableRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PostgreSQLHistoryTableRequest';
    ...
    */
    protected static $setters = [
            ...
            'tableNameLike' => 'setTableNameLike',
    ...
    */
    protected static $getters = [
            ...
            'tableNameLike' => 'getTableNameLike',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['tableNameLike'] = isset($data['tableNameLike']) ? $data['tableNameLike'] : null;
    ...
    * @return string|null
    */
    public function getTableNameLike()
    {
        return $this->container['tableNameLike'];
    }

    /**
    * Sets tableNameLike
    *
    * @param string|null $tableNameLike 数据库表名，模糊查询
    *
    * @return $this
    */
    public function setTableNameLike($tableNameLike)
    {
        $this->container['tableNameLike'] = $tableNameLike;
        return $this;
    }
