...
class ExecutePrivilegeDatabaseUserRoleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecutePrivilegeDatabaseUserRoleResponse';
