...
class ListInstancesSupportFastRestoreRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstancesSupportFastRestoreRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * restoreTime  要恢复的时间点，格式为“yyyy-mm-ddThh:mm:ssZ”。 其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。
    * instanceIds  实例id列表。
    *
    * @var string[]
    */
    ...
    * Sets restoreTime
    *
    * @param string $restoreTime 要恢复的时间点，格式为“yyyy-mm-ddThh:mm:ssZ”。 其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。
    *
    * @return $this
    */
