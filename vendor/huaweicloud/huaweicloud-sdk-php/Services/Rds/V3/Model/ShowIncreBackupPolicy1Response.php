...
class ShowIncreBackupPolicy1Response implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowIncreBackupPolicy1Response';
    ...
    *  increBackupPolicy
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\ShowIncreBackupPolicyRespBodyIncreBackupPolicy|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\ShowIncreBackupPolicyRespBodyIncreBackupPolicy|null $increBackupPolicy increBackupPolicy
    *
    * @return $this
    */
