...
class PostgresqlPreCheckUpgradeMajorVersionReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PostgresqlPreCheckUpgradeMajorVersionReq';
