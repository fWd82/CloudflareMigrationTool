...
class ExecuteRevokeDatabaseUserRoleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteRevokeDatabaseUserRoleResponse';
