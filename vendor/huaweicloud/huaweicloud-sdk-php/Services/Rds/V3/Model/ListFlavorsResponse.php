...
class ListFlavorsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'flavors' => '\HuaweiCloud\SDK\Rds\V3\Model\Flavor[]'
    ];
    ...
    *  实例规格信息。
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\Flavor[]|null
    */
    ...
    * Sets flavors
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\Flavor[]|null $flavors 实例规格信息。
    *
    * @return $this
    */
