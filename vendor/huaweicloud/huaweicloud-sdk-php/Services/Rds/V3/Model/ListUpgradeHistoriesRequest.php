...
class ListUpgradeHistoriesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListUpgradeHistoriesRequest';
    ...
    * sortField  排序字段。 start_time 开始时间。 end_time 结束时间。 默认开始时间。
    ...
    * Sets sortField
    *
    * @param string|null $sortField 排序字段。 start_time 开始时间。 end_time 结束时间。 默认开始时间。
    *
    * @return $this
    */
