...
class ListSlowLogFileRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSlowLogFileRequest';
    ...
    * Sets limit
    *
    * @param int|null $limit 查询记录数。取值范围[1, 100]。
    *
    * @return $this
    */
