...
class ErrorLogItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ErrorLogItem';
    ...
    * Sets time
    *
    * @param string|null $time 日期时间UTC时间。
    *
    * @return $this
    */
    ...
    * Sets content
    *
    * @param string|null $content 错误日志内容。
    *
    * @return $this
    */
