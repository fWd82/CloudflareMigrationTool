...
class DeleteLogConfigResponseBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteLogConfigResponseBody';
    ...
    */
    protected static $openAPITypes = [
            'logConfigs' => '\HuaweiCloud\SDK\Rds\V3\Model\DeleteLogConfigs[]'
    ];
    ...
    *  实例日志配置信息。
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\DeleteLogConfigs[]
    */
    ...
    * Sets logConfigs
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\DeleteLogConfigs[] $logConfigs 实例日志配置信息。
    *
    * @return $this
    */
