...
class MysqlSlowLogStatisticsItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MysqlSlowLogStatisticsItem';
    ...
    * Sets rowsSent
    *
    * @param int|null $rowsSent 结果行数量。mysql支持
    *
    * @return $this
    */
    ...
    * Sets rowsExamined
    *
    * @param int|null $rowsExamined 扫描的行数量。mysql支持
    *
    * @return $this
    */
