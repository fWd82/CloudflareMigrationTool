...
class StartInstanceEnlargeVolumeActionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StartInstanceEnlargeVolumeActionRequest';
