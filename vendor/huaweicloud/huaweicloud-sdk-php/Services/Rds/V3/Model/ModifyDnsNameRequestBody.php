...
class ModifyDnsNameRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyDnsNameRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dnsName  新域名的前缀，校验规则是^[0-9a-zA-Z]{8,64}$
    *
    * @var string[]
    */
    ...
    * Sets dnsName
    *
    * @param string $dnsName 新域名的前缀，校验规则是^[0-9a-zA-Z]{8,64}$
    *
    * @return $this
    */
