...
class ChangeFailoverModeResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeFailoverModeResponse';
    ...
    *
    * @param string|null $replicationMode 同步模式
    *
    * @return $this
    */
