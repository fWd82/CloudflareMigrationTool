...
class FollowerMigrateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FollowerMigrateRequest';
    ...
    * Sets azCode
    *
    * @param string $azCode 要迁入的可用区code
    *
    * @return $this
    */
