...
class CopyConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'configId' => 'string',
            'body' => '\HuaweiCloud\SDK\Rds\V3\Model\ConfigurationCopyRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\ConfigurationCopyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\ConfigurationCopyRequestBody|null $body body
    *
    * @return $this
    */
