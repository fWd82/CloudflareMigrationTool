...
class ListPostgresqlDatabaseSchemasRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPostgresqlDatabaseSchemasRequest';
