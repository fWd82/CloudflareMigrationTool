...
class RestoreToExistingInstanceRequestBodySource implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RestoreToExistingInstanceRequestBody_source';
