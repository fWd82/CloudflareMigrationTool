...
class DeleteLogLtsConfigsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteLogLtsConfigsRequest';
    ...
    */
    protected static $openAPITypes = [
            'engine' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Rds\V3\Model\DeleteLogConfigResponseBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\DeleteLogConfigResponseBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\DeleteLogConfigResponseBody|null $body body
    *
    * @return $this
    */
