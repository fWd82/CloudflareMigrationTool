...
class PostgreSQLRestoreTableInstance implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PostgreSQLRestoreTableInstance';
    ...
    */
    protected static $openAPITypes = [
            'restoreTime' => 'int',
            'instanceId' => 'string',
            'databases' => '\HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLRestoreDatabase[]'
    ];
    ...
    *  数据库信息
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLRestoreDatabase[]|null
    */
    ...
    * Sets databases
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLRestoreDatabase[]|null $databases 数据库信息
    *
    * @return $this
    */
