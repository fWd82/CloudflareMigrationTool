...
class ShowAutoEnlargePolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAutoEnlargePolicyResponse';
    ...
    * Sets switchOption
    *
    * @param bool|null $switchOption 是否已开启自动扩容，true为开启
    *
    * @return $this
    */
    ...
    * Sets limitSize
    *
    * @param int|null $limitSize 扩容上限，单位GB
    *
    * @return $this
    */
    ...
    *
    * @param int|null $triggerThreshold 可用空间百分比，小于等于此值或者10GB时触发扩容
    *
    * @return $this
    */
