...
class ListAuditlogsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    */
    protected static $openAPITypes = [
            'auditlogs' => '\HuaweiCloud\SDK\Rds\V3\Model\Auditlog[]',
            'totalRecord' => 'int'
    ];
    ...
    *  auditlogs
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\Auditlog[]|null
    */
    ...
    * Sets auditlogs
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\Auditlog[]|null $auditlogs auditlogs
    *
    * @return $this
    */
