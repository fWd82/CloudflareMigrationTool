...
class ChargeInfo implements ModelInterface, ArrayAccess
{
    ...
    * periodType  订购周期类型。  取值范围：  - month：包月。 - year：包年。
    ...
    * isAutoPay  创建包周期时可指定，表示是否自动从客户的账户中支付，此字段不影响自动续订的支付方式。  - true，为自动支付。 - false，为手动支付，默认该方式。
    *
    * @var string[]
    */
    ...
    * Sets periodType
    *
    * @param string|null $periodType 订购周期类型。  取值范围：  - month：包月。 - year：包年。
    *
    * @return $this
    */
    ...
    * Sets isAutoPay
    *
    * @param bool|null $isAutoPay 创建包周期时可指定，表示是否自动从客户的账户中支付，此字段不影响自动续订的支付方式。  - true，为自动支付。 - false，为手动支付，默认该方式。
    *
    * @return $this
    */
