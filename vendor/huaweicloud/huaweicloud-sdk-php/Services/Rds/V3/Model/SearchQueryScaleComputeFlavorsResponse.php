...
class SearchQueryScaleComputeFlavorsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchQueryScaleComputeFlavorsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * computeFlavorGroups  计算规格列表对象。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'computeFlavorGroups' => '\HuaweiCloud\SDK\Rds\V3\Model\Computes[]'
    ];
    ...
    *  计算规格列表对象。
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\Computes[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\Computes[]|null $computeFlavorGroups 计算规格列表对象。
    *
    * @return $this
    */
