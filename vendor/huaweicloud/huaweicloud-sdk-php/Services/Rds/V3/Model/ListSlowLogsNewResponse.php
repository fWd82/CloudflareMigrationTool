...
class ListSlowLogsNewResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSlowLogsNewResponse';
    ...
    */
    protected static $openAPITypes = [
            'slowLogList' => '\HuaweiCloud\SDK\Rds\V3\Model\SlowLog[]',
            'totalRecord' => 'int'
    ];
    ...
    *  slowLogList
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\SlowLog[]|null
    */
    ...
    * Sets slowLogList
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\SlowLog[]|null $slowLogList slowLogList
    *
    * @return $this
    */
