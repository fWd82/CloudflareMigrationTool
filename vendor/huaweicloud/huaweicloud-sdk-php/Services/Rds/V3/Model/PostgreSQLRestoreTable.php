...
class PostgreSQLRestoreTable implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PostgreSQLRestoreTable';
    ...
    * Sets oldName
    *
    * @param string|null $oldName 恢复前表名
    *
    * @return $this
    */
