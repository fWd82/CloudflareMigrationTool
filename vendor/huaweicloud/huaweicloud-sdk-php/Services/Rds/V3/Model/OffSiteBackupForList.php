...
class OffSiteBackupForList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OffSiteBackupForList';
    ...
    * type  备份类型，取值：  - “auto”: 自动全量备份 - “incremental”: 自动增量备份
    * size  备份大小，单位为KB。
    * datastore  datastore
    ...
    * Sets type
    *
    * @param string $type 备份类型，取值：  - “auto”: 自动全量备份 - “incremental”: 自动增量备份
    *
    * @return $this
    */
