...
class SearchQueryScaleComputeFlavorsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchQueryScaleComputeFlavorsRequest';
