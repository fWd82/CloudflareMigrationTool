...
class ResourceTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResourceTagRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * tags  标签列表 租户权限时该字段必选，op_service权限时和sys_tags二选一
    * sysTags  系统标签列表 op_service权限可以访问，和tags二选一。 目前TMS调用时只包含一个resource_tag结构体 ，key固定为：_sys_enterprise_project_id value是UUID或0,value为0表示默认企业项目
    *
    * @var string[]
    */
