...
class ShowAuditRuleRiskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAuditRuleRiskRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['riskId'] === null) {
            $invalidProperties[] = "'riskId' can't be null";
        }
