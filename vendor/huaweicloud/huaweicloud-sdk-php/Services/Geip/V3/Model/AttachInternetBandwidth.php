...
class AttachInternetBandwidth implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AttachInternetBandwidth';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * globalEipSegmentId  全域弹性公网IP段的ID
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['globalEipSegmentId'] === null) {
            ...
            if ((mb_strlen($this->container['globalEipSegmentId']) > 2147483647)) {
                $invalidProperties[] = "invalid value for 'globalEipSegmentId', the character length must be smaller than or equal to 2147483647.";
            }
            if ((mb_strlen($this->container['globalEipSegmentId']) < 0)) {
                $invalidProperties[] = "invalid value for 'globalEipSegmentId', the character length must be bigger than or equal to 0.";
            }
    ...
    *
    * @param string $globalEipSegmentId 全域弹性公网IP段的ID
    *
    * @return $this
    */
