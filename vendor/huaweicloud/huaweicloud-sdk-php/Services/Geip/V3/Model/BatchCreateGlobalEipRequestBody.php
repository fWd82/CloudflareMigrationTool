...
class BatchCreateGlobalEipRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateGlobalEipRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'globalEip' => '\HuaweiCloud\SDK\Geip\V3\Model\BatchCreateGlobalEipRequestBodyGlobalEip'
    ];
    ...
    *  globalEip
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\BatchCreateGlobalEipRequestBodyGlobalEip
    */
    ...
    * Sets globalEip
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\BatchCreateGlobalEipRequestBodyGlobalEip $globalEip globalEip
    *
    * @return $this
    */
