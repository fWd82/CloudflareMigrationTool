...
class CreateInternetBandwidthResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateInternetBandwidthResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'internetBandwidth' => '\HuaweiCloud\SDK\Geip\V3\Model\CreateInternetBandwidth',
            'xRequestId' => 'string'
    ];
    ...
    *  internetBandwidth
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\CreateInternetBandwidth|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\CreateInternetBandwidth|null $internetBandwidth internetBandwidth
    *
    * @return $this
    */
