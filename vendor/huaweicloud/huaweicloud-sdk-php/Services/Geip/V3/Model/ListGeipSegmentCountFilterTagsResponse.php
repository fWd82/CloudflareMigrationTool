...
class ListGeipSegmentCountFilterTagsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGeipSegmentCountFilterTagsResponse';
