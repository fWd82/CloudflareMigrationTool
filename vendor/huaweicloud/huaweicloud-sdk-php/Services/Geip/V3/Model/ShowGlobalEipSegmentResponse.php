...
class ShowGlobalEipSegmentResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowGlobalEipSegmentResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'globalEipSegment' => '\HuaweiCloud\SDK\Geip\V3\Model\ShowGlobalEipSegment',
            'xRequestId' => 'string'
    ];
    ...
    *  globalEipSegment
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\ShowGlobalEipSegment|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\ShowGlobalEipSegment|null $globalEipSegment globalEipSegment
    *
    * @return $this
    */
