...
class UpdateGlobalEipSegmentRequestBodyGlobalEipSegment implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGlobalEipSegmentRequestBody_global_eip_segment';
