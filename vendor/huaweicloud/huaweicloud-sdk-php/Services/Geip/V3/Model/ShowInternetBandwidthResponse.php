...
class ShowInternetBandwidthResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowInternetBandwidthResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'internetBandwidth' => '\HuaweiCloud\SDK\Geip\V3\Model\ShowInternetBandwidth',
            'xRequestId' => 'string'
    ];
    ...
    *  internetBandwidth
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\ShowInternetBandwidth|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\ShowInternetBandwidth|null $internetBandwidth internetBandwidth
    *
    * @return $this
    */
