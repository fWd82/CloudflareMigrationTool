...
class ListSupportInstancesSupportRegions implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSupportInstancesSupportRegions';
    ...
    * Sets accessSite
    *
    * @param string|null $accessSite access_site,后端实例所在的站点信息
    *
    * @return $this
    */
