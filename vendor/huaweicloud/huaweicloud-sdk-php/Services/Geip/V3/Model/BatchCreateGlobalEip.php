...
class BatchCreateGlobalEip implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateGlobalEip';
    ...
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\InternetBandwidthInfo
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\InternetBandwidthInfo $internetBandwidthInfo internetBandwidthInfo
    *
    * @return $this
    */
