...
class DetachInternetBandwidth implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DetachInternetBandwidth';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * globalEipSegmentId  全局IP段id
    *
    * @var string[]
    */
    ...
    *
    * @param string $globalEipSegmentId 全局IP段id
    *
    * @return $this
    */
