...
class AssociateInstanceGlobalEipRequestBodyGlobalEipAssociateInstanceInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateInstanceGlobalEipRequestBody_global_eip_associate_instance_info';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['instanceType']) && !preg_match("/^[A-Z0-9_-]+$/", $this->container['instanceType'])) {
            ...
            if (!is_null($this->container['projectId']) && !preg_match("/^[a-z0-9]{32}$/", $this->container['projectId'])) {
