...
class AddInternetBandwidthTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddInternetBandwidthTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Geip\V3\Model\CreateV2TagRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\CreateV2TagRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\CreateV2TagRequestBody|null $body body
    *
    * @return $this
    */
