...
class ListGlobalEipsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'globalEips' => '\HuaweiCloud\SDK\Geip\V3\Model\ListGlobalEips[]',
    ...
    *  全域弹性公网IP列表
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\ListGlobalEips[]|null
    */
    ...
    * Sets globalEips
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\ListGlobalEips[]|null $globalEips 全域弹性公网IP列表
    *
    * @return $this
    */
