...
class AssociateInstanceGlobalEipSegmentRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateInstanceGlobalEipSegmentRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'globalEipSegment' => '\HuaweiCloud\SDK\Geip\V3\Model\AssociateInstanceGlobalEipSegmentRequestBodyGlobalEipSegment'
    ];
    ...
    *  globalEipSegment
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\AssociateInstanceGlobalEipSegmentRequestBodyGlobalEipSegment
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\AssociateInstanceGlobalEipSegmentRequestBodyGlobalEipSegment $globalEipSegment globalEipSegment
    *
    * @return $this
    */
