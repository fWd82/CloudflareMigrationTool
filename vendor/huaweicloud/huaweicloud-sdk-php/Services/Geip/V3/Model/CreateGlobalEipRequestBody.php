...
class CreateGlobalEipRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateGlobalEipRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'globalEip' => '\HuaweiCloud\SDK\Geip\V3\Model\CreateGlobalEipRequestBodyGlobalEip'
    ];
    ...
    *  globalEip
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\CreateGlobalEipRequestBodyGlobalEip
    */
    ...
    * Sets globalEip
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\CreateGlobalEipRequestBodyGlobalEip $globalEip globalEip
    *
    * @return $this
    */
