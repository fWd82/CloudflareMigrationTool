...
class UpdateGlobalEipRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGlobalEipRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'globalEip' => '\HuaweiCloud\SDK\Geip\V3\Model\UpdateGlobalEipRequestBodyGlobalEip'
    ];
    ...
    *  globalEip
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\UpdateGlobalEipRequestBodyGlobalEip
    */
    ...
    * Sets globalEip
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\UpdateGlobalEipRequestBodyGlobalEip $globalEip globalEip
    *
    * @return $this
    */
