...
class BatchCreateInternetBandwidthTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateInternetBandwidthTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Geip\V3\Model\BatchCreateV2RequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\BatchCreateV2RequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\BatchCreateV2RequestBody|null $body body
    *
    * @return $this
    */
