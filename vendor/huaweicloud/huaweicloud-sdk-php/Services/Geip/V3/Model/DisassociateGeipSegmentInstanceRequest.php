...
class DisassociateGeipSegmentInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateGeipSegmentInstanceRequest';
