...
class CreateGlobalEipSegmentRequestBodyGlobalEipSegmentInternetBandwidth implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateGlobalEipSegmentRequestBody_global_eip_segment_internet_bandwidth';
