...
class ListGlobalEipSegmentsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGlobalEipSegmentsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  本次请求的编号
    * globalEipSegments  全域弹性公网IP段对象
    * pageInfo  pageInfo
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'globalEipSegments' => '\HuaweiCloud\SDK\Geip\V3\Model\ListGlobalEipSegments[]',
    ...
    *  全域弹性公网IP段对象
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\ListGlobalEipSegments[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\ListGlobalEipSegments[]|null $globalEipSegments 全域弹性公网IP段对象
    *
    * @return $this
    */
