...
class BatchDetachInternetBandwidthsGlobalEipSegmentRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDetachInternetBandwidthsGlobalEipSegmentRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'globalEipSegments' => '\HuaweiCloud\SDK\Geip\V3\Model\DetachInternetBandwidth[]'
    ];
    ...
    *  请求列表
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\DetachInternetBandwidth[]
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\DetachInternetBandwidth[] $globalEipSegments 请求列表
    *
    * @return $this
    */
