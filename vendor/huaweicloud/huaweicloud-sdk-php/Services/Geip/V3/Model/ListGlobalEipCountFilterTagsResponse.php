...
class ListGlobalEipCountFilterTagsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGlobalEipCountFilterTagsResponse';
