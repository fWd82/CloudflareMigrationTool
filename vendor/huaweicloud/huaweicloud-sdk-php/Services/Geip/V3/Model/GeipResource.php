...
class GeipResource implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GeipResource';
    ...
    *  包含标签。
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\CreateTag[]
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\CreateTag[] $tags 包含标签。
    *
    * @return $this
    */
