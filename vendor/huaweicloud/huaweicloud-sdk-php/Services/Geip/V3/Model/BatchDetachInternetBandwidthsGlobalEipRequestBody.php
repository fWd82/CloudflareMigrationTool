...
class BatchDetachInternetBandwidthsGlobalEipRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDetachInternetBandwidthsGlobalEipRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * globalEips  批量解绑全域公网带宽请求体对象
    *
    * @var string[]
    */
    ...
    * Sets globalEips
    *
    * @param object[] $globalEips 批量解绑全域公网带宽请求体对象
    *
    * @return $this
    */
