...
class UpdateInternetBandwidthResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInternetBandwidthResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'internetBandwidth' => '\HuaweiCloud\SDK\Geip\V3\Model\UpdateInternetBandwidth',
            'xRequestId' => 'string'
    ];
    ...
    *  internetBandwidth
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\UpdateInternetBandwidth|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\UpdateInternetBandwidth|null $internetBandwidth internetBandwidth
    *
    * @return $this
    */
