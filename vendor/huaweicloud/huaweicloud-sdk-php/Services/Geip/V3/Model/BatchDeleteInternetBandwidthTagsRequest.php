...
class BatchDeleteInternetBandwidthTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteInternetBandwidthTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Geip\V3\Model\BatchDeleteV2RequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\BatchDeleteV2RequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\BatchDeleteV2RequestBody|null $body body
    *
    * @return $this
    */
