...
class ListGeipResourceQuotasRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGeipResourceQuotasRequest';
    ...
    */
    ...
    const TYPE_INTERNET_BANDWIDTH_IP = 'internetBandwidthIP';
    const TYPE_INTERNET_BANDWIDTH = 'internetBandwidth';
    ...
    */
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_INTERNET_BANDWIDTH_IP,
            self::TYPE_INTERNET_BANDWIDTH,
        ];
    }
