...
class ShowUserDisclaimerResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowUserDisclaimerResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'userDisclaimerRecord' => '\HuaweiCloud\SDK\Geip\V3\Model\ShowUserDisclaimerRecord',
            'xRequestId' => 'string'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\ShowUserDisclaimerRecord|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\ShowUserDisclaimerRecord|null $userDisclaimerRecord userDisclaimerRecord
    *
    * @return $this
    */
