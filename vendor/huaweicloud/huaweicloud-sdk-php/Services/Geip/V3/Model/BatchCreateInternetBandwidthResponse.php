...
class BatchCreateInternetBandwidthResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateInternetBandwidthResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  本次请求的编号
    * internetBandwidths  创建成功响应体对象
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'internetBandwidths' => '\HuaweiCloud\SDK\Geip\V3\Model\BatchCreateInternetBandwidth[]',
            'xRequestId' => 'string'
    ];
    ...
    *  创建成功响应体对象
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\BatchCreateInternetBandwidth[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\BatchCreateInternetBandwidth[]|null $internetBandwidths 创建成功响应体对象
    *
    * @return $this
    */
