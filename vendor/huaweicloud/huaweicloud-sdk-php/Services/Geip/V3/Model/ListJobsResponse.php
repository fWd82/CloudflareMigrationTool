...
class ListJobsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'jobs' => '\HuaweiCloud\SDK\Geip\V3\Model\ListJobs[]',
    ...
    *  响应job对象
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\ListJobs[]|null
    */
    ...
    * Sets jobs
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\ListJobs[]|null $jobs 响应job对象
    *
    * @return $this
    */
