...
class UpdateGlobalEipSegmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGlobalEipSegmentRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Geip\V3\Model\UpdateGlobalEipSegmentRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\UpdateGlobalEipSegmentRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\UpdateGlobalEipSegmentRequestBody|null $body body
    *
    * @return $this
    */
