...
class AttachInternetBandwidthGlobalEipRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AttachInternetBandwidthGlobalEipRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'globalEip' => '\HuaweiCloud\SDK\Geip\V3\Model\AttachInternetBandwidthGlobalEipRequestBodyGlobalEip'
    ];
    ...
    *  globalEip
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\AttachInternetBandwidthGlobalEipRequestBodyGlobalEip
    */
    ...
    * Sets globalEip
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\AttachInternetBandwidthGlobalEipRequestBodyGlobalEip $globalEip globalEip
    *
    * @return $this
    */
