...
class ListSupportRegionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSupportRegionsResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'supportRegions' => '\HuaweiCloud\SDK\Geip\V3\Model\ListSupportRegions[]',
    ...
    *  支持的Region对象
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\ListSupportRegions[]|null
    */
    ...
    * Sets supportRegions
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\ListSupportRegions[]|null $supportRegions 支持的Region对象
    *
    * @return $this
    */
