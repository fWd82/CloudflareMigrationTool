...
class UpdateGlobalEipRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGlobalEipRequest';
    ...
    */
    protected static $openAPITypes = [
            'globalEipId' => 'string',
            'body' => '\HuaweiCloud\SDK\Geip\V3\Model\UpdateGlobalEipRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\UpdateGlobalEipRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\UpdateGlobalEipRequestBody|null $body body
    *
    * @return $this
    */
