...
class ListGlobalEipDomainTagsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGlobalEipDomainTagsResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'totalCount' => 'int',
            'tags' => '\HuaweiCloud\SDK\Geip\V3\Model\GeipTags[]',
            'xRequestId' => 'string'
    ];
    ...
    *  tag列表信息
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\GeipTags[]|null
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\GeipTags[]|null $tags tag列表信息
    *
    * @return $this
    */
