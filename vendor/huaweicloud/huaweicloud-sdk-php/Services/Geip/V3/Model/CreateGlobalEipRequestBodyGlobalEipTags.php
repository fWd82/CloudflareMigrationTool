...
class CreateGlobalEipRequestBodyGlobalEipTags implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateGlobalEipRequestBody_global_eip_tags';
