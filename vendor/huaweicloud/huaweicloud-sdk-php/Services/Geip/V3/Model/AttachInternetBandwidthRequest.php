...
class AttachInternetBandwidthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AttachInternetBandwidthRequest';
    ...
    */
    protected static $openAPITypes = [
            'globalEipId' => 'string',
            'body' => '\HuaweiCloud\SDK\Geip\V3\Model\AttachInternetBandwidthGlobalEipRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\AttachInternetBandwidthGlobalEipRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\AttachInternetBandwidthGlobalEipRequestBody|null $body body
    *
    * @return $this
    */
