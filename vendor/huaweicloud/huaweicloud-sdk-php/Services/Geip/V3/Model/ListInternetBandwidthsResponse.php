...
class ListInternetBandwidthsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInternetBandwidthsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  本次请求的编号
    * internetBandwidths  全域公网带宽列表
    * pageInfo  pageInfo
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'internetBandwidths' => '\HuaweiCloud\SDK\Geip\V3\Model\ListInternetBandwidths[]',
    ...
    *  全域公网带宽列表
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\ListInternetBandwidths[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\ListInternetBandwidths[]|null $internetBandwidths 全域公网带宽列表
    *
    * @return $this
    */
