...
class UpdateGlobalEipRequestBodyGlobalEip implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGlobalEipRequestBody_global_eip';
