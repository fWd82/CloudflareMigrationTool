...
class ExtLimitPojo implements ModelInterface, ArrayAccess
{
    ...
    * minIngressSize  入网全域公网带宽的最小size
    * maxIngressSize  入网全域公网带宽的最大size
    * ratio95peak  增强95保底率
    *
    * @var string[]
    */
    ...
    */
    protected static $openAPIFormats = [
        'minIngressSize' => 'int32',
        'maxIngressSize' => 'int32',
        'ratio95peak' => 'int32'
    ];
    ...
    * Sets minIngressSize
    *
    * @param int|null $minIngressSize 入网全域公网带宽的最小size
    *
    * @return $this
    */
    ...
    * Sets maxIngressSize
    *
    * @param int|null $maxIngressSize 入网全域公网带宽的最大size
    *
    * @return $this
    */
