...
class ListInternetBandwidths implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInternetBandwidths';
    ...
    * status  状态
    * geipCount  全域弹性公网IP个数
    * geipSegmentCount  全域弹性公网IP段个数
    * createdAt  创建时间
    * updatedAt  更新时间
    * isPrePaid  是否包周期
    * tags  全域公网带宽标签
    ...
    */
    protected static $attributeMap = [
            ...
            'domainId' => 'domain_id',
            'status' => 'status',
            'geipCount' => 'geip_count',
            'geipSegmentCount' => 'geip_segment_count',
    ...
    */
    protected static $setters = [
            ...
            'status' => 'setStatus',
            'geipCount' => 'setGeipCount',
            'geipSegmentCount' => 'setGeipSegmentCount',
    ...
    */
    protected static $getters = [
            ...
            'status' => 'getStatus',
            'geipCount' => 'getGeipCount',
            'geipSegmentCount' => 'getGeipSegmentCount',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['geipCount'] = isset($data['geipCount']) ? $data['geipCount'] : null;
        $this->container['geipSegmentCount'] = isset($data['geipSegmentCount']) ? $data['geipSegmentCount'] : null;
    ...
    * @return int|null
    */
    public function getGeipCount()
    {
        return $this->container['geipCount'];
    }

    /**
    * Sets geipCount
    *
    * @param int|null $geipCount 全域弹性公网IP个数
    *
    * @return $this
    */
    public function setGeipCount($geipCount)
    {
        $this->container['geipCount'] = $geipCount;
        return $this;
    }

    /**
    * Gets geipSegmentCount
    *  全域弹性公网IP段个数
    *
    * @return int|null
    */
    public function getGeipSegmentCount()
    {
        return $this->container['geipSegmentCount'];
    }

    /**
    * Sets geipSegmentCount
    *
    * @param int|null $geipSegmentCount 全域弹性公网IP段个数
    *
    * @return $this
    */
    public function setGeipSegmentCount($geipSegmentCount)
    {
        $this->container['geipSegmentCount'] = $geipSegmentCount;
        return $this;
    }
