...
class CreateGlobalEipSegmentRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateGlobalEipSegmentRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'globalEipSegment' => '\HuaweiCloud\SDK\Geip\V3\Model\CreateGlobalEipSegmentRequestBodyGlobalEipSegment'
    ];
    ...
    *  globalEipSegment
    *
    * @return \HuaweiCloud\SDK\Geip\V3\Model\CreateGlobalEipSegmentRequestBodyGlobalEipSegment
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Geip\V3\Model\CreateGlobalEipSegmentRequestBodyGlobalEipSegment $globalEipSegment globalEipSegment
    *
    * @return $this
    */
