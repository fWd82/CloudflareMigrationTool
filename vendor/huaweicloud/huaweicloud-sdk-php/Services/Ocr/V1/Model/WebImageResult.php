...
class WebImageResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WebImageResult';
    ...
    */
    protected static $openAPITypes = [
            'wordsBlockCount' => 'int',
            'wordsBlockList' => '\HuaweiCloud\SDK\Ocr\V1\Model\WebImageWordsBlockList[]',
            'extractedData' => '\HuaweiCloud\SDK\Ocr\V1\Model\WebImageExtractedData'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['extractedData'] === null) {
            $invalidProperties[] = "'extractedData' can't be null";
        }
    ...
    *
    * @return \HuaweiCloud\SDK\Ocr\V1\Model\WebImageWordsBlockList[]
    */
    ...
    * Sets wordsBlockList
    *
    * @param \HuaweiCloud\SDK\Ocr\V1\Model\WebImageWordsBlockList[] $wordsBlockList 识别文字块列表，输出顺序从左到右，从上到下。
    *
    * @return $this
    */
    ...
    *  extractedData
    *
    * @return \HuaweiCloud\SDK\Ocr\V1\Model\WebImageExtractedData
    */
    ...
    * Sets extractedData
    *
    * @param \HuaweiCloud\SDK\Ocr\V1\Model\WebImageExtractedData $extractedData extractedData
    *
    * @return $this
    */
