...
class SmartDocumentRecognizerWordsBlockList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SmartDocumentRecognizerWordsBlockList';
    ...
    * Sets confidence
    *
    * @param float|null $confidence 文字块识别结果的置信度。
    *
    * @return $this
    */
