...
class QualificationCategory implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'QualificationCategory';
    ...
    * Sets category
    *
    * @param string|null $category 诚信考核信息（非必有，依赖对应从业资格证板式）。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $initialIssueDate 初次领证日期（非必有，依赖对应从业资格证板式）
    *
    * @return $this
    */
    ...
    * Sets issueDate
    *
    * @param string|null $issueDate 有效起始日期（非必有，依赖对应从业资格证板式）
    *
    * @return $this
    */
    ...
    * Sets expiryDate
    *
    * @param string|null $expiryDate 有效期至
    *
    * @return $this
    */
