...
class ThailandLicensePlateItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ThailandLicensePlateItem';
    ...
    * Sets plateNumber
    *
    * @param string|null $plateNumber 车牌内容。
    *
    * @return $this
    */
    ...
    * Sets plateLocation
    *
    * @param int[][]|null $plateLocation 车牌的区域位置信息，列表形式，包含文字区域四个顶点的二维坐标（x,y）;坐标原点为图片左上角，x轴沿水平方向，y轴沿竖直方向。
    *
    * @return $this
    */
    ...
    * Sets confidence
    *
    * @param float|null $confidence 相关字段的置信度信息，置信度越大，表示本次识别的对应字段的可靠性越高，在统计意义上，置信度越大，准确率越高。注：置信度由算法给出，不直接等价于对应字段的准确率。
    *
    * @return $this
    */
