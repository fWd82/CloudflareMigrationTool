...
class IdcardFrontResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IdcardFrontResult';
    ...
    *  verificationResult
    *
    * @return \HuaweiCloud\SDK\Ocr\V1\Model\IdcardFrontVerificationResult|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Ocr\V1\Model\IdcardFrontVerificationResult|null $verificationResult verificationResult
    *
    * @return $this
    */
    ...
    *
    * @param int[][]|null $portraitLocation 身份证头像位置信息的结果。 仅在输入参数return_portrait_location为true时，返回该字段。
    *
    * @return $this
    */
