...
class TagResourceRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\TagResourceReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\TagResourceReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\TagResourceReqBody|null $body body
    *
    * @return $this
    */
