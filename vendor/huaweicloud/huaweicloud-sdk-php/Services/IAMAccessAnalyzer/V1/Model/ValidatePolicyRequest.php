...
class ValidatePolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ValidatePolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'marker' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\ValidatePolicyReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\ValidatePolicyReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\ValidatePolicyReqBody|null $body body
    *
    * @return $this
    */
