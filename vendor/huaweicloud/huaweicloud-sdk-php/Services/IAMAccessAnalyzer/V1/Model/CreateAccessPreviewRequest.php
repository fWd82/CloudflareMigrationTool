...
class CreateAccessPreviewRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAccessPreviewRequest';
    ...
    */
    protected static $openAPITypes = [
            'analyzerId' => 'string',
            'body' => '\HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\CreateAccessPreviewReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\CreateAccessPreviewReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\CreateAccessPreviewReqBody|null $body body
    *
    * @return $this
    */
