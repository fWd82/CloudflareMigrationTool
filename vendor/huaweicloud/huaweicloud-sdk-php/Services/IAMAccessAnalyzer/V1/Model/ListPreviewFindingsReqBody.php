...
class ListPreviewFindingsReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPreviewFindingsReqBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * filters  匹配要返回的分析结果的筛选项。
    * limit  单页最大结果数。
    * marker  页面标记。
    *
    * @var string[]
    ...
    * Sets filters
    *
    * @param \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\FindingFilter[]|null $filters 匹配要返回的分析结果的筛选项。
    *
    * @return $this
    */
