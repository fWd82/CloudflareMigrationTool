...
class UntagResourceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UntagResourceRequest';
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\UntagResourceReqBody'
    ];
    ...
    */
    ...
    const RESOURCE_TYPE_ANALYZERS = 'analyzers';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['resourceId'] === null) {
            ...
            if (!preg_match("/^[\\w-]+$/", $this->container['resourceId'])) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\UntagResourceReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\UntagResourceReqBody|null $body body
    *
    * @return $this
    */
