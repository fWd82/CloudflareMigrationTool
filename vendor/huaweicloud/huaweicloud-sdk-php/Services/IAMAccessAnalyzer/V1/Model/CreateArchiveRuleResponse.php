...
class CreateArchiveRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateArchiveRuleResponse';
    ...
    * Sets id
    *
    * @param string|null $id 存档规则的唯一标识符。
    *
    * @return $this
    */
