...
class CreateKmsTagRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateKmsTagRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'tag' => '\HuaweiCloud\SDK\Kms\V2\Model\TagItem',
            'sequence' => 'string'
    ];
    ...
    * Sets tag
    *
    * @param \HuaweiCloud\SDK\Kms\V2\Model\TagItem|null $tag tag
    *
    * @return $this
    */
