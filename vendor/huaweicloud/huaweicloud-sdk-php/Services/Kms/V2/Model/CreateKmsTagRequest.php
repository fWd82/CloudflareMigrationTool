...
class CreateKmsTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateKmsTagRequest';
    ...
    */
    protected static $openAPITypes = [
            'keyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Kms\V2\Model\CreateKmsTagRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Kms\V2\Model\CreateKmsTagRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Kms\V2\Model\CreateKmsTagRequestBody|null $body body
    *
    * @return $this
    */
