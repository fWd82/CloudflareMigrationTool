...
class EncryptDatakeyRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EncryptDatakeyRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * keyId  密钥ID，36字节，满足正则匹配“^[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12}$”。 例如：0d0466b0-e727-4d9c-b35d-f84bb474a37f。
    * plainText  CMK为AES时，DEK明文和DEK明文的SHA256（32字节）；CMK为SM4时，DEK明文和DEK明文的SM3（32字节），均为16进制字符串表示。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['plainText'] === null) {
            ...
            if ((mb_strlen($this->container['plainText']) > 8192)) {
                $invalidProperties[] = "invalid value for 'plainText', the character length must be smaller than or equal to 8192.";
            }
            if ((mb_strlen($this->container['plainText']) < 8)) {
                $invalidProperties[] = "invalid value for 'plainText', the character length must be bigger than or equal to 8.";
            }
        if ($this->container['datakeyPlainLength'] === null) {
            $invalidProperties[] = "'datakeyPlainLength' can't be null";
        }
            if ((mb_strlen($this->container['datakeyPlainLength']) > 10)) {
                $invalidProperties[] = "invalid value for 'datakeyPlainLength', the character length must be smaller than or equal to 10.";
            }
            if ((mb_strlen($this->container['datakeyPlainLength']) < 0)) {
                $invalidProperties[] = "invalid value for 'datakeyPlainLength', the character length must be bigger than or equal to 0.";
            }
    ...
    * Sets plainText
    *
    * @param string $plainText CMK为AES时，DEK明文和DEK明文的SHA256（32字节）；CMK为SM4时，DEK明文和DEK明文的SM3（32字节），均为16进制字符串表示。
    *
    * @return $this
    */
    ...
    /**
    * Gets datakeyPlainLength
    *  DEK明文字节长度，取值范围为1~1024。 DEK明文字节长度，取值为“64”。
    *
    * @return string
    */
    public function getDatakeyPlainLength()
    {
        return $this->container['datakeyPlainLength'];
    }

    /**
    * Sets datakeyPlainLength
    *
    * @param string $datakeyPlainLength DEK明文字节长度，取值范围为1~1024。 DEK明文字节长度，取值为“64”。
    *
    * @return $this
    */
    public function setDatakeyPlainLength($datakeyPlainLength)
    {
        $this->container['datakeyPlainLength'] = $datakeyPlainLength;
        return $this;
    }
