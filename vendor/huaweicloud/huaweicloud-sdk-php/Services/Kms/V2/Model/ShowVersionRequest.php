    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['versionId'] === null) {
            ...
            if ((mb_strlen($this->container['versionId']) > 10)) {
                $invalidProperties[] = "invalid value for 'versionId', the character length must be smaller than or equal to 10.";
            }
            if ((mb_strlen($this->container['versionId']) < 1)) {
