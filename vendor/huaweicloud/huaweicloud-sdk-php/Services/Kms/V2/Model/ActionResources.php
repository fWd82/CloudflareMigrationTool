...
class ActionResources implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'resourceDetail' => '\HuaweiCloud\SDK\Kms\V2\Model\KeyDetails',
            'resourceName' => 'string',
    ...
    * Sets resourceDetail
    *
    * @param \HuaweiCloud\SDK\Kms\V2\Model\KeyDetails|null $resourceDetail resourceDetail
    *
    * @return $this
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Kms\V2\Model\TagItem[]|null $tags 标签列表，没有标签，数组默认为空。
    *
    * @return $this
    */
