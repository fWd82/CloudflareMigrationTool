...
class CreateDatakeyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDatakeyResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * keyId  密钥ID。
    * plainText  DEK明文16进制，两位表示1byte。
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['plainText']) && (mb_strlen($this->container['plainText']) > 8192)) {
                $invalidProperties[] = "invalid value for 'plainText', the character length must be smaller than or equal to 8192.";
            }
            if (!is_null($this->container['plainText']) && (mb_strlen($this->container['plainText']) < 8)) {
    ...
    * Sets plainText
    *
    * @param string|null $plainText DEK明文16进制，两位表示1byte。
    *
    * @return $this
    */
