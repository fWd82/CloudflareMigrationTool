...
class ShowUserInstancesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowUserInstancesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceNum  非默认用户主密钥个数。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['instanceNum']) && ($this->container['instanceNum'] > 100)) {
                $invalidProperties[] = "invalid value for 'instanceNum', must be smaller than or equal to 100.";
            }
    ...
    * Sets instanceNum
    *
    * @param int|null $instanceNum 非默认用户主密钥个数。
    *
    * @return $this
    */
