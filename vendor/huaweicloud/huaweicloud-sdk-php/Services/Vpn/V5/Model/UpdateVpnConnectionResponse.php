...
class UpdateVpnConnectionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpnConnectionResponse';
    ...
    */
    protected static $openAPITypes = [
            'vpnConnection' => '\HuaweiCloud\SDK\Vpn\V5\Model\UpdateResponseVpnConnection',
            'requestId' => 'string',
    ...
    *  vpnConnection
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\UpdateResponseVpnConnection|null
    */
    ...
    * Sets vpnConnection
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\UpdateResponseVpnConnection|null $vpnConnection vpnConnection
    *
    * @return $this
    */
