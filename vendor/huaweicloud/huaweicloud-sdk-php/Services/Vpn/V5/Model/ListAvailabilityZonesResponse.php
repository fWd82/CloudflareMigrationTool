...
class ListAvailabilityZonesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'availabilityZones' => '\HuaweiCloud\SDK\Vpn\V5\Model\AvailabilityZones',
            'requestId' => 'string'
    ];
    ...
    *  availabilityZones
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\AvailabilityZones|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\AvailabilityZones|null $availabilityZones availabilityZones
    *
    * @return $this
    */
