...
class CreateVgwResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateVgwResponse';
    ...
    */
    protected static $openAPITypes = [
            'vpnGateway' => '\HuaweiCloud\SDK\Vpn\V5\Model\CreateResponseVpnGateway',
            'requestId' => 'string',
    ...
    *  vpnGateway
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\CreateResponseVpnGateway|null
    */
    ...
    * Sets vpnGateway
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\CreateResponseVpnGateway|null $vpnGateway vpnGateway
    *
    * @return $this
    */
