...
class CountResourcesByTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CountResourcesByTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\QueryResourcesRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\QueryResourcesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\QueryResourcesRequestBody|null $body body
    *
    * @return $this
    */
