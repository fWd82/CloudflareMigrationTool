...
class ListCgwsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCgwsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * cgwId  CustomerGateway ID
    ...
    * Sets cgwId
    *
    * @param string|null $cgwId CustomerGateway ID
    *
    * @return $this
    */
