...
class UpdateRequestPolicyTemplate implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRequestPolicyTemplate';
    ...
    */
    protected static $openAPITypes = [
            'ikePolicy' => '\HuaweiCloud\SDK\Vpn\V5\Model\UpdateVgwIkePolicy',
            'ipsecPolicy' => '\HuaweiCloud\SDK\Vpn\V5\Model\UpdateVgwIpsecPolicy'
    ];
    ...
    *  ikePolicy
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\UpdateVgwIkePolicy|null
    */
    ...
    * Sets ikePolicy
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\UpdateVgwIkePolicy|null $ikePolicy ikePolicy
    *
    * @return $this
    */
    ...
    *  ipsecPolicy
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\UpdateVgwIpsecPolicy|null
    */
    ...
    * Sets ipsecPolicy
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\UpdateVgwIpsecPolicy|null $ipsecPolicy ipsecPolicy
    *
    * @return $this
    */
