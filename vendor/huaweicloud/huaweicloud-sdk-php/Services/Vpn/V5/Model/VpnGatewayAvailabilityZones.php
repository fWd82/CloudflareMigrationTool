...
class VpnGatewayAvailabilityZones implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VpnGatewayAvailabilityZones';
    ...
    * Sets vpc
    *
    * @param string[]|null $vpc VPC关联类型的可用区列表
    *
    * @return $this
    */
    ...
    * Sets er
    *
    * @param string[]|null $er ER关联类型的可用区列表
    *
    * @return $this
    */
