...
class CreateConnectionMonitorRequestBodyContent implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateConnectionMonitorRequestBodyContent';
    ...
    *
    * @param string $vpnConnectionId VPN连接监控对应的VPN连接ID
    *
    * @return $this
    */
