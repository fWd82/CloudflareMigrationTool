...
class UpdateVgwResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVgwResponse';
    ...
    */
    protected static $openAPITypes = [
            'vpnGateway' => '\HuaweiCloud\SDK\Vpn\V5\Model\UpdateResponseVpnGateway',
            'requestId' => 'string',
    ...
    *  vpnGateway
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\UpdateResponseVpnGateway|null
    */
    ...
    * Sets vpnGateway
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\UpdateResponseVpnGateway|null $vpnGateway vpnGateway
    *
    * @return $this
    */
