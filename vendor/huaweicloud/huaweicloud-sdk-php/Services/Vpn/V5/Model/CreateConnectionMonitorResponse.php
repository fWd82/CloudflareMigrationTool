...
class CreateConnectionMonitorResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateConnectionMonitorResponse';
    ...
    */
    protected static $openAPITypes = [
            'connectionMonitor' => '\HuaweiCloud\SDK\Vpn\V5\Model\CreateConnectionMonitorInfo',
            'requestId' => 'string',
    ...
    *  connectionMonitor
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\CreateConnectionMonitorInfo|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\CreateConnectionMonitorInfo|null $connectionMonitor connectionMonitor
    *
    * @return $this
    */
