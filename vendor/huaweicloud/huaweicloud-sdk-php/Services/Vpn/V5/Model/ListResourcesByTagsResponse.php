...
class ListResourcesByTagsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resources' => '\HuaweiCloud\SDK\Vpn\V5\Model\Resource[]',
            'totalCount' => 'int'
    ];
    ...
    *  resources
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\Resource[]|null
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\Resource[]|null $resources resources
    *
    * @return $this
    */
