...
class UpdateVgwCertificateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVgwCertificateResponse';
    ...
    */
    protected static $openAPITypes = [
            'certificate' => '\HuaweiCloud\SDK\Vpn\V5\Model\VpnGatewayCertificateConfig',
            'requestId' => 'string',
    ...
    *  certificate
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\VpnGatewayCertificateConfig|null
    */
    ...
    * Sets certificate
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\VpnGatewayCertificateConfig|null $certificate certificate
    *
    * @return $this
    */
