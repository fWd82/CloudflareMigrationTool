...
class ShowVpnConnectionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowVpnConnectionResponse';
    ...
    */
    protected static $openAPITypes = [
            'vpnConnection' => '\HuaweiCloud\SDK\Vpn\V5\Model\ResponseVpnConnection',
            'requestId' => 'string',
    ...
    * Sets vpnConnection
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\ResponseVpnConnection|null $vpnConnection vpnConnection
    *
    * @return $this
    */
