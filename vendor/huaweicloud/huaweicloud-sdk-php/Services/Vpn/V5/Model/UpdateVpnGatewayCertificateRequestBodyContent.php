...
class UpdateVpnGatewayCertificateRequestBodyContent implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpnGatewayCertificateRequestBodyContent';
    ...
    * Sets certificate
    *
    * @param string|null $certificate 证书内容，国密证书时为签名证书内容
    *
    * @return $this
    */
    ...
    * Sets privateKey
    *
    * @param string|null $privateKey 证书私钥，国密证书时为签名证书私钥
    *
    * @return $this
    */
    ...
    *
    * @param string|null $certificateChain VPN网关CA证书内容
    *
    * @return $this
    */
    ...
    * Sets encCertificate
    *
    * @param string|null $encCertificate 国密证书的加密证书内容
    *
    * @return $this
    */
    ...
    * Sets encPrivateKey
    *
    * @param string|null $encPrivateKey 国密证书的加密证书私钥
    *
    * @return $this
    */
