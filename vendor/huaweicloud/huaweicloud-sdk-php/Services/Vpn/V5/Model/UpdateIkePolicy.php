...
class UpdateIkePolicy implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateIkePolicy';
    ...
    */
    protected static $openAPITypes = [
            ...
            'peerIdType' => 'string',
            'peerId' => 'string',
            'dpd' => '\HuaweiCloud\SDK\Vpn\V5\Model\UpdateDpd'
    ];
    ...
    *  dpd
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\UpdateDpd|null
    */
    ...
    * Sets dpd
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\UpdateDpd|null $dpd dpd
    *
    * @return $this
    */
