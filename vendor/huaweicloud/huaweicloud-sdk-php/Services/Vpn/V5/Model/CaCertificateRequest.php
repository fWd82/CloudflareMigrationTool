...
class CaCertificateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CaCertificateRequest';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['content']) && (mb_strlen($this->container['content']) > 8192)) {
    ...
    * Sets content
    *
    * @param string|null $content 对端网关CA证书内容
    *
    * @return $this
    */
