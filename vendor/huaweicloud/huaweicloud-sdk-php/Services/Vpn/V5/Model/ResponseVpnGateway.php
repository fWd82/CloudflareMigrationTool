...
class ResponseVpnGateway implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResponseVpnGateway';
    ...
    * Sets status
    *
    * @param string|null $status VPN网关状态
    *
    * @return $this
    */
    ...
    *
    * @param string[]|null $supportedFlavors 网关可升配到的目标规格
    *
    * @return $this
    */
