...
class ListStackSetOperationsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListStackSetOperationsResponse';
    ...
    */
    ...
    /**
    * Gets stackSetOperations
    *  资源栈集操作列表
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\StackSetOperation[]|null
    */
    public function getStackSetOperations()
    {
        return $this->container['stackSetOperations'];
    }

    /**
    * Sets stackSetOperations
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\StackSetOperation[]|null $stackSetOperations 资源栈集操作列表
    *
    * @return $this
    */
