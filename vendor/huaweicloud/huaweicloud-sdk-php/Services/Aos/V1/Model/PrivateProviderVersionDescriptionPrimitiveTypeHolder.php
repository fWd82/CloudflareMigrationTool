...
class PrivateProviderVersionDescriptionPrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrivateProviderVersionDescriptionPrimitiveTypeHolder';
