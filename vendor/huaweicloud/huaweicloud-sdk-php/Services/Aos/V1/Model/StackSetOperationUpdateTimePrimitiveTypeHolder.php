...
class StackSetOperationUpdateTimePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StackSetOperationUpdateTimePrimitiveTypeHolder';
