...
class ListStacksResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListStacksResponse';
    ...
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\Stack[]|null
    */
    ...
    * Sets stacks
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\Stack[]|null $stacks 资源栈列表。默认按照生成时间降序排序，最新生成的在最前
    *
    * @return $this
    */
