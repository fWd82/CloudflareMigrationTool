...
class InitialStackDescriptionPrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InitialStackDescriptionPrimitiveTypeHolder';
