...
class ListStackInstancesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListStackInstancesResponse';
    ...
    *  资源栈实例列表
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\StackInstance[]|null
    */
    public function getStackInstances()
    {
        return $this->container['stackInstances'];
    }

    /**
    * Sets stackInstances
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\StackInstance[]|null $stackInstances 资源栈实例列表
    *
    * @return $this
    */
