...
class DeleteStackInstanceDeprecatedResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteStackInstanceDeprecatedResponse';
