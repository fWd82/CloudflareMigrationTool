...
class StackSetUpdateTimePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StackSetUpdateTimePrimitiveTypeHolder';
