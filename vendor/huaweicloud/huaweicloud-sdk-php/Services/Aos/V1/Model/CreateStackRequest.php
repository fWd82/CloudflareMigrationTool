...
class CreateStackRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateStackRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Aos\V1\Model\CreateStackRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\CreateStackRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\CreateStackRequestBody|null $body body
    *
    * @return $this
    */
