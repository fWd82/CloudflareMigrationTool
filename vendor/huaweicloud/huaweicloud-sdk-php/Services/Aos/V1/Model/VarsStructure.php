...
class VarsStructure implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'varKey' => 'string',
            'varValue' => 'string',
            'encryption' => '\HuaweiCloud\SDK\Aos\V1\Model\EncryptionStructure'
    ];
    ...
    *  encryption
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\EncryptionStructure|null
    */
    ...
    * Sets encryption
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\EncryptionStructure|null $encryption encryption
    *
    * @return $this
    */
