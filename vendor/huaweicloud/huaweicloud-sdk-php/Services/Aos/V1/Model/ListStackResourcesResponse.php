...
class ListStackResourcesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'stackResources' => '\HuaweiCloud\SDK\Aos\V1\Model\StackResource[]'
    ];
    ...
    *  资源栈中所管理的资源信息列表
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\StackResource[]|null
    */
    ...
    * Sets stackResources
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\StackResource[]|null $stackResources 资源栈中所管理的资源信息列表
    *
    * @return $this
    */
