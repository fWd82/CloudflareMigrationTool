...
class ShowStackSetOperationMetadataRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowStackSetOperationMetadataRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['stackSetOperationId'] === null) {
            $invalidProperties[] = "'stackSetOperationId' can't be null";
        }
            if ((mb_strlen($this->container['stackSetOperationId']) > 36)) {
