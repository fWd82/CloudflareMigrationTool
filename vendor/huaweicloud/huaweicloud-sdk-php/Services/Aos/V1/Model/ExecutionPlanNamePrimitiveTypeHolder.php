...
class ExecutionPlanNamePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecutionPlanNamePrimitiveTypeHolder';
