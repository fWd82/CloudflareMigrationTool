...
class ListStackOutputsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListStackOutputsResponse';
    ...
    * Sets outputs
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\StackOutput[]|null $outputs 资源栈输出列表
    *
    * @return $this
    */
