...
class StackInstanceStatusPrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StackInstanceStatusPrimitiveTypeHolder';
