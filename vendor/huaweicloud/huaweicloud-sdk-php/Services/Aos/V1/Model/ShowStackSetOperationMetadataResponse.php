...
class ShowStackSetOperationMetadataResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowStackSetOperationMetadataResponse';
