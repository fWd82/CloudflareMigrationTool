...
class StackSetOperationStatusMessagePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StackSetOperationStatusMessagePrimitiveTypeHolder';
