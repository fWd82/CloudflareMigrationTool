...
class DeploymentTargetsPrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeploymentTargetsPrimitiveTypeHolder';
