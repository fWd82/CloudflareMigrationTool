...
class StackSetStackNamePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StackSetStackNamePrimitiveTypeHolder';
