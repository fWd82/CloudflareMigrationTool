...
class CreateStackInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateStackInstanceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'stackSetName' => 'string',
            'body' => '\HuaweiCloud\SDK\Aos\V1\Model\CreateStackInstanceRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\CreateStackInstanceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\CreateStackInstanceRequestBody|null $body body
    *
    * @return $this
    */
