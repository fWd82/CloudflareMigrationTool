...
class StackSetOperationCreateTimePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StackSetOperationCreateTimePrimitiveTypeHolder';
