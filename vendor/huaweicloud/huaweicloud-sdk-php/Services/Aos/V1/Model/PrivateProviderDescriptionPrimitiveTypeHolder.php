...
class PrivateProviderDescriptionPrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrivateProviderDescriptionPrimitiveTypeHolder';
