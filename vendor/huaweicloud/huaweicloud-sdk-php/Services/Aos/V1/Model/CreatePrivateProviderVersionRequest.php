...
class CreatePrivateProviderVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePrivateProviderVersionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'providerName' => 'string',
            'body' => '\HuaweiCloud\SDK\Aos\V1\Model\CreatePrivateProviderVersionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\CreatePrivateProviderVersionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\CreatePrivateProviderVersionRequestBody|null $body body
    *
    * @return $this
    */
