...
class UpdateTemplateMetadataRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTemplateMetadataRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'templateName' => 'string',
            'body' => '\HuaweiCloud\SDK\Aos\V1\Model\UpdateTemplateMetadataRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\UpdateTemplateMetadataRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\UpdateTemplateMetadataRequestBody|null $body body
    *
    * @return $this
    */
