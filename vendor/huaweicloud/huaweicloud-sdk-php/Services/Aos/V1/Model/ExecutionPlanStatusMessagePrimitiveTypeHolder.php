...
class ExecutionPlanStatusMessagePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecutionPlanStatusMessagePrimitiveTypeHolder';
