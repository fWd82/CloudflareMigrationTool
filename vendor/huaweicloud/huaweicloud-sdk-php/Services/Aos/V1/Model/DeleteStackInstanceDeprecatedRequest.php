...
class DeleteStackInstanceDeprecatedRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteStackInstanceDeprecatedRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'stackSetName' => 'string',
            'body' => '\HuaweiCloud\SDK\Aos\V1\Model\DeleteStackInstanceRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\DeleteStackInstanceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\DeleteStackInstanceRequestBody|null $body body
    *
    * @return $this
    */
