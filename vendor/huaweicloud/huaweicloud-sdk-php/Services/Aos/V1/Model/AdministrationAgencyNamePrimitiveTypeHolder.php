...
class AdministrationAgencyNamePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AdministrationAgencyNamePrimitiveTypeHolder';
