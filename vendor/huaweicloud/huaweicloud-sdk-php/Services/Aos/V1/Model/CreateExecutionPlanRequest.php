...
class CreateExecutionPlanRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateExecutionPlanRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'stackName' => 'string',
            'body' => '\HuaweiCloud\SDK\Aos\V1\Model\CreateExecutionPlanRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\CreateExecutionPlanRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\CreateExecutionPlanRequestBody|null $body body
    *
    * @return $this
    */
