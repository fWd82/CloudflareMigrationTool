...
class ContinueRollbackStackRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ContinueRollbackStackRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'stackName' => 'string',
            'body' => '\HuaweiCloud\SDK\Aos\V1\Model\ContinueRollbackStackRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\ContinueRollbackStackRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\ContinueRollbackStackRequestBody|null $body body
    *
    * @return $this
    */
