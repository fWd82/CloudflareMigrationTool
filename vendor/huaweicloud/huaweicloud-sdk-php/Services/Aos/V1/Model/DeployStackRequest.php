...
class DeployStackRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeployStackRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'stackName' => 'string',
            'body' => '\HuaweiCloud\SDK\Aos\V1\Model\DeployStackRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\DeployStackRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\DeployStackRequestBody|null $body body
    *
    * @return $this
    */
