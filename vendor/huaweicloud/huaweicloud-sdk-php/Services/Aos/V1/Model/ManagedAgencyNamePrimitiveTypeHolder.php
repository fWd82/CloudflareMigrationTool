...
class ManagedAgencyNamePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ManagedAgencyNamePrimitiveTypeHolder';
