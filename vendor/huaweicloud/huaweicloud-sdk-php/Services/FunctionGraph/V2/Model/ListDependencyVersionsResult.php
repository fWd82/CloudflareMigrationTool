...
class ListDependencyVersionsResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDependencyVersionsResult';
    ...
    * Sets etag
    *
    * @param string $etag 依赖包唯一标志（MD5校验值）
    *
    * @return $this
    */
