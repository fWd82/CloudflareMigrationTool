...
class UpdateFunctionReservedInstancesCountRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateFunctionReservedInstancesCountRequestBody';
