...
class UpdateFunctionAsyncInvokeConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateFunctionAsyncInvokeConfigRequest';
    ...
    */
    protected static $openAPITypes = [
            'functionUrn' => 'string',
            'body' => '\HuaweiCloud\SDK\FunctionGraph\V2\Model\UpdateFunctionAsyncInvokeConfigRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\FunctionGraph\V2\Model\UpdateFunctionAsyncInvokeConfigRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\FunctionGraph\V2\Model\UpdateFunctionAsyncInvokeConfigRequestBody|null $body body
    *
    * @return $this
    */
