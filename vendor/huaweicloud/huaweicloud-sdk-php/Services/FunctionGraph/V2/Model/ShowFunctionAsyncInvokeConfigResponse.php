...
class ShowFunctionAsyncInvokeConfigResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowFunctionAsyncInvokeConfigResponse';
