...
class ListFunctionTriggerResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListFunctionTriggerResult';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['triggerStatus'] === null) {
            $invalidProperties[] = "'triggerStatus' can't be null";
        }
    ...
    *
    * @param string $triggerTypeCode 触发器类型。  - TIMER: \"定时触发器。\" - APIG: \"APIG触发器。\" - CTS: \"云审计服务触发器。\" - DDS: \"文档数据库服务触发器。\" - DMS: \"分布式服务触发器。\" - DIS: \"数据接入服务触发器。\" - LTS: \"云日志服务触发器。\" - OBS: \"对象存储触发器。\" - SMN: \"消息通知服务触发器。\" - KAFKA: \"专享版消息通知服务触发器。\"
    *
    * @return $this
    */
    ...
    * Sets triggerStatus
    *
    * @param string $triggerStatus \"触发器状态\"  - ACTIVE: 启用状态。 - DISABLED: 禁用状态。
    *
    * @return $this
    */
    ...
    *
    * @param \DateTime $lastUpdatedTime 最后更新时间。
    *
    * @return $this
    */
    ...
    * Sets createdTime
    *
    * @param \DateTime $createdTime 触发器创建时间。
    *
    * @return $this
    */
