...
class ListVersionAliasResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVersionAliasResult';
    ...
    * Sets lastModified
    *
    * @param \DateTime $lastModified 别名最后修改时间。
    *
    * @return $this
    */
    ...
    * Sets aliasUrn
    *
    * @param string $aliasUrn 版本别名唯一标识。
    *
    * @return $this
    */
