...
class UpdateTriggerRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'triggerId' => 'string',
            'body' => '\HuaweiCloud\SDK\FunctionGraph\V2\Model\UpdateTriggerRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\FunctionGraph\V2\Model\UpdateTriggerRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\FunctionGraph\V2\Model\UpdateTriggerRequestBody|null $body body
    *
    * @return $this
    */
