...
class NodeExecutionDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NodeExecutionDetail';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nodeId  流程节点ID
    * nodeName  流程节点名称
    * executionId  流程节点执行ID
    * executions  节点执行记录
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'nodeName' => 'string',
            'executionId' => 'string',
            'executions' => '\HuaweiCloud\SDK\FunctionGraph\V2\Model\NodeExecution[]'
    ];
    ...
    * Sets nodeName
    *
    * @param string|null $nodeName 流程节点名称
    *
    * @return $this
    */
    ...
    * Sets executionId
    *
    * @param string|null $executionId 流程节点执行ID
    *
    * @return $this
    */
    ...
    *  节点执行记录
    *
    * @return \HuaweiCloud\SDK\FunctionGraph\V2\Model\NodeExecution[]|null
    */
    ...
    * Sets executions
    *
    * @param \HuaweiCloud\SDK\FunctionGraph\V2\Model\NodeExecution[]|null $executions 节点执行记录
    *
    * @return $this
    */
