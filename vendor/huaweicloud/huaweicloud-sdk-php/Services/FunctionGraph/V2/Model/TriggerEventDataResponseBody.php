...
class TriggerEventDataResponseBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TriggerEventDataResponseBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  触发器名称
    * scheduleType  定时触发类型（TIMER触发器参数）。 - Rate：指定固定频率（分钟、小时、天数）定期调用函数，单位为分钟时，输入值不能超过60；单位为小时时，输入值不能超过24；单位为天时，输入值不能超过30。 - Cron：指定Cron表达式定期调用函数
    * schedule  定时触发规则（TIMER触发器参数）。 - 触发类型为Rate时对应定时规则 - 触发类型为Cron时对应Cron表达式
    ...
    * triggerid  APIG触发器id。（APIG触发器参数）
    * type  API接口类型（APIG触发器参数）。 - 1：公有API - 2：私有API
    * path  APIG接口PATH路径（APIG触发器参数）。
    * protocol  API的请求协议（APIG触发器参数）。
    * reqMethod  API的请求方式（APIG触发器参数）。
    * groupId  API所属的分组编号（APIG触发器参数）。
    * groupName  API所属的分组名称（APIG触发器参数）。
    * matchMode  API的匹配方式（APIG触发器参数）。 - SWA：前缀匹配 - NORMAL：正常匹配（绝对匹配）
    * envName  API的发布环境（APIG触发器参数）。
    * envId  API的发布环境id（APIG触发器参数）。
    * apiId  API编号（APIG触发器参数）。
    * apiName  API名称（APIG触发器参数）。
    * auth  API的认证方式（APIG触发器参数）。 - IAM：IAM认证，只允许IAM用户能访问，安全级别中等 - APP：采用Appkey&Appsecret认证，安全级别高，推荐使用 - NONE：无认证模式，所有用户均可访问，不推荐使用
    * invokeUrl  API调用地址（APIG触发器参数）。
    * funcInfo  funcInfo
    ...
    * romaAppId  API归属的集成应用编号。（APIG触发器参数）
    * operations  自定义操作（CTS触发器参数）。 CTS云审计服务类型和操作订阅所需要的事件通知，当CTS云审计服务获取已订阅的操作记录后，通过CTS触发器将采集到的操作记录作为参数传递来调用FunctionGraph函数。
    * collectionName  集合名称（DDS触发器参数）。
    * dbName  文档数据库名称（DDS触发器参数）。
    * dbPassword  文档数据库密码（DDS触发器参数）。
    * dbUser  文档数据库用户名（DDS触发器参数）。
    * instanceAddrs  文档数据库实例地址（DDS触发器参数）。
    * mode  文档数据库实例类型（DDS触发器参数）。 - Sharding：集群实例 - ReplicaSet：副本集实例 - Single：单节点实例
    ...
    * queueId  队列id（DMS触发器参数）。
    * consumerGroupId  消费组id（DMS触发器参数）。
    * pollingInterval  拉取周期。
    * streamName  通道名称（DIS触发器参数）。
    * sharditeratorType  起始位置（DIS触发器参数）。 - TRIM_HORIZON：从最早被存储至分区的有效记录开始读取。 - LATEST：从分区中的最新记录开始读取，此设置可以保证总是读到分区中最新记录。
    * pollingUnit  拉取周期单位（DIS触发器参数）。 - s：秒 - ms：毫秒
    * maxFetchBytes  最大提取字节数（DIS触发器参数）。
    * isSerial  串行处理数据（DIS触发器参数），如果开启该选项，取一次数据处理完之后才会取下一次数据；否则只要拉取周期到了就会取数据进行处理。
    * logGroupId  日志组id（LTS触发器参数）。
    * logTopicId  日志流id（LTS触发器参数）。
    * bucket  桶名称（OBS触发器参数），用作事件源的OBS存储桶，不能和本用户已有桶重名；不能和其他用户已有的桶重名；创建成功后不支持修改。
    * prefix  前缀（OBS触发器参数），输入一个可选性前缀来限制对以此关键字开头的对象的通知。
    * suffix  后缀（OBS触发器参数），输入一个可选性后缀来限制对以此关键字结尾的对象的通知
    * events  触发事件（OBS触发器参数）。 - ObjectCreated：表示所有创建对象的操作，包含Put、Post、Copy对象以及合并段 - Put：使用Put方法上传对象 - Post：使用Post方法上传对象 - Copy：使用copy方法复制对象 - CompleteMultipartUpload：表示合并分段任务 - ObjectRemoved：表示删除对象 - Delete：指定对象版本号删除对象 - DeleteMarkerCreated：不指定对象版本号删除对象
    * topicUrn  主题URN（SMN触发器参数）。
    * topicIds  KAFKA主题id列表（KAFKA触发器参数）。
    ...
    * accessPassword  RABBITMQ账户密码（RABBITMQ触发器参数）。
    * accessUser  RABBITMQ账户名（RABBITMQ触发器参数）。
    * connectAddress  实例连接IP地址（RABBITMQ触发器参数）。
    * exchangeName  交换机名称（RABBITMQ触发器参数）。
    ...
    */
    protected static $setters = [
            ...
            'dbUser' => 'setDbUser',
            'instanceAddrs' => 'setInstanceAddrs',
            'mode' => 'setMode',
    ...
    */
    protected static $getters = [
            ...
            'dbUser' => 'getDbUser',
            'instanceAddrs' => 'getInstanceAddrs',
            'mode' => 'getMode',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['invokeUrl'] = isset($data['invokeUrl']) ? $data['invokeUrl'] : null;
        ...
        $this->container['instanceAddrs'] = isset($data['instanceAddrs']) ? $data['instanceAddrs'] : null;
    ...
    * Sets scheduleType
    *
    * @param string|null $scheduleType 定时触发类型（TIMER触发器参数）。 - Rate：指定固定频率（分钟、小时、天数）定期调用函数，单位为分钟时，输入值不能超过60；单位为小时时，输入值不能超过24；单位为天时，输入值不能超过30。 - Cron：指定Cron表达式定期调用函数
    *
    * @return $this
    */
    ...
    * Sets schedule
    *
    * @param string|null $schedule 定时触发规则（TIMER触发器参数）。 - 触发类型为Rate时对应定时规则 - 触发类型为Cron时对应Cron表达式
    *
    * @return $this
    */
    ...
    * Sets triggerid
    *
    * @param string|null $triggerid APIG触发器id。（APIG触发器参数）
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param int|null $type API接口类型（APIG触发器参数）。 - 1：公有API - 2：私有API
    *
    * @return $this
    */
    ...
    * Sets path
    *
    * @param string|null $path APIG接口PATH路径（APIG触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets protocol
    *
    * @param string|null $protocol API的请求协议（APIG触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets reqMethod
    *
    * @param string|null $reqMethod API的请求方式（APIG触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets groupId
    *
    * @param string|null $groupId API所属的分组编号（APIG触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets groupName
    *
    * @param string|null $groupName API所属的分组名称（APIG触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets matchMode
    *
    * @param string|null $matchMode API的匹配方式（APIG触发器参数）。 - SWA：前缀匹配 - NORMAL：正常匹配（绝对匹配）
    *
    * @return $this
    */
    ...
    * Sets envName
    *
    * @param string|null $envName API的发布环境（APIG触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets envId
    *
    * @param string|null $envId API的发布环境id（APIG触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets apiId
    *
    * @param string|null $apiId API编号（APIG触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets apiName
    *
    * @param string|null $apiName API名称（APIG触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets auth
    *
    * @param string|null $auth API的认证方式（APIG触发器参数）。 - IAM：IAM认证，只允许IAM用户能访问，安全级别中等 - APP：采用Appkey&Appsecret认证，安全级别高，推荐使用 - NONE：无认证模式，所有用户均可访问，不推荐使用
    *
    * @return $this
    */
    ...
    */
    ...
    {
        return $this->container['invokeUrl'];
    }

    /**
    * Sets invokeUrl
    *
    * @param string|null $invokeUrl API调用地址（APIG触发器参数）。
    *
    * @return $this
    */
    public function setInvokeUrl($invokeUrl)
    {
        $this->container['invokeUrl'] = $invokeUrl;
        return $this;
    }
    ...
    * Sets romaAppId
    *
    * @param string|null $romaAppId API归属的集成应用编号。（APIG触发器参数）
    *
    * @return $this
    */
    ...
    * Sets operations
    *
    * @param string[]|null $operations 自定义操作（CTS触发器参数）。 CTS云审计服务类型和操作订阅所需要的事件通知，当CTS云审计服务获取已订阅的操作记录后，通过CTS触发器将采集到的操作记录作为参数传递来调用FunctionGraph函数。
    *
    * @return $this
    */
    ...
    * Sets collectionName
    *
    * @param string|null $collectionName 集合名称（DDS触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets dbName
    *
    * @param string|null $dbName 文档数据库名称（DDS触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets dbPassword
    *
    * @param string|null $dbPassword 文档数据库密码（DDS触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets dbUser
    *
    * @param string|null $dbUser 文档数据库用户名（DDS触发器参数）。
    *
    * @return $this
    */
    ...
    * @return string[]|null
    */
    public function getInstanceAddrs()
    {
        return $this->container['instanceAddrs'];
    }

    /**
    * Sets instanceAddrs
    *
    * @param string[]|null $instanceAddrs 文档数据库实例地址（DDS触发器参数）。
    *
    * @return $this
    */
    public function setInstanceAddrs($instanceAddrs)
    {
        $this->container['instanceAddrs'] = $instanceAddrs;
        return $this;
    }
    ...
    * Sets mode
    *
    * @param string|null $mode 文档数据库实例类型（DDS触发器参数）。 - Sharding：集群实例 - ReplicaSet：副本集实例 - Single：单节点实例
    *
    * @return $this
    */
    ...
    * Sets queueId
    *
    * @param string|null $queueId 队列id（DMS触发器参数）。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $consumerGroupId 消费组id（DMS触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets streamName
    *
    * @param string|null $streamName 通道名称（DIS触发器参数）。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $sharditeratorType 起始位置（DIS触发器参数）。 - TRIM_HORIZON：从最早被存储至分区的有效记录开始读取。 - LATEST：从分区中的最新记录开始读取，此设置可以保证总是读到分区中最新记录。
    *
    * @return $this
    */
    ...
    * Sets pollingUnit
    *
    * @param string|null $pollingUnit 拉取周期单位（DIS触发器参数）。 - s：秒 - ms：毫秒
    *
    * @return $this
    */
    ...
    * Sets isSerial
    *
    * @param string|null $isSerial 串行处理数据（DIS触发器参数），如果开启该选项，取一次数据处理完之后才会取下一次数据；否则只要拉取周期到了就会取数据进行处理。
    *
    * @return $this
    */
    ...
    * Sets logGroupId
    *
    * @param string|null $logGroupId 日志组id（LTS触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets logTopicId
    *
    * @param string|null $logTopicId 日志流id（LTS触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets bucket
    *
    * @param string|null $bucket 桶名称（OBS触发器参数），用作事件源的OBS存储桶，不能和本用户已有桶重名；不能和其他用户已有的桶重名；创建成功后不支持修改。
    *
    * @return $this
    */
    ...
    * Sets events
    *
    * @param string[]|null $events 触发事件（OBS触发器参数）。 - ObjectCreated：表示所有创建对象的操作，包含Put、Post、Copy对象以及合并段 - Put：使用Put方法上传对象 - Post：使用Post方法上传对象 - Copy：使用copy方法复制对象 - CompleteMultipartUpload：表示合并分段任务 - ObjectRemoved：表示删除对象 - Delete：指定对象版本号删除对象 - DeleteMarkerCreated：不指定对象版本号删除对象
    *
    * @return $this
    */
    ...
    * Sets topicUrn
    *
    * @param string|null $topicUrn 主题URN（SMN触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets topicIds
    *
    * @param string[]|null $topicIds KAFKA主题id列表（KAFKA触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets accessPassword
    *
    * @param string|null $accessPassword RABBITMQ账户密码（RABBITMQ触发器参数）。
    *
    * @return $this
    */
    ...
    * Sets exchangeName
    *
    * @param string|null $exchangeName 交换机名称（RABBITMQ触发器参数）。
    *
    * @return $this
    */
