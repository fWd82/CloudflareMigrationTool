...
class CreateVersionAliasRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateVersionAliasRequest';
    ...
    */
    protected static $openAPITypes = [
            'functionUrn' => 'string',
            'body' => '\HuaweiCloud\SDK\FunctionGraph\V2\Model\CreateVersionAliasRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\FunctionGraph\V2\Model\CreateVersionAliasRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\FunctionGraph\V2\Model\CreateVersionAliasRequestBody|null $body body
    *
    * @return $this
    */
