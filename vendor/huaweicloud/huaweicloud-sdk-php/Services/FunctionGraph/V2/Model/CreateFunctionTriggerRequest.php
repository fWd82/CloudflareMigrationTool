...
class CreateFunctionTriggerRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateFunctionTriggerRequest';
    ...
    */
    protected static $openAPITypes = [
            'functionUrn' => 'string',
            'body' => '\HuaweiCloud\SDK\FunctionGraph\V2\Model\CreateFunctionTriggerRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\FunctionGraph\V2\Model\CreateFunctionTriggerRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\FunctionGraph\V2\Model\CreateFunctionTriggerRequestBody|null $body body
    *
    * @return $this
    */
