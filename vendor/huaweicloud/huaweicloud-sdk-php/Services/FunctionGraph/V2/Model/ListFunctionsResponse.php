...
class ListFunctionsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'functions' => '\HuaweiCloud\SDK\FunctionGraph\V2\Model\ListFunctionResult[]',
            'nextMarker' => 'int',
            'count' => 'int'
    ];
    ...
    * Sets functions
    *
    * @param \HuaweiCloud\SDK\FunctionGraph\V2\Model\ListFunctionResult[]|null $functions 函数列表。
    *
    * @return $this
    */
    ...
    * Sets count
    *
    * @param int|null $count 满足查询条件的函数总数。
    *
    * @return $this
    */
