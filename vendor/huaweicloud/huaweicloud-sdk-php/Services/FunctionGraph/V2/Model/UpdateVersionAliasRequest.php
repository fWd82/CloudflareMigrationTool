...
class UpdateVersionAliasRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVersionAliasRequest';
    ...
    */
    protected static $openAPITypes = [
            'functionUrn' => 'string',
            'aliasName' => 'string',
            'body' => '\HuaweiCloud\SDK\FunctionGraph\V2\Model\UpdateVersionAliasRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aliasName'] === null) {
            $invalidProperties[] = "'aliasName' can't be null";
        }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\FunctionGraph\V2\Model\UpdateVersionAliasRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\FunctionGraph\V2\Model\UpdateVersionAliasRequestBody|null $body body
    *
    * @return $this
    */
