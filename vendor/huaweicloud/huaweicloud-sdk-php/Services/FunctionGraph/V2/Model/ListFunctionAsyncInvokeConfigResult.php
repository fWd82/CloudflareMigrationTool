...
class ListFunctionAsyncInvokeConfigResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListFunctionAsyncInvokeConfigResult';
