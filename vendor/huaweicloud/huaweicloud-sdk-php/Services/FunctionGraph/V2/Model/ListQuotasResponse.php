...
class ListQuotasResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'quotas' => '\HuaweiCloud\SDK\FunctionGraph\V2\Model\ListQuotasResult'
    ];
    ...
    *  quotas
    *
    * @return \HuaweiCloud\SDK\FunctionGraph\V2\Model\ListQuotasResult|null
    */
    ...
    * Sets quotas
    *
    * @param \HuaweiCloud\SDK\FunctionGraph\V2\Model\ListQuotasResult|null $quotas quotas
    *
    * @return $this
    */
