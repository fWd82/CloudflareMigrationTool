...
class CreateFunctionResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateFunctionResponse';
    ...
    * reservedInstanceCount  函数预留实例数量。
    * dependList  依赖id列表
    ...
    */
    protected static $setters = [
            ...
            'reservedInstanceCount' => 'setReservedInstanceCount',
    ...
    */
    protected static $getters = [
            ...
            'reservedInstanceCount' => 'getReservedInstanceCount',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['reservedInstanceCount'] = isset($data['reservedInstanceCount']) ? $data['reservedInstanceCount'] : null;
    ...
    * Sets version
    *
    * @param string|null $version 函数版本号。
    *
    * @return $this
    */
    ...
    */
    ...
    /**
    * Gets reservedInstanceCount
    *  函数预留实例数量。
    *
    * @return int|null
    */
    public function getReservedInstanceCount()
    {
        return $this->container['reservedInstanceCount'];
    }

    /**
    * Sets reservedInstanceCount
    *
    * @param int|null $reservedInstanceCount 函数预留实例数量。
    *
    * @return $this
    */
    public function setReservedInstanceCount($reservedInstanceCount)
    {
        $this->container['reservedInstanceCount'] = $reservedInstanceCount;
        return $this;
    }
