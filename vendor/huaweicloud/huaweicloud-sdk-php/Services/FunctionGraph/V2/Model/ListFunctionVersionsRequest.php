...
class ListFunctionVersionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListFunctionVersionsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * functionUrn  函数的URN，详细解释见FunctionGraph函数模型的描述。
    * marker  上一次查询到的最后的记录位置。
    * maxitems  每次查询获取的最大函数记录数量。
    *
    * @var string[]
    */
    ...
    * Sets maxitems
    *
    * @param string|null $maxitems 每次查询获取的最大函数记录数量。
    *
    * @return $this
    */
