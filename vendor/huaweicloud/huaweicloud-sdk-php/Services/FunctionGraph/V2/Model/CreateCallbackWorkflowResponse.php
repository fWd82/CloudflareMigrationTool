...
class CreateCallbackWorkflowResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCallbackWorkflowResponse';
    ...
    * Sets executionId
    *
    * @param string|null $executionId 错误码
    *
    * @return $this
    */
