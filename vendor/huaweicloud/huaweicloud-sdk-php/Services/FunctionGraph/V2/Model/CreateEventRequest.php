...
class CreateEventRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'functionUrn' => 'string',
            'body' => '\HuaweiCloud\SDK\FunctionGraph\V2\Model\CreateEventRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\FunctionGraph\V2\Model\CreateEventRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\FunctionGraph\V2\Model\CreateEventRequestBody|null $body body
    *
    * @return $this
    */
