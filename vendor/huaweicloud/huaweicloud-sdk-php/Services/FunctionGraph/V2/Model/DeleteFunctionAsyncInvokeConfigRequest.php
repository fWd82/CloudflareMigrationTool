...
class DeleteFunctionAsyncInvokeConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteFunctionAsyncInvokeConfigRequest';
