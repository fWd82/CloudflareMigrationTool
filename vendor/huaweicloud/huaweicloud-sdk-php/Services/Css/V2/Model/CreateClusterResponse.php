...
class CreateClusterResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'cluster' => '\HuaweiCloud\SDK\Css\V2\Model\CreateClusterResp',
            'orderId' => 'string'
    ];
    ...
    *  cluster
    *
    * @return \HuaweiCloud\SDK\Css\V2\Model\CreateClusterResp|null
    */
    ...
    * Sets cluster
    *
    * @param \HuaweiCloud\SDK\Css\V2\Model\CreateClusterResp|null $cluster cluster
    *
    * @return $this
    */
