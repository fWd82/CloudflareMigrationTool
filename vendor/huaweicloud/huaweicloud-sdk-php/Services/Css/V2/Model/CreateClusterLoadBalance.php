...
class CreateClusterLoadBalance implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateClusterLoadBalance';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['endpointWithDnsName'] === null) {
            $invalidProperties[] = "'endpointWithDnsName' can't be null";
        }
    ...
    *
    * @param bool $endpointWithDnsName 是否开启内网域名。 - true： 开启内网域名。 - false： 关闭内网域名。
    *
    * @return $this
    */
    ...
    * Sets vpcPermissions
    *
    * @param string[]|null $vpcPermissions 访问控制。
    *
    * @return $this
    */
