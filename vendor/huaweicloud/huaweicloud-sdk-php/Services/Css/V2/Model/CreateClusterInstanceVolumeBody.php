...
class CreateClusterInstanceVolumeBody implements ModelInterface, ArrayAccess
{
    ...
    * size  卷大小，必须为大于0且为4和10的公倍数，磁盘规格大小可以通过[获取实例规格列表](ListFlavors.xml)中diskrange属性获得。 单位：GB。  >ess-master节点和ess-client节点默认大小为40G，且不可更改。
    *
    * @var string[]
    */
    ...
    * Sets size
    *
    * @param int $size 卷大小，必须为大于0且为4和10的公倍数，磁盘规格大小可以通过[获取实例规格列表](ListFlavors.xml)中diskrange属性获得。 单位：GB。  >ess-master节点和ess-client节点默认大小为40G，且不可更改。
    *
    * @return $this
    */
