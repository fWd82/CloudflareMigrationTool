...
class EsHealthmonitorsResource implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EsHealthmonitorsResource';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  后端服务器ID。
    * name  后端服务器的名称。
    * protocolPort  后端服务的前端监听端口。
    * ipgroup  ipgroup
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'name' => 'string',
            'protocolPort' => 'string',
            'ipgroup' => '\HuaweiCloud\SDK\Css\V1\Model\EsHealthIpgroupResource'
    ];
    ...
    * Sets name
    *
    * @param string|null $name 后端服务器的名称。
    *
    * @return $this
    */
    ...
    * Sets protocolPort
    *
    * @param string|null $protocolPort 后端服务的前端监听端口。
    *
    * @return $this
    */
    ...
    *  ipgroup
    *
    * @return \HuaweiCloud\SDK\Css\V1\Model\EsHealthIpgroupResource|null
    */
    ...
    * Sets ipgroup
    *
    * @param \HuaweiCloud\SDK\Css\V1\Model\EsHealthIpgroupResource|null $ipgroup ipgroup
    *
    * @return $this
    */
