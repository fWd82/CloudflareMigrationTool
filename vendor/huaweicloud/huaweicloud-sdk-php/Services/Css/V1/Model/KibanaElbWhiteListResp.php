...
class KibanaElbWhiteListResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'kibanaElbWhiteListResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * enableWhiteList  是否开启kibana访问控制。 - true: 开启访问控制。 - false: 关闭访问控制
    * whiteList  kibana公网访问白名单。
    *
    * @var string[]
    */
    ...
    *
    * @param bool|null $enableWhiteList 是否开启kibana访问控制。 - true: 开启访问控制。 - false: 关闭访问控制
    *
    * @return $this
    */
    ...
    * Sets whiteList
    *
    * @param string|null $whiteList kibana公网访问白名单。
    *
    * @return $this
    */
