...
class ClusterListInstances implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ClusterListInstances';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * status  节点状态值。  - 100：创建中。 - 200：可用。 - 303：不可用，如创建失败。
    * type  当前节点的类型。
    * id  实例ID。
    * name  实例名字。
    * specCode  节点规格名称。
    ...
    * Sets status
    *
    * @param string|null $status 节点状态值。  - 100：创建中。 - 200：可用。 - 303：不可用，如创建失败。
    *
    * @return $this
    */
    ...
    *  volume
    *
    * @return \HuaweiCloud\SDK\Css\V1\Model\ClusterVolumeRsp|null
    */
    ...
    * Sets volume
    *
    * @param \HuaweiCloud\SDK\Css\V1\Model\ClusterVolumeRsp|null $volume volume
    *
    * @return $this
    */
