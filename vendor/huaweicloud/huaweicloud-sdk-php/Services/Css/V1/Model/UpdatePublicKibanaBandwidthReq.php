...
class UpdatePublicKibanaBandwidthReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePublicKibanaBandwidthReq';
    ...
    */
    protected static $openAPITypes = [
            'bandWidth' => '\HuaweiCloud\SDK\Css\V1\Model\UpdatePublicKibanaBandwidthReqBandWidth',
            'isAutoPay' => 'int'
    ];
    ...
    *  bandWidth
    *
    * @return \HuaweiCloud\SDK\Css\V1\Model\UpdatePublicKibanaBandwidthReqBandWidth
    */
    ...
    * Sets bandWidth
    *
    * @param \HuaweiCloud\SDK\Css\V1\Model\UpdatePublicKibanaBandwidthReqBandWidth $bandWidth bandWidth
    *
    * @return $this
    */
