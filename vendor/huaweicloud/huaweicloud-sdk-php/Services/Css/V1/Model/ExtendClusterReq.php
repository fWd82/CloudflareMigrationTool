...
class ExtendClusterReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExtendClusterReq';
    ...
    */
    protected static $openAPITypes = [
            'grow' => '\HuaweiCloud\SDK\Css\V1\Model\ExtendClusterGrowReq',
            'isAutoPay' => 'int'
    ];
    ...
    *  grow
    *
    * @return \HuaweiCloud\SDK\Css\V1\Model\ExtendClusterGrowReq
    */
    ...
    * Sets grow
    *
    * @param \HuaweiCloud\SDK\Css\V1\Model\ExtendClusterGrowReq $grow grow
    *
    * @return $this
    */
