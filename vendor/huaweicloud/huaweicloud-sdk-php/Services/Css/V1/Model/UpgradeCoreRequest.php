...
class UpgradeCoreRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpgradeCoreRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * clusterId  指定待升级的集群ID。
    * instType  指定待升级的节点类型，当前仅支持all。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'instType' => 'string',
            'body' => '\HuaweiCloud\SDK\Css\V1\Model\UpgradingTheKernelBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Css\V1\Model\UpgradingTheKernelBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Css\V1\Model\UpgradingTheKernelBody|null $body body
    *
    * @return $this
    */
