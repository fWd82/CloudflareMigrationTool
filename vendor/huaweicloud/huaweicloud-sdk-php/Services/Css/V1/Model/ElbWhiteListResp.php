...
class ElbWhiteListResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'elbWhiteListResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * enableWhiteList  是否开启公网访问控制。 - true: 开启公网访问控制。 - false: 关闭公网访问控制。
    * whiteList  公网访问白名单。
    *
    * @var string[]
    */
    ...
    *
    * @param bool|null $enableWhiteList 是否开启公网访问控制。 - true: 开启公网访问控制。 - false: 关闭公网访问控制。
    *
    * @return $this
    */
    ...
    * Sets whiteList
    *
    * @param string|null $whiteList 公网访问白名单。
    *
    * @return $this
    */
