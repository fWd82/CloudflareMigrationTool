...
class UpdatePublicKibanaWhitelistReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePublicKibanaWhitelistReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * whiteList  允许kibana公网访问的白名单ip或网段，以逗号隔开，不可重复。
    *
    * @var string[]
    */
    ...
    * Sets whiteList
    *
    * @param string $whiteList 允许kibana公网访问的白名单ip或网段，以逗号隔开，不可重复。
    *
    * @return $this
    */
