...
class ClusterList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ClusterList';
    ...
    * name  集群名称。
    * publicIp  公网IP信息。
    * created  集群创建时间，格式为ISO8601：CCYY-MM-DDThh:mm:ss。  返回的集群列表信息按照创建时间降序排序，即创建时间最新的集群排在最前。
    * id  集群ID。
    * status  集群状态值。  - 100：创建中。 - 200：可用。 - 303：不可用，如创建失败。
    ...
    * authorityEnable  是否开启认证。 - true：表示集群开启认证。 - false：表示集群不开启认证。
    * diskEncrypted  磁盘是否加密。  - true : 磁盘已加密。 - false : 磁盘未加密。
    * backupAvailable  快照是否开启。 - true: 快照开启状态。 - false: 快照关闭状态。
    * actionProgress  集群行为进度，显示创建或扩容进度的百分比等。CREATING表示创建的百分比。
    ...
    *  datastore
    *
    * @return \HuaweiCloud\SDK\Css\V1\Model\ClusterListDatastore|null
    */
    ...
    * Sets datastore
    *
    * @param \HuaweiCloud\SDK\Css\V1\Model\ClusterListDatastore|null $datastore datastore
    *
    * @return $this
    */
    ...
    *  节点对象列表。
    *
    * @return \HuaweiCloud\SDK\Css\V1\Model\ClusterListInstances[]|null
    */
    ...
    * Sets instances
    *
    * @param \HuaweiCloud\SDK\Css\V1\Model\ClusterListInstances[]|null $instances 节点对象列表。
    *
    * @return $this
    */
    ...
    * Sets created
    *
    * @param string|null $created 集群创建时间，格式为ISO8601：CCYY-MM-DDThh:mm:ss。  返回的集群列表信息按照创建时间降序排序，即创建时间最新的集群排在最前。
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status 集群状态值。  - 100：创建中。 - 200：可用。 - 303：不可用，如创建失败。
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $authorityEnable 是否开启认证。 - true：表示集群开启认证。 - false：表示集群不开启认证。
    *
    * @return $this
    */
    ...
    * Sets actionProgress
    *
    * @param object|null $actionProgress 集群行为进度，显示创建或扩容进度的百分比等。CREATING表示创建的百分比。
    *
    * @return $this
    */
    ...
    *  集群标签。
    *
    * @return \HuaweiCloud\SDK\Css\V1\Model\ClusterListTags[]|null
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Css\V1\Model\ClusterListTags[]|null $tags 集群标签。
    *
    * @return $this
    */
    ...
    *  failedReason
    *
    * @return \HuaweiCloud\SDK\Css\V1\Model\ClusterListFailedReasons|null
    */
    ...
    * Sets failedReason
    *
    * @param \HuaweiCloud\SDK\Css\V1\Model\ClusterListFailedReasons|null $failedReason failedReason
    *
    * @return $this
    */
