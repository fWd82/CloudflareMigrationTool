...
class UpgradeDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpgradeDetailRequest';
    ...
    * Sets limit
    *
    * @param int|null $limit 查询返回终端节点服务的连接列表限制每页个数，即每页返回的个数。
    *
    * @return $this
    */
    ...
    * Sets actionMode
    *
    * @param string|null $actionMode 查询升级行为。 - 查询集群版本升级详情：不填写该参数。 - 查询切换AZ详情：当前仅支持AZ_MIGRATION。
    *
    * @return $this
    */
