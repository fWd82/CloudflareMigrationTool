...
class CloseKibanaPublicReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CloseKibanaPublicReq';
    ...
    * Sets eipSize
    *
    * @param int|null $eipSize 带宽。单位：Mbit/s
    *
    * @return $this
    */
