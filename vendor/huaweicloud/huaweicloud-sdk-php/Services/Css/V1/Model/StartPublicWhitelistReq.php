...
class StartPublicWhitelistReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StartPublicWhitelistReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * whiteList  开启白名单的用户IP。
    *
    * @var string[]
    */
    ...
    * Sets whiteList
    *
    * @param string $whiteList 开启白名单的用户IP。
    *
    * @return $this
    */
