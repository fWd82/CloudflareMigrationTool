...
class EsListenerResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EsListenerResponse';
    ...
    * Sets protocol
    *
    * @param string|null $protocol 监听器的监听协议。
    *
    * @return $this
    */
    ...
    * Sets protocolPort
    *
    * @param string|null $protocolPort 监听器的前端监听端口。
    *
    * @return $this
    */
    ...
    *  ipgroup
    *
    * @return \HuaweiCloud\SDK\Css\V1\Model\EsIpgroupResource|null
    */
    ...
    * Sets ipgroup
    *
    * @param \HuaweiCloud\SDK\Css\V1\Model\EsIpgroupResource|null $ipgroup ipgroup
    *
    * @return $this
    */
