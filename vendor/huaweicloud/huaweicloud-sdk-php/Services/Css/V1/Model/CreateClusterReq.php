...
class CreateClusterReq implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'cluster' => '\HuaweiCloud\SDK\Css\V1\Model\CreateClusterBody'
    ];
    ...
    *  cluster
    *
    * @return \HuaweiCloud\SDK\Css\V1\Model\CreateClusterBody
    */
    ...
    * Sets cluster
    *
    * @param \HuaweiCloud\SDK\Css\V1\Model\CreateClusterBody $cluster cluster
    *
    * @return $this
    */
