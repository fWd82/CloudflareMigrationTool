...
class UpdateEsElbRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateEsElbRequestBody';
    ...
    * Sets enable
    *
    * @param bool $enable 打开或关闭es负载均衡器。 - true：开启。 - false：关闭。
    *
    * @return $this
    */
