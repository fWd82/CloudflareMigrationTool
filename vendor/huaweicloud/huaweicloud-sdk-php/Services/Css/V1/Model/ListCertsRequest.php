...
class ListCertsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCertsRequest';
    ...
    * Sets limit
    *
    * @param string|null $limit 指定查询个数，默认值为10，即一次查询10个证书信息。
    *
    * @return $this
    */
    ...
    */
    ...
    {
        return $this->container['certsType'];
    }

    /**
    * Sets certsType
    *
    * @param string|null $certsType 证书类型。defaultCerts为默认证书类型，不指定查询证书类型默认查找自定义证书列表。
    *
    * @return $this
    */
    public function setCertsType($certsType)
    {
        $this->container['certsType'] = $certsType;
        return $this;
    }
