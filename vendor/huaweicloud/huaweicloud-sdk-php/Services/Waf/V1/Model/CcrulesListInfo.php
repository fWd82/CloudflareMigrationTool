...
class CcrulesListInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CcrulesListInfo';
    ...
    * prefix  路径是否为前缀模式，当防护url以*结束，则为前缀模式。当mode值为0时，该参数有返回值。
    ...
    * Sets prefix
    *
    * @param bool|null $prefix 路径是否为前缀模式，当防护url以*结束，则为前缀模式。当mode值为0时，该参数有返回值。
    *
    * @return $this
    */
