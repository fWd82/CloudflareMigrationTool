...
class ApplyCertificateToHostRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ApplyCertificateToHostRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * contentType  内容类型
    * enterpriseProjectId  您可以通过调用企业项目管理服务（EPS）的查询企业项目列表接口（ListEnterpriseProject）查询企业项目id
    * certificateId  https证书id，您可以通过调用查询证书列表（ListCertificates）接口获取证书id
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\ApplyCertificateToHostRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\ApplyCertificateToHostRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\ApplyCertificateToHostRequestBody|null $body body
    *
    * @return $this
    */
