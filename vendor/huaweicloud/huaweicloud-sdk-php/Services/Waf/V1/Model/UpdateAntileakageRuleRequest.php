...
class UpdateAntileakageRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAntileakageRuleRequest';
    ...
    * ruleId  防敏感信息泄露规则id，通过查询防敏感信息泄露规则列表接口（ListAntileakageRules）获取
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'string',
            'ruleId' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\UpdateAntileakageRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\UpdateAntileakageRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\UpdateAntileakageRuleRequestBody|null $body body
    *
    * @return $this
    */
