...
class ChangePrepaidCloudWafRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangePrepaidCloudWafRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'isAutoPay' => 'bool',
            'wafProductInfo' => '\HuaweiCloud\SDK\Waf\V1\Model\AlterWafProductInfo',
    ...
    *  wafProductInfo
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\AlterWafProductInfo|null
    */
    ...
    * Sets wafProductInfo
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\AlterWafProductInfo|null $wafProductInfo wafProductInfo
    *
    * @return $this
    */
