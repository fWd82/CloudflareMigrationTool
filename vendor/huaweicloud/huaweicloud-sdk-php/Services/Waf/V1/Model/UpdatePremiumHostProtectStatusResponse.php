...
class UpdatePremiumHostProtectStatusResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePremiumHostProtectStatusResponse';
