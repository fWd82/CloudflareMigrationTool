...
class CreateCcRuleRequestBodyAction implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCcRuleRequestBody_action';
    ...
    */
    protected static $openAPITypes = [
            'category' => 'string',
            'detail' => '\HuaweiCloud\SDK\Waf\V1\Model\CreateCcRuleRequestBodyActionDetail'
    ];
    ...
    *  detail
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\CreateCcRuleRequestBodyActionDetail|null
    */
    ...
    * Sets detail
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\CreateCcRuleRequestBodyActionDetail|null $detail detail
    *
    * @return $this
    */
