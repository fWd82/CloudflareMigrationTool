...
class UpdateAntiTamperRuleRefreshRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAntiTamperRuleRefreshRequest';
    ...
    * ruleId  防篡改规则id，通过查询防篡改规则列表接口（ListAntitamperRule）获取
    *
    * @var string[]
    */
