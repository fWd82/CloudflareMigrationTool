...
class CreateAntileakageRuleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAntileakageRuleRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * url  规则应用的url
    * category  类别（响应码：code，敏感信息：sensitive）
    * contents  规则内容（http状态码：400 、401、402 、 403 、404 、 405 、500 、501 、502 、503、 504 、507；手机：phone、身份证号：id_card、邮箱：email）
    * description  规则描述
    *
    * @var string[]
    */
    ...
    * Sets contents
    *
    * @param string[] $contents 规则内容（http状态码：400 、401、402 、 403 、404 、 405 、500 、501 、502 、503、 504 、507；手机：phone、身份证号：id_card、邮箱：email）
    *
    * @return $this
    */
