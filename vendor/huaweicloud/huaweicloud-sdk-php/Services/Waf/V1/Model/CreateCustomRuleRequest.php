...
class CreateCustomRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCustomRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\CreateCustomRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\CreateCustomRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\CreateCustomRuleRequestBody|null $body body
    *
    * @return $this
    */
