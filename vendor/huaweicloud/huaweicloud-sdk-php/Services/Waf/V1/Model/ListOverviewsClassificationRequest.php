...
class ListOverviewsClassificationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListOverviewsClassificationRequest';
    ...
    * Sets top
    *
    * @param int|null $top 要查询的前几的结果，最大值为10，默认值为5。
    *
    * @return $this
    */
