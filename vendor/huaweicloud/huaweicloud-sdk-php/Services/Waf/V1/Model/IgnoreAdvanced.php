...
class IgnoreAdvanced implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IgnoreAdvanced';
    ...
    * Sets contents
    *
    * @param string[]|null $contents 指定字段类型的子字段，默认值为“全部”
    *
    * @return $this
    */
