...
class MigrateCompositeHostsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MigrateCompositeHostsRequestBody';
    ...
    * Sets hostIds
    *
    * @param string[] $hostIds host_id列表
    *
    * @return $this
    */
    ...
    * Sets policyId
    *
    * @param string $policyId 策略ID（目标企业项目下的策略ID）
    *
    * @return $this
    */
