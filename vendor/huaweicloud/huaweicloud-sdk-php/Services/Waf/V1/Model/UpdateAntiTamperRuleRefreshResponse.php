...
class UpdateAntiTamperRuleRefreshResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAntiTamperRuleRefreshResponse';
    ...
    * Sets description
    *
    * @param string|null $description 创建规则的时间戳
    *
    * @return $this
    */
