...
class CreateCcRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCcRuleResponse';
    ...
    * id  Rule ID.
    * policyid  Policy ID.
    * url  当mode值为0时，该参数有返回值。规则应用的URL链接。
    ...
    * Sets url
    *
    * @param string|null $url 当mode值为0时，该参数有返回值。规则应用的URL链接。
    *
    * @return $this
    */
