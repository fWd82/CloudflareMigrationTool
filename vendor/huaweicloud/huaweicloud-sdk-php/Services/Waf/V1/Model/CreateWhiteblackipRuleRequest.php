...
class CreateWhiteblackipRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateWhiteblackipRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\CreateWhiteBlackIpRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\CreateWhiteBlackIpRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\CreateWhiteBlackIpRuleRequestBody|null $body body
    *
    * @return $this
    */
