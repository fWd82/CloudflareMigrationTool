...
class CreateCcRuleRequestBodyActionDetailResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCcRuleRequestBody_action_detail_response';
    ...
    * Sets content
    *
    * @param string|null $content 防护页面内容
    *
    * @return $this
    */
