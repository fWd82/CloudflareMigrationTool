...
class UpdatePremiumHostResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePremiumHostResponse';
    ...
    * Sets lbAlgorithm
    *
    * @param string|null $lbAlgorithm LB负载均衡，默认轮询，不支持修改
    *
    * @return $this
    */
