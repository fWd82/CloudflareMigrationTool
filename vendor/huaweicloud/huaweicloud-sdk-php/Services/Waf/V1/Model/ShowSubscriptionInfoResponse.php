...
class ShowSubscriptionInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSubscriptionInfoResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'isNewUser' => 'bool',
            'premium' => '\HuaweiCloud\SDK\Waf\V1\Model\Premium'
    ];
    ...
    *  premium
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\Premium|null
    */
    ...
    * Sets premium
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\Premium|null $premium premium
    *
    * @return $this
    */
