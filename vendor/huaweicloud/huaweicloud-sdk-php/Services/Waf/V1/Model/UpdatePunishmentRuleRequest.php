...
class UpdatePunishmentRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePunishmentRuleRequest';
    ...
    * ruleId  攻击惩罚规则id，通过查询攻击惩罚规则列表接口（ListPunishmentRules）获取
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'string',
            'ruleId' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\UpdatePunishmentRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\UpdatePunishmentRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\UpdatePunishmentRuleRequestBody|null $body body
    *
    * @return $this
    */
