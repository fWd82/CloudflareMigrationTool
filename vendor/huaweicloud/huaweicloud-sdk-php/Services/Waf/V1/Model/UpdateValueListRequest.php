...
class UpdateValueListRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateValueListRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * contentType  内容类型
    * enterpriseProjectId  您可以通过调用企业项目管理服务（EPS）的查询企业项目列表接口（ListEnterpriseProject）查询企业项目id
    * valuelistid  引用表id，通过查询引用表列表（ListValueList）接口获取
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'valuelistid' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\UpdateValueListRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['valuelistid'] === null) {
            $invalidProperties[] = "'valuelistid' can't be null";
        }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\UpdateValueListRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\UpdateValueListRequestBody|null $body body
    *
    * @return $this
    */
