...
class UpdateWhiteBlackIpRuleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateWhiteBlackIpRuleRequestBody';
    ...
    * ipGroupId  创建的Ip地址组id，该参数与addr参数使用一个即可；Ip地址组可在控制台中对象管理->地址组管理中添加。
    *
    * @var string[]
    */
    ...
    * Sets ipGroupId
    *
    * @param string|null $ipGroupId 创建的Ip地址组id，该参数与addr参数使用一个即可；Ip地址组可在控制台中对象管理->地址组管理中添加。
    *
    * @return $this
    */
