...
class CreateAntileakageRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAntileakageRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\CreateAntileakageRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\CreateAntileakageRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\CreateAntileakageRuleRequestBody|null $body body
    *
    * @return $this
    */
