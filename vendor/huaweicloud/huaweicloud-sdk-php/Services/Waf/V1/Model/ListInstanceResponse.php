...
class ListInstanceResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'purchased' => 'bool',
            'items' => '\HuaweiCloud\SDK\Waf\V1\Model\ListInstance[]'
    ];
    ...
    * Sets purchased
    *
    * @param bool|null $purchased 是否曾经购买过独享引擎
    *
    * @return $this
    */
    ...
    *  详细的独享引擎信息列表
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\ListInstance[]|null
    */
    ...
    * Sets items
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\ListInstance[]|null $items 详细的独享引擎信息列表
    *
    * @return $this
    */
