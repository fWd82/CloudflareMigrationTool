...
class UpdateWhiteblackipRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateWhiteblackipRuleRequest';
    ...
    * ruleId  黑白名单规则id，您可以调用查询黑白名单规则列表（ListWhiteblackipRule）获取黑白名单规则id
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'string',
            'ruleId' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\UpdateWhiteBlackIpRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\UpdateWhiteBlackIpRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\UpdateWhiteBlackIpRuleRequestBody|null $body body
    *
    * @return $this
    */
