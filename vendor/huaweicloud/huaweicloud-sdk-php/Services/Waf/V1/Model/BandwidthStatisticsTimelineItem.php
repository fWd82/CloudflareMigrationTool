...
class BandwidthStatisticsTimelineItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BandwidthStatisticsTimelineItem';
    ...
    * Sets key
    *
    * @param string|null $key 键值，包括带宽（BANDWIDTH）、入带宽（IN_BANDWIDTH）以及出带宽（OUT_BANDWIDTH）
    *
    * @return $this
    */
