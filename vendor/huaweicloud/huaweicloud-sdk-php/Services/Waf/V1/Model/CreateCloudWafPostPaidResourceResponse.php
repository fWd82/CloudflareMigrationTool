...
class CreateCloudWafPostPaidResourceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCloudWafPostPaidResourceResponse';
