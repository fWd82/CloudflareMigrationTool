...
class ListQpsTimelineRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListQpsTimelineRequest';
    ...
    * instances  要查询引擎实例id（仅独享或者ELB实例化模式涉及）
    ...
    * Sets instances
    *
    * @param string|null $instances 要查询引擎实例id（仅独享或者ELB实例化模式涉及）
    *
    * @return $this
    */
