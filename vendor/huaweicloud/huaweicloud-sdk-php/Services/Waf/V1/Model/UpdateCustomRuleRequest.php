...
class UpdateCustomRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCustomRuleRequest';
    ...
    * ruleId  精准防护规则id，通过查询精准防护规则列表接口（ListCustomRules）获取
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'string',
            'ruleId' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\UpdateCustomRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\UpdateCustomRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\UpdateCustomRuleRequestBody|null $body body
    *
    * @return $this
    */
