...
class UpdateValueListRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateValueListRequestBody';
    ...
    */
    ...
    const TYPE_RESOPNSE_BODY = 'resopnse_body';
