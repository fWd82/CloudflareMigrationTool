...
class OrganizationPolicyAssignmentResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OrganizationPolicyAssignmentResponse';
