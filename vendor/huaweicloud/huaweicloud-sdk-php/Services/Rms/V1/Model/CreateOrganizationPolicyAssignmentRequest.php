...
class CreateOrganizationPolicyAssignmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateOrganizationPolicyAssignmentRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Rms\V1\Model\OrganizationPolicyAssignmentRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\OrganizationPolicyAssignmentRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\OrganizationPolicyAssignmentRequest|null $body body
    *
    * @return $this
    */
