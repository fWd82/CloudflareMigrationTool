...
class ShowAggregateDiscoveredResourceCountsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'groupByKey' => 'string',
            'groupedResourceCounts' => '\HuaweiCloud\SDK\Rms\V1\Model\GroupedResourceCount[]',
    ...
    *  分组资源计数的列表。
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\GroupedResourceCount[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\GroupedResourceCount[]|null $groupedResourceCounts 分组资源计数的列表。
    *
    * @return $this
    */
