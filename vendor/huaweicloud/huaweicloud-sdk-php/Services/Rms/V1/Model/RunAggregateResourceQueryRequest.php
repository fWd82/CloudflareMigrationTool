...
class RunAggregateResourceQueryRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'aggregatorId' => 'string',
            'body' => '\HuaweiCloud\SDK\Rms\V1\Model\QueryRunRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\QueryRunRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\QueryRunRequestBody|null $body body
    *
    * @return $this
    */
