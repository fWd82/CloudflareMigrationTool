...
class ListAggregationAuthorizationsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'aggregationAuthorizations' => '\HuaweiCloud\SDK\Rms\V1\Model\AggregationAuthorizationResp[]',
    ...
    *  授权过的资源聚合器帐号列表。
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\AggregationAuthorizationResp[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\AggregationAuthorizationResp[]|null $aggregationAuthorizations 授权过的资源聚合器帐号列表。
    *
    * @return $this
    */
