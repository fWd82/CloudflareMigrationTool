...
class ShowAggregateComplianceDetailsByPolicyAssignmentRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'limit' => 'int',
            'marker' => 'string',
            'body' => '\HuaweiCloud\SDK\Rms\V1\Model\AggregateComplianceDetailRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\AggregateComplianceDetailRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\AggregateComplianceDetailRequest|null $body body
    *
    * @return $this
    */
