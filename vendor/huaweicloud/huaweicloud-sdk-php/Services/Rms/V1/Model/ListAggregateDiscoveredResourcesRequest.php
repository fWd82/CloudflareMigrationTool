...
class ListAggregateDiscoveredResourcesRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'limit' => 'int',
            'marker' => 'string',
            'body' => '\HuaweiCloud\SDK\Rms\V1\Model\AggregateDiscoveredResourcesRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\AggregateDiscoveredResourcesRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\AggregateDiscoveredResourcesRequest|null $body body
    *
    * @return $this
    */
