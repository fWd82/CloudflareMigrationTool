...
class CreateConfigurationAggregatorResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateConfigurationAggregatorResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'accountAggregationSources' => '\HuaweiCloud\SDK\Rms\V1\Model\AccountAggregationSource',
            'updatedAt' => 'string',
            'createdAt' => 'string'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\AccountAggregationSource|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\AccountAggregationSource|null $accountAggregationSources accountAggregationSources
    *
    * @return $this
    */
