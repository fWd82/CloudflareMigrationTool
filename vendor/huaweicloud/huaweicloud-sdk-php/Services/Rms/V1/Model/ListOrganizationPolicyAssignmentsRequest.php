...
class ListOrganizationPolicyAssignmentsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListOrganizationPolicyAssignmentsRequest';
