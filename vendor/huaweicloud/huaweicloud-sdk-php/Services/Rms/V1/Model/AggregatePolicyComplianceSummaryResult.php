...
class AggregatePolicyComplianceSummaryResult implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceDetails' => '\HuaweiCloud\SDK\Rms\V1\Model\PolicyComplianceSummaryUnit',
            'assignmentDetails' => '\HuaweiCloud\SDK\Rms\V1\Model\PolicyComplianceSummaryUnit',
            'groupName' => 'string'
    ];
    ...
    *  resourceDetails
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\PolicyComplianceSummaryUnit|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\PolicyComplianceSummaryUnit|null $resourceDetails resourceDetails
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\PolicyComplianceSummaryUnit|null $assignmentDetails assignmentDetails
    *
    * @return $this
    */
