...
class AggregateResourceConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'aggregatorId' => 'string',
            'resourceIdentifier' => '\HuaweiCloud\SDK\Rms\V1\Model\ResourceIdentifier'
    ];
    ...
    *  resourceIdentifier
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\ResourceIdentifier
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\ResourceIdentifier $resourceIdentifier resourceIdentifier
    *
    * @return $this
    */
