...
class ListAggregateComplianceByPolicyAssignmentRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'limit' => 'int',
            'marker' => 'string',
            'body' => '\HuaweiCloud\SDK\Rms\V1\Model\AggregatePolicyAssignmentsRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\AggregatePolicyAssignmentsRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\AggregatePolicyAssignmentsRequest|null $body body
    *
    * @return $this
    */
