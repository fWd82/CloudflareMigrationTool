...
class DeleteOrganizationPolicyAssignmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteOrganizationPolicyAssignmentRequest';
