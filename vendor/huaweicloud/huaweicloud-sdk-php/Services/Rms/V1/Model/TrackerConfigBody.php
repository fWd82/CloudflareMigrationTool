...
class TrackerConfigBody implements ModelInterface, ArrayAccess
{
    ...
    *  channel
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\ChannelConfigBody
    */
    ...
    * Sets channel
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\ChannelConfigBody $channel channel
    *
    * @return $this
    */
    ...
    *  selector
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\SelectorConfigBody
    */
    ...
    * Sets selector
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\SelectorConfigBody $selector selector
    *
    * @return $this
    */
