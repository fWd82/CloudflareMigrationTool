...
class AggregateDiscoveredResourceCountsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'aggregatorId' => 'string',
            'filter' => '\HuaweiCloud\SDK\Rms\V1\Model\ResourceCountsFilters',
            'groupByKey' => 'string'
    ];
    ...
    *  filter
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\ResourceCountsFilters|null
    */
    ...
    * Sets filter
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\ResourceCountsFilters|null $filter filter
    *
    * @return $this
    */
