...
class AggregateDiscoveredResourcesRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'aggregatorId' => 'string',
            'filter' => '\HuaweiCloud\SDK\Rms\V1\Model\ResourcesFilters',
            'provider' => 'string',
            'resourceType' => 'string'
    ];
    ...
    *  filter
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\ResourcesFilters|null
    */
    ...
    * Sets filter
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\ResourcesFilters|null $filter filter
    *
    * @return $this
    */
