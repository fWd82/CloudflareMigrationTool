...
class HistoryItem implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'captureTime' => 'string',
            'status' => 'string',
            'relations' => '\HuaweiCloud\SDK\Rms\V1\Model\ResourceRelation[]',
            'resource' => '\HuaweiCloud\SDK\Rms\V1\Model\ResourceEntity'
    ];
    ...
    * Sets captureTime
    *
    * @param string|null $captureTime 该资源在RMS系统捕获时间
    *
    * @return $this
    */
    ...
    *  资源关系列表
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\ResourceRelation[]|null
    */
    ...
    * Sets relations
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\ResourceRelation[]|null $relations 资源关系列表
    *
    * @return $this
    */
    ...
    *  resource
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\ResourceEntity|null
    */
    ...
    * Sets resource
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\ResourceEntity|null $resource resource
    *
    * @return $this
    */
