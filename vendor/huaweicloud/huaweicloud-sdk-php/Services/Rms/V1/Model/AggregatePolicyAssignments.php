...
class AggregatePolicyAssignments implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'compliance' => '\HuaweiCloud\SDK\Rms\V1\Model\Compliance',
            'accountId' => 'string'
    ];
    ...
    *  compliance
    *
    * @return \HuaweiCloud\SDK\Rms\V1\Model\Compliance|null
    */
    ...
    * Sets compliance
    *
    * @param \HuaweiCloud\SDK\Rms\V1\Model\Compliance|null $compliance compliance
    *
    * @return $this
    */
