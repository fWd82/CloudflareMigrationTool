...
class CreateOrganizationPolicyAssignmentResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateOrganizationPolicyAssignmentResponse';
