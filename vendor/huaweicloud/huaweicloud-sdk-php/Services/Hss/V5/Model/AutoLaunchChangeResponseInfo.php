...
class AutoLaunchChangeResponseInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AutoLaunchChangeResponseInfo';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['runUser']) && (mb_strlen($this->container['runUser']) > 64)) {
                $invalidProperties[] = "invalid value for 'runUser', the character length must be smaller than or equal to 64.";
            }
