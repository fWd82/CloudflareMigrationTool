...
class ListHostVulsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListHostVulsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\HostVulInfo[]'
    ];
    ...
    *  服务器上的漏洞列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\HostVulInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\HostVulInfo[]|null $dataList 服务器上的漏洞列表
    *
    * @return $this
    */
