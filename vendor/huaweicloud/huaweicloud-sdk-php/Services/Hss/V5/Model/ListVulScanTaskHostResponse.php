...
class ListVulScanTaskHostResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulScanTaskHostResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  总数
    * dataList  漏洞扫描任务对应的主机列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\VulScanTaskHostInfo[]'
    ];
    ...
    *  漏洞扫描任务对应的主机列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\VulScanTaskHostInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\VulScanTaskHostInfo[]|null $dataList 漏洞扫描任务对应的主机列表
    *
    * @return $this
    */
