...
class ListUserChangeHistoriesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListUserChangeHistoriesResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\UserChangeHistoryResponseInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 账号变动总数
    *
    * @return $this
    */
    ...
    *  账号历史变动记录列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\UserChangeHistoryResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\UserChangeHistoryResponseInfo[]|null $dataList 账号历史变动记录列表
    *
    * @return $this
    */
