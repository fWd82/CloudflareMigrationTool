...
class ListHostStatusResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListHostStatusResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  总数
    * dataList  查询弹性云服务器状态列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\Host[]'
    ];
    ...
    *  查询弹性云服务器状态列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\Host[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\Host[]|null $dataList 查询弹性云服务器状态列表
    *
    * @return $this
    */
