...
class ListProcessesHostRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProcessesHostRequest';
    ...
    * Sets category
    *
    * @param string|null $category 类型，默认为host，包含如下： - host：主机 - container：容器
    *
    * @return $this
    */
