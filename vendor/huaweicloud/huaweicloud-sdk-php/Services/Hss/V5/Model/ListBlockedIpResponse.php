...
class ListBlockedIpResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBlockedIpResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\BlockedIpResponseInfo[]'
    ];
    ...
    *  已拦截IP详情
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\BlockedIpResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\BlockedIpResponseInfo[]|null $dataList 已拦截IP详情
    *
    * @return $this
    */
