...
class ListPortHostResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPortHostResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\PortHostResponseInfo[]'
    ];
    ...
    *  机器信息列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\PortHostResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\PortHostResponseInfo[]|null $dataList 机器信息列表
    *
    * @return $this
    */
