...
class ChangeBlockedIpRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeBlockedIpRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\ChangeBlockedIpRequestInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ChangeBlockedIpRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ChangeBlockedIpRequestInfo|null $body body
    *
    * @return $this
    */
