...
class ListContainerNodesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListContainerNodesResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ContainerNodeInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 容器节点总数
    *
    * @return $this
    */
    ...
    *  容器节点列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ContainerNodeInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ContainerNodeInfo[]|null $dataList 容器节点列表
    *
    * @return $this
    */
