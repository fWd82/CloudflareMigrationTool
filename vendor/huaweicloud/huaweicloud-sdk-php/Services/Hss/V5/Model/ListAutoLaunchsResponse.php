...
class ListAutoLaunchsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAutoLaunchsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\AutoLauchResponseInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 自启动项总数
    *
    * @return $this
    */
    ...
    *  自启动项列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AutoLauchResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AutoLauchResponseInfo[]|null $dataList 自启动项列表
    *
    * @return $this
    */
