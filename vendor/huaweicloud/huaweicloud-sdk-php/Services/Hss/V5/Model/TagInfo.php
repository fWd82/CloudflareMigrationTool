...
class TagInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TagInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  键。最大长度128个unicode字符。 key不能为空
    * value  值。最大长度255个unicode字符。
    *
    * @var string[]
    */
    ...
    * Sets value
    *
    * @param string|null $value 值。最大长度255个unicode字符。
    *
    * @return $this
    */
