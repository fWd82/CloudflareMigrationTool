...
class SetRaspSwitchRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetRaspSwitchRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\SetRaspSwitchRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\SetRaspSwitchRequestInfo|null $body body
    *
    * @return $this
    */
