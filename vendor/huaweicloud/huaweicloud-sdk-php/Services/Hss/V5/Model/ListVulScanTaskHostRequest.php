...
class ListVulScanTaskHostRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulScanTaskHostRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['taskId'] === null) {
            ...
            if ((mb_strlen($this->container['taskId']) > 256)) {
