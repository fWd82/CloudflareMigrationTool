...
class ListProtectionPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProtectionPolicyResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ProtectionPolicyInfo[]'
    ];
    ...
    *  查询防护策略列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ProtectionPolicyInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ProtectionPolicyInfo[]|null $dataList 查询防护策略列表
    *
    * @return $this
    */
