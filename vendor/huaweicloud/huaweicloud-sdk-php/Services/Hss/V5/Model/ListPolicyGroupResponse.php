...
class ListPolicyGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPolicyGroupResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\PolicyGroupResponseInfo[]'
    ];
    ...
    *  策略组列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\PolicyGroupResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\PolicyGroupResponseInfo[]|null $dataList 策略组列表
    *
    * @return $this
    */
