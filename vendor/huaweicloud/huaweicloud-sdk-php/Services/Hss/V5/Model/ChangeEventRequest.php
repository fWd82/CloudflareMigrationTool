...
class ChangeEventRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeEventRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'containerId' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\ChangeEventRequestInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ChangeEventRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ChangeEventRequestInfo|null $body body
    *
    * @return $this
    */
