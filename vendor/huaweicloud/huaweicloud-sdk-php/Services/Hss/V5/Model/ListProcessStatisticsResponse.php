...
class ListProcessStatisticsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProcessStatisticsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ProcessStatisticResponseInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 进程统计信息总数,
    *
    * @return $this
    */
    ...
    *  进程统计信息列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ProcessStatisticResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ProcessStatisticResponseInfo[]|null $dataList 进程统计信息列表
    *
    * @return $this
    */
