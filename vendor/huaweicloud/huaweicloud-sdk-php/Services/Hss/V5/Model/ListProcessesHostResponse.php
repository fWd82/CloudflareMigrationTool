...
class ListProcessesHostResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProcessesHostResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ProcessesHostResponseInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 主机统计信息总数,
    *
    * @return $this
    */
    ...
    *  主机统计信息列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ProcessesHostResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ProcessesHostResponseInfo[]|null $dataList 主机统计信息列表
    *
    * @return $this
    */
