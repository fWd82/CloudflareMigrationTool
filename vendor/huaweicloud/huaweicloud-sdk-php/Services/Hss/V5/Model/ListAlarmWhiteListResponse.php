...
class ListAlarmWhiteListResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAlarmWhiteListResponse';
    ...
    * Sets eventTypeList
    *
    * @param int[]|null $eventTypeList 支持筛选的事件类型
    *
    * @return $this
    */
    ...
    *  告警白名单详情
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AlarmWhiteListResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AlarmWhiteListResponseInfo[]|null $dataList 告警白名单详情
    *
    * @return $this
    */
