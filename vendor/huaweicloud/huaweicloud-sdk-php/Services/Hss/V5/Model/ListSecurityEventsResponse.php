...
class ListSecurityEventsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSecurityEventsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\EventManagementResponseInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 告警事件总数
    *
    * @return $this
    */
    ...
    *  事件列表详情
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\EventManagementResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\EventManagementResponseInfo[]|null $dataList 事件列表详情
    *
    * @return $this
    */
