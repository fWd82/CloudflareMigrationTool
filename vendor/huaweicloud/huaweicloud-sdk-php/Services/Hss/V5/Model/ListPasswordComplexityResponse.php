...
class ListPasswordComplexityResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPasswordComplexityResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  记录总数
    * dataList  口令复杂度策略检测列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\PwdPolicyInfoResponseInfo[]'
    ];
    ...
    *  口令复杂度策略检测列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\PwdPolicyInfoResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\PwdPolicyInfoResponseInfo[]|null $dataList 口令复杂度策略检测列表
    *
    * @return $this
    */
