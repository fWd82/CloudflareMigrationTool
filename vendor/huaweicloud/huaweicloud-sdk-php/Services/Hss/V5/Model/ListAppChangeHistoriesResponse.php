...
class ListAppChangeHistoriesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAppChangeHistoriesResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\AppChangeResponseInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 软件变动总数
    *
    * @return $this
    */
    ...
    *  软件历史变动记录列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AppChangeResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AppChangeResponseInfo[]|null $dataList 软件历史变动记录列表
    *
    * @return $this
    */
