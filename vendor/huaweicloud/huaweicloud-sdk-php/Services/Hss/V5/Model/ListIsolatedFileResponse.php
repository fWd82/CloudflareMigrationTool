...
class ListIsolatedFileResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIsolatedFileResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\IsolatedFileResponseInfo[]'
    ];
    ...
    *  已隔离文件详情
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\IsolatedFileResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\IsolatedFileResponseInfo[]|null $dataList 已隔离文件详情
    *
    * @return $this
    */
