...
class ListSwrImageRepositoryResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSwrImageRepositoryResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  总数
    * dataList  查询swr镜像仓库镜像列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\PrivateImageRepositoryInfo[]'
    ];
    ...
    *  查询swr镜像仓库镜像列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\PrivateImageRepositoryInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\PrivateImageRepositoryInfo[]|null $dataList 查询swr镜像仓库镜像列表
    *
    * @return $this
    */
