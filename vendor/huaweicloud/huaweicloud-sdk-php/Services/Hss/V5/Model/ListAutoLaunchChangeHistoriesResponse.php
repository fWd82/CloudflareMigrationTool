...
class ListAutoLaunchChangeHistoriesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAutoLaunchChangeHistoriesResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\AutoLaunchChangeResponseInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 自启动项变动总数
    *
    * @return $this
    */
    ...
    *  软件历史变动记录列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AutoLaunchChangeResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AutoLaunchChangeResponseInfo[]|null $dataList 软件历史变动记录列表
    *
    * @return $this
    */
