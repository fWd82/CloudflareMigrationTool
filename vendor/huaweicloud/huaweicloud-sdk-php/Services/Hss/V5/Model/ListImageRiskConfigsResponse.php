...
class ListImageRiskConfigsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListImageRiskConfigsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ImageRiskConfigsInfoResponseInfo[]'
    ];
    ...
    *  配置检测列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ImageRiskConfigsInfoResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ImageRiskConfigsInfoResponseInfo[]|null $dataList 配置检测列表
    *
    * @return $this
    */
