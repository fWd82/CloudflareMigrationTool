...
class ListWeakPasswordUsersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWeakPasswordUsersResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\WeakPwdListInfoResponseInfo[]'
    ];
    ...
    *  弱口令列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\WeakPwdListInfoResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\WeakPwdListInfoResponseInfo[]|null $dataList 弱口令列表
    *
    * @return $this
    */
