...
class ChangeHostsGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeHostsGroupRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ChangeHostsGroupRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ChangeHostsGroupRequestInfo|null $body body
    *
    * @return $this
    */
