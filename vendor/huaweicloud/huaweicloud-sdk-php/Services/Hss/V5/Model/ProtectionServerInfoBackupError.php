...
class ProtectionServerInfoBackupError implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProtectionServerInfo_backup_error';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['errorCode']) && ($this->container['errorCode'] > 128)) {
                $invalidProperties[] = "invalid value for 'errorCode', must be smaller than or equal to 128.";
            }
            ...
            if (!is_null($this->container['errorDescription']) && (mb_strlen($this->container['errorDescription']) > 128)) {
                $invalidProperties[] = "invalid value for 'errorDescription', the character length must be smaller than or equal to 128.";
            }
