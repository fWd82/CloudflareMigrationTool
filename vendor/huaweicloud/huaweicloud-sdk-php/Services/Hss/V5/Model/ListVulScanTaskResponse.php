...
class ListVulScanTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulScanTaskResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\VulScanTaskInfo[]'
    ];
    ...
    *  漏洞扫描任务列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\VulScanTaskInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\VulScanTaskInfo[]|null $dataList 漏洞扫描任务列表
    *
    * @return $this
    */
