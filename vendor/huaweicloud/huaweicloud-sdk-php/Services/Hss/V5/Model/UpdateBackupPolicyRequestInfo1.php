...
class UpdateBackupPolicyRequestInfo1 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateBackupPolicyRequestInfo1';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * enabled  策略是否启用，缺省值：true
    * policyId  策略ID,若开启防护时开启备份防护，该字段必选
    ...
    */
    protected static $openAPITypes = [
            ...
            'trigger' => '\HuaweiCloud\SDK\Hss\V5\Model\BackupTriggerRequestInfo1'
    ];
    ...
    * Sets enabled
    *
    * @param bool|null $enabled 策略是否启用，缺省值：true
    *
    * @return $this
    */
    ...
    * Sets policyId
    *
    * @param string|null $policyId 策略ID,若开启防护时开启备份防护，该字段必选
    *
    * @return $this
    */
    ...
    *  trigger
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\BackupTriggerRequestInfo1|null
    */
    ...
    * Sets trigger
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\BackupTriggerRequestInfo1|null $trigger trigger
    *
    * @return $this
    */
