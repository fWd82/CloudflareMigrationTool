...
class AssociatePolicyGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociatePolicyGroupRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AssociatePolicyGroupRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AssociatePolicyGroupRequestInfo|null $body body
    *
    * @return $this
    */
