...
class ShowImageCheckRuleDetailResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowImageCheckRuleDetailResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'audit' => 'string',
            'remediation' => 'string',
            'checkInfoList' => '\HuaweiCloud\SDK\Hss\V5\Model\ImageCheckRuleCheckCaseResponseInfo[]'
    ];
    ...
    * Sets reference
    *
    * @param string|null $reference 参考
    *
    * @return $this
    */
    ...
    *  检测用例信息
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ImageCheckRuleCheckCaseResponseInfo[]|null
    */
    ...
    * Sets checkInfoList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ImageCheckRuleCheckCaseResponseInfo[]|null $checkInfoList 检测用例信息
    *
    * @return $this
    */
