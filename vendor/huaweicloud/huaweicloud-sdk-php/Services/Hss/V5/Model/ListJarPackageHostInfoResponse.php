...
class ListJarPackageHostInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListJarPackageHostInfoResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\JarPackageHostInfo[]'
    ];
    ...
    *  服务器列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\JarPackageHostInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\JarPackageHostInfo[]|null $dataList 服务器列表
    *
    * @return $this
    */
