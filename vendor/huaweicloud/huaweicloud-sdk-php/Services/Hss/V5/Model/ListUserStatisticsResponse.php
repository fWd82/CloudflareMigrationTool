...
class ListUserStatisticsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListUserStatisticsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\UserStatisticInfoResponseInfo[]'
    ];
    ...
    *  账户统计信息列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\UserStatisticInfoResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\UserStatisticInfoResponseInfo[]|null $dataList 账户统计信息列表
    *
    * @return $this
    */
