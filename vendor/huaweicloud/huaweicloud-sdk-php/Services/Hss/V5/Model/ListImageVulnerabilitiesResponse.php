...
class ListImageVulnerabilitiesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListImageVulnerabilitiesResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ImageVulInfo[]'
    ];
    ...
    *  镜像的漏洞列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ImageVulInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ImageVulInfo[]|null $dataList 镜像的漏洞列表
    *
    * @return $this
    */
