...
class RunImageSynchronizeResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RunImageSynchronizeResponse';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['errorCode']) && ($this->container['errorCode'] > 10)) {
                $invalidProperties[] = "invalid value for 'errorCode', must be smaller than or equal to 10.";
            }
