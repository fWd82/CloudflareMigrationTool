...
class ListRiskConfigsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRiskConfigsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  记录总数
    * dataList  服务器配置检测结果列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\SecurityCheckInfoResponseInfo[]'
    ];
    ...
    *  服务器配置检测结果列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\SecurityCheckInfoResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\SecurityCheckInfoResponseInfo[]|null $dataList 服务器配置检测结果列表
    *
    * @return $this
    */
