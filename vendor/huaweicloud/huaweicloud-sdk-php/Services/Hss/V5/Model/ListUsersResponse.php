...
class ListUsersResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\UserResponseInfo[]'
    ];
    ...
    *  账号信息列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\UserResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\UserResponseInfo[]|null $dataList 账号信息列表
    *
    * @return $this
    */
