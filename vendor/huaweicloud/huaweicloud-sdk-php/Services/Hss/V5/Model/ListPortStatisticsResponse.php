...
class ListPortStatisticsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPortStatisticsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\PortStatisticResponseInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 开放端口总数
    *
    * @return $this
    */
    ...
    *  开放端口统计信息列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\PortStatisticResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\PortStatisticResponseInfo[]|null $dataList 开放端口统计信息列表
    *
    * @return $this
    */
