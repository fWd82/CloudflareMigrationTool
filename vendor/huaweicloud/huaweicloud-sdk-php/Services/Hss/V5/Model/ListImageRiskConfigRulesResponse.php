...
class ListImageRiskConfigRulesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListImageRiskConfigRulesResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ImageRiskConfigsCheckRulesResponseInfo[]'
    ];
    ...
    *  数据列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ImageRiskConfigsCheckRulesResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ImageRiskConfigsCheckRulesResponseInfo[]|null $dataList 数据列表
    *
    * @return $this
    */
