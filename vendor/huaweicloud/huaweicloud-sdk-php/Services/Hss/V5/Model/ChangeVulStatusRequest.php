...
class ChangeVulStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeVulStatusRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ChangeVulStatusRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ChangeVulStatusRequestInfo|null $body body
    *
    * @return $this
    */
