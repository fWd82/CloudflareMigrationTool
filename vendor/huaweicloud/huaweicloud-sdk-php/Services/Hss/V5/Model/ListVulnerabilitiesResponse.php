...
class ListVulnerabilitiesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulnerabilitiesResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\VulInfo[]'
    ];
    ...
    *  软件漏洞列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\VulInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\VulInfo[]|null $dataList 软件漏洞列表
    *
    * @return $this
    */
