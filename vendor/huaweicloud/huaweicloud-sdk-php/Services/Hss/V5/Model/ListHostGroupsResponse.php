...
class ListHostGroupsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\HostGroupItem[]'
    ];
    ...
    *  服务器组列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\HostGroupItem[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\HostGroupItem[]|null $dataList 服务器组列表
    *
    * @return $this
    */
