...
class ListProtectionServerResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProtectionServerResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  总数
    * dataList  查询勒索防护服务器列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ProtectionServerInfo[]'
    ];
    ...
    *  查询勒索防护服务器列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ProtectionServerInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ProtectionServerInfo[]|null $dataList 查询勒索防护服务器列表
    *
    * @return $this
    */
