...
class UpdateFlinkJarJobResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateFlinkJarJobResponse';
    ...
    */
    protected static $openAPITypes = [
            'isSuccess' => 'bool',
            'message' => 'string',
            'job' => '\HuaweiCloud\SDK\Dli\V1\Model\FlinkJobUpdateTime'
    ];
    ...
    *  job
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\FlinkJobUpdateTime|null
    */
    ...
    * Sets job
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\FlinkJobUpdateTime|null $job job
    *
    * @return $this
    */
