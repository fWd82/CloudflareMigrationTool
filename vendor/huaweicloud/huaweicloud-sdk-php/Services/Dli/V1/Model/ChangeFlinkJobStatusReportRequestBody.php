...
class ChangeFlinkJobStatusReportRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeFlinkJobStatusReportRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'jobs' => '\HuaweiCloud\SDK\Dli\V1\Model\Job[]',
            'messageId' => 'string',
    ...
    *  作业信息列表
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\Job[]
    */
    ...
    * Sets jobs
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\Job[] $jobs 作业信息列表
    *
    * @return $this
    */
