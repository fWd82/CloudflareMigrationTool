...
class CreateFlinkJarJobRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateFlinkJarJobRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  作业名称。长度限制：0-57个字符。
    * desc  作业描述。长度限制：0-512个字符。
    * queueName  队列名称。长度限制：1-128个字符。
    * cuNumber  用户为作业选择的CU数量，默认值为2。
    * managerCuNumber  用户为作业选择的管理节点CU数量，对应为flink jobmanager数量，默认值为1。
    * parallelNumber  用户为作业选择的并发量，默认值为1.
    * logEnabled  是否开启作业日志。 开启：true 关闭：false 默认：false
    * obsBucket  当“log_enabled”为“true”时, 用户授权保存作业日志的OBS桶名。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['name'] === null) {
            ...
            if (!is_null($this->container['desc']) && (mb_strlen($this->container['desc']) > 512)) {
                $invalidProperties[] = "invalid value for 'desc', the character length must be smaller than or equal to 512.";
            }
    ...
    * Sets desc
    *
    * @param string|null $desc 作业描述。长度限制：0-512个字符。
    *
    * @return $this
    */
    ...
    *
    * @param int|null $managerCuNumber 用户为作业选择的管理节点CU数量，对应为flink jobmanager数量，默认值为1。
    *
    * @return $this
    */
    ...
    * Sets parallelNumber
    *
    * @param int|null $parallelNumber 用户为作业选择的并发量，默认值为1.
    *
    * @return $this
    */
    ...
    * Sets obsBucket
    *
    * @param string|null $obsBucket 当“log_enabled”为“true”时, 用户授权保存作业日志的OBS桶名。
    *
    * @return $this
    */
