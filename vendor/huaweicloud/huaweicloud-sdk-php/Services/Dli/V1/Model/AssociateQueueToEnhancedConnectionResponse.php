...
class AssociateQueueToEnhancedConnectionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateQueueToEnhancedConnectionResponse';
