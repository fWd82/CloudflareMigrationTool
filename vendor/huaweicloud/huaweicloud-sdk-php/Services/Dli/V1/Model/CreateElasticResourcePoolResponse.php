...
class CreateElasticResourcePoolResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateElasticResourcePoolResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * isSuccess  是否成功
    * message  响应消息
    * elasticResourcePoolName  创建成功的弹性资源池名称
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $elasticResourcePoolName 创建成功的弹性资源池名称
    *
    * @return $this
    */
