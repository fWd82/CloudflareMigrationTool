...
class DeleteEnhancedConnectionRoutesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteEnhancedConnectionRoutesResponse';
