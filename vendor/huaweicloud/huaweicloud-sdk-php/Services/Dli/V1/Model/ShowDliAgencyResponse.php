...
class ShowDliAgencyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDliAgencyResponse';
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['currentRoles'] = isset($data['currentRoles']) ? $data['currentRoles'] : null;
    }
    ...
    */
    ...
    {
        return $this->container['currentRoles'];
    }

    /**
    * Sets currentRoles
    *
    * @param string[]|null $currentRoles 当前已有委托
    *
    * @return $this
    */
    public function setCurrentRoles($currentRoles)
    {
        $this->container['currentRoles'] = $currentRoles;
        return $this;
    }
