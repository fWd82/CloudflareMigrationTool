...
class CreateEnhancedConnectionRoutesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateEnhancedConnectionRoutesRequest';
