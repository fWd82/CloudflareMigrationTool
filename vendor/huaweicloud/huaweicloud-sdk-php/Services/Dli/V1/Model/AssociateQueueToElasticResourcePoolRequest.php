...
class AssociateQueueToElasticResourcePoolRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateQueueToElasticResourcePoolRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Dli\V1\Model\AssociateQueueToElasticResourcePoolRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\AssociateQueueToElasticResourcePoolRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\AssociateQueueToElasticResourcePoolRequestBody|null $body body
    *
    * @return $this
    */
