...
class CreateQueuePlanRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateQueuePlanRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * queueName  需要设置定时扩缩计划的队列名称，名称只能包含数字、英文字母和下划线，但不能是纯数字，且不能以下划线开头。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'queueName' => 'string',
            'body' => '\HuaweiCloud\SDK\Dli\V1\Model\QueuePlanRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\QueuePlanRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\QueuePlanRequestBody|null $body body
    *
    * @return $this
    */
