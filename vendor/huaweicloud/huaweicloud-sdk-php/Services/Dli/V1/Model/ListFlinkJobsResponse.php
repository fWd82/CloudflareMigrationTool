...
class ListFlinkJobsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListFlinkJobsResponse';
    ...
    */
    protected static $openAPITypes = [
            'isSuccess' => 'bool',
            'message' => 'string',
            'jobList' => '\HuaweiCloud\SDK\Dli\V1\Model\FlinkJobList'
    ];
    ...
    *  jobList
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\FlinkJobList|null
    */
    ...
    * Sets jobList
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\FlinkJobList|null $jobList jobList
    *
    * @return $this
    */
