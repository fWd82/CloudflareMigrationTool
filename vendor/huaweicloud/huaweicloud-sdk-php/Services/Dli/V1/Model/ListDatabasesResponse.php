...
class ListDatabasesResponse implements ModelInterface, ArrayAccess
{
    ...
    * databaseCount  数据库的总数。
    * databases  查询所有数据库的响应参数。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'message' => 'string',
            'databaseCount' => 'int',
            'databases' => '\HuaweiCloud\SDK\Dli\V1\Model\Database[]'
    ];
    ...
    * Sets databaseCount
    *
    * @param int|null $databaseCount 数据库的总数。
    *
    * @return $this
    */
    ...
    *  查询所有数据库的响应参数。
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\Database[]|null
    */
    ...
    * Sets databases
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\Database[]|null $databases 查询所有数据库的响应参数。
    *
    * @return $this
    */
