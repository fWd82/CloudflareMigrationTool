...
class UpdateElasticResourcePoolRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateElasticResourcePoolRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Dli\V1\Model\UpdateElasticResourcePoolRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\UpdateElasticResourcePoolRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\UpdateElasticResourcePoolRequestBody|null $body body
    *
    * @return $this
    */
