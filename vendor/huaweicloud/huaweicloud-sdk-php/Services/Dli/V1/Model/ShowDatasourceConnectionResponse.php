...
class ShowDatasourceConnectionResponse implements ModelInterface, ArrayAccess
{
    ...
    * availableQueueInfo  当前跨源已绑定的队列信息
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'service' => 'string',
            'createTime' => 'int',
            'availableQueueInfo' => '\HuaweiCloud\SDK\Dli\V1\Model\AvailableQueueInfo[]'
    ];
    ...
    *  当前跨源已绑定的队列信息
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\AvailableQueueInfo[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\AvailableQueueInfo[]|null $availableQueueInfo 当前跨源已绑定的队列信息
    *
    * @return $this
    */
