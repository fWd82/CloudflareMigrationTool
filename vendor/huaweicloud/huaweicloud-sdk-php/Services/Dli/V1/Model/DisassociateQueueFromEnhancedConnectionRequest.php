...
class DisassociateQueueFromEnhancedConnectionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateQueueFromEnhancedConnectionRequest';
