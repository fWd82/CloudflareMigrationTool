...
class ListEnhancedConnectionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEnhancedConnectionsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * isSuccess  执行请求是否成功。“true”表示请求执行成功。
    * message  系统提示信息，执行成功时，信息可能为空。
    * connections  跨源连接信息列表。
    * count  返回的跨源连接个数。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'isSuccess' => 'bool',
            'message' => 'string',
            'connections' => '\HuaweiCloud\SDK\Dli\V1\Model\EnhancedConnection[]',
            'count' => 'int'
    ];
    ...
    *  跨源连接信息列表。
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\EnhancedConnection[]|null
    */
    ...
    * Sets connections
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\EnhancedConnection[]|null $connections 跨源连接信息列表。
    *
    * @return $this
    */
    ...
    * Sets count
    *
    * @param int|null $count 返回的跨源连接个数。
    *
    * @return $this
    */
