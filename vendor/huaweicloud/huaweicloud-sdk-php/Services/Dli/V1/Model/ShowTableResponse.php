...
class ShowTableResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTableResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'message' => 'string',
            'columnCount' => 'int',
            'columns' => '\HuaweiCloud\SDK\Dli\V1\Model\Column[]',
            'tableType' => 'string',
            'dataType' => 'string',
            'dataLocation' => 'string',
    ...
    *  表的列信息，包含列名称、类型和描述信息。
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\Column[]|null
    */
    ...
    * Sets columns
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\Column[]|null $columns 表的列信息，包含列名称、类型和描述信息。
    *
    * @return $this
    */
