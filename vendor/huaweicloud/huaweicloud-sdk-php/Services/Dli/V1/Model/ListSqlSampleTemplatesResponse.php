...
class ListSqlSampleTemplatesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSqlSampleTemplatesResponse';
    ...
    */
    protected static $openAPITypes = [
            'isSuccess' => 'bool',
            'message' => 'string',
            'sqls' => '\HuaweiCloud\SDK\Dli\V1\Model\SqlSampleTemplate[]',
            'sqlCount' => 'int'
    ];
    ...
    *  样例模板信息。
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\SqlSampleTemplate[]|null
    */
    ...
    * Sets sqls
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\SqlSampleTemplate[]|null $sqls 样例模板信息。
    *
    * @return $this
    */
