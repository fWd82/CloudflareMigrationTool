...
class UploadPythonFileJobResourcesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UploadPythonFileJobResourcesResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'owner' => 'string',
            'isAsync' => 'bool',
            'details' => '\HuaweiCloud\SDK\Dli\V1\Model\UploadJobResourcesDetail[]',
            'moduleName' => 'string',
            'moduleType' => 'string'
    ];
    ...
    *  分组资源包的详细信息
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\UploadJobResourcesDetail[]|null
    */
    ...
    * Sets details
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\UploadJobResourcesDetail[]|null $details 分组资源包的详细信息
    *
    * @return $this
    */
