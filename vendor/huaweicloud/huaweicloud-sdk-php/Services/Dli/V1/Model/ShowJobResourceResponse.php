...
class ShowJobResourceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowJobResourceResponse';
    ...
    * Sets createTime
    *
    * @param int|null $createTime 资源包上传的unix时间。是单位为“毫秒”的时间戳。
    *
    * @return $this
    */
