...
class UpdateFlinkSqlJobTemplateRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateFlinkSqlJobTemplateRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  模板名称，长度限制：0-57个字符。
    * desc  模板描述，长度限制：0-2048个字符。
    * sqlBody  Stream SQL语句，至少包含source，query，sink三个部分，长度限制：0-1024*1024个字符。
    *
    * @var string[]
    */
    ...
    * Sets name
    *
    * @param string|null $name 模板名称，长度限制：0-57个字符。
    *
    * @return $this
    */
    ...
    * Sets sqlBody
    *
    * @param string|null $sqlBody Stream SQL语句，至少包含source，query，sink三个部分，长度限制：0-1024*1024个字符。
    *
    * @return $this
    */
