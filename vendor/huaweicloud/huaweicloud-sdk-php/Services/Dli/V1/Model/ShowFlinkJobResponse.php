...
class ShowFlinkJobResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowFlinkJobResponse';
    ...
    */
    protected static $openAPITypes = [
            'isSuccess' => 'bool',
            'message' => 'string',
            'jobDetail' => '\HuaweiCloud\SDK\Dli\V1\Model\FlinkJobDetail'
    ];
    ...
    *  jobDetail
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\FlinkJobDetail|null
    */
    ...
    * Sets jobDetail
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\FlinkJobDetail|null $jobDetail jobDetail
    *
    * @return $this
    */
