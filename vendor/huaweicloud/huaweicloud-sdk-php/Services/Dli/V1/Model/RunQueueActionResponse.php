...
class RunQueueActionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RunQueueActionResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * isSuccess  请求执行是否成功。“true”表示请求执行成功。
    * message  系统提示信息，执行成功时，信息可能为空。
    * jobId  当force为true的时候返回的jobId，可以根据job_id的状态来看最终结果
    * queueName  扩缩容的队列名称。
    * result  扩缩容结果
    *
    * @var string[]
    ...
    * Sets jobId
    *
    * @param string|null $jobId 当force为true的时候返回的jobId，可以根据job_id的状态来看最终结果
    *
    * @return $this
    */
    ...
    * Sets queueName
    *
    * @param string|null $queueName 扩缩容的队列名称。
    *
    * @return $this
    */
