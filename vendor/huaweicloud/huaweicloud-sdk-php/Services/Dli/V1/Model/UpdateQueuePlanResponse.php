...
class UpdateQueuePlanResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateQueuePlanResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * queueName  定时扩缩容计划对应的队列名称
    * planId  扩缩容计划的ID编号
    ...
    * Sets queueName
    *
    * @param string|null $queueName 定时扩缩容计划对应的队列名称
    *
    * @return $this
    */
