...
class UploadJobResourcesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UploadJobResourcesRequestBody';
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\Tag[]|null $tags 资源标签。具体请参考表tags。
    *
    * @return $this
    */
