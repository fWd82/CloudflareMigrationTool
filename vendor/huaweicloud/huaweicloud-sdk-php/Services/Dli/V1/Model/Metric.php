...
class Metric implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'sources' => '\HuaweiCloud\SDK\Dli\V1\Model\FlinkJobMetricInfo[]',
            'sinks' => '\HuaweiCloud\SDK\Dli\V1\Model\FlinkJobMetricInfo[]',
    ...
    *  所有输入流。
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\FlinkJobMetricInfo[]|null
    */
    ...
    * Sets sources
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\FlinkJobMetricInfo[]|null $sources 所有输入流。
    *
    * @return $this
    */
    ...
    * Sets sinks
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\FlinkJobMetricInfo[]|null $sinks 所有输出流。
    *
    * @return $this
    */
