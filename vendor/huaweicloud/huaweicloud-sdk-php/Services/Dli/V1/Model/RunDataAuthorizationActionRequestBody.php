...
class RunDataAuthorizationActionRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RunDataAuthorizationActionRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'userName' => 'string',
            'action' => 'string',
            'privileges' => '\HuaweiCloud\SDK\Dli\V1\Model\DataAuthorizationPrivilege[]'
    ];
    ...
    *  赋权信息。
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\DataAuthorizationPrivilege[]
    */
    ...
    * Sets privileges
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\DataAuthorizationPrivilege[] $privileges 赋权信息。
    *
    * @return $this
    */
