...
class ShowEnhancedConnectionPrivilegeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowEnhancedConnectionPrivilegeRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * connectionId  增强型跨源连接ID。
    *
    * @var string[]
    */
