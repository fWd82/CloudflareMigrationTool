...
class ListDatabaseUsersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDatabaseUsersResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * isSuccess  执行请求是否成功。“true”表示请求执行成功。
    * message  系统提示信息，执行成功时，信息可能为空。
    * databaseName  被查询的数据库名称。
    * privileges  权限信息。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'message' => 'string',
            'databaseName' => 'string',
            'privileges' => '\HuaweiCloud\SDK\Dli\V1\Model\DatabaseUserPrivilege[]'
    ];
    ...
    * Sets databaseName
    *
    * @param string|null $databaseName 被查询的数据库名称。
    *
    * @return $this
    */
    ...
    *  权限信息。
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\DatabaseUserPrivilege[]|null
    */
    ...
    * Sets privileges
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\DatabaseUserPrivilege[]|null $privileges 权限信息。
    *
    * @return $this
    */
