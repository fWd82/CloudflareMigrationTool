...
class ListJobAuthInfosRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListJobAuthInfosRequest';
    ...
    * Sets authInfoName
    *
    * @param string|null $authInfoName 认证信息名称
    *
    * @return $this
    */
