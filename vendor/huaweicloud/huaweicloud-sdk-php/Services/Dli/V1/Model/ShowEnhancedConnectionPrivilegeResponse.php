...
class ShowEnhancedConnectionPrivilegeResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowEnhancedConnectionPrivilegeResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * isSuccess  行请求是否成功。“true”表示请求执行成功。
    * message  系统提示信息，执行成功时，信息可能为空。
    * connectionId  增强型跨源连接ID，用于标识跨源连接的UUID。
    * privileges  跨源连接各个授权项目的信息。
    *
    * @var string[]
    */
    ...
    * Sets isSuccess
    *
    * @param bool|null $isSuccess 行请求是否成功。“true”表示请求执行成功。
    *
    * @return $this
    */
    ...
    * Sets connectionId
    *
    * @param string|null $connectionId 增强型跨源连接ID，用于标识跨源连接的UUID。
    *
    * @return $this
    */
