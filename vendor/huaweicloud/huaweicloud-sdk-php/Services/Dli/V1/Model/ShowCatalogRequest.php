...
class ShowCatalogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCatalogRequest';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['catalogName'] === null) {
            $invalidProperties[] = "'catalogName' can't be null";
        }
