...
class AssociateQueueToEnhancedConnectionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateQueueToEnhancedConnectionRequest';
