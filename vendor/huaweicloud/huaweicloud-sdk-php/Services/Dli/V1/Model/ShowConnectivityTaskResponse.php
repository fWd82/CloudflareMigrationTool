...
class ShowConnectivityTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowConnectivityTaskResponse';
    ...
    * Sets connectivity
    *
    * @param string|null $connectivity 连通性测试结果
    *
    * @return $this
    */
