...
class ListTablePrivilegesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTablePrivilegesResponse';
    ...
    * Sets userName
    *
    * @param string|null $userName 被查询的用户名称。
    *
    * @return $this
    */
