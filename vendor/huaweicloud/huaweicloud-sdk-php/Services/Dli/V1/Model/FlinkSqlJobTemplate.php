...
class FlinkSqlJobTemplate implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FlinkSqlJobTemplate';
    ...
    * createTime  模板创建时间。
    * updateTime  模板更新时间。
    * sqlBody  Stream SQL语句, 至少包含source, query, sink三个部分。
    * jobType  作业模板的类型。
    *
    * @var string[]
    */
    ...
    * Sets sqlBody
    *
    * @param string|null $sqlBody Stream SQL语句, 至少包含source, query, sink三个部分。
    *
    * @return $this
    */
    ...
    * Sets jobType
    *
    * @param string|null $jobType 作业模板的类型。
    *
    * @return $this
    */
