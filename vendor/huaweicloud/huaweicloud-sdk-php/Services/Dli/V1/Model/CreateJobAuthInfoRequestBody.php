...
class CreateJobAuthInfoRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateJobAuthInfoRequestBody';
    ...
    * Sets datasourceType
    *
    * @param string $datasourceType 数据源类型，目前支持CSS,KRB,passwd,Kafka_SSL
    *
    * @return $this
    */
    ...
    * Sets keyPassword
    *
    * @param string|null $keyPassword key密码
    *
    * @return $this
    */
