...
class CreateRouteToEnhancedConnectionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateRouteToEnhancedConnectionResponse';
