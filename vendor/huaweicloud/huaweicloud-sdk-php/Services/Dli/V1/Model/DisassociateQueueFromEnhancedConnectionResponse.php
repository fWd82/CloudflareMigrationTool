...
class DisassociateQueueFromEnhancedConnectionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateQueueFromEnhancedConnectionResponse';
