...
class UpdateQueuePropertyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateQueuePropertyRequest';
    ...
    */
    protected static $openAPITypes = [
            'queueName' => 'string',
            'body' => '\HuaweiCloud\SDK\Dli\V1\Model\UpdateQueuePropertyRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\UpdateQueuePropertyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\UpdateQueuePropertyRequestBody|null $body body
    *
    * @return $this
    */
