...
class ExportFlinkJobsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportFlinkJobsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * isSuccess  执行请求是否成功。“true”表示请求执行成功。
    * message  消息内容
    * zipFile  OBS上导出作业zip文件名。
    *
    * @var string[]
    */
    ...
    * Sets zipFile
    *
    * @param string[]|null $zipFile OBS上导出作业zip文件名。
    *
    * @return $this
    */
