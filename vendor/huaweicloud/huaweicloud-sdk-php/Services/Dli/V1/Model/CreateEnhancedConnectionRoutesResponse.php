...
class CreateEnhancedConnectionRoutesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateEnhancedConnectionRoutesResponse';
