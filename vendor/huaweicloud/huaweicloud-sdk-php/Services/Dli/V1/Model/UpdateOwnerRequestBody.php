...
class UpdateOwnerRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateOwnerRequestBody';
    ...
    * Sets newOwner
    *
    * @param string $newOwner 新owner名称。
    *
    * @return $this
    */
