...
class UpdateElasticResourcePoolQueueResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateElasticResourcePoolQueueResponse';
