...
class ShowBaremetalServerInterfaceAttachmentsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBaremetalServerInterfaceAttachmentsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * interfaceAttachments  裸金属服务器网卡信息列表，详情请参见表2 interfaceAttachments字段数据结构说明。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'interfaceAttachments' => '\HuaweiCloud\SDK\Bms\V1\Model\InterfaceAttachments[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Bms\V1\Model\InterfaceAttachments[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bms\V1\Model\InterfaceAttachments[]|null $interfaceAttachments 裸金属服务器网卡信息列表，详情请参见表2 interfaceAttachments字段数据结构说明。
    *
    * @return $this
    */
