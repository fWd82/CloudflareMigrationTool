...
class CreateSchedulerHints implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSchedulerHints';
    ...
    */
    ...
    {
        $invalidProperties = [];
            $allowedValues = $this->getDecBaremetalAllowableValues();
                if (!is_null($this->container['decBaremetal']) && !in_array($this->container['decBaremetal'], $allowedValues, true)) {
                $invalidProperties[] = sprintf(
                "invalid value for 'decBaremetal', must be one of '%s'",
