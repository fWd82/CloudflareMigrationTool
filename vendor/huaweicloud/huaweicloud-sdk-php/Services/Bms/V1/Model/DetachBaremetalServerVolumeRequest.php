...
class DetachBaremetalServerVolumeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DetachBaremetalServerVolumeRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * serverId  裸金属服务器ID
    * attachmentId  裸金属服务器的云磁盘ID
    *
    * @var string[]
    */
