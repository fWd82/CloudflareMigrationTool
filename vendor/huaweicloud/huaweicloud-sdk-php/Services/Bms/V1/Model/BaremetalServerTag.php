...
class BaremetalServerTag implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BaremetalServerTag';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  键。  - 最大长度127个unicode字符。  - key不能为空。
    * value  值列表。  - 最多20个value。  - value不允许重复。  - 每个值最大长度255个unicode字符。  - 如果values为空则表示any_value。  - value之间为或的关系。
    *
    * @var string[]
    */
