...
class OsReinstallBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OsReinstallBody';
    ...
    */
    protected static $openAPITypes = [
            'osReinstall' => '\HuaweiCloud\SDK\Bms\V1\Model\OsReinstall'
    ];
    ...
    *  osReinstall
    *
    * @return \HuaweiCloud\SDK\Bms\V1\Model\OsReinstall
    */
    ...
    * Sets osReinstall
    *
    * @param \HuaweiCloud\SDK\Bms\V1\Model\OsReinstall $osReinstall osReinstall
    *
    * @return $this
    */
