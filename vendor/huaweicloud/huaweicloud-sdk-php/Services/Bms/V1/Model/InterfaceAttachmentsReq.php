...
class InterfaceAttachmentsReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InterfaceAttachmentsReq';
    ...
    *
    * @param bool $deleteOnTermination deleteOnTermination
    *
    * @return $this
    */
