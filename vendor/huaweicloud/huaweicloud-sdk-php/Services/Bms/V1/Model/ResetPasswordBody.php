...
class ResetPasswordBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResetPasswordBody';
    ...
    */
    protected static $openAPITypes = [
            'resetPassword' => '\HuaweiCloud\SDK\Bms\V1\Model\ResetPassword'
    ];
    ...
    *  resetPassword
    *
    * @return \HuaweiCloud\SDK\Bms\V1\Model\ResetPassword
    */
    ...
    * Sets resetPassword
    *
    * @param \HuaweiCloud\SDK\Bms\V1\Model\ResetPassword $resetPassword resetPassword
    *
    * @return $this
    */
