...
class ShowJobInfosResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowJobInfosResponse';
    ...
    * code  出现错误时，返回的错误码。错误码和其对应的含义请参考8.1-状态码。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'entities' => '\HuaweiCloud\SDK\Bms\V1\Model\Entities',
            'jobId' => 'string',
            'jobType' => 'string',
            'beginTime' => 'string',
            'endTime' => 'string',
    ...
    *  entities
    *
    * @return \HuaweiCloud\SDK\Bms\V1\Model\Entities|null
    */
    ...
    * Sets entities
    *
    * @param \HuaweiCloud\SDK\Bms\V1\Model\Entities|null $entities entities
    *
    * @return $this
    */
    ...
    * Sets jobType
    *
    * @param string|null $jobType Job的类型，包含以下类型：baremetalBatchCreate：批量创建裸金属服务器baremetalBatchOperate：批量修改裸金属服务器电源状态baremetalBatchCreate：批量创建裸金属服务器baremetalChangeOsVolumeBoot：切换快速发放裸金属服务器操作系统baremetalChangeOsLocalDisk：切换本地盘裸金属服务器操作系统baremetalVolumeBootReinstallOs：重装快速发放裸金属服务器操作系统baremetalReinstallOs：重装本地盘裸金属服务器操作系统baremetalAttachVolume：挂载单个磁盘baremetalDetachVolume：卸载单个磁盘baremetalBatchAttachVolume：裸金属服务器批量挂载共享磁盘
    *
    * @return $this
    */
    ...
    * Sets code
    *
    * @param string|null $code 出现错误时，返回的错误码。错误码和其对应的含义请参考8.1-状态码。
    *
    * @return $this
    */
