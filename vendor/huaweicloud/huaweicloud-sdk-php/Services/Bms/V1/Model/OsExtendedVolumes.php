...
class OsExtendedVolumes implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OsExtendedVolumes';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  云硬盘ID
    * deleteOnTermination  删裸金属服务器时是否一并删除该卷。true：是false：否
    *
    * @var string[]
    */
    ...
    *
    * @param bool|null $deleteOnTermination 删裸金属服务器时是否一并删除该卷。true：是false：否
    *
    * @return $this
    */
