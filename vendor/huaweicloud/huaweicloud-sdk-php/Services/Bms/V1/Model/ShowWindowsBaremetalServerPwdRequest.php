...
class ShowWindowsBaremetalServerPwdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowWindowsBaremetalServerPwdRequest';
