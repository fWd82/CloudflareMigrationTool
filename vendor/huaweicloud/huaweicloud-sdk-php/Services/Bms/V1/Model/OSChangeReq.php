...
class OSChangeReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OSChangeReq';
    ...
    */
    protected static $openAPITypes = [
            'osChange' => '\HuaweiCloud\SDK\Bms\V1\Model\OsChange'
    ];
    ...
    *  osChange
    *
    * @return \HuaweiCloud\SDK\Bms\V1\Model\OsChange
    */
    ...
    * Sets osChange
    *
    * @param \HuaweiCloud\SDK\Bms\V1\Model\OsChange $osChange osChange
    *
    * @return $this
    */
