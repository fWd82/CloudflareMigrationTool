...
class AttachVolumeBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AttachVolumeBody';
    ...
    */
    protected static $openAPITypes = [
            'volumeAttachment' => '\HuaweiCloud\SDK\Bms\V1\Model\VolumeAttachment'
    ];
    ...
    *  volumeAttachment
    *
    * @return \HuaweiCloud\SDK\Bms\V1\Model\VolumeAttachment
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bms\V1\Model\VolumeAttachment $volumeAttachment volumeAttachment
    *
    * @return $this
    */
