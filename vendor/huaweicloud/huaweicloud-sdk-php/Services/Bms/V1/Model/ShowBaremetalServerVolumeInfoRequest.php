...
class ShowBaremetalServerVolumeInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBaremetalServerVolumeInfoRequest';
