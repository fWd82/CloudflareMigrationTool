...
class TimeDoubleValueData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TimeDoubleValueData';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['time']) && (mb_strlen($this->container['time']) > 20)) {
            ...
            if (!is_null($this->container['value']) && ($this->container['value'] > 18446744073709551615)) {
                $invalidProperties[] = "invalid value for 'value', must be smaller than or equal to 18446744073709551615.";
            }
    ...
    * Sets time
    *
    * @param string|null $time 采样时间。日期格式按照ISO8601表示法，并使用UTC时间。格式为YYYY-MM-DDThh:mm:ssZ
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param double|null $value 当前时间返回参数取值
    *
    * @return $this
    */
