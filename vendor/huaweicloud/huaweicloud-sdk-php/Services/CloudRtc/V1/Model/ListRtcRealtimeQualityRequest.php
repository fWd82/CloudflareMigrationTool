...
class ListRtcRealtimeQualityRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRtcRealtimeQualityRequest';
    ...
    * app  应用标识
    * roomId  房间ID
    * metric  查询的数据类型 - JoinSuccessRate: 加入房间成功率 - JoinSuccess5SecsRate: 5秒加入成功率 - VideoFreezeRate: 视频卡顿率 - AudioFreezeRate: 音频卡顿率
