...
class ListRtcUserListResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRtcUserListResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'limit' => 'int',
            'offset' => 'int',
            'users' => '\HuaweiCloud\SDK\CloudRTC\V1\Model\RtcUser[]',
            'xRequestId' => 'string'
    ];
    ...
    *  用户列表
    *
    * @return \HuaweiCloud\SDK\CloudRTC\V1\Model\RtcUser[]|null
    */
    ...
    * Sets users
    *
    * @param \HuaweiCloud\SDK\CloudRTC\V1\Model\RtcUser[]|null $users 用户列表
    *
    * @return $this
    */
