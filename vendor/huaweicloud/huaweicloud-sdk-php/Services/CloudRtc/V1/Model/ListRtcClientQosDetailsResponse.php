...
class ListRtcClientQosDetailsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRtcClientQosDetailsResponse';
    ...
    */
    protected static $openAPITypes = [
            'roomId' => 'string',
            'data' => '\HuaweiCloud\SDK\CloudRTC\V1\Model\QosQualityData[]',
            'xRequestId' => 'string'
    ];
    ...
    *  QoS质量数据
    *
    * @return \HuaweiCloud\SDK\CloudRTC\V1\Model\QosQualityData[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\CloudRTC\V1\Model\QosQualityData[]|null $data QoS质量数据
    *
    * @return $this
    */
