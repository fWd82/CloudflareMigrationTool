...
class ListRtcRealtimeNetworkRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRtcRealtimeNetworkRequest';
    ...
    * app  应用标识
    * roomId  房间ID
    * metric  查询的数据类型 VideoUpstreamExcellentTransRate：客户端视频上行优质传输率; AudioUpstreamExcellentTransRate：客户端音频上行优质传输率; VideoExcellentTransRate：端到端视频优质传输率; AudioExcellentTransRate：端到端音频优质传输率;
    * sdkType  sdk类型 - native: 非web版sdk; - webrtc: web版sdk;
    * startTime  查询起始时间。UTC时间，格式：YYYY-MM-DDThh:mm:ssZ，如2020-04-23T06:00:00Z，不写默认读取过去1小时数据。
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['sdkType'] = isset($data['sdkType']) ? $data['sdkType'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['metric'] === null) {
            ...
            if ((mb_strlen($this->container['metric']) < 0)) {
                $invalidProperties[] = "invalid value for 'metric', the character length must be bigger than or equal to 0.";
            }
        if ($this->container['sdkType'] === null) {
            $invalidProperties[] = "'sdkType' can't be null";
        }
            if ((mb_strlen($this->container['sdkType']) > 256)) {
                $invalidProperties[] = "invalid value for 'sdkType', the character length must be smaller than or equal to 256.";
            }
            if ((mb_strlen($this->container['sdkType']) < 1)) {
                $invalidProperties[] = "invalid value for 'sdkType', the character length must be bigger than or equal to 1.";
            }
    ...
    */
    ...
    {
        $this->container['sdkType'] = $sdkType;
        return $this;
    }
    ...
    * Sets startTime
    *
    * @param string|null $startTime 查询起始时间。UTC时间，格式：YYYY-MM-DDThh:mm:ssZ，如2020-04-23T06:00:00Z，不写默认读取过去1小时数据。
    *
    * @return $this
    */
