...
class TimeValueData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TimeValueData';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['value']) && ($this->container['value'] > 1844674407)) {
                $invalidProperties[] = "invalid value for 'value', must be smaller than or equal to 1844674407.";
            }
