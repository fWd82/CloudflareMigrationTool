...
class UpdateMixJobReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMixJobReq';
    ...
    */
    protected static $openAPITypes = [
            'mixParam' => '\HuaweiCloud\SDK\CloudRTC\V2\Model\UpdateMixParam'
    ];
    ...
    *  mixParam
    *
    * @return \HuaweiCloud\SDK\CloudRTC\V2\Model\UpdateMixParam
    */
    ...
    * Sets mixParam
    *
    * @param \HuaweiCloud\SDK\CloudRTC\V2\Model\UpdateMixParam $mixParam mixParam
    *
    * @return $this
    */
