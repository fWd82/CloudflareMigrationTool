...
class CreateIndividualStreamJobRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateIndividualStreamJobRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'appId' => 'string',
            'body' => '\HuaweiCloud\SDK\CloudRTC\V2\Model\IndividualStreamJobReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CloudRTC\V2\Model\IndividualStreamJobReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CloudRTC\V2\Model\IndividualStreamJobReq|null $body body
    *
    * @return $this
    */
