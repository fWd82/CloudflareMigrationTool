...
class CreateMixJobRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMixJobRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'appId' => 'string',
            'body' => '\HuaweiCloud\SDK\CloudRTC\V2\Model\MixJobReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CloudRTC\V2\Model\MixJobReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CloudRTC\V2\Model\MixJobReq|null $body body
    *
    * @return $this
    */
