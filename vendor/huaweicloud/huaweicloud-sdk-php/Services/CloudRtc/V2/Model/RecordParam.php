...
class RecordParam implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RecordParam';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['recordRuleId'] === null) {
            $invalidProperties[] = "'recordRuleId' can't be null";
        }
            if ((mb_strlen($this->container['recordRuleId']) > 128)) {
                $invalidProperties[] = "invalid value for 'recordRuleId', the character length must be smaller than or equal to 128.";
            }
            if ((mb_strlen($this->container['recordRuleId']) < 1)) {
                $invalidProperties[] = "invalid value for 'recordRuleId', the character length must be bigger than or equal to 1.";
            }
    ...
    * Sets recordRuleId
    *
    * @param string $recordRuleId 录制规则id。
    *
    * @return $this
    */
