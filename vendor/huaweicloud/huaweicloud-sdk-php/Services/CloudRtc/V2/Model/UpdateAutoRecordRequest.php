...
class UpdateAutoRecordRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAutoRecordRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'appId' => 'string',
            'body' => '\HuaweiCloud\SDK\CloudRTC\V2\Model\AutoRecordModeReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CloudRTC\V2\Model\AutoRecordModeReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CloudRTC\V2\Model\AutoRecordModeReq|null $body body
    *
    * @return $this
    */
