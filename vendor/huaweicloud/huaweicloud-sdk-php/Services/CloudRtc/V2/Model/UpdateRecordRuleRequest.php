...
class UpdateRecordRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRecordRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'appId' => 'string',
            'ruleId' => 'string',
            'body' => '\HuaweiCloud\SDK\CloudRTC\V2\Model\RecordRuleReq'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ruleId'] === null) {
            ...
            if ((mb_strlen($this->container['ruleId']) > 128)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CloudRTC\V2\Model\RecordRuleReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CloudRTC\V2\Model\RecordRuleReq|null $body body
    *
    * @return $this
    */
