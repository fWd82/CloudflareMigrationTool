...
class ListRecordRulesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRecordRulesRequest';
    ...
    * appId  应用id
    * offset  查询结果起始编号，此处代表分页的页码
    * limit  查询结果集数量，此处代表每一页的条数
    *
    * @var string[]
    */
    ...
    * Sets offset
    *
    * @param int|null $offset 查询结果起始编号，此处代表分页的页码
    *
    * @return $this
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 查询结果集数量，此处代表每一页的条数
    *
    * @return $this
    */
