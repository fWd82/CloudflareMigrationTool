...
class CreateAppRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'xSdkDate' => 'string',
            'xProjectId' => 'string',
            'body' => '\HuaweiCloud\SDK\CloudRTC\V2\Model\AppReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CloudRTC\V2\Model\AppReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CloudRTC\V2\Model\AppReq|null $body body
    *
    * @return $this
    */
