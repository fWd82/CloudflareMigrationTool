...
class UpdateIndividualStreamJobRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateIndividualStreamJobRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'appId' => 'string',
            'jobId' => 'string',
            'body' => '\HuaweiCloud\SDK\CloudRTC\V2\Model\UpdateIndividualJobReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CloudRTC\V2\Model\UpdateIndividualJobReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CloudRTC\V2\Model\UpdateIndividualJobReq|null $body body
    *
    * @return $this
    */
