...
class AppReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AppReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * appName  app名称，仅支持填入utf8格式内容
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['appName'] === null) {
            ...
            if ((mb_strlen($this->container['appName']) > 256)) {
    ...
    * Sets appName
    *
    * @param string $appName app名称，仅支持填入utf8格式内容
    *
    * @return $this
    */
