...
class UpdateUrlAuthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateUrlAuthRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'appId' => 'string',
            'body' => '\HuaweiCloud\SDK\CloudRTC\V2\Model\AppAuthReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CloudRTC\V2\Model\AppAuthReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CloudRTC\V2\Model\AppAuthReq|null $body body
    *
    * @return $this
    */
