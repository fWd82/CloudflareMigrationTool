...
class UpdateMixJobRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMixJobRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'appId' => 'string',
            'jobId' => 'string',
            'body' => '\HuaweiCloud\SDK\CloudRTC\V2\Model\UpdateMixJobReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CloudRTC\V2\Model\UpdateMixJobReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CloudRTC\V2\Model\UpdateMixJobReq|null $body body
    *
    * @return $this
    */
