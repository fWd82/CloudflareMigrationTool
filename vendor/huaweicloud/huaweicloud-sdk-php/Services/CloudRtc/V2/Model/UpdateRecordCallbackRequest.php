...
class UpdateRecordCallbackRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRecordCallbackRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'appId' => 'string',
            'body' => '\HuaweiCloud\SDK\CloudRTC\V2\Model\AppCallbackUrlReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CloudRTC\V2\Model\AppCallbackUrlReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CloudRTC\V2\Model\AppCallbackUrlReq|null $body body
    *
    * @return $this
    */
