...
class RemoveUsersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemoveUsersRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'appId' => 'string',
            'roomId' => 'string',
            'body' => '\HuaweiCloud\SDK\CloudRTC\V2\Model\RemoveUsersReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CloudRTC\V2\Model\RemoveUsersReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CloudRTC\V2\Model\RemoveUsersReq|null $body body
    *
    * @return $this
    */
