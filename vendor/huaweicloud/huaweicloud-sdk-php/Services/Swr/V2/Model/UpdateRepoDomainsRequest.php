...
class UpdateRepoDomainsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'repository' => 'string',
            'accessDomain' => 'string',
            'body' => '\HuaweiCloud\SDK\Swr\V2\Model\UpdateRepoDomainsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\UpdateRepoDomainsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\UpdateRepoDomainsRequestBody|null $body body
    *
    * @return $this
    */
