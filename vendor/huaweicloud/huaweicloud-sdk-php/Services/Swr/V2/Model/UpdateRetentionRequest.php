...
class UpdateRetentionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'repository' => 'string',
            'retentionId' => 'int',
            'body' => '\HuaweiCloud\SDK\Swr\V2\Model\UpdateRetentionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\UpdateRetentionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\UpdateRetentionRequestBody|null $body body
    *
    * @return $this
    */
