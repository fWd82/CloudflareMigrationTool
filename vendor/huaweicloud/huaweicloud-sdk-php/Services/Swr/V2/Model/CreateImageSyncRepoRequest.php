...
class CreateImageSyncRepoRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'repository' => 'string',
            'body' => '\HuaweiCloud\SDK\Swr\V2\Model\CreateImageSyncRepoRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\CreateImageSyncRepoRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\CreateImageSyncRepoRequestBody|null $body body
    *
    * @return $this
    */
