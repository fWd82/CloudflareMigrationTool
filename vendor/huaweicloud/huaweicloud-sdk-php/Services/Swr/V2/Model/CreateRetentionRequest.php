...
class CreateRetentionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'repository' => 'string',
            'body' => '\HuaweiCloud\SDK\Swr\V2\Model\CreateRetentionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\CreateRetentionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\CreateRetentionRequestBody|null $body body
    *
    * @return $this
    */
