...
class UpdateRepoRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'repository' => 'string',
            'body' => '\HuaweiCloud\SDK\Swr\V2\Model\UpdateRepoRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\UpdateRepoRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\UpdateRepoRequestBody|null $body body
    *
    * @return $this
    */
