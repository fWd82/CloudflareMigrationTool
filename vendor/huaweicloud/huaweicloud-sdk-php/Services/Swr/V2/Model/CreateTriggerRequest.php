...
class CreateTriggerRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'repository' => 'string',
            'body' => '\HuaweiCloud\SDK\Swr\V2\Model\CreateTriggerRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\CreateTriggerRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\CreateTriggerRequestBody|null $body body
    *
    * @return $this
    */
