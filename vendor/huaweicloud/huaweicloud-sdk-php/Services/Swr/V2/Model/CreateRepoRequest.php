...
class CreateRepoRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'body' => '\HuaweiCloud\SDK\Swr\V2\Model\CreateRepoRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\CreateRepoRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\CreateRepoRequestBody|null $body body
    *
    * @return $this
    */
