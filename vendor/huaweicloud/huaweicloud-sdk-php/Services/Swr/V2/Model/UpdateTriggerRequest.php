...
class UpdateTriggerRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'repository' => 'string',
            'trigger' => 'string',
            'body' => '\HuaweiCloud\SDK\Swr\V2\Model\UpdateTriggerRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\UpdateTriggerRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\UpdateTriggerRequestBody|null $body body
    *
    * @return $this
    */
