...
class ListSharedReposDetailsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'body' => '\HuaweiCloud\SDK\Swr\V2\Model\ShowReposResp[]',
            'contentRange' => 'string'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\ShowReposResp[]|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\ShowReposResp[]|null $body body
    *
    * @return $this
    */
