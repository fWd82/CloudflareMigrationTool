...
class SwitchoverDisasterRecoveryResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SwitchoverDisasterRecoveryResponse';
    ...
    */
    protected static $openAPITypes = [
            'disasterRecovery' => '\HuaweiCloud\SDK\Dws\V2\Model\DisasterRecoveryId'
    ];
    ...
    *  disasterRecovery
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\DisasterRecoveryId|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\DisasterRecoveryId|null $disasterRecovery disasterRecovery
    *
    * @return $this
    */
