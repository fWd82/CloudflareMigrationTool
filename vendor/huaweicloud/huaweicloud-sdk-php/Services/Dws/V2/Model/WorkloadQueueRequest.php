...
class WorkloadQueueRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WorkloadQueueRequest';
    ...
    */
    protected static $openAPITypes = [
            'workloadQueue' => '\HuaweiCloud\SDK\Dws\V2\Model\WorkloadQueueInfo'
    ];
    ...
    *  workloadQueue
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\WorkloadQueueInfo
    */
    ...
    * Sets workloadQueue
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\WorkloadQueueInfo $workloadQueue workloadQueue
    *
    * @return $this
    */
