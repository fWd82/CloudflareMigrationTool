...
class CreateClusterRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'cluster' => '\HuaweiCloud\SDK\Dws\V2\Model\CreateClusterInfo'
    ];
    ...
    *  cluster
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\CreateClusterInfo
    */
    ...
    * Sets cluster
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\CreateClusterInfo $cluster cluster
    *
    * @return $this
    */
