...
class WorkloadQueueUserReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WorkloadQueueUserReq';
    ...
    */
    protected static $openAPITypes = [
            'queueName' => 'string',
            'userList' => '\HuaweiCloud\SDK\Dws\V2\Model\WorkloadQueueUserReqUserList[]'
    ];
