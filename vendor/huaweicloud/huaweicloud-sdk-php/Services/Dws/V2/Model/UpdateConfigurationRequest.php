...
class UpdateConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Dws\V2\Model\ConfigurationParameterValues'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\ConfigurationParameterValues|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\ConfigurationParameterValues|null $body body
    *
    * @return $this
    */
