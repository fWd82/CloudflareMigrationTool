...
class ListTopoRingsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTopoRingsResponse';
    ...
    */
    protected static $openAPITypes = [
            'clusterRings' => '\HuaweiCloud\SDK\Dws\V2\Model\TopoRingInfo[]',
            'count' => 'int'
    ];
