...
class RestartLogicalClusterRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RestartLogicalClusterRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * clusterId  指定重启集群的ID
    * logicalClusterId  指定待重启逻辑集群的ID
    *
    * @var string[]
    */
