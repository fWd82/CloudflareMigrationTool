...
class ListQuotasResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'quotas' => '\HuaweiCloud\SDK\Dws\V2\Model\QuotasQuotas'
    ];
    ...
    *  quotas
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\QuotasQuotas|null
    */
    ...
    * Sets quotas
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\QuotasQuotas|null $quotas quotas
    *
    * @return $this
    */
