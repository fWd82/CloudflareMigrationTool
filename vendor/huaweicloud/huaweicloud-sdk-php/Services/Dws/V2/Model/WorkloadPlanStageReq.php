...
class WorkloadPlanStageReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WorkloadPlanStageReq';
    ...
    */
    protected static $openAPITypes = [
            'workloadPlanStage' => '\HuaweiCloud\SDK\Dws\V2\Model\WorkloadPlanStageReqWorkloadPlanStage'
    ];
    ...
    *  workloadPlanStage
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\WorkloadPlanStageReqWorkloadPlanStage|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\WorkloadPlanStageReqWorkloadPlanStage|null $workloadPlanStage workloadPlanStage
    *
    * @return $this
    */
