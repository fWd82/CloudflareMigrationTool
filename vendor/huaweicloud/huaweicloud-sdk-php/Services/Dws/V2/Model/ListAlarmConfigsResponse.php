...
class ListAlarmConfigsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAlarmConfigsResponse';
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'alarmConfigs' => '\HuaweiCloud\SDK\Dws\V2\Model\AlarmConfigResponse[]'
    ];
