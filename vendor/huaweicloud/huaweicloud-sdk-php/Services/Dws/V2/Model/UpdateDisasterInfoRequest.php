...
class UpdateDisasterInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDisasterInfoRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * disasterRecoveryId  容灾ID
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Dws\V2\Model\UpdateDisasterRecoveryRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\UpdateDisasterRecoveryRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\UpdateDisasterRecoveryRequest|null $body body
    *
    * @return $this
    */
