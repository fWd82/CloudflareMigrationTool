...
class ReconfigureExtDataSourceAction implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReconfigureExtDataSourceAction';
