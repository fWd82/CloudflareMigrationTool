...
class ListDisasterRecoverResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDisasterRecoverResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * disasterRecovery  容灾对象
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'disasterRecovery' => '\HuaweiCloud\SDK\Dws\V2\Model\DisasterRecovery[]'
    ];
    ...
    *  容灾对象
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\DisasterRecovery[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\DisasterRecovery[]|null $disasterRecovery 容灾对象
    *
    * @return $this
    */
