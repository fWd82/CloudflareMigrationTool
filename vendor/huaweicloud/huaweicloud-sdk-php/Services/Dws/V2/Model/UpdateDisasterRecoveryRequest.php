...
class UpdateDisasterRecoveryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDisasterRecoveryRequest';
    ...
    */
    protected static $openAPITypes = [
            'disasterRecovery' => '\HuaweiCloud\SDK\Dws\V2\Model\UpdateDisasterRecoveryReq'
    ];
    ...
    *  disasterRecovery
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\UpdateDisasterRecoveryReq|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\UpdateDisasterRecoveryReq|null $disasterRecovery disasterRecovery
    *
    * @return $this
    */
