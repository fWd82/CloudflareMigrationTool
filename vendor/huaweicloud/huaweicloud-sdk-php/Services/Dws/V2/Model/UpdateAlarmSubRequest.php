...
class UpdateAlarmSubRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAlarmSubRequest';
    ...
    */
    protected static $openAPITypes = [
            'alarmSubId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dws\V2\Model\AlarmSubUpdateRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\AlarmSubUpdateRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\AlarmSubUpdateRequest|null $body body
    *
    * @return $this
    */
