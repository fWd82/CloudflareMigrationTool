...
class ListWorkloadPlansResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWorkloadPlansResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'planList' => '\HuaweiCloud\SDK\Dws\V2\Model\WorkloadPlanInfo[]',
            'count' => 'int'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['planList'] = isset($data['planList']) ? $data['planList'] : null;
    ...
    */
    ...
    {
        return $this->container['planList'];
    }

    /**
    * Sets planList
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\WorkloadPlanInfo[]|null $planList 资源池名称。
    *
    * @return $this
    */
    public function setPlanList($planList)
    {
        $this->container['planList'] = $planList;
        return $this;
    }
