...
class ShowInstanceExtendProductInfoRespMonthly implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowInstanceExtendProductInfoResp_monthly';
