...
class ShowMaintainWindowsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'maintainWindows' => '\HuaweiCloud\SDK\RabbitMQ\V2\Model\MaintainWindowsEntity[]'
    ];
    ...
    *  支持的维护时间窗列表。
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\MaintainWindowsEntity[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\MaintainWindowsEntity[]|null $maintainWindows 支持的维护时间窗列表。
    *
    * @return $this
    */
