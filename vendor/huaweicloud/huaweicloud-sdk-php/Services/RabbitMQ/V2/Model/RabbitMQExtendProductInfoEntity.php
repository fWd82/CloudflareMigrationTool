...
class RabbitMQExtendProductInfoEntity implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RabbitMQExtendProductInfoEntity';
    ...
    */
    protected static $openAPITypes = [
            ...
            'archTypes' => 'string[]',
            'chargingMode' => 'string[]',
            'ios' => '\HuaweiCloud\SDK\RabbitMQ\V2\Model\RabbitMQExtendProductIosEntity[]',
    ...
    *  磁盘IO信息。
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\RabbitMQExtendProductIosEntity[]|null
    */
    ...
    * Sets ios
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\RabbitMQExtendProductIosEntity[]|null $ios 磁盘IO信息。
    *
    * @return $this
    */
    ...
    *  properties
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\RabbitMQExtendProductPropertiesEntity|null
    */
    ...
    * Sets properties
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\RabbitMQExtendProductPropertiesEntity|null $properties properties
    *
    * @return $this
    */
    ...
    *  支持的特性功能。
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\RabbitMQProductSupportFeaturesEntity[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\RabbitMQProductSupportFeaturesEntity[]|null $supportFeatures 支持的特性功能。
    *
    * @return $this
    */
