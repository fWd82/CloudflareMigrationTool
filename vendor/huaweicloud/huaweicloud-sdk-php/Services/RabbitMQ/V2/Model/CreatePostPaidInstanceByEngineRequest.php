...
class CreatePostPaidInstanceByEngineRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePostPaidInstanceByEngineRequest';
    ...
    */
    protected static $openAPITypes = [
            'engine' => 'string',
            'body' => '\HuaweiCloud\SDK\RabbitMQ\V2\Model\CreateInstanceReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\CreateInstanceReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\CreateInstanceReq|null $body body
    *
    * @return $this
    */
