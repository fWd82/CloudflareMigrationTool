...
class ListProductsRespValues implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProductsResp_values';
    ...
    */
    protected static $openAPITypes = [
            'detail' => '\HuaweiCloud\SDK\RabbitMQ\V2\Model\ListProductsRespDetail[]',
            'name' => 'string',
    ...
    *  规格详情。
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\ListProductsRespDetail[]|null
    */
    ...
    * Sets detail
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\ListProductsRespDetail[]|null $detail 规格详情。
    *
    * @return $this
    */
