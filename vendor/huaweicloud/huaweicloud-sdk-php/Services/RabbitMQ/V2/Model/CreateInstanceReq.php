...
class CreateInstanceReq implements ModelInterface, ArrayAccess
{
    ...
    * engineVersion  消息引擎的版本。   - RabbitMQ版本有：3.8.35[和3.7.17](tag:tm,hk_tm,hk_sbc,sbc)。
    ...
    * accessUser  认证用户名，只能由英文字母开头且由英文字母、数字、中划线、下划线组成，长度为4~64的字符。
    ...
    * productId  产品标识。  [产品ID可以从[查询产品规格列表](ListEngineProducts.xml)获取。](tag:hws,hws_hk,ctc,cmcc,hws_eu,g42,hk_g42,tm,hk_tm,ocb,hws_ocb,hcs) [产品ID可以从[查询产品规格列表](ListProducts.xml)获取。](tag:hk_sbc,sbc)  如果产品ID为集群类型（即对应的type为cluster），broker_num字段为必选。
    ...
    * Sets engineVersion
    *
    * @param string $engineVersion 消息引擎的版本。   - RabbitMQ版本有：3.8.35[和3.7.17](tag:tm,hk_tm,hk_sbc,sbc)。
    *
    * @return $this
    */
    ...
    * Sets productId
    *
    * @param string $productId 产品标识。  [产品ID可以从[查询产品规格列表](ListEngineProducts.xml)获取。](tag:hws,hws_hk,ctc,cmcc,hws_eu,g42,hk_g42,tm,hk_tm,ocb,hws_ocb,hcs) [产品ID可以从[查询产品规格列表](ListProducts.xml)获取。](tag:hk_sbc,sbc)  如果产品ID为集群类型（即对应的type为cluster），broker_num字段为必选。
    *
    * @return $this
    */
