...
class BlackWhiteIpRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BlackWhiteIpRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * type  类型。white：白名单，black：黑名单
    * ipList  ip列表
    *
    * @var string[]
    */
    ...
    * Sets type
    *
    * @param string $type 类型。white：白名单，black：黑名单
    *
    * @return $this
    */
