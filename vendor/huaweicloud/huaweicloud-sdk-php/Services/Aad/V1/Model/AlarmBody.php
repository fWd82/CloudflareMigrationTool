...
class AlarmBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AlarmBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * topicUrn  SMN的topic urn
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['topicUrn'] === null) {
            ...
            if ((mb_strlen($this->container['topicUrn']) > 255)) {
    ...
    * Sets topicUrn
    *
    * @param string $topicUrn SMN的topic urn
    *
    * @return $this
    */
