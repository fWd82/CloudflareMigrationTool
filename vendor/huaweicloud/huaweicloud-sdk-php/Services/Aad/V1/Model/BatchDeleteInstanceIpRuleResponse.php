...
class BatchDeleteInstanceIpRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteInstanceIpRuleResponse';
