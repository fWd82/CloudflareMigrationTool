...
class UpdatePackageIpRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePackageIpRequest';
    ...
    */
    protected static $openAPITypes = [
            'packageId' => 'string',
            'body' => '\HuaweiCloud\SDK\Aad\V1\Model\UpdatePackageIpRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aad\V1\Model\UpdatePackageIpRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aad\V1\Model\UpdatePackageIpRequestBody|null $body body
    *
    * @return $this
    */
