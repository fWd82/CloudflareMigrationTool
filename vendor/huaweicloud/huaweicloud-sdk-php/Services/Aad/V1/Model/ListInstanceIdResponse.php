...
class ListInstanceIdResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceIdResponse';
    ...
    * Sets instanceIds
    *
    * @param string[]|null $instanceIds 实例ID列表
    *
    * @return $this
    */
