...
class UpdatePolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Aad\V1\Model\UpdatePolicyRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aad\V1\Model\UpdatePolicyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aad\V1\Model\UpdatePolicyRequestBody|null $body body
    *
    * @return $this
    */
