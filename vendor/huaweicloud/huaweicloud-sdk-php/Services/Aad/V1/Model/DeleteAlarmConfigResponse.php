...
class DeleteAlarmConfigResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteAlarmConfigResponse';
    ...
    * Sets topicUrn
    *
    * @param string|null $topicUrn SMN的topic urn
    *
    * @return $this
    */
