...
class ExecuteUnblockIpResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteUnblockIpResponse';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['errorCode']) && (mb_strlen($this->container['errorCode']) > 128)) {
                $invalidProperties[] = "invalid value for 'errorCode', the character length must be smaller than or equal to 128.";
            }
