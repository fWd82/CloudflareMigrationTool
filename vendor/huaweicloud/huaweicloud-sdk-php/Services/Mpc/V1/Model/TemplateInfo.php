...
class TemplateInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'templateId' => 'int',
            'template' => '\HuaweiCloud\SDK\Mpc\V1\Model\QueryTransTemplate'
    ];
    ...
    *  template
    *
    * @return \HuaweiCloud\SDK\Mpc\V1\Model\QueryTransTemplate|null
    */
    ...
    * Sets template
    *
    * @param \HuaweiCloud\SDK\Mpc\V1\Model\QueryTransTemplate|null $template template
    *
    * @return $this
    */
