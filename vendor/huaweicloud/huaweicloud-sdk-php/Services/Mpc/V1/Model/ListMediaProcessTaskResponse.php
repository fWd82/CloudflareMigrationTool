...
class ListMediaProcessTaskResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'taskArray' => '\HuaweiCloud\SDK\Mpc\V1\Model\MediaProcessTaskInfo[]',
            'isTruncated' => 'int',
            'total' => 'int'
    ];
    ...
    *  任务列表
    *
    * @return \HuaweiCloud\SDK\Mpc\V1\Model\MediaProcessTaskInfo[]|null
    */
    ...
    * Sets taskArray
    *
    * @param \HuaweiCloud\SDK\Mpc\V1\Model\MediaProcessTaskInfo[]|null $taskArray 任务列表
    *
    * @return $this
    */
