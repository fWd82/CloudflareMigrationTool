...
class ListAllBucketsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'buckets' => '\HuaweiCloud\SDK\Mpc\V1\Model\ObsBucket[]'
    ];
    ...
    *  桶列表
    *
    * @return \HuaweiCloud\SDK\Mpc\V1\Model\ObsBucket[]|null
    */
    ...
    * Sets buckets
    *
    * @param \HuaweiCloud\SDK\Mpc\V1\Model\ObsBucket[]|null $buckets 桶列表
    *
    * @return $this
    */
