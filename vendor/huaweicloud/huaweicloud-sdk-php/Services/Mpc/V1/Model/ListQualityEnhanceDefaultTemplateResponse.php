...
class ListQualityEnhanceDefaultTemplateResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'taskArray' => '\HuaweiCloud\SDK\Mpc\V1\Model\QualityEnhanceTemplateInfo[]',
            'total' => 'int'
    ];
    ...
    *  任务列表
    *
    * @return \HuaweiCloud\SDK\Mpc\V1\Model\QualityEnhanceTemplateInfo[]|null
    */
    ...
    * Sets taskArray
    *
    * @param \HuaweiCloud\SDK\Mpc\V1\Model\QualityEnhanceTemplateInfo[]|null $taskArray 任务列表
    *
    * @return $this
    */
