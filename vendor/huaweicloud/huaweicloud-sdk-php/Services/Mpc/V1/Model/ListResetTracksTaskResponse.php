...
class ListResetTracksTaskResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'taskArray' => '\HuaweiCloud\SDK\Mpc\V1\Model\ResetTracksTaskInfo[]',
            'isTruncated' => 'int',
            'total' => 'int'
    ];
    ...
    *  任务列表
    *
    * @return \HuaweiCloud\SDK\Mpc\V1\Model\ResetTracksTaskInfo[]|null
    */
    ...
    * Sets taskArray
    *
    * @param \HuaweiCloud\SDK\Mpc\V1\Model\ResetTracksTaskInfo[]|null $taskArray 任务列表
    *
    * @return $this
    */
