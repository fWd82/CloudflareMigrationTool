...
class TemplateGroup implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'name' => 'string',
            'templateIds' => 'int[]',
            'videos' => '\HuaweiCloud\SDK\Mpc\V1\Model\VideoAndTemplate[]',
    ...
    *  视频信息列表
    *
    * @return \HuaweiCloud\SDK\Mpc\V1\Model\VideoAndTemplate[]|null
    */
    ...
    * Sets videos
    *
    * @param \HuaweiCloud\SDK\Mpc\V1\Model\VideoAndTemplate[]|null $videos 视频信息列表
    *
    * @return $this
    */
