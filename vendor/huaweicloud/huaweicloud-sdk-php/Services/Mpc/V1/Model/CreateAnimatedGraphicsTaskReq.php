...
class CreateAnimatedGraphicsTaskReq implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'userData' => 'string',
            'outputParam' => '\HuaweiCloud\SDK\Mpc\V1\Model\AnimatedGraphicsOutputParam'
    ];
    ...
    *  outputParam
    *
    * @return \HuaweiCloud\SDK\Mpc\V1\Model\AnimatedGraphicsOutputParam|null
    */
    ...
    * Sets outputParam
    *
    * @param \HuaweiCloud\SDK\Mpc\V1\Model\AnimatedGraphicsOutputParam|null $outputParam outputParam
    *
    * @return $this
    */
