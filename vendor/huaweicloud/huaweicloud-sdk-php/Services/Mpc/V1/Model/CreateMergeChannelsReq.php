...
class CreateMergeChannelsReq implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'multiAudio' => '\HuaweiCloud\SDK\Mpc\V1\Model\MpcMultiAudio'
    ];
    ...
    *  multiAudio
    *
    * @return \HuaweiCloud\SDK\Mpc\V1\Model\MpcMultiAudio|null
    */
    ...
    * Sets multiAudio
    *
    * @param \HuaweiCloud\SDK\Mpc\V1\Model\MpcMultiAudio|null $multiAudio multiAudio
    *
    * @return $this
    */
