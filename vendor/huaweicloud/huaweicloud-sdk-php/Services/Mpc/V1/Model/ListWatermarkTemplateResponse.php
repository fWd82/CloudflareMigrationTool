...
class ListWatermarkTemplateResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'templates' => '\HuaweiCloud\SDK\Mpc\V1\Model\WatermarkTemplate[]'
    ];
    ...
    *  水印模板
    *
    * @return \HuaweiCloud\SDK\Mpc\V1\Model\WatermarkTemplate[]|null
    */
    ...
    * Sets templates
    *
    * @param \HuaweiCloud\SDK\Mpc\V1\Model\WatermarkTemplate[]|null $templates 水印模板
    *
    * @return $this
    */
