...
class ListTranscodingTaskResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'taskArray' => '\HuaweiCloud\SDK\Mpc\V1\Model\QueryTranscodingsTaskResponse[]',
            'isTruncated' => 'int',
            'total' => 'int'
    ];
    ...
    *  返回任务组
    *
    * @return \HuaweiCloud\SDK\Mpc\V1\Model\QueryTranscodingsTaskResponse[]|null
    */
    ...
    * Sets taskArray
    *
    * @param \HuaweiCloud\SDK\Mpc\V1\Model\QueryTranscodingsTaskResponse[]|null $taskArray 返回任务组
    *
    * @return $this
    */
