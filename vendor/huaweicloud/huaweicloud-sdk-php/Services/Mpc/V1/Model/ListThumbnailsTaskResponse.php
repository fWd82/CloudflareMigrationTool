...
class ListThumbnailsTaskResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'taskArray' => '\HuaweiCloud\SDK\Mpc\V1\Model\ThumbTask[]',
            'isTruncated' => 'int',
            'total' => 'int'
    ];
    ...
    *  截图任务组
    *
    * @return \HuaweiCloud\SDK\Mpc\V1\Model\ThumbTask[]|null
    */
    ...
    * Sets taskArray
    *
    * @param \HuaweiCloud\SDK\Mpc\V1\Model\ThumbTask[]|null $taskArray 截图任务组
    *
    * @return $this
    */
