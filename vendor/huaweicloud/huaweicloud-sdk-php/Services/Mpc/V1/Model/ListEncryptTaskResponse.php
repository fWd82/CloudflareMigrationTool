...
class ListEncryptTaskResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'taskArray' => '\HuaweiCloud\SDK\Mpc\V1\Model\EachEncryptRsp[]',
            'isTruncated' => 'int',
            'total' => 'int'
    ];
    ...
    *  任务列表
    *
    * @return \HuaweiCloud\SDK\Mpc\V1\Model\EachEncryptRsp[]|null
    */
    ...
    * Sets taskArray
    *
    * @param \HuaweiCloud\SDK\Mpc\V1\Model\EachEncryptRsp[]|null $taskArray 任务列表
    *
    * @return $this
    */
