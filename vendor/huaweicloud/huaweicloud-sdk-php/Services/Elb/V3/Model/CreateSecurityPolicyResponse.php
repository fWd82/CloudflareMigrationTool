...
class CreateSecurityPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSecurityPolicyResponse';
    ...
    */
    protected static $openAPITypes = [
            'securityPolicy' => '\HuaweiCloud\SDK\Elb\V3\Model\SecurityPolicy',
            'requestId' => 'string'
    ];
    ...
    * Sets securityPolicy
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\SecurityPolicy|null $securityPolicy securityPolicy
    *
    * @return $this
    */
