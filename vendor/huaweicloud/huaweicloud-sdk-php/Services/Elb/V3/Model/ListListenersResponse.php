...
class ListListenersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListListenersResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  请求ID。  注：自动生成 。
    * pageInfo  pageInfo
    * listeners  Listener的列表。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'listeners' => '\HuaweiCloud\SDK\Elb\V3\Model\Listener[]'
    ];
    ...
    *  Listener的列表。
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\Listener[]|null
    */
    ...
    * Sets listeners
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\Listener[]|null $listeners Listener的列表。
    *
    * @return $this
    */
