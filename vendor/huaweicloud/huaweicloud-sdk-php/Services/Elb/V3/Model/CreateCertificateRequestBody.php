...
class CreateCertificateRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'certificate' => '\HuaweiCloud\SDK\Elb\V3\Model\CreateCertificateOption'
    ];
    ...
    *  certificate
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\CreateCertificateOption
    */
    ...
    * Sets certificate
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\CreateCertificateOption $certificate certificate
    *
    * @return $this
    */
