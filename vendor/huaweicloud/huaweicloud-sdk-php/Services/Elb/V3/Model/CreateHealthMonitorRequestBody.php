...
class CreateHealthMonitorRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateHealthMonitorRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'healthmonitor' => '\HuaweiCloud\SDK\Elb\V3\Model\CreateHealthMonitorOption'
    ];
    ...
    *  healthmonitor
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\CreateHealthMonitorOption
    */
    ...
    * Sets healthmonitor
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\CreateHealthMonitorOption $healthmonitor healthmonitor
    *
    * @return $this
    */
