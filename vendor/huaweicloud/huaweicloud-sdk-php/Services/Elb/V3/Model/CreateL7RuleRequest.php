...
class CreateL7RuleRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'l7policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Elb\V3\Model\CreateL7RuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\CreateL7RuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\CreateL7RuleRequestBody|null $body body
    *
    * @return $this
    */
