...
class UpdateIpGroupRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'ipgroup' => '\HuaweiCloud\SDK\Elb\V3\Model\UpdateIpGroupOption'
    ];
    ...
    *  ipgroup
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\UpdateIpGroupOption
    */
    ...
    * Sets ipgroup
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\UpdateIpGroupOption $ipgroup ipgroup
    *
    * @return $this
    */
