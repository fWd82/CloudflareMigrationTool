...
class ListQuotaDetailsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListQuotaDetailsResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'quotas' => '\HuaweiCloud\SDK\Elb\V3\Model\QuotaInfo[]'
    ];
