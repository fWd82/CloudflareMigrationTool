...
class UpdateLogtankRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'logtankId' => 'string',
            'body' => '\HuaweiCloud\SDK\Elb\V3\Model\UpdateLogtankRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\UpdateLogtankRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\UpdateLogtankRequestBody|null $body body
    *
    * @return $this
    */
