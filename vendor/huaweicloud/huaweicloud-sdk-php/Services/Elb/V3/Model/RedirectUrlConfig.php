...
class RedirectUrlConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RedirectUrlConfig';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * protocol  重定向的协议。默认值${protocol}表示继承原值（即与被转发请求保持一致）。  取值： - HTTP - HTTPS - ${protocol}
