...
class UpdateL7PolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateL7PolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            'l7policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Elb\V3\Model\UpdateL7PolicyRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\UpdateL7PolicyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\UpdateL7PolicyRequestBody|null $body body
    *
    * @return $this
    */
