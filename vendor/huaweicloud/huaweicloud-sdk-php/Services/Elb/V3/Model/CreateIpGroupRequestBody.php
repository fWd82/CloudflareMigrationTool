...
class CreateIpGroupRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'ipgroup' => '\HuaweiCloud\SDK\Elb\V3\Model\CreateIpGroupOption'
    ];
    ...
    *  ipgroup
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\CreateIpGroupOption
    */
    ...
    * Sets ipgroup
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\CreateIpGroupOption $ipgroup ipgroup
    *
    * @return $this
    */
