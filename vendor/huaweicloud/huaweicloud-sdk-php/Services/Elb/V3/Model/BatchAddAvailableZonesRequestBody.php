...
class BatchAddAvailableZonesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchAddAvailableZonesRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * availabilityZoneList  新增的可用区列表，不能为空。
    *
    * @var string[]
    */
    ...
    *
    * @param string[] $availabilityZoneList 新增的可用区列表，不能为空。
    *
    * @return $this
    */
