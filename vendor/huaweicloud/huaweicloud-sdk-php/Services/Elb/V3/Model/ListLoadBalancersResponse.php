...
class ListLoadBalancersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLoadBalancersResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * loadbalancers  Loadbalancer的列表。
    * pageInfo  pageInfo
    ...
    */
    protected static $openAPITypes = [
            'loadbalancers' => '\HuaweiCloud\SDK\Elb\V3\Model\LoadBalancer[]',
    ...
    * Sets loadbalancers
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\LoadBalancer[]|null $loadbalancers Loadbalancer的列表。
    *
    * @return $this
    */
