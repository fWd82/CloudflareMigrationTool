...
class IpInfo implements ModelInterface, ArrayAccess
{
    ...
    * ip  IP地址组中的IP地址。  [不支持IPv6，请勿设置为IPv6地址。](tag:dt,dt_test)
    * description  IP地址组中ip的备注信息
    *
    * @var string[]
    */
    ...
    * Sets ip
    *
    * @param string $ip IP地址组中的IP地址。  [不支持IPv6，请勿设置为IPv6地址。](tag:dt,dt_test)
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string $description IP地址组中ip的备注信息
    *
    * @return $this
    */
