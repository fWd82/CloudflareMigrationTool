...
class LoadBalancerStatusPolicy implements ModelInterface, ArrayAccess
{
    ...
    *
    * @param string|null $provisioningStatus 转发策略的配置状态。  取值范围： - ACTIVE: 默认值，表示正常。 [- ERROR: 表示当前策略与同一监听器下的其他策略存在相同的规则配置。 ](tag:hws,hws_hk,ocb,ctc,hcs,g42,tm,cmcc,hk_g42,hws_ocb,fcs)
    *
    * @return $this
    */
