...
class UpdateL7RuleRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'l7policyId' => 'string',
            'l7ruleId' => 'string',
            'body' => '\HuaweiCloud\SDK\Elb\V3\Model\UpdateL7RuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\UpdateL7RuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\UpdateL7RuleRequestBody|null $body body
    *
    * @return $this
    */
