...
class ListMasterSlavePoolsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMasterSlavePoolsResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'pools' => '\HuaweiCloud\SDK\Elb\V3\Model\MasterSlavePool[]'
    ];
    ...
    * Sets pools
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\MasterSlavePool[]|null $pools 后端服务器组列表。
    *
    * @return $this
    */
