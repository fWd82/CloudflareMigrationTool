...
class ListLogtanksResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLogtanksResponse';
    ...
    */
    protected static $openAPITypes = [
            'logtanks' => '\HuaweiCloud\SDK\Elb\V3\Model\Logtank[]',
    ...
    *  描述信息
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\Logtank[]|null
    */
    ...
    * Sets logtanks
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\Logtank[]|null $logtanks 描述信息
    *
    * @return $this
    */
