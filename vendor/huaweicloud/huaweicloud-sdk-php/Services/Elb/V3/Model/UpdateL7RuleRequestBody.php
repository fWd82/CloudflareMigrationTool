...
class UpdateL7RuleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'rule' => '\HuaweiCloud\SDK\Elb\V3\Model\UpdateL7RuleOption'
    ];
    ...
    *  rule
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\UpdateL7RuleOption
    */
    ...
    * Sets rule
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\UpdateL7RuleOption $rule rule
    *
    * @return $this
    */
