...
class BatchDeleteIpListRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteIpListRequest';
    ...
    */
    protected static $openAPITypes = [
            'ipgroupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Elb\V3\Model\BatchDeleteIpListRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\BatchDeleteIpListRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\BatchDeleteIpListRequestBody|null $body body
    *
    * @return $this
    */
