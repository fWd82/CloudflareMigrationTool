...
class CreateSecurityPolicyOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSecurityPolicyOption';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  自定义安全策略的名称。默认空字符串\"\"。
    * description  自定义安全策略的描述信息。默认空字符串\"\"。
    * enterpriseProjectId  所属企业项目ID。  [不支持该字段，请勿使用。](tag:dt,dt_test,hcso_dt)
    ...
    *
    * @param string|null $enterpriseProjectId 所属企业项目ID。  [不支持该字段，请勿使用。](tag:dt,dt_test,hcso_dt)
    *
    * @return $this
    */
