...
class BatchRemoveAvailableZonesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchRemoveAvailableZonesRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * availabilityZoneList  移除的可用区列表，不能为空。
    *
    * @var string[]
    */
    ...
    *
    * @param string[] $availabilityZoneList 移除的可用区列表，不能为空。
    *
    * @return $this
    */
