...
class UpdateCertificateRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'certificate' => '\HuaweiCloud\SDK\Elb\V3\Model\UpdateCertificateOption'
    ];
    ...
    *  certificate
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\UpdateCertificateOption
    */
    ...
    * Sets certificate
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\UpdateCertificateOption $certificate certificate
    *
    * @return $this
    */
