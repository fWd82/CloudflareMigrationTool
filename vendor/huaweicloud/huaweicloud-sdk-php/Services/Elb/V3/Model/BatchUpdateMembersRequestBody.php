...
class BatchUpdateMembersRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'members' => '\HuaweiCloud\SDK\Elb\V3\Model\BatchUpdateMembersOption[]'
    ];
    ...
    *  后端服务器对象。
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\BatchUpdateMembersOption[]
    */
    ...
    * Sets members
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\BatchUpdateMembersOption[] $members 后端服务器对象。
    *
    * @return $this
    */
