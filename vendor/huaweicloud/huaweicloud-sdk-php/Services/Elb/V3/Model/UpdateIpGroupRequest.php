...
class UpdateIpGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateIpGroupRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * ipgroupId  待更新的IP地址组的ID。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'ipgroupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Elb\V3\Model\UpdateIpGroupRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\UpdateIpGroupRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\UpdateIpGroupRequestBody|null $body body
    *
    * @return $this
    */
