...
class MasterSlavePool implements ModelInterface, ArrayAccess
{
    ...
    * Sets members
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\MasterSlaveMember[] $members 后端云服务器组中的后端云服务器列表。
    *
    * @return $this
    */
    ...
    * Sets createdAt
    *
    * @param string $createdAt 创建时间。格式：yyyy-MM-dd'T'HH:mm:ss'Z'，UTC时区。  [注意：独享型实例的历史数据以及共享型实例下的资源，不返回该字段。 ](tag:hws,hws_hk,ocb,ctc,g42,tm,cmcc,hk_g42,hws_ocb,fcs,dt,hk_tm)
    *
    * @return $this
    */
    ...
    * Sets updatedAt
    *
    * @param string $updatedAt 更新时间。格式：yyyy-MM-dd'T'HH:mm:ss'Z'，UTC时区。  [注意：独享型实例的历史数据以及共享型实例下的资源，不返回该字段。 ](tag:hws,hws_hk,ocb,ctc,g42,tm,cmcc,hk_g42,hws_ocb,fcs,dt,hk_tm)
    *
    * @return $this
    */
    ...
    *
    * @param string $enterpriseProjectId 后端服务器组的企业项目ID。无论创建什么企业项目，都在默认企业项目下。  [不支持该字段，请勿使用。](tag:dt,dt_test,hcso_dt)
    *
    * @return $this
    */
