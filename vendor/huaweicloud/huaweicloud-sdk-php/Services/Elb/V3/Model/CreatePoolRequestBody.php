...
class CreatePoolRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'pool' => '\HuaweiCloud\SDK\Elb\V3\Model\CreatePoolOption'
    ];
    ...
    *  pool
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\CreatePoolOption
    */
    ...
    * Sets pool
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\CreatePoolOption $pool pool
    *
    * @return $this
    */
