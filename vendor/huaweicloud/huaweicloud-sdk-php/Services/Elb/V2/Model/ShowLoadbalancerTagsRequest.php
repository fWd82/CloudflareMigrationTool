...
class ShowLoadbalancerTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowLoadbalancerTagsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * loadbalancerId  负载均衡器所在的项目id
    *
    * @var string[]
    */
