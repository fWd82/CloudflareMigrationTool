...
class CreatePoolRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'pool' => '\HuaweiCloud\SDK\Elb\V2\Model\CreatePoolReq'
    ];
    ...
    *  pool
    *
    * @return \HuaweiCloud\SDK\Elb\V2\Model\CreatePoolReq
    */
    ...
    * Sets pool
    *
    * @param \HuaweiCloud\SDK\Elb\V2\Model\CreatePoolReq $pool pool
    *
    * @return $this
    */
