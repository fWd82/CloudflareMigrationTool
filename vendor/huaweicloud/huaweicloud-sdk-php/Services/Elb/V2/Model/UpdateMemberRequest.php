...
class UpdateMemberRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'memberId' => 'string',
            'poolId' => 'string',
            'body' => '\HuaweiCloud\SDK\Elb\V2\Model\UpdateMemberRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V2\Model\UpdateMemberRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V2\Model\UpdateMemberRequestBody|null $body body
    *
    * @return $this
    */
