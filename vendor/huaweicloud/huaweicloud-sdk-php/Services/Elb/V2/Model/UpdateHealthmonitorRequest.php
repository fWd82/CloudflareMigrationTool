...
class UpdateHealthmonitorRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateHealthmonitorRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * healthmonitorId  健康检查id
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Elb\V2\Model\UpdateHealthmonitorRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V2\Model\UpdateHealthmonitorRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V2\Model\UpdateHealthmonitorRequestBody|null $body body
    *
    * @return $this
    */
