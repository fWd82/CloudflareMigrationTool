...
class CreateMemberRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'poolId' => 'string',
            'body' => '\HuaweiCloud\SDK\Elb\V2\Model\CreateMemberRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V2\Model\CreateMemberRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V2\Model\CreateMemberRequestBody|null $body body
    *
    * @return $this
    */
