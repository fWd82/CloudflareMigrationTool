...
class CreateHealthmonitorRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'healthmonitor' => '\HuaweiCloud\SDK\Elb\V2\Model\CreateHealthmonitorReq'
    ];
    ...
    *  healthmonitor
    *
    * @return \HuaweiCloud\SDK\Elb\V2\Model\CreateHealthmonitorReq
    */
    ...
    * Sets healthmonitor
    *
    * @param \HuaweiCloud\SDK\Elb\V2\Model\CreateHealthmonitorReq $healthmonitor healthmonitor
    *
    * @return $this
    */
