...
class CreateL7ruleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateL7ruleRequest';
    ...
    */
    protected static $openAPITypes = [
            'l7policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Elb\V2\Model\CreateL7ruleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V2\Model\CreateL7ruleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V2\Model\CreateL7ruleRequestBody|null $body body
    *
    * @return $this
    */
