...
class UpdateHealthmonitorRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'healthmonitor' => '\HuaweiCloud\SDK\Elb\V2\Model\UpdateHealthmonitorReq'
    ];
    ...
    *  healthmonitor
    *
    * @return \HuaweiCloud\SDK\Elb\V2\Model\UpdateHealthmonitorReq
    */
    ...
    * Sets healthmonitor
    *
    * @param \HuaweiCloud\SDK\Elb\V2\Model\UpdateHealthmonitorReq $healthmonitor healthmonitor
    *
    * @return $this
    */
