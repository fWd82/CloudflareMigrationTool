...
class CreateLoadbalancerTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateLoadbalancerTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Elb\V2\Model\CreateLoadbalancerTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V2\Model\CreateLoadbalancerTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V2\Model\CreateLoadbalancerTagsRequestBody|null $body body
    *
    * @return $this
    */
