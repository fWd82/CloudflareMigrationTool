...
class UpdateL7ruleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateL7ruleRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * l7policyId  待更新的转发规则所在的转发策略id
    * l7ruleId  待更新的转发规则id
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'l7policyId' => 'string',
            'l7ruleId' => 'string',
            'body' => '\HuaweiCloud\SDK\Elb\V2\Model\UpdateL7ruleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V2\Model\UpdateL7ruleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V2\Model\UpdateL7ruleRequestBody|null $body body
    *
    * @return $this
    */
