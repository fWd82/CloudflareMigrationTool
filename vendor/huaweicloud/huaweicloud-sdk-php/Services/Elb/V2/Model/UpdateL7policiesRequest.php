...
class UpdateL7policiesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateL7policiesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * l7policyId  待更新的转发策略id
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'l7policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Elb\V2\Model\UpdateL7policiesRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V2\Model\UpdateL7policiesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V2\Model\UpdateL7policiesRequestBody|null $body body
    *
    * @return $this
    */
