...
class UpdateCertificateRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Elb\V2\Model\UpdateCertificateRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V2\Model\UpdateCertificateRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V2\Model\UpdateCertificateRequestBody|null $body body
    *
    * @return $this
    */
