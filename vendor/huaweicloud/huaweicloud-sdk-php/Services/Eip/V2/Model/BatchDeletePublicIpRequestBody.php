...
class BatchDeletePublicIpRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeletePublicIpRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * publicipIds  弹性公网ip的id列表。
    *
    * @var string[]
    */
    ...
    * Sets publicipIds
    *
    * @param string[] $publicipIds 弹性公网ip的id列表。
    *
    * @return $this
    */
