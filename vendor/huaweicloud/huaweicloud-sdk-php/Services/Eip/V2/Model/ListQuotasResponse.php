...
class ListQuotasResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'quotas' => '\HuaweiCloud\SDK\Eip\V2\Model\ResourceResp'
    ];
    ...
    *  quotas
    *
    * @return \HuaweiCloud\SDK\Eip\V2\Model\ResourceResp|null
    */
    ...
    * Sets quotas
    *
    * @param \HuaweiCloud\SDK\Eip\V2\Model\ResourceResp|null $quotas quotas
    *
    * @return $this
    */
