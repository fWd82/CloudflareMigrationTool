...
class ResourceResp implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resources' => '\HuaweiCloud\SDK\Eip\V2\Model\QuotaShowResp[]'
    ];
    ...
    *  资源配额对象
    *
    * @return \HuaweiCloud\SDK\Eip\V2\Model\QuotaShowResp[]
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Eip\V2\Model\QuotaShowResp[] $resources 资源配额对象
    *
    * @return $this
    */
