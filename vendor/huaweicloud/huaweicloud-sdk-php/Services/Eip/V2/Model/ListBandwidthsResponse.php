...
class ListBandwidthsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBandwidthsResponse';
    ...
    */
    protected static $openAPITypes = [
            'bandwidths' => '\HuaweiCloud\SDK\Eip\V2\Model\BandwidthResp[]'
    ];
    ...
    * Sets bandwidths
    *
    * @param \HuaweiCloud\SDK\Eip\V2\Model\BandwidthResp[]|null $bandwidths 带宽列表对象
    *
    * @return $this
    */
