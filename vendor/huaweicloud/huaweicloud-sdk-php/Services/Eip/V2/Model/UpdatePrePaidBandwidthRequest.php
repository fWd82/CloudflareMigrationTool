...
class UpdatePrePaidBandwidthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePrePaidBandwidthRequest';
    ...
    */
    protected static $openAPITypes = [
            'bandwidthId' => 'string',
            'body' => '\HuaweiCloud\SDK\Eip\V2\Model\UpdatePrePaidBandwidthRequestBody'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Eip\V2\Model\UpdatePrePaidBandwidthRequestBody|null $body body
    *
    * @return $this
    */
