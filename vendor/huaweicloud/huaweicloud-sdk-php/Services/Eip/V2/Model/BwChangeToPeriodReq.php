...
class BwChangeToPeriodReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BwChangeToPeriodReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * bandwidthIds  待按需转包带宽列表
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['bandwidthIds'] === null) {
            $invalidProperties[] = "'bandwidthIds' can't be null";
        }
    ...
    * Sets bandwidthIds
    *
    * @param string[] $bandwidthIds 待按需转包带宽列表
    *
    * @return $this
    */
