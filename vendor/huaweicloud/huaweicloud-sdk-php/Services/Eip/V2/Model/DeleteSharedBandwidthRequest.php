...
class DeleteSharedBandwidthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteSharedBandwidthRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * bandwidthId  带宽唯一标识  约束： 当前仅支持删除共享带宽
    *
    * @var string[]
    */
