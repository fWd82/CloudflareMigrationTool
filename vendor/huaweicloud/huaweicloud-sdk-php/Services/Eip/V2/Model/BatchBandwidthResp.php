...
class BatchBandwidthResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchBandwidthResp';
    ...
    * Sets billingInfo
    *
    * @param string|null $billingInfo 功能说明：账单信息  如果billing_info不为空，说明是包周期的带宽
    *
    * @return $this
    */
