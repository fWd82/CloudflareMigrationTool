...
class ResourceTagResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResourceTagResp';
    ...
    * Sets key
    *
    * @param string|null $key 键。同一资源的key值不能重复。
    *
    * @return $this
    */
