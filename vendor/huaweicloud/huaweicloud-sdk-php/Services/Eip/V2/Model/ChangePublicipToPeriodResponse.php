...
class ChangePublicipToPeriodResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangePublicipToPeriodResponse';
    ...
    * Sets publicipIds
    *
    * @param string[]|null $publicipIds 转包IP列表
    *
    * @return $this
    */
