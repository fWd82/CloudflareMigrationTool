...
class UpdateBandwidthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateBandwidthRequest';
    ...
    */
    protected static $openAPITypes = [
            'bandwidthId' => 'string',
            'body' => '\HuaweiCloud\SDK\Eip\V2\Model\UpdateBandwidthRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Eip\V2\Model\UpdateBandwidthRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Eip\V2\Model\UpdateBandwidthRequestBody|null $body body
    *
    * @return $this
    */
