...
class TagReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TagReq';
    ...
    * Sets key
    *
    * @param string $key 键。最大长度127个unicode字符。 key不能为空。(搜索时不对此参数做校验)
    *
    * @return $this
    */
    ...
    * Sets values
    *
    * @param string[] $values 值列表。每个值最大长度255个unicode字符，如果values为空列表，则表示any_value。value之间为或的关系。
    *
    * @return $this
    */
