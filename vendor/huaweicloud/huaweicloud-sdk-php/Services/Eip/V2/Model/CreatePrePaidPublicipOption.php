...
class CreatePrePaidPublicipOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePrePaidPublicipOption';
    ...
    * Sets ipVersion
    *
    * @param int|null $ipVersion 功能说明：弹性公网IP的版本  取值范围：4、6，分别表示创建ipv4和ipv6  约束：必须是系统具体支持的类型  不填或空字符串时，默认创建ipv4
    *
    * @return $this
    */
