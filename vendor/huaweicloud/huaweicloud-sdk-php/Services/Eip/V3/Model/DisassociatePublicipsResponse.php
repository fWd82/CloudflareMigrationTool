...
class DisassociatePublicipsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociatePublicipsResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'publicip' => '\HuaweiCloud\SDK\Eip\V3\Model\PublicipInstanceResp'
    ];
    ...
    *  publicip
    *
    * @return \HuaweiCloud\SDK\Eip\V3\Model\PublicipInstanceResp|null
    */
    ...
    * Sets publicip
    *
    * @param \HuaweiCloud\SDK\Eip\V3\Model\PublicipInstanceResp|null $publicip publicip
    *
    * @return $this
    */
