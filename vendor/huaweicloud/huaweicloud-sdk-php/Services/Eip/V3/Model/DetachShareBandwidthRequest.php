...
class DetachShareBandwidthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DetachShareBandwidthRequest';
    ...
    */
    protected static $openAPITypes = [
            'publicipId' => 'string',
            'body' => '\HuaweiCloud\SDK\Eip\V3\Model\DetachSharedbwReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Eip\V3\Model\DetachSharedbwReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Eip\V3\Model\DetachSharedbwReq|null $body body
    *
    * @return $this
    */
