...
class ListTenantVpcIgwsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTenantVpcIgwsResponse';
    ...
    */
    protected static $openAPITypes = [
            'vpcIgws' => '\HuaweiCloud\SDK\Eip\V3\Model\VpcIgwsTenantResp[]',
            'requestId' => 'string'
    ];
    ...
    */
    ...
    {
        $this->container['vpcIgws'] = isset($data['vpcIgws']) ? $data['vpcIgws'] : null;
    ...
    */
    public function getVpcIgws()
    {
        return $this->container['vpcIgws'];
    }

    /**
    * Sets vpcIgws
    *
    * @param \HuaweiCloud\SDK\Eip\V3\Model\VpcIgwsTenantResp[]|null $vpcIgws 虚拟IGW列表对象
    *
    * @return $this
    */
    public function setVpcIgws($vpcIgws)
    {
        $this->container['vpcIgws'] = $vpcIgws;
        return $this;
    }
