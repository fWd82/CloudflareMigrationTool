...
class ListPublicipPoolRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPublicipPoolRequest';
    ...
    * sortKey  排序，形式为\"sort_key=id&sort_dir=asc\"  支持字段：id/name/created_at/updated_at/public_border_group
    ...
    * Sets sortKey
    *
    * @param string|null $sortKey 排序，形式为\"sort_key=id&sort_dir=asc\"  支持字段：id/name/created_at/updated_at/public_border_group
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name 根据name过滤
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status 根据status过滤
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type 根据type过滤
    *
    * @return $this
    */
