...
class AssociatePublicipsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociatePublicipsRequest';
    ...
    */
    protected static $openAPITypes = [
            'publicipId' => 'string',
            'body' => '\HuaweiCloud\SDK\Eip\V3\Model\AssociatePublicipsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Eip\V3\Model\AssociatePublicipsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Eip\V3\Model\AssociatePublicipsRequestBody|null $body body
    *
    * @return $this
    */
