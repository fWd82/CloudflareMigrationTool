...
class BandwidthResponseBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BandwidthResponseBody';
    ...
    * Sets projectId
    *
    * @param string|null $projectId - 功能说明：用户所属项目ID
    *
    * @return $this
    */
