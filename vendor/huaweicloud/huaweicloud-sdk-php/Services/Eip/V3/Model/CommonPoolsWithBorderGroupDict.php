...
class CommonPoolsWithBorderGroupDict implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CommonPoolsWithBorderGroupDict';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * publicipPools  同组的公共池列表
    * publicBorderGroup  分组：中心还是边缘
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'publicipPools' => 'string[]',
    ...
    * Sets publicipPools
    *
    * @param string[]|null $publicipPools 同组的公共池列表
    *
    * @return $this
    */
    ...
    *
    * @param string|null $publicBorderGroup 分组：中心还是边缘
    *
    * @return $this
    */
