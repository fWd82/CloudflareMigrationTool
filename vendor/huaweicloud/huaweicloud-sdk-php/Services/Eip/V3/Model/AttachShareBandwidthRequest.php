...
class AttachShareBandwidthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AttachShareBandwidthRequest';
    ...
    */
    protected static $openAPITypes = [
            'publicipId' => 'string',
            'body' => '\HuaweiCloud\SDK\Eip\V3\Model\AttachSharebwReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Eip\V3\Model\AttachSharebwReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Eip\V3\Model\AttachSharebwReq|null $body body
    *
    * @return $this
    */
