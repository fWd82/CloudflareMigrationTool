...
class UpdatePublicipResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePublicipResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'publicip' => '\HuaweiCloud\SDK\Eip\V3\Model\PublicipUpdateResp'
    ];
    ...
    *  publicip
    *
    * @return \HuaweiCloud\SDK\Eip\V3\Model\PublicipUpdateResp|null
    */
    ...
    * Sets publicip
    *
    * @param \HuaweiCloud\SDK\Eip\V3\Model\PublicipUpdateResp|null $publicip publicip
    *
    * @return $this
    */
