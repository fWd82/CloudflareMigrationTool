...
class BatchAttachSharebwDict implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchAttachSharebwDict';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * bandwidthId  - 共享带宽的id
    * publicipId  - 弹性公网IP ID
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['publicipId']) && (mb_strlen($this->container['publicipId']) < 36)) {
                $invalidProperties[] = "invalid value for 'publicipId', the character length must be bigger than or equal to 36.";
            }
            if (!is_null($this->container['publicipId']) && !preg_match("/[A-Za-z0-9]{8}-[A-Za-z0-9]{4}-[A-Za-z0-9]{4}-[A-Za-z0-9]{4}-[A-Za-z0-9]{12}/", $this->container['publicipId'])) {
                $invalidProperties[] = "invalid value for 'publicipId', must be conform to the pattern /[A-Za-z0-9]{8}-[A-Za-z0-9]{4}-[A-Za-z0-9]{4}-[A-Za-z0-9]{4}-[A-Za-z0-9]{12}/.";
            }
    ...
    * Sets bandwidthId
    *
    * @param string|null $bandwidthId - 共享带宽的id
    *
    * @return $this
    */
    ...
    * Sets publicipId
    *
    * @param string|null $publicipId - 弹性公网IP ID
    *
    * @return $this
    */
