...
class CreateTenantVpcIgwRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTenantVpcIgwRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Eip\V3\Model\CreateTenantVpcIgwRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Eip\V3\Model\CreateTenantVpcIgwRequestBody|null $body body
    *
    * @return $this
    */
