...
class ShowPublicipResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPublicipResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'publicip' => '\HuaweiCloud\SDK\Eip\V3\Model\PublicipSingleShowResp'
    ];
    ...
    * Sets publicip
    *
    * @param \HuaweiCloud\SDK\Eip\V3\Model\PublicipSingleShowResp|null $publicip publicip
    *
    * @return $this
    */
