...
class UpdatePublicipRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'publicipId' => 'string',
            'body' => '\HuaweiCloud\SDK\Eip\V3\Model\UpdatePublicipsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Eip\V3\Model\UpdatePublicipsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Eip\V3\Model\UpdatePublicipsRequestBody|null $body body
    *
    * @return $this
    */
