...
class ListEipBandwidthsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEipBandwidthsResponse';
    ...
    */
    protected static $openAPITypes = [
            'eipBandwidths' => '\HuaweiCloud\SDK\Eip\V3\Model\EipBandwidthResponseBody[]',
    ...
    *  带宽列表对象
    *
    * @return \HuaweiCloud\SDK\Eip\V3\Model\EipBandwidthResponseBody[]|null
    */
    ...
    * Sets eipBandwidths
    *
    * @param \HuaweiCloud\SDK\Eip\V3\Model\EipBandwidthResponseBody[]|null $eipBandwidths 带宽列表对象
    *
    * @return $this
    */
