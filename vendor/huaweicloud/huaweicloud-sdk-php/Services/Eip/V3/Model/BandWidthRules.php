...
class BandWidthRules implements ModelInterface, ArrayAccess
{
    ...
    * id  - 功能说明：带宽规则ID
    * name  - 功能说明：带宽规则名称
    * adminStateUp  - 功能说明：配置状态，为False时配置不生效。
    * egressSize  - 功能说明：出网带宽最大值，单位Mbps - 取值范围[0,n]，其中n为所属带宽的带宽大小（size字段）。0表示设置为最大带宽
    * egressGuarentedSize  - 功能说明：出网保障带宽大小，单位Mbps - 取值范围[0,x]，其中x为所属带宽剩余的保障额
    ...
    * Sets id
    *
    * @param string|null $id - 功能说明：带宽规则ID
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name - 功能说明：带宽规则名称
    *
    * @return $this
    */
    ...
    * Sets adminStateUp
    *
    * @param bool|null $adminStateUp - 功能说明：配置状态，为False时配置不生效。
    *
    * @return $this
    */
    ...
    * Sets egressSize
    *
    * @param int|null $egressSize - 功能说明：出网带宽最大值，单位Mbps - 取值范围[0,n]，其中n为所属带宽的带宽大小（size字段）。0表示设置为最大带宽
    *
    * @return $this
    */
    ...
    *
    * @param int|null $egressGuarentedSize - 功能说明：出网保障带宽大小，单位Mbps - 取值范围[0,x]，其中x为所属带宽剩余的保障额
    *
    * @return $this
    */
