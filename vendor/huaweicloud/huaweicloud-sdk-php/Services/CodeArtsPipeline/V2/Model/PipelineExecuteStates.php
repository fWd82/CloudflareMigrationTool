...
class PipelineExecuteStates implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'result' => 'string',
            'status' => 'string',
            'stages' => '\HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\Stages[]',
            'executor' => 'string',
            'pipelineName' => 'string',
            'pipelineId' => 'string',
            'buildId' => 'string',
    ...
    *  阶段执行情况
    *
    * @return \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\Stages[]
    */
    ...
    * Sets stages
    *
    * @param \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\Stages[] $stages 阶段执行情况
    *
    * @return $this
    */
