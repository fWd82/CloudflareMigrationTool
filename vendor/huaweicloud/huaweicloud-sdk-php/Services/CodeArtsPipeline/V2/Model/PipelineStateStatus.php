...
class PipelineStateStatus implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'errorCode' => 'string',
            'errorMsg' => 'string',
            'children' => '\HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\PipelineStateStatus[]',
            'detailUrl' => 'string'
    ];
    ...
    *  子任务运行信息(对任务来说是空的)
    *
    * @return \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\PipelineStateStatus[]
    */
    ...
    * Sets children
    *
    * @param \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\PipelineStateStatus[] $children 子任务运行信息(对任务来说是空的)
    *
    * @return $this
    */
