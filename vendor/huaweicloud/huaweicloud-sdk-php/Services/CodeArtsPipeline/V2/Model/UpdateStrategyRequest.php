...
class UpdateStrategyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateStrategyRequest';
    ...
    */
    protected static $openAPITypes = [
            'ruleSetId' => 'string',
            'domainId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\UpdateRuleSetReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\UpdateRuleSetReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\UpdateRuleSetReq|null $body body
    *
    * @return $this
    */
