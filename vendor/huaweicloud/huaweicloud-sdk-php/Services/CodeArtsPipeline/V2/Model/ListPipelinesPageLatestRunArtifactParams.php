...
class ListPipelinesPageLatestRunArtifactParams implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPipelinesPage_latest_run_artifact_params';
    ...
    * Sets branchFilter
    *
    * @param string|null $branchFilter 过滤分支
    *
    * @return $this
    */
    ...
    * Sets organization
    *
    * @param string|null $organization docker组织
    *
    * @return $this
    */
