...
class UpdateRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'domainId' => 'string',
            'ruleId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\UpdateRuleReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\UpdateRuleReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\UpdateRuleReq|null $body body
    *
    * @return $this
    */
