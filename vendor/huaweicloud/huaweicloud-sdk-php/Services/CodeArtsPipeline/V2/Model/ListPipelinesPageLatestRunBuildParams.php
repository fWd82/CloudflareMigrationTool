...
class ListPipelinesPageLatestRunBuildParams implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPipelinesPage_latest_run_build_params';
    ...
    * Sets codehubId
    *
    * @param string|null $codehubId codehub仓库ID
    *
    * @return $this
    */
