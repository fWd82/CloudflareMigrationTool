...
class ShowPipelineLogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPipelineLogRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'jobRunId' => 'string',
            'stepRunId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\LogQuery'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\LogQuery|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\LogQuery|null $body body
    *
    * @return $this
    */
