...
class UploadBasicPluginRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UploadBasicPluginRequestBody';
    ...
    * Sets uploadFile
    *
    * @param \SplFileObject $uploadFile uploadFile
    *
    * @return $this
    */
