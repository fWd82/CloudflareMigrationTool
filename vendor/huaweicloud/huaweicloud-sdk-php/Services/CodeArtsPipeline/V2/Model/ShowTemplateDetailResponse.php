...
class ShowTemplateDetailResponse implements ModelInterface, ArrayAccess
{
    ...
    *  模板参数
    *
    * @return \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\TemplateParam[]|null
    */
    ...
    * Sets parameter
    *
    * @param \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\TemplateParam[]|null $parameter 模板参数
    *
    * @return $this
    */
    ...
    *
    * @return map[string,\HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\TemplateState]|null
    */
    ...
    * Sets states
    *
    * @param map[string,\HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\TemplateState]|null $states 编排State详情，map类型数据。本字段为描述流水线基础编排数据之一，建议可通过流水线真实界面基于模板创建接口中获取
    *
    * @return $this
    */
