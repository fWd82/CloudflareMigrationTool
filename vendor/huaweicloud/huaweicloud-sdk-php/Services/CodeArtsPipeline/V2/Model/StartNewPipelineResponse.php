...
class StartNewPipelineResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StartNewPipelineResponse';
    ...
    * Sets buildId
    *
    * @param string|null $buildId 流水线构建ID
    *
    * @return $this
    */
