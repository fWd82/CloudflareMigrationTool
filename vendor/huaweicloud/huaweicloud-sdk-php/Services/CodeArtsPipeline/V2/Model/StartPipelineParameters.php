...
class StartPipelineParameters implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'buildParams' => '\HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\StartPipelineBuildParams[]'
    ];
    ...
    *  启动流水线时的构建参数
    *
    * @return \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\StartPipelineBuildParams[]|null
    */
    ...
    * Sets buildParams
    *
    * @param \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\StartPipelineBuildParams[]|null $buildParams 启动流水线时的构建参数
    *
    * @return $this
    */
