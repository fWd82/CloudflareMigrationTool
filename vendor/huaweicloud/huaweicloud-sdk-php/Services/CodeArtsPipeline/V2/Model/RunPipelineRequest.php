...
class RunPipelineRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RunPipelineRequest';
    ...
    */
    protected static $openAPITypes = [
            'pipelineId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\RunPipelineDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\RunPipelineDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\RunPipelineDTO|null $body body
    *
    * @return $this
    */
