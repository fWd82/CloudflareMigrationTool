...
class TemplateParam implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'isStatic' => 'bool',
            'isDefault' => 'bool',
            'limits' => '\HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\ParamTypeLimits[]',
            'constraints' => '\HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\Constraint[]'
    ];
    ...
    *  array类型数据
    *
    * @return \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\ParamTypeLimits[]
    */
    ...
    * Sets limits
    *
    * @param \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\ParamTypeLimits[] $limits array类型数据
    *
    * @return $this
    */
    ...
    *  array类型数据
    *
    * @return \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\Constraint[]
    */
    ...
    * Sets constraints
    *
    * @param \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\Constraint[] $constraints array类型数据
    *
    * @return $this
    */
