...
class PipelineLatestRun implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'executorId' => 'string',
            'executorName' => 'string',
            'stageStatusList' => '\HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\PipelineLatestRunStageStatusList[]',
            'status' => 'string',
            'runNumber' => 'int',
            'triggerType' => 'string',
            'buildParams' => '\HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\PipelineLatestRunBuildParams',
    ...
    *  阶段状态信息
    *
    * @return \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\PipelineLatestRunStageStatusList[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\PipelineLatestRunStageStatusList[]|null $stageStatusList 阶段状态信息
    *
    * @return $this
    */
    ...
    *  buildParams
    *
    * @return \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\PipelineLatestRunBuildParams|null
    */
    ...
    * Sets buildParams
    *
    * @param \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\PipelineLatestRunBuildParams|null $buildParams buildParams
    *
    * @return $this
    */
