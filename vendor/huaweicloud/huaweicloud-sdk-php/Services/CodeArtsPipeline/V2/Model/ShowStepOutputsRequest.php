...
class ShowStepOutputsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowStepOutputsRequest';
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['stepRunIds'] = isset($data['stepRunIds']) ? $data['stepRunIds'] : null;
    }
    ...
    * @return string|null
    */
    public function getStepRunIds()
    {
        return $this->container['stepRunIds'];
    }

    /**
    * Sets stepRunIds
    *
    * @param string|null $stepRunIds stepRunIds
    *
    * @return $this
    */
    public function setStepRunIds($stepRunIds)
    {
        $this->container['stepRunIds'] = $stepRunIds;
        return $this;
    }
