...
class ListPipelineRunsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPipelineRunsRequest';
    ...
    */
    protected static $openAPITypes = [
            'pipelineId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\ListPipelineRunsQuery'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\ListPipelineRunsQuery|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\ListPipelineRunsQuery|null $body body
    *
    * @return $this
    */
