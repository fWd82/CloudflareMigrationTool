...
class ShowPipleineStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPipleineStatusRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * pipelineId  要获取状态的流水线ID
    * buildId  要获取状态的执行ID
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pipelineId'] === null) {
            ...
            if (!is_null($this->container['buildId']) && (mb_strlen($this->container['buildId']) > 10)) {
                $invalidProperties[] = "invalid value for 'buildId', the character length must be smaller than or equal to 10.";
            }
            if (!is_null($this->container['buildId']) && (mb_strlen($this->container['buildId']) < 1)) {
    ...
    * Sets buildId
    *
    * @param string|null $buildId 要获取状态的执行ID
    *
    * @return $this
    */
