...
class CreateEndpointRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'endpoint' => '\HuaweiCloud\SDK\Ga\V1\Model\CreateEndpointOption'
    ];
    ...
    *  endpoint
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\CreateEndpointOption
    */
    ...
    * Sets endpoint
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\CreateEndpointOption $endpoint endpoint
    *
    * @return $this
    */
