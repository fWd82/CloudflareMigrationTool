...
class CreateTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ga\V1\Model\CreateTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\CreateTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\CreateTagsRequestBody|null $body body
    *
    * @return $this
    */
