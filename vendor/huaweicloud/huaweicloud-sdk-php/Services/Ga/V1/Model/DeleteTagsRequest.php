...
class DeleteTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ga\V1\Model\DeleteTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\DeleteTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\DeleteTagsRequestBody|null $body body
    *
    * @return $this
    */
