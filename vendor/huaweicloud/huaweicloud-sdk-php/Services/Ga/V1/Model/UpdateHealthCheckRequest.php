...
class UpdateHealthCheckRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateHealthCheckRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Ga\V1\Model\UpdateHealthCheckRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\UpdateHealthCheckRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\UpdateHealthCheckRequestBody|null $body body
    *
    * @return $this
    */
