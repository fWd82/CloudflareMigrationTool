...
class CreateEndpointRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Ga\V1\Model\CreateEndpointRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\CreateEndpointRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\CreateEndpointRequestBody|null $body body
    *
    * @return $this
    */
