...
class AddIpGroupIpRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddIpGroupIpRequest';
    ...
    */
    protected static $openAPITypes = [
            'ipGroupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ga\V1\Model\AddIpGroupIpRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\AddIpGroupIpRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\AddIpGroupIpRequestBody|null $body body
    *
    * @return $this
    */
