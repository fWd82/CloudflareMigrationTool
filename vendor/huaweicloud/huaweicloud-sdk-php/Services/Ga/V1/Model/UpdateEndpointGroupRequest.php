...
class UpdateEndpointGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateEndpointGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Ga\V1\Model\UpdateEndpointGroupRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\UpdateEndpointGroupRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\UpdateEndpointGroupRequestBody|null $body body
    *
    * @return $this
    */
