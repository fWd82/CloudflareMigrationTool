...
class CreateIpGroupIpOption implements ModelInterface, ArrayAccess
{
    ...
    * description  IP地址组中的IP网段描述，取值范围：0~255个字符之间，禁止输入字符：<>。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cidr'] === null) {
            ...
            if ((mb_strlen($this->container['cidr']) > 50)) {
            ...
            if (!preg_match("/[a-fA-F0-9:.\/]*$/", $this->container['cidr'])) {
    ...
    * Sets cidr
    *
    * @param string $cidr IP地址组中的IP网段，cidr格式。
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string|null $description IP地址组中的IP网段描述，取值范围：0~255个字符之间，禁止输入字符：<>。
    *
    * @return $this
    */
