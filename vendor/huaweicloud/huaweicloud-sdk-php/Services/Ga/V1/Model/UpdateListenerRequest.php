...
class UpdateListenerRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateListenerRequest';
    ...
    */
    protected static $openAPITypes = [
            'listenerId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ga\V1\Model\UpdateListenerRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['listenerId'] === null) {
            ...
            if ((mb_strlen($this->container['listenerId']) < 1)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\UpdateListenerRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\UpdateListenerRequestBody|null $body body
    *
    * @return $this
    */
