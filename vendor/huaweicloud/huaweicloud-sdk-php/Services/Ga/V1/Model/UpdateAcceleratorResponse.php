...
class UpdateAcceleratorResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAcceleratorResponse';
    ...
    */
    protected static $openAPITypes = [
            'accelerator' => '\HuaweiCloud\SDK\Ga\V1\Model\AcceleratorDetail',
            'requestId' => 'string'
    ];
    ...
    * Sets accelerator
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\AcceleratorDetail|null $accelerator accelerator
    *
    * @return $this
    */
