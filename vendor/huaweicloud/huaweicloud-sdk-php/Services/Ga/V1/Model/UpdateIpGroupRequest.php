...
class UpdateIpGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'ipGroupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ga\V1\Model\UpdateIpGroupRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\UpdateIpGroupRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\UpdateIpGroupRequestBody|null $body body
    *
    * @return $this
    */
