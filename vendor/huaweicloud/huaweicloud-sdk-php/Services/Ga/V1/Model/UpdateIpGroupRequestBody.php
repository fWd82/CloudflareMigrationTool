...
class UpdateIpGroupRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'ipGroup' => '\HuaweiCloud\SDK\Ga\V1\Model\UpdateIpGroupOption'
    ];
    ...
    *  ipGroup
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\UpdateIpGroupOption
    */
    ...
    * Sets ipGroup
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\UpdateIpGroupOption $ipGroup ipGroup
    *
    * @return $this
    */
