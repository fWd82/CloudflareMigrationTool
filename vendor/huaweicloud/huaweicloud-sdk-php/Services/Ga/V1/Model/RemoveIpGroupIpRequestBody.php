...
class RemoveIpGroupIpRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemoveIpGroupIpRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * ipList  IP地址组中的IP网段列表，一次最多支持删除20个条目。
    *
    * @var string[]
    */
    ...
    * Sets ipList
    *
    * @param string[] $ipList IP地址组中的IP网段列表，一次最多支持删除20个条目。
    *
    * @return $this
    */
