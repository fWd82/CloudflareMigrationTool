...
class CreateAcceleratorOptionIpSets implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAcceleratorOption_ip_sets';
    ...
    *  area
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\Area
    */
    ...
    * Sets area
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\Area $area area
    *
    * @return $this
    */
