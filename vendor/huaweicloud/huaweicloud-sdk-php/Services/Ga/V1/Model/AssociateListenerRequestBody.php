...
class AssociateListenerRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateListenerRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'listenerId' => 'string',
            'type' => '\HuaweiCloud\SDK\Ga\V1\Model\ListenerAccessControlType'
    ];
    ...
    *  type
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\ListenerAccessControlType
    */
    ...
    * Sets type
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\ListenerAccessControlType $type type
    *
    * @return $this
    */
