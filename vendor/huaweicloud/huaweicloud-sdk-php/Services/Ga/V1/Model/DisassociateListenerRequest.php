...
class DisassociateListenerRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateListenerRequest';
    ...
    */
    protected static $openAPITypes = [
            'ipGroupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ga\V1\Model\DisassociateListenerRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\DisassociateListenerRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\DisassociateListenerRequestBody|null $body body
    *
    * @return $this
    */
