...
class AssociateListenerRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateListenerRequest';
    ...
    */
    protected static $openAPITypes = [
            'ipGroupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ga\V1\Model\AssociateListenerRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\AssociateListenerRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\AssociateListenerRequestBody|null $body body
    *
    * @return $this
    */
