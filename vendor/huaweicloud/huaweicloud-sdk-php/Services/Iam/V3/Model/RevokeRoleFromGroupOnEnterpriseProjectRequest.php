...
class RevokeRoleFromGroupOnEnterpriseProjectRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RevokeRoleFromGroupOnEnterpriseProjectRequest';
