...
class OpenIdConnectConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OpenIdConnectConfig';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['scope'] === null) {
            ...
            if ((mb_strlen($this->container['scope']) < 6)) {
                $invalidProperties[] = "invalid value for 'scope', the character length must be bigger than or equal to 6.";
            }
        ...
        if ($this->container['responseMode'] === null) {
            $invalidProperties[] = "'responseMode' can't be null";
        }
    ...
    *
    * @param string $authorizationEndpoint OpenID Connect身份提供商授权地址; 编程访问和管理控制台访问方式值不为空，编程访问方式值可为空
    *
    * @return $this
    */
    ...
    * Sets scope
    *
    * @param string $scope 授权请求信息范围，编程访问和管理控制台访问方式必选，编程访问方式不可选，可选值：openid 、email、profile，IDP自定义scope，字符集a-zA-Z_0-9 ，1-10个可选值组合空格分割，至少包括openid，顺序无关，总长度最长255字符，例如：\"openid\"、\"openid email\"、\"openid profile\" 、\"openid email profile\"
    *
    * @return $this
    */
    ...
    * Sets responseType
    *
    * @param string $responseType 授权请求返回的类型；id_token ；编程访问和管理控制台访问方式值不为空，编程访问方式值可为空
    *
    * @return $this
    */
    ...
    * Sets responseMode
    *
    * @param string $responseMode 授权请求返回方式， form_post 或 fragment ；编程访问和管理控制台访问方式值不为空，编程访问方式值可为空
    *
    * @return $this
    */
