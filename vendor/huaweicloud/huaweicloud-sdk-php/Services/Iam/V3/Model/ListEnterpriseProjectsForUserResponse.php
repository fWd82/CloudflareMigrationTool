...
class ListEnterpriseProjectsForUserResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEnterpriseProjectsForUserResponse';
