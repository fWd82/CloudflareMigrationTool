...
class UpdateOpenIdConnectConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateOpenIdConnectConfig';
    ...
    * authorizationEndpoint  OpenID Connect身份提供商授权地址；编程访问和管理控制台访问方式值不可为空，编程访问方式值可为空
    ...
    * responseType  授权请求返回的类型；值为id_token ；编程访问和管理控制台访问方式值不可为空，编程访问方式值可为空
    * responseMode  授权请求返回方式，可选值 form_post 或 fragment ；编程访问和管理控制台访问方式值为可选值，编程访问方式值可为空
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['idpUrl']) && (mb_strlen($this->container['idpUrl']) > 255)) {
                $invalidProperties[] = "invalid value for 'idpUrl', the character length must be smaller than or equal to 255.";
            }
            if (!is_null($this->container['idpUrl']) && (mb_strlen($this->container['idpUrl']) < 10)) {
            ...
            if (!is_null($this->container['clientId']) && (mb_strlen($this->container['clientId']) < 5)) {
            ...
            if (!is_null($this->container['signingKey']) && (mb_strlen($this->container['signingKey']) > 30000)) {
                $invalidProperties[] = "invalid value for 'signingKey', the character length must be smaller than or equal to 30000.";
            }
            if (!is_null($this->container['signingKey']) && (mb_strlen($this->container['signingKey']) < 10)) {
    ...
    * Sets accessMode
    *
    * @param string|null $accessMode 访问方式: program_console: 支持编程访问和管理控制台访问方式; program: 支持编程访问方式
    *
    * @return $this
    */
    ...
    * Sets idpUrl
    *
    * @param string|null $idpUrl OpenID Connect身份提供商标识，对应ID token 中 iss
    *
    * @return $this
    */
    ...
    * Sets clientId
    *
    * @param string|null $clientId 在OpenID Connect身份提供商注册的客户端ID
    *
    * @return $this
    */
    ...
    *
    * @param string|null $authorizationEndpoint OpenID Connect身份提供商授权地址；编程访问和管理控制台访问方式值不可为空，编程访问方式值可为空
    *
    * @return $this
    */
    ...
    * Sets responseType
    *
    * @param string|null $responseType 授权请求返回的类型；值为id_token ；编程访问和管理控制台访问方式值不可为空，编程访问方式值可为空
    *
    * @return $this
    */
    ...
    * Sets responseMode
    *
    * @param string|null $responseMode 授权请求返回方式，可选值 form_post 或 fragment ；编程访问和管理控制台访问方式值为可选值，编程访问方式值可为空
    *
    * @return $this
    */
    ...
    * Sets signingKey
    *
    * @param string|null $signingKey OpenID Connect身份提供商ID Token签名的公钥
    *
    * @return $this
    */
