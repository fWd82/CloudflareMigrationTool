...
class ListEnterpriseProjectsForGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEnterpriseProjectsForGroupResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * enterpriseProjects  企业项目信息。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'enterpriseProjects' => '\HuaweiCloud\SDK\Iam\V3\Model\ListEnterpriseProjectsResDetail[]'
    ];
    ...
    *  企业项目信息。
    *
    * @return \HuaweiCloud\SDK\Iam\V3\Model\ListEnterpriseProjectsResDetail[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\ListEnterpriseProjectsResDetail[]|null $enterpriseProjects 企业项目信息。
    *
    * @return $this
    */
