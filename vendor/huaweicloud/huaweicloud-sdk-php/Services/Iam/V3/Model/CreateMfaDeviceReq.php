...
class CreateMfaDeviceReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMfaDeviceReq';
    ...
    */
    protected static $openAPITypes = [
            'virtualMfaDevice' => '\HuaweiCloud\SDK\Iam\V3\Model\CreateMfaDevice'
    ];
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['virtualMfaDevice'] === null) {
            $invalidProperties[] = "'virtualMfaDevice' can't be null";
        }
    ...
    *  virtualMfaDevice
    *
    * @return \HuaweiCloud\SDK\Iam\V3\Model\CreateMfaDevice
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\CreateMfaDevice $virtualMfaDevice virtualMfaDevice
    *
    * @return $this
    */
