...
class AssociateRoleToUserOnEnterpriseProjectRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateRoleToUserOnEnterpriseProjectRequest';
