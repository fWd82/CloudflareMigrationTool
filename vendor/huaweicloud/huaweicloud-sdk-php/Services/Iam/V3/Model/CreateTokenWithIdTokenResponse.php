...
class CreateTokenWithIdTokenResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTokenWithIdTokenResponse';
    ...
    */
    protected static $openAPITypes = [
            'token' => '\HuaweiCloud\SDK\Iam\V3\Model\ScopedTokenInfo',
    ...
    *  token
    *
    * @return \HuaweiCloud\SDK\Iam\V3\Model\ScopedTokenInfo|null
    */
    ...
    * Sets token
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\ScopedTokenInfo|null $token token
    *
    * @return $this
    */
