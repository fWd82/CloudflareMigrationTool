...
class UpdateLoginProtectRespon implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateLoginProtectRespon';
    ...
    * Sets userId
    *
    * @param string $userId 待修改信息的IAM用户ID。
    *
    * @return $this
    */
    ...
    * Sets enabled
    *
    * @param bool $enabled IAM用户是否开启登录保护，开启为\"true\"，不开启为\"false\"。
    *
    * @return $this
    */
    ...
    *
    * @param string $verificationMethod IAM用户登录验证方式。手机验证为“sms”,邮箱验证为“email”,MFA验证为“vmfa”。
    *
    * @return $this
    */
