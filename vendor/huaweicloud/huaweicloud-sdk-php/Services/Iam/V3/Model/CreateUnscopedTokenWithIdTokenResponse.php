...
class CreateUnscopedTokenWithIdTokenResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateUnscopedTokenWithIdTokenResponse';
    ...
    */
    protected static $openAPITypes = [
            'token' => '\HuaweiCloud\SDK\Iam\V3\Model\UnscopedTokenInfo',
    ...
    *  token
    *
    * @return \HuaweiCloud\SDK\Iam\V3\Model\UnscopedTokenInfo|null
    */
    ...
    * Sets token
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\UnscopedTokenInfo|null $token token
    *
    * @return $this
    */
