...
class RevokeRoleFromUserOnEnterpriseProjectRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RevokeRoleFromUserOnEnterpriseProjectRequest';
