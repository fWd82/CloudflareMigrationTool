...
class SearchPublicationsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchPublicationsRequest';
    ...
    * Sets searchKey
    *
    * @param string|null $searchKey 搜索条件，支持名称模糊搜索。
    *
    * @return $this
    */
