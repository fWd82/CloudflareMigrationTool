...
class ShowDepartmentResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDepartmentResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'deptName' => 'string',
            'isLeafNodes' => 'bool',
            'childDepts' => '\HuaweiCloud\SDK\Meeting\V1\Model\ChildDeptDTO[]'
    ];
    ...
    *  子部门详情。
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\ChildDeptDTO[]|null
    */
    ...
    * Sets childDepts
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\ChildDeptDTO[]|null $childDepts 子部门详情。
    *
    * @return $this
    */
