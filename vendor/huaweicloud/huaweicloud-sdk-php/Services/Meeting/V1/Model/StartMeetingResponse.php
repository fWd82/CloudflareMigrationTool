...
class StartMeetingResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StartMeetingResponse';
    ...
    * Sets uuid
    *
    * @param string|null $uuid uuid。 > 废弃参数，请勿使用。
    *
    * @return $this
    */
