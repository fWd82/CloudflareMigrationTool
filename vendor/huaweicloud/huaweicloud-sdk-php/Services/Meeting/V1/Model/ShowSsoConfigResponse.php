...
class ShowSsoConfigResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSsoConfigResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * enableSso  是否开启SSO登录。
    * domain  企业域名。
    * authorizeUrl  鉴权中心URL。
    * getTokenUrl  获取Token URL。
    * clientId  APP ID。
    * clientSecret  APP秘钥。
    * scope  授权范围。 * openid：OAuth2.0的OIDC
    * accFieldName  第三方帐号的字段名称。
    * getUserInfoUrl  用户信息查询URL。
    * oauth2ServerType  鉴权类型。OAuth2.0鉴权时取0。 * 0：OAuth2.0鉴权
    ...
    * thirdAccessToken  第三方accessToken的字段名称。
    ...
    * Sets enableSso
    *
    * @param bool|null $enableSso 是否开启SSO登录。
    *
    * @return $this
    */
    ...
    * Sets authorizeUrl
    *
    * @param string|null $authorizeUrl 鉴权中心URL。
    *
    * @return $this
    */
    ...
    * Sets getTokenUrl
    *
    * @param string|null $getTokenUrl 获取Token URL。
    *
    * @return $this
    */
    ...
    * Sets clientId
    *
    * @param string|null $clientId APP ID。
    *
    * @return $this
    */
    ...
    * Sets clientSecret
    *
    * @param string|null $clientSecret APP秘钥。
    *
    * @return $this
    */
    ...
    * Sets accFieldName
    *
    * @param string|null $accFieldName 第三方帐号的字段名称。
    *
    * @return $this
    */
    ...
    *
    * @param int|null $oauth2ServerType 鉴权类型。OAuth2.0鉴权时取0。 * 0：OAuth2.0鉴权
    *
    * @return $this
    */
    ...
    *
    * @param string|null $thirdAccessToken 第三方accessToken的字段名称。
    *
    * @return $this
    */
