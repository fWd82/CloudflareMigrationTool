...
class CreateRecurringMeetingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateRecurringMeetingRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'userUuid' => 'string',
            'xSiteId' => 'string',
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\RestScheduleConfDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\RestScheduleConfDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\RestScheduleConfDTO|null $body body
    *
    * @return $this
    */
