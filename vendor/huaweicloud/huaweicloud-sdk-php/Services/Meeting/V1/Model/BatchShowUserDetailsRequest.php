...
class BatchShowUserDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchShowUserDetailsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xRequestId  请求requestId，用来标识一路请求，用于问题跟踪定位，建议使用UUID，若不携带，则后台自动生成。
    * acceptLanguage  语言参数，默认为中文zh-CN，英文为en-US。
    * idType  查询类型。默认是USER_ID。 * USER_ID：表示根据华为云会议用户ID查询用户详情 * THIRD_ACCOUNT：表示根据第三方账号查询用户详情
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'idType' => 'string',
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\ShowUserRequestDTO[]'
    ];
    ...
    * Sets idType
    *
    * @param string|null $idType 查询类型。默认是USER_ID。 * USER_ID：表示根据华为云会议用户ID查询用户详情 * THIRD_ACCOUNT：表示根据第三方账号查询用户详情
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\ShowUserRequestDTO[]|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\ShowUserRequestDTO[]|null $body body
    *
    * @return $this
    */
