...
class SearchStatisticConferenceParticipantRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchStatisticConferenceParticipantRequest';
    ...
    * category  查询分类，取值： * user_participate_info: 用户与会统计数据 * hard_terminal_participate_info: 硬件终端与会统计数据 * participant_type_info: 与会设备统计数据
    *
    * @var string[]
    */
    ...
    */
    ...
    const TIME_UNIT_D = 'D';
    const TIME_UNIT_M = 'M';
    const CATEGORY_USER_PARTICIPATE_INFO = 'user_participate_info';
    const CATEGORY_HARD_TERMINAL_PARTICIPATE_INFO = 'hard_terminal_participate_info';
    const CATEGORY_PARTICIPANT_TYPE_INFO = 'participant_type_info';
    ...
    */
    ...
    {
        return [
            self::CATEGORY_USER_PARTICIPATE_INFO,
            self::CATEGORY_HARD_TERMINAL_PARTICIPATE_INFO,
            self::CATEGORY_PARTICIPANT_TYPE_INFO,
        ];
    }
    ...
    * Sets category
    *
    * @param string $category 查询分类，取值： * user_participate_info: 用户与会统计数据 * hard_terminal_participate_info: 硬件终端与会统计数据 * participant_type_info: 与会设备统计数据
    *
    * @return $this
    */
