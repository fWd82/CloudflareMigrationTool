...
class MuteParticipantRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MuteParticipantRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\RestMuteParticipantReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\RestMuteParticipantReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\RestMuteParticipantReqBody|null $body body
    *
    * @return $this
    */
