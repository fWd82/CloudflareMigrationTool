...
class SearchMemberVmrRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchMemberVmrRequest';
    ...
    * limit  查询数量。 默认值：10。
    * searchKey  搜索条件。支持云会议室名称、ID模糊搜索。
    * specialVmr  查询VMR的类型。不填则查询所有类型。 * false:个人会议ID * true:云会议室
    *
    * @var string[]
    */
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['specialVmr'] = isset($data['specialVmr']) ? $data['specialVmr'] : null;
    }
    ...
    * Sets searchKey
    *
    * @param string|null $searchKey 搜索条件。支持云会议室名称、ID模糊搜索。
    *
    * @return $this
    */
    ...
    * @return bool|null
    */
    public function getSpecialVmr()
    {
        return $this->container['specialVmr'];
    }

    /**
    * Sets specialVmr
    *
    * @param bool|null $specialVmr 查询VMR的类型。不填则查询所有类型。 * false:个人会议ID * true:云会议室
    *
    * @return $this
    */
    public function setSpecialVmr($specialVmr)
    {
        $this->container['specialVmr'] = $specialVmr;
        return $this;
    }
