...
class SearchStatisticResourceInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchStatisticResourceInfoRequest';
    ...
    * category  查询分类，取值： * used_vmr_info: 已购VMR资源使用统计数据 * used_live_info: 已购直播端口资源使用统计数据 * used_record_info: 已购录播资源使用统计数据 * used_pstn_info: 已购电话外呼资源使用统计数据
    *
    * @var string[]
    */
    ...
    */
    ...
    const TIME_UNIT_D = 'D';
    const TIME_UNIT_M = 'M';
    const CATEGORY_USED_VMR_INFO = 'used_vmr_info';
    const CATEGORY_USED_LIVE_INFO = 'used_live_info';
    const CATEGORY_USED_RECORD_INFO = 'used_record_info';
    const CATEGORY_USED_PSTN_INFO = 'used_pstn_info';
    ...
    */
    ...
    {
        return [
            self::CATEGORY_USED_VMR_INFO,
            self::CATEGORY_USED_LIVE_INFO,
            self::CATEGORY_USED_RECORD_INFO,
            self::CATEGORY_USED_PSTN_INFO,
        ];
    }
    ...
    * Sets category
    *
    * @param string $category 查询分类，取值： * used_vmr_info: 已购VMR资源使用统计数据 * used_live_info: 已购直播端口资源使用统计数据 * used_record_info: 已购录播资源使用统计数据 * used_pstn_info: 已购电话外呼资源使用统计数据
    *
    * @return $this
    */
