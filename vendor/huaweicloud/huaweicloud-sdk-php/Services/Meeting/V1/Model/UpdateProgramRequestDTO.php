...
class UpdateProgramRequestDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProgramRequestDTO';
    ...
    */
    protected static $openAPITypes = [
            'programName' => 'string',
            'programItemList' => '\HuaweiCloud\SDK\Meeting\V1\Model\ProgramItemRequestBase[]'
    ];
    ...
    *  节目素材列表。
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\ProgramItemRequestBase[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\ProgramItemRequestBase[]|null $programItemList 节目素材列表。
    *
    * @return $this
    */
