...
class SearchMaterialsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchMaterialsRequest';
    ...
    * Sets searchKey
    *
    * @param string|null $searchKey 搜索条件。支持素材名称、更新人模糊搜索。
    *
    * @return $this
    */
