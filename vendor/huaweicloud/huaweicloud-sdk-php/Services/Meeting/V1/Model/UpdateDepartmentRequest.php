...
class UpdateDepartmentRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'deptCode' => 'string',
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\ModDeptDTO'
    ];
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['deptCode'] === null) {
            $invalidProperties[] = "'deptCode' can't be null";
        }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\ModDeptDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\ModDeptDTO|null $body body
    *
    * @return $this
    */
