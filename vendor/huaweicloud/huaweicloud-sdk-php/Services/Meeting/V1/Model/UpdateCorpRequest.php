...
class UpdateCorpRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCorpRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\ModCorpDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\ModCorpDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\ModCorpDTO|null $body body
    *
    * @return $this
    */
