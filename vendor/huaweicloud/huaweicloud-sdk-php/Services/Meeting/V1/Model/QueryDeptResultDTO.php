...
class QueryDeptResultDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'QueryDeptResultDTO';
    ...
    * Sets deptCode
    *
    * @param string|null $deptCode 部门编码，企业内唯一。
    *
    * @return $this
    */
