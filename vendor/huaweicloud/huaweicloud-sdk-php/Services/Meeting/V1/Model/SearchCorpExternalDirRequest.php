...
class SearchCorpExternalDirRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchCorpExternalDirRequest';
    ...
    * limit  查询数量。 默认值：10。
    * searchKey  搜索条件。支持名称、手机、邮箱模糊搜索。
    * searchScope  搜索范围。默认值为ALL。 * PERSONAL - 查询个人外部联系人 * CORP - 查询企业外部联系人 * ALL - 查询所有外部联系人
    *
    * @var string[]
    */
    ...
    * Sets searchKey
    *
    * @param string|null $searchKey 搜索条件。支持名称、手机、邮箱模糊搜索。
    *
    * @return $this
    */
    ...
    * Sets searchScope
    *
    * @param string|null $searchScope 搜索范围。默认值为ALL。 * PERSONAL - 查询个人外部联系人 * CORP - 查询企业外部联系人 * ALL - 查询所有外部联系人
    *
    * @return $this
    */
