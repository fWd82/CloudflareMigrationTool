...
class ShowOnlineMeetingDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowOnlineMeetingDetailRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * conferenceId  会议ID。 > 会议ID。创建会议时返回的conferenceID。不是vmrConferenceID。
    * offset  查询偏移量。默认为0。针对PageParticipant中的与会者分页。
    * limit  查询数量。默认值20。
    ...
    * Sets offset
    *
    * @param int|null $offset 查询偏移量。默认为0。针对PageParticipant中的与会者分页。
    *
    * @return $this
    */
    ...
    * Sets xQueryType
    *
    * @param string|null $xQueryType 当X-Type为2时，该字段有效。默认值为0。 - 0: 查询与会人 - 1: 查询终端
    *
    * @return $this
    */
