...
class InviteOperateVideoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InviteOperateVideoRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * conferenceId  会议ID。
    * participantId  被邀请的与会者标识。
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\RestVideoBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\RestVideoBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\RestVideoBody|null $body body
    *
    * @return $this
    */
