...
class ShowMeetingFileListRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowMeetingFileListRequest';
    ...
    * Sets body
    *
    * @param map[string,string]|null $body body
    *
    * @return $this
    */
