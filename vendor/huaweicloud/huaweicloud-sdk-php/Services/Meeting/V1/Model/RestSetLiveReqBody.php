...
class RestSetLiveReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RestSetLiveReqBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * isLive  会议直播开关。默认值为0。 - 0: 停止会议直播 - 1: 启动会议直播
    *
    * @var string[]
    */
    ...
    * Sets isLive
    *
    * @param int $isLive 会议直播开关。默认值为0。 - 0: 停止会议直播 - 1: 启动会议直播
    *
    * @return $this
    */
