...
class SearchStatisticConferenceInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchStatisticConferenceInfoRequest';
    ...
    * category  查询分类，取值： * conference_info: 会议总体数据 * conference_hourly_info: 单日内会议总体数据 * category = conference_hourly_info的情况，timeUnit只能取值'D'，且startTime与endTime必须为同一天
    *
    * @var string[]
    */
    ...
    */
    ...
    const TIME_UNIT_D = 'D';
    const TIME_UNIT_M = 'M';
    const CATEGORY_CONFERENCE_INFO = 'conference_info';
    const CATEGORY_CONFERENCE_HOURLY_INFO = 'conference_hourly_info';
    ...
    */
    ...
    {
        return [
            self::CATEGORY_CONFERENCE_INFO,
            self::CATEGORY_CONFERENCE_HOURLY_INFO,
        ];
    }
    ...
    * Sets category
    *
    * @param string $category 查询分类，取值： * conference_info: 会议总体数据 * conference_hourly_info: 单日内会议总体数据 * category = conference_hourly_info的情况，timeUnit只能取值'D'，且startTime与endTime必须为同一天
    *
    * @return $this
    */
