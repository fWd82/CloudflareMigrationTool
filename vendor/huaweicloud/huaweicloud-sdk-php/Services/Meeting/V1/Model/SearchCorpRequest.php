...
class SearchCorpRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchCorpRequest';
    ...
    * limit  查询数量。 默认值：10。
    * searchKey  搜索条件，支持名称、手机、邮箱、帐号模糊搜索。
    *
    * @var string[]
    */
    ...
    * Sets searchKey
    *
    * @param string|null $searchKey 搜索条件，支持名称、手机、邮箱、帐号模糊搜索。
    *
    * @return $this
    */
