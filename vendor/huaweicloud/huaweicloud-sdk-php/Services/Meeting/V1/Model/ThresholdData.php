...
class ThresholdData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ThresholdData';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * receiving  自定义接收方向阈值，单位为毫秒(ms)
    * receivingDefault  默认接收方向阈值，单位为毫秒(ms)
    * sending  自定义发送方向阈值，单位为毫秒(ms)
    * sendingDefault  默认发送方向阈值，单位为毫秒(ms)
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['receiving']) && ($this->container['receiving'] > 10000)) {
                $invalidProperties[] = "invalid value for 'receiving', must be smaller than or equal to 10000.";
            }
            ...
            if (!is_null($this->container['receivingDefault']) && ($this->container['receivingDefault'] > 10000)) {
                $invalidProperties[] = "invalid value for 'receivingDefault', must be smaller than or equal to 10000.";
            }
            ...
            if (!is_null($this->container['sending']) && ($this->container['sending'] > 10000)) {
                $invalidProperties[] = "invalid value for 'sending', must be smaller than or equal to 10000.";
            }
            ...
            if (!is_null($this->container['sendingDefault']) && ($this->container['sendingDefault'] > 10000)) {
                $invalidProperties[] = "invalid value for 'sendingDefault', must be smaller than or equal to 10000.";
            }
    ...
    * Sets receiving
    *
    * @param int|null $receiving 自定义接收方向阈值，单位为毫秒(ms)
    *
    * @return $this
    */
    ...
    *
    * @param int|null $receivingDefault 默认接收方向阈值，单位为毫秒(ms)
    *
    * @return $this
    */
    ...
    * Sets sending
    *
    * @param int|null $sending 自定义发送方向阈值，单位为毫秒(ms)
    *
    * @return $this
    */
    ...
    * Sets sendingDefault
    *
    * @param int|null $sendingDefault 默认发送方向阈值，单位为毫秒(ms)
    *
    * @return $this
    */
