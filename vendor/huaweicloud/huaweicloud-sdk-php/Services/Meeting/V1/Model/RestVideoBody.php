...
class RestVideoBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RestVideoBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * status  主持人邀请与会者开启/关闭摄像头请求。 * 1：关闭视频 * 0：开启视频
    *
    * @var string[]
    */
    ...
    * Sets status
    *
    * @param int $status 主持人邀请与会者开启/关闭摄像头请求。 * 1：关闭视频 * 0：开启视频
    *
    * @return $this
    */
