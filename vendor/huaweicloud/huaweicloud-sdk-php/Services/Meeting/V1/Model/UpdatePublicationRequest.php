...
class UpdatePublicationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePublicationRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\UpdatePublicationRequestDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\UpdatePublicationRequestDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\UpdatePublicationRequestDTO|null $body body
    *
    * @return $this
    */
