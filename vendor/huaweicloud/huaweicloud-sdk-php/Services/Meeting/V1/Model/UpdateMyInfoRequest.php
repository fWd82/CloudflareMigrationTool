...
class UpdateMyInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMyInfoRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\ModMemberDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\ModMemberDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\ModMemberDTO|null $body body
    *
    * @return $this
    */
