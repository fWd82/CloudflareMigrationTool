...
class SearchAttendanceRecordsOfHisMeetingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchAttendanceRecordsOfHisMeetingRequest';
    ...
    * Sets searchKey
    *
    * @param string|null $searchKey 查询条件 。
    *
    * @return $this
    */
