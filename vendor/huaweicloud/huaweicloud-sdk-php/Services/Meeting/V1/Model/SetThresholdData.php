...
class SetThresholdData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetThresholdData';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * receiving  接收方向阈值设定值，单位为毫秒(ms)。 取值范围：0 - 10000。
    * sending  发送方向阈值设定值，单位为毫秒(ms)。 取值范围：0 - 10000。
    *
    * @var string[]
    */
    ...
    * Sets receiving
    *
    * @param int|null $receiving 接收方向阈值设定值，单位为毫秒(ms)。 取值范围：0 - 10000。
    *
    * @return $this
    */
    ...
    * Sets sending
    *
    * @param int|null $sending 发送方向阈值设定值，单位为毫秒(ms)。 取值范围：0 - 10000。
    *
    * @return $this
    */
