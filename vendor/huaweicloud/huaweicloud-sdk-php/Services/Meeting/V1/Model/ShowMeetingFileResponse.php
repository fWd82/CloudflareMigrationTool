...
class ShowMeetingFileResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowMeetingFileResponse';
    ...
    * Sets fileUrl
    *
    * @param string|null $fileUrl 文件url。
    *
    * @return $this
    */
    ...
    * Sets thumbnailUrl
    *
    * @param string|null $thumbnailUrl 缩略图文件url。
    *
    * @return $this
    */
    ...
    * Sets pdfUrl
    *
    * @param string|null $pdfUrl pdf文件url。
    *
    * @return $this
    */
