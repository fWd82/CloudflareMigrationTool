...
class AddCorpDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddCorpDTO';
    ...
    */
    protected static $openAPITypes = [
            'basicInfo' => '\HuaweiCloud\SDK\Meeting\V1\Model\CorpBasicDTO',
            'adminInfo' => '\HuaweiCloud\SDK\Meeting\V1\Model\AdminDTO',
            'resInfo' => '\HuaweiCloud\SDK\Meeting\V1\Model\AddCorpResDTO',
            'groupId' => 'string',
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['basicInfo'] === null) {
            $invalidProperties[] = "'basicInfo' can't be null";
        }
        if ($this->container['adminInfo'] === null) {
            $invalidProperties[] = "'adminInfo' can't be null";
        }
    ...
    *  basicInfo
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\CorpBasicDTO
    */
    ...
    * Sets basicInfo
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\CorpBasicDTO $basicInfo basicInfo
    *
    * @return $this
    */
    ...
    *  adminInfo
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\AdminDTO
    */
    ...
    * Sets adminInfo
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\AdminDTO $adminInfo adminInfo
    *
    * @return $this
    */
    ...
    *  resInfo
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\AddCorpResDTO|null
    */
    ...
    * Sets resInfo
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\AddCorpResDTO|null $resInfo resInfo
    *
    * @return $this
    */
