...
class SearchCorpVmrRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchCorpVmrRequest';
    ...
    * limit  查询数量。 默认值：10。
    * searchKey  搜索条件。支持云会议室名称、ID及分配的用户、硬终端名称模糊搜索。
    * vmrMode  VMR模式。不填则默认为云会议室。 - 1：云会议室 - 2：网络研讨会
    * status  云会议室状态。不填则查询所有。 * 0：正常 * 1：停用 * 2：未分配
    *
    * @var string[]
    */
    ...
    * Sets searchKey
    *
    * @param string|null $searchKey 搜索条件。支持云会议室名称、ID及分配的用户、硬终端名称模糊搜索。
    *
    * @return $this
    */
    ...
    * Sets vmrMode
    *
    * @param int|null $vmrMode VMR模式。不填则默认为云会议室。 - 1：云会议室 - 2：网络研讨会
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param int|null $status 云会议室状态。不填则查询所有。 * 0：正常 * 1：停用 * 2：未分配
    *
    * @return $this
    */
