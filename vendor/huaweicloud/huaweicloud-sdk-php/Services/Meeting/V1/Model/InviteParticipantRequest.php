...
class InviteParticipantRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InviteParticipantRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\RestInviteReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\RestInviteReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\RestInviteReqBody|null $body body
    *
    * @return $this
    */
