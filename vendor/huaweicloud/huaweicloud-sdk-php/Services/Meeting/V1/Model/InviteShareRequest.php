...
class InviteShareRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InviteShareRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\InviteShareDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\InviteShareDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\InviteShareDTO|null $body body
    *
    * @return $this
    */
