...
class UpdateUserRequest implements ModelInterface, ArrayAccess
{
    ...
    * account  帐号。 * 如果是帐号/密码鉴权方式，是指华为云会议帐号 * 如果是App ID鉴权方式，是指第三方User ID
    * accountType  帐号类型。默认0。 * 0：华为云会议帐号。用于帐号/密码鉴权方式 * 1：第三方User ID，用于App ID鉴权方式
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'account' => 'string',
            'accountType' => 'int',
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\ModUserDTO'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['account'] === null) {
            ...
            if (!is_null($this->container['accountType']) && ($this->container['accountType'] > 1)) {
                $invalidProperties[] = "invalid value for 'accountType', must be smaller than or equal to 1.";
            }
            if (!is_null($this->container['accountType']) && ($this->container['accountType'] < 0)) {
                $invalidProperties[] = "invalid value for 'accountType', must be bigger than or equal to 0.";
            }
    ...
    * Sets accountType
    *
    * @param int|null $accountType 帐号类型。默认0。 * 0：华为云会议帐号。用于帐号/密码鉴权方式 * 1：第三方User ID，用于App ID鉴权方式
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\ModUserDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\ModUserDTO|null $body body
    *
    * @return $this
    */
