...
class CancelRecurringSubMeetingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CancelRecurringSubMeetingRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'conferenceId' => 'string',
            'type' => 'int',
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\RestCancelSingleRecordCycleConfListReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\RestCancelSingleRecordCycleConfListReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\RestCancelSingleRecordCycleConfListReqBody|null $body body
    *
    * @return $this
    */
