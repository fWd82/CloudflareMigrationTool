...
class SearchVisionActiveCodeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchVisionActiveCodeRequest';
    ...
    * Sets searchKey
    *
    * @param string|null $searchKey 搜索条件,支持激活码、终端名称模糊搜索。
    *
    * @return $this
    */
    ...
    * Sets devType
    *
    * @param string|null $devType 终端类型。 - idea-hub:智能协作大屏 - huawei-vision:智慧屏TV - welink-desktop(iwb):SmartRooms会议版 - smart-rooms：SmartRooms完整版
    *
    * @return $this
    */
