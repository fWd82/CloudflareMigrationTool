...
class BatchUpdateUserStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * Sets value
    *
    * @param int $value 用户的新状态。 - 0，启用 - 1，停用
    *
    * @return $this
    */
