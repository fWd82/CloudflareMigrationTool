...
class UpdateRoomSettingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRoomSettingRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'conferenceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\OpenRoomSettingReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\OpenRoomSettingReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\OpenRoomSettingReq|null $body body
    *
    * @return $this
    */
