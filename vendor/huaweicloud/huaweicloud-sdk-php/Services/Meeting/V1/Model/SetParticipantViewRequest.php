...
class SetParticipantViewRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetParticipantViewRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * conferenceId  会议ID。
    * participantId  专业会议终端的与会者标识。
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\RestParticipantViewReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\RestParticipantViewReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\RestParticipantViewReqBody|null $body body
    *
    * @return $this
    */
