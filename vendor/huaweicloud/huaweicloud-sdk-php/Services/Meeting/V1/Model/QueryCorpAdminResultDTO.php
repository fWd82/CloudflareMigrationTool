...
class QueryCorpAdminResultDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'QueryCorpAdminResultDTO';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  用户UUID。
    * account  用户帐号（华为云会议帐号）。
    * name  用户名称。
    ...
    */
    protected static $openAPITypes = [
            ...
            'phone' => 'string',
            'country' => 'string',
            'dept' => '\HuaweiCloud\SDK\Meeting\V1\Model\DeptBasicDTO'
    ];
    ...
    * Sets account
    *
    * @param string|null $account 用户帐号（华为云会议帐号）。
    *
    * @return $this
    */
    ...
    *  dept
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\DeptBasicDTO|null
    */
    ...
    * Sets dept
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\DeptBasicDTO|null $dept dept
    *
    * @return $this
    */
