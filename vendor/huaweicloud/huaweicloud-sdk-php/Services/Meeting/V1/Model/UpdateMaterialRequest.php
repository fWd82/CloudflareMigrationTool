...
class UpdateMaterialRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMaterialRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\UpdateMaterialRequestDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\UpdateMaterialRequestDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\UpdateMaterialRequestDTO|null $body body
    *
    * @return $this
    */
