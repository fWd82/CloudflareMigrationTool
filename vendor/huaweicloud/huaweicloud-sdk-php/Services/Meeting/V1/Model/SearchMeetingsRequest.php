...
class SearchMeetingsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchMeetingsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * userUuid  用户的UUID。 > 仅管理员有权限查询本企业其他用户的会议列表；普通帐号该字段无效，只能查询自己的。
    * offset  查询偏移量。默认为0。
    * limit  查询数量。默认是20，最大500条。
    * queryAll  是否查询企业下所有用户的会议记录。默认值为false。 * true：查询所有用户的会议 * false：仅查询管理员自己创建的会议 > 仅对企业管理员生效。
    * searchKey  查询条件。会议主题、会议预约人和会议ID等可作为搜索内容。长度限制为1-128个字符。
    * queryConfMode  查询时间范围。 - ADAY:  一天 - AWEEK:  一周 - AMONTH:  一个月 - ALL:  查询所有
    * sortType  查询结果排序。 - ASC_StartTIME:  按会议开始时间升序排序 - DSC_StartTIME:  按会议开始时间降序排序
    ...
    */
    protected static $setters = [
            ...
            'queryConfMode' => 'setQueryConfMode',
    ...
    */
    protected static $getters = [
            ...
            'queryConfMode' => 'getQueryConfMode',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['queryConfMode'] = isset($data['queryConfMode']) ? $data['queryConfMode'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['searchKey']) && (mb_strlen($this->container['searchKey']) < 1)) {
                $invalidProperties[] = "invalid value for 'searchKey', the character length must be bigger than or equal to 1.";
            }
    ...
    * Sets userUuid
    *
    * @param string|null $userUuid 用户的UUID。 > 仅管理员有权限查询本企业其他用户的会议列表；普通帐号该字段无效，只能查询自己的。
    *
    * @return $this
    */
    ...
    * Sets queryAll
    *
    * @param bool|null $queryAll 是否查询企业下所有用户的会议记录。默认值为false。 * true：查询所有用户的会议 * false：仅查询管理员自己创建的会议 > 仅对企业管理员生效。
    *
    * @return $this
    */
    ...
    * @return string|null
    */
    public function getQueryConfMode()
    {
        return $this->container['queryConfMode'];
    }

    /**
    * Sets queryConfMode
    *
    * @param string|null $queryConfMode 查询时间范围。 - ADAY:  一天 - AWEEK:  一周 - AMONTH:  一个月 - ALL:  查询所有
    *
    * @return $this
    */
    public function setQueryConfMode($queryConfMode)
    {
        $this->container['queryConfMode'] = $queryConfMode;
        return $this;
    }
    ...
    * Sets sortType
    *
    * @param string|null $sortType 查询结果排序。 - ASC_StartTIME:  按会议开始时间升序排序 - DSC_StartTIME:  按会议开始时间降序排序
    *
    * @return $this
    */
