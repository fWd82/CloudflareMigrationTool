...
class BatchUpdateDevicesStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateDevicesStatusRequest';
