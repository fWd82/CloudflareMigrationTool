...
class SetPacketThresholdData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetPacketThresholdData';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * receiving  接收方向阈值设定值，单位为百分比(%)。 取值范围：0 - 100。
    * sending  发送方向阈值设定值，单位为百分比(%)。 取值范围：0 - 100。
    *
    * @var string[]
    */
    ...
    * Sets receiving
    *
    * @param int|null $receiving 接收方向阈值设定值，单位为百分比(%)。 取值范围：0 - 100。
    *
    * @return $this
    */
    ...
    * Sets sending
    *
    * @param int|null $sending 发送方向阈值设定值，单位为百分比(%)。 取值范围：0 - 100。
    *
    * @return $this
    */
