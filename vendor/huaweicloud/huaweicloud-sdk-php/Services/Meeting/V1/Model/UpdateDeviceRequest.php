...
class UpdateDeviceRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'sn' => 'string',
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\ModDeviceDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\ModDeviceDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\ModDeviceDTO|null $body body
    *
    * @return $this
    */
