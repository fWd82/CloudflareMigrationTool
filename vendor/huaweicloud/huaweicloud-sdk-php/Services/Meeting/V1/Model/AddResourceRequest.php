...
class AddResourceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddResourceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'corpId' => 'string',
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\ResourceDTO[]'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\ResourceDTO[]|null $body body
    *
    * @return $this
    */
