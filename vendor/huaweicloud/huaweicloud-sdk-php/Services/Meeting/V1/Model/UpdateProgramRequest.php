...
class UpdateProgramRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\UpdateProgramRequestDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\UpdateProgramRequestDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\UpdateProgramRequestDTO|null $body body
    *
    * @return $this
    */
