...
class UpdateMemberVmrRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMemberVmrRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\ModVmrDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\ModVmrDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\ModVmrDTO|null $body body
    *
    * @return $this
    */
