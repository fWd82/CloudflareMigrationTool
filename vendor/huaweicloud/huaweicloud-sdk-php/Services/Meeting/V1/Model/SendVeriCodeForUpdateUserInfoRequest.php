...
class SendVeriCodeForUpdateUserInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SendVeriCodeForUpdateUserInfoRequest';
