...
class ShowPublicationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPublicationResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'programList' => '\HuaweiCloud\SDK\Meeting\V1\Model\ProgramResponseBase[]',
            'deptList' => '\HuaweiCloud\SDK\Meeting\V1\Model\PublishDeptResponseDTO[]',
            'deviceList' => '\HuaweiCloud\SDK\Meeting\V1\Model\PublishDeviceResponseDTO[]'
    ];
    ...
    *  发布节目ID列表。
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\ProgramResponseBase[]|null
    */
    ...
    * Sets programList
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\ProgramResponseBase[]|null $programList 发布节目ID列表。
    *
    * @return $this
    */
    ...
    *  发布部门列表。
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\PublishDeptResponseDTO[]|null
    */
    ...
    * Sets deptList
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\PublishDeptResponseDTO[]|null $deptList 发布部门列表。
    *
    * @return $this
    */
    ...
    *  发布设备列表。
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\PublishDeviceResponseDTO[]|null
    */
    ...
    * Sets deviceList
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\PublishDeviceResponseDTO[]|null $deviceList 发布设备列表。
    *
    * @return $this
    */
