...
class SendVeriCodeForChangePwdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SendVeriCodeForChangePwdRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\VerifyCodeSendDTOV1'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\VerifyCodeSendDTOV1|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\VerifyCodeSendDTOV1|null $body body
    *
    * @return $this
    */
