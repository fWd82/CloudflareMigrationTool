...
class UpdateResourceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateResourceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'corpId' => 'string',
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\ModResourceDTO[]'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\ModResourceDTO[]|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\ModResourceDTO[]|null $body body
    *
    * @return $this
    */
