...
class SearchProgramsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchProgramsRequest';
    ...
    * Sets searchKey
    *
    * @param string|null $searchKey 搜索条件，支持节目名称、更新人模糊搜索。
    *
    * @return $this
    */
