...
class AzCodeInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AzCodeInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * azCode  |参数名称：可用区编码| |参数的约束及描述：该参数非必填，且只允许字符串|
    *
    * @var string[]
    */
    ...
    * Sets azCode
    *
    * @param string|null $azCode |参数名称：可用区编码| |参数的约束及描述：该参数非必填，且只允许字符串|
    *
    * @return $this
    */
