...
class FilterV2 implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'operator' => 'int',
            'filterFactor' => '\HuaweiCloud\SDK\Bssintl\V2\Model\FilterFactor'
    ];
    ...
    *  filterFactor
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\FilterFactor
    */
    ...
    * Sets filterFactor
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\FilterFactor $filterFactor filterFactor
    *
    * @return $this
    */
