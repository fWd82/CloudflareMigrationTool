...
class QueryResourcesReq implements ModelInterface, ArrayAccess
{
    ...
    * resourceIds  资源ID列表。 查询指定资源ID的资源（当only_main_resource=0时，查询指定资源及其附属资源）。最大支持50个ID同时作为条件查询，多个ID以英文逗号分隔。  说明： 资源ID是指开通资源以后，云服务针对该资源分配的标志，譬如云主机ECS的资源ID是server_id。
    * orderId  订单号。查询指定订单下的资源。  说明： 使用特殊字符进行查询的时候，请注意进行URL编码转换，如“%”的转码应为“%25”。
    ...
    * statusList  资源状态。 查询指定状态的资源。多个状态以英文逗号分隔。 2：使用中4：已冻结5：已过期
    ...
    * Sets resourceIds
    *
    * @param string[]|null $resourceIds 资源ID列表。 查询指定资源ID的资源（当only_main_resource=0时，查询指定资源及其附属资源）。最大支持50个ID同时作为条件查询，多个ID以英文逗号分隔。  说明： 资源ID是指开通资源以后，云服务针对该资源分配的标志，譬如云主机ECS的资源ID是server_id。
    *
    * @return $this
    */
    ...
    * Sets orderId
    *
    * @param string|null $orderId 订单号。查询指定订单下的资源。  说明： 使用特殊字符进行查询的时候，请注意进行URL编码转换，如“%”的转码应为“%25”。
    *
    * @return $this
    */
    ...
    * Sets statusList
    *
    * @param int[]|null $statusList 资源状态。 查询指定状态的资源。多个状态以英文逗号分隔。 2：使用中4：已冻结5：已过期
    *
    * @return $this
    */
    ...
    *
    * @param string|null $expireTimeBegin 查询指定时间段内失效的资源列表，时间段的起始时间，UTC时间。
    *
    * @return $this
    */
    ...
    * Sets expireTimeEnd
    *
    * @param string|null $expireTimeEnd 查询指定时间段内失效的资源列表，时间段的结束时间，UTC时间。
    *
    * @return $this
    */
