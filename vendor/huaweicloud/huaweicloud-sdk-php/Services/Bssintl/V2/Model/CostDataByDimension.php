...
class CostDataByDimension implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'dimensions' => '\HuaweiCloud\SDK\Bssintl\V2\Model\DimensionGroup[]',
            'costs' => '\HuaweiCloud\SDK\Bssintl\V2\Model\Cost[]',
    ...
    *  维度列表。
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\DimensionGroup[]|null
    */
    ...
    * Sets dimensions
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\DimensionGroup[]|null $dimensions 维度列表。
    *
    * @return $this
    */
    ...
    *  成本值。
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\Cost[]|null
    */
    ...
    * Sets costs
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\Cost[]|null $costs 成本值。
    *
    * @return $this
    */
