...
class ListUsageTypesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'usageTypes' => '\HuaweiCloud\SDK\Bssintl\V2\Model\UsageType[]'
    ];
    ...
    *  使用量类型列表，具体请参见表3。
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\UsageType[]|null
    */
    ...
    * Sets usageTypes
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\UsageType[]|null $usageTypes 使用量类型列表，具体请参见表3。
    *
    * @return $this
    */
