...
class ListIndirectPartnersResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'indirectPartners' => '\HuaweiCloud\SDK\Bssintl\V2\Model\IndirectPartnerInfo[]'
    ];
    ...
    *  云经销商列表，具体参见表1。
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\IndirectPartnerInfo[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\IndirectPartnerInfo[]|null $indirectPartners 云经销商列表，具体参见表1。
    *
    * @return $this
    */
