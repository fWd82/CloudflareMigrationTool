...
class ServiceResourceInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'basicInfo' => '\HuaweiCloud\SDK\Bssintl\V2\Model\ResourceBasicInfo'
    ];
    ...
    *  basicInfo
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\ResourceBasicInfo|null
    */
    ...
    * Sets basicInfo
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\ResourceBasicInfo|null $basicInfo basicInfo
    *
    * @return $this
    */
