...
class RenewalResourcesResponse implements ModelInterface, ArrayAccess
{
    ...
    * Sets orderIds
    *
    * @param string[]|null $orderIds 续订资源生成的订单ID的列表。
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\FailResourceInfo[]|null $failResourceInfos |参数名称：失败的资源信息列表| |参数的约束及描述：套餐包使用量信息|
    *
    * @return $this
    */
