...
class ApplyEnterpriseRealnameAuthsReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ApplyEnterpriseRealnameAuthsReq';
    ...
    */
    protected static $openAPITypes = [
            ...
            'regAddress' => 'string',
            'xaccountType' => 'string',
            'enterprisePerson' => '\HuaweiCloud\SDK\Bssintl\V2\Model\EnterprisePersonNew'
    ];
    ...
    *  enterprisePerson
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\EnterprisePersonNew|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\EnterprisePersonNew|null $enterprisePerson enterprisePerson
    *
    * @return $this
    */
