...
class RateOnPeriodReq implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'productInfos' => '\HuaweiCloud\SDK\Bssintl\V2\Model\PeriodProductInfo[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\PeriodProductInfo[]
    */
    ...
    * Sets productInfos
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\PeriodProductInfo[] $productInfos 产品信息列表，询价时要询价产品的信息的列表，具体参见表1。
    *
    * @return $this
    */
