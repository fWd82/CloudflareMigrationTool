...
class ShowCustomerOrderDetailsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'orderInfo' => '\HuaweiCloud\SDK\Bssintl\V2\Model\CustomerOrderV3',
            'orderLineItems' => '\HuaweiCloud\SDK\Bssintl\V2\Model\OrderLineItemEntityV2[]'
    ];
    ...
    *  orderInfo
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\CustomerOrderV3|null
    */
    ...
    * Sets orderInfo
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\CustomerOrderV3|null $orderInfo orderInfo
    *
    * @return $this
    */
