...
class ListFreeResourceUsagesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListFreeResourceUsagesRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Bssintl\V2\Model\ListFreeResourceUsagesReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\ListFreeResourceUsagesReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\ListFreeResourceUsagesReq|null $body body
    *
    * @return $this
    */
