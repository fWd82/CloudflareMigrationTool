...
class ListServiceTypesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListServiceTypesResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'serviceTypes' => '\HuaweiCloud\SDK\Bssintl\V2\Model\ServiceTypes[]'
    ];
