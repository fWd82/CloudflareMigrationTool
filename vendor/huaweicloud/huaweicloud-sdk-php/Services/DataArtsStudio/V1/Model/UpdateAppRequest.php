...
class UpdateAppRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAppRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'contentType' => 'string',
            'appId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\AppUpdateDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\AppUpdateDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\AppUpdateDTO|null $body body
    *
    * @return $this
    */
