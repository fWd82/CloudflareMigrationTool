...
class ShowApplyDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowApplyDetailRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['applyId'] === null) {
            $invalidProperties[] = "'applyId' can't be null";
        }
