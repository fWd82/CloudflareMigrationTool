...
class CreateSecurityPermissionSetPermissionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSecurityPermissionSetPermissionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspace' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSetPermissionCreateDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSetPermissionCreateDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSetPermissionCreateDTO|null $body body
    *
    * @return $this
    */
