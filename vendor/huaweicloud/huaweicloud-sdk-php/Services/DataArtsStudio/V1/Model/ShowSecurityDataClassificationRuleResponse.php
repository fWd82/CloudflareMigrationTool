...
class ShowSecurityDataClassificationRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSecurityDataClassificationRuleResponse';
