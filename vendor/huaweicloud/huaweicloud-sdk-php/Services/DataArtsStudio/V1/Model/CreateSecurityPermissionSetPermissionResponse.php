...
class CreateSecurityPermissionSetPermissionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSecurityPermissionSetPermissionResponse';
