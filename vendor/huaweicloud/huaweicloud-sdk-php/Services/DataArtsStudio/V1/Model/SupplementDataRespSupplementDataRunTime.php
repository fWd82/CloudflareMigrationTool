...
class SupplementDataRespSupplementDataRunTime implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SupplementDataResp_supplement_data_run_time';
