...
class BatchDeleteRulesBaseDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteRulesBaseDTO';
