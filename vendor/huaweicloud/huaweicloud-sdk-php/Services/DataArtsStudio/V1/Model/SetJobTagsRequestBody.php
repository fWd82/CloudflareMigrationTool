...
class SetJobTagsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetJobTagsRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * tagNames  标签列表, 若未空，则标识删除标签
    *
    * @var string[]
    */
    ...
    * Sets tagNames
    *
    * @param string[]|null $tagNames 标签列表, 若未空，则标识删除标签
    *
    * @return $this
    */
