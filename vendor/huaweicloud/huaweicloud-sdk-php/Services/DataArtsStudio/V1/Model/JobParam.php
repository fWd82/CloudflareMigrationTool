...
class JobParam implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'JobParam';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  参数名称，只能包含英文字母、数字、中划线和下划线。
    * value  参数值
    * type  参数类型:   - variable: 变量   - constants: 常量
    *
    * @var string[]
    */
    ...
    * Sets name
    *
    * @param string $name 参数名称，只能包含英文字母、数字、中划线和下划线。
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type 参数类型:   - variable: 变量   - constants: 常量
    *
    * @return $this
    */
