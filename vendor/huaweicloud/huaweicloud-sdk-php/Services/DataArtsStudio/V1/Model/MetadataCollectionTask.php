...
class MetadataCollectionTask implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MetadataCollectionTask';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['scheduleConfig'] === null) {
            $invalidProperties[] = "'scheduleConfig' can't be null";
        }
    ...
    *  scheduleConfig
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\SchedulerInfo
    */
    ...
    * Sets scheduleConfig
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\SchedulerInfo $scheduleConfig scheduleConfig
    *
    * @return $this
    */
    ...
    * Sets taskConfig
    *
    * @param object $taskConfig 任务信息Map<String, Object>
    *
    * @return $this
    */
