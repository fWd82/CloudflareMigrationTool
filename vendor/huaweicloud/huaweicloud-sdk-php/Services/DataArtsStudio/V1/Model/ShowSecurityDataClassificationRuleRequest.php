...
class ShowSecurityDataClassificationRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSecurityDataClassificationRuleRequest';
