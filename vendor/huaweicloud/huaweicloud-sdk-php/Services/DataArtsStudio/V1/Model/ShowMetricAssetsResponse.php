...
class ShowMetricAssetsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowMetricAssetsResponse';
    ...
    * Sets entities
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\OpenEntityHeader[]|null $entities 指标资产列表
    *
    * @return $this
    */
