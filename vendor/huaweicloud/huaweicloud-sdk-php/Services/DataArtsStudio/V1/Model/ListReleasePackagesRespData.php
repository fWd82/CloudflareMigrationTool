...
class ListReleasePackagesRespData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListReleasePackagesResp_data';
    ...
    * packageId  发布包id
    * packageName  发布包名称
    * projectId  项目ID和空间信息，以 项目ID-workspace-空间ID 拼接。
    * workspaceId  发布包所在空间ID
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'packageApprovers' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\ListReleasePackagesRespPackageApprovers[]',
            'packageId' => 'string',
            'packageName' => 'string',
            'projectId' => 'string',
            'workspaceId' => 'string'
    ...
    * Sets applyUserId
    *
    * @param string|null $applyUserId 申请人id
    *
    * @return $this
    */
    ...
    * Sets deleteFlag
    *
    * @param int|null $deleteFlag 是否删除，0:没有删除，1:删除
    *
    * @return $this
    */
    ...
    *  发布包审批信息
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ListReleasePackagesRespPackageApprovers[]
    */
    ...
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ListReleasePackagesRespPackageApprovers[] $packageApprovers 发布包审批信息
    *
    * @return $this
    */
    ...
    * Sets projectId
    *
    * @param string|null $projectId 项目ID和空间信息，以 项目ID-workspace-空间ID 拼接。
    *
    * @return $this
    */
    ...
    * Sets workspaceId
    *
    * @param string|null $workspaceId 发布包所在空间ID
    *
    * @return $this
    */
