...
class ListDatabasesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'dwId' => 'string',
            'databases' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\DatabasesList[]'
    ];
    ...
    * Sets totalCount
    *
    * @param int|null $totalCount 当前数据连接数据库记录数
    *
    * @return $this
    */
    ...
    *  数据库列表
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DatabasesList[]|null
    */
    ...
    * Sets databases
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DatabasesList[]|null $databases 数据库列表
    *
    * @return $this
    */
