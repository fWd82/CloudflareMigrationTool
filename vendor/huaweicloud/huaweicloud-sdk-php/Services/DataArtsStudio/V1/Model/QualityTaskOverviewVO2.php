...
class QualityTaskOverviewVO2 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'QualityTaskOverviewVO_2';
    ...
    * lastRunTime  最新运行时间,13位时间戳(精确到毫秒)
    * creator  创建者
    *
    * @var string[]
    */
    ...
    * Sets lastRunTime
    *
    * @param int|null $lastRunTime 最新运行时间,13位时间戳(精确到毫秒)
    *
    * @return $this
    */
