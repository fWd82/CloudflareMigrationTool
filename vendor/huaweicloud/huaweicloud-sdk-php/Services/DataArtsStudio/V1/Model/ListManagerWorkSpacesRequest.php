...
class ListManagerWorkSpacesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListManagerWorkSpacesRequest';
    ...
    * Sets offset
    *
    * @param int|null $offset 数据偏移量。默认0
    *
    * @return $this
    */
