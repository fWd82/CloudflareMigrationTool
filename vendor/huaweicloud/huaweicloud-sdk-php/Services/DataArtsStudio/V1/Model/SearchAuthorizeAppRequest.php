...
class SearchAuthorizeAppRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchAuthorizeAppRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['apiId'] === null) {
            ...
            if ((mb_strlen($this->container['apiId']) > 64)) {
                $invalidProperties[] = "invalid value for 'apiId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['apiId']) < 1)) {
                $invalidProperties[] = "invalid value for 'apiId', the character length must be bigger than or equal to 1.";
            }
