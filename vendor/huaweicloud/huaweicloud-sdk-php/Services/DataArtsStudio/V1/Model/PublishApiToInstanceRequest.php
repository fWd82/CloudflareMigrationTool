...
class PublishApiToInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PublishApiToInstanceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'apiId' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\GatewayDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\GatewayDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\GatewayDTO|null $body body
    *
    * @return $this
    */
