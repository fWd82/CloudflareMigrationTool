...
class DebugDataconnectionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DebugDataconnectionRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspace' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\ApigDataSourceVo'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ApigDataSourceVo|null $body body
    *
    * @return $this
    */
