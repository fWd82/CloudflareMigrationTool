...
class CreateSecurityPermissionSetMemberRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSecurityPermissionSetMemberRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspace' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSetMemberCreateDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSetMemberCreateDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSetMemberCreateDTO|null $body body
    *
    * @return $this
    */
