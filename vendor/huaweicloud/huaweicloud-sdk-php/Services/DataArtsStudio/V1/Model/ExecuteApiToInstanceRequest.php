...
class ExecuteApiToInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteApiToInstanceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'apiId' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\ApiActionDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ApiActionDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ApiActionDTO|null $body body
    *
    * @return $this
    */
