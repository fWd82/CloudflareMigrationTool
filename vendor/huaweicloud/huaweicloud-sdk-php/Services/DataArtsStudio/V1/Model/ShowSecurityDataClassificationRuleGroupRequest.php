...
class ShowSecurityDataClassificationRuleGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSecurityDataClassificationRuleGroupRequest';
