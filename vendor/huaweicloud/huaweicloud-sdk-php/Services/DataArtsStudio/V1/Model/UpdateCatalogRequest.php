...
class UpdateCatalogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCatalogRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'contentType' => 'string',
            'catalogId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\ApiCatalogUpdateParaDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ApiCatalogUpdateParaDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ApiCatalogUpdateParaDTO|null $body body
    *
    * @return $this
    */
