...
class DimensionHierarchiesVO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DimensionHierarchiesVO';
    ...
    */
    protected static $openAPITypes = [
            'id' => 'int',
            'name' => 'string',
            'attrs' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\HierarchiesAttrVO[]',
            'createTime' => '\DateTime',
            'updateTime' => '\DateTime',
            'createBy' => 'string',
            'updateBy' => 'string'
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['name']) && (mb_strlen($this->container['name']) > 600)) {
