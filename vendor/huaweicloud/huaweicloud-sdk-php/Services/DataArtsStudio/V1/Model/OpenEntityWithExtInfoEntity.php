...
class OpenEntityWithExtInfoEntity implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OpenEntityWithExtInfo_entity';
    ...
    * updatedBy  更新人
    * updateTime  更新时间
    * tags  标签 List<TagHeader>
    * classificationNames  分类名称 List<String>
    *
    * @var string[]
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\TagHeader[]|null $tags 标签 List<TagHeader>
    *
    * @return $this
    */
    ...
    *
    * @param string[]|null $classificationNames 分类名称 List<String>
    *
    * @return $this
    */
