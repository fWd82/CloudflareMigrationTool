...
class ListSecurityPermissionSetsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSecurityPermissionSetsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * total  总条数
    * permissionSets  权限集列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'permissionSets' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSet[]'
    ];
    ...
    *  权限集列表
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSet[]|null
    */
    ...
    * Sets permissionSets
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSet[]|null $permissionSets 权限集列表
    *
    * @return $this
    */
