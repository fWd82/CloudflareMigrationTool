...
class ShowConsistencyTaskDetailResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowConsistencyTaskDetailResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'createTime' => 'int',
            'lastRunTime' => 'int',
            'subRules' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\ConsistencyRuleDetailForOpenApi[][]'
    ];
    ...
    *  子规则
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ConsistencyRuleDetailForOpenApi[][]|null
    */
    ...
    * Sets subRules
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ConsistencyRuleDetailForOpenApi[][]|null $subRules 子规则
    *
    * @return $this
    */
