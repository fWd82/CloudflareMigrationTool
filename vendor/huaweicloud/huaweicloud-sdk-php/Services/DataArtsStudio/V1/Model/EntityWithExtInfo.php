...
class EntityWithExtInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EntityWithExtInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * entity  entity
    * referredEntities  关联资产map Map<String, AtlasAssetEntity>
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'entity' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\AtlasAssetEntity',
    ...
    *  entity
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\AtlasAssetEntity
    */
    ...
    * Sets entity
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\AtlasAssetEntity $entity entity
    *
    * @return $this
    */
    ...
    *
    * @param object|null $referredEntities 关联资产map Map<String, AtlasAssetEntity>
    *
    * @return $this
    */
