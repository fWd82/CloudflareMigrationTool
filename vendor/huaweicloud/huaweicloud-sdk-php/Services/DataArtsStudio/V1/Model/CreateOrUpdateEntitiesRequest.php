...
class CreateOrUpdateEntitiesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateOrUpdateEntitiesRequest';
    ...
    */
    protected static $openAPITypes = [
            'instance' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\DataEntityWithExtInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DataEntityWithExtInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DataEntityWithExtInfo|null $body body
    *
    * @return $this
    */
