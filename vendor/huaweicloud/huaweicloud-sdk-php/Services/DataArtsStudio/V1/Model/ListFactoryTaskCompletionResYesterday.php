...
class ListFactoryTaskCompletionResYesterday implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListFactoryTaskCompletionRes_yesterday';
