...
class ConfirmMessageRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ConfirmMessageRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'dlmType' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\OpenApiParaForCheckMessage'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\OpenApiParaForCheckMessage|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\OpenApiParaForCheckMessage|null $body body
    *
    * @return $this
    */
