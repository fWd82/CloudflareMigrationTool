...
class BatchDeleteSecurityPermissionSetMembersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteSecurityPermissionSetMembersRequest';
