...
class SubCategoryDetailVO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SubCategoryDetailVO';
    ...
    * Sets subCategories
    *
    * @param object|null $subCategories 子目录
    *
    * @return $this
    */
