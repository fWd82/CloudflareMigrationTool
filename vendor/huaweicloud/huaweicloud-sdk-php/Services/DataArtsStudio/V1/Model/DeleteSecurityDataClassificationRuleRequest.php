...
class DeleteSecurityDataClassificationRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteSecurityDataClassificationRuleRequest';
