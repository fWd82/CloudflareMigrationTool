...
class BatchDeleteSecurityPermissionSetPermissionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteSecurityPermissionSetPermissionsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspace' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\BatchDeleteBaseDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\BatchDeleteBaseDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\BatchDeleteBaseDTO|null $body body
    *
    * @return $this
    */
