...
class ListAggregationLogicTablesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAggregationLogicTablesRequest';
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['autoGenerate'] = isset($data['autoGenerate']) ? $data['autoGenerate'] : null;
    }
    ...
    */
    ...
    {
        return $this->container['autoGenerate'];
    }

    /**
    * Sets autoGenerate
    *
    * @param bool|null $autoGenerate 是否自动生成
    *
    * @return $this
    */
    public function setAutoGenerate($autoGenerate)
    {
        $this->container['autoGenerate'] = $autoGenerate;
        return $this;
    }
