...
class MigrateApiRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MigrateApiRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'dlmType' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\ApiMoveParaDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ApiMoveParaDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ApiMoveParaDTO|null $body body
    *
    * @return $this
    */
