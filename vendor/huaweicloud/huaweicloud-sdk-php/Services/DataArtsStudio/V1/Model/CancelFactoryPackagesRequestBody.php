...
class CancelFactoryPackagesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CancelFactoryPackagesRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * packageIds  发布包id列表信息
    *
    * @var string[]
    */
    ...
    * Sets packageIds
    *
    * @param string[]|null $packageIds 发布包id列表信息
    *
    * @return $this
    */
