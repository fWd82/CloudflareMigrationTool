...
class ListApproversRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApproversRequest';
    ...
    * Sets approverName
    *
    * @param string|null $approverName 审核人名字
    *
    * @return $this
    */
