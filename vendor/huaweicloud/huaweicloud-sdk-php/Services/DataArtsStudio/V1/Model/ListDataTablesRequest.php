...
class ListDataTablesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDataTablesRequest';
    ...
    * Sets tableName
    *
    * @param string|null $tableName 指定查询表的名称
    *
    * @return $this
    */
