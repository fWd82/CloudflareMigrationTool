...
class CreateSecrecyLevelDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSecrecyLevelDTO';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  密级名称。名称应该唯一，只能由英文字母、数字、下划线、汉字构成。
    * description  密级描述
    *
    * @var string[]
    */
    ...
    * Sets name
    *
    * @param string|null $name 密级名称。名称应该唯一，只能由英文字母、数字、下划线、汉字构成。
    *
    * @return $this
    */
