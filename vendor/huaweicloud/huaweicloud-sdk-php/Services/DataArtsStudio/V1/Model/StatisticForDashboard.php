...
class StatisticForDashboard implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StatisticForDashboard';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * logTime  统计时间点(13位时间戳)
    * callNum  调用总量
    ...
    * Sets logTime
    *
    * @param int|null $logTime 统计时间点(13位时间戳)
    *
    * @return $this
    */
