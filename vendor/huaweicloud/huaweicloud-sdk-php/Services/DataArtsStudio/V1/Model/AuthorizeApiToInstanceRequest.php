...
class AuthorizeApiToInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AuthorizeApiToInstanceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'apiId' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\ApiParaForAuthorizeToInstance'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ApiParaForAuthorizeToInstance|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ApiParaForAuthorizeToInstance|null $body body
    *
    * @return $this
    */
