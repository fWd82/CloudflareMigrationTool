...
class MigrateCatalogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MigrateCatalogRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'contentType' => 'string',
            'catalogId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\CatalogMoveParaDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\CatalogMoveParaDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\CatalogMoveParaDTO|null $body body
    *
    * @return $this
    */
