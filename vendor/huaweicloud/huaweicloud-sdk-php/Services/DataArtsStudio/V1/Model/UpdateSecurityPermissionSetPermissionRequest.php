...
class UpdateSecurityPermissionSetPermissionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSecurityPermissionSetPermissionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'permissionId' => 'string',
            'workspace' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSetPermissionUpdateDTO'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['permissionId'] === null) {
            ...
            if ((mb_strlen($this->container['permissionId']) > 128)) {
                $invalidProperties[] = "invalid value for 'permissionId', the character length must be smaller than or equal to 128.";
            }
            if ((mb_strlen($this->container['permissionId']) < 1)) {
                $invalidProperties[] = "invalid value for 'permissionId', the character length must be bigger than or equal to 1.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSetPermissionUpdateDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSetPermissionUpdateDTO|null $body body
    *
    * @return $this
    */
