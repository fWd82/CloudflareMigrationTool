...
class CreateDeploymentHostRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDeploymentHostRequest';
    ...
    */
    protected static $openAPITypes = [
            'groupId' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentHost'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentHost|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentHost|null $body body
    *
    * @return $this
    */
