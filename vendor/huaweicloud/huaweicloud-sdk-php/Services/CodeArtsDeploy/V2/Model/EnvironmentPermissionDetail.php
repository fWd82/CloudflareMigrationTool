...
class EnvironmentPermissionDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EnvironmentPermissionDetail';
    ...
    * Sets canDelete
    *
    * @param bool|null $canDelete 是否有删除环境权限
    *
    * @return $this
    */
    ...
    * Sets canEdit
    *
    * @param bool|null $canEdit 是否有编辑环境权限
    *
    * @return $this
    */
    ...
    * Sets canManage
    *
    * @param bool|null $canManage 是否有编辑环境权限矩阵的权限
    *
    * @return $this
    */
    ...
    * Sets canView
    *
    * @param bool|null $canView 是否有环境的查看权限
    *
    * @return $this
    */
