...
class TaskBaseResponseBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TaskBaseResponseBody';
    ...
    * Sets deploySystem
    *
    * @param string|null $deploySystem 部署任务类型
    *
    * @return $this
    */
