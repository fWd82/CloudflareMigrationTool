...
class DeploymentGroup implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeploymentGroup';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['regionName'] === null) {
            ...
            if ((mb_strlen($this->container['regionName']) > 20)) {
                $invalidProperties[] = "invalid value for 'regionName', the character length must be smaller than or equal to 20.";
            }
    ...
    * Sets os
    *
    * @param string $os 操作信息：windows|linux
    *
    * @return $this
    */
    ...
    * Sets isProxyMode
    *
    * @param int|null $isProxyMode 主机集群是否为代理类型
    *
    * @return $this
    */
