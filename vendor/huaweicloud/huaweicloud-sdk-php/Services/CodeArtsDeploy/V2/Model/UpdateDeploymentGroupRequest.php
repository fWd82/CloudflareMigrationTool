...
class UpdateDeploymentGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDeploymentGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            'groupId' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentGroupUpdateRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentGroupUpdateRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentGroupUpdateRequest|null $body body
    *
    * @return $this
    */
