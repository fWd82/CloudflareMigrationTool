...
class CreateHostRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateHostRequest';
    ...
    */
    protected static $openAPITypes = [
            'groupId' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\CreateHostRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\CreateHostRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\CreateHostRequestBody|null $body body
    *
    * @return $this
    */
