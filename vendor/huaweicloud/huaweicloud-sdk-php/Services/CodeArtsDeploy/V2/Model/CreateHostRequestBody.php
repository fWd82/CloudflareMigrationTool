...
class CreateHostRequestBody implements ModelInterface, ArrayAccess
{
    ...
    *  authorization
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\HostAuthorizationBody
    */
    ...
    * Sets authorization
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\HostAuthorizationBody $authorization authorization
    *
    * @return $this
    */
