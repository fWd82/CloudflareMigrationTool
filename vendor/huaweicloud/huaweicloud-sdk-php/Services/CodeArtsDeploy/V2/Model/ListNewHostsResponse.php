...
class ListNewHostsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListNewHostsResponse';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'status' => 'string',
            'result' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\HostInfo[]'
    ];
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\HostInfo[]|null $result 主机信息列表
    *
    * @return $this
    */
