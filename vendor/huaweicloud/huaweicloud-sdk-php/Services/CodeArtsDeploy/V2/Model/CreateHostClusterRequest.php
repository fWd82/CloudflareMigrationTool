...
class CreateHostClusterRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateHostClusterRequest';
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\CreateHostClusterRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\CreateHostClusterRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\CreateHostClusterRequestBody|null $body body
    *
    * @return $this
    */
