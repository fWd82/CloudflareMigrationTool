...
class DeleteHostFromEnvironmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteHostFromEnvironmentRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hostId'] === null) {
            ...
            if ((mb_strlen($this->container['hostId']) > 32)) {
                $invalidProperties[] = "invalid value for 'hostId', the character length must be smaller than or equal to 32.";
            }
            if ((mb_strlen($this->container['hostId']) < 32)) {
