...
class DeleteTemplateGroupCollectionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteTemplateGroupCollectionRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['groupCollectionId'] === null) {
            $invalidProperties[] = "'groupCollectionId' can't be null";
        }
