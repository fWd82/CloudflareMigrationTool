...
class ShowTakeOverAssetDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTakeOverAssetDetailsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xSdkDate  使用AK/SK方式认证时必选，请求的发生时间。
    * sourceBucket  媒资原始输入存放的桶。
    * sourceObject  媒资原始输入的objectKey。
    *
    * @var string[]
    */
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['sourceBucket'] = isset($data['sourceBucket']) ? $data['sourceBucket'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sourceBucket'] === null) {
            $invalidProperties[] = "'sourceBucket' can't be null";
        }
        if ($this->container['sourceObject'] === null) {
            $invalidProperties[] = "'sourceObject' can't be null";
        }
    ...
    */
    ...
    {
        return $this->container['sourceBucket'];
    }
    ...
    */
    ...
    {
        $this->container['sourceBucket'] = $sourceBucket;
        return $this;
    }
