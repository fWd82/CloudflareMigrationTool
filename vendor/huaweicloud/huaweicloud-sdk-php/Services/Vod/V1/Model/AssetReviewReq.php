...
class AssetReviewReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssetReviewReq';
    ...
    *  review
    *
    * @return \HuaweiCloud\SDK\Vod\V1\Model\Review
    */
    ...
    * Sets review
    *
    * @param \HuaweiCloud\SDK\Vod\V1\Model\Review $review review
    *
    * @return $this
    */
