...
class PublishAssetsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PublishAssetsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * assetInfoArray  发布的媒资信息。
    *
    * @var string[]
    */
    ...
    * Sets assetInfoArray
    *
    * @param \HuaweiCloud\SDK\Vod\V1\Model\AssetInfo[]|null $assetInfoArray 发布的媒资信息。
    *
    * @return $this
    */
