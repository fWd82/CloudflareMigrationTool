...
class ListDomainLogsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDomainLogsRequest';
    ...
    * Sets pageSize
    *
    * @param int|null $pageSize 每页显示日志数量。
    *
    * @return $this
    */
    ...
    * Sets pageNumber
    *
    * @param int|null $pageNumber 当前页数。
    *
    * @return $this
    */
