...
class ListTranscodeTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * groupId  模板id
    * isDefault  是否默认
    * offset  偏移量。默认为0。指定group_id时该参数无效。<br/>
    * limit  每页记录数。默认为10，范围[1,100]。指定group_id时该参数无效。<br/>
    * queryString  按照模板名和描述模糊查询。指定group_id时该参数无效。<br/>
    *
    * @var string[]
    */
    ...
    * Sets groupId
    *
    * @param string|null $groupId 模板id
    *
    * @return $this
    */
    ...
    * Sets offset
    *
    * @param int|null $offset 偏移量。默认为0。指定group_id时该参数无效。<br/>
    *
    * @return $this
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 每页记录数。默认为10，范围[1,100]。指定group_id时该参数无效。<br/>
    *
    * @return $this
    */
    ...
    * Sets queryString
    *
    * @param string|null $queryString 按照模板名和描述模糊查询。指定group_id时该参数无效。<br/>
    *
    * @return $this
    */
