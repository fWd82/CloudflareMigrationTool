...
class CreateAssetProcessTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAssetProcessTaskRequest';
    ...
    */
    protected static $openAPITypes = [
            'xSdkDate' => 'string',
            'body' => '\HuaweiCloud\SDK\Vod\V1\Model\AssetProcessReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vod\V1\Model\AssetProcessReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vod\V1\Model\AssetProcessReq|null $body body
    *
    * @return $this
    */
