...
class DeleteAssetsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteAssetsRequest';
    ...
    * Sets assetId
    *
    * @param string[] $assetId 媒资ID，支持一次删除多个媒资，批量删除时以逗号分隔。
    *
    * @return $this
    */
