...
class PublishAssetFromObsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PublishAssetFromObsRequest';
    ...
    */
    protected static $openAPITypes = [
            'xSdkDate' => 'string',
            'body' => '\HuaweiCloud\SDK\Vod\V1\Model\PublishAssetFromObsReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vod\V1\Model\PublishAssetFromObsReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vod\V1\Model\PublishAssetFromObsReq|null $body body
    *
    * @return $this
    */
