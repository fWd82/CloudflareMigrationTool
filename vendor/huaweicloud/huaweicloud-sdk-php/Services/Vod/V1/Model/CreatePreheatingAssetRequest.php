...
class CreatePreheatingAssetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePreheatingAssetRequest';
    ...
    */
    protected static $openAPITypes = [
            'xSdkDate' => 'string',
            'body' => '\HuaweiCloud\SDK\Vod\V1\Model\CreatePreheatingAssetReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vod\V1\Model\CreatePreheatingAssetReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vod\V1\Model\CreatePreheatingAssetReq|null $body body
    *
    * @return $this
    */
