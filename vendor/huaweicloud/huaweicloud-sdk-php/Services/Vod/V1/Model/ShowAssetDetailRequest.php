...
class ShowAssetDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAssetDetailRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xSdkDate  使用AK/SK方式认证时必选，请求的发生时间。
    * assetId  媒资ID。
    * categories  查询的信息类型。 - 为空时表示查询所有信息。 - 不为空时支持同时查询一个或者多个类型的信息，取值如下： - - base_info：媒资基本信息。 - - transcode_info：转码结果信息。 - - thumbnail_info：截图结果信息。 - - review_info：审核结果信息。
    *
    * @var string[]
    */
    ...
    */
    ...
    const CATEGORIES_BASE_INFO = 'base_info';
    const CATEGORIES_TRANSCODE_INFO = 'transcode_info';
    const CATEGORIES_THUMBNAIL_INFO = 'thumbnail_info';
    const CATEGORIES_REVIEW_INFO = 'review_info';
    ...
    */
    ...
    {
        return [
            self::CATEGORIES_BASE_INFO,
            self::CATEGORIES_TRANSCODE_INFO,
            self::CATEGORIES_THUMBNAIL_INFO,
            self::CATEGORIES_REVIEW_INFO,
        ];
    }
    ...
    * Sets categories
    *
    * @param string[]|null $categories 查询的信息类型。 - 为空时表示查询所有信息。 - 不为空时支持同时查询一个或者多个类型的信息，取值如下： - - base_info：媒资基本信息。 - - transcode_info：转码结果信息。 - - thumbnail_info：截图结果信息。 - - review_info：审核结果信息。
    *
    * @return $this
    */
