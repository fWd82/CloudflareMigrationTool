...
class ShowTakeOverTaskDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTakeOverTaskDetailsRequest';
    ...
    * Sets size
    *
    * @param int|null $size 每页记录数。  默认10，范围[1,100]
    *
    * @return $this
    */
