...
class UnpublishAssetsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UnpublishAssetsRequest';
    ...
    */
    protected static $openAPITypes = [
            'xSdkDate' => 'string',
            'body' => '\HuaweiCloud\SDK\Vod\V1\Model\PublishAssetReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vod\V1\Model\PublishAssetReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vod\V1\Model\PublishAssetReq|null $body body
    *
    * @return $this
    */
