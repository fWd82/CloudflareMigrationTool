...
class ListAssetCategoryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAssetCategoryRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xSdkDate  使用AK/SK方式认证时必选，请求的发生时间。
    * id  视频分类ID。  若设置为0，则查询所有一级分类。
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param int $id 视频分类ID。  若设置为0，则查询所有一级分类。
    *
    * @return $this
    */
