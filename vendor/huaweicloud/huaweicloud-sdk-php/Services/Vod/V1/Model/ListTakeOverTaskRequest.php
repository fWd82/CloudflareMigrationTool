...
class ListTakeOverTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTakeOverTaskRequest';
    ...
    * taskId  任务ID。
    * page  分页编号，默认为0。
    * size  每页记录数。  默认10，范围[1,100]，指定task_id时该参数无效。
    *
    * @var string[]
    */
    ...
    * Sets size
    *
    * @param int|null $size 每页记录数。  默认10，范围[1,100]，指定task_id时该参数无效。
    *
    * @return $this
    */
