...
class CdnLog implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CdnLog';
    ...
    * Sets startTime
    *
    * @param string|null $startTime 查询起始时间。
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param string|null $endTime 查询结束时间。
    *
    * @return $this
    */
    ...
    * Sets size
    *
    * @param int|null $size 日志大小。  单位：byte。
    *
    * @return $this
    */
