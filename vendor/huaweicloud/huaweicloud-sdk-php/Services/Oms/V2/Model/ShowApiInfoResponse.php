...
class ShowApiInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowApiInfoResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  版本号，例如v1。
    * links  链接地址信息。
    * status  版本状态。  取值“CURRENT”，表示该版本为主推版本。  取值\"SUPPORTED\"，表示支持该版本。  取值“DEPRECATED”，表示为废弃版本，存在后续删除的可能。
    * updated  版本更新时间。  格式为“yyyy-mm-ddThh:mm:ssZ”。  其中，T指某个时间的开始；Z指UTC时间。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'links' => '\HuaweiCloud\SDK\Oms\V2\Model\Link[]',
            'status' => 'string',
            'updated' => 'string'
    ];
    ...
    *  链接地址信息。
    *
    * @return \HuaweiCloud\SDK\Oms\V2\Model\Link[]|null
    */
    ...
    * Sets links
    *
    * @param \HuaweiCloud\SDK\Oms\V2\Model\Link[]|null $links 链接地址信息。
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status 版本状态。  取值“CURRENT”，表示该版本为主推版本。  取值\"SUPPORTED\"，表示支持该版本。  取值“DEPRECATED”，表示为废弃版本，存在后续删除的可能。
    *
    * @return $this
    */
    ...
    * Sets updated
    *
    * @param string|null $updated 版本更新时间。  格式为“yyyy-mm-ddThh:mm:ssZ”。  其中，T指某个时间的开始；Z指UTC时间。
    *
    * @return $this
    */
