...
class CreateTaskGroupReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTaskGroupReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * srcNode  srcNode
    * description  任务组描述，不能超过255个字符，且不能包含^<>&\"'等特殊字符。
    * dstNode  dstNode
    ...
    */
    protected static $openAPITypes = [
            'srcNode' => '\HuaweiCloud\SDK\Oms\V2\Model\TaskGroupSrcNode',
            'description' => 'string',
            'dstNode' => '\HuaweiCloud\SDK\Oms\V2\Model\TaskGroupDstNode',
    ...
    *  srcNode
    *
    * @return \HuaweiCloud\SDK\Oms\V2\Model\TaskGroupSrcNode
    */
    ...
    * Sets srcNode
    *
    * @param \HuaweiCloud\SDK\Oms\V2\Model\TaskGroupSrcNode $srcNode srcNode
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string|null $description 任务组描述，不能超过255个字符，且不能包含^<>&\"'等特殊字符。
    *
    * @return $this
    */
    ...
    *  dstNode
    *
    * @return \HuaweiCloud\SDK\Oms\V2\Model\TaskGroupDstNode
    */
    ...
    * Sets dstNode
    *
    * @param \HuaweiCloud\SDK\Oms\V2\Model\TaskGroupDstNode $dstNode dstNode
    *
    * @return $this
    */
