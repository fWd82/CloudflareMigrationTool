...
class ListTasksResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'tasks' => '\HuaweiCloud\SDK\Oms\V2\Model\TaskResp[]',
            'count' => 'int'
    ];
    ...
    *  查询的任务详情
    *
    * @return \HuaweiCloud\SDK\Oms\V2\Model\TaskResp[]|null
    */
    ...
    * Sets tasks
    *
    * @param \HuaweiCloud\SDK\Oms\V2\Model\TaskResp[]|null $tasks 查询的任务详情
    *
    * @return $this
    */
    ...
    * Sets count
    *
    * @param int|null $count 满足查询条件的任务总数
    *
    * @return $this
    */
