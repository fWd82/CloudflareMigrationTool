...
class ShowSyncTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSyncTaskResponse';
    ...
    */
    protected static $attributeMap = [
            ...
            'monthlyFailureObject' => 'monthly_failure_object',
    ...
    */
    protected static $setters = [
            ...
            'monthlyFailureObject' => 'setMonthlyFailureObject',
    ...
    */
    protected static $getters = [
            ...
            'monthlyFailureObject' => 'getMonthlyFailureObject',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['monthlyFailureObject'] = isset($data['monthlyFailureObject']) ? $data['monthlyFailureObject'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['monthlyAcceptanceRequest']) && ($this->container['monthlyAcceptanceRequest'] > 9223372036854775807)) {
                $invalidProperties[] = "invalid value for 'monthlyAcceptanceRequest', must be smaller than or equal to 9223372036854775807.";
            }
            if (!is_null($this->container['monthlyAcceptanceRequest']) && ($this->container['monthlyAcceptanceRequest'] < 0)) {
                $invalidProperties[] = "invalid value for 'monthlyAcceptanceRequest', must be bigger than or equal to 0.";
            }
            if (!is_null($this->container['monthlySuccessObject']) && ($this->container['monthlySuccessObject'] > 9223372036854775807)) {
                $invalidProperties[] = "invalid value for 'monthlySuccessObject', must be smaller than or equal to 9223372036854775807.";
            }
            if (!is_null($this->container['monthlySuccessObject']) && ($this->container['monthlySuccessObject'] < 0)) {
                $invalidProperties[] = "invalid value for 'monthlySuccessObject', must be bigger than or equal to 0.";
            }
            if (!is_null($this->container['monthlyFailureObject']) && ($this->container['monthlyFailureObject'] > 9223372036854775807)) {
                $invalidProperties[] = "invalid value for 'monthlyFailureObject', must be smaller than or equal to 9223372036854775807.";
            }
            if (!is_null($this->container['monthlyFailureObject']) && ($this->container['monthlyFailureObject'] < 0)) {
                $invalidProperties[] = "invalid value for 'monthlyFailureObject', must be bigger than or equal to 0.";
            }
            if (!is_null($this->container['monthlySkipObject']) && ($this->container['monthlySkipObject'] > 9223372036854775807)) {
                $invalidProperties[] = "invalid value for 'monthlySkipObject', must be smaller than or equal to 9223372036854775807.";
            }
            if (!is_null($this->container['monthlySkipObject']) && ($this->container['monthlySkipObject'] < 0)) {
                $invalidProperties[] = "invalid value for 'monthlySkipObject', must be bigger than or equal to 0.";
            }
            if (!is_null($this->container['monthlySize']) && ($this->container['monthlySize'] > 9223372036854775807)) {
                $invalidProperties[] = "invalid value for 'monthlySize', must be smaller than or equal to 9223372036854775807.";
            }
            if (!is_null($this->container['monthlySize']) && ($this->container['monthlySize'] < 0)) {
                $invalidProperties[] = "invalid value for 'monthlySize', must be bigger than or equal to 0.";
            }
    ...
    */
    ...
    /**
    * Gets monthlyAcceptanceRequest
    *  当月接收同步请求对象数
    *
    * @return int|null
    */
    public function getMonthlyAcceptanceRequest()
    {
        return $this->container['monthlyAcceptanceRequest'];
    }

    /**
    * Sets monthlyAcceptanceRequest
    *
    * @param int|null $monthlyAcceptanceRequest 当月接收同步请求对象数
    *
    * @return $this
    */
    public function setMonthlyAcceptanceRequest($monthlyAcceptanceRequest)
    {
        $this->container['monthlyAcceptanceRequest'] = $monthlyAcceptanceRequest;
        return $this;
    }

    /**
    * Gets monthlySuccessObject
    *  当月同步成功对象数
    *
    * @return int|null
    */
    public function getMonthlySuccessObject()
    {
        return $this->container['monthlySuccessObject'];
    }

    /**
    * Sets monthlySuccessObject
    *
    * @param int|null $monthlySuccessObject 当月同步成功对象数
    *
    * @return $this
    */
    public function setMonthlySuccessObject($monthlySuccessObject)
    {
        $this->container['monthlySuccessObject'] = $monthlySuccessObject;
        return $this;
    }

    /**
    * Gets monthlyFailureObject
    *  当月同步失败对象数
    *
    * @return int|null
    */
    public function getMonthlyFailureObject()
    {
        return $this->container['monthlyFailureObject'];
    }

    /**
    * Sets monthlyFailureObject
    *
    * @param int|null $monthlyFailureObject 当月同步失败对象数
    *
    * @return $this
    */
    public function setMonthlyFailureObject($monthlyFailureObject)
    {
        $this->container['monthlyFailureObject'] = $monthlyFailureObject;
        return $this;
    }

    /**
    * Gets monthlySkipObject
    *  当月同步忽略对象数
    *
    * @return int|null
    */
    public function getMonthlySkipObject()
    {
        return $this->container['monthlySkipObject'];
    }

    /**
    * Sets monthlySkipObject
    *
    * @param int|null $monthlySkipObject 当月同步忽略对象数
    *
    * @return $this
    */
    public function setMonthlySkipObject($monthlySkipObject)
    {
        $this->container['monthlySkipObject'] = $monthlySkipObject;
        return $this;
    }
    ...
    * @return int|null
    */
    public function getMonthlySize()
    {
        return $this->container['monthlySize'];
    }

    /**
    * Sets monthlySize
    *
    * @param int|null $monthlySize 当月同步对象容量大小（Byte）。
    *
    * @return $this
    */
    public function setMonthlySize($monthlySize)
    {
        $this->container['monthlySize'] = $monthlySize;
        return $this;
    }
