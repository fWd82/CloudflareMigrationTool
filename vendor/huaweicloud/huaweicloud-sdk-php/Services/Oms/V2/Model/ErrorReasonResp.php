...
class ErrorReasonResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ErrorReasonResp';
    ...
    * Sets errorCode
    *
    * @param string|null $errorCode 迁移失败的错误码。
    *
    * @return $this
    */
    ...
    * Sets errorMsg
    *
    * @param string|null $errorMsg 迁移失败的原因。
    *
    * @return $this
    */
