...
class CreateSyncEventsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSyncEventsRequest';
    ...
    */
    protected static $openAPITypes = [
            'syncTaskId' => 'string',
            'body' => '\HuaweiCloud\SDK\Oms\V2\Model\SyncObjectReq'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['syncTaskId'] === null) {
            ...
            if ((mb_strlen($this->container['syncTaskId']) > 1024)) {
                $invalidProperties[] = "invalid value for 'syncTaskId', the character length must be smaller than or equal to 1024.";
            }
            if ((mb_strlen($this->container['syncTaskId']) < 1)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Oms\V2\Model\SyncObjectReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Oms\V2\Model\SyncObjectReq|null $body body
    *
    * @return $this
    */
