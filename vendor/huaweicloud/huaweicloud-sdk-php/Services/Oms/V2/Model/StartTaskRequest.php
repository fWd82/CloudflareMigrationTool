...
class StartTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StartTaskRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Oms\V2\Model\StartTaskReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Oms\V2\Model\StartTaskReq|null $body body
    *
    * @return $this
    */
