...
class SrcNodeResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SrcNodeResp';
    ...
    */
    ...
    const CLOUD_TYPE_HUAWEI_CLOUD = 'HuaweiCloud';
    const CLOUD_TYPE_QING_CLOUD = 'QingCloud';
    const CLOUD_TYPE_KINGSOFT_CLOUD = 'KingsoftCloud';
    ...
    */
    public function getCloudTypeAllowableValues()
    {
        return [
            ...
            self::CLOUD_TYPE_HUAWEI_CLOUD,
            self::CLOUD_TYPE_QING_CLOUD,
            self::CLOUD_TYPE_KINGSOFT_CLOUD,
    ...
    * Sets objectKey
    *
    * @param string[]|null $objectKey 任务类型为对象迁移任务时，表示待迁移对象名称； 任务类型为前缀迁移任务时，表示待迁移前缀。
    *
    * @return $this
    */
