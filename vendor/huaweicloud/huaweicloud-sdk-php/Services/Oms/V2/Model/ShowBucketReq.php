...
class ShowBucketReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBucketReq';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['filePath'] === null) {
            ...
            if ((mb_strlen($this->container['filePath']) > 1023)) {
                $invalidProperties[] = "invalid value for 'filePath', the character length must be smaller than or equal to 1023.";
            }
            if ((mb_strlen($this->container['filePath']) < 0)) {
        ...
        if ($this->container['behindFilename'] === null) {
            $invalidProperties[] = "'behindFilename' can't be null";
        }
            if ((mb_strlen($this->container['behindFilename']) > 1024)) {
                $invalidProperties[] = "invalid value for 'behindFilename', the character length must be smaller than or equal to 1024.";
            }
            if ((mb_strlen($this->container['behindFilename']) < 0)) {
                $invalidProperties[] = "invalid value for 'behindFilename', the character length must be bigger than or equal to 0.";
            }
    ...
    * Sets filePath
    *
    * @param string $filePath 目标桶中需要查询的对象文件路径，/结尾
    *
    * @return $this
    */
    ...
    * Sets ak
    *
    * @param string|null $ak 源端桶的AK（最大长度100个字符）
    *
    * @return $this
    */
    ...
    * Sets sk
    *
    * @param string|null $sk 源端桶的SK（最大长度100个字符）
    *
    * @return $this
    */
    ...
    * @return string
    */
    public function getBehindFilename()
    {
        return $this->container['behindFilename'];
    }

    /**
    * Sets behindFilename
    *
    * @param string $behindFilename 分页信息，当前页最后一个对象名称（偏移量）
    *
    * @return $this
    */
    public function setBehindFilename($behindFilename)
    {
        $this->container['behindFilename'] = $behindFilename;
        return $this;
    }
