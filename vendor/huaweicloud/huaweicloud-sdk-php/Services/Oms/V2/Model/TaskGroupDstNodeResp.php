...
class TaskGroupDstNodeResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TaskGroupDstNodeResp';
    ...
    * Sets region
    *
    * @param string|null $region 目的端桶所处的区域。
    *
    * @return $this
    */
