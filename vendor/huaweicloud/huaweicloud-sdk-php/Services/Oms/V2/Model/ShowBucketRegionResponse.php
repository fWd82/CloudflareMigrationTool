...
class ShowBucketRegionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBucketRegionResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  region ID
    * name  region 名称
    * support  此region是否支持迁移
    *
    * @var string[]
    */
    ...
    * Sets name
    *
    * @param string|null $name region 名称
    *
    * @return $this
    */
    ...
    * Sets support
    *
    * @param bool|null $support 此region是否支持迁移
    *
    * @return $this
    */
