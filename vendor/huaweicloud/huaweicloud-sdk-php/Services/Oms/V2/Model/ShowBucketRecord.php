...
class ShowBucketRecord implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBucketRecord';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  对象名
    * size  对象大小，若对象无size属性，则返回--
    *
    * @var string[]
    */
    ...
    * Sets size
    *
    * @param string|null $size 对象大小，若对象无size属性，则返回--
    *
    * @return $this
    */
