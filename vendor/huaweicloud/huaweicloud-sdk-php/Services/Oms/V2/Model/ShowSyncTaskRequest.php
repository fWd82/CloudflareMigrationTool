...
class ShowSyncTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSyncTaskRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * syncTaskId  同步任务ID。
    * queryTime  查询同步任务详情的时间（毫秒），依据该值返回所在月份的统计数据。
    *
    * @var string[]
    */
