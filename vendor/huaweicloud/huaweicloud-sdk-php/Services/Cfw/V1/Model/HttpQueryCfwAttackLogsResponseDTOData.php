...
class HttpQueryCfwAttackLogsResponseDTOData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HttpQueryCfwAttackLogsResponseDTO_data';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'limit' => 'int',
            'records' => '\HuaweiCloud\SDK\Cfw\V1\Model\HttpQueryCfwAttackLogsResponseDTODataRecords[]'
    ];
