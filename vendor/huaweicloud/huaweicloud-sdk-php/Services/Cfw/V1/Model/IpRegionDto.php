...
class IpRegionDto implements ModelInterface, ArrayAccess
{
    ...
    * descriptionCn  中文描述
    * descriptionEn  英文描述
    * regionType  区域类型，0表示国家，1表示省份，2表示大洲
    *
    * @var string[]
    */
    ...
    * Sets descriptionCn
    *
    * @param string|null $descriptionCn 中文描述
    *
    * @return $this
    */
    ...
    * Sets descriptionEn
    *
    * @param string|null $descriptionEn 英文描述
    *
    * @return $this
    */
    ...
    * Sets regionType
    *
    * @param int|null $regionType 区域类型，0表示国家，1表示省份，2表示大洲
    *
    * @return $this
    */
