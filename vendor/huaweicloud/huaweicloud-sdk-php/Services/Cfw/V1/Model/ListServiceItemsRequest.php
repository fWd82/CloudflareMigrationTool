...
class ListServiceItemsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListServiceItemsRequest';
    ...
    * Sets keyWord
    *
    * @param string|null $keyWord 查询字段
    *
    * @return $this
    */
