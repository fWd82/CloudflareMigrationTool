...
class ChangeIpsProtectModeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeIpsProtectModeRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'fwInstanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cfw\V1\Model\IpsProtectDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cfw\V1\Model\IpsProtectDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cfw\V1\Model\IpsProtectDTO|null $body body
    *
    * @return $this
    */
