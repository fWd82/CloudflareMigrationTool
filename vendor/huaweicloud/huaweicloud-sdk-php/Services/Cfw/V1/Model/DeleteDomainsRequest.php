...
class DeleteDomainsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDomainsRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cfw\V1\Model\DeleteDomainDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cfw\V1\Model\DeleteDomainDto|null $body body
    *
    * @return $this
    */
