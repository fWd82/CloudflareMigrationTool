...
class AddServiceItemsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddServiceItemsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'fwInstanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cfw\V1\Model\AddServiceItemsUsingPOSTRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cfw\V1\Model\AddServiceItemsUsingPOSTRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cfw\V1\Model\AddServiceItemsUsingPOSTRequestBody|null $body body
    *
    * @return $this
    */
