...
class AddBlackWhiteListRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddBlackWhiteListRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'fwInstanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cfw\V1\Model\AddBlackWhiteListDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cfw\V1\Model\AddBlackWhiteListDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cfw\V1\Model\AddBlackWhiteListDto|null $body body
    *
    * @return $this
    */
