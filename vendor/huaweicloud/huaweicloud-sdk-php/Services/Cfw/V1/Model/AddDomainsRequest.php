...
class AddDomainsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddDomainsRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cfw\V1\Model\AddDomainListDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cfw\V1\Model\AddDomainListDto|null $body body
    *
    * @return $this
    */
