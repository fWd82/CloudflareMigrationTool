...
class ListAclRuleHitCountRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAclRuleHitCountRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cfw\V1\Model\ListRuleHitCountDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cfw\V1\Model\ListRuleHitCountDto|null $body body
    *
    * @return $this
    */
