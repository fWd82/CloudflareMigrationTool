...
class ServiceItemListResponseDtoDataRecords implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ServiceItemListResponseDto_data_records';
