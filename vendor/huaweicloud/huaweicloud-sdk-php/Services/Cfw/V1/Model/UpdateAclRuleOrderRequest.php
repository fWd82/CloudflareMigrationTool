...
class UpdateAclRuleOrderRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAclRuleOrderRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'fwInstanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cfw\V1\Model\OrderRuleAclDto'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cfw\V1\Model\OrderRuleAclDto|null $body body
    *
    * @return $this
    */
