...
class AllowedAddressPair implements ModelInterface, ArrayAccess
{
    ...
    * ipAddress  功能说明：IP地址约束：不支持0.0.0.0如果allowed_address_pairs配置地址池较大的CIDR（掩码小于24位），建议为该port配置一个单独的安全组。
    * macAddress  功能说明：MAC地址
    *
    * @var string[]
    */
    ...
    * Sets ipAddress
    *
    * @param string|null $ipAddress 功能说明：IP地址约束：不支持0.0.0.0如果allowed_address_pairs配置地址池较大的CIDR（掩码小于24位），建议为该port配置一个单独的安全组。
    *
    * @return $this
    */
    ...
    * Sets macAddress
    *
    * @param string|null $macAddress 功能说明：MAC地址
    *
    * @return $this
    */
