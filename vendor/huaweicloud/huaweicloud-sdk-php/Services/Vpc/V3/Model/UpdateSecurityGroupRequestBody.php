...
class UpdateSecurityGroupRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'securityGroup' => '\HuaweiCloud\SDK\Vpc\V3\Model\UpdateSecurityGroupOption'
    ];
    ...
    * Sets securityGroup
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\UpdateSecurityGroupOption $securityGroup securityGroup
    *
    * @return $this
    */
