...
class FirewallAssociation implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FirewallAssociation';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * virsubnetId  功能说明：ACL绑定的子网ID
    *
    * @var string[]
    */
    ...
    * Sets virsubnetId
    *
    * @param string $virsubnetId 功能说明：ACL绑定的子网ID
    *
    * @return $this
    */
