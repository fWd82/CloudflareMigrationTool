...
class UpdateTrafficMirrorFilterRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTrafficMirrorFilterRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'trafficMirrorFilter' => '\HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorFilterOption'
    ];
    ...
    *  trafficMirrorFilter
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorFilterOption
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorFilterOption $trafficMirrorFilter trafficMirrorFilter
    *
    * @return $this
    */
