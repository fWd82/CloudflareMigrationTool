...
class AddFirewallRulesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddFirewallRulesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * firewallId  网络ACL的唯一标识
    * projectId  项目ID
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'firewallId' => 'string',
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpc\V3\Model\AddFirewallRulesRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\AddFirewallRulesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\AddFirewallRulesRequestBody|null $body body
    *
    * @return $this
    */
