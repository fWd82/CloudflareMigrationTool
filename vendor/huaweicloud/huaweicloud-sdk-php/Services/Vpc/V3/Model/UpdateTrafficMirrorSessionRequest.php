...
class UpdateTrafficMirrorSessionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTrafficMirrorSessionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorSessionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorSessionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorSessionRequestBody|null $body body
    *
    * @return $this
    */
