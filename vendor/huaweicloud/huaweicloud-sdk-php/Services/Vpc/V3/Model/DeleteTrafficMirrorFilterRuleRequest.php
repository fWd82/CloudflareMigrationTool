...
class DeleteTrafficMirrorFilterRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteTrafficMirrorFilterRuleRequest';
