...
class IpExtraSetOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IpExtraSetOption';
    ...
    * Sets remarks
    *
    * @param string|null $remarks 功能说明：IP的备注信息 取值范围：0-255个字符，不能包含“<”和“>”。
    *
    * @return $this
    */
