...
class CreateSubNetworkInterfaceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'subNetworkInterface' => '\HuaweiCloud\SDK\Vpc\V3\Model\CreateSubNetworkInterfaceOption'
    ];
    ...
    *  subNetworkInterface
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\CreateSubNetworkInterfaceOption
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\CreateSubNetworkInterfaceOption $subNetworkInterface subNetworkInterface
    *
    * @return $this
    */
