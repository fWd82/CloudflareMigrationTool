...
class FirewallInsertRuleItemOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FirewallInsertRuleItemOption';
    ...
    * Sets protocol
    *
    * @param string $protocol 功能说明：ACL规则协议 取值范围：支持tcp,udp,icmp,icmpv6或者协议号（0-255），any表示全部协议
    *
    * @return $this
    */
