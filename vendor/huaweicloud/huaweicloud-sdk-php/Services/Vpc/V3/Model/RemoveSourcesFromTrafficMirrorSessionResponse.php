...
class RemoveSourcesFromTrafficMirrorSessionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemoveSourcesFromTrafficMirrorSessionResponse';
    ...
    */
    protected static $openAPITypes = [
            'trafficMirrorSession' => '\HuaweiCloud\SDK\Vpc\V3\Model\TrafficMirrorSession',
            'requestId' => 'string'
    ];
    ...
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\TrafficMirrorSession|null $trafficMirrorSession trafficMirrorSession
    *
    * @return $this
    */
