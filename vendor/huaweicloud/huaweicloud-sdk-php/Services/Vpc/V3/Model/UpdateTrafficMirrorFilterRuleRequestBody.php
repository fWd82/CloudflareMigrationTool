...
class UpdateTrafficMirrorFilterRuleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTrafficMirrorFilterRuleRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'trafficMirrorFilterRule' => '\HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorFilterRuleOption'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorFilterRuleOption
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorFilterRuleOption $trafficMirrorFilterRule trafficMirrorFilterRule
    *
    * @return $this
    */
