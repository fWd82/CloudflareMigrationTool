...
class FirewallDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FirewallDetail';
    ...
    *  功能说明：ACL入方向规则列表
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\FirewallRuleDetail[]
    */
    ...
    * Sets ingressRules
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\FirewallRuleDetail[] $ingressRules 功能说明：ACL入方向规则列表
    *
    * @return $this
    */
    ...
    * Sets egressRules
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\FirewallRuleDetail[] $egressRules 功能说明：ACL出方向规则列表
    *
    * @return $this
    */
