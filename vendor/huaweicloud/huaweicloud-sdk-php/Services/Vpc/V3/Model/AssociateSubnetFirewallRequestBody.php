...
class AssociateSubnetFirewallRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateSubnetFirewallRequestBody';
    ...
    * Sets subnets
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\FirewallAssociation[] $subnets 绑定ACL的子网列表
    *
    * @return $this
    */
