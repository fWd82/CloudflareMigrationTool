...
class AddSourcesToTrafficMirrorSessionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddSourcesToTrafficMirrorSessionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Vpc\V3\Model\AddSourcesToTrafficMirrorSessionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\AddSourcesToTrafficMirrorSessionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\AddSourcesToTrafficMirrorSessionRequestBody|null $body body
    *
    * @return $this
    */
