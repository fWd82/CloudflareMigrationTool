...
class BatchCreateSecurityGroupRulesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateSecurityGroupRulesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * securityGroupRules  批量创建安全组规则的响应体
    * requestId  请求ID
    *
    * @var string[]
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\SecurityGroupRule[]|null $securityGroupRules 批量创建安全组规则的响应体
    *
    * @return $this
    */
