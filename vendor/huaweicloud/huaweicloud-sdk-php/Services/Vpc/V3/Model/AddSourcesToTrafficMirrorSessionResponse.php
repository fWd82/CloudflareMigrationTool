...
class AddSourcesToTrafficMirrorSessionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddSourcesToTrafficMirrorSessionResponse';
