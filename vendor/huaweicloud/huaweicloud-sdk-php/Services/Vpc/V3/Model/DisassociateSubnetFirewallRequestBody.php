...
class DisassociateSubnetFirewallRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateSubnetFirewallRequestBody';
    ...
    * Sets subnets
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\FirewallAssociation[] $subnets 解绑ACL的子网列表
    *
    * @return $this
    */
