...
class UpdateTrafficMirrorFilterRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTrafficMirrorFilterRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  项目ID
    * trafficMirrorFilterId  流量镜像筛选条件ID
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorFilterRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorFilterRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorFilterRequestBody|null $body body
    *
    * @return $this
    */
