...
class UpdateTrafficMirrorFilterRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTrafficMirrorFilterRuleRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  项目ID
    * trafficMirrorFilterRuleId  流量镜像筛选条件规则ID
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorFilterRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorFilterRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\UpdateTrafficMirrorFilterRuleRequestBody|null $body body
    *
    * @return $this
    */
