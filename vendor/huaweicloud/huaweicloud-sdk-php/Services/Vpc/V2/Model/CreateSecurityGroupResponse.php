...
class CreateSecurityGroupResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'securityGroup' => '\HuaweiCloud\SDK\Vpc\V2\Model\SecurityGroup'
    ];
    ...
    *  securityGroup
    *
    * @return \HuaweiCloud\SDK\Vpc\V2\Model\SecurityGroup|null
    */
    ...
    * Sets securityGroup
    *
    * @param \HuaweiCloud\SDK\Vpc\V2\Model\SecurityGroup|null $securityGroup securityGroup
    *
    * @return $this
    */
