...
class CreatePrivateipRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'privateips' => '\HuaweiCloud\SDK\Vpc\V2\Model\CreatePrivateipOption[]'
    ];
    ...
    *  私有IP列表对象
    *
    * @return \HuaweiCloud\SDK\Vpc\V2\Model\CreatePrivateipOption[]
    */
    ...
    * Sets privateips
    *
    * @param \HuaweiCloud\SDK\Vpc\V2\Model\CreatePrivateipOption[] $privateips 私有IP列表对象
    *
    * @return $this
    */
