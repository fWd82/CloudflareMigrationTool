...
class CreateVpcResourceTagRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'vpcId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpc\V2\Model\CreateVpcResourceTagRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V2\Model\CreateVpcResourceTagRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V2\Model\CreateVpcResourceTagRequestBody|null $body body
    *
    * @return $this
    */
