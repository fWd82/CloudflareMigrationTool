...
class NeutronShowSecurityGroupRuleResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'securityGroupRule' => '\HuaweiCloud\SDK\Vpc\V2\Model\NeutronSecurityGroupRule'
    ];
    ...
    *
    * @param \HuaweiCloud\SDK\Vpc\V2\Model\NeutronSecurityGroupRule|null $securityGroupRule securityGroupRule
    *
    * @return $this
    */
