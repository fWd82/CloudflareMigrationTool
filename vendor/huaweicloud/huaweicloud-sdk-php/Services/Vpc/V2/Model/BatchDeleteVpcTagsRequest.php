...
class BatchDeleteVpcTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'vpcId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpc\V2\Model\BatchDeleteVpcTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V2\Model\BatchDeleteVpcTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V2\Model\BatchDeleteVpcTagsRequestBody|null $body body
    *
    * @return $this
    */
