...
class ShowSecurityGroupRuleResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'securityGroupRule' => '\HuaweiCloud\SDK\Vpc\V2\Model\SecurityGroupRule'
    ];
    ...
    *
    * @param \HuaweiCloud\SDK\Vpc\V2\Model\SecurityGroupRule|null $securityGroupRule securityGroupRule
    *
    * @return $this
    */
