...
class CreateSubnetTagRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'subnetId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpc\V2\Model\CreateSubnetTagRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V2\Model\CreateSubnetTagRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V2\Model\CreateSubnetTagRequestBody|null $body body
    *
    * @return $this
    */
