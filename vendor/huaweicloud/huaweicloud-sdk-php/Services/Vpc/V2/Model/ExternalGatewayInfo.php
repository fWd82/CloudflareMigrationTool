...
class ExternalGatewayInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExternalGatewayInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * enableSnat  功能说明：是否启用SNAT 取值范围：true、false；默认为false。
    * networkId  外部网络的ID。
    *
    * @var string[]
    */
    ...
    * Sets enableSnat
    *
    * @param bool|null $enableSnat 功能说明：是否启用SNAT 取值范围：true、false；默认为false。
    *
    * @return $this
    */
    ...
    * Sets networkId
    *
    * @param string|null $networkId 外部网络的ID。
    *
    * @return $this
    */
