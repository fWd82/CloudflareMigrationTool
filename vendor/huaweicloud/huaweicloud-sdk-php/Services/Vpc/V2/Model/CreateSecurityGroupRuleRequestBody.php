...
class CreateSecurityGroupRuleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'securityGroupRule' => '\HuaweiCloud\SDK\Vpc\V2\Model\CreateSecurityGroupRuleOption'
    ];
    ...
    *  securityGroupRule
    *
    * @return \HuaweiCloud\SDK\Vpc\V2\Model\CreateSecurityGroupRuleOption
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Vpc\V2\Model\CreateSecurityGroupRuleOption $securityGroupRule securityGroupRule
    *
    * @return $this
    */
