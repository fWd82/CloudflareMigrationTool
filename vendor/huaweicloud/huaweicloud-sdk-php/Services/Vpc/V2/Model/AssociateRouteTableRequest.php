...
class AssociateRouteTableRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'routetableId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpc\V2\Model\RoutetableAssociateReqbody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V2\Model\RoutetableAssociateReqbody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V2\Model\RoutetableAssociateReqbody|null $body body
    *
    * @return $this
    */
