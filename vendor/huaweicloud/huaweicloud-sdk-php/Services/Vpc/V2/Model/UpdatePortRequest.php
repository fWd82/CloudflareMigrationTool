...
class UpdatePortRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'portId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpc\V2\Model\UpdatePortRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V2\Model\UpdatePortRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V2\Model\UpdatePortRequestBody|null $body body
    *
    * @return $this
    */
