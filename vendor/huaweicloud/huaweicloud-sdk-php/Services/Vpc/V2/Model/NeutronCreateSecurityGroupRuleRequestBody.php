...
class NeutronCreateSecurityGroupRuleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'securityGroupRule' => '\HuaweiCloud\SDK\Vpc\V2\Model\NeutronCreateSecurityGroupRuleOption'
    ];
    ...
    *  securityGroupRule
    *
    * @return \HuaweiCloud\SDK\Vpc\V2\Model\NeutronCreateSecurityGroupRuleOption
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Vpc\V2\Model\NeutronCreateSecurityGroupRuleOption $securityGroupRule securityGroupRule
    *
    * @return $this
    */
