...
class HostRoute implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HostRoute';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['nexthop']) && (mb_strlen($this->container['nexthop']) > 64)) {
                $invalidProperties[] = "invalid value for 'nexthop', the character length must be smaller than or equal to 64.";
            }
    ...
    * Sets destination
    *
    * @param string|null $destination 路由目的子网
    *
    * @return $this
    */
    ...
    * Sets nexthop
    *
    * @param string|null $nexthop 路由下一跳IP
    *
    * @return $this
    */
