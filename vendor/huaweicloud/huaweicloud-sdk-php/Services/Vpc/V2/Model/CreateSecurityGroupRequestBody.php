...
class CreateSecurityGroupRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'securityGroup' => '\HuaweiCloud\SDK\Vpc\V2\Model\CreateSecurityGroupOption'
    ];
    ...
    *  securityGroup
    *
    * @return \HuaweiCloud\SDK\Vpc\V2\Model\CreateSecurityGroupOption
    */
    ...
    * Sets securityGroup
    *
    * @param \HuaweiCloud\SDK\Vpc\V2\Model\CreateSecurityGroupOption $securityGroup securityGroup
    *
    * @return $this
    */
