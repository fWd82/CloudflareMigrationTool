...
class UpdateVpcPeeringRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'peeringId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpc\V2\Model\UpdateVpcPeeringRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V2\Model\UpdateVpcPeeringRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V2\Model\UpdateVpcPeeringRequestBody|null $body body
    *
    * @return $this
    */
