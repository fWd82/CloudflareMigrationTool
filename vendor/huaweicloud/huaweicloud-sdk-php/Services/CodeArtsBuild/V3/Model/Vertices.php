...
class Vertices implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Vertices';
    ...
    * Sets id
    *
    * @param string|null $id 子任务构建记录ID
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status 子任务执行状态
    *
    * @return $this
    */
    ...
    * Sets startTime
    *
    * @param string|null $startTime 子任务开始时间
    *
    * @return $this
    */
    ...
    * Sets finishTime
    *
    * @param string|null $finishTime 子任务结束时间
    *
    * @return $this
    */
    ...
    * Sets buildNo
    *
    * @param string|null $buildNo 子任务构建编号
    *
    * @return $this
    */
