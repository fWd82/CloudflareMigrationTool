...
class ShowHistoryDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowHistoryDetailsRequest';
    ...
    * Sets buildNumber
    *
    * @param int $buildNumber 构建任务的构建编号，从1开始，每次构建递增1
    *
    * @return $this
    */
