...
class UpdateBuildJobRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateBuildJobRequestBody';
    ...
    */
    protected static $openAPITypes = [
            ...
            'flavor' => 'string',
            'parameters' => '\HuaweiCloud\SDK\CodeArtsBuild\V3\Model\UpdateBuildJobParameter[]',
            'scms' => '\HuaweiCloud\SDK\CodeArtsBuild\V3\Model\UpdateBuildJobScm[]',
            'steps' => '\HuaweiCloud\SDK\CodeArtsBuild\V3\Model\UpdateBuildJobSteps[]',
            'hostType' => 'string',
    ...
    *  构建执行参数列表
    *
    * @return \HuaweiCloud\SDK\CodeArtsBuild\V3\Model\UpdateBuildJobParameter[]|null
    */
    ...
    * Sets parameters
    *
    * @param \HuaweiCloud\SDK\CodeArtsBuild\V3\Model\UpdateBuildJobParameter[]|null $parameters 构建执行参数列表
    *
    * @return $this
    */
    ...
    *  构建执行SCM
    *
    * @return \HuaweiCloud\SDK\CodeArtsBuild\V3\Model\UpdateBuildJobScm[]|null
    */
    ...
    * Sets scms
    *
    * @param \HuaweiCloud\SDK\CodeArtsBuild\V3\Model\UpdateBuildJobScm[]|null $scms 构建执行SCM
    *
    * @return $this
    */
    ...
    *  构建执行的步骤
    *
    * @return \HuaweiCloud\SDK\CodeArtsBuild\V3\Model\UpdateBuildJobSteps[]
    */
    ...
    * Sets steps
    *
    * @param \HuaweiCloud\SDK\CodeArtsBuild\V3\Model\UpdateBuildJobSteps[] $steps 构建执行的步骤
    *
    * @return $this
    */
