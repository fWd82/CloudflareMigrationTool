...
class ShowListHistoryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowListHistoryRequest';
    ...
    * Sets interval
    *
    * @param int $interval 距今天的时间区间（单位：天），interval小于等于30
    *
    * @return $this
    */
