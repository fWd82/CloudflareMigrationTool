...
class UninstallInstanceEipRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UninstallInstanceEipRequest';
    ...
    */
    protected static $openAPITypes = [
            'serverId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cbh\V2\Model\OperateEipRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cbh\V2\Model\OperateEipRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cbh\V2\Model\OperateEipRequestBody|null $body body
    *
    * @return $this
    */
