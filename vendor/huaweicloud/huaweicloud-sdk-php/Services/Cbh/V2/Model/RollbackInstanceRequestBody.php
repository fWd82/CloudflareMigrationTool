...
class RollbackInstanceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RollbackInstanceRequestBody';
    ...
    * Sets serverId
    *
    * @param string $serverId 需要回退的实例id
    *
    * @return $this
    */
