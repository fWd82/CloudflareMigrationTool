...
class UpdateInstanceSecurityGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInstanceSecurityGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            'serverId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cbh\V2\Model\ChangeInstanceSecurityGroups'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cbh\V2\Model\ChangeInstanceSecurityGroups|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cbh\V2\Model\ChangeInstanceSecurityGroups|null $body body
    *
    * @return $this
    */
