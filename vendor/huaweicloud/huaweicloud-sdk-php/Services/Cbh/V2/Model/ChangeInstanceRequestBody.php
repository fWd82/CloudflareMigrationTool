...
class ChangeInstanceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * serverId  serverId
    * newResourceSpecCode  待变更云堡垒机规格ID，例如： - cbh.basic.50 - cbh.enhance.50  已上线的规格请参见《云堡垒机产品介绍》的[服务版本差异](https://support.huaweicloud.com/productdesc-cbh/cbh_01_0010.html)章节。
    ...
    *
    * @param string|null $newResourceSpecCode 待变更云堡垒机规格ID，例如： - cbh.basic.50 - cbh.enhance.50  已上线的规格请参见《云堡垒机产品介绍》的[服务版本差异](https://support.huaweicloud.com/productdesc-cbh/cbh_01_0010.html)章节。
    *
    * @return $this
    */
