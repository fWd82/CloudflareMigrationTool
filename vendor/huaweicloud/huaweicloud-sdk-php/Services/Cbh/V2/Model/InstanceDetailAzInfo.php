...
class InstanceDetailAzInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InstanceDetail_az_info';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * region  云堡垒机实例所在可用区ID。
    * zone  云堡垒机实例所在可用分区ID。(实例为主备模式时作为主机实例所在可用分区)
    * availabilityZoneDisplay  云堡垒机实例所在可用分区中文名称。(实例为主备模式时作为主机实例所在可用分区中文名称)
    * slaveZone  云堡垒机备机实例所在可用区。
    * slaveZoneDisplay  云堡垒机备机实例所在可用区中文名称。
    *
    * @var string[]
    */
    ...
    */
    protected static $attributeMap = [
            ...
            'slaveZone' => 'slave_zone',
            'slaveZoneDisplay' => 'slave_zone_display'
    ];
    ...
    * Sets region
    *
    * @param string $region 云堡垒机实例所在可用区ID。
    *
    * @return $this
    */
    ...
    * Sets zone
    *
    * @param string $zone 云堡垒机实例所在可用分区ID。(实例为主备模式时作为主机实例所在可用分区)
    *
    * @return $this
    */
    ...
    *
    * @param string $availabilityZoneDisplay 云堡垒机实例所在可用分区中文名称。(实例为主备模式时作为主机实例所在可用分区中文名称)
    *
    * @return $this
    */
    ...
    * Sets slaveZone
    *
    * @param string|null $slaveZone 云堡垒机备机实例所在可用区。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $slaveZoneDisplay 云堡垒机备机实例所在可用区中文名称。
    *
    * @return $this
    */
