...
class LoginInstanceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LoginInstanceResponse';
    ...
    * Sets loginUrl
    *
    * @param string|null $loginUrl 云堡垒机登录链接。
    *
    * @return $this
    */
