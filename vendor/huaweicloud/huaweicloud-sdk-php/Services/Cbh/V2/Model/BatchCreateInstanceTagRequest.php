...
class BatchCreateInstanceTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateInstanceTagRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceId  资源ID。(list接口获取)
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cbh\V2\Model\CbsGetResourceIdTags'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cbh\V2\Model\CbsGetResourceIdTags|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cbh\V2\Model\CbsGetResourceIdTags|null $body body
    *
    * @return $this
    */
