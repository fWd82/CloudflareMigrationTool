...
class StartCbhRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StartCbhRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  云堡垒机实例的ID，使用UUID格式。
    *
    * @var string[]
    */
    ...
    * Sets instanceId
    *
    * @param string $instanceId 云堡垒机实例的ID，使用UUID格式。
    *
    * @return $this
    */
