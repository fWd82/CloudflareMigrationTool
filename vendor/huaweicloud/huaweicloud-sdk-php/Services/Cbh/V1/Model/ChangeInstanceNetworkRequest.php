...
class ChangeInstanceNetworkRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeInstanceNetworkRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * serverId  云堡垒机实例ID，使用UUID格式。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'serverId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cbh\V1\Model\ChangeInstanceNetwork'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cbh\V1\Model\ChangeInstanceNetwork|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cbh\V1\Model\ChangeInstanceNetwork|null $body body
    *
    * @return $this
    */
