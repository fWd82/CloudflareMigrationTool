...
class CreateInstanceBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'server' => '\HuaweiCloud\SDK\Cbh\V1\Model\CBHInstances'
    ];
    ...
    *  server
    *
    * @return \HuaweiCloud\SDK\Cbh\V1\Model\CBHInstances
    */
    ...
    * Sets server
    *
    * @param \HuaweiCloud\SDK\Cbh\V1\Model\CBHInstances $server server
    *
    * @return $this
    */
