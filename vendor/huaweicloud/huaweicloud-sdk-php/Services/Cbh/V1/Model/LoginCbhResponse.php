...
class LoginCbhResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LoginCbhResponse';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['loginUrl']) && (mb_strlen($this->container['loginUrl']) > 4096)) {
                $invalidProperties[] = "invalid value for 'loginUrl', the character length must be smaller than or equal to 4096.";
            }
    ...
    * Sets loginUrl
    *
    * @param string|null $loginUrl IAM登录链接
    *
    * @return $this
    */
