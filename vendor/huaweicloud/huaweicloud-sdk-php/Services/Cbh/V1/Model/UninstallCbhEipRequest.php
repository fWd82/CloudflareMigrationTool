...
class UninstallCbhEipRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UninstallCbhEipRequest';
    ...
    */
    protected static $openAPITypes = [
            'serverId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cbh\V1\Model\OperateEipRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cbh\V1\Model\OperateEipRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cbh\V1\Model\OperateEipRequestBody|null $body body
    *
    * @return $this
    */
