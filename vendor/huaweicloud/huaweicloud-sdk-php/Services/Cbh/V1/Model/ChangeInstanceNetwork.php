...
class ChangeInstanceNetwork implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeInstanceNetwork';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * type  云堡垒机实例状态，枚举值如下： - create  创建 - renewals  续费 - change  扩容
    * securityGroups  云堡垒机实例修改后的安全组信息。
    * nics  云堡垒机实例修改后的网卡信息。
    * serverId  云堡垒机实例ID。云堡垒机实例状态为renewals或change时必传。
    *
    * @var string[]
    */
    ...
    * Sets type
    *
    * @param string $type 云堡垒机实例状态，枚举值如下： - create  创建 - renewals  续费 - change  扩容
    *
    * @return $this
    */
    ...
    * Sets securityGroups
    *
    * @param \HuaweiCloud\SDK\Cbh\V1\Model\SecurityGroup[] $securityGroups 云堡垒机实例修改后的安全组信息。
    *
    * @return $this
    */
    ...
    * Sets nics
    *
    * @param \HuaweiCloud\SDK\Cbh\V1\Model\Nics[] $nics 云堡垒机实例修改后的网卡信息。
    *
    * @return $this
    */
    ...
    * Sets serverId
    *
    * @param string|null $serverId 云堡垒机实例ID。云堡垒机实例状态为renewals或change时必传。
    *
    * @return $this
    */
