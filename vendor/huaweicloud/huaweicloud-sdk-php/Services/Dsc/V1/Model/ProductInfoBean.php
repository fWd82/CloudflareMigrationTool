...
class ProductInfoBean implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProductInfoBean';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['resourceSizeMeasureId'] === null) {
            $invalidProperties[] = "'resourceSizeMeasureId' can't be null";
        }
    ...
    * Sets resourceSize
    *
    * @param int $resourceSize 产品支持的数据库数量，或者支持obs的扫描量
    *
    * @return $this
    */
    ...
    *
    * @param int $resourceSizeMeasureId 资源容量度量标识，枚举值举例如下：15：mbps（购买带宽时使用），17：gb（购买云硬盘时使用），14：个/次
    *
    * @return $this
    */
    ...
    *
    * @param string $resourceSpecCode 产品编码
    *
    * @return $this
    */
