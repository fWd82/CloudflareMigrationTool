...
class ListArtifactoryStorageStatisticResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListArtifactoryStorageStatisticResponse';
