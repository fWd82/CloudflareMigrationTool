...
class CreateProjectRelatedRepositoryResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateProjectRelatedRepositoryResponse';
