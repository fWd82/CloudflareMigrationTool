...
class CancelSyncIamUserResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CancelSyncIamUserResponse';
    ...
    * Sets state
    *
    * @param string|null $state 请求下发的结果
    *
    * @return $this
    */
