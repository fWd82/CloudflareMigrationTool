...
class AutoScalingPolicy implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'minCapacity' => 'int',
            'maxCapacity' => 'int',
            'resourcesPlans' => '\HuaweiCloud\SDK\Mrs\V2\Model\ResourcesPlan[]',
            'rules' => '\HuaweiCloud\SDK\Mrs\V2\Model\Rule[]',
            'execScripts' => '\HuaweiCloud\SDK\Mrs\V2\Model\ScaleScript[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Mrs\V2\Model\ResourcesPlan[]|null
    */
    ...
    * Sets resourcesPlans
    *
    * @param \HuaweiCloud\SDK\Mrs\V2\Model\ResourcesPlan[]|null $resourcesPlans 资源计划列表。若该参数为空表示不启用资源计划。 当启用弹性伸缩时，资源计划与自动伸缩规则需至少配置其中一种。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Mrs\V2\Model\Rule[]|null
    */
    ...
    * Sets rules
    *
    * @param \HuaweiCloud\SDK\Mrs\V2\Model\Rule[]|null $rules 自动伸缩的规则列表。 当启用弹性伸缩时，资源计划与自动伸缩规则需至少配置其中一种。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Mrs\V2\Model\ScaleScript[]|null
    */
    ...
    * Sets execScripts
    *
    * @param \HuaweiCloud\SDK\Mrs\V2\Model\ScaleScript[]|null $execScripts 弹性伸缩自定义自动化脚本列表。若该参数为空表示不启用自动化脚本。
    *
    * @return $this
    */
