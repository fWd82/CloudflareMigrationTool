...
class UpdateDataConnectorRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDataConnectorRequest';
    ...
    */
    protected static $openAPITypes = [
            'connectorId' => 'string',
            'body' => '\HuaweiCloud\SDK\Mrs\V2\Model\DataConnectorReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Mrs\V2\Model\DataConnectorReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Mrs\V2\Model\DataConnectorReq|null $body body
    *
    * @return $this
    */
