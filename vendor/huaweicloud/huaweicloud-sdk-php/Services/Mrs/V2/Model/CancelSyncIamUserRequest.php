...
class CancelSyncIamUserRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CancelSyncIamUserRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\Mrs\V2\Model\CancelSyncRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Mrs\V2\Model\CancelSyncRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Mrs\V2\Model\CancelSyncRequest|null $body body
    *
    * @return $this
    */
