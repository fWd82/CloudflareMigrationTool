...
class ShowJobExeListNewResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowJobExeListNewResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalRecord' => 'int',
            'jobList' => '\HuaweiCloud\SDK\Mrs\V2\Model\JobQueryBean[]'
    ];
    ...
    * Sets jobList
    *
    * @param \HuaweiCloud\SDK\Mrs\V2\Model\JobQueryBean[]|null $jobList 作业列表。
    *
    * @return $this
    */
