...
class CreateClusterReqV2 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateClusterReqV2';
    ...
    *
    * @return \HuaweiCloud\SDK\Mrs\V2\Model\AddJobsReqV11[]|null
    */
    ...
    * Sets addJobs
    *
    * @param \HuaweiCloud\SDK\Mrs\V2\Model\AddJobsReqV11[]|null $addJobs 创建集群时可同时提交作业，当前仅MRS1.8.7之前版本支持，暂时只支持新增一个作业。建议使用创建集群并提交作业接口RunJobFlow的steps参数
    *
    * @return $this
    */
