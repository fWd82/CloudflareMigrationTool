...
class ExpandClusterRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExpandClusterRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\Mrs\V2\Model\ExpandParam'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Mrs\V2\Model\ExpandParam|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Mrs\V2\Model\ExpandParam|null $body body
    *
    * @return $this
    */
