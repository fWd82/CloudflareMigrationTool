...
class AutoScalingPolicyInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AutoScalingPolicyInfo';
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Mrs\V2\Model\Tag[]|null $tags 弹性伸缩标签列表
    *
    * @return $this
    */
