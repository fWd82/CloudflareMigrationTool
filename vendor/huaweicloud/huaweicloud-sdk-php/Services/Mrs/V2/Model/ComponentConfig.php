...
class ComponentConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ComponentConfig';
    ...
    */
    protected static $openAPITypes = [
            ...
            'configs' => '\HuaweiCloud\SDK\Mrs\V2\Model\Config[]'
    ];
    ...
    *  组件配置项列表
    *
    * @return \HuaweiCloud\SDK\Mrs\V2\Model\Config[]|null
    */
    ...
    * Sets configs
    *
    * @param \HuaweiCloud\SDK\Mrs\V2\Model\Config[]|null $configs 组件配置项列表
    *
    * @return $this
    */
