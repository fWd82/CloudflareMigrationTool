...
class ShrinkClusterRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\Mrs\V2\Model\ShrinkParam'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Mrs\V2\Model\ShrinkParam|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Mrs\V2\Model\ShrinkParam|null $body body
    *
    * @return $this
    */
