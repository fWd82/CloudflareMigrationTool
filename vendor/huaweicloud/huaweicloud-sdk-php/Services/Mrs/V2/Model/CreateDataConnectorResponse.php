...
class CreateDataConnectorResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDataConnectorResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * connectorId  数据连接创建成功后系统返回的数据连接ID值。
    *
    * @var string[]
    */
    ...
    * Sets connectorId
    *
    * @param string|null $connectorId 数据连接创建成功后系统返回的数据连接ID值。
    *
    * @return $this
    */
