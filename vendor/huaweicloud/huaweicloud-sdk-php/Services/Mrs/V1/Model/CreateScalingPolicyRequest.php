...
class CreateScalingPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\Mrs\V1\Model\AutoScalingPolicyReqV11'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Mrs\V1\Model\AutoScalingPolicyReqV11|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Mrs\V1\Model\AutoScalingPolicyReqV11|null $body body
    *
    * @return $this
    */
