...
class ListHostsRequest implements ModelInterface, ArrayAccess
{
    ...
    * pageSize  分页查询每页返回的最大集群数量。 取值范围：[1～2147483646] 默认值为10。
    * currentPage  当前查询页码。默认值为1。
    *
    * @var string[]
    */
    ...
    * Sets pageSize
    *
    * @param string|null $pageSize 分页查询每页返回的最大集群数量。 取值范围：[1～2147483646] 默认值为10。
    *
    * @return $this
    */
    ...
    * Sets currentPage
    *
    * @param string|null $currentPage 当前查询页码。默认值为1。
    *
    * @return $this
    */
