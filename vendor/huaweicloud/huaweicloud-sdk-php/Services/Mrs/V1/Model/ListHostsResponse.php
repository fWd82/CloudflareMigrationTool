...
class ListHostsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'hosts' => '\HuaweiCloud\SDK\Mrs\V1\Model\HostModel[]',
            'total' => 'int'
    ];
    ...
    *  主机参数。
    *
    * @return \HuaweiCloud\SDK\Mrs\V1\Model\HostModel[]|null
    */
    ...
    * Sets hosts
    *
    * @param \HuaweiCloud\SDK\Mrs\V1\Model\HostModel[]|null $hosts 主机参数。
    *
    * @return $this
    */
