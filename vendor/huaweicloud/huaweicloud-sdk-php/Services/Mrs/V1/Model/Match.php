...
class Match implements ModelInterface, ArrayAccess
{
    ...
    * key  键。当前只有resource_name可用，表示集群的名称，后续扩展。
    * value  值。每个值最大长度64个unicode字符。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string|null $key 键。当前只有resource_name可用，表示集群的名称，后续扩展。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string|null $value 值。每个值最大长度64个unicode字符。
    *
    * @return $this
    */
