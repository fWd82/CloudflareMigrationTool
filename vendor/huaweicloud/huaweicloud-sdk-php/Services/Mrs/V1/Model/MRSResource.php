...
class MRSResource implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MRSResource';
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Mrs\V1\Model\TagPlain[]|null $tags 标签
    *
    * @return $this
    */
