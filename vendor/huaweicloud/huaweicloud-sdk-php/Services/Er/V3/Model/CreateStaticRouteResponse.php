...
class CreateStaticRouteResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateStaticRouteResponse';
    ...
    */
    protected static $openAPITypes = [
            'route' => '\HuaweiCloud\SDK\Er\V3\Model\Route',
            'requestId' => 'string',
            'xClientToken' => 'string'
    ];
    ...
    *  route
    *
    * @return \HuaweiCloud\SDK\Er\V3\Model\Route|null
    */
    ...
    * Sets route
    *
    * @param \HuaweiCloud\SDK\Er\V3\Model\Route|null $route route
    *
    * @return $this
    */
