...
class CreateEnterpriseRouterRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateEnterpriseRouterRequest';
    ...
    */
    protected static $openAPITypes = [
            'xClientToken' => 'string',
            'body' => '\HuaweiCloud\SDK\Er\V3\Model\CreateEnterpriseRouterRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Er\V3\Model\CreateEnterpriseRouterRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Er\V3\Model\CreateEnterpriseRouterRequestBody|null $body body
    *
    * @return $this
    */
