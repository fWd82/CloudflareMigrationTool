...
class UpdateVpcAttachmentRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpcAttachmentRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'vpcAttachment' => '\HuaweiCloud\SDK\Er\V3\Model\UpdateVpcAttachmentBody'
    ];
    ...
    *  vpcAttachment
    *
    * @return \HuaweiCloud\SDK\Er\V3\Model\UpdateVpcAttachmentBody|null
    */
    ...
    * Sets vpcAttachment
    *
    * @param \HuaweiCloud\SDK\Er\V3\Model\UpdateVpcAttachmentBody|null $vpcAttachment vpcAttachment
    *
    * @return $this
    */
