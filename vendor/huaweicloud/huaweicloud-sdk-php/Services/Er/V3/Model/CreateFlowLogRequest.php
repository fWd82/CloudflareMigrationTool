...
class CreateFlowLogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateFlowLogRequest';
    ...
    */
    protected static $openAPITypes = [
            'xClientToken' => 'string',
            'erId' => 'string',
            'body' => '\HuaweiCloud\SDK\Er\V3\Model\CreateFlowLogRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Er\V3\Model\CreateFlowLogRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Er\V3\Model\CreateFlowLogRequestBody|null $body body
    *
    * @return $this
    */
