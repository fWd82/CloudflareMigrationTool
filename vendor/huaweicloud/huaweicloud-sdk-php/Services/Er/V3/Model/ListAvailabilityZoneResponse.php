...
class ListAvailabilityZoneResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAvailabilityZoneResponse';
    ...
    */
    protected static $openAPITypes = [
            'availabilityZones' => '\HuaweiCloud\SDK\Er\V3\Model\AvailableZone[]',
            'requestId' => 'string'
    ];
    ...
    *  可用区列表
    *
    * @return \HuaweiCloud\SDK\Er\V3\Model\AvailableZone[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Er\V3\Model\AvailableZone[]|null $availabilityZones 可用区列表
    *
    * @return $this
    */
