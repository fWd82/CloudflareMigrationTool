...
class CreateVpcAttachmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateVpcAttachmentRequest';
    ...
    */
    protected static $openAPITypes = [
            'xClientToken' => 'string',
            'erId' => 'string',
            'body' => '\HuaweiCloud\SDK\Er\V3\Model\CreateVpcAttachmentBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Er\V3\Model\CreateVpcAttachmentBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Er\V3\Model\CreateVpcAttachmentBody|null $body body
    *
    * @return $this
    */
