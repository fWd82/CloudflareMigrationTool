...
class CreateRouteTableRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'xClientToken' => 'string',
            'erId' => 'string',
            'body' => '\HuaweiCloud\SDK\Er\V3\Model\CreateRouteTableRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Er\V3\Model\CreateRouteTableRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Er\V3\Model\CreateRouteTableRequestBody|null $body body
    *
    * @return $this
    */
