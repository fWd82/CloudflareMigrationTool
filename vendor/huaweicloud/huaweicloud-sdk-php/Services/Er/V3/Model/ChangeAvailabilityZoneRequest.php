...
class ChangeAvailabilityZoneRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeAvailabilityZoneRequest';
    ...
    */
    protected static $openAPITypes = [
            'erId' => 'string',
            'body' => '\HuaweiCloud\SDK\Er\V3\Model\EnterpriseRouterAZ'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Er\V3\Model\EnterpriseRouterAZ|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Er\V3\Model\EnterpriseRouterAZ|null $body body
    *
    * @return $this
    */
