...
class UpdateEnterpriseRouterRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateEnterpriseRouterRequest';
    ...
    */
    protected static $openAPITypes = [
            'erId' => 'string',
            'body' => '\HuaweiCloud\SDK\Er\V3\Model\UpdateEnterpriseRouterRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Er\V3\Model\UpdateEnterpriseRouterRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Er\V3\Model\UpdateEnterpriseRouterRequestBody|null $body body
    *
    * @return $this
    */
