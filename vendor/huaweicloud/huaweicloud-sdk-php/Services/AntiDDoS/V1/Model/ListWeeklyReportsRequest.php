...
class ListWeeklyReportsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWeeklyReportsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * periodStartDate  每周的起始时间
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $periodStartDate 每周的起始时间
    *
    * @return $this
    */
