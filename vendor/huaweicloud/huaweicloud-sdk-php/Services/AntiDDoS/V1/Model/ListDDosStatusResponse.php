...
class ListDDosStatusResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'ddosStatus' => '\HuaweiCloud\SDK\AntiDDoS\V1\Model\DDosStatus[]'
    ];
    ...
    *  防护状态列表
    *
    * @return \HuaweiCloud\SDK\AntiDDoS\V1\Model\DDosStatus[]|null
    */
    ...
    * Sets ddosStatus
    *
    * @param \HuaweiCloud\SDK\AntiDDoS\V1\Model\DDosStatus[]|null $ddosStatus 防护状态列表
    *
    * @return $this
    */
