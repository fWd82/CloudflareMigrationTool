...
class UpdateAlertConfigRequestBodyWarnConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAlertConfigRequestBody_warn_config';
