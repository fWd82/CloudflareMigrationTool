...
class ListGcbResourceByTagResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGcbResourceByTagResponse';
    ...
    *  资源列表。
    *
    * @return \HuaweiCloud\SDK\Cc\V2\Model\TmsResource[]|null
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Cc\V2\Model\TmsResource[]|null $resources 资源列表。
    *
    * @return $this
    */
