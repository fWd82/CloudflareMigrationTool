...
class ListGcbResourceTagsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGcbResourceTagsResponse';
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Cc\V2\Model\Tag[]|null $tags 标签列表。
    *
    * @return $this
    */
