...
class BatchCreateDeleteTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateDeleteTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'resourceType' => 'string',
            'body' => '\HuaweiCloud\SDK\Cc\V2\Model\ResourceTags'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cc\V2\Model\ResourceTags|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cc\V2\Model\ResourceTags|null $body body
    *
    * @return $this
    */
