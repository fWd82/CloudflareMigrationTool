...
class CreateGcbResourceTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateGcbResourceTagRequest';
    ...
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cc\V2\Model\CreateGcbTagRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cc\V2\Model\CreateGcbTagRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cc\V2\Model\CreateGcbTagRequestBody|null $body body
    *
    * @return $this
    */
