...
class QueryResourceByTagRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'withoutAnyTag' => 'bool',
            'tags' => '\HuaweiCloud\SDK\Cc\V2\Model\QueryTag[]',
            'tagsAny' => '\HuaweiCloud\SDK\Cc\V2\Model\QueryTag[]',
            'notTags' => '\HuaweiCloud\SDK\Cc\V2\Model\QueryTag[]',
            'notTagsAny' => '\HuaweiCloud\SDK\Cc\V2\Model\QueryTag[]',
            'matches' => '\HuaweiCloud\SDK\Cc\V2\Model\TmsMatch[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Cc\V2\Model\QueryTag[]|null
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Cc\V2\Model\QueryTag[]|null $tags 包含标签，最多包含20个key，每个key下面的value最多10个，每个key对应的value可以为空数组但结构体不能缺失。Key不能重复，同一个key中values不能重复。结果返回包含所有标签的资源列表，key之间是与的关系，key-value结构中value是或的关系。无tag过滤条件时返回全量数据。
    *
    * @return $this
    */
    ...
    * Sets tagsAny
    *
    * @param \HuaweiCloud\SDK\Cc\V2\Model\QueryTag[]|null $tagsAny 包含任意标签，最多包含20个key，每个key下面的value最多10个, 每个key对应的value可以为空数组但结构体不能缺失。Key不能重复，同一个key中values不能重复。结果返回包含标签的资源列表，key之间是或的关系，key-value结构中value是或的关系。无过滤条件时返回全量数据。
    *
    * @return $this
    */
    ...
    * Sets notTags
    *
    * @param \HuaweiCloud\SDK\Cc\V2\Model\QueryTag[]|null $notTags 不包含标签，最多包含20个key，每个key下面的value最多10个, 每个key对应的value可以为空数组但结构体不能缺失。Key不能重复，同一个key中values不能重复。结果返回不包含标签的资源列表，key之间是与的关系，key-value结构中value是或的关系。无过滤条件时返回全量数据。
    *
    * @return $this
    */
    ...
    * Sets notTagsAny
    *
    * @param \HuaweiCloud\SDK\Cc\V2\Model\QueryTag[]|null $notTagsAny 不包含任意标签，最多包含20个key，每个key下面的value最多10个, 每个key对应的value可以为空数组但结构体不能缺失。Key不能重复，同一个key中values不能重复。结果返回不包含标签的资源列表，key之间是或的关系，key-value结构中value是或的关系。无过滤条件时返回全量数据。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Cc\V2\Model\TmsMatch[]|null
    */
    ...
    * Sets matches
    *
    * @param \HuaweiCloud\SDK\Cc\V2\Model\TmsMatch[]|null $matches 是否匹配以下tag，key必须为\"resource_name\"，value如果有值则模糊匹配，如果为空字符串则精确匹配。
    *
    * @return $this
    */
