...
class DeleteGcbResourceTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteGcbResourceTagRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tagKey'] === null) {
            ...
            if ((mb_strlen($this->container['tagKey']) > 128)) {
                $invalidProperties[] = "invalid value for 'tagKey', the character length must be smaller than or equal to 128.";
            }
            if ((mb_strlen($this->container['tagKey']) < 0)) {
                $invalidProperties[] = "invalid value for 'tagKey', the character length must be bigger than or equal to 0.";
            }
