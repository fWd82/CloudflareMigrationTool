...
class ListDomainTagsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDomainTagsResponse';
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Cc\V2\Model\AggTag[]|null $tags 标签列表
    *
    * @return $this
    */
