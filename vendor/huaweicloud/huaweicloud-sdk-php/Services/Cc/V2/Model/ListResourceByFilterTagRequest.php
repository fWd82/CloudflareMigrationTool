...
class ListResourceByFilterTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListResourceByFilterTagRequest';
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'body' => '\HuaweiCloud\SDK\Cc\V2\Model\ListResourceByFilterTagRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cc\V2\Model\ListResourceByFilterTagRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cc\V2\Model\ListResourceByFilterTagRequestBody|null $body body
    *
    * @return $this
    */
