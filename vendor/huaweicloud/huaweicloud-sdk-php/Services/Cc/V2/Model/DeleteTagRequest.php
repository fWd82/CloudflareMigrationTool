...
class DeleteTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteTagRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tagKey'] === null) {
            ...
            if ((mb_strlen($this->container['tagKey']) < 1)) {
                $invalidProperties[] = "invalid value for 'tagKey', the character length must be bigger than or equal to 1.";
            }
