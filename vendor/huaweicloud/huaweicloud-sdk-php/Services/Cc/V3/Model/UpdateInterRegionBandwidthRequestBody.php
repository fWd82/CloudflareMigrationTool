...
class UpdateInterRegionBandwidthRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInterRegionBandwidthRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'interRegionBandwidth' => '\HuaweiCloud\SDK\Cc\V3\Model\UpdateInterRegionBandwidth'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\UpdateInterRegionBandwidth
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\UpdateInterRegionBandwidth $interRegionBandwidth interRegionBandwidth
    *
    * @return $this
    */
