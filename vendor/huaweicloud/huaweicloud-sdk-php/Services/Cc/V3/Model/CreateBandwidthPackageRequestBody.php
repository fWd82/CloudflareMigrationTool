...
class CreateBandwidthPackageRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateBandwidthPackageRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'bandwidthPackage' => '\HuaweiCloud\SDK\Cc\V3\Model\CreateBandwidthPackage'
    ];
    ...
    *  bandwidthPackage
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\CreateBandwidthPackage
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\CreateBandwidthPackage $bandwidthPackage bandwidthPackage
    *
    * @return $this
    */
