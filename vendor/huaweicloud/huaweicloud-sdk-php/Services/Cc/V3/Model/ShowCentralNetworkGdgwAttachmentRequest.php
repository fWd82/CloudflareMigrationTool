...
class ShowCentralNetworkGdgwAttachmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCentralNetworkGdgwAttachmentRequest';
