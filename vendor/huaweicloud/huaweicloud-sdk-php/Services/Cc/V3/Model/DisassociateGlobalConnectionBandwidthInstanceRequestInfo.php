...
class DisassociateGlobalConnectionBandwidthInstanceRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateGlobalConnectionBandwidthInstanceRequestInfo';
