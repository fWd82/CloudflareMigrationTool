...
class ListCloudConnectionQuotasResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCloudConnectionQuotasResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'quotas' => '\HuaweiCloud\SDK\Cc\V3\Model\CloudConnectionQuota[]'
    ];
    ...
    *  配额列表。
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\CloudConnectionQuota[]
    */
    ...
    * Sets quotas
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\CloudConnectionQuota[] $quotas 配额列表。
    *
    * @return $this
    */
