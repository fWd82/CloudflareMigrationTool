...
class UntagCentralNetworkRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UntagCentralNetworkRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Cc\V3\Model\UntagCentralNetworkRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\UntagCentralNetworkRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\UntagCentralNetworkRequestBody|null $body body
    *
    * @return $this
    */
