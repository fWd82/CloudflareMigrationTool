...
class CreateCloudConnectionRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCloudConnectionRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'cloudConnection' => '\HuaweiCloud\SDK\Cc\V3\Model\CreateCloudConnection'
    ];
    ...
    *  cloudConnection
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\CreateCloudConnection
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\CreateCloudConnection $cloudConnection cloudConnection
    *
    * @return $this
    */
