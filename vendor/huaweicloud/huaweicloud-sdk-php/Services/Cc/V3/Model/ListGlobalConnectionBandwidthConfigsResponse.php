...
class ListGlobalConnectionBandwidthConfigsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGlobalConnectionBandwidthConfigsResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'configs' => '\HuaweiCloud\SDK\Cc\V3\Model\ListGlobalConnectionBandwidthConfigs'
    ];
    ...
    *  configs
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\ListGlobalConnectionBandwidthConfigs|null
    */
    ...
    * Sets configs
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\ListGlobalConnectionBandwidthConfigs|null $configs configs
    *
    * @return $this
    */
