...
class ListCentralNetworkTagsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCentralNetworkTagsResponse';
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\MultivaluedTag[] $tags 所有标签。
    *
    * @return $this
    */
