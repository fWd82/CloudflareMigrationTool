...
class CreateCentralNetworkGdgwAttachmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCentralNetworkGdgwAttachmentRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Cc\V3\Model\CreateCentralNetworkGdgwAttachmentRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\CreateCentralNetworkGdgwAttachmentRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\CreateCentralNetworkGdgwAttachmentRequestBody|null $body body
    *
    * @return $this
    */
