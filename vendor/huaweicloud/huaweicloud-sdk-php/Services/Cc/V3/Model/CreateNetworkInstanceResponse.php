...
class CreateNetworkInstanceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateNetworkInstanceResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'networkInstance' => '\HuaweiCloud\SDK\Cc\V3\Model\NetworkInstance'
    ];
    ...
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\NetworkInstance $networkInstance networkInstance
    *
    * @return $this
    */
