...
class UpdateCloudConnectionRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCloudConnectionRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'cloudConnection' => '\HuaweiCloud\SDK\Cc\V3\Model\UpdateCloudConnection'
    ];
    ...
    *  cloudConnection
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\UpdateCloudConnection
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\UpdateCloudConnection $cloudConnection cloudConnection
    *
    * @return $this
    */
