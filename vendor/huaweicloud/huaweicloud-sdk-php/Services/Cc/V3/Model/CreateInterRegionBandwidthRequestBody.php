...
class CreateInterRegionBandwidthRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateInterRegionBandwidthRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'interRegionBandwidth' => '\HuaweiCloud\SDK\Cc\V3\Model\CreateInterRegionBandwidth'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\CreateInterRegionBandwidth
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\CreateInterRegionBandwidth $interRegionBandwidth interRegionBandwidth
    *
    * @return $this
    */
