...
class AssociateGlobalConnectionBandwidthInstanceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateGlobalConnectionBandwidthInstanceResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  资源ID标识符。
    * gcbandwidths  全域互联带宽绑定实例响应详情。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'gcbandwidths' => '\HuaweiCloud\SDK\Cc\V3\Model\AssociateGlobalConnectionBandwidthInstanceResponseInfo[]'
    ];
    ...
    *  全域互联带宽绑定实例响应详情。
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\AssociateGlobalConnectionBandwidthInstanceResponseInfo[]
    */
    ...
    * Sets gcbandwidths
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\AssociateGlobalConnectionBandwidthInstanceResponseInfo[] $gcbandwidths 全域互联带宽绑定实例响应详情。
    *
    * @return $this
    */
