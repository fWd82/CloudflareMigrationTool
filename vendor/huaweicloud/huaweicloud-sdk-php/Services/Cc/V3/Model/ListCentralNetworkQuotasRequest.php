...
class ListCentralNetworkQuotasRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCentralNetworkQuotasRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * quotaType  根据配额类型查询，可查询多个类型。
    ...
    */
    protected static $openAPITypes = [
            'quotaType' => '\HuaweiCloud\SDK\Cc\V3\Model\CentralNetworkQuotaKeyEnum[]',
            'limit' => 'int',
            'marker' => 'string'
    ];
    ...
    *  根据配额类型查询，可查询多个类型。
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\CentralNetworkQuotaKeyEnum[]|null
    */
    ...
    * Sets quotaType
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\CentralNetworkQuotaKeyEnum[]|null $quotaType 根据配额类型查询，可查询多个类型。
    *
    * @return $this
    */
