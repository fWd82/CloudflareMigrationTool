...
class CreateCentralNetworkGdgwAttachmentRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCentralNetworkGdgwAttachmentRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'centralNetworkGdgwAttachment' => '\HuaweiCloud\SDK\Cc\V3\Model\CreateCentralNetworkGdgwAttachment'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\CreateCentralNetworkGdgwAttachment
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\CreateCentralNetworkGdgwAttachment $centralNetworkGdgwAttachment centralNetworkGdgwAttachment
    *
    * @return $this
    */
