...
class DisassociateBandwidthPackageResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateBandwidthPackageResponse';
