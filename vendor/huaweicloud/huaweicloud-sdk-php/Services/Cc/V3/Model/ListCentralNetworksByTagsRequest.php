...
class ListCentralNetworksByTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCentralNetworksByTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'limit' => 'int',
            'marker' => 'string',
            'body' => '\HuaweiCloud\SDK\Cc\V3\Model\ListCentralNetworksByTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\ListCentralNetworksByTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\ListCentralNetworksByTagsRequestBody|null $body body
    *
    * @return $this
    */
