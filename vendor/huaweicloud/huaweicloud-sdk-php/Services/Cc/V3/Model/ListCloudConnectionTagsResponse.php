...
class ListCloudConnectionTagsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCloudConnectionTagsResponse';
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\MultivaluedTag[] $tags 云连接实例的所有标签。
    *
    * @return $this
    */
