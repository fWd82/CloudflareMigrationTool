...
class CreateNetworkInstanceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateNetworkInstanceRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'networkInstance' => '\HuaweiCloud\SDK\Cc\V3\Model\CreateNetworkInstance'
    ];
    ...
    *  networkInstance
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\CreateNetworkInstance
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\CreateNetworkInstance $networkInstance networkInstance
    *
    * @return $this
    */
