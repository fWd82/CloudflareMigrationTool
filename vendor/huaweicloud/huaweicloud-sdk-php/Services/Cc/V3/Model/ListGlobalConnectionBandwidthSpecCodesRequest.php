...
class ListGlobalConnectionBandwidthSpecCodesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGlobalConnectionBandwidthSpecCodesRequest';
    ...
    * Sets level
    *
    * @param string[]|null $level 带宽等级： - Pt: 铂金 - Au: 金 - Ag: 银
    *
    * @return $this
    */
