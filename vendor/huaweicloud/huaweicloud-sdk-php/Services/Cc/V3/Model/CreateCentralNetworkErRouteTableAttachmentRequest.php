...
class CreateCentralNetworkErRouteTableAttachmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCentralNetworkErRouteTableAttachmentRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Cc\V3\Model\CreateCentralNetworkErRouteTableAttachmentsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\CreateCentralNetworkErRouteTableAttachmentsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\CreateCentralNetworkErRouteTableAttachmentsRequestBody|null $body body
    *
    * @return $this
    */
