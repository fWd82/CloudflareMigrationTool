...
class UpdateCentralNetworkConnectionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCentralNetworkConnectionRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * centralNetworkId  中心网络的ID。
    * connectionId  中心网络连接ID。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'connectionId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cc\V3\Model\UpdateCentralNetworkConnectionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\UpdateCentralNetworkConnectionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\UpdateCentralNetworkConnectionRequestBody|null $body body
    *
    * @return $this
    */
