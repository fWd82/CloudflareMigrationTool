...
class CreateCentralNetworkRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCentralNetworkRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'centralNetwork' => '\HuaweiCloud\SDK\Cc\V3\Model\CreateCentralNetwork'
    ];
    ...
    *  centralNetwork
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\CreateCentralNetwork
    */
    ...
    * Sets centralNetwork
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\CreateCentralNetwork $centralNetwork centralNetwork
    *
    * @return $this
    */
