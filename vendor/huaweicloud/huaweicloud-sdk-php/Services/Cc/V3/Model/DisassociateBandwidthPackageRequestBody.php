...
class DisassociateBandwidthPackageRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateBandwidthPackageRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'bandwidthPackage' => '\HuaweiCloud\SDK\Cc\V3\Model\DisassociateBandwidthPackage'
    ];
    ...
    *  bandwidthPackage
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\DisassociateBandwidthPackage
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\DisassociateBandwidthPackage $bandwidthPackage bandwidthPackage
    *
    * @return $this
    */
