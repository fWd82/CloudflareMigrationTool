...
class ListAuthorisationsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAuthorisationsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  资源ID标识符。
    * pageInfo  pageInfo
    * authorisations  授权实例列表。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'authorisations' => '\HuaweiCloud\SDK\Cc\V3\Model\Authorisation[]'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['authorisations'] = isset($data['authorisations']) ? $data['authorisations'] : null;
    }
    ...
    * Sets authorisations
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\Authorisation[] $authorisations 授权实例列表。
    *
    * @return $this
    */
