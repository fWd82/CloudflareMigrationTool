...
class UpdateBandwidthPackageRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateBandwidthPackageRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'bandwidthPackage' => '\HuaweiCloud\SDK\Cc\V3\Model\UpdateBandwidthPackage'
    ];
    ...
    *  bandwidthPackage
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\UpdateBandwidthPackage
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\UpdateBandwidthPackage $bandwidthPackage bandwidthPackage
    *
    * @return $this
    */
