...
class UpdateAuthorisationRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAuthorisationRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'authorisation' => '\HuaweiCloud\SDK\Cc\V3\Model\UpdateAuthorisation'
    ];
    ...
    *  authorisation
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\UpdateAuthorisation
    */
    ...
    * Sets authorisation
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\UpdateAuthorisation $authorisation authorisation
    *
    * @return $this
    */
