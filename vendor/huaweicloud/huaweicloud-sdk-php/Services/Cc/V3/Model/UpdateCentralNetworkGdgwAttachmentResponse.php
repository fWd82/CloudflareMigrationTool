...
class UpdateCentralNetworkGdgwAttachmentResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCentralNetworkGdgwAttachmentResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'centralNetworkGdgwAttachment' => '\HuaweiCloud\SDK\Cc\V3\Model\CentralNetworkGdgwAttachment'
    ];
    ...
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\CentralNetworkGdgwAttachment $centralNetworkGdgwAttachment centralNetworkGdgwAttachment
    *
    * @return $this
    */
