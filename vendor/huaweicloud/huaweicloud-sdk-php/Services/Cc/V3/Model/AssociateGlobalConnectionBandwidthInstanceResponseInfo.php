...
class AssociateGlobalConnectionBandwidthInstanceResponseInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateGlobalConnectionBandwidthInstanceResponseInfo';
    ...
    * result  功能说明：绑定操作成功还是失败。 - success: 成功 - fail: 失败
    * message  功能说明：绑定操作如果失败，具体的错误信息。
    *
    * @var string[]
    */
    ...
    * Sets result
    *
    * @param string|null $result 功能说明：绑定操作成功还是失败。 - success: 成功 - fail: 失败
    *
    * @return $this
    */
    ...
    * Sets message
    *
    * @param string|null $message 功能说明：绑定操作如果失败，具体的错误信息。
    *
    * @return $this
    */
