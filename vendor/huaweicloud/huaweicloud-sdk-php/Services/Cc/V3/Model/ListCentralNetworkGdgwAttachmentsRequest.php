...
class ListCentralNetworkGdgwAttachmentsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCentralNetworkGdgwAttachmentsRequest';
    ...
    * globalDcGatewayId  根据GDW实例ID过滤列表。
    *
    * @var string[]
    */
    ...
    *
    * @param string[]|null $globalDcGatewayId 根据GDW实例ID过滤列表。
    *
    * @return $this
    */
