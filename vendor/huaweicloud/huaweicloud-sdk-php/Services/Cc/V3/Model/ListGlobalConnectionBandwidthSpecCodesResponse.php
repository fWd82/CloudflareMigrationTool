...
class ListGlobalConnectionBandwidthSpecCodesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGlobalConnectionBandwidthSpecCodesResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'specCodes' => '\HuaweiCloud\SDK\Cc\V3\Model\GlobalConnectionBandwidthSpecCode[]'
    ];
    ...
    *  线路规格列表响应体。
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\GlobalConnectionBandwidthSpecCode[]
    */
    ...
    * Sets specCodes
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\GlobalConnectionBandwidthSpecCode[] $specCodes 线路规格列表响应体。
    *
    * @return $this
    */
