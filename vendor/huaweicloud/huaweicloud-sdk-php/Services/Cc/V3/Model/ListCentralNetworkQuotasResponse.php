...
class ListCentralNetworkQuotasResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCentralNetworkQuotasResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'quotas' => '\HuaweiCloud\SDK\Cc\V3\Model\CentralNetworkQuota[]'
    ];
    ...
    *  配额列表
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\CentralNetworkQuota[]
    */
    ...
    * Sets quotas
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\CentralNetworkQuota[] $quotas 配额列表
    *
    * @return $this
    */
