...
class Proxy2NodeMonitoredObject implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Proxy2NodeMonitoredObject';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dcsInstanceId  测量对象ID，即节点的ID。
    * name  测量对象名称，即节点IP。
    * dcsClusterProxy2Node  维度dcs_cluster_proxy2_node 的测量对象的ID。
    * status  测量对象状态，即节点状态。
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $dcsClusterProxy2Node 维度dcs_cluster_proxy2_node 的测量对象的ID。
    *
    * @return $this
    */
