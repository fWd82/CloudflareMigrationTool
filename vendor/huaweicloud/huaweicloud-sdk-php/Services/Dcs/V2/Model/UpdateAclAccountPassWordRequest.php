...
class UpdateAclAccountPassWordRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAclAccountPassWordRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'accountId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dcs\V2\Model\AclAccountModifyPasswordBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dcs\V2\Model\AclAccountModifyPasswordBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dcs\V2\Model\AclAccountModifyPasswordBody|null $body body
    *
    * @return $this
    */
