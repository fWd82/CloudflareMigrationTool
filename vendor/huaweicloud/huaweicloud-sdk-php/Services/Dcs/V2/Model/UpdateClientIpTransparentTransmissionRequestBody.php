...
class UpdateClientIpTransparentTransmissionRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateClientIpTransparentTransmissionRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * transparentClientIpEnable  开启或关闭客户ip透传标志
    *
    * @var string[]
    */
    ...
    *
    * @param bool|null $transparentClientIpEnable 开启或关闭客户ip透传标志
    *
    * @return $this
    */
