...
class UpdateAclAccountRemarkRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAclAccountRemarkRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'accountId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dcs\V2\Model\UpdateAclAccountRemarkRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accountId'] === null) {
            ...
            if ((mb_strlen($this->container['accountId']) < 0)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dcs\V2\Model\UpdateAclAccountRemarkRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dcs\V2\Model\UpdateAclAccountRemarkRequestBody|null $body body
    *
    * @return $this
    */
