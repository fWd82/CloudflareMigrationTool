...
class ClusterRedisNodeMonitoredObject implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ClusterRedisNodeMonitoredObject';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dcsInstanceId  测量对象ID，即节点的ID。
    * name  测量对象名称，即节点IP。
    * dcsClusterRedisNode  维度dcs_cluster_redis_node的测量对象的ID。
    * status  测量对象状态，即节点状态。
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $dcsClusterRedisNode 维度dcs_cluster_redis_node的测量对象的ID。
    *
    * @return $this
    */
