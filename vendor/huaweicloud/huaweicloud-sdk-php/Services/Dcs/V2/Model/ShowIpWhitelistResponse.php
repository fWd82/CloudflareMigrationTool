...
class ShowIpWhitelistResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowIpWhitelistResponse';
    ...
    *
    * @param bool|null $enableWhitelist 是否启用白名单（true/false）。
    *
    * @return $this
    */
    ...
    *  IP白名单分组列表。
    *
    * @return \HuaweiCloud\SDK\Dcs\V2\Model\Whitelist[]|null
    */
    ...
    * Sets whitelist
    *
    * @param \HuaweiCloud\SDK\Dcs\V2\Model\Whitelist[]|null $whitelist IP白名单分组列表。
    *
    * @return $this
    */
