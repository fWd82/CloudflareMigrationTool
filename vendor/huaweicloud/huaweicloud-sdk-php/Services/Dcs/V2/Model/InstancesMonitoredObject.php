...
class InstancesMonitoredObject implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InstancesMonitoredObject';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dcsInstanceId  测量对象ID，即实例的ID。
    * name  测量对象名称，即实例名称。
    * status  测量对象状态，即实例状态。
    *
    * @var string[]
    ...
    * Sets dcsInstanceId
    *
    * @param string|null $dcsInstanceId 测量对象ID，即实例的ID。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name 测量对象名称，即实例名称。
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status 测量对象状态，即实例状态。
    *
    * @return $this
    */
