...
class ResetAclAccountPassWordRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResetAclAccountPassWordRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'accountId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dcs\V2\Model\AclAccountResetPasswordBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dcs\V2\Model\AclAccountResetPasswordBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dcs\V2\Model\AclAccountResetPasswordBody|null $body body
    *
    * @return $this
    */
