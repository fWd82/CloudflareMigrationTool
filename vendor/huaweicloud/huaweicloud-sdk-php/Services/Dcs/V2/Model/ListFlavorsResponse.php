...
class ListFlavorsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'flavors' => '\HuaweiCloud\SDK\Dcs\V2\Model\FlavorsItems[]'
    ];
    ...
    *  产品规格详情。
    *
    * @return \HuaweiCloud\SDK\Dcs\V2\Model\FlavorsItems[]|null
    */
    ...
    * Sets flavors
    *
    * @param \HuaweiCloud\SDK\Dcs\V2\Model\FlavorsItems[]|null $flavors 产品规格详情。
    *
    * @return $this
    */
