...
class ShowBigkeyScanTaskDetailsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBigkeyScanTaskDetailsResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'finishedAt' => 'string',
            'num' => 'int',
            'keys' => '\HuaweiCloud\SDK\Dcs\V2\Model\BigkeysBody[]'
    ];
    ...
    * Sets id
    *
    * @param string|null $id 大key分析记录ID
    *
    * @return $this
    */
    ...
    *  大key记录
    *
    * @return \HuaweiCloud\SDK\Dcs\V2\Model\BigkeysBody[]|null
    */
    ...
    * Sets keys
    *
    * @param \HuaweiCloud\SDK\Dcs\V2\Model\BigkeysBody[]|null $keys 大key记录
    *
    * @return $this
    */
