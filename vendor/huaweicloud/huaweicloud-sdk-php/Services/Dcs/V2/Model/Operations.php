...
class Operations implements ModelInterface, ArrayAccess
{
    ...
    * operation  操作信息
    * isSupport  是否支持该操作
    * causeId  不支持该操作的原因ID，仅在is_support为false时返回
    *
    * @var string[]
    */
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['causeId'] = isset($data['causeId']) ? $data['causeId'] : null;
    }
    ...
    * Sets operation
    *
    * @param string|null $operation 操作信息
    *
    * @return $this
    */
    ...
    * Sets isSupport
    *
    * @param bool|null $isSupport 是否支持该操作
    *
    * @return $this
    */
    ...
    * Sets causeId
    *
    * @param string|null $causeId 不支持该操作的原因ID，仅在is_support为false时返回
    *
    * @return $this
    */
