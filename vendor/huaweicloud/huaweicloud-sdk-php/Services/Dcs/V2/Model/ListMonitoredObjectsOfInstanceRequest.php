...
class ListMonitoredObjectsOfInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMonitoredObjectsOfInstanceRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  主维度对象ID，与DCS实例列表中实例ID相同。
    * dimName  主维度ID，当前支持子维度的主维度ID的有dcs_instance_id。
    *
    * @var string[]
    */
