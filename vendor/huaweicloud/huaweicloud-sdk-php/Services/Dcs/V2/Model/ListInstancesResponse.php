...
class ListInstancesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'instanceNum' => 'int',
            'instances' => '\HuaweiCloud\SDK\Dcs\V2\Model\InstanceListInfo[]'
    ];
    ...
    *  实例的详情数组。
    *
    * @return \HuaweiCloud\SDK\Dcs\V2\Model\InstanceListInfo[]|null
    */
    ...
    * Sets instances
    *
    * @param \HuaweiCloud\SDK\Dcs\V2\Model\InstanceListInfo[]|null $instances 实例的详情数组。
    *
    * @return $this
    */
