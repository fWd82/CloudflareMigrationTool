...
class InstanceGroupListInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InstanceGroupListInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * groupId  分片id
    * groupName  分片名称
    * replicationList  每个分片包含的副本列表。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'groupId' => 'string',
            'groupName' => 'string',
            'replicationList' => '\HuaweiCloud\SDK\Dcs\V2\Model\InstanceReplicationListInfo[]'
    ];
    ...
    *  每个分片包含的副本列表。
    *
    * @return \HuaweiCloud\SDK\Dcs\V2\Model\InstanceReplicationListInfo[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Dcs\V2\Model\InstanceReplicationListInfo[]|null $replicationList 每个分片包含的副本列表。
    *
    * @return $this
    */
