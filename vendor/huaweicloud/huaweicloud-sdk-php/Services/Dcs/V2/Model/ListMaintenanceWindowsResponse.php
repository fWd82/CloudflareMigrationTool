...
class ListMaintenanceWindowsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMaintenanceWindowsResponse';
    ...
    */
    protected static $openAPITypes = [
            'maintainWindows' => '\HuaweiCloud\SDK\Dcs\V2\Model\MaintainWindowsEntity[]'
    ];
    ...
    *  支持的维护时间窗列表。
    *
    * @return \HuaweiCloud\SDK\Dcs\V2\Model\MaintainWindowsEntity[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Dcs\V2\Model\MaintainWindowsEntity[]|null $maintainWindows 支持的维护时间窗列表。
    *
    * @return $this
    */
