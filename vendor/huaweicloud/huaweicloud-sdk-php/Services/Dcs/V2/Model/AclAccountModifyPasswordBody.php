...
class AclAccountModifyPasswordBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AclAccountModifyPasswordBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * oldPassword  旧密码
    * newPassword  新密码 - 输入长度为8到64位的字符串。 - 不能包含正序逆序用户名。 - 必须包含如下四种字符中的三种组合（不允许包含冒号）：   - 小写字母   - 大写字母   - 数字   - 特殊字符包括（`~!@#$%^&*()-_=+\\|{},<.>/?）
    *
    * @var string[]
    */
    ...
    * Sets newPassword
    *
    * @param string|null $newPassword 新密码 - 输入长度为8到64位的字符串。 - 不能包含正序逆序用户名。 - 必须包含如下四种字符中的三种组合（不允许包含冒号）：   - 小写字母   - 大写字母   - 数字   - 特殊字符包括（`~!@#$%^&*()-_=+\\|{},<.>/?）
    *
    * @return $this
    */
