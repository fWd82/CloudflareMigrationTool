...
class UpdateAclAccountRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAclAccountRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'accountId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dcs\V2\Model\AclAccountRoleModifyBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dcs\V2\Model\AclAccountRoleModifyBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dcs\V2\Model\AclAccountRoleModifyBody|null $body body
    *
    * @return $this
    */
