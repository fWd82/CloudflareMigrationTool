...
class ListSlowlogResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSlowlogResponse';
    ...
    *  慢日志列表
    *
    * @return \HuaweiCloud\SDK\Dcs\V2\Model\SlowlogItem[]|null
    */
    ...
    * Sets slowlogs
    *
    * @param \HuaweiCloud\SDK\Dcs\V2\Model\SlowlogItem[]|null $slowlogs 慢日志列表
    *
    * @return $this
    */
