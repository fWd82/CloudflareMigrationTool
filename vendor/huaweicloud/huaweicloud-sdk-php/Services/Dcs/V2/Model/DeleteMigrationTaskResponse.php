...
class DeleteMigrationTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteMigrationTaskResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * taskIdList  删除的迁移任务ID列表。
    *
    * @var string[]
    */
    ...
    * Sets taskIdList
    *
    * @param string[]|null $taskIdList 删除的迁移任务ID列表。
    *
    * @return $this
    */
