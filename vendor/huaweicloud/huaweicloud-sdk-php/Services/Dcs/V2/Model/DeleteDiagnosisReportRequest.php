...
class DeleteDiagnosisReportRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDiagnosisReportRequest';
    ...
    * Sets reportIdList
    *
    * @param string[]|null $reportIdList 诊断报告ID
    *
    * @return $this
    */
