...
class ListClientsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListClientsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  实例ID。
    * nodeId  节点ID。
    * offset  偏移量，表示从此偏移量开始查询， 偏移量大于等于0。
    ...
    * Sets offset
    *
    * @param int|null $offset 偏移量，表示从此偏移量开始查询， 偏移量大于等于0。
    *
    * @return $this
    */
    ...
    * Sets addr
    *
    * @param string|null $addr 按客户端连接地址过滤。
    *
    * @return $this
    */
