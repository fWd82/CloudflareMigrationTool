...
class DeleteMigrateTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteMigrateTaskRequest';
    ...
    * Sets taskIdList
    *
    * @param string[] $taskIdList 删除的迁移任务ID列表。
    *
    * @return $this
    */
