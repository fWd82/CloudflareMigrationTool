...
class MigrationUpdateRequestEntity implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MigrationUpdateRequestEntity';
    ...
    * Sets resumeMode
    *
    * @param string|null $resumeMode 模式
    *
    * @return $this
    */
