...
class ListAvailableZonesResponse implements ModelInterface, ArrayAccess
{
    ...
    * regionId  区域ID。
    * availableZones  可用分区数组。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'regionId' => 'string',
            'availableZones' => '\HuaweiCloud\SDK\Dcs\V2\Model\AvailableZones[]'
    ];
    ...
    *  可用分区数组。
    *
    * @return \HuaweiCloud\SDK\Dcs\V2\Model\AvailableZones[]|null
    */
    ...
    * Sets availableZones
    *
    * @param \HuaweiCloud\SDK\Dcs\V2\Model\AvailableZones[]|null $availableZones 可用分区数组。
    *
    * @return $this
    */
