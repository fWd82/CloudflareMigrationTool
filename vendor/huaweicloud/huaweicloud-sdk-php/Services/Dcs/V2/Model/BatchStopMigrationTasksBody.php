...
class BatchStopMigrationTasksBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchStopMigrationTasksBody';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['migrationTasks'] === null) {
            $invalidProperties[] = "'migrationTasks' can't be null";
        }
    ...
    * Sets migrationTasks
    *
    * @param string[] $migrationTasks 数据迁移任务列表。
    *
    * @return $this
    */
