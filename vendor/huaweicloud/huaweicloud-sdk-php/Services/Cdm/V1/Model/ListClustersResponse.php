...
class ListClustersResponse implements ModelInterface, ArrayAccess
{
    ...
    * clusters  集群列表，请参见clusters参数说明
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'clusters' => '\HuaweiCloud\SDK\Cdm\V1\Model\Clusters[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Cdm\V1\Model\Clusters[]|null
    */
    ...
    * Sets clusters
    *
    * @param \HuaweiCloud\SDK\Cdm\V1\Model\Clusters[]|null $clusters 集群列表，请参见clusters参数说明
    *
    * @return $this
    */
