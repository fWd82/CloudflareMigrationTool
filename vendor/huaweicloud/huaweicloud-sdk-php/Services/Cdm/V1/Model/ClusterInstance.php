...
class ClusterInstance implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ClusterInstance';
    ...
    * Sets name
    *
    * @param string|null $name 节点的虚拟机名称。
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type 节点类型，只支持一种类型“cdm”。
    *
    * @return $this
    */
