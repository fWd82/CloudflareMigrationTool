...
class ClusterDetailInstanceFlavor implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ClusterDetailInstance_flavor';
    ...
    * Sets id
    *
    * @param string|null $id 节点虚拟机的规格ID。
    *
    * @return $this
    */
