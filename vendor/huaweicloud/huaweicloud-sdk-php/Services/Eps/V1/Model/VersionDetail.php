...
class VersionDetail implements ModelInterface, ArrayAccess
{
    ...
    * id  版本ID（版本号），如v1.0。
    * links  API的URL地址。
    * version  若该版本API支持微版本，则返回支持的最大微版本号，如果不支持微版本，则返回空。
    ...
    * minVersion  若该版本API 支持微版本，则返回支持的最小微版本号， 如果不支持微版本，则返回空。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'links' => '\HuaweiCloud\SDK\Eps\V1\Model\Link[]',
            'version' => 'string',
            'status' => 'string',
            'updated' => '\DateTime',
            'minVersion' => 'string'
    ...
    *  API的URL地址。
    *
    * @return \HuaweiCloud\SDK\Eps\V1\Model\Link[]
    */
    ...
    * Sets links
    *
    * @param \HuaweiCloud\SDK\Eps\V1\Model\Link[] $links API的URL地址。
    *
    * @return $this
    */
    ...
    * Sets version
    *
    * @param string $version 若该版本API支持微版本，则返回支持的最大微版本号，如果不支持微版本，则返回空。
    *
    * @return $this
    */
    ...
    * Sets minVersion
    *
    * @param string $minVersion 若该版本API 支持微版本，则返回支持的最小微版本号， 如果不支持微版本，则返回空。
    *
    * @return $this
    */
