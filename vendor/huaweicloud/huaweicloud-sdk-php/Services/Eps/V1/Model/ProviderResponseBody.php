...
class ProviderResponseBody implements ModelInterface, ArrayAccess
{
    ...
    * provider  云服务名称
    * providerI18nDisplayName  云服务显示名称，可以通过参数中的'locale'设置语言
    ...
    */
    protected static $openAPITypes = [
            ...
            'resourceTypes' => '\HuaweiCloud\SDK\Eps\V1\Model\ResourceTypeBody[]'
    ];
    ...
    *
    * @param string $providerI18nDisplayName 云服务显示名称，可以通过参数中的'locale'设置语言
    *
    * @return $this
    */
    ...
    *  资源类型列表
    *
    * @return \HuaweiCloud\SDK\Eps\V1\Model\ResourceTypeBody[]
    */
    ...
    * Sets resourceTypes
    *
    * @param \HuaweiCloud\SDK\Eps\V1\Model\ResourceTypeBody[] $resourceTypes 资源类型列表
    *
    * @return $this
    */
