...
class UpdateEnterpriseProjectResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateEnterpriseProjectResponse';
    ...
    */
    protected static $openAPITypes = [
            'enterpriseProject' => '\HuaweiCloud\SDK\Eps\V1\Model\EpDetail'
    ];
    ...
    *
    * @param \HuaweiCloud\SDK\Eps\V1\Model\EpDetail|null $enterpriseProject enterpriseProject
    *
    * @return $this
    */
