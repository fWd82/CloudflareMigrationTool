...
class ListEnterpriseProjectResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEnterpriseProjectResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * enterpriseProjects  企业项目列表
    * totalCount  企业项目总数
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'enterpriseProjects' => '\HuaweiCloud\SDK\Eps\V1\Model\EpDetail[]',
            'totalCount' => 'int'
    ];
    ...
    *  企业项目列表
    *
    * @return \HuaweiCloud\SDK\Eps\V1\Model\EpDetail[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Eps\V1\Model\EpDetail[]|null $enterpriseProjects 企业项目列表
    *
    * @return $this
    */
    ...
    * Sets totalCount
    *
    * @param int|null $totalCount 企业项目总数
    *
    * @return $this
    */
