...
class Match implements ModelInterface, ArrayAccess
{
    ...
    * key  键。有matches参数时，该字段为必填，固定为resource_name。
    * value  值。即资源名称，有matches参数时，该字段为必填，且默认为模糊搜索，如”message.com”。每个值最大长度255个字符。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key 键。有matches参数时，该字段为必填，固定为resource_name。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value 值。即资源名称，有matches参数时，该字段为必填，且默认为模糊搜索，如”message.com”。每个值最大长度255个字符。
    *
    * @return $this
    */
