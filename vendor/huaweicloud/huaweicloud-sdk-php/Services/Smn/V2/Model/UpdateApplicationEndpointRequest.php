...
class UpdateApplicationEndpointRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'endpointUrn' => 'string',
            'body' => '\HuaweiCloud\SDK\Smn\V2\Model\UpdateApplicationEndpointRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Smn\V2\Model\UpdateApplicationEndpointRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Smn\V2\Model\UpdateApplicationEndpointRequestBody|null $body body
    *
    * @return $this
    */
