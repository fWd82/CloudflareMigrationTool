...
class UpdateTopicAttributeRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'topicUrn' => 'string',
            'name' => 'string',
            'body' => '\HuaweiCloud\SDK\Smn\V2\Model\UpdateTopicAttributeRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Smn\V2\Model\UpdateTopicAttributeRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Smn\V2\Model\UpdateTopicAttributeRequestBody|null $body body
    *
    * @return $this
    */
