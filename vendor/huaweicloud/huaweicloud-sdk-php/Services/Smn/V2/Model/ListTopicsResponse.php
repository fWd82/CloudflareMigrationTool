...
class ListTopicsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'topicCount' => 'int',
            'topics' => '\HuaweiCloud\SDK\Smn\V2\Model\ListTopicsItem[]'
    ];
    ...
    *  Topic结构体数组。
    *
    * @return \HuaweiCloud\SDK\Smn\V2\Model\ListTopicsItem[]|null
    */
    ...
    * Sets topics
    *
    * @param \HuaweiCloud\SDK\Smn\V2\Model\ListTopicsItem[]|null $topics Topic结构体数组。
    *
    * @return $this
    */
