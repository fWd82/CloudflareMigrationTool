...
class AddSubscriptionFromSubscriptionUserResponseItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddSubscriptionFromSubscriptionUserResponseItem';
    ...
    * Sets requestId
    *
    * @param string $requestId 请求的唯一标识ID。
    *
    * @return $this
    */
    ...
    * Sets errorCode
    *
    * @param string|null $errorCode 返回信息对应的代码。
    *
    * @return $this
    */
    ...
    * Sets errorMsg
    *
    * @param string|null $errorMsg 服务异常错误信息描述。
    *
    * @return $this
    */
