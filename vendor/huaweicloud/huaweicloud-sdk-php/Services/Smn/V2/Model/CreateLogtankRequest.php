...
class CreateLogtankRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'topicUrn' => 'string',
            'body' => '\HuaweiCloud\SDK\Smn\V2\Model\CreateLogtankRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Smn\V2\Model\CreateLogtankRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Smn\V2\Model\CreateLogtankRequestBody|null $body body
    *
    * @return $this
    */
