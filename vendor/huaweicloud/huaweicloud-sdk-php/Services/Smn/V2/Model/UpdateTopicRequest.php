...
class UpdateTopicRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'topicUrn' => 'string',
            'body' => '\HuaweiCloud\SDK\Smn\V2\Model\UpdateTopicRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Smn\V2\Model\UpdateTopicRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Smn\V2\Model\UpdateTopicRequestBody|null $body body
    *
    * @return $this
    */
