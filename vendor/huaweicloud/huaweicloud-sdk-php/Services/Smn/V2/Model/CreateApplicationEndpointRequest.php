...
class CreateApplicationEndpointRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Smn\V2\Model\CreateApplicationEndpointRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Smn\V2\Model\CreateApplicationEndpointRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Smn\V2\Model\CreateApplicationEndpointRequestBody|null $body body
    *
    * @return $this
    */
