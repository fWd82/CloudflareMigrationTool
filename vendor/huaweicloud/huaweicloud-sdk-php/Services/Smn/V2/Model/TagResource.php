...
class TagResource implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'resourceDetail' => '\HuaweiCloud\SDK\Smn\V2\Model\ResourceDetail',
    ...
    *  resourceDetail
    *
    * @return \HuaweiCloud\SDK\Smn\V2\Model\ResourceDetail
    */
    ...
    * Sets resourceDetail
    *
    * @param \HuaweiCloud\SDK\Smn\V2\Model\ResourceDetail $resourceDetail resourceDetail
    *
    * @return $this
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Smn\V2\Model\ResourceTag[] $tags 标签列表。
    *
    * @return $this
    */
