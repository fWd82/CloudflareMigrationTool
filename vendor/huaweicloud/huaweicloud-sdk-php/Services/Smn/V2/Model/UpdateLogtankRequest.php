...
class UpdateLogtankRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'topicUrn' => 'string',
            'logtankId' => 'string',
            'body' => '\HuaweiCloud\SDK\Smn\V2\Model\UpdateLogtankRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Smn\V2\Model\UpdateLogtankRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Smn\V2\Model\UpdateLogtankRequestBody|null $body body
    *
    * @return $this
    */
