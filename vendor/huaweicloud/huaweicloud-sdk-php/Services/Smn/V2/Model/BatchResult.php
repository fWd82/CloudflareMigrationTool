...
class BatchResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchResult';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * code  执行结果code
    * message  执行结果message
    * subscriptionUrn  订阅者urn
    *
    * @var string[]
    */
    ...
    * Sets code
    *
    * @param string|null $code 执行结果code
    *
    * @return $this
    */
    ...
    * Sets message
    *
    * @param string|null $message 执行结果message
    *
    * @return $this
    */
    ...
    *
    * @param string|null $subscriptionUrn 订阅者urn
    *
    * @return $this
    */
