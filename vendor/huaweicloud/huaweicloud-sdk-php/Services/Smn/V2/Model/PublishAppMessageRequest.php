...
class PublishAppMessageRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'endpointUrn' => 'string',
            'body' => '\HuaweiCloud\SDK\Smn\V2\Model\PublishAppMessageRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Smn\V2\Model\PublishAppMessageRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Smn\V2\Model\PublishAppMessageRequestBody|null $body body
    *
    * @return $this
    */
