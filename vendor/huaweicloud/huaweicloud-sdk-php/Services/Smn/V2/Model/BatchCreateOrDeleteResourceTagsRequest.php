...
class BatchCreateOrDeleteResourceTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Smn\V2\Model\BatchCreateOrDeleteResourceTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Smn\V2\Model\BatchCreateOrDeleteResourceTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Smn\V2\Model\BatchCreateOrDeleteResourceTagsRequestBody|null $body body
    *
    * @return $this
    */
