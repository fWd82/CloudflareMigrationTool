...
class ListConfigurationsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'configurations' => '\HuaweiCloud\SDK\Dds\V3\Model\ListConfigurationsResult[]'
    ];
    ...
    *  参数模板列表。
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\ListConfigurationsResult[]|null
    */
    ...
    * Sets configurations
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\ListConfigurationsResult[]|null $configurations 参数模板列表。
    *
    * @return $this
    */
