...
class DeleteKillOpRuleListRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteKillOpRuleListRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dds\V3\Model\DeleteKillOpRuleListRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\DeleteKillOpRuleListRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\DeleteKillOpRuleListRequestBody|null $body body
    *
    * @return $this
    */
