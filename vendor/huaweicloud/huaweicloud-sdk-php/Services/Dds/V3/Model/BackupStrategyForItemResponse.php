...
class BackupStrategyForItemResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BackupStrategyForItemResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * startTime  备份时间段。自动备份将在该时间段内触发。当前时间指UTC时间。
    * keepDays  已生成备份文件可以保存的天数。取值范围：0~732。
    *
    * @var string[]
    */
    ...
    * Sets keepDays
    *
    * @param int $keepDays 已生成备份文件可以保存的天数。取值范围：0~732。
    *
    * @return $this
    */
