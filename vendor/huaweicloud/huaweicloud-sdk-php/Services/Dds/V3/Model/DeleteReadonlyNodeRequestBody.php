...
class DeleteReadonlyNodeRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteReadonlyNodeRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nodeList  所有需要删除的节点ID。
    *
    * @var string[]
    */
    ...
    * Sets nodeList
    *
    * @param string[] $nodeList 所有需要删除的节点ID。
    *
    * @return $this
    */
