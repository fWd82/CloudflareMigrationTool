...
class RestoreNewInstanceConfigurationsOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RestoreNewInstanceConfigurationsOption';
