...
class CreateManualBackupOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateManualBackupOption';
    ...
    * Sets description
    *
    * @param string|null $description 手动备份描述。 取值范围：长度不超过256位，且不能包含>!<\"&'=特殊字符。
    *
    * @return $this
    */
