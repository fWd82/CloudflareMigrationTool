...
class ListFlavorsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'flavors' => '\HuaweiCloud\SDK\Dds\V3\Model\Flavor[]'
    ];
    ...
    *  实例规格信息列表。
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\Flavor[]|null
    */
    ...
    * Sets flavors
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\Flavor[]|null $flavors 实例规格信息列表。
    *
    * @return $this
    */
