...
class ListLtsErrorLogsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLtsErrorLogsRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dds\V3\Model\ListLtsErrorLogsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\ListLtsErrorLogsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\ListLtsErrorLogsRequestBody|null $body body
    *
    * @return $this
    */
