...
class ListDatastoreVersionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDatastoreVersionsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * datastoreName  数据库版本类型。取值为“DDS-Community”。
    *
    * @var string[]
    */
    ...
    */
    ...
    const DATASTORE_NAME_DDS_COMMUNITY = 'DDS-Community';
    const DATASTORE_NAME_DDS_ENHANCED = 'DDS-Enhanced';
    ...
    */
    ...
    {
        return [
            self::DATASTORE_NAME_DDS_COMMUNITY,
            self::DATASTORE_NAME_DDS_ENHANCED,
        ];
    }
    ...
    * Sets datastoreName
    *
    * @param string $datastoreName 数据库版本类型。取值为“DDS-Community”。
    *
    * @return $this
    */
