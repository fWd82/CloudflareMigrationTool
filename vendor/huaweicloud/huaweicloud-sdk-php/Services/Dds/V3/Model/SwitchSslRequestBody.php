...
class SwitchSslRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SwitchSslRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * sslOption  SSL开关选项。取值：取“0”，表示DDS实例默认不启用SSL连接。取“1”，表示DDS实例默认启用SSL连接。
    *
    * @var string[]
    */
    ...
    * Sets sslOption
    *
    * @param string $sslOption SSL开关选项。取值：取“0”，表示DDS实例默认不启用SSL连接。取“1”，表示DDS实例默认启用SSL连接。
    *
    * @return $this
    */
