...
class GetBackupDownloadLinkResponseBodyFiles implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetBackupDownloadLinkResponseBody_files';
    ...
    *
    * @param string $linkExpiredTime 下载链接过期时间，格式为“yyyy-mm-ddThh:mm:ssZ”。其中，T指某个时间的开始，Z指时区偏移量，例如UTC时间偏移显示为+0000。
    *
    * @return $this
    */
