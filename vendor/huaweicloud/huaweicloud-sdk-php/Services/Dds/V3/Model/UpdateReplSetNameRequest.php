...
class UpdateReplSetNameRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateReplSetNameRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dds\V3\Model\MongoUpdateReplSetV3RequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\MongoUpdateReplSetV3RequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\MongoUpdateReplSetV3RequestBody|null $body body
    *
    * @return $this
    */
