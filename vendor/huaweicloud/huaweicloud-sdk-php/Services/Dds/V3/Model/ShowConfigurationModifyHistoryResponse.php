...
class ShowConfigurationModifyHistoryResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowConfigurationModifyHistoryResponse';
    ...
    */
    protected static $openAPITypes = [
            'histories' => '\HuaweiCloud\SDK\Dds\V3\Model\HistoryInfo[]'
    ];
