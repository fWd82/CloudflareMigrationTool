...
class UpdateKillOpRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateKillOpRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dds\V3\Model\UpdateKillOpRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\UpdateKillOpRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\UpdateKillOpRuleRequestBody|null $body body
    *
    * @return $this
    */
