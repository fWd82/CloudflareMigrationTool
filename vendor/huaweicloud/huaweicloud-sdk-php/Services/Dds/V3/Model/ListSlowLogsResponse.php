...
class ListSlowLogsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'slowLogList' => '\HuaweiCloud\SDK\Dds\V3\Model\SlowlogResult[]',
            'totalRecord' => 'int'
    ];
    ...
    *  具体信息。
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\SlowlogResult[]|null
    */
    ...
    * Sets slowLogList
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\SlowlogResult[]|null $slowLogList 具体信息。
    *
    * @return $this
    */
