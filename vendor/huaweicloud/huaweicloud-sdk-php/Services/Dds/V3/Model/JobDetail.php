...
class JobDetail implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'ended' => 'string',
            'progress' => 'string',
            'instance' => '\HuaweiCloud\SDK\Dds\V3\Model\JobInstanceInfo',
            'failReason' => 'string'
    ];
    ...
    *  instance
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\JobInstanceInfo
    */
    ...
    * Sets instance
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\JobInstanceInfo $instance instance
    *
    * @return $this
    */
