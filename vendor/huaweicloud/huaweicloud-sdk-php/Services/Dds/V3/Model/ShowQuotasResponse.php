...
class ShowQuotasResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'quotas' => '\HuaweiCloud\SDK\Dds\V3\Model\ShowResourcesListResponseBody'
    ];
    ...
    *  quotas
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\ShowResourcesListResponseBody|null
    */
    ...
    * Sets quotas
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\ShowResourcesListResponseBody|null $quotas quotas
    *
    * @return $this
    */
