...
class ListSlowLogsRequest implements ModelInterface, ArrayAccess
{
    ...
    * type  语句类型，取空值，表示查询所有语句类型，也可指定如下日志类型： - INSERT - QUERY - UPDATE - REMOVE - GETMORE - COMMAND - KILLCURSORS
    ...
    */
    ...
    const TYPE_GETMORE = 'GETMORE';
    const TYPE_COMMAND = 'COMMAND';
    const TYPE_KILLCURSORS = 'KILLCURSORS';
    ...
    * Sets type
    *
    * @param string|null $type 语句类型，取空值，表示查询所有语句类型，也可指定如下日志类型： - INSERT - QUERY - UPDATE - REMOVE - GETMORE - COMMAND - KILLCURSORS
    *
    * @return $this
    */
