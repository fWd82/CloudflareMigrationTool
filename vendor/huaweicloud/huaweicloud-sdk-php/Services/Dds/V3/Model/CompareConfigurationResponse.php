...
class CompareConfigurationResponse implements ModelInterface, ArrayAccess
{
    ...
    * differences  参数模板之间的区别集合。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'differences' => '\HuaweiCloud\SDK\Dds\V3\Model\DiffDetails[]'
    ];
    ...
    *  参数模板之间的区别集合。
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\DiffDetails[]|null
    */
    ...
    * Sets differences
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\DiffDetails[]|null $differences 参数模板之间的区别集合。
    *
    * @return $this
    */
