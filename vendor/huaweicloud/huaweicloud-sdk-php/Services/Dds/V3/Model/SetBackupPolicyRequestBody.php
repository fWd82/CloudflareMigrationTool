...
class SetBackupPolicyRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'backupPolicy' => '\HuaweiCloud\SDK\Dds\V3\Model\BackupPolicy'
    ];
    ...
    *  backupPolicy
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\BackupPolicy
    */
    ...
    * Sets backupPolicy
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\BackupPolicy $backupPolicy backupPolicy
    *
    * @return $this
    */
