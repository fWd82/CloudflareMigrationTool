...
class DownloadErrorlogRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DownloadErrorlogRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * fileNameList  - 需要下载的文件的文件名列表。
    * nodeIdList  节点ID列表，取空值，表示查询实例下所有允许查询的节点。使用请参考《DDS API参考》的“查询实例列表和详情”响应消息表“nodes 数据结构说明”的“id”。允许查询的节点如下： - 集群下面的mongos、shard、config节点 - 副本集、单节点下面的所有节点
    *
    * @var string[]
    */
    ...
    * Sets nodeIdList
    *
    * @param string[]|null $nodeIdList 节点ID列表，取空值，表示查询实例下所有允许查询的节点。使用请参考《DDS API参考》的“查询实例列表和详情”响应消息表“nodes 数据结构说明”的“id”。允许查询的节点如下： - 集群下面的mongos、shard、config节点 - 副本集、单节点下面的所有节点
    *
    * @return $this
    */
