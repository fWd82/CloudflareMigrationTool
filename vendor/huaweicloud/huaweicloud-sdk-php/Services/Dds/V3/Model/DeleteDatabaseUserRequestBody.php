...
class DeleteDatabaseUserRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDatabaseUserRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * userName  数据库用户名称。 - 长度为1~64位，可以包含大写字母（A~Z）、小写字母（a~z）、数字（0~9）、中划线、下划线和点。
    * dbName  用户所在的数据库。 - 长度为1~64位，可以包含大写字母（A~Z）、小写字母（a~z）、数字（0~9）、下划线。
    *
    * @var string[]
    */
    ...
    * Sets dbName
    *
    * @param string $dbName 用户所在的数据库。 - 长度为1~64位，可以包含大写字母（A~Z）、小写字母（a~z）、数字（0~9）、下划线。
    *
    * @return $this
    */
