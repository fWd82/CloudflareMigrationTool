...
class RestoreNewInstanceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RestoreNewInstanceResponse';
    ...
    *  实例规格详情，与请求参数相同。
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\RestoreNewInstanceFlavorOption[]|null
    */
    ...
    * Sets flavor
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\RestoreNewInstanceFlavorOption[]|null $flavor 实例规格详情，与请求参数相同。
    *
    * @return $this
    */
