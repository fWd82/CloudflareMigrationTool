...
class DeleteSessionRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteSessionRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * sessions  需要终结的会话ID列表。
    *
    * @var string[]
    */
    ...
    * Sets sessions
    *
    * @param string[] $sessions 需要终结的会话ID列表。
    *
    * @return $this
    */
