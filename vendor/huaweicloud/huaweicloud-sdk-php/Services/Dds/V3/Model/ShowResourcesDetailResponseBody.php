...
class ShowResourcesDetailResponseBody implements ModelInterface, ArrayAccess
{
    ...
    * mode  实例类型： - 若值为“Single”，则表示单节点实例配额信息。 - 若值为“ReplicaSet”，则表示副本集实例配额信息。 - 若值为“Sharding”，则表示集群实例配额信息。
    * quota  当前配额值。
    * used  已使用的资源数。
    *
    * @var string[]
    ...
    * Sets mode
    *
    * @param string $mode 实例类型： - 若值为“Single”，则表示单节点实例配额信息。 - 若值为“ReplicaSet”，则表示副本集实例配额信息。 - 若值为“Sharding”，则表示集群实例配额信息。
    *
    * @return $this
    */
