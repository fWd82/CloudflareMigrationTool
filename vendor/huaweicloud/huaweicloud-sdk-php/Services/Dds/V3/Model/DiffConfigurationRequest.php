...
class DiffConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DiffConfigurationRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * sourceConfigurationId  需要进行比较的参数模板ID。
    * targetConfigurationId  需要进行比较的参数模板ID。
    *
    * @var string[]
    */
    ...
    *
    * @param string $sourceConfigurationId 需要进行比较的参数模板ID。
    *
    * @return $this
    */
    ...
    *
    * @param string $targetConfigurationId 需要进行比较的参数模板ID。
    *
    * @return $this
    */
