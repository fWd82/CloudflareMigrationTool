...
class ShrinkInstanceNodesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShrinkInstanceNodesRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dds\V3\Model\ReduceInstanceNodeRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\ReduceInstanceNodeRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\ReduceInstanceNodeRequestBody|null $body body
    *
    * @return $this
    */
