...
class CreateManualBackupRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'backup' => '\HuaweiCloud\SDK\Dds\V3\Model\CreateManualBackupOption'
    ];
    ...
    *  backup
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\CreateManualBackupOption
    */
    ...
    * Sets backup
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\CreateManualBackupOption $backup backup
    *
    * @return $this
    */
