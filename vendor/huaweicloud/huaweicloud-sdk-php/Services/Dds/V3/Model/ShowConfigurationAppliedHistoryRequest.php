...
class ShowConfigurationAppliedHistoryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowConfigurationAppliedHistoryRequest';
