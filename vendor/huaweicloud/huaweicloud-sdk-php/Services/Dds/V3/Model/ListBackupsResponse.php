...
class ListBackupsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'backups' => '\HuaweiCloud\SDK\Dds\V3\Model\BackupForList[]',
            'totalCount' => 'int'
    ];
    ...
    *  备份列表。
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\BackupForList[]|null
    */
    ...
    * Sets backups
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\BackupForList[]|null $backups 备份列表。
    *
    * @return $this
    */
