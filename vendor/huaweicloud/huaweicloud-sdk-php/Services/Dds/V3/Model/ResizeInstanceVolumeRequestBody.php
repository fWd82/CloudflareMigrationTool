...
class ResizeInstanceVolumeRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'volume' => '\HuaweiCloud\SDK\Dds\V3\Model\ResizeInstanceVolumeOption',
            'isAutoPay' => 'bool'
    ];
    ...
    *  volume
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\ResizeInstanceVolumeOption
    */
    ...
    * Sets volume
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\ResizeInstanceVolumeOption $volume volume
    *
    * @return $this
    */
