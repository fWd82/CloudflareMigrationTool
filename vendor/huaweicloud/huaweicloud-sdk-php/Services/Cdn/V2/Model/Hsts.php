...
class Hsts implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Hsts';
    ...
    *
    * @param string|null $includeSubdomains 包含子域名，on：包含，off：不包含。   > status参数为on时，必传。
    *
    * @return $this
    */
