...
class IpFrequencyLimit implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IpFrequencyLimit';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * status  状态，on：打开，off：关闭。
    * qps  访问阈值,单位：次/秒，取值范围：1-100000。   > 当开启ip限频时，访问阈值必填。
    *
    * @var string[]
    */
    ...
    * Sets qps
    *
    * @param int|null $qps 访问阈值,单位：次/秒，取值范围：1-100000。   > 当开启ip限频时，访问阈值必填。
    *
    * @return $this
    */
