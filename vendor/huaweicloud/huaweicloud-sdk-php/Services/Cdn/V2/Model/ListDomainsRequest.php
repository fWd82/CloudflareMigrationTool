...
class ListDomainsRequest implements ModelInterface, ArrayAccess
{
    ...
    * Sets pageSize
    *
    * @param int|null $pageSize 每页加速域名的数量，取值范围1-10000，默认值为30。
    *
    * @return $this
    */
    ...
    * Sets pageNumber
    *
    * @param int|null $pageNumber 查询的页码，即：从哪一页开始查询，取值范围1-65535，默认值为1。
    *
    * @return $this
    */
    ...
    * Sets exactMatch
    *
    * @param bool|null $exactMatch 精准匹配 true：开启 false：关闭。
    *
    * @return $this
    */
