...
class PreheatingTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'preheatingTask' => '\HuaweiCloud\SDK\Cdn\V2\Model\PreheatingTaskRequestBody'
    ];
    ...
    *  preheatingTask
    *
    * @return \HuaweiCloud\SDK\Cdn\V2\Model\PreheatingTaskRequestBody
    */
    ...
    * Sets preheatingTask
    *
    * @param \HuaweiCloud\SDK\Cdn\V2\Model\PreheatingTaskRequestBody $preheatingTask preheatingTask
    *
    * @return $this
    */
