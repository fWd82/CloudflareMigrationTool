...
class VerifyDomainOwnerRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VerifyDomainOwnerRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * verifyType  校验类型： - dns：DNS解析校验； - file：文件校验； - all：DNS与文件都会进行探测，默认为all。
    *
    * @var string[]
    */
    ...
    * Sets verifyType
    *
    * @param string|null $verifyType 校验类型： - dns：DNS解析校验； - file：文件校验； - all：DNS与文件都会进行探测，默认为all。
    *
    * @return $this
    */
