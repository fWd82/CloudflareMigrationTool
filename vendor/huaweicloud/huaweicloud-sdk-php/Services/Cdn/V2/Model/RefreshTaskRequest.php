...
class RefreshTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'refreshTask' => '\HuaweiCloud\SDK\Cdn\V2\Model\RefreshTaskRequestBody'
    ];
    ...
    *  refreshTask
    *
    * @return \HuaweiCloud\SDK\Cdn\V2\Model\RefreshTaskRequestBody
    */
    ...
    * Sets refreshTask
    *
    * @param \HuaweiCloud\SDK\Cdn\V2\Model\RefreshTaskRequestBody $refreshTask refreshTask
    *
    * @return $this
    */
