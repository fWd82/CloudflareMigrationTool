...
class ShowLogsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'logs' => '\HuaweiCloud\SDK\Cdn\V2\Model\LogObject[]'
    ];
    ...
    *  日志列表数据。
    *
    * @return \HuaweiCloud\SDK\Cdn\V2\Model\LogObject[]|null
    */
    ...
    * Sets logs
    *
    * @param \HuaweiCloud\SDK\Cdn\V2\Model\LogObject[]|null $logs 日志列表数据。
    *
    * @return $this
    */
