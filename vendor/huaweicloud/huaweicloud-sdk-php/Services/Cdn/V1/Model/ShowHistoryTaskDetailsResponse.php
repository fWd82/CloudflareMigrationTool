...
class ShowHistoryTaskDetailsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'taskType' => 'string',
            'status' => 'string',
            'urls' => '\HuaweiCloud\SDK\Cdn\V1\Model\UrlObject[]',
            'createTime' => 'int',
            'processing' => 'int',
            'succeed' => 'int',
            'failed' => 'int',
    ...
    *  本次提交的url列表。
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\UrlObject[]|null
    */
    ...
    * Sets urls
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\UrlObject[]|null $urls 本次提交的url列表。
    *
    * @return $this
    */
