...
class DomainItemLocationDetails implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'endTime' => 'int',
            'statType' => 'string',
            'domains' => '\HuaweiCloud\SDK\Cdn\V1\Model\DomainRegion[]'
    ];
    ...
    *  域名详情数据列表
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\DomainRegion[]|null
    */
    ...
    * Sets domains
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\DomainRegion[]|null $domains 域名详情数据列表
    *
    * @return $this
    */
