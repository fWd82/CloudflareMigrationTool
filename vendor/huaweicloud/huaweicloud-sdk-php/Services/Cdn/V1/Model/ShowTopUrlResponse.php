...
class ShowTopUrlResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'serviceArea' => 'string',
            'topUrlSummary' => '\HuaweiCloud\SDK\Cdn\V1\Model\TopUrlSummary[]'
    ];
    ...
    *  详情数据对象。
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\TopUrlSummary[]|null
    */
    ...
    * Sets topUrlSummary
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\TopUrlSummary[]|null $topUrlSummary 详情数据对象。
    *
    * @return $this
    */
