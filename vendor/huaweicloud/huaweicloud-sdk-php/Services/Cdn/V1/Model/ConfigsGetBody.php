...
class ConfigsGetBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'userAgentFilter' => '\HuaweiCloud\SDK\Cdn\V1\Model\UserAgentFilter',
            'originRequestUrlRewrite' => '\HuaweiCloud\SDK\Cdn\V1\Model\OriginRequestUrlRewrite[]',
            'flexibleOrigin' => '\HuaweiCloud\SDK\Cdn\V1\Model\FlexibleOrigins[]',
            'sliceEtagStatus' => 'string',
            'originReceiveTimeout' => 'int',
            'remoteAuth' => '\HuaweiCloud\SDK\Cdn\V1\Model\CommonRemoteAuth',
            'websocket' => '\HuaweiCloud\SDK\Cdn\V1\Model\WebSocketSeek',
            'videoSeek' => '\HuaweiCloud\SDK\Cdn\V1\Model\VideoSeek',
            'requestLimitRules' => '\HuaweiCloud\SDK\Cdn\V1\Model\RequestLimitRules[]',
            'ipFrequencyLimit' => '\HuaweiCloud\SDK\Cdn\V1\Model\IpFrequencyLimitQuery',
            'hsts' => '\HuaweiCloud\SDK\Cdn\V1\Model\HstsQuery',
            'quic' => '\HuaweiCloud\SDK\Cdn\V1\Model\Quic',
            'errorCodeRedirectRules' => '\HuaweiCloud\SDK\Cdn\V1\Model\ErrorCodeRedirectRules[]'
    ];
    ...
    *  userAgentFilter
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\UserAgentFilter|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\UserAgentFilter|null $userAgentFilter userAgentFilter
    *
    * @return $this
    */
    ...
    *  高级回源。
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\FlexibleOrigins[]|null
    */
    ...
    * Sets flexibleOrigin
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\FlexibleOrigins[]|null $flexibleOrigin 高级回源。
    *
    * @return $this
    */
    ...
    *  remoteAuth
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\CommonRemoteAuth|null
    */
    ...
    * Sets remoteAuth
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\CommonRemoteAuth|null $remoteAuth remoteAuth
    *
    * @return $this
    */
    ...
    *  websocket
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\WebSocketSeek|null
    */
    ...
    * Sets websocket
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\WebSocketSeek|null $websocket websocket
    *
    * @return $this
    */
    ...
    *  videoSeek
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\VideoSeek|null
    */
    ...
    * Sets videoSeek
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\VideoSeek|null $videoSeek videoSeek
    *
    * @return $this
    */
    ...
    *  请求限速。
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\RequestLimitRules[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\RequestLimitRules[]|null $requestLimitRules 请求限速。
    *
    * @return $this
    */
    ...
    *  ipFrequencyLimit
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\IpFrequencyLimitQuery|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\IpFrequencyLimitQuery|null $ipFrequencyLimit ipFrequencyLimit
    *
    * @return $this
    */
    ...
    *  hsts
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\HstsQuery|null
    */
    ...
    * Sets hsts
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\HstsQuery|null $hsts hsts
    *
    * @return $this
    */
    ...
    *  quic
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\Quic|null
    */
    ...
    * Sets quic
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\Quic|null $quic quic
    *
    * @return $this
    */
