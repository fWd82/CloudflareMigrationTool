...
class FlexibleOrigins implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'matchPattern' => 'string',
            'priority' => 'int',
            'backSources' => '\HuaweiCloud\SDK\Cdn\V1\Model\BackSources[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\BackSources[]
    */
    ...
    * Sets backSources
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\BackSources[] $backSources 回源信息。  > 每个目录的回源源站数量不超过1个。
    *
    * @return $this
    */
