...
class ModifyDomainConfigRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'configs' => '\HuaweiCloud\SDK\Cdn\V1\Model\Configs'
    ];
    ...
    *  configs
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\Configs|null
    */
    ...
    * Sets configs
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\Configs|null $configs configs
    *
    * @return $this
    */
