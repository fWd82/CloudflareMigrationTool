...
class RemoteAuthRuleVo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'reserveArgs' => 'string',
            'addCustomArgsRules' => '\HuaweiCloud\SDK\Cdn\V1\Model\CustomArgs[]',
            'reserveHeadersSetting' => 'string',
            'addCustomHeadersRules' => '\HuaweiCloud\SDK\Cdn\V1\Model\CustomArgs[]',
    ...
    *  URL鉴权参数
    *
    * @return \HuaweiCloud\SDK\Cdn\V1\Model\CustomArgs[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\CustomArgs[]|null $addCustomArgsRules URL鉴权参数
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cdn\V1\Model\CustomArgs[]|null $addCustomHeadersRules 请求头鉴权参数
    *
    * @return $this
    */
