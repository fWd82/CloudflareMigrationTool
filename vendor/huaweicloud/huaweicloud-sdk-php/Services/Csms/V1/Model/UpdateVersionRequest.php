...
class UpdateVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'secretName' => 'string',
            'versionId' => 'string',
            'body' => '\HuaweiCloud\SDK\Csms\V1\Model\UpdateVersionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Csms\V1\Model\UpdateVersionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Csms\V1\Model\UpdateVersionRequestBody|null $body body
    *
    * @return $this
    */
