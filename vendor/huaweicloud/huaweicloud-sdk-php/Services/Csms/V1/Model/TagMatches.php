...
class TagMatches implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TagMatches';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  为要匹配的字段。 约束：值只能为resource_name。
    * value  模糊匹配的值。  约束：最大长度为255个字符，为空返回空值。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['key']) && !preg_match("/resource_name/", $this->container['key'])) {
                $invalidProperties[] = "invalid value for 'key', must be conform to the pattern /resource_name/.";
            }
    ...
    * Sets key
    *
    * @param string|null $key 为要匹配的字段。 约束：值只能为resource_name。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string|null $value 模糊匹配的值。  约束：最大长度为255个字符，为空返回空值。
    *
    * @return $this
    */
