...
class CreateSecretVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSecretVersionRequest';
    ...
    */
    protected static $openAPITypes = [
            'secretName' => 'string',
            'body' => '\HuaweiCloud\SDK\Csms\V1\Model\CreateSecretVersionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Csms\V1\Model\CreateSecretVersionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Csms\V1\Model\CreateSecretVersionRequestBody|null $body body
    *
    * @return $this
    */
