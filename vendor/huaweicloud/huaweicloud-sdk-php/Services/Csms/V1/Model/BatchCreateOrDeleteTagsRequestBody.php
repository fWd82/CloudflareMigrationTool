...
class BatchCreateOrDeleteTagsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateOrDeleteTagsRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * tags  标签列表，key和value键值对的集合。
    * action  操作标识： 仅限于“create”和“delete”。
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Csms\V1\Model\TagItem[] $tags 标签列表，key和value键值对的集合。
    *
    * @return $this
    */
