...
class UploadSecretBlobRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UploadSecretBlobRequestBody';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['secretBlob'] === null) {
            $invalidProperties[] = "'secretBlob' can't be null";
        }
            if ((mb_strlen($this->container['secretBlob']) > 5242880)) {
                $invalidProperties[] = "invalid value for 'secretBlob', the character length must be smaller than or equal to 5242880.";
            }
            if ((mb_strlen($this->container['secretBlob']) < 0)) {
    ...
    * Sets secretBlob
    *
    * @param string $secretBlob 将指定凭据对象进行备份后得到的凭据备份文件，备份文件包含有凭据当前所有的凭据版本信息，备份文件经过加密与编码，内容不可直接读。
    *
    * @return $this
    */
