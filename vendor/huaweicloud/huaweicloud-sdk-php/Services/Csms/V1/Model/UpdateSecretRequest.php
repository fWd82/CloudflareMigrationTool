...
class UpdateSecretRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'secretName' => 'string',
            'body' => '\HuaweiCloud\SDK\Csms\V1\Model\UpdateSecretRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Csms\V1\Model\UpdateSecretRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Csms\V1\Model\UpdateSecretRequestBody|null $body body
    *
    * @return $this
    */
