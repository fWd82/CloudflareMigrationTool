...
class AcceptOrRejectEndpointRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AcceptOrRejectEndpointRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Vpcep\V1\Model\AcceptOrRejectEndpointRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpcep\V1\Model\AcceptOrRejectEndpointRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpcep\V1\Model\AcceptOrRejectEndpointRequestBody|null $body body
    *
    * @return $this
    */
