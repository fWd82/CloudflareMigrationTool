...
class BatchRemoveEndpointServicePermissionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchRemoveEndpointServicePermissionsRequest';
