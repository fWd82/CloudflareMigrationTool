...
class UpdateEndpointServiceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateEndpointServiceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Vpcep\V1\Model\UpdateEndpointServiceRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpcep\V1\Model\UpdateEndpointServiceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpcep\V1\Model\UpdateEndpointServiceRequestBody|null $body body
    *
    * @return $this
    */
