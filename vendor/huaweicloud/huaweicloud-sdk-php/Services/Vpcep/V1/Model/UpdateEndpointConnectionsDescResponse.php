...
class UpdateEndpointConnectionsDescResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateEndpointConnectionsDescResponse';
