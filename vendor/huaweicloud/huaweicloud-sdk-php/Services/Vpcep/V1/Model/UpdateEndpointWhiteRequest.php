...
class UpdateEndpointWhiteRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateEndpointWhiteRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Vpcep\V1\Model\UpdateEndpointWhiteRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpcep\V1\Model\UpdateEndpointWhiteRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpcep\V1\Model\UpdateEndpointWhiteRequestBody|null $body body
    *
    * @return $this
    */
