...
class ListEndpointServiceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEndpointServiceResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * endpointServices  终端节点服务列表
    * totalCount  满足查询条件的终端节点服务总条数，不受分页（即limit、offset参数）影响。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'endpointServices' => '\HuaweiCloud\SDK\Vpcep\V1\Model\ServiceList[]',
            'totalCount' => 'int'
    ];
    ...
    *  终端节点服务列表
    *
    * @return \HuaweiCloud\SDK\Vpcep\V1\Model\ServiceList[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Vpcep\V1\Model\ServiceList[]|null $endpointServices 终端节点服务列表
    *
    * @return $this
    */
    ...
    * Sets totalCount
    *
    * @param int|null $totalCount 满足查询条件的终端节点服务总条数，不受分页（即limit、offset参数）影响。
    *
    * @return $this
    */
