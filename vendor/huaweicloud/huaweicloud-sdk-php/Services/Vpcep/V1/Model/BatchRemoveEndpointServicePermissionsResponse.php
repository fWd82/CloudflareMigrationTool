...
class BatchRemoveEndpointServicePermissionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchRemoveEndpointServicePermissionsResponse';
