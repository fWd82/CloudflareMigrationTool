...
class UpdateEndpointServicePermissionDescRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateEndpointServicePermissionDescRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['permissionId'] === null) {
            ...
            if ((mb_strlen($this->container['permissionId']) > 64)) {
                $invalidProperties[] = "invalid value for 'permissionId', the character length must be smaller than or equal to 64.";
            }
