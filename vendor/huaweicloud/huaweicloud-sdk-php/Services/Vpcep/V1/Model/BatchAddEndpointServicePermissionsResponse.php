...
class BatchAddEndpointServicePermissionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchAddEndpointServicePermissionsResponse';
