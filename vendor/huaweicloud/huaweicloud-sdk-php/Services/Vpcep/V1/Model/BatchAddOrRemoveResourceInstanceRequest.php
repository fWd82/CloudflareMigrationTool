...
class BatchAddOrRemoveResourceInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchAddOrRemoveResourceInstanceRequest';
