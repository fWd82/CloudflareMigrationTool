...
class ListServicePublicDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListServicePublicDetailsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  项目ID。
    * limit  查询返回公共的终端节点服务数量限制，即每页返回的个数。 取值范围：0~1000，取值一般为10，20或者50，默认为10。
    ...
    * Sets limit
    *
    * @param int|null $limit 查询返回公共的终端节点服务数量限制，即每页返回的个数。 取值范围：0~1000，取值一般为10，20或者50，默认为10。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $endpointServiceName 公共终端节点服务的名称，支持大小写以及模糊匹配。
    *
    * @return $this
    */
