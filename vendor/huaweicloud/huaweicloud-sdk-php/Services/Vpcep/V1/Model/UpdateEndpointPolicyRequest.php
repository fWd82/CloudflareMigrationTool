...
class UpdateEndpointPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateEndpointPolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Vpcep\V1\Model\UpdateEndpointPolicyRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpcep\V1\Model\UpdateEndpointPolicyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpcep\V1\Model\UpdateEndpointPolicyRequestBody|null $body body
    *
    * @return $this
    */
