...
class UpdateEndpointRoutetableRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateEndpointRoutetableRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Vpcep\V1\Model\UpdateEndpointRoutetableRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpcep\V1\Model\UpdateEndpointRoutetableRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpcep\V1\Model\UpdateEndpointRoutetableRequestBody|null $body body
    *
    * @return $this
    */
