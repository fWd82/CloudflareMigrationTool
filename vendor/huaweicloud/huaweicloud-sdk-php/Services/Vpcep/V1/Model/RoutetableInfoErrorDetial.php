...
class RoutetableInfoErrorDetial implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RoutetableInfoErrorDetial';
    ...
    * Sets errorMessage
    *
    * @param string|null $errorMessage 详细错误信息。
    *
    * @return $this
    */
