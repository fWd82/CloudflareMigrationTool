...
class ShowServerRemoteConsoleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'remoteConsole' => '\HuaweiCloud\SDK\Ecs\V2\Model\GetServerRemoteConsoleOption'
    ];
    ...
    *  remoteConsole
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\GetServerRemoteConsoleOption
    */
    ...
    * Sets remoteConsole
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\GetServerRemoteConsoleOption $remoteConsole remoteConsole
    *
    * @return $this
    */
