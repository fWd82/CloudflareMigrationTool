...
class CreatePostPaidServersRequest implements ModelInterface, ArrayAccess
{
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\CreatePostPaidServersRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\CreatePostPaidServersRequestBody|null $body body
    *
    * @return $this
    */
