...
class NovaCreateKeypairRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Ecs\V2\Model\NovaCreateKeypairRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\NovaCreateKeypairRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\NovaCreateKeypairRequestBody|null $body body
    *
    * @return $this
    */
