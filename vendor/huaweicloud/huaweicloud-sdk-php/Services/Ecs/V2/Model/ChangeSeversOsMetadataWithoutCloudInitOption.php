...
class ChangeSeversOsMetadataWithoutCloudInitOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeSeversOsMetadataWithoutCloudInitOption';
