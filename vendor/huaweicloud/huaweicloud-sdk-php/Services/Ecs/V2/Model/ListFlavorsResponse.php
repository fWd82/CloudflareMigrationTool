...
class ListFlavorsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'flavors' => '\HuaweiCloud\SDK\Ecs\V2\Model\Flavor[]'
    ];
    ...
    *  云服务器规格列表。
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\Flavor[]|null
    */
    ...
    * Sets flavors
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\Flavor[]|null $flavors 云服务器规格列表。
    *
    * @return $this
    */
