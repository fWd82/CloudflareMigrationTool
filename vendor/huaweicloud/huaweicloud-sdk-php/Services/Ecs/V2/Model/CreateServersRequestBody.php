...
class CreateServersRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'server' => '\HuaweiCloud\SDK\Ecs\V2\Model\PrePaidServer'
    ];
    ...
    *  server
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\PrePaidServer
    */
    ...
    * Sets server
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\PrePaidServer $server server
    *
    * @return $this
    */
