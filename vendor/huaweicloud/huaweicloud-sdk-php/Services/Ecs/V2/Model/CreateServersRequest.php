...
class CreateServersRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'xClientToken' => 'string',
            'body' => '\HuaweiCloud\SDK\Ecs\V2\Model\CreateServersRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\CreateServersRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\CreateServersRequestBody|null $body body
    *
    * @return $this
    */
