...
class PrePaidServerDataVolume implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'multiattach' => 'bool',
            'hwpassthrough' => 'bool',
            'extendparam' => '\HuaweiCloud\SDK\Ecs\V2\Model\PrePaidServerDataVolumeExtendParam',
            'clusterType' => 'string',
            'clusterId' => 'string',
    ...
    * Sets volumetype
    *
    * @param string $volumetype 云服务器数据盘对应的磁盘类型，需要与系统所提供的磁盘类型相匹配。   - SATA：普通IO磁盘类型。  - SAS：高IO磁盘类型。  - SSD：超高IO磁盘类型。  - GPSSD：为通用型SSD磁盘类型。  - co-p1：高IO (性能优化Ⅰ型)。  - uh-l1：超高IO (时延优化)。  - ESSD：为极速IO磁盘类型。  - GPSSD2：通用型SSD V2磁盘类型。  - ESSD2：极速型SSD V2磁盘类型。   > 说明： >  > 对于HANA云服务器、HL1型云服务器、HL2型云服务器，需使用co-p1和uh-l1两种磁盘类型。对于其他类型的云服务器，不能使用co-p1和uh-l1两种磁盘类型。  了解不同磁盘类型的详细信息，请参见 [磁盘类型及性能介绍](https://support.huaweicloud.com/productdesc-evs/zh-cn_topic_0044524691.html)。  获取region可用的卷类型，请参见[查询云硬盘类型列表](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=EVS&api=CinderListVolumeTypes)
    *
    * @return $this
    */
    ...
    *  extendparam
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\PrePaidServerDataVolumeExtendParam|null
    */
    ...
    * Sets extendparam
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\PrePaidServerDataVolumeExtendParam|null $extendparam extendparam
    *
    * @return $this
    */
    ...
    *  metadata
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\PrePaidServerDataVolumeMetadata|null
    */
    ...
    * Sets metadata
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\PrePaidServerDataVolumeMetadata|null $metadata metadata
    *
    * @return $this
    */
