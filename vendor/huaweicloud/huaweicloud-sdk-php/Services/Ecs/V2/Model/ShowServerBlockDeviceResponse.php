...
class ShowServerBlockDeviceResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'volumeAttachment' => '\HuaweiCloud\SDK\Ecs\V2\Model\ServerBlockDevice'
    ];
    ...
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\ServerBlockDevice|null $volumeAttachment volumeAttachment
    *
    * @return $this
    */
