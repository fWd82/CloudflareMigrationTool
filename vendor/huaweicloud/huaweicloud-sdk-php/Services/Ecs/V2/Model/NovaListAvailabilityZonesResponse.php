...
class NovaListAvailabilityZonesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'availabilityZoneInfo' => '\HuaweiCloud\SDK\Ecs\V2\Model\NovaAvailabilityZone[]'
    ];
    ...
    *  可用域信息。
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\NovaAvailabilityZone[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\NovaAvailabilityZone[]|null $availabilityZoneInfo 可用域信息。
    *
    * @return $this
    */
