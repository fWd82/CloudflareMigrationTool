...
class ReinstallSeverMetadataWithoutCloudInitOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReinstallSeverMetadataWithoutCloudInitOption';
