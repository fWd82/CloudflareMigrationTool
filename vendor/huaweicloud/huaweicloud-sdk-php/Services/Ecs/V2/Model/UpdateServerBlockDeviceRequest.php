...
class UpdateServerBlockDeviceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateServerBlockDeviceRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * serverId  云服务器ID。
    * volumeId  磁盘id，uuid格式
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'serverId' => 'string',
            'volumeId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ecs\V2\Model\UpdateServerBlockDeviceReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\UpdateServerBlockDeviceReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\UpdateServerBlockDeviceReq|null $body body
    *
    * @return $this
    */
