...
class ResetServerPasswordRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resetPassword' => '\HuaweiCloud\SDK\Ecs\V2\Model\ResetServerPasswordOption'
    ];
    ...
    * Sets resetPassword
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\ResetServerPasswordOption $resetPassword resetPassword
    *
    * @return $this
    */
