...
class BatchDeleteServerNicsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'nics' => '\HuaweiCloud\SDK\Ecs\V2\Model\BatchDeleteServerNicOption[]'
    ];
    ...
    * Sets nics
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\BatchDeleteServerNicOption[] $nics 需要删除的网卡列表信息。  说明： 主网卡是弹性云服务器上配置了路由规则的网卡，不可删除。
    *
    * @return $this
    */
