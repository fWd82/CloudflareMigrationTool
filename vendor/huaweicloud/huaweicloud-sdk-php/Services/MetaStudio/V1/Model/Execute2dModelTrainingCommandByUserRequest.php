...
class Execute2dModelTrainingCommandByUserRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Execute2dModelTrainingCommandByUserRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'xAppUserId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\Execute2dModelTrainingCommandByUserReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\Execute2dModelTrainingCommandByUserReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\Execute2dModelTrainingCommandByUserReq|null $body body
    *
    * @return $this
    */
