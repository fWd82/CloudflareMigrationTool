...
class UpdateInteractionRuleGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInteractionRuleGroupResponse';
    ...
    * Sets groupName
    *
    * @param string|null $groupName 互动规则库名称
    *
    * @return $this
    */
