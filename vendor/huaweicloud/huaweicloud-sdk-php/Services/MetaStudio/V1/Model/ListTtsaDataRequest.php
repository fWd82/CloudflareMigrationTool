...
class ListTtsaDataRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTtsaDataRequest';
    ...
    * offset  偏移量，表示生成内容时间偏移，目前每次返回2秒内容。
    *
    * @var string[]
    */
    ...
    * Sets offset
    *
    * @param int|null $offset 偏移量，表示生成内容时间偏移，目前每次返回2秒内容。
    *
    * @return $this
    */
