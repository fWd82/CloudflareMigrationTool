...
class UpdateDigitalHumanBusinessCardResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDigitalHumanBusinessCardResponse';
