...
class ConfirmTrainingSegmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ConfirmTrainingSegmentRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['index'] === null) {
            ...
            if (($this->container['index'] > 1024)) {
                $invalidProperties[] = "invalid value for 'index', must be smaller than or equal to 1024.";
            }
