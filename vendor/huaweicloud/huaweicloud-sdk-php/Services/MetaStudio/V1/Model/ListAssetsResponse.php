...
class ListAssetsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    *  资产信息列表。
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\DigitalAssetInfo[]|null
    */
    ...
    * Sets assets
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\DigitalAssetInfo[]|null $assets 资产信息列表。
    *
    * @return $this
    */
