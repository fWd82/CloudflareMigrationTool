...
class ListTtsaJobsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTtsaJobsResponse';
    ...
    *  语音驱动任务列表。
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\TTSAJob[]|null
    */
    public function getTtsaJobs()
    {
        return $this->container['ttsaJobs'];
    }

    /**
    * Sets ttsaJobs
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\TTSAJob[]|null $ttsaJobs 语音驱动任务列表。
    *
    * @return $this
    */
