...
class CreateDigitalAssetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDigitalAssetRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\CreateDigitalAssetRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\CreateDigitalAssetRequestBody|null $body body
    *
    * @return $this
    */
