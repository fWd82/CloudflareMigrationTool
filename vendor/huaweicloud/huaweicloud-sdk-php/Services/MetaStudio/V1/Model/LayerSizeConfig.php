...
class LayerSizeConfig implements ModelInterface, ArrayAccess
{
    ...
    * width  图层图片宽度像素值（相对画布大小）。 > 横屏（16:9）画布像素为1920x1080；竖屏（9:16）画布像素为1080x1920。
    * height  图层图片高度像素值（相对画布大小）。 > 横屏（16:9）画布像素为1920x1080；竖屏（9:16）画布像素为1080x1920。
    *
    * @var string[]
    */
    ...
    * Sets width
    *
    * @param int|null $width 图层图片宽度像素值（相对画布大小）。 > 横屏（16:9）画布像素为1920x1080；竖屏（9:16）画布像素为1080x1920。
    *
    * @return $this
    */
    ...
    * Sets height
    *
    * @param int|null $height 图层图片高度像素值（相对画布大小）。 > 横屏（16:9）画布像素为1920x1080；竖屏（9:16）画布像素为1080x1920。
    *
    * @return $this
    */
