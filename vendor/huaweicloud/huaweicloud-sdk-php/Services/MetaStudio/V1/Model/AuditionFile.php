...
class AuditionFile implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AuditionFile';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * downloadUrl  试听文件下载链接，有效期为1个小时。
    *
    * @var string[]
    */
    ...
    * Sets downloadUrl
    *
    * @param string $downloadUrl 试听文件下载链接，有效期为1个小时。
    *
    * @return $this
    */
