...
class CreateTrainingAdvanceJobRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTrainingAdvanceJobRequest';
    ...
    */
    protected static $openAPITypes = [
            'xAppUserId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\CreateTrainingJobReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\CreateTrainingJobReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\CreateTrainingJobReq|null $body body
    *
    * @return $this
    */
