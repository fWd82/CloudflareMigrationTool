...
class LiveEventReportResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LiveEventReportResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * liveEventReportUrl  刷新后的直播事件上传URL
    ...
    *
    * @param string|null $liveEventReportUrl 刷新后的直播事件上传URL
    *
    * @return $this
    */
