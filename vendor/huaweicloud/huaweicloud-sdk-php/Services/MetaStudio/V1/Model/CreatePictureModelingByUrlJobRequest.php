...
class CreatePictureModelingByUrlJobRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePictureModelingByUrlJobRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\PictureModelingByUrlReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\PictureModelingByUrlReq|null $body body
    *
    * @return $this
    */
