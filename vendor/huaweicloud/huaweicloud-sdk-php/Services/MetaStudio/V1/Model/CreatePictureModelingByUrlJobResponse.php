...
class CreatePictureModelingByUrlJobResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePictureModelingByUrlJobResponse';
