...
class UpdateInteractionRuleGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInteractionRuleGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xAppUserId' => 'string',
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\InteractionRuleGroup'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\InteractionRuleGroup|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\InteractionRuleGroup|null $body body
    *
    * @return $this
    */
