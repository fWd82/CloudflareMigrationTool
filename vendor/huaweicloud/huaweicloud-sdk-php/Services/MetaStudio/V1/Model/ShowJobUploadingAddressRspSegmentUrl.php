...
class ShowJobUploadingAddressRspSegmentUrl implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowJobUploadingAddressRsp_segment_url';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * audioUploadingUrl  音频上传的地址。 > * 通过该obs地址上传时需要设置content-type为audio/wav
    * txtUploadingUrl  文本上传的地址。 > * 通过该obs地址上传时需要设置content-type为text/plain
    *
    * @var string[]
    */
    ...
    *
    * @param string[]|null $audioUploadingUrl 音频上传的地址。 > * 通过该obs地址上传时需要设置content-type为audio/wav
    *
    * @return $this
    */
    ...
    *
    * @param string[]|null $txtUploadingUrl 文本上传的地址。 > * 通过该obs地址上传时需要设置content-type为text/plain
    *
    * @return $this
    */
