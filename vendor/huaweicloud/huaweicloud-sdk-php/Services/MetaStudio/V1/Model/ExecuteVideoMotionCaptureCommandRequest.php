...
class ExecuteVideoMotionCaptureCommandRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteVideoMotionCaptureCommandRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'xAppUserId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\ControlDigitalHumanLiveReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\ControlDigitalHumanLiveReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\ControlDigitalHumanLiveReq|null $body body
    *
    * @return $this
    */
