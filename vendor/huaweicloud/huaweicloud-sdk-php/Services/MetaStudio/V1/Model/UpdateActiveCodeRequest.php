...
class UpdateActiveCodeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateActiveCodeRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xAppUserId' => 'string',
            'activeCodeId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateActiveCodeReq'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['activeCodeId'] === null) {
            $invalidProperties[] = "'activeCodeId' can't be null";
        }
            if ((mb_strlen($this->container['activeCodeId']) > 64)) {
                $invalidProperties[] = "invalid value for 'activeCodeId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['activeCodeId']) < 1)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateActiveCodeReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateActiveCodeReq|null $body body
    *
    * @return $this
    */
