...
class ListDigitalHumanVideoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDigitalHumanVideoRequest';
    ...
    * Sets assetName
    *
    * @param string|null $assetName 输出视频资产名称。
    *
    * @return $this
    */
