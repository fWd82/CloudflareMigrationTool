...
class ListDigitalHumanBusinessCardRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDigitalHumanBusinessCardRequest';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['videoAssetName']) && (mb_strlen($this->container['videoAssetName']) < 0)) {
                $invalidProperties[] = "invalid value for 'videoAssetName', the character length must be bigger than or equal to 0.";
            }
    ...
    * Sets videoAssetName
    *
    * @param string|null $videoAssetName 输出的视频资产名称。
    *
    * @return $this
    */
