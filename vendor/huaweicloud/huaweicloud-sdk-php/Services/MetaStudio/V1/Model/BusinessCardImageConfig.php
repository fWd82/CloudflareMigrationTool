...
class BusinessCardImageConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BusinessCardImageConfig';
    ...
    * Sets humanImage
    *
    * @param string $humanImage 人物照片，需要Base64编码。
    *
    * @return $this
    */
    ...
    * Sets logoImage
    *
    * @param string|null $logoImage Logo图片，需要Base64编码。
    *
    * @return $this
    */
