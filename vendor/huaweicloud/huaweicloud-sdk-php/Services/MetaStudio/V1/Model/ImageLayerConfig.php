...
class ImageLayerConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImageLayerConfig';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['imageUrl']) && (mb_strlen($this->container['imageUrl']) > 2048)) {
    ...
    * Sets imageUrl
    *
    * @param string|null $imageUrl 图片文件的URL。
    *
    * @return $this
    */
