...
class DeleteAssetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteAssetRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['assetId'] === null) {
            ...
            if (!is_null($this->container['mode']) && !preg_match("/force/", $this->container['mode'])) {
                $invalidProperties[] = "invalid value for 'mode', must be conform to the pattern /force/.";
            }
