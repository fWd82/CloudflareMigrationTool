...
class CreateDigitalHumanBusinessCardRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDigitalHumanBusinessCardRequest';
