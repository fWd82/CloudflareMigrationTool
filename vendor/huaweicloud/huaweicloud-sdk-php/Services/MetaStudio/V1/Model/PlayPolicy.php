...
class PlayPolicy implements ModelInterface, ArrayAccess
{
    ...
    * Sets repeatCount
    *
    * @param int|null $repeatCount 剧本重复播放次数。 -1表示持续重复，直至人工停止 0 表示不重复，仅执行一次 其他值n，实际运行次数为n+1次
    *
    * @return $this
    */
    ...
    * Sets autoPlayScript
    *
    * @param bool|null $autoPlayScript 是否自动播放剧本。 true: 服务完成任务初始化后，自动播放剧本 false: 服务完成任务初始化后，等待信号后再开始播放剧本
    *
    * @return $this
    */
