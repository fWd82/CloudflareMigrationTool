...
class ListInteractionRuleGroupsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInteractionRuleGroupsRequest';
    ...
    * Sets groupName
    *
    * @param string|null $groupName 规则库名称
    *
    * @return $this
    */
