...
class CopyVideoScriptsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CopyVideoScriptsResponse';
    ...
    * Sets scriptId
    *
    * @param string|null $scriptId 新剧本ID
    *
    * @return $this
    */
