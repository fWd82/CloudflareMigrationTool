...
class IflytekSpark implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IflytekSpark';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * appId  星火大模型应用ID。
    * appKey  星火大模型应用密钥。
    * apiSecret  星火大模型API密钥。
    *
    * @var string[]
    */
    ...
    * Sets appId
    *
    * @param string|null $appId 星火大模型应用ID。
    *
    * @return $this
    */
    ...
    * Sets appKey
    *
    * @param string|null $appKey 星火大模型应用密钥。
    *
    * @return $this
    */
    ...
    * Sets apiSecret
    *
    * @param string|null $apiSecret 星火大模型API密钥。
    *
    * @return $this
    */
