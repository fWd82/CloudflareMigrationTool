...
class ConfirmFileUploadRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ConfirmFileUploadRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xAppUserId' => 'string',
            'fileId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\ConfirmFileUploadRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\ConfirmFileUploadRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\ConfirmFileUploadRequestBody|null $body body
    *
    * @return $this
    */
