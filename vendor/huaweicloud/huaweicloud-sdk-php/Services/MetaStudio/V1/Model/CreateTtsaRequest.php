...
class CreateTtsaRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTtsaRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\CreateTTSAReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\CreateTTSAReq|null $body body
    *
    * @return $this
    */
