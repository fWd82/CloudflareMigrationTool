...
class UpdateVocabularyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVocabularyRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * vocabularyId  被更新的热词表id。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'vocabularyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Sis\V1\Model\PutUpdateVocabReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Sis\V1\Model\PutUpdateVocabReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Sis\V1\Model\PutUpdateVocabReq|null $body body
    *
    * @return $this
    */
