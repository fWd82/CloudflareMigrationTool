...
class RecognizeShortAudioResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RecognizeShortAudioResponse';
    ...
    */
    protected static $openAPITypes = [
            'traceId' => 'string',
            'result' => '\HuaweiCloud\SDK\Sis\V1\Model\Result'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\Sis\V1\Model\Result|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\Sis\V1\Model\Result|null $result result
    *
    * @return $this
    */
