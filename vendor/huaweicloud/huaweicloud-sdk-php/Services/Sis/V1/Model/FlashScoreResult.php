...
class FlashScoreResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FlashScoreResult';
    ...
    * Sets score
    *
    * @param double $score 调用成功表示识别出的置信度，取值范围：0~1。
    *
    * @return $this
    */
