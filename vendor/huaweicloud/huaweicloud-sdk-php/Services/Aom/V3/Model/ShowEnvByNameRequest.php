...
class ShowEnvByNameRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowEnvByNameRequest';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['environmentName'] === null) {
            $invalidProperties[] = "'environmentName' can't be null";
        }
