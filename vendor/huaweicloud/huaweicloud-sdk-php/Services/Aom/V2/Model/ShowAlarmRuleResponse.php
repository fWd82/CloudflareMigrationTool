...
class ShowAlarmRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAlarmRuleResponse';
    ...
    * Sets thresholds
    *
    * @param \HuaweiCloud\SDK\Aom\V2\Model\QueryAlarmResult[]|null $thresholds 阈值规则列表。
    *
    * @return $this
    */
