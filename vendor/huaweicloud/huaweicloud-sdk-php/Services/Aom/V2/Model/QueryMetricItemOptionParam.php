...
class QueryMetricItemOptionParam implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'QueryMetricItemOptionParam';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dimensions  指标维度列表。
    * metricName  指标名称。名称长度取值范围为1~255个字符。取值范围：AOM提供的基础指标，cpuUsage、cpuCoreUsed等。cpuUsage：cpu使用率；cpuCoreUsed：cpu内核占用；用户上报的自定义指标名称。
    ...
    */
    ...
    const MODEL_NAMESPACE_PAAS_CONTAINER = 'PAAS.CONTAINER';
    const MODEL_NAMESPACE_PAAS_NODE = 'PAAS.NODE';
    const MODEL_NAMESPACE_PAAS_SLA = 'PAAS.SLA';
    const MODEL_NAMESPACE_PAAS_AGGR = 'PAAS.AGGR';
    const MODEL_NAMESPACE_CUSTOMMETRICS = 'CUSTOMMETRICS';
    ...
    */
    ...
    {
        return [
            self::MODEL_NAMESPACE_PAAS_CONTAINER,
            self::MODEL_NAMESPACE_PAAS_NODE,
            self::MODEL_NAMESPACE_PAAS_SLA,
            self::MODEL_NAMESPACE_PAAS_AGGR,
            self::MODEL_NAMESPACE_CUSTOMMETRICS,
        ];
    }
    ...
    * Sets metricName
    *
    * @param string|null $metricName 指标名称。名称长度取值范围为1~255个字符。取值范围：AOM提供的基础指标，cpuUsage、cpuCoreUsed等。cpuUsage：cpu使用率；cpuCoreUsed：cpu内核占用；用户上报的自定义指标名称。
    *
    * @return $this
    */
