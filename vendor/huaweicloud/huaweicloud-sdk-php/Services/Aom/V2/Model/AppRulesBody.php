...
class AppRulesBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AppRulesBody';
    ...
    * Sets appRules
    *
    * @param \HuaweiCloud\SDK\Aom\V2\Model\AppRules[]|null $appRules 服务参数。
    *
    * @return $this
    */
