...
class ShowActionRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowActionRuleResponse';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['notificationTemplate']) && (mb_strlen($this->container['notificationTemplate']) > 100)) {
                $invalidProperties[] = "invalid value for 'notificationTemplate', the character length must be smaller than or equal to 100.";
            }
            if (!is_null($this->container['notificationTemplate']) && (mb_strlen($this->container['notificationTemplate']) < 1)) {
    ...
    * Sets userName
    *
    * @param string|null $userName 子账号名称
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type 规则类型。\"1\"：通知，\"2\"：用户
    *
    * @return $this
    */
    ...
    *
    * @param string|null $notificationTemplate 消息模板
    *
    * @return $this
    */
    ...
    * Sets smnTopics
    *
    * @param \HuaweiCloud\SDK\Aom\V2\Model\SmnTopics[]|null $smnTopics SMN主题信息，不能大于5
    *
    * @return $this
    */
