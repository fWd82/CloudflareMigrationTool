...
class CountEventsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CountEventsRequest';
    ...
    */
    protected static $openAPITypes = [
            'type' => 'string',
            'body' => '\HuaweiCloud\SDK\Aom\V2\Model\EventQueryParam'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aom\V2\Model\EventQueryParam|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aom\V2\Model\EventQueryParam|null $body body
    *
    * @return $this
    */
