...
class EventQueryParam2 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EventQueryParam2';
    ...
    * search  模糊查询匹配字段，可以为空。如果值不为空，可以模糊匹配。metadata字段为必选字段。
    * sort  sort
    ...
    */
    protected static $openAPITypes = [
            ...
            'step' => 'int',
            'search' => 'string',
            'sort' => '\HuaweiCloud\SDK\Aom\V2\Model\EventQueryParam2Sort',
    ...
    * Sets search
    *
    * @param string|null $search 模糊查询匹配字段，可以为空。如果值不为空，可以模糊匹配。metadata字段为必选字段。
    *
    * @return $this
    */
    ...
    *  sort
    *
    * @return \HuaweiCloud\SDK\Aom\V2\Model\EventQueryParam2Sort|null
    */
    ...
    * Sets sort
    *
    * @param \HuaweiCloud\SDK\Aom\V2\Model\EventQueryParam2Sort|null $sort sort
    *
    * @return $this
    */
