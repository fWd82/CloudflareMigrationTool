...
class ListInstantQueryAomPromPostRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstantQueryAomPromPostRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * query  PromQL表达式(参考https://prometheus.io/docs/prometheus/latest/querying/basics/)。
    * time  指定用于计算 PromQL 的时间戳，(Unix时间戳格式，单位：秒）。
    *
    * @var string[]
    */
    ...
    * Sets time
    *
    * @param string|null $time 指定用于计算 PromQL 的时间戳，(Unix时间戳格式，单位：秒）。
    *
    * @return $this
    */
