...
class UpdateAlarmRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAlarmRuleResponse';
    ...
    * Sets alarmRuleId
    *
    * @param int|null $alarmRuleId 阈值规则id。
    *
    * @return $this
    */
