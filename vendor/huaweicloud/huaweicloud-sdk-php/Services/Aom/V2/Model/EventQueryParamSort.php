...
class EventQueryParamSort implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EventQueryParam_sort';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * orderBy  排序字段列表。会根据列表中定义顺序对返回列表进行排序。
    ...
    * Sets orderBy
    *
    * @param string[]|null $orderBy 排序字段列表。会根据列表中定义顺序对返回列表进行排序。
    *
    * @return $this
    */
