...
class ListAllScriptByNameResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAllScriptByNameResponse';
    ...
    */
    protected static $openAPITypes = [
            'elements' => '\HuaweiCloud\SDK\Aom\V1\Model\Script[]',
            'totalElements' => 'int'
    ];
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['totalElements']) && ($this->container['totalElements'] > 99999999)) {
                $invalidProperties[] = "invalid value for 'totalElements', must be smaller than or equal to 99999999.";
            }
    ...
    *  查询结果集合。
    *
    * @return \HuaweiCloud\SDK\Aom\V1\Model\Script[]|null
    */
    ...
    * Sets elements
    *
    * @param \HuaweiCloud\SDK\Aom\V1\Model\Script[]|null $elements 查询结果集合。
    *
    * @return $this
    */
