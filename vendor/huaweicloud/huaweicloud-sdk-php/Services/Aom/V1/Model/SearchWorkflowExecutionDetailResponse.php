...
class SearchWorkflowExecutionDetailResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchWorkflowExecutionDetailResponse';
    ...
    * executionResultList  节点执行信息。
    * approveUserNameList  审批用户列表
    * projectId  租户从IAM申请到的projectid，一般为32位字符串。
    * workflowEditTime  执行workflow的更新时间
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['lastRecordIdWithSnapshot']) && (mb_strlen($this->container['lastRecordIdWithSnapshot']) > 128)) {
                $invalidProperties[] = "invalid value for 'lastRecordIdWithSnapshot', the character length must be smaller than or equal to 128.";
            }
    ...
    * Sets lastUpdateTime
    *
    * @param int|null $lastUpdateTime 流程实例上次更新时间，格式：yyyy-MM-ddTHH:mm:ssZ，UTC时间。
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Aom\V1\Model\ExecutionResultList[]|null $executionResultList 节点执行信息。
    *
    * @return $this
    */
    ...
    *
    * @param string[]|null $approveUserNameList 审批用户列表
    *
    * @return $this
    */
    ...
    *
    * @param int|null $workflowEditTime 执行workflow的更新时间
    *
    * @return $this
    */
