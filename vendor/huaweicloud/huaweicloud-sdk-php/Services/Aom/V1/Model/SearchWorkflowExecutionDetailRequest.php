...
class SearchWorkflowExecutionDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchWorkflowExecutionDetailRequest';
