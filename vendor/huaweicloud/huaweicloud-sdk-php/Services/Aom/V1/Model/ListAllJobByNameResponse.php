...
class ListAllJobByNameResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAllJobByNameResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalElements' => 'int',
            'elements' => '\HuaweiCloud\SDK\Aom\V1\Model\Job[]'
    ];
    ...
    *  查询作业信息集合。
    *
    * @return \HuaweiCloud\SDK\Aom\V1\Model\Job[]|null
    */
    ...
    * Sets elements
    *
    * @param \HuaweiCloud\SDK\Aom\V1\Model\Job[]|null $elements 查询作业信息集合。
    *
    * @return $this
    */
