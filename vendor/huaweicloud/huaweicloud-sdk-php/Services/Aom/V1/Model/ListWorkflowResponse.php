...
class ListWorkflowResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'elements' => '\HuaweiCloud\SDK\Aom\V1\Model\Workflow[]',
            'totalElements' => 'int'
    ];
    ...
    *  工作流详情集合。
    *
    * @return \HuaweiCloud\SDK\Aom\V1\Model\Workflow[]|null
    */
    ...
    * Sets elements
    *
    * @param \HuaweiCloud\SDK\Aom\V1\Model\Workflow[]|null $elements 工作流详情集合。
    *
    * @return $this
    */
