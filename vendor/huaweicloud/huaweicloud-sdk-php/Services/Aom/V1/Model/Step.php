...
class Step implements ModelInterface, ArrayAccess
{
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ignoreError'] === null) {
            $invalidProperties[] = "'ignoreError' can't be null";
        }
    ...
    * Sets input
    *
    * @param map[string,string]|null $input 步骤参数。
    *
    * @return $this
    */
    ...
    * Sets ignoreError
    *
    * @param bool $ignoreError 是否自动忽略错误。
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string|null $description 步骤说明。
    *
    * @return $this
    */
