...
class CustomPolicy implements ModelInterface, ArrayAccess
{
    ...
    * authValue  method参数值，method为agency时，为{\"agency_name\":rms_fg_agency}, rms_fg_agency为授权Config调用FunctionGraph接口的委托名称
    *
    * @var string[]
    */
    ...
    * Sets authValue
    *
    * @param map[string,object]|null $authValue method参数值，method为agency时，为{\"agency_name\":rms_fg_agency}, rms_fg_agency为授权Config调用FunctionGraph接口的委托名称
    *
    * @return $this
    */
