...
class ShowBuiltInPolicyDefinitionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBuiltInPolicyDefinitionResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'triggerType' => 'string',
            'keywords' => 'string[]',
            'defaultResourceTypes' => '\HuaweiCloud\SDK\Config\V1\Model\PolicyDefinitionDefaultResourceTypes[]',
            'parameters' => 'map[string,\HuaweiCloud\SDK\Config\V1\Model\PolicyParameterDefinition]'
    ];
    ...
    */
    protected static $setters = [
            ...
            'defaultResourceTypes' => 'setDefaultResourceTypes',
    ...
    */
    protected static $getters = [
            ...
            'defaultResourceTypes' => 'getDefaultResourceTypes',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['defaultResourceTypes'] = isset($data['defaultResourceTypes']) ? $data['defaultResourceTypes'] : null;
    ...
    */
    ...
    /**
    * Gets defaultResourceTypes
    *  默认资源类型列表
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\PolicyDefinitionDefaultResourceTypes[]|null
    */
    public function getDefaultResourceTypes()
    {
        return $this->container['defaultResourceTypes'];
    }

    /**
    * Sets defaultResourceTypes
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\PolicyDefinitionDefaultResourceTypes[]|null $defaultResourceTypes 默认资源类型列表
    *
    * @return $this
    */
    public function setDefaultResourceTypes($defaultResourceTypes)
    {
        $this->container['defaultResourceTypes'] = $defaultResourceTypes;
        return $this;
    }
    ...
    *  策略参数
    *
    * @return map[string,\HuaweiCloud\SDK\Config\V1\Model\PolicyParameterDefinition]|null
    */
    ...
    * Sets parameters
    *
    * @param map[string,\HuaweiCloud\SDK\Config\V1\Model\PolicyParameterDefinition]|null $parameters 策略参数
    *
    * @return $this
    */
