...
class PolicyStateRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'policyResource' => '\HuaweiCloud\SDK\Config\V1\Model\PolicyResource',
            'triggerType' => 'string',
    ...
    *  policyResource
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\PolicyResource
    */
    ...
    * Sets policyResource
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\PolicyResource $policyResource policyResource
    *
    * @return $this
    */
