...
class ListAggregateComplianceByPolicyAssignmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAggregateComplianceByPolicyAssignmentRequest';
    ...
    */
    protected static $openAPITypes = [
            'limit' => 'int',
            'marker' => 'string',
            'body' => '\HuaweiCloud\SDK\Config\V1\Model\AggregatePolicyAssignmentsRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\AggregatePolicyAssignmentsRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\AggregatePolicyAssignmentsRequest|null $body body
    *
    * @return $this
    */
