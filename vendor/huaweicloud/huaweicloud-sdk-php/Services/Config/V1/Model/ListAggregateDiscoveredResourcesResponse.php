...
class ListAggregateDiscoveredResourcesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceIdentifiers' => '\HuaweiCloud\SDK\Config\V1\Model\ResourceIdentifier[]',
    ...
    *  资源信息列表。
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\ResourceIdentifier[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\ResourceIdentifier[]|null $resourceIdentifiers 资源信息列表。
    *
    * @return $this
    */
