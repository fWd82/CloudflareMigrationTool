...
class ShowOrganizationConformancePackRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowOrganizationConformancePackRequest';
