...
class ListTrackedResourceTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTrackedResourceTagsRequest';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['key']) && !preg_match("/[\\p{L}\\p{Z}\\p{N}_.:+\\-@]+/", $this->container['key'])) {
                $invalidProperties[] = "invalid value for 'key', must be conform to the pattern /[\\p{L}\\p{Z}\\p{N}_.:+\\-@]+/.";
            }
