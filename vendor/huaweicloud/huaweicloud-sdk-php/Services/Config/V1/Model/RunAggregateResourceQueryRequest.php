...
class RunAggregateResourceQueryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RunAggregateResourceQueryRequest';
    ...
    */
    protected static $openAPITypes = [
            'aggregatorId' => 'string',
            'body' => '\HuaweiCloud\SDK\Config\V1\Model\QueryRunRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\QueryRunRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\QueryRunRequestBody|null $body body
    *
    * @return $this
    */
