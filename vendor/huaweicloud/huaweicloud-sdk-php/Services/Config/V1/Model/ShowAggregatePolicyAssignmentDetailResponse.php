...
class ShowAggregatePolicyAssignmentDetailResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAggregatePolicyAssignmentDetailResponse';
