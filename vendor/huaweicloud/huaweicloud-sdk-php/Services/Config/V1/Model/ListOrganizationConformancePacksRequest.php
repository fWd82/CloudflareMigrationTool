...
class ListOrganizationConformancePacksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListOrganizationConformancePacksRequest';
