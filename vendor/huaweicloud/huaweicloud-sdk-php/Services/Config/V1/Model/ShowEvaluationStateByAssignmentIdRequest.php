...
class ShowEvaluationStateByAssignmentIdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowEvaluationStateByAssignmentIdRequest';
