...
class RunEvaluationByPolicyAssignmentIdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RunEvaluationByPolicyAssignmentIdRequest';
