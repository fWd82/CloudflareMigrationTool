...
class ShowTrackerConfigResponse implements ModelInterface, ArrayAccess
{
    ...
    *  channel
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\ChannelConfigBody|null
    */
    ...
    * Sets channel
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\ChannelConfigBody|null $channel channel
    *
    * @return $this
    */
    ...
    *  selector
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\SelectorConfigBody|null
    */
    ...
    * Sets selector
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\SelectorConfigBody|null $selector selector
    *
    * @return $this
    */
