...
class ShowAggregateComplianceDetailsByPolicyAssignmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAggregateComplianceDetailsByPolicyAssignmentRequest';
    ...
    */
    protected static $openAPITypes = [
            'limit' => 'int',
            'marker' => 'string',
            'body' => '\HuaweiCloud\SDK\Config\V1\Model\AggregateComplianceDetailRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\AggregateComplianceDetailRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\AggregateComplianceDetailRequest|null $body body
    *
    * @return $this
    */
