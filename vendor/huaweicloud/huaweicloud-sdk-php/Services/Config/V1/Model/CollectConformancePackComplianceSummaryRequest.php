...
class CollectConformancePackComplianceSummaryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CollectConformancePackComplianceSummaryRequest';
