...
class DeleteConfigurationAggregatorRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteConfigurationAggregatorRequest';
