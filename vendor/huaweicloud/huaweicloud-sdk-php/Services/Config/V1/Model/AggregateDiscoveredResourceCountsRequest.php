...
class AggregateDiscoveredResourceCountsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AggregateDiscoveredResourceCountsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * aggregatorId  资源聚合器ID。
    * filter  filter
    * groupByKey  用于对资源计数进行分组的键（RESOURCE_TYPE | ACCOUNT_ID）。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'aggregatorId' => 'string',
            'filter' => '\HuaweiCloud\SDK\Config\V1\Model\ResourceCountsFilters',
            'groupByKey' => 'string'
    ];
    ...
    *  filter
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\ResourceCountsFilters|null
    */
    ...
    * Sets filter
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\ResourceCountsFilters|null $filter filter
    *
    * @return $this
    */
    ...
    * Sets groupByKey
    *
    * @param string $groupByKey 用于对资源计数进行分组的键（RESOURCE_TYPE | ACCOUNT_ID）。
    *
    * @return $this
    */
