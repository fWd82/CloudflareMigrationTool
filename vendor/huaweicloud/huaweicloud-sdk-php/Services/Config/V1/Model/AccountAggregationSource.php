...
class AccountAggregationSource implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AccountAggregationSource';
    ...
    * Sets domainIds
    *
    * @param string[]|null $domainIds 帐号列表。
    *
    * @return $this
    */
