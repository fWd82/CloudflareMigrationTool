...
class CreateOrganizationConformancePackRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateOrganizationConformancePackRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\OrgConformancePackRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\OrgConformancePackRequestBody|null $body body
    *
    * @return $this
    */
