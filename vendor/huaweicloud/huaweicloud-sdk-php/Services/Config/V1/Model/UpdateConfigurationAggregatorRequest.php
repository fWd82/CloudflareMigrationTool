...
class UpdateConfigurationAggregatorRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateConfigurationAggregatorRequest';
    ...
    */
    protected static $openAPITypes = [
            'aggregatorId' => 'string',
            'body' => '\HuaweiCloud\SDK\Config\V1\Model\ConfigurationAggregatorRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\ConfigurationAggregatorRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\ConfigurationAggregatorRequest|null $body body
    *
    * @return $this
    */
