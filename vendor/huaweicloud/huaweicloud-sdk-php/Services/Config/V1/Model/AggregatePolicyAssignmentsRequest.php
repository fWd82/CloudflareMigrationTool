...
class AggregatePolicyAssignmentsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'aggregatorId' => 'string',
            'filter' => '\HuaweiCloud\SDK\Config\V1\Model\AggregatePolicyAssignmentsFilters'
    ];
    ...
    *  filter
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\AggregatePolicyAssignmentsFilters|null
    */
    ...
    * Sets filter
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\AggregatePolicyAssignmentsFilters|null $filter filter
    *
    * @return $this
    */
