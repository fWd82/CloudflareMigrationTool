...
class ListConformancePackComplianceByPackIdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListConformancePackComplianceByPackIdRequest';
