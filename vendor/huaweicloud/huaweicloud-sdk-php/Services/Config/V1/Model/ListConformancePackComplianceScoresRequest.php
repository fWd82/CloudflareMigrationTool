...
class ListConformancePackComplianceScoresRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListConformancePackComplianceScoresRequest';
