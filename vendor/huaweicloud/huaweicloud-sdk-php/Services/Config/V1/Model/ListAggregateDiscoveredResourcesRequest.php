...
class ListAggregateDiscoveredResourcesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAggregateDiscoveredResourcesRequest';
    ...
    */
    protected static $openAPITypes = [
            'limit' => 'int',
            'marker' => 'string',
            'body' => '\HuaweiCloud\SDK\Config\V1\Model\AggregateDiscoveredResourcesRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\AggregateDiscoveredResourcesRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\AggregateDiscoveredResourcesRequest|null $body body
    *
    * @return $this
    */
