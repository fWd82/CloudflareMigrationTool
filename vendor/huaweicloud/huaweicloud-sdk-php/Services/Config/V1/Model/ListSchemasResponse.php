...
class ListSchemasResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'value' => '\HuaweiCloud\SDK\Config\V1\Model\ResourceSchemaResponse[]',
    ...
    *  schemas 接口.
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\ResourceSchemaResponse[]|null
    */
    ...
    * Sets value
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\ResourceSchemaResponse[]|null $value schemas 接口.
    *
    * @return $this
    */
