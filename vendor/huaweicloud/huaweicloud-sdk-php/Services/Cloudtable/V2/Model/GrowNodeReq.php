...
class GrowNodeReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GrowNodeReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * componentName  扩容节点类型：rs,tsdb,lemon
    * nodeNum  扩容节点范围是 [2,10]
    *
    * @var string[]
    */
    ...
    * Sets componentName
    *
    * @param string $componentName 扩容节点类型：rs,tsdb,lemon
    *
    * @return $this
    */
    ...
    * Sets nodeNum
    *
    * @param int $nodeNum 扩容节点范围是 [2,10]
    *
    * @return $this
    */
