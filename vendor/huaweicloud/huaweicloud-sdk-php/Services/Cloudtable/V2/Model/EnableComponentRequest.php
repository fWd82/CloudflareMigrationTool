...
class EnableComponentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EnableComponentRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  租户ID
    * clusterId  集群ID
    * componentName  组件类型，取值为tsdb
    * xLanguage  语言类型
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\CloudTable\V2\Model\AddComponentReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CloudTable\V2\Model\AddComponentReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CloudTable\V2\Model\AddComponentReq|null $body body
    *
    * @return $this
    */
