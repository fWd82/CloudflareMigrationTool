...
class ListClustersResponse implements ModelInterface, ArrayAccess
{
    ...
    * clusters  查询到的集群详细列表，每个json体表示一个集群的详情。
    * count  查询到的集群数量。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'clusters' => '\HuaweiCloud\SDK\CloudTable\V2\Model\ClusterDetail[]',
            'count' => 'int'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\CloudTable\V2\Model\ClusterDetail[]|null
    */
    ...
    * Sets clusters
    *
    * @param \HuaweiCloud\SDK\CloudTable\V2\Model\ClusterDetail[]|null $clusters 查询到的集群详细列表，每个json体表示一个集群的详情。
    *
    * @return $this
    */
