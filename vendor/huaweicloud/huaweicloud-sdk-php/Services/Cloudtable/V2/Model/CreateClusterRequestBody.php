...
class CreateClusterRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'cluster' => '\HuaweiCloud\SDK\CloudTable\V2\Model\Cluster'
    ];
    ...
    *  cluster
    *
    * @return \HuaweiCloud\SDK\CloudTable\V2\Model\Cluster
    */
    ...
    * Sets cluster
    *
    * @param \HuaweiCloud\SDK\CloudTable\V2\Model\Cluster $cluster cluster
    *
    * @return $this
    */
