...
class UpdateClusterSettingResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateClusterSettingResponse';
    ...
    * Sets modifyResult
    *
    * @param bool|null $modifyResult 配置修改结果
    *
    * @return $this
    */
