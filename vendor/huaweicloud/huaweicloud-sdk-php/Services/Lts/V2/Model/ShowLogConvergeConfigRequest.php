...
class ShowLogConvergeConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowLogConvergeConfigRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * memberAccountId  成员帐户ID
    *
    * @var string[]
    */
