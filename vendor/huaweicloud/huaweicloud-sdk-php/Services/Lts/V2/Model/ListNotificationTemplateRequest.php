...
class ListNotificationTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListNotificationTemplateRequest';
    ...
    */
    protected static $openAPITypes = [
            'domainId' => 'string',
            'body' => '\HuaweiCloud\SDK\Lts\V2\Model\PreviewTemplateBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Lts\V2\Model\PreviewTemplateBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Lts\V2\Model\PreviewTemplateBody|null $body body
    *
    * @return $this
    */
