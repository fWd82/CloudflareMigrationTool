...
class PageInfo implements ModelInterface, ArrayAccess
{
    ...
    * nextMarker  返回下一页查询地址(为空时，代表后面没有数据)
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['nextMarker'] === null) {
            ...
            if ((mb_strlen($this->container['nextMarker']) > 5000)) {
                $invalidProperties[] = "invalid value for 'nextMarker', the character length must be smaller than or equal to 5000.";
            }
            if ((mb_strlen($this->container['nextMarker']) < 0)) {
        ...
        if ($this->container['previousMarker'] === null) {
            ...
            if ((mb_strlen($this->container['previousMarker']) > 5000)) {
                $invalidProperties[] = "invalid value for 'previousMarker', the character length must be smaller than or equal to 5000.";
            }
    ...
    * Sets nextMarker
    *
    * @param string $nextMarker 返回下一页查询地址(为空时，代表后面没有数据)
    *
    * @return $this
    */
    ...
    * Sets previousMarker
    *
    * @param string $previousMarker 返回前一页查询地址
    *
    * @return $this
    */
    ...
    * Sets currentCount
    *
    * @param string $currentCount 本页返回条目数量
    *
    * @return $this
    */
