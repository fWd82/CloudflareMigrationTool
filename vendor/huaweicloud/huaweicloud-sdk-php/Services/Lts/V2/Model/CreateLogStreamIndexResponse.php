...
class CreateLogStreamIndexResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateLogStreamIndexResponse';
    ...
    * Sets errorMessage
    *
    * @param string|null $errorMessage 错误信息描述
    *
    * @return $this
    */
