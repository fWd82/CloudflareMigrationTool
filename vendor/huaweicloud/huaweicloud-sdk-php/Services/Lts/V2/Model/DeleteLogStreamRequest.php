...
class DeleteLogStreamRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteLogStreamRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * logGroupId  租户想删除的日志流所在的日志组的groupid，一般为36位字符串。
    * logStreamId  需要删除的日志流ID，获取方式请参见：获取账号ID、项目ID、日志组ID、日志流ID（https://support.huaweicloud.com/api-lts/lts_api_0006.html）。
    *
    * @var string[]
    */
