...
class ListStructuredLogsWithTimeRangeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListStructuredLogsWithTimeRangeRequest';
    ...
    */
    protected static $openAPITypes = [
            'logStreamId' => 'string',
            'body' => '\HuaweiCloud\SDK\Lts\V2\Model\QueryLtsStructLogParamsNew'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Lts\V2\Model\QueryLtsStructLogParamsNew|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Lts\V2\Model\QueryLtsStructLogParamsNew|null $body body
    *
    * @return $this
    */
