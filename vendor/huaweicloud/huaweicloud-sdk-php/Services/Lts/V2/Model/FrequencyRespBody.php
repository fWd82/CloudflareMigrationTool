...
class FrequencyRespBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FrequencyRespBody';
    ...
    * Sets fixedRateUnit
    *
    * @param string|null $fixedRateUnit 时间单位枚举值：
    *
    * @return $this
    */
