...
class AccessConfigHostGroupIdListCreate implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AccessConfigHostGroupIdListCreate';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * hostGroupIdList  主机组ID列表
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['hostGroupIdList'] === null) {
            $invalidProperties[] = "'hostGroupIdList' can't be null";
        }
    ...
    *
    * @param string[] $hostGroupIdList 主机组ID列表
    *
    * @return $this
    */
