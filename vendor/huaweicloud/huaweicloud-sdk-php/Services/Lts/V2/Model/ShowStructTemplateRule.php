...
class ShowStructTemplateRule implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowStructTemplateRule';
