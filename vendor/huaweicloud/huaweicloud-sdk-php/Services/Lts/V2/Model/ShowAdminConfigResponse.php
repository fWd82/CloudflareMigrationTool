...
class ShowAdminConfigResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAdminConfigResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * logConvergeSwitch  logConvergeSwitch
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'logConvergeSwitch' => 'bool'
    ];
    ...
    *
    * @param bool|null $logConvergeSwitch logConvergeSwitch
    *
    * @return $this
    */
