...
class ListNotificationTopicsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListNotificationTopicsRequest';
    ...
    * Sets offset
    *
    * @param int $offset 查询游标，初始传入0，后续从上一次的返回值中获取
    *
    * @return $this
    */
