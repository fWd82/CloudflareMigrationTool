...
class TagFieldsInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TagFieldsInfo';
    ...
    * Sets isAnalysis
    *
    * @param bool|null $isAnalysis 是否解析
    *
    * @return $this
    */
