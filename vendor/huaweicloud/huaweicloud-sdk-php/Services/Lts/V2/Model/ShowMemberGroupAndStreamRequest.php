...
class ShowMemberGroupAndStreamRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowMemberGroupAndStreamRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * memberAccountId  成员账号ID
    *
    * @var string[]
    */
