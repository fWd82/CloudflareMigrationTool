...
class DeleteNotificationTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteNotificationTemplateRequest';
    ...
    */
    protected static $openAPITypes = [
            'domainId' => 'string',
            'body' => '\HuaweiCloud\SDK\Lts\V2\Model\DeleteNotificationTemplateBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Lts\V2\Model\DeleteNotificationTemplateBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Lts\V2\Model\DeleteNotificationTemplateBody|null $body body
    *
    * @return $this
    */
