...
class CreateLogStreamResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateLogStreamResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * logStreamId  创建的日志流的Id。
    *
    * @var string[]
    */
    ...
    * Sets logStreamId
    *
    * @param string|null $logStreamId 创建的日志流的Id。
    *
    * @return $this
    */
