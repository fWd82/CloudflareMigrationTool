...
class CreateTransferRequestBodyLogStreams implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTransferRequestBody_log_streams';
