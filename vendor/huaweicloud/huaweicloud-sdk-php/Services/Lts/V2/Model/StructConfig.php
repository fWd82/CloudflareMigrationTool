...
class StructConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StructConfig';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * logGroupId  日志组ID，获取方式请参见：获取账号ID、项目ID、日志组ID、日志流ID（https://support.huaweicloud.com/api-lts/lts_api_0006.html）。
    * logStreamId  日志流ID，获取方式请参见：获取账号ID、项目ID、日志组ID、日志流ID（https://support.huaweicloud.com/api-lts/lts_api_0006.html）。
    ...
    */
    ...
    const TEMPLATE_TYPE_BUILT_IN = 'built_in';
    ...
    * Sets templateId
    *
    * @param string $templateId 所用模板id。当使用系统模板时，当前属性可以为空
    *
    * @return $this
    */
    ...
    * Sets templateName
    *
    * @param string $templateName 所用模板名称，会对模板名称及id进行校验
    *
    * @return $this
    */
    ...
    * Sets templateType
    *
    * @param string $templateType 所用模板类型，分为built_in及custom两种类型，对应系统模板和自定义模板，系统模板分为CTS，VPC和ELB三种。
    *
    * @return $this
    */
