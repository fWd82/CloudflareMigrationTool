...
class CreateTransferResponseBodyLogTransferInfoLogAgencyTransfer implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTransferResponseBody_log_transfer_info_log_agency_transfer';
