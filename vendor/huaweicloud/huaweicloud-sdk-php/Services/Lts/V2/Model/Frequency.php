...
class Frequency implements ModelInterface, ArrayAccess
{
    ...
    * hourOfDay  当字段type为\"DAILY\"或者\"WEEKLY\"时取该字段
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['type'] === null) {
            ...
            if (!is_null($this->container['hourOfDay']) && ($this->container['hourOfDay'] > 24)) {
                $invalidProperties[] = "invalid value for 'hourOfDay', must be smaller than or equal to 24.";
            }
            if (!is_null($this->container['hourOfDay']) && ($this->container['hourOfDay'] < 0)) {
                $invalidProperties[] = "invalid value for 'hourOfDay', must be bigger than or equal to 0.";
            }
    ...
    * Sets hourOfDay
    *
    * @param int|null $hourOfDay 当字段type为\"DAILY\"或者\"WEEKLY\"时取该字段
    *
    * @return $this
    */
