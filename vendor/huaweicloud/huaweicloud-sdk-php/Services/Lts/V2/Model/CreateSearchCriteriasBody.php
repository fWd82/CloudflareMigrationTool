...
class CreateSearchCriteriasBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSearchCriteriasBody';
    ...
    * epsId  企业项目id
    * name  创建快速查询名称
    * searchType  查询类型 原始日志：ORIGINALLOG 可视化日志: VISUALIZATION
    *
    * @var string[]
    */
    ...
    * Sets searchType
    *
    * @param string $searchType 查询类型 原始日志：ORIGINALLOG 可视化日志: VISUALIZATION
    *
    * @return $this
    */
