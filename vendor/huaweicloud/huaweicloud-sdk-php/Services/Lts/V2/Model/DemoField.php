...
class DemoField implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DemoField';
    ...
    * isAnalysis  是否开启快速分析
    * index  手动正则及分隔符方式中字段序号
    * relation  描叙多层级json中字段间的层级关系
    * userDefinedName  json及nginx方式中字段自定义别名
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['type'] === null) {
            ...
            if (!is_null($this->container['relation']) && (mb_strlen($this->container['relation']) > 1000)) {
                $invalidProperties[] = "invalid value for 'relation', the character length must be smaller than or equal to 1000.";
            }
    ...
    * Sets index
    *
    * @param int|null $index 手动正则及分隔符方式中字段序号
    *
    * @return $this
    */
    ...
    * Sets relation
    *
    * @param string|null $relation 描叙多层级json中字段间的层级关系
    *
    * @return $this
    */
    ...
    *
    * @param string|null $userDefinedName json及nginx方式中字段自定义别名
    *
    * @return $this
    */
