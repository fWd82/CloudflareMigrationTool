...
class UpdateLogStreamRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateLogStreamRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * logGroupId  日志组ID，获取方式请参见：获取帐号ID、项目ID、日志组ID、日志流ID。  缺省值：None 最小长度：36 最大长度：36
    * logStreamId  日志流ID，获取方式请参见：获取帐号ID、项目ID、日志组ID、日志流ID。  缺省值：None 最小长度：36 最大长度：36
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'logGroupId' => 'string',
            'logStreamId' => 'string',
            'body' => '\HuaweiCloud\SDK\Lts\V2\Model\UpdateLogStreamParams'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Lts\V2\Model\UpdateLogStreamParams|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Lts\V2\Model\UpdateLogStreamParams|null $body body
    *
    * @return $this
    */
