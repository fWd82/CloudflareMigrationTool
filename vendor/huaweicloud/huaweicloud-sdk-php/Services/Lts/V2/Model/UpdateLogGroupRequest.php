...
class UpdateLogGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateLogGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            'logGroupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Lts\V2\Model\UpdateLogGroupParams'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Lts\V2\Model\UpdateLogGroupParams|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Lts\V2\Model\UpdateLogGroupParams|null $body body
    *
    * @return $this
    */
