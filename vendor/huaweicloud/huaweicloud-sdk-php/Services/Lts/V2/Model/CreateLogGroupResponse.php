...
class CreateLogGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateLogGroupResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * logGroupId  创建的日志组的Id。
    *
    * @var string[]
    */
    ...
    * Sets logGroupId
    *
    * @param string|null $logGroupId 创建的日志组的Id。
    *
    * @return $this
    */
