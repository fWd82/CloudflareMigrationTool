...
class CreateLogStreamRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateLogStreamRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * logGroupId  租户想创建的日志流所在的日志组的groupid，一般为36位字符串。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'logGroupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Lts\V2\Model\CreateLogStreamParams'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Lts\V2\Model\CreateLogStreamParams|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Lts\V2\Model\CreateLogStreamParams|null $body body
    *
    * @return $this
    */
