...
class UpdatelogConvergeConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatelogConvergeConfig';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  ID
    * memberAccountId  组织成员账号id
    * memberProjectId  组织成员项目id
    * createTime  创建时间
    * updateTime  更新时间
    * status  状态
    * organizationId  组织id
    * managementAccountId  管理员或者委托管理员账号id
    * managementProjectId  管理员或者委托管理员项目id
    * version  版本
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['memberAccountId'] === null) {
            $invalidProperties[] = "'memberAccountId' can't be null";
        }
        ...
        if ($this->container['managementProjectId'] === null) {
            $invalidProperties[] = "'managementProjectId' can't be null";
        }
    ...
    *
    * @param string $memberAccountId 组织成员账号id
    *
    * @return $this
    */
    ...
    *
    * @param string|null $memberProjectId 组织成员项目id
    *
    * @return $this
    */
    ...
    *
    * @param string $managementAccountId 管理员或者委托管理员账号id
    *
    * @return $this
    */
    ...
    *
    * @param string $managementProjectId 管理员或者委托管理员项目id
    *
    * @return $this
    */
