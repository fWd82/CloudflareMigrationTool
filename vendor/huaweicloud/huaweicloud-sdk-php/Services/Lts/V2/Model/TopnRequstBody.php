...
class TopnRequstBody implements ModelInterface, ArrayAccess
{
    ...
    * sortBy  排序依据，index/write/storage/basicTransfer/seniorTransfer/coldStorage，必须是search_list中存在的数据
    ...
    * searchList  查询数据类型，字符串数组可多种搭配，只能在index/write/storage/basicTransfer/seniorTransfer/coldStorage中选填
    *
    * @var string[]
    */
    ...
    * Sets sortBy
    *
    * @param string $sortBy 排序依据，index/write/storage/basicTransfer/seniorTransfer/coldStorage，必须是search_list中存在的数据
    *
    * @return $this
    */
    ...
    * Sets searchList
    *
    * @param string[] $searchList 查询数据类型，字符串数组可多种搭配，只能在index/write/storage/basicTransfer/seniorTransfer/coldStorage中选填
    *
    * @return $this
    */
