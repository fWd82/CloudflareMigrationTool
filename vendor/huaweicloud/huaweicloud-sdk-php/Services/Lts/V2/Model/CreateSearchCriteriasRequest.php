...
class CreateSearchCriteriasRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSearchCriteriasRequest';
    ...
    */
    protected static $openAPITypes = [
            'groupId' => 'string',
            'topicId' => 'string',
            'body' => '\HuaweiCloud\SDK\Lts\V2\Model\CreateSearchCriteriasBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Lts\V2\Model\CreateSearchCriteriasBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Lts\V2\Model\CreateSearchCriteriasBody|null $body body
    *
    * @return $this
    */
