...
class AomMappingRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AomMappingRequestInfo';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ruleName'] === null) {
            ...
            if (!is_null($this->container['ruleId']) && (mb_strlen($this->container['ruleId']) > 100)) {
                $invalidProperties[] = "invalid value for 'ruleId', the character length must be smaller than or equal to 100.";
            }
        ...
        if ($this->container['ruleInfo'] === null) {
            $invalidProperties[] = "'ruleInfo' can't be null";
        }
    ...
    *  ruleInfo
    *
    * @return \HuaweiCloud\SDK\Lts\V2\Model\AomMappingRuleInfo
    */
    ...
    * Sets ruleInfo
    *
    * @param \HuaweiCloud\SDK\Lts\V2\Model\AomMappingRuleInfo $ruleInfo ruleInfo
    *
    * @return $this
    */
