...
class ListQueryStructuredLogsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListQueryStructuredLogsRequest';
    ...
    */
    protected static $openAPITypes = [
            'logGroupId' => 'string',
            'logStreamId' => 'string',
            'body' => '\HuaweiCloud\SDK\Lts\V2\Model\QueryLtsStructLogParams'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Lts\V2\Model\QueryLtsStructLogParams|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Lts\V2\Model\QueryLtsStructLogParams|null $body body
    *
    * @return $this
    */
