...
class CreateLogStreamIndexRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateLogStreamIndexRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * groupId  '项目ID，账号ID，日志组ID、日志流ID，获取方式请参见：获取项目ID，获取账号ID，日志组ID、日志流ID'
    * streamId  '项目ID，账号ID，日志组ID、日志流ID，获取方式请参见：获取项目ID，获取账号ID，日志组ID、日志流ID'
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'groupId' => 'string',
            'streamId' => 'string',
            'body' => '\HuaweiCloud\SDK\Lts\V2\Model\LTSIndexConfigInfo'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['streamId'] === null) {
            ...
            if ((mb_strlen($this->container['streamId']) > 36)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Lts\V2\Model\LTSIndexConfigInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Lts\V2\Model\LTSIndexConfigInfo|null $body body
    *
    * @return $this
    */
