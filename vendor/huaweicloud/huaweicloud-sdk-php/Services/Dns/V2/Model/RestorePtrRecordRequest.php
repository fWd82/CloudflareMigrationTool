...
class RestorePtrRecordRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RestorePtrRecordRequest';
    ...
    */
    protected static $openAPITypes = [
            'region' => 'string',
            'floatingipId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dns\V2\Model\RestorePtrReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dns\V2\Model\RestorePtrReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\RestorePtrReq|null $body body
    *
    * @return $this
    */
