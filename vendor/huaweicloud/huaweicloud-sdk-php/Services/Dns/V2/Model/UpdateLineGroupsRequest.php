...
class UpdateLineGroupsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateLineGroupsRequest';
    ...
    * @return string
    */
    public function getLinegroupId()
    {
        return $this->container['linegroupId'];
    }
