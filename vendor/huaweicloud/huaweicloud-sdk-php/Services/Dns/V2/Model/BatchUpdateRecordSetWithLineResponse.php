...
class BatchUpdateRecordSetWithLineResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateRecordSetWithLineResponse';
