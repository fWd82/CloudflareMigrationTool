...
class CreateRecordSetWithBatchLinesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateRecordSetWithBatchLinesResponse';
