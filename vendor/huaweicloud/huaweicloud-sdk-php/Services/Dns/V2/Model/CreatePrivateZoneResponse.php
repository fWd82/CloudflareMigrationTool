...
class CreatePrivateZoneResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePrivateZoneResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'masters' => 'string[]',
            'router' => '\HuaweiCloud\SDK\Dns\V2\Model\RouterWithStatus'
    ];
    ...
    * Sets serial
    *
    * @param int|null $serial 该zone下SOA记录中用于标识zone文件变更的序列值，用于主从节点同步。  该参数暂未使用。
    *
    * @return $this
    */
    ...
    * Sets router
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\RouterWithStatus|null $router router
    *
    * @return $this
    */
