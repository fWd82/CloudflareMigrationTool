...
class ShowRecordSetByZoneResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRecordSetByZoneResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * links  links
    * recordsets  recordset列表。
    * metadata  metadata
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'recordsets' => '\HuaweiCloud\SDK\Dns\V2\Model\ShowRecordSetByZoneResp[]',
    ...
    *  recordset列表。
    *
    * @return \HuaweiCloud\SDK\Dns\V2\Model\ShowRecordSetByZoneResp[]|null
    */
    ...
    * Sets recordsets
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\ShowRecordSetByZoneResp[]|null $recordsets recordset列表。
    *
    * @return $this
    */
