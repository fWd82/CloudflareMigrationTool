...
class DeleteRecordSetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteRecordSetRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * zoneId  当前recordset所属的zoneID。
    * recordsetId  当前recordset所属的ID信息。
    *
    * @var string[]
    */
