...
class UpdatePublicZoneRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePublicZoneRequest';
    ...
    */
    protected static $openAPITypes = [
            'zoneId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dns\V2\Model\UpdatePublicZoneInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dns\V2\Model\UpdatePublicZoneInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\UpdatePublicZoneInfo|null $body body
    *
    * @return $this
    */
