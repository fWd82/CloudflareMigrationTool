...
class CreateEipRecordSetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateEipRecordSetRequest';
    ...
    */
    protected static $openAPITypes = [
            'region' => 'string',
            'floatingipId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dns\V2\Model\CreatePtrReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dns\V2\Model\CreatePtrReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\CreatePtrReq|null $body body
    *
    * @return $this
    */
