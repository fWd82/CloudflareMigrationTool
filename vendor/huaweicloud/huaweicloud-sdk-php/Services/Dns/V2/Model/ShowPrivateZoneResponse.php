...
class ShowPrivateZoneResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPrivateZoneResponse';
    ...
    * Sets routers
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\Router[]|null $routers 与该zone关联的Router(VPC)列表。
    *
    * @return $this
    */
