...
class UpdateRecordSetsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRecordSetsRequest';
    ...
    */
    protected static $openAPITypes = [
            'zoneId' => 'string',
            'recordsetId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dns\V2\Model\UpdateRecordSetsReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dns\V2\Model\UpdateRecordSetsReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\UpdateRecordSetsReq|null $body body
    *
    * @return $this
    */
