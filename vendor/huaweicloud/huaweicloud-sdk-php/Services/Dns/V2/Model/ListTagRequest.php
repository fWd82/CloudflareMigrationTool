...
class ListTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTagRequest';
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'body' => '\HuaweiCloud\SDK\Dns\V2\Model\ListTagReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dns\V2\Model\ListTagReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\ListTagReq|null $body body
    *
    * @return $this
    */
