...
class BatchDeleteRecordSetWithLineResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteRecordSetWithLineResponse';
