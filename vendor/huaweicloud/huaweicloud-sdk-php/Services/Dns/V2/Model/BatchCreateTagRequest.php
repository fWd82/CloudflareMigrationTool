...
class BatchCreateTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateTagRequest';
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dns\V2\Model\BatchHandTags'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dns\V2\Model\BatchHandTags|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\BatchHandTags|null $body body
    *
    * @return $this
    */
