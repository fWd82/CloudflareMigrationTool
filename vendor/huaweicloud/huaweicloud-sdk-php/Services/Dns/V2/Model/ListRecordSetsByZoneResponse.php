...
class ListRecordSetsByZoneResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRecordSetsByZoneResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'recordsets' => '\HuaweiCloud\SDK\Dns\V2\Model\ListRecordSets[]',
    ...
    *  recordset列表对象。
    *
    * @return \HuaweiCloud\SDK\Dns\V2\Model\ListRecordSets[]|null
    */
    ...
    * Sets recordsets
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\ListRecordSets[]|null $recordsets recordset列表对象。
    *
    * @return $this
    */
