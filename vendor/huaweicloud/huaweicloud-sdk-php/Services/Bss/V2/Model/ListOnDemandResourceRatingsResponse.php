...
class ListOnDemandResourceRatingsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'measureId' => 'int',
            'currency' => 'string',
            'productRatingResults' => '\HuaweiCloud\SDK\Bss\V2\Model\DemandProductRatingResult[]'
    ];
    ...
    *  产品询价结果，具体参见表2。
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\DemandProductRatingResult[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\DemandProductRatingResult[]|null $productRatingResults 产品询价结果，具体参见表2。
    *
    * @return $this
    */
