...
class ClaimEnterpriseMultiAccountCouponResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ClaimEnterpriseMultiAccountCouponResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * subCouponId  |参数名称：实际回收金额。| |参数的约束及描述：成功时返回|
    *
    * @var string[]
    */
    ...
    * Sets subCouponId
    *
    * @param string|null $subCouponId |参数名称：实际回收金额。| |参数的约束及描述：成功时返回|
    *
    * @return $this
    */
