...
class ShowCustomerMonthlySumRequest implements ModelInterface, ArrayAccess
{
    ...
    * billCycle  查询消费汇总数据所在的账期，东八区时间，格式为YYYY-MM。
    ...
    * method  查询方式。oneself：自身sub_customer：企业子客户all：自己和企业子客户 此参数不携带或携带值为空时，默认值为“all”，如果没有企业子客户，all的时候也是查询客户自己的数据。
    ...
    * Sets billCycle
    *
    * @param string $billCycle 查询消费汇总数据所在的账期，东八区时间，格式为YYYY-MM。
    *
    * @return $this
    */
    ...
    * Sets method
    *
    * @param string|null $method 查询方式。oneself：自身sub_customer：企业子客户all：自己和企业子客户 此参数不携带或携带值为空时，默认值为“all”，如果没有企业子客户，all的时候也是查询客户自己的数据。
    *
    * @return $this
    */
