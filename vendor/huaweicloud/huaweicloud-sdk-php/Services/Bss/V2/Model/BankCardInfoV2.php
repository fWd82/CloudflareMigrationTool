...
class BankCardInfoV2 implements ModelInterface, ArrayAccess
{
    ...
    * bankAccount  银行卡账号。 当identifyType为4时，不能为空。 银行账号输入规则：^[0-9a-zA-Z]，可以包含特殊横杠（-）字符。
    * areacode  国家/区号码。 例如：0086：中国大陆区号码。
    * mobile  手机号码。
    * verificationCode  验证码。 请调用“发送验证码”接口获取。
    *
    * @var string[]
    */
    ...
    * Sets bankAccount
    *
    * @param string $bankAccount 银行卡账号。 当identifyType为4时，不能为空。 银行账号输入规则：^[0-9a-zA-Z]，可以包含特殊横杠（-）字符。
    *
    * @return $this
    */
    ...
    * Sets areacode
    *
    * @param string $areacode 国家/区号码。 例如：0086：中国大陆区号码。
    *
    * @return $this
    */
    ...
    *
    * @param string $verificationCode 验证码。 请调用“发送验证码”接口获取。
    *
    * @return $this
    */
