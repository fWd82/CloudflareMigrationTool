...
class AdjustToIndirectPartnerReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AdjustToIndirectPartnerReq';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['amount'] === null) {
            ...
            if (($this->container['amount'] > 999999999.99)) {
                $invalidProperties[] = "invalid value for 'amount', must be smaller than or equal to 999999999.99.";
            }
