...
class CustomerInformation implements ModelInterface, ArrayAccess
{
    ...
    * customerLevel  客户等级。具体等级体系和权益请参见客户等级体系。 V0V1V2V3V4V5
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'customerType' => 'int',
            'isFrozen' => 'int',
            'accountManagers' => '\HuaweiCloud\SDK\Bss\V2\Model\AccountManager[]',
            'xaccountId' => 'string',
            'xaccountType' => 'string',
    ...
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\AccountManager[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\AccountManager[]|null $accountManagers 该客户对应的客户经理信息，目前只支持1个，具体参见表2。
    *
    * @return $this
    */
    ...
    * Sets customerLevel
    *
    * @param string|null $customerLevel 客户等级。具体等级体系和权益请参见客户等级体系。 V0V1V2V3V4V5
    *
    * @return $this
    */
