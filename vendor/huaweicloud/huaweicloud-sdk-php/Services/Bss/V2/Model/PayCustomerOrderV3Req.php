...
class PayCustomerOrderV3Req implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'useCoupon' => 'string',
            'useDiscount' => 'string',
            'couponInfos' => '\HuaweiCloud\SDK\Bss\V2\Model\CouponSimpleInfoOrderPayV3[]',
            'discountInfos' => '\HuaweiCloud\SDK\Bss\V2\Model\DiscountSimpleInfoV3[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\CouponSimpleInfoOrderPayV3[]|null
    */
    ...
    * Sets couponInfos
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\CouponSimpleInfoOrderPayV3[]|null $couponInfos 优惠券ID列表，目前支持传递最多三个优惠券ID。 请从“查询订单可用优惠券”接口的响应参数中获取。 具体参见表1。 当use_coupon参数取值为“YES”，本字段必填；当use_coupon参数取值为“NO”，本字段不可填写，否则报参数错误。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\DiscountSimpleInfoV3[]|null
    */
    ...
    * Sets discountInfos
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\DiscountSimpleInfoV3[]|null $discountInfos 折扣ID列表，目前仅支持传递一个折扣ID。 请从“查询订单可用折扣”接口的响应参数中获取。 具体参见表2。 当use_discount参数取值为“YES”，本字段必填；当use_discount参数取值为“NO”，本字段不可填写，否则报参数错误。
    *
    * @return $this
    */
