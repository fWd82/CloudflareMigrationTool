...
class DemandProductInfo implements ModelInterface, ArrayAccess
{
    ...
    * Sets region
    *
    * @param string $region 云服务区编码，例如：“cn-north-1”。
    *
    * @return $this
    */
    ...
    * Sets availableZone
    *
    * @param string|null $availableZone 可用区标识。此参数不携带或携带值为空串或携带值为null时，不作为筛选条件。
    *
    * @return $this
    */
    ...
    * Sets sizeMeasureId
    *
    * @param int|null $sizeMeasureId 资源容量度量标识，枚举值如下： 15：Mbps（购买带宽时使用）17：GB（购买云硬盘时使用）14：个（次） 线性产品时该参数不能为空。线性产品为包括硬盘，带宽等在订购时需要指定大小的产品。例如硬盘在订购时需选择10G、20G等不同大小。非线性产品时此参数不携带或者携带值为null时，不作为筛选条件。
    *
    * @return $this
    */
    ...
    * Sets usageMeasureId
    *
    * @param int $usageMeasureId 使用量度量单位， 例如按小时询价，使用量值为1，使用量单位为小时。
    *
    * @return $this
    */
