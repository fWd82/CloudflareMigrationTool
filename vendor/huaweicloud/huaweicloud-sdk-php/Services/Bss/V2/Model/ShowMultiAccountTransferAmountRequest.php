...
class ShowMultiAccountTransferAmountRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowMultiAccountTransferAmountRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * balanceType  账户类型：BALANCE_TYPE_DEBIT：余额账户BALANCE_TYPE_CREDIT：信用账户
    ...
    * Sets balanceType
    *
    * @param string $balanceType 账户类型：BALANCE_TYPE_DEBIT：余额账户BALANCE_TYPE_CREDIT：信用账户
    *
    * @return $this
    */
