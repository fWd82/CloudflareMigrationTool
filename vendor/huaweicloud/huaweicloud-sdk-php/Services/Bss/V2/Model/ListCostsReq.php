...
class ListCostsReq implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'timeCondition' => '\HuaweiCloud\SDK\Bss\V2\Model\TimeCondition',
            'groupby' => '\HuaweiCloud\SDK\Bss\V2\Model\GroupBy[]',
            'costType' => 'string',
            'amountType' => 'string',
            'offset' => 'int',
            'limit' => 'int',
            'filters' => '\HuaweiCloud\SDK\Bss\V2\Model\FilterV2[]'
    ];
    ...
    *  timeCondition
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\TimeCondition
    */
    ...
    * Sets timeCondition
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\TimeCondition $timeCondition timeCondition
    *
    * @return $this
    */
