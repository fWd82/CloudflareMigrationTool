...
class ListFreeResourceUsagesRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Bss\V2\Model\ListFreeResourceUsagesReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\ListFreeResourceUsagesReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\ListFreeResourceUsagesReq|null $body body
    *
    * @return $this
    */
