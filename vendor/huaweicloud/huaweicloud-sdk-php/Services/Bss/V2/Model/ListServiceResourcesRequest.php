...
class ListServiceResourcesRequest implements ModelInterface, ArrayAccess
{
    ...
    *
    * @param string $serviceTypeCode 云服务类型编码，例如OBS的云服务类型编码为“hws.service.type.obs”。您可以调用[查询云服务类型列表](https://support.huaweicloud.com/api-oce/zh-cn_topic_0000001256679455.html)接口获取。
    *
    * @return $this
    */
