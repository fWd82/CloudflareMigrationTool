...
class ListRateOnPeriodDetailResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'officialWebsiteRatingResult' => '\HuaweiCloud\SDK\Bss\V2\Model\OfficialWebsiteRatingResult',
            'optionalDiscountRatingResults' => '\HuaweiCloud\SDK\Bss\V2\Model\OptionalDiscountRatingResult[]',
            'currency' => 'string'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\OfficialWebsiteRatingResult|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\OfficialWebsiteRatingResult|null $officialWebsiteRatingResult officialWebsiteRatingResult
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\OptionalDiscountRatingResult[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\OptionalDiscountRatingResult[]|null $optionalDiscountRatingResults 存在可选折扣优惠时返回折扣优惠维度询价结果，每个折扣优惠一组询价结果，具体参见表4。
    *
    * @return $this
    */
