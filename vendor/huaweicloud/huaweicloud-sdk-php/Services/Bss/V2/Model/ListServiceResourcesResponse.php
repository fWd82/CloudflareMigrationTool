...
class ListServiceResourcesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'infos' => '\HuaweiCloud\SDK\Bss\V2\Model\ServiceResourceInfo[]'
    ];
    ...
    *  资源基本信息列表，具体请参见表3。
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\ServiceResourceInfo[]|null
    */
    ...
    * Sets infos
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\ServiceResourceInfo[]|null $infos 资源基本信息列表，具体请参见表3。
    *
    * @return $this
    */
