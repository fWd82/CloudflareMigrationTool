...
class ListRenewRateOnPeriodResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'currency' => 'string',
            'renewInquiryResults' => '\HuaweiCloud\SDK\Bss\V2\Model\RenewInquiryResultInfo[]',
            'officialWebsiteRatingResult' => '\HuaweiCloud\SDK\Bss\V2\Model\OfficialWebsiteRatingResultV2',
            'optionalDiscountRatingResults' => '\HuaweiCloud\SDK\Bss\V2\Model\OptionalDiscountRatingResultV2[]',
    ...
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\OfficialWebsiteRatingResultV2|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\OfficialWebsiteRatingResultV2|null $officialWebsiteRatingResult officialWebsiteRatingResult
    *
    * @return $this
    */
