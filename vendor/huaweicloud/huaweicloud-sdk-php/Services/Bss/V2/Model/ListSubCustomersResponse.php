...
class ListSubCustomersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSubCustomersResponse';
    ...
    */
    protected static $openAPITypes = [
            'customerInfos' => '\HuaweiCloud\SDK\Bss\V2\Model\CustomerInformation[]',
            'count' => 'int'
    ];
    ...
    *  客户信息列表。 具体请参见表1。
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\CustomerInformation[]|null
    */
    ...
    * Sets customerInfos
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\CustomerInformation[]|null $customerInfos 客户信息列表。 具体请参见表1。
    *
    * @return $this
    */
