...
class ListCountiesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCountiesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * count  查询个数，成功的时候返回。
    * counties  区县信息列表，成功的时候返回，具体参见表2。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'counties' => '\HuaweiCloud\SDK\Bss\V2\Model\County[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\County[]|null
    */
    ...
    * Sets counties
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\County[]|null $counties 区县信息列表，成功的时候返回，具体参见表2。
    *
    * @return $this
    */
