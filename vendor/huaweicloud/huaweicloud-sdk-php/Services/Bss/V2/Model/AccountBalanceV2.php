...
class AccountBalanceV2 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AccountBalanceV2';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * accountId  账户标识。
    * accountType  账户类型： 1：余额2：信用5：奖励7：保证金8：可拨款
    * amount  账户余额。
    * currency  币种。 CNY：人民币。
    * designatedAmount  专款专用余额。
    * creditAmount  总信用额度。只有account_type取值为2时，该字段才有效。
    * measureId  度量单位。 1：元。
    * memo  备注。
    *
    * @var string[]
    ...
    * Sets accountType
    *
    * @param int $accountType 账户类型： 1：余额2：信用5：奖励7：保证金8：可拨款
    *
    * @return $this
    */
    ...
    * Sets currency
    *
    * @param string $currency 币种。 CNY：人民币。
    *
    * @return $this
    */
    ...
    * Sets creditAmount
    *
    * @param double|null $creditAmount 总信用额度。只有account_type取值为2时，该字段才有效。
    *
    * @return $this
    */
