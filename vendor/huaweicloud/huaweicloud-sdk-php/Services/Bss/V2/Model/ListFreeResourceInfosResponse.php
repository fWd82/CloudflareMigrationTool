...
class ListFreeResourceInfosResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'freeResourcePackages' => '\HuaweiCloud\SDK\Bss\V2\Model\FreeResourcePackageV3[]',
            'totalCount' => 'int'
    ];
    ...
    *  资源包信息列表，具体参见表2。
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\FreeResourcePackageV3[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\FreeResourcePackageV3[]|null $freeResourcePackages 资源包信息列表，具体参见表2。
    *
    * @return $this
    */
