...
class ShowRefundOrderDetailsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'refundInfos' => '\HuaweiCloud\SDK\Bss\V2\Model\OrderRefundInfoV2[]'
    ];
    ...
    *  资源信息列表。 具体请参见表2。
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\OrderRefundInfoV2[]|null
    */
    ...
    * Sets refundInfos
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\OrderRefundInfoV2[]|null $refundInfos 资源信息列表。 具体请参见表2。
    *
    * @return $this
    */
