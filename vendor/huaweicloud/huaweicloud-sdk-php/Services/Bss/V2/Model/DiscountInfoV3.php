...
class DiscountInfoV3 implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'discountType' => 'int',
            'orders' => '\HuaweiCloud\SDK\Bss\V2\Model\OrderV3[]'
    ];
    ...
    *  可使用折扣的订单列表。 具体请参见表3。
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\OrderV3[]
    */
    ...
    * Sets orders
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\OrderV3[] $orders 可使用折扣的订单列表。 具体请参见表3。
    *
    * @return $this
    */
