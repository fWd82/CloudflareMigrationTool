...
class AvailRetrieveCoupons implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AvailRetrieveCoupons';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * couponId  主优惠券ID。
    * planName  促销计划名称。
    * subCouponId  子优惠券ID。主优惠券拨款后生成的子优惠券ID。
    * balance  优惠券余额。单位为元
    ...
    * Sets couponId
    *
    * @param string|null $couponId 主优惠券ID。
    *
    * @return $this
    */
    ...
    * Sets subCouponId
    *
    * @param string|null $subCouponId 子优惠券ID。主优惠券拨款后生成的子优惠券ID。
    *
    * @return $this
    */
