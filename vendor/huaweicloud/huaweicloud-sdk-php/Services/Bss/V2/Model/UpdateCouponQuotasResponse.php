...
class UpdateCouponQuotasResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCouponQuotasResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * errorDetails  发放失败的云经销商额度信息，具体参见表1，只有HTTP STATUS 200的时候才有这个结构体。
    * simpleQuotaInfos  发放成功的云经销商额度信息，具体参见表2，只有HTTP STATUS 200的时候才有这个结构体。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'errorDetails' => '\HuaweiCloud\SDK\Bss\V2\Model\ErrorDetail[]',
            'simpleQuotaInfos' => '\HuaweiCloud\SDK\Bss\V2\Model\QuotaSimpleInfo[]'
    ];
    ...
    * Sets errorDetails
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\ErrorDetail[]|null $errorDetails 发放失败的云经销商额度信息，具体参见表1，只有HTTP STATUS 200的时候才有这个结构体。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\QuotaSimpleInfo[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\QuotaSimpleInfo[]|null $simpleQuotaInfos 发放成功的云经销商额度信息，具体参见表2，只有HTTP STATUS 200的时候才有这个结构体。
    *
    * @return $this
    */
