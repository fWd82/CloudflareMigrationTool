...
class ListCostsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Bss\V2\Model\ListCostsReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\ListCostsReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\ListCostsReq|null $body body
    *
    * @return $this
    */
