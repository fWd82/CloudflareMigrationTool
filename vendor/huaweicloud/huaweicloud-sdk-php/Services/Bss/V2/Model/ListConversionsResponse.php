...
class ListConversionsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'conversions' => '\HuaweiCloud\SDK\Bss\V2\Model\Conversion[]'
    ];
    ...
    *  度量单位的换算信息，具体参见表3。
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\Conversion[]|null
    */
    ...
    * Sets conversions
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\Conversion[]|null $conversions 度量单位的换算信息，具体参见表3。
    *
    * @return $this
    */
