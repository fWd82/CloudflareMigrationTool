...
class Province implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Province';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * code  省份的编码。
    * name  省份的名称，根据请求的语言会传递回对应的语言的名称，目前仅支持中文。
    *
    * @var string[]
    */
    ...
    * Sets name
    *
    * @param string $name 省份的名称，根据请求的语言会传递回对应的语言的名称，目前仅支持中文。
    *
    * @return $this
    */
