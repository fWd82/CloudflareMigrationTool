...
class ListResourceUsageResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListResourceUsageResponse';
    ...
    * totalCount  总条数。
    * usageInfoList  使用量明细（5分钟统计值）。具体请参见表3。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'totalCount' => 'int',
            'usageInfoList' => '\HuaweiCloud\SDK\Bss\V2\Model\StatUsageInfo[]'
    ];
    ...
    */
    protected static $setters = [
            ...
            'usageInfoList' => 'setUsageInfoList'
    ];
    ...
    */
    protected static $getters = [
            ...
            'usageInfoList' => 'getUsageInfoList'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['usageInfoList'] = isset($data['usageInfoList']) ? $data['usageInfoList'] : null;
    }
    ...
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\StatUsageInfo[]|null
    */
    public function getUsageInfoList()
    {
        return $this->container['usageInfoList'];
    }

    /**
    * Sets usageInfoList
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\StatUsageInfo[]|null $usageInfoList 使用量明细（5分钟统计值）。具体请参见表3。
    *
    * @return $this
    */
    public function setUsageInfoList($usageInfoList)
    {
        $this->container['usageInfoList'] = $usageInfoList;
        return $this;
    }
