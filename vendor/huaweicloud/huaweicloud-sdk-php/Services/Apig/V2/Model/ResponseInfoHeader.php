...
class ResponseInfoHeader implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResponseInfoHeader';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  分组自定义响应的响应头的key，支持英文字母、数字和中划线，长度为1到128位
    * value  分组自定义响应的响应头的value，为长度为1到1024位的字符串
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string|null $key 分组自定义响应的响应头的key，支持英文字母、数字和中划线，长度为1到128位
    *
    * @return $this
    */
