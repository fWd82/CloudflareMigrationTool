...
class ListApisBindedToRequestThrottlingPolicyV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApisBindedToRequestThrottlingPolicyV2Request';
