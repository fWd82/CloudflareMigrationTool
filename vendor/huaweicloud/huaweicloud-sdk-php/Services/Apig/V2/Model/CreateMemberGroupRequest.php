...
class CreateMemberGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMemberGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'vpcChannelId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\MemberGroupCreateBatch'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\MemberGroupCreateBatch|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\MemberGroupCreateBatch|null $body body
    *
    * @return $this
    */
