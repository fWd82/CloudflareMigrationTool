...
class ShowDetailsOfVpcChannelV2Response implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDetailsOfVpcChannelV2Response';
    ...
    */
    protected static $openAPITypes = [
            ...
            'vpcHealthConfig' => '\HuaweiCloud\SDK\Apig\V2\Model\VpcHealthConfigInfo'
    ];
    ...
    * Sets members
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\VpcMemberInfo[]|null $members 后端实例列表。
    *
    * @return $this
    */
    ...
    *  vpcHealthConfig
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\VpcHealthConfigInfo|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\VpcHealthConfigInfo|null $vpcHealthConfig vpcHealthConfig
    *
    * @return $this
    */
