...
class BackendParam implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BackendParam';
    ...
    * Sets reqParamId
    *
    * @param string|null $reqParamId 对应的请求参数编号
    *
    * @return $this
    */
