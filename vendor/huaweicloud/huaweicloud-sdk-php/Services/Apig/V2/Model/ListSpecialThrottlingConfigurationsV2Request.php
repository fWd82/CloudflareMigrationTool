...
class ListSpecialThrottlingConfigurationsV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSpecialThrottlingConfigurationsV2Request';
    ...
    * Sets objectType
    *
    * @param string|null $objectType 特殊流控类型：APP，USER
    *
    * @return $this
    */
    ...
    * Sets appName
    *
    * @param string|null $appName 筛选的特殊应用名称
    *
    * @return $this
    */
    ...
    * Sets user
    *
    * @param string|null $user 筛选的特殊用户名称
    *
    * @return $this
    */
