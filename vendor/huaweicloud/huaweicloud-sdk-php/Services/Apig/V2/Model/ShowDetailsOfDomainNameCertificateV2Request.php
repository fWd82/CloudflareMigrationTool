...
class ShowDetailsOfDomainNameCertificateV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDetailsOfDomainNameCertificateV2Request';
