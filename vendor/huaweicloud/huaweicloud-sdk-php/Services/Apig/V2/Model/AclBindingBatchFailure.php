...
class AclBindingBatchFailure implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AclBindingBatchFailure';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * bindId  解除绑定失败的API和ACL绑定关系ID
    ...
    * Sets bindId
    *
    * @param string|null $bindId 解除绑定失败的API和ACL绑定关系ID
    *
    * @return $this
    */
