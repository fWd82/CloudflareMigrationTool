...
class ListApisBindedToAppV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApisBindedToAppV2Request';
    ...
    * Sets envId
    *
    * @param string|null $envId 授权的环境编号
    *
    * @return $this
    */
