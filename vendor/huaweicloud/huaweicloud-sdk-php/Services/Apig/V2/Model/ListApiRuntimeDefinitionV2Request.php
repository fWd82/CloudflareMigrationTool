...
class ListApiRuntimeDefinitionV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApiRuntimeDefinitionV2Request';
    ...
    * Sets envId
    *
    * @param string|null $envId API的发布环境编号
    *
    * @return $this
    */
