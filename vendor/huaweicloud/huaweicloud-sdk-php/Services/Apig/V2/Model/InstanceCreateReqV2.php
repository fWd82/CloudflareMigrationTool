...
class InstanceCreateReqV2 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InstanceCreateReqV2';
    ...
    *
    * @param string[]|null $availableZoneIds 可用区列表
    *
    * @return $this
    */
    ...
    *
    * @param string|null $loadbalancerProvider 负载均衡器类型： - lvs - elb
    *
    * @return $this
    */
    ...
    *
    * @param int|null $ingressBandwidthSize 入口带宽大小
    *
    * @return $this
    */
