...
class ApiAclInfoWithBindNum implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ApiAclInfoWithBindNum';
    ...
    * Sets aclValue
    *
    * @param string|null $aclValue ACL策略的值
    *
    * @return $this
    */
