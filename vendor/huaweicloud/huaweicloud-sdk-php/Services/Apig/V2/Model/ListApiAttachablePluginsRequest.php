...
class ListApiAttachablePluginsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApiAttachablePluginsRequest';
    ...
    * Sets pluginId
    *
    * @param string|null $pluginId 插件编号
    *
    * @return $this
    */
