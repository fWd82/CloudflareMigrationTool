...
class CreateAppCodeV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAppCodeV2Request';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'appId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\AppCodeCreate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\AppCodeCreate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\AppCodeCreate|null $body body
    *
    * @return $this
    */
