...
class TmsKeyValue implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TmsKeyValue';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  键。  支持可用 UTF-8 格式表示的字母(包含中文)、数字和空格，以及以下字符： _ . : = + - @； \\_sys\\_开头属于系统标签，租户不能输入
    * value  值。  支持可用 UTF-8 格式表示的字母(包含中文)、数字和空格，以及以下字符： _ . : / = + - @
    *
    * @var string[]
    */
    ...
    * Sets value
    *
    * @param string|null $value 值。  支持可用 UTF-8 格式表示的字母(包含中文)、数字和空格，以及以下字符： _ . : / = + - @
    *
    * @return $this
    */
