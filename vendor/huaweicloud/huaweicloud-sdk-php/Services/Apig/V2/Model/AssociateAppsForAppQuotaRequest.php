...
class AssociateAppsForAppQuotaRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateAppsForAppQuotaRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'appQuotaId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\CreateAppQuotaBindingApp'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\CreateAppQuotaBindingApp|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\CreateAppQuotaBindingApp|null $body body
    *
    * @return $this
    */
