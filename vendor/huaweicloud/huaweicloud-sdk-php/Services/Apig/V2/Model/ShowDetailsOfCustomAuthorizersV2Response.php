...
class ShowDetailsOfCustomAuthorizersV2Response implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDetailsOfCustomAuthorizersV2Response';
