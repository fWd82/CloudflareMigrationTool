...
class ListAclStrategiesV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAclStrategiesV2Request';
    ...
    * Sets name
    *
    * @param string|null $name ACL策略名称。
    *
    * @return $this
    */
    ...
    * Sets entityType
    *
    * @param string|null $entityType 作用的对象类型： - IP - DOMAIN
    *
    * @return $this
    */
