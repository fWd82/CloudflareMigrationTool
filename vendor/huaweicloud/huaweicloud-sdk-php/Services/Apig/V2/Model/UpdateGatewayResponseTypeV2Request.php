...
class UpdateGatewayResponseTypeV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGatewayResponseTypeV2Request';
    ...
    */
    protected static $openAPITypes = [
            ...
            'responseId' => 'string',
            'responseType' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\ResponseInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\ResponseInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\ResponseInfo|null $body body
    *
    * @return $this
    */
