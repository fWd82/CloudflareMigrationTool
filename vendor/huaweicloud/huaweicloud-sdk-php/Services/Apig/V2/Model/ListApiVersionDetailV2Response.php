...
class ListApiVersionDetailV2Response implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApiVersionDetailV2Response';
    ...
    */
    protected static $openAPITypes = [
            ...
            'policyHttps' => '\HuaweiCloud\SDK\Apig\V2\Model\ApiPolicyHttpResp[]',
            'slDomain' => 'string',
            'slDomains' => 'string[]',
            'versionId' => 'string'
    ];
    ...
    * Sets publishTime
    *
    * @param \DateTime|null $publishTime 版本发布时间
    *
    * @return $this
    */
    ...
    *  web策略后端列表
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\ApiPolicyHttpResp[]|null
    */
    ...
    * Sets policyHttps
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\ApiPolicyHttpResp[]|null $policyHttps web策略后端列表
    *
    * @return $this
    */
    ...
    * Sets slDomain
    *
    * @param string|null $slDomain 系统默认分配的子域名
    *
    * @return $this
    */
    ...
    * Sets versionId
    *
    * @param string|null $versionId 版本编号
    *
    * @return $this
    */
