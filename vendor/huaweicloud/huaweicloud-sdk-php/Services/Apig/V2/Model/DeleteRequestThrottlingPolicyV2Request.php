...
class DeleteRequestThrottlingPolicyV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteRequestThrottlingPolicyV2Request';
