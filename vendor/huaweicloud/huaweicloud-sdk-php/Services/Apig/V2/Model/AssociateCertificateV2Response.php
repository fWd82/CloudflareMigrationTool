...
class AssociateCertificateV2Response implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateCertificateV2Response';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sslName'] === null) {
            $invalidProperties[] = "'sslName' can't be null";
        }
