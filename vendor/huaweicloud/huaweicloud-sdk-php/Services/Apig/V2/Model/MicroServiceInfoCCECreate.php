...
class MicroServiceInfoCCECreate implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MicroServiceInfoCCECreate';
    ...
    */
    protected static $openAPITypes = [
            ...
            'version' => 'string',
            'port' => 'int',
            'labels' => '\HuaweiCloud\SDK\Apig\V2\Model\MicroserviceLabel[]'
    ];
    ...
    * Sets version
    *
    * @param string|null $version 工作负载的版本
    *
    * @return $this
    */
    ...
    * Sets labels
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\MicroserviceLabel[]|null $labels 工作负载的标签列表。
    *
    * @return $this
    */
