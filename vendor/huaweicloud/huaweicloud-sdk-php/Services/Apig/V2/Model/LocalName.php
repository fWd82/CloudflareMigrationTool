...
class LocalName implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LocalName';
    ...
    * Sets enUs
    *
    * @param string|null $enUs 可用区英文名称。
    *
    * @return $this
    */
    ...
    * Sets zhCn
    *
    * @param string|null $zhCn 可用区中文名称。
    *
    * @return $this
    */
