...
class ListApiVersionsV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApiVersionsV2Request';
    ...
    * Sets envName
    *
    * @param string|null $envName 环境的名称
    *
    * @return $this
    */
