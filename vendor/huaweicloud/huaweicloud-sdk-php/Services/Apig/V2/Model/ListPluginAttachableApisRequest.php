...
class ListPluginAttachableApisRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPluginAttachableApisRequest';
    ...
    * Sets groupId
    *
    * @param string|null $groupId 分组编号
    *
    * @return $this
    */
