...
class ListApisBindedToSignatureKeyV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApisBindedToSignatureKeyV2Request';
