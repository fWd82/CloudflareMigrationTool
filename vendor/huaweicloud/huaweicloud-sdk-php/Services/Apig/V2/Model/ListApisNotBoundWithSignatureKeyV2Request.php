...
class ListApisNotBoundWithSignatureKeyV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApisNotBoundWithSignatureKeyV2Request';
