...
class UpdateMemberGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMemberGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\MemberGroupCreate'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\MemberGroupCreate|null $body body
    *
    * @return $this
    */
