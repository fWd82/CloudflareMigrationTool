...
class ListSignatureKeysBindedToApiV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSignatureKeysBindedToApiV2Request';
    ...
    * Sets signName
    *
    * @param string|null $signName 签名密钥的名称
    *
    * @return $this
    */
