...
class ListApisUnbindedToRequestThrottlingPolicyV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApisUnbindedToRequestThrottlingPolicyV2Request';
