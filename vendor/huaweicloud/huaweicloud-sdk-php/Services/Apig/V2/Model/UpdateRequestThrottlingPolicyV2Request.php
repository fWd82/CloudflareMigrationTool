...
class UpdateRequestThrottlingPolicyV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRequestThrottlingPolicyV2Request';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'throttleId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\ThrottleBaseInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\ThrottleBaseInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\ThrottleBaseInfo|null $body body
    *
    * @return $this
    */
