...
class UpdateVpcChannelV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpcChannelV2Request';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'vpcChannelId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\VpcCreate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\VpcCreate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\VpcCreate|null $body body
    *
    * @return $this
    */
