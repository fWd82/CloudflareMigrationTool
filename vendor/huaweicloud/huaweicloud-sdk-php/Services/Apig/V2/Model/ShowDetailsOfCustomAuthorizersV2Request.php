...
class ShowDetailsOfCustomAuthorizersV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDetailsOfCustomAuthorizersV2Request';
