...
class MicroServiceInfoCCEServiceCreate implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MicroServiceInfoCCEServiceCreate';
    ...
    * port  Service的监听端口号。如果是多端口Service，用户需填写一个端口。
    *
    * @var string[]
    */
    ...
    * Sets port
    *
    * @param int|null $port Service的监听端口号。如果是多端口Service，用户需填写一个端口。
    *
    * @return $this
    */
