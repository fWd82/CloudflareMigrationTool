...
class ResettingAppSecretV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResettingAppSecretV2Request';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'appId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\AppResetCreate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\AppResetCreate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\AppResetCreate|null $body body
    *
    * @return $this
    */
