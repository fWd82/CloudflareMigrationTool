...
class ListSignatureKeysV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSignatureKeysV2Request';
