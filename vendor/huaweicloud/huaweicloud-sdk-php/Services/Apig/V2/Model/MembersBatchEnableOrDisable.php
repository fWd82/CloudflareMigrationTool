...
class MembersBatchEnableOrDisable implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MembersBatchEnableOrDisable';
    ...
    * Sets memberIds
    *
    * @param string[]|null $memberIds 后端服务器编号列表。
    *
    * @return $this
    */
