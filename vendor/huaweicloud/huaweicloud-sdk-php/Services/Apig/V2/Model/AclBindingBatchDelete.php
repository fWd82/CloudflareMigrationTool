...
class AclBindingBatchDelete implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AclBindingBatchDelete';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * aclBindings  需要解除绑定的API和ACL绑定关系ID列表
    *
    * @var string[]
    */
    ...
    * Sets aclBindings
    *
    * @param string[]|null $aclBindings 需要解除绑定的API和ACL绑定关系ID列表
    *
    * @return $this
    */
