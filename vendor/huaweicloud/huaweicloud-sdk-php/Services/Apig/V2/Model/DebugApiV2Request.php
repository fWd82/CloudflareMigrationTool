...
class DebugApiV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DebugApiV2Request';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'apiId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\ApiDebugInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\ApiDebugInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\ApiDebugInfo|null $body body
    *
    * @return $this
    */
