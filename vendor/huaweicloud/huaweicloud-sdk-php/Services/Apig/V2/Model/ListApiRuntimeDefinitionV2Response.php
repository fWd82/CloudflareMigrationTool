...
class ListApiRuntimeDefinitionV2Response implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApiRuntimeDefinitionV2Response';
    ...
    * Sets slDomain
    *
    * @param string|null $slDomain 分组的二级域名
    *
    * @return $this
    */
