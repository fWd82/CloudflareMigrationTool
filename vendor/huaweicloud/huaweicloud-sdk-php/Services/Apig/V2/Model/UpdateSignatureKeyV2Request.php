...
class UpdateSignatureKeyV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSignatureKeyV2Request';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'signId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\BaseSignature'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\BaseSignature|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\BaseSignature|null $body body
    *
    * @return $this
    */
