...
class ListRequestThrottlingPolicyV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRequestThrottlingPolicyV2Request';
