...
class ListApiGroupsV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApiGroupsV2Request';
    ...
    * id  API分组编号
    * name  API分组名称
    * preciseSearch  指定需要精确匹配查找的参数名称，目前仅支持API分组名称
    *
    * @var string[]
    */
    ...
    * Sets name
    *
    * @param string|null $name API分组名称
    *
    * @return $this
    */
    ...
    * Sets preciseSearch
    *
    * @param string|null $preciseSearch 指定需要精确匹配查找的参数名称，目前仅支持API分组名称
    *
    * @return $this
    */
