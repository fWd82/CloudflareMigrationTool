...
class UpdateAppQuotaRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAppQuotaRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'appQuotaId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\AppQuotaCreate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\AppQuotaCreate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\AppQuotaCreate|null $body body
    *
    * @return $this
    */
