...
class ApiCheckInfoV2 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ApiCheckInfoV2';
    ...
    * Sets type
    *
    * @param string|null $type 校验类型：   - path：路径类型   - name：名称类型
    *
    * @return $this
    */
