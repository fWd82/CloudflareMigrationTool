...
class UpdateApiV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateApiV2Request';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'apiId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\ApiCreate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\ApiCreate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\ApiCreate|null $body body
    *
    * @return $this
    */
