...
class ListApisUnbindedToAclPolicyV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApisUnbindedToAclPolicyV2Request';
