...
class AddingBackendInstancesV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddingBackendInstancesV2Request';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'vpcChannelId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\VpcMemberCreate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\VpcMemberCreate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\VpcMemberCreate|null $body body
    *
    * @return $this
    */
