...
class CreateSpecialThrottlingConfigurationV2Response implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSpecialThrottlingConfigurationV2Response';
