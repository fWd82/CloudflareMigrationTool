...
class OpenEngressEipReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OpenEngressEipReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * bandwidthSize  出公网带宽  单位：Mbit/s
    * bandwidthChargingMode  出公网带宽计费类型： - bandwidth：按带宽计费 - traffic：按流量计费
    *
    * @var string[]
    */
    ...
    * Sets bandwidthSize
    *
    * @param string|null $bandwidthSize 出公网带宽  单位：Mbit/s
    *
    * @return $this
    */
    ...
    *
    * @param string|null $bandwidthChargingMode 出公网带宽计费类型： - bandwidth：按带宽计费 - traffic：按流量计费
    *
    * @return $this
    */
