...
class ThrottleForApi implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ThrottleForApi';
    ...
    * createTime  创建时间
    * envName  流控策略生效的环境（即在哪个环境上有效）
    * bindId  流控策略与API绑定关系编号
    * bindTime  流控策略与API绑定时间
    *
    * @var string[]
    */
    ...
    * Sets envName
    *
    * @param string|null $envName 流控策略生效的环境（即在哪个环境上有效）
    *
    * @return $this
    */
    ...
    * Sets bindId
    *
    * @param string|null $bindId 流控策略与API绑定关系编号
    *
    * @return $this
    */
    ...
    * Sets bindTime
    *
    * @param \DateTime|null $bindTime 流控策略与API绑定时间
    *
    * @return $this
    */
