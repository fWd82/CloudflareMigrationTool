...
class CreateAppQuotaBindingApp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAppQuotaBindingApp';
