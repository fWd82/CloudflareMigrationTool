...
class DeleteSpecialThrottlingConfigurationV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteSpecialThrottlingConfigurationV2Request';
