...
class MemberGroupCreateBatch implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MemberGroupCreateBatch';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * memberGroups  后端服务器组列表
    *
    * @var string[]
    */
    ...
    * Sets memberGroups
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\MemberGroupCreate[]|null $memberGroups 后端服务器组列表
    *
    * @return $this
    */
