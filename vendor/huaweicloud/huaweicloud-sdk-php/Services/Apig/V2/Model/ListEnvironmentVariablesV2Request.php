...
class ListEnvironmentVariablesV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEnvironmentVariablesV2Request';
    ...
    * Sets variableName
    *
    * @param string|null $variableName 变量名
    *
    * @return $this
    */
