...
class UpdateBackendInstancesV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateBackendInstancesV2Request';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'vpcChannelId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\VpcMemberModify'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\VpcMemberModify|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\VpcMemberModify|null $body body
    *
    * @return $this
    */
