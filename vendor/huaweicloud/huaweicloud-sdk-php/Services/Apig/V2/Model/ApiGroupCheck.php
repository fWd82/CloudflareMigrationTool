...
class ApiGroupCheck implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ApiGroupCheck';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * groupName  待校验的API分组名称
    ...
    * Sets groupName
    *
    * @param string $groupName 待校验的API分组名称
    *
    * @return $this
    */
