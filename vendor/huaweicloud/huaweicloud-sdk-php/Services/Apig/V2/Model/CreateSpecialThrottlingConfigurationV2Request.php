...
class CreateSpecialThrottlingConfigurationV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSpecialThrottlingConfigurationV2Request';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'throttleId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\ThrottleSpecialCreate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\ThrottleSpecialCreate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\ThrottleSpecialCreate|null $body body
    *
    * @return $this
    */
