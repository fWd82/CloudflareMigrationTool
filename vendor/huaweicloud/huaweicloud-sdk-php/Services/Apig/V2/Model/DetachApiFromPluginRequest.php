...
class DetachApiFromPluginRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DetachApiFromPluginRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'pluginId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\PluginOperApiInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\PluginOperApiInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\PluginOperApiInfo|null $body body
    *
    * @return $this
    */
