...
class UpdateAppAclRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAppAclRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'appId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\AppAclCreate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\AppAclCreate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\AppAclCreate|null $body body
    *
    * @return $this
    */
