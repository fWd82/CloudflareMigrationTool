...
class ShowDetailsOfGatewayResponseV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDetailsOfGatewayResponseV2Request';
