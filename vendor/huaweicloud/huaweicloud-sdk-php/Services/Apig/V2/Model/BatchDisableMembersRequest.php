...
class BatchDisableMembersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDisableMembersRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'vpcChannelId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\MembersBatchEnableOrDisable'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\MembersBatchEnableOrDisable|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\MembersBatchEnableOrDisable|null $body body
    *
    * @return $this
    */
