...
class ApiCreate implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ApiCreate';
    ...
    */
    protected static $openAPITypes = [
            ...
            'backendApi' => '\HuaweiCloud\SDK\Apig\V2\Model\BackendApiCreate',
            'policyHttps' => '\HuaweiCloud\SDK\Apig\V2\Model\ApiPolicyHttpCreate[]'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['policyHttps'] = isset($data['policyHttps']) ? $data['policyHttps'] : null;
    }
    ...
    *  backendApi
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\BackendApiCreate|null
    */
    ...
    * Sets backendApi
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\BackendApiCreate|null $backendApi backendApi
    *
    * @return $this
    */
    ...
    *  web策略后端列表
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\ApiPolicyHttpCreate[]|null
    */
    public function getPolicyHttps()
    {
        return $this->container['policyHttps'];
    }

    /**
    * Sets policyHttps
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\ApiPolicyHttpCreate[]|null $policyHttps web策略后端列表
    *
    * @return $this
    */
    public function setPolicyHttps($policyHttps)
    {
        $this->container['policyHttps'] = $policyHttps;
        return $this;
    }
