...
class UrlDomainCreate implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UrlDomainCreate';
    ...
    * Sets urlDomain
    *
    * @param string|null $urlDomain 自定义域名。长度为0-255位的字符串，需要符合域名规范。
    *
    * @return $this
    */
