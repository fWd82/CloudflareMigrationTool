...
class ListAttachedDomainsV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAttachedDomainsV2Request';
    ...
    * Sets urlDomain
    *
    * @param string|null $urlDomain 独立域名
    *
    * @return $this
    */
