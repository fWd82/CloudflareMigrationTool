...
class UpdateSpecialThrottlingConfigurationV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSpecialThrottlingConfigurationV2Request';
    ...
    */
    protected static $openAPITypes = [
            ...
            'throttleId' => 'string',
            'strategyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\ThrottleSpecialUpdate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\ThrottleSpecialUpdate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\ThrottleSpecialUpdate|null $body body
    *
    * @return $this
    */
