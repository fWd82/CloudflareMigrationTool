...
class SignatureWithBindNum implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SignatureWithBindNum';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  签名密钥的名称。支持汉字，英文，数字，下划线，且只能以英文和汉字开头。 > 中文字符必须为UTF-8或者unicode编码。
    * signType  签名密钥类型： - hmac - basic - public_key - aes  basic类型需要实例升级到对应版本，若不存在可联系技术工程师升级。  public_key类型开启实例配置public_key才可使用，实例特性配置详情请参考“附录 > 实例支持的APIG特性”，如确认实例不存在public_key配置可联系技术工程师开启。  aes类型需要实例升级到对应版本，若不存在可联系技术工程师升级。
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['ldapiBindNum'] = isset($data['ldapiBindNum']) ? $data['ldapiBindNum'] : null;
    }
    ...
    * Sets signType
    *
    * @param string|null $signType 签名密钥类型： - hmac - basic - public_key - aes  basic类型需要实例升级到对应版本，若不存在可联系技术工程师升级。  public_key类型开启实例配置public_key才可使用，实例特性配置详情请参考“附录 > 实例支持的APIG特性”，如确认实例不存在public_key配置可联系技术工程师开启。  aes类型需要实例升级到对应版本，若不存在可联系技术工程师升级。
    *
    * @return $this
    */
    ...
    * Sets bindNum
    *
    * @param int|null $bindNum 绑定的API数量
    *
    * @return $this
    */
    ...
    * @return int|null
    */
    public function getLdapiBindNum()
    {
        return $this->container['ldapiBindNum'];
    }

    /**
    * Sets ldapiBindNum
    *
    * @param int|null $ldapiBindNum 绑定的自定义后端数量  暂不支持
    *
    * @return $this
    */
    public function setLdapiBindNum($ldapiBindNum)
    {
        $this->container['ldapiBindNum'] = $ldapiBindNum;
        return $this;
    }
