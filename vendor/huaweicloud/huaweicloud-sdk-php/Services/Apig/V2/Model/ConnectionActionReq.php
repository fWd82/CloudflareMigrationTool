...
class ConnectionActionReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ConnectionActionReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * action  允许或拒绝连接 - receive 接受 - reject 拒绝
    * endpoints  终端节点列表
    *
    * @var string[]
    */
    ...
    * Sets action
    *
    * @param string $action 允许或拒绝连接 - receive 接受 - reject 拒绝
    *
    * @return $this
    */
