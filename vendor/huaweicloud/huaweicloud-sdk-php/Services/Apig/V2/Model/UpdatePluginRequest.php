...
class UpdatePluginRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePluginRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'pluginId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\PluginCreate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\PluginCreate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\PluginCreate|null $body body
    *
    * @return $this
    */
