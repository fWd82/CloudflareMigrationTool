...
class CreateMemberGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMemberGroupResponse';
    ...
    * Sets memberGroups
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\MemberGroupInfo[]|null $memberGroups VPC通道后端服务器组列表
    *
    * @return $this
    */
