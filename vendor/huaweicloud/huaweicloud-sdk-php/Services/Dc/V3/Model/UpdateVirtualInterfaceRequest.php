...
class UpdateVirtualInterfaceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVirtualInterfaceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Dc\V3\Model\UpdateVirtualInterfaceRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dc\V3\Model\UpdateVirtualInterfaceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\UpdateVirtualInterfaceRequestBody|null $body body
    *
    * @return $this
    */
