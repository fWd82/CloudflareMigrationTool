...
class ListSwitchoverTestRecordsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSwitchoverTestRecordsRequest';
    ...
    * sortKey  排序字段。
    * resourceId  通过RESOURCE-ID过虑倒换测试记录信息
    *
    * @var string[]
    */
    ...
    * Sets resourceId
    *
    * @param string[]|null $resourceId 通过RESOURCE-ID过虑倒换测试记录信息
    *
    * @return $this
    */
