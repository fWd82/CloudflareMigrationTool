...
class UpdateHostedDirectConnectRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateHostedDirectConnectRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Dc\V3\Model\UpdateHostedDirectConnectRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dc\V3\Model\UpdateHostedDirectConnectRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\UpdateHostedDirectConnectRequestBody|null $body body
    *
    * @return $this
    */
