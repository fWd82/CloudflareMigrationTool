...
class UpdateVifPeerResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVifPeerResponse';
    ...
    * Sets vifPeer
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\VifPeer|null $vifPeer vifPeer
    *
    * @return $this
    */
