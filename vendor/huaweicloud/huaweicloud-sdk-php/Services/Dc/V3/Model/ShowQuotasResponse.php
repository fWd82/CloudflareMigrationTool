...
class ShowQuotasResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'quotas' => '\HuaweiCloud\SDK\Dc\V3\Model\ShowQuotasResponseBodyQuotas'
    ];
    ...
    *  quotas
    *
    * @return \HuaweiCloud\SDK\Dc\V3\Model\ShowQuotasResponseBodyQuotas|null
    */
    ...
    * Sets quotas
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\ShowQuotasResponseBodyQuotas|null $quotas quotas
    *
    * @return $this
    */
