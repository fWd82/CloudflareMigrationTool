...
class CreateMetricDataRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMetricDataRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * body  添加一条或多条自定义指标监控数据，请求参数。
    *
    * @var string[]
    */
