...
class ListEventsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'events' => '\HuaweiCloud\SDK\Ces\V1\Model\EventInfo[]',
    ...
    *  一条或者多条事件数据。
    *
    * @return \HuaweiCloud\SDK\Ces\V1\Model\EventInfo[]|null
    */
    ...
    * Sets events
    *
    * @param \HuaweiCloud\SDK\Ces\V1\Model\EventInfo[]|null $events 一条或者多条事件数据。
    *
    * @return $this
    */
