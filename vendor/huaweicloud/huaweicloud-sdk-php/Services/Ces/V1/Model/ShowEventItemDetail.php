...
class ShowEventItemDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowEventItemDetail';
    ...
    * Sets dimensions
    *
    * @param \HuaweiCloud\SDK\Ces\V1\Model\MetricsDimension[]|null $dimensions 维度信息列表
    *
    * @return $this
    */
