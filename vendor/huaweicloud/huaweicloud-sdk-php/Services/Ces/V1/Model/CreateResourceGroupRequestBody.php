...
class CreateResourceGroupRequestBody implements ModelInterface, ArrayAccess
{
    ...
    *  创建的资源分组选择一个或者多个资源。
    *
    * @return \HuaweiCloud\SDK\Ces\V1\Model\CreateResourceGroup[]
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Ces\V1\Model\CreateResourceGroup[] $resources 创建的资源分组选择一个或者多个资源。
    *
    * @return $this
    */
