...
class UpdateAlarmRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAlarmRequest';
    ...
    */
    protected static $openAPITypes = [
            'alarmId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ces\V1\Model\UpdateAlarmRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ces\V1\Model\UpdateAlarmRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ces\V1\Model\UpdateAlarmRequestBody|null $body body
    *
    * @return $this
    */
