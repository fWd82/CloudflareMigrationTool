...
class MetricInfoList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MetricInfoList';
    ...
    * Sets dimensions
    *
    * @param \HuaweiCloud\SDK\Ces\V1\Model\MetricsDimension[] $dimensions 指标维度
    *
    * @return $this
    */
