...
class ModifyAlarmActionReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyAlarmActionReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * alarmEnabled  告警是否启用。true：启动。false：停止
    *
    * @var string[]
    */
    ...
    * Sets alarmEnabled
    *
    * @param bool $alarmEnabled 告警是否启用。true：启动。false：停止
    *
    * @return $this
    */
