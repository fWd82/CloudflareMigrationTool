...
class UpdateAlarmActionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAlarmActionRequest';
    ...
    */
    protected static $openAPITypes = [
            'alarmId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ces\V1\Model\ModifyAlarmActionReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ces\V1\Model\ModifyAlarmActionReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ces\V1\Model\ModifyAlarmActionReq|null $body body
    *
    * @return $this
    */
