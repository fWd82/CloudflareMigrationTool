...
class BatchDeleteResourcesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteResourcesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * succeedCount  成功删除的资源数目
    *
    * @var string[]
    */
    ...
    * Sets succeedCount
    *
    * @param int|null $succeedCount 成功删除的资源数目
    *
    * @return $this
    */
