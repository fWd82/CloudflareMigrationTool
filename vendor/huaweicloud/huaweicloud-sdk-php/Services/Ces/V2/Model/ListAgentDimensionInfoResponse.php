...
class ListAgentDimensionInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAgentDimensionInfoResponse';
    ...
    */
    protected static $openAPITypes = [
            'dimensions' => '\HuaweiCloud\SDK\Ces\V2\Model\AgentDimension[]',
            'count' => 'int'
    ];
