...
class CreateOneClickAlarmResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateOneClickAlarmResponse';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['oneClickAlarmId']) && (mb_strlen($this->container['oneClickAlarmId']) > 64)) {
                $invalidProperties[] = "invalid value for 'oneClickAlarmId', the character length must be smaller than or equal to 64.";
            }
            if (!is_null($this->container['oneClickAlarmId']) && (mb_strlen($this->container['oneClickAlarmId']) < 1)) {
                $invalidProperties[] = "invalid value for 'oneClickAlarmId', the character length must be bigger than or equal to 1.";
            }
            if (!is_null($this->container['oneClickAlarmId']) && !preg_match("/^([a-z]|[A-Z]|[0-9]){1,64}$/", $this->container['oneClickAlarmId'])) {
