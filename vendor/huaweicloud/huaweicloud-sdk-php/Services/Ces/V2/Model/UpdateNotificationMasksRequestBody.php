...
class UpdateNotificationMasksRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateNotificationMasksRequestBody';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['maskName'] === null) {
            $invalidProperties[] = "'maskName' can't be null";
        }
            if ((mb_strlen($this->container['maskName']) > 64)) {
    ...
    *  relationType
    *
    * @return \HuaweiCloud\SDK\Ces\V2\Model\RelationType|null
    */
    ...
    * Sets relationType
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\RelationType|null $relationType relationType
    *
    * @return $this
    */
