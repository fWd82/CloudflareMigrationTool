...
class UpdateResourceGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ces\V2\Model\PutResourceGroupReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ces\V2\Model\PutResourceGroupReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\PutResourceGroupReq|null $body body
    *
    * @return $this
    */
