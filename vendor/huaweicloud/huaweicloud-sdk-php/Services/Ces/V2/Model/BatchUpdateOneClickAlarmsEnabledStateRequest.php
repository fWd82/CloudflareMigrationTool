...
class BatchUpdateOneClickAlarmsEnabledStateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateOneClickAlarmsEnabledStateRequest';
