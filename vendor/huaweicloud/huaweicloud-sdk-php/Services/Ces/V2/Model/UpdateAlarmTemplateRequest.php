...
class UpdateAlarmTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'templateId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ces\V2\Model\UpdateAlarmTemplateRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ces\V2\Model\UpdateAlarmTemplateRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\UpdateAlarmTemplateRequestBody|null $body body
    *
    * @return $this
    */
