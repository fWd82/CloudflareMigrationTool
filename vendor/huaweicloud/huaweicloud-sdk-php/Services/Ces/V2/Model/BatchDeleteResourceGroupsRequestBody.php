...
class BatchDeleteResourceGroupsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteResourceGroupsRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * groupIds  需要批量删除的资源分组ID列表
    *
    * @var string[]
    */
    ...
    * Sets groupIds
    *
    * @param string[] $groupIds 需要批量删除的资源分组ID列表
    *
    * @return $this
    */
