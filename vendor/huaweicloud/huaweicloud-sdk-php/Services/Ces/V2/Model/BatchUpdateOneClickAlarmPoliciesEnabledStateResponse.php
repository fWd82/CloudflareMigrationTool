...
class BatchUpdateOneClickAlarmPoliciesEnabledStateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateOneClickAlarmPoliciesEnabledStateResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * alarmPolicyIds  成功启停的告警规则策略ID列表
    *
    * @var string[]
    */
    ...
    * Sets alarmPolicyIds
    *
    * @param string[]|null $alarmPolicyIds 成功启停的告警规则策略ID列表
    *
    * @return $this
    */
