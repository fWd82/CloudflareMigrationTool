...
class BatchDeleteAlarmRulesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteAlarmRulesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * alarmIds  成功删除的告警规则ID列表
    *
    * @var string[]
    */
    ...
    * Sets alarmIds
    *
    * @param string[]|null $alarmIds 成功删除的告警规则ID列表
    *
    * @return $this
    */
