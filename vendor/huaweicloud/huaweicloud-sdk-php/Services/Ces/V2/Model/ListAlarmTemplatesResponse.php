...
class ListAlarmTemplatesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'alarmTemplates' => '\HuaweiCloud\SDK\Ces\V2\Model\AlarmTemplates[]',
            'count' => 'int'
    ];
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['count']) && ($this->container['count'] > 9999999)) {
                $invalidProperties[] = "invalid value for 'count', must be smaller than or equal to 9999999.";
            }
    ...
    *  告警模板列表
    *
    * @return \HuaweiCloud\SDK\Ces\V2\Model\AlarmTemplates[]|null
    */
    ...
    * Sets alarmTemplates
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\AlarmTemplates[]|null $alarmTemplates 告警模板列表
    *
    * @return $this
    */
