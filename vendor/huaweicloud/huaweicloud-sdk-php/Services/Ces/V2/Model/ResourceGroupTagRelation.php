    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['key'] === null) {
            ...
            if (!is_null($this->container['value']) && (mb_strlen($this->container['value']) > 42)) {
                $invalidProperties[] = "invalid value for 'value', the character length must be smaller than or equal to 42.";
            }
