...
class UpdateOneClickAlarmNotificationsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateOneClickAlarmNotificationsRequest';
