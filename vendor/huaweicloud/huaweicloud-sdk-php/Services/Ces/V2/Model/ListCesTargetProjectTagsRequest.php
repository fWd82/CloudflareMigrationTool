...
class ListCesTargetProjectTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCesTargetProjectTagsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceType  资源类型。CES-alarm：告警规则
    *
    * @var string[]
    */
    ...
    */
    ...
    const RESOURCE_TYPE_CES_ALARM = 'CES-alarm';
    ...
    * Sets resourceType
    *
    * @param string $resourceType 资源类型。CES-alarm：告警规则
    *
    * @return $this
    */
