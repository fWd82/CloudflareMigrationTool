...
class BatchDeleteNotificationMasksRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteNotificationMasksRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * notificationMaskIds  屏蔽规则编号
    *
    * @var string[]
    */
    ...
    *
    * @param string[] $notificationMaskIds 屏蔽规则编号
    *
    * @return $this
    */
