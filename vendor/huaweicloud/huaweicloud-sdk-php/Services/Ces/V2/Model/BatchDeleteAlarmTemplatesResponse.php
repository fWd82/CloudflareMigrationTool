...
class BatchDeleteAlarmTemplatesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteAlarmTemplatesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * templateIds  成功删除的告警模板ID列表
    *
    * @var string[]
    */
    ...
    * Sets templateIds
    *
    * @param string[]|null $templateIds 成功删除的告警模板ID列表
    *
    * @return $this
    */
