...
class Metric implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'metricName' => 'string',
            'dimensions' => '\HuaweiCloud\SDK\Ces\V2\Model\Dimension[]'
    ];
    ...
    * Sets metricName
    *
    * @param string|null $metricName 资源的监控指标名称，必须以字母开头，只能包含0-9/a-z/A-Z/_，字符长度最短为1，最大为64；如：弹性云服务器中的监控指标cpu_util，表示弹性服务器的CPU使用率；文档数据库中的指标mongo001_command_ps，表示command执行频率；各服务的指标名称可查看：“[服务指标名称](https://support.huaweicloud.com/usermanual-ces/zh-cn_topic_0202622212.html)”。
    *
    * @return $this
    */
    ...
    * Sets dimensions
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\Dimension[]|null $dimensions 指标维度，目前最大可添加4个维度。
    *
    * @return $this
    */
