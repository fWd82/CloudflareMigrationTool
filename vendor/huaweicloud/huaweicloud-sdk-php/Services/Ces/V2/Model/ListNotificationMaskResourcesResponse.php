...
class ListNotificationMaskResourcesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListNotificationMaskResourcesResponse';
