...
class Tag implements ModelInterface, ArrayAccess
{
    ...
    * key  标签的键。  最大长度127个字符。 key不能为空。
    * values  值列表。每个值最大长度255个字符，如果values为空列表，则表示匹配任意值value。value之间为或的关系。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key 标签的键。  最大长度127个字符。 key不能为空。
    *
    * @return $this
    */
    ...
    * Sets values
    *
    * @param string[] $values 值列表。每个值最大长度255个字符，如果values为空列表，则表示匹配任意值value。value之间为或的关系。
    *
    * @return $this
    */
