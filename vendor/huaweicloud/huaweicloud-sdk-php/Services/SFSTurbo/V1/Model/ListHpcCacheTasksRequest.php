...
class ListHpcCacheTasksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListHpcCacheTasksRequest';
    ...
    * Sets offset
    *
    * @param int|null $offset offset，默认值为 0
    *
    * @return $this
    */
