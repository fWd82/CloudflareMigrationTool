...
class ListBackendTargetsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBackendTargetsResponse';
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'targets' => '\HuaweiCloud\SDK\SFSTurbo\V1\Model\ShowBackendTargetInfoResponseBody[]',
            'xRequestId' => 'string'
    ];
