...
class OneFsTaskResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OneFsTaskResp';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['beginTime'] === null) {
            ...
            if (!preg_match("/2006-01-02 15:04:05/", $this->container['beginTime'])) {
                $invalidProperties[] = "invalid value for 'beginTime', must be conform to the pattern /2006-01-02 15:04:05/.";
            }
        if ($this->container['endTime'] === null) {
            $invalidProperties[] = "'endTime' can't be null";
        }
            if (!preg_match("/2006-01-02 15:04:06/", $this->container['endTime'])) {
    ...
    * Sets status
    *
    * @param string $status 任务状态, SUCCESS表示成功，DOING表示正在执行，FAIL表示失败
    *
    * @return $this
    */
    ...
    * Sets beginTime
    *
    * @param string $beginTime 任务开始时间，UTC时间，例如：2006-01-02 15:04:05'
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param string $endTime 任务结束时间，UTC时间，例如：2006-01-02 15:04:06'
    *
    * @return $this
    */
