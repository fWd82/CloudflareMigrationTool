...
class CreateShareRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateShareRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'share' => '\HuaweiCloud\SDK\SFSTurbo\V1\Model\Share',
    ...
    *  share
    *
    * @return \HuaweiCloud\SDK\SFSTurbo\V1\Model\Share
    */
    ...
    * Sets share
    *
    * @param \HuaweiCloud\SDK\SFSTurbo\V1\Model\Share $share share
    *
    * @return $this
    */
    ...
    *  bssParam
    *
    * @return \HuaweiCloud\SDK\SFSTurbo\V1\Model\BssInfo|null
    */
    ...
    * Sets bssParam
    *
    * @param \HuaweiCloud\SDK\SFSTurbo\V1\Model\BssInfo|null $bssParam bssParam
    *
    * @return $this
    */
