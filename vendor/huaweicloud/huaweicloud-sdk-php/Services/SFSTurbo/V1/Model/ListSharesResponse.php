...
class ListSharesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSharesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * shares  SFS Turbo文件系统的列表。
    * count  SFS Turbo文件系统的数量。
    *
    * @var string[]
    */
    ...
    * Sets count
    *
    * @param int|null $count SFS Turbo文件系统的数量。
    *
    * @return $this
    */
