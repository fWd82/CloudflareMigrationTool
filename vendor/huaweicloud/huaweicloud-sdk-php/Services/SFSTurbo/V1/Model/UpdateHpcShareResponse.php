...
class UpdateHpcShareResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateHpcShareResponse';
    ...
    * Sets gcTime
    *
    * @param int|null $gcTime 文件系统冷数据淘汰时间
    *
    * @return $this
    */
