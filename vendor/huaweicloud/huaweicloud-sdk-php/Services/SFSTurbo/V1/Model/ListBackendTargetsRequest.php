...
class ListBackendTargetsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBackendTargetsRequest';
    ...
    * Sets limit
    *
    * @param int|null $limit 查询列表返回元素个数
    *
    * @return $this
    */
    ...
    * Sets marker
    *
    * @param string|null $marker 查询列表偏移量
    *
    * @return $this
    */
