...
class BatchCreateResourceTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'resourceType' => 'string',
            'body' => '\HuaweiCloud\SDK\Cts\V3\Model\BatchCreateResourceTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cts\V3\Model\BatchCreateResourceTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cts\V3\Model\BatchCreateResourceTagsRequestBody|null $body body
    *
    * @return $this
    */
