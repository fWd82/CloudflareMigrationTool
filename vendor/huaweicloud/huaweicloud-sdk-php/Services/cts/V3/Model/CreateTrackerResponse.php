...
class CreateTrackerResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTrackerResponse';
    ...
    *
    * @param bool|null $isSupportValidate 是否打开事件文件校验。当前环境仅\"tracker_type\"参数值为\"system\"时支持该功能。
    *
    * @return $this
    */
