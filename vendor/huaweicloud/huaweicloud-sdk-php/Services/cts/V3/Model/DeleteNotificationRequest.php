...
class DeleteNotificationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteNotificationRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * notificationId  标识关键操作通知id。 批量删除请使用逗号隔开，notification_id=\"xxx1,cccc2\"
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['notificationId'] === null) {
            ...
            if ((mb_strlen($this->container['notificationId']) > 400)) {
                $invalidProperties[] = "invalid value for 'notificationId', the character length must be smaller than or equal to 400.";
            }
