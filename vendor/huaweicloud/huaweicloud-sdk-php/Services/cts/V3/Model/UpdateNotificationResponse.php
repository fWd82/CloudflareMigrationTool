...
class UpdateNotificationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateNotificationResponse';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['topicId']) && (mb_strlen($this->container['topicId']) > 128)) {
                $invalidProperties[] = "invalid value for 'topicId', the character length must be smaller than or equal to 128.";
            }
            ...
            if (!is_null($this->container['createTime']) && ($this->container['createTime'] >= 4102416000000)) {
                $invalidProperties[] = "invalid value for 'createTime', must be smaller than 4102416000000.";
            }
            if (!is_null($this->container['createTime']) && ($this->container['createTime'] <= 946656000000)) {
                $invalidProperties[] = "invalid value for 'createTime', must be bigger than 946656000000.";
            }
