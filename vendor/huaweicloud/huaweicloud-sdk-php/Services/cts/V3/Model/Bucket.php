...
class Bucket implements ModelInterface, ArrayAccess
{
    ...
    * bucketLocation  标识桶位置。
    * kmsId  事件文件转储加密所采用的秘钥id。 如果is_support_trace_files_encryption\"参数值为“是”时，此参数为必选项。
    ...
    */
    protected static $openAPITypes = [
            ...
            'checkBucketResponse' => '\HuaweiCloud\SDK\Cts\V3\Model\CheckBucketResponse'
    ];
    ...
    */
    protected static $attributeMap = [
            ...
            'checkBucketResponse' => 'check_bucket_response'
    ];
    ...
    */
    protected static $setters = [
            ...
            'checkBucketResponse' => 'setCheckBucketResponse'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['checkBucketResponse'] = isset($data['checkBucketResponse']) ? $data['checkBucketResponse'] : null;
    }
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bucketName'] === null) {
            ...
            if (!is_null($this->container['bucketLocation']) && (mb_strlen($this->container['bucketLocation']) > 32)) {
                $invalidProperties[] = "invalid value for 'bucketLocation', the character length must be smaller than or equal to 32.";
            }
            if (!is_null($this->container['bucketLocation']) && (mb_strlen($this->container['bucketLocation']) < 1)) {
        ...
        if ($this->container['isSupportTraceFilesEncryption'] === null) {
            $invalidProperties[] = "'isSupportTraceFilesEncryption' can't be null";
        }
    ...
    * Sets bucketLocation
    *
    * @param string|null $bucketLocation 标识桶位置。
    *
    * @return $this
    */
    ...
    * Sets kmsId
    *
    * @param string|null $kmsId 事件文件转储加密所采用的秘钥id。 如果is_support_trace_files_encryption\"参数值为“是”时，此参数为必选项。
    *
    * @return $this
    */
    ...
    *
    * @param bool $isSupportTraceFilesEncryption 事件文件转储加密功能开关。 该参数必须与kms_id参数同时使用。
    *
    * @return $this
    */
    ...
    /**
    * Gets checkBucketResponse
    *  checkBucketResponse
    *
    * @return \HuaweiCloud\SDK\Cts\V3\Model\CheckBucketResponse|null
    */
    public function getCheckBucketResponse()
    {
        return $this->container['checkBucketResponse'];
    }

    /**
    * Sets checkBucketResponse
    *
    * @param \HuaweiCloud\SDK\Cts\V3\Model\CheckBucketResponse|null $checkBucketResponse checkBucketResponse
    *
    * @return $this
    */
    public function setCheckBucketResponse($checkBucketResponse)
    {
        $this->container['checkBucketResponse'] = $checkBucketResponse;
        return $this;
    }
