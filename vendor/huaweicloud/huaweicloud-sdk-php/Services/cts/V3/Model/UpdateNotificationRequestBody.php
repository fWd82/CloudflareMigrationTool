...
class UpdateNotificationRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * agencyName  云服务委托名称。 参数值为\"cts_admin_trust\"时，修改追踪器会自动创建一个云服务委托：cts_admin_trust。
    * operations  操作事件列表。
    ...
    * Sets agencyName
    *
    * @param string|null $agencyName 云服务委托名称。 参数值为\"cts_admin_trust\"时，修改追踪器会自动创建一个云服务委托：cts_admin_trust。
    *
    * @return $this
    */
