...
class ListOperationsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListOperationsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * serviceType  事件对应的云服务类型。
    * resourceType  事件对应的资源类型。传入该参数时，service_type必选。
    *
    * @var string[]
    */
    ...
    * Sets resourceType
    *
    * @param string|null $resourceType 事件对应的资源类型。传入该参数时，service_type必选。
    *
    * @return $this
    */
