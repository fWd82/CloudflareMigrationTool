...
class ReplaceDefinerInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReplaceDefinerInfo';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['replaceDefiner'] === null) {
            $invalidProperties[] = "'replaceDefiner' can't be null";
        }
    ...
    * Sets replaceDefiner
    *
    * @param bool $replaceDefiner 是否使用目标库的用户替换掉definer
    *
    * @return $this
    */
