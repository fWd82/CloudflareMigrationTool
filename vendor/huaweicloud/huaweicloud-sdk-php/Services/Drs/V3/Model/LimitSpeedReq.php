...
class LimitSpeedReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LimitSpeedReq';
    ...
    *  限速信息请求体
    *
    * @return \HuaweiCloud\SDK\Drs\V3\Model\SpeedLimitInfo[]
    */
    ...
    * Sets speedLimit
    *
    * @param \HuaweiCloud\SDK\Drs\V3\Model\SpeedLimitInfo[] $speedLimit 限速信息请求体
    *
    * @return $this
    */
