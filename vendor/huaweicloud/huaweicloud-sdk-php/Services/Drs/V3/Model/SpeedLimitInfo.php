...
class SpeedLimitInfo implements ModelInterface, ArrayAccess
{
    ...
    * end  结束时间,此时间为UTC时间,输入必须为59分结尾，格式为hh:mm，小时数为两位，例如：05:59。
    * speed  限速，取值范围为1~9999 ,单位为MB/s
    * isUtc  是否为UTC时间
    *
    * @var string[]
    */
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['isUtc'] = isset($data['isUtc']) ? $data['isUtc'] : null;
    }
    ...
    * Sets end
    *
    * @param string $end 结束时间,此时间为UTC时间,输入必须为59分结尾，格式为hh:mm，小时数为两位，例如：05:59。
    *
    * @return $this
    */
    ...
    * Sets speed
    *
    * @param string $speed 限速，取值范围为1~9999 ,单位为MB/s
    *
    * @return $this
    */
    ...
    */
    ...
    {
        return $this->container['isUtc'];
    }

    /**
    * Sets isUtc
    *
    * @param bool|null $isUtc 是否为UTC时间
    *
    * @return $this
    */
    public function setIsUtc($isUtc)
    {
        $this->container['isUtc'] = $isUtc;
        return $this;
    }
