...
class CreateCompareTaskResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCompareTaskResult';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * compareTaskId  对比任务创建成功后，返回对比任务的id，用于查询该对比任务的结果。
    * errorCode  错误码。
    * errorMsg  错误信息。
    *
    * @var string[]
    ...
    * Sets compareTaskId
    *
    * @param string|null $compareTaskId 对比任务创建成功后，返回对比任务的id，用于查询该对比任务的结果。
    *
    * @return $this
    */
