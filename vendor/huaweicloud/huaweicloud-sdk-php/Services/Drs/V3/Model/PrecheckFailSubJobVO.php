...
class PrecheckFailSubJobVO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrecheckFailSubJobVO';
    ...
    * Sets id
    *
    * @param string|null $id 预检查失败子任务id。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name 预检查失败子任务名称。
    *
    * @return $this
    */
    ...
    * Sets checkResult
    *
    * @param string|null $checkResult 检查结果。
    *
    * @return $this
    */
