...
class PageReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PageReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * curPage  当前页, 不能超过item除每页任务数量的最大页
    * perPage  每页item数量，填0获取全部item
    *
    * @var string[]
    */
    ...
    * Sets curPage
    *
    * @param int|null $curPage 当前页, 不能超过item除每页任务数量的最大页
    *
    * @return $this
    */
    ...
    * Sets perPage
    *
    * @param int|null $perPage 每页item数量，填0获取全部item
    *
    * @return $this
    */
