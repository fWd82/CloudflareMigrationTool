...
class DatabaseObjectInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DatabaseObjectInfo';
    ...
    * Sets id
    *
    * @param string|null $id type为database时，为库名；type为table或者view时，字段值参考示例
    *
    * @return $this
    */
    ...
    * Sets parentId
    *
    * @param string|null $parentId type为table或view时需要填写，为库名
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name 数据库对象名称，库名、表名、视图名
    *
    * @return $this
    */
    ...
    * Sets aliasName
    *
    * @param string|null $aliasName 别名，映射的新名称
    *
    * @return $this
    */
