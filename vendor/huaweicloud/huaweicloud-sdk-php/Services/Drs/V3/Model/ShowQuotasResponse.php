...
class ShowQuotasResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'quotas' => '\HuaweiCloud\SDK\Drs\V3\Model\QueryQuotaInfo'
    ];
    ...
    *  quotas
    *
    * @return \HuaweiCloud\SDK\Drs\V3\Model\QueryQuotaInfo|null
    */
    ...
    * Sets quotas
    *
    * @param \HuaweiCloud\SDK\Drs\V3\Model\QueryQuotaInfo|null $quotas quotas
    *
    * @return $this
    */
