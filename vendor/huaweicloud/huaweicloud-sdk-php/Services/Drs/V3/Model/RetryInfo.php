...
class RetryInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RetryInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * jobId  任务ID
    * isSyncReEdit  再编辑之后启动，必填为true。
    *
    * @var string[]
    */
    ...
    * Sets isSyncReEdit
    *
    * @param bool|null $isSyncReEdit 再编辑之后启动，必填为true。
    *
    * @return $this
    */
