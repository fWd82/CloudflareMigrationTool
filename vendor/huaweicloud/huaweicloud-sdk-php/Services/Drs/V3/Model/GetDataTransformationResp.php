...
class GetDataTransformationResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetDataTransformationResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalCount  数据加工总数。
    * filterConditions  数据过滤配置信息。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'filterConditions' => '\HuaweiCloud\SDK\Drs\V3\Model\DataTransformationInfo[]'
    ];
    ...
    * Sets totalCount
    *
    * @param int|null $totalCount 数据加工总数。
    *
    * @return $this
    */
    ...
    *  数据过滤配置信息。
    *
    * @return \HuaweiCloud\SDK\Drs\V3\Model\DataTransformationInfo[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Drs\V3\Model\DataTransformationInfo[]|null $filterConditions 数据过滤配置信息。
    *
    * @return $this
    */
