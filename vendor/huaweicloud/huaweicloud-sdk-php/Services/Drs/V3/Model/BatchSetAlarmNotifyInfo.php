...
class BatchSetAlarmNotifyInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchSetAlarmNotifyInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * subscriptions  手动输入手机号、邮箱模式时填写
    * topicUrn  主题资源标识
    * delayTime  订阅延迟时间
    * rtoDelay  rto延迟时间
    * rpoDelay  rpo延迟时间
    * alarmToUser  异常告警是否通知用户，不填默认为false
    *
    * @var string[]
    */
    ...
    * Sets subscriptions
    *
    * @param \HuaweiCloud\SDK\Drs\V3\Model\SubscriptionInfo[]|null $subscriptions 手动输入手机号、邮箱模式时填写
    *
    * @return $this
    */
    ...
    * Sets topicUrn
    *
    * @param string|null $topicUrn 主题资源标识
    *
    * @return $this
    */
    ...
    * Sets alarmToUser
    *
    * @param bool|null $alarmToUser 异常告警是否通知用户，不填默认为false
    *
    * @return $this
    */
