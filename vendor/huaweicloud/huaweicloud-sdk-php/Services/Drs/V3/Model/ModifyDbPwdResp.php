...
class ModifyDbPwdResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyDbPwdResp';
    ...
    * Sets endPointType
    *
    * @param string|null $endPointType 源库：so，目标库：ta
    *
    * @return $this
    */
