...
class ModifyTuningParamsReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyTuningParamsReq';
    ...
    * increRelay  增量日志拉取参数的参数名及对应的取值 -slotAdvanceInterval： 源库逻辑复制槽推进间隔
    * recovery  初始化参数，首次调用时需要传true，其他时候不传。
    *
    * @var string[]
    */
    ...
    * Sets increCapture
    *
    * @param map[string,string]|null $increCapture 增量抓取参数的参数名及对应的取值
    *
    * @return $this
    */
    ...
    * Sets increApply
    *
    * @param map[string,string]|null $increApply 增量回放参数的参数名及对应的取值
    *
    * @return $this
    */
    ...
    * Sets increRelay
    *
    * @param map[string,string]|null $increRelay 增量日志拉取参数的参数名及对应的取值 -slotAdvanceInterval： 源库逻辑复制槽推进间隔
    *
    * @return $this
    */
    ...
    * Sets recovery
    *
    * @param bool|null $recovery 初始化参数，首次调用时需要传true，其他时候不传。
    *
    * @return $this
    */
