...
class ShowPositionResultRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPositionResultRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  请求语言类型。
    * jobId  任务ID。
    * queryId  位点信息采集的ID，由采集数据库位点信息接口返回的ID。
    *
    * @var string[]
    */
