...
class UpdateBatchAsyncJobsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateBatchAsyncJobsRequest';
    ...
    */
    protected static $openAPITypes = [
            'asyncJobId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Drs\V5\Model\BatchAsyncUpdateJobReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Drs\V5\Model\BatchAsyncUpdateJobReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Drs\V5\Model\BatchAsyncUpdateJobReq|null $body body
    *
    * @return $this
    */
