...
class ShowActionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowActionsResponse';
    ...
    *  jobAction
    *
    * @return \HuaweiCloud\SDK\Drs\V5\Model\JobActions|null
    */
    ...
    * Sets jobAction
    *
    * @param \HuaweiCloud\SDK\Drs\V5\Model\JobActions|null $jobAction jobAction
    *
    * @return $this
    */
