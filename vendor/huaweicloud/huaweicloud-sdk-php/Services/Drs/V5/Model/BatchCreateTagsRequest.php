...
class BatchCreateTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'xLanguage' => 'string',
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Drs\V5\Model\BatchAddTagReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Drs\V5\Model\BatchAddTagReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Drs\V5\Model\BatchAddTagReq|null $body body
    *
    * @return $this
    */
