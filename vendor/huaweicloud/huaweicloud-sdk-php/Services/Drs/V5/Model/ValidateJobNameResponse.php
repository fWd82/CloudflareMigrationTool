...
class ValidateJobNameResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ValidateJobNameResponse';
    ...
    * Sets isValid
    *
    * @param bool|null $isValid 任务名称是否有效。
    *
    * @return $this
    */
