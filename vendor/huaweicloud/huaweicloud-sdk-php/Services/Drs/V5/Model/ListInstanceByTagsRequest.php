...
class ListInstanceByTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceByTagsRequest';
    ...
    * xLanguage  请求语言类型。
    * limit  查询记录数，默认为1000，limit最多为1000,不能为负数，最小值为1。
    * offset  索引位置，偏移量从第一条数据偏移offset条数据后开始查询，默认为0（偏移0条数据，表示从第一条数据开始查询）,必须为数字，不能为负数。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'limit' => 'int',
            'offset' => 'int',
            'body' => '\HuaweiCloud\SDK\Drs\V5\Model\QueryInstanceByTagReq'
    ];
    ...
    * Sets limit
    *
    * @param int|null $limit 查询记录数，默认为1000，limit最多为1000,不能为负数，最小值为1。
    *
    * @return $this
    */
    ...
    * Sets offset
    *
    * @param int|null $offset 索引位置，偏移量从第一条数据偏移offset条数据后开始查询，默认为0（偏移0条数据，表示从第一条数据开始查询）,必须为数字，不能为负数。
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Drs\V5\Model\QueryInstanceByTagReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Drs\V5\Model\QueryInstanceByTagReq|null $body body
    *
    * @return $this
    */
