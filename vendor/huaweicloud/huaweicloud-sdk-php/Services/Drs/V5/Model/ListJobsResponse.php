...
class ListJobsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'jobs' => '\HuaweiCloud\SDK\Drs\V5\Model\JobListResp[]'
    ];
    ...
    *  任务信息列表。
    *
    * @return \HuaweiCloud\SDK\Drs\V5\Model\JobListResp[]
    */
    ...
    * Sets jobs
    *
    * @param \HuaweiCloud\SDK\Drs\V5\Model\JobListResp[] $jobs 任务信息列表。
    *
    * @return $this
    */
