...
class BatchDeleteTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'xLanguage' => 'string',
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Drs\V5\Model\BatchDeleteTagReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Drs\V5\Model\BatchDeleteTagReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Drs\V5\Model\BatchDeleteTagReq|null $body body
    *
    * @return $this
    */
