...
class QueryInstanceByTagReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'QueryInstanceByTagReq';
    ...
    * tags  包含标签，最多包含20个key，每个key下面的value最多20个。
    * matches  搜索字段,key为要匹配的字段，如resource_name等。value为匹配的值。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'withoutAnyTag' => 'bool',
            'tags' => '\HuaweiCloud\SDK\Drs\V5\Model\Tag[]',
            'matches' => '\HuaweiCloud\SDK\Drs\V5\Model\TagMatch[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Drs\V5\Model\Tag[]|null
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Drs\V5\Model\Tag[]|null $tags 包含标签，最多包含20个key，每个key下面的value最多20个。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Drs\V5\Model\TagMatch[]|null
    */
    ...
    * Sets matches
    *
    * @param \HuaweiCloud\SDK\Drs\V5\Model\TagMatch[]|null $matches 搜索字段,key为要匹配的字段，如resource_name等。value为匹配的值。
    *
    * @return $this
    */
