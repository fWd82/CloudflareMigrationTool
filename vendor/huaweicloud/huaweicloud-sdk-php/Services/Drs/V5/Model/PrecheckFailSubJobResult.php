...
class PrecheckFailSubJobResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrecheckFailSubJobResult';
    ...
    * Sets checkResult
    *
    * @param string|null $checkResult 子任务检查结果。
    *
    * @return $this
    */
