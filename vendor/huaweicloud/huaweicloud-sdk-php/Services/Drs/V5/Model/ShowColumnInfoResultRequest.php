...
class ShowColumnInfoResultRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowColumnInfoResultRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * jobId  任务ID。
    * xLanguage  请求语言类型。
    * queryId  指定数据库表的列信息采集的ID，提交采集指定数据库表的列信息接口返回的ID。
