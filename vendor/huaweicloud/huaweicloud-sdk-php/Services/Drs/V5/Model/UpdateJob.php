...
class UpdateJob implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateJob';
    ...
    */
    protected static $openAPITypes = [
            ...
            'tuningParams' => '\HuaweiCloud\SDK\Drs\V5\Model\ModifyTuningParams',
    ...
    * Sets jobId
    *
    * @param string|null $jobId 待更新的任务ID。
    *
    * @return $this
    */
    ...
    *  tuningParams
    *
    * @return \HuaweiCloud\SDK\Drs\V5\Model\ModifyTuningParams|null
    */
    ...
    * Sets tuningParams
    *
    * @param \HuaweiCloud\SDK\Drs\V5\Model\ModifyTuningParams|null $tuningParams tuningParams
    *
    * @return $this
    */
