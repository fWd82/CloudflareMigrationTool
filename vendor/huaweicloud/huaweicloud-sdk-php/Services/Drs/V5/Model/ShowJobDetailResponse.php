...
class ShowJobDetailResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'job' => '\HuaweiCloud\SDK\Drs\V5\Model\JobDetailResp'
    ];
    ...
    *  job
    *
    * @return \HuaweiCloud\SDK\Drs\V5\Model\JobDetailResp|null
    */
    ...
    * Sets job
    *
    * @param \HuaweiCloud\SDK\Drs\V5\Model\JobDetailResp|null $job job
    *
    * @return $this
    */
