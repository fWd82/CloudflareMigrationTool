...
class ContentCompareDetailInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ContentCompareDetailInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * sourceDb  源库库名。
    * targetDb  目标库库名。
    * sourceTableName  源库表名。
    * targetTableName  目标库表名。
    * sourceRowNum  源库表行数。
    * targetRowNum  目标库表行数。
    * differenceRowNum  对比不一致行数。
    * lineCompareResult  行对比结果。取值： - true：一致。 - false：不一致。
    * contentCompareResult  内容对比结果。取值： - true：一致。 - false：不一致。
    * message  失败原因。
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $sourceTableName 源库表名。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $targetTableName 目标库表名。
    *
    * @return $this
    */
    ...
    *
    * @param int|null $differenceRowNum 对比不一致行数。
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $lineCompareResult 行对比结果。取值： - true：一致。 - false：不一致。
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $contentCompareResult 内容对比结果。取值： - true：一致。 - false：不一致。
    *
    * @return $this
    */
