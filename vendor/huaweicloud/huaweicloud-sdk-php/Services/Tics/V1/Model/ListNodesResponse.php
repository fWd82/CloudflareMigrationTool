...
class ListNodesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'lists' => '\HuaweiCloud\SDK\Tics\V1\Model\TicsTrustInfoVo[]',
            'total' => 'int'
    ];
    ...
    *  实例集合
    *
    * @return \HuaweiCloud\SDK\Tics\V1\Model\TicsTrustInfoVo[]|null
    */
    ...
    * Sets lists
    *
    * @param \HuaweiCloud\SDK\Tics\V1\Model\TicsTrustInfoVo[]|null $lists 实例集合
    *
    * @return $this
    */
