...
class ListLeagueDatasetsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLeagueDatasetsRequest';
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['partnerName'] = isset($data['partnerName']) ? $data['partnerName'] : null;
    }
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['limit'] === null) {
            ...
            if (!is_null($this->container['partnerName']) && (mb_strlen($this->container['partnerName']) > 128)) {
                $invalidProperties[] = "invalid value for 'partnerName', the character length must be smaller than or equal to 128.";
            }
            if (!is_null($this->container['partnerName']) && (mb_strlen($this->container['partnerName']) < 0)) {
                $invalidProperties[] = "invalid value for 'partnerName', the character length must be bigger than or equal to 0.";
            }
    ...
    * Sets partnerName
    *
    * @param string|null $partnerName partner_name
    *
    * @return $this
    */
