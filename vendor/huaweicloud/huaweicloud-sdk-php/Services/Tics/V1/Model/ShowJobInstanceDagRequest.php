...
class ShowJobInstanceDagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowJobInstanceDagRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  实例id，最大32位，字母和数字组成
    * leagueId  联盟id，最大32位，字母和数字组成
    * roundId  轮数，最小值0最大值0x7fffffff
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['roundId'] === null) {
            $invalidProperties[] = "'roundId' can't be null";
        }
            if (($this->container['roundId'] > 2147483647)) {
                $invalidProperties[] = "invalid value for 'roundId', must be smaller than or equal to 2147483647.";
            }
            if (($this->container['roundId'] < 0)) {
                $invalidProperties[] = "invalid value for 'roundId', must be bigger than or equal to 0.";
            }
    ...
    * Sets roundId
    *
    * @param int $roundId 轮数，最小值0最大值0x7fffffff
    *
    * @return $this
    */
