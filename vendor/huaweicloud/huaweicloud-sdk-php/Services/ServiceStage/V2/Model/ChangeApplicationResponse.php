...
class ChangeApplicationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeApplicationResponse';
    ...
    * Sets unifiedModel
    *
    * @param string|null $unifiedModel 是否统一模型
    *
    * @return $this
    */
