...
class ComponentCreate implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'build' => '\HuaweiCloud\SDK\ServiceStage\V2\Model\Build'
    ];
    ...
    *  runtime
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V2\Model\RuntimeType
    */
    ...
    * Sets runtime
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\RuntimeType $runtime runtime
    *
    * @return $this
    */
    ...
    *  category
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V2\Model\ComponentCategory
    */
    ...
    * Sets category
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\ComponentCategory $category category
    *
    * @return $this
    */
    ...
    *  build
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V2\Model\Build|null
    */
    ...
    * Sets build
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\Build|null $build build
    *
    * @return $this
    */
