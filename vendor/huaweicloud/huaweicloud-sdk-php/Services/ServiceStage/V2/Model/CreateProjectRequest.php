...
class CreateProjectRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'xRepoAuth' => 'string',
            'namespace' => 'string',
            'body' => '\HuaweiCloud\SDK\ServiceStage\V2\Model\ProjectCreate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V2\Model\ProjectCreate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\ProjectCreate|null $body body
    *
    * @return $this
    */
