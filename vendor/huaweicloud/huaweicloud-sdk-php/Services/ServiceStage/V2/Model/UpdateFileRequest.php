...
class UpdateFileRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateFileRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'path' => 'string',
            'ref' => 'string',
            'body' => '\HuaweiCloud\SDK\ServiceStage\V2\Model\FileUpdate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V2\Model\FileUpdate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\FileUpdate|null $body body
    *
    * @return $this
    */
