...
class CreateTagRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'project' => 'string',
            'ref' => 'string',
            'body' => '\HuaweiCloud\SDK\ServiceStage\V2\Model\TagCreate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V2\Model\TagCreate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\TagCreate|null $body body
    *
    * @return $this
    */
