...
class ShowApplicationConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowApplicationConfigurationRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * applicationId  应用ID。
    * environmentId  环境ID，如果未提供，查询所有环境。
    *
    * @var string[]
    */
    ...
    * Sets environmentId
    *
    * @param string|null $environmentId 环境ID，如果未提供，查询所有环境。
    *
    * @return $this
    */
