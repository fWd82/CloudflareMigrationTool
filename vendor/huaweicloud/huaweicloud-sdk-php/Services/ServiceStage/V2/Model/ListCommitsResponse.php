...
class ListCommitsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'commits' => '\HuaweiCloud\SDK\ServiceStage\V2\Model\CommitsCommits[]'
    ];
    ...
    *  提交记录列表。
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V2\Model\CommitsCommits[]|null
    */
    ...
    * Sets commits
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\CommitsCommits[]|null $commits 提交记录列表。
    *
    * @return $this
    */
