...
class ConfigurationStrategy implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ConfigurationStrategy';
    ...
    * Sets upgrade
    *
    * @param string|null $upgrade 部署策略
    *
    * @return $this
    */
