...
class AccessToken implements ModelInterface, ArrayAccess
{
    ...
    * name  授权名称。
    * token  git仓库设置中创建的私有token。
    * host  git仓库的主机地址，如https://192.168.1.1:8080/gitlab，默认为官方主机。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['token'] === null) {
            ...
            if ((mb_strlen($this->container['token']) > 256)) {
    ...
    * Sets token
    *
    * @param string $token git仓库设置中创建的私有token。
    *
    * @return $this
    */
    ...
    * Sets host
    *
    * @param string|null $host git仓库的主机地址，如https://192.168.1.1:8080/gitlab，默认为官方主机。
    *
    * @return $this
    */
