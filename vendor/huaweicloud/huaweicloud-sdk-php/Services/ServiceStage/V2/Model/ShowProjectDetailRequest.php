...
class ShowProjectDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowProjectDetailRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cloneUrl'] === null) {
            $invalidProperties[] = "'cloneUrl' can't be null";
        }
