...
class CreateHookRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateHookRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'namespace' => 'string',
            'project' => 'string',
            'body' => '\HuaweiCloud\SDK\ServiceStage\V2\Model\HookCreate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V2\Model\HookCreate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\HookCreate|null $body body
    *
    * @return $this
    */
