...
class ListInstanceSnapshotsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceSnapshotsRequest';
    ...
    * snapshotOrderBy  排序字段，默认按创建时间排序。  排序字段支持枚举值：create_time、version。
    ...
    */
    protected static $attributeMap = [
            ...
            'limit' => 'limit',
            'offset' => 'offset',
            'snapshotOrderBy' => 'snapshot_order_by',
            'order' => 'order'
    ];
    ...
    */
    protected static $setters = [
            ...
            'limit' => 'setLimit',
            'offset' => 'setOffset',
            'snapshotOrderBy' => 'setSnapshotOrderBy',
            'order' => 'setOrder'
    ];
    ...
    */
    protected static $getters = [
            ...
            'limit' => 'getLimit',
            'offset' => 'getOffset',
            'snapshotOrderBy' => 'getSnapshotOrderBy',
            'order' => 'getOrder'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['snapshotOrderBy'] = isset($data['snapshotOrderBy']) ? $data['snapshotOrderBy'] : null;
    ...
    */
    ...
    /**
    * Gets snapshotOrderBy
    *  排序字段，默认按创建时间排序。  排序字段支持枚举值：create_time、version。
    *
    * @return string|null
    */
    public function getSnapshotOrderBy()
    {
        return $this->container['snapshotOrderBy'];
    }

    /**
    * Sets snapshotOrderBy
    *
    * @param string|null $snapshotOrderBy 排序字段，默认按创建时间排序。  排序字段支持枚举值：create_time、version。
    *
    * @return $this
    */
    public function setSnapshotOrderBy($snapshotOrderBy)
    {
        $this->container['snapshotOrderBy'] = $snapshotOrderBy;
        return $this;
    }
