...
class CreateOAuthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateOAuthRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * repoType  仓库类型。 支持OAuth授权的仓库类型有：github、gitlab、gitee、bitbucket。
    ...
    */
    protected static $openAPITypes = [
            'repoType' => 'string',
            'tag' => 'string',
            'body' => '\HuaweiCloud\SDK\ServiceStage\V2\Model\OAuth'
    ];
    ...
    * Sets repoType
    *
    * @param string $repoType 仓库类型。 支持OAuth授权的仓库类型有：github、gitlab、gitee、bitbucket。
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V2\Model\OAuth|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\OAuth|null $body body
    *
    * @return $this
    */
