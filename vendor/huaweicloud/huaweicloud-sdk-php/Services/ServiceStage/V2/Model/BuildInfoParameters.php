...
class BuildInfoParameters implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BuildInfo_parameters';
    ...
    * clusterId  指定构建集群的id。
    * nodeLabelSelector  key是标签的键，value是标签的值。
    *
    * @var string[]
    */
    ...
    *
    * @param object|null $nodeLabelSelector key是标签的键，value是标签的值。
    *
    * @return $this
    */
