...
class ListComponentsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListComponentsResponse';
    ...
    * Sets components
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\ComponentView[]|null $components 组件列表。
    *
    * @return $this
    */
