...
class DeleteApplicationConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteApplicationConfigurationRequest';
