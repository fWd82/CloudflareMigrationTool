...
class ApplicationConfigModify implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'configuration' => '\HuaweiCloud\SDK\ServiceStage\V2\Model\ApplicationConfigModifyConfiguration'
    ];
    ...
    *  configuration
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V2\Model\ApplicationConfigModifyConfiguration
    */
    ...
    * Sets configuration
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\ApplicationConfigModifyConfiguration $configuration configuration
    *
    * @return $this
    */
