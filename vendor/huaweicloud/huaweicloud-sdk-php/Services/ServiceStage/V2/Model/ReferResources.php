...
class ReferResources implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReferResources';
    ...
    *  type
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V2\Model\ResourceType|null
    */
    ...
    * Sets type
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\ResourceType|null $type type
    *
    * @return $this
    */
