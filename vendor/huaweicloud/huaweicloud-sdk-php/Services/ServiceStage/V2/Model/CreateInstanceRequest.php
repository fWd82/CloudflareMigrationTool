...
class CreateInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'componentId' => 'string',
            'body' => '\HuaweiCloud\SDK\ServiceStage\V2\Model\InstanceCreate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V2\Model\InstanceCreate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\InstanceCreate|null $body body
    *
    * @return $this
    */
