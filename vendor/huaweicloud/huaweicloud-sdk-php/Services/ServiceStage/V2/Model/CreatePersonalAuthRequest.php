...
class CreatePersonalAuthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePersonalAuthRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * repoType  仓库类型。 支持私人令牌授权的仓库类型有：github、gitlab、gitee。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'repoType' => 'string',
            'body' => '\HuaweiCloud\SDK\ServiceStage\V2\Model\AccessToken'
    ];
    ...
    * Sets repoType
    *
    * @param string $repoType 仓库类型。 支持私人令牌授权的仓库类型有：github、gitlab、gitee。
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V2\Model\AccessToken|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\AccessToken|null $body body
    *
    * @return $this
    */
