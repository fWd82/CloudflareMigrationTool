...
class ShowJobInfoResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'taskCount' => 'int',
            'job' => '\HuaweiCloud\SDK\ServiceStage\V3\Model\JobInfo',
            'tasks' => '\HuaweiCloud\SDK\ServiceStage\V3\Model\TaskInfo[]'
    ];
    ...
    * Sets taskCount
    *
    * @param int|null $taskCount taskCount
    *
    * @return $this
    */
    ...
    *  job
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V3\Model\JobInfo|null
    */
    ...
    * Sets job
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V3\Model\JobInfo|null $job job
    *
    * @return $this
    */
    ...
    *  tasks
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V3\Model\TaskInfo[]|null
    */
    ...
    * Sets tasks
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V3\Model\TaskInfo[]|null $tasks tasks
    *
    * @return $this
    */
