...
class ComponentStorage implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'type' => 'string',
            'name' => 'string',
            'parameters' => '\HuaweiCloud\SDK\ServiceStage\V3\Model\ComponentStorageParameters',
            'mounts' => '\HuaweiCloud\SDK\ServiceStage\V3\Model\ComponentMount[]'
    ];
    ...
    *  parameters
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V3\Model\ComponentStorageParameters
    */
    ...
    * Sets parameters
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V3\Model\ComponentStorageParameters $parameters parameters
    *
    * @return $this
    */
    ...
    *  mounts
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V3\Model\ComponentMount[]
    */
    ...
    * Sets mounts
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V3\Model\ComponentMount[] $mounts mounts
    *
    * @return $this
    */
