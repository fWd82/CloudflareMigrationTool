...
class EnvironmentResourceModify implements ModelInterface, ArrayAccess
{
    ...
    *  for custom type
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V3\Model\Resource[]
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V3\Model\Resource[] $resources for custom type
    *
    * @return $this
    */
