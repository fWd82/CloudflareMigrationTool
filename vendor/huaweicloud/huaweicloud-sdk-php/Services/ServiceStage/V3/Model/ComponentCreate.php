...
class ComponentCreate implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ComponentCreate';
    ...
    */
    protected static $openAPITypes = [
            ...
            'timezone' => 'string',
            'jvmOpts' => 'string',
            'tomcatOpts' => '\HuaweiCloud\SDK\ServiceStage\V3\Model\ComponentModifyTomcatOpts',
            'logs' => '\HuaweiCloud\SDK\ServiceStage\V3\Model\ComponentLogs[]',
            'customMetric' => '\HuaweiCloud\SDK\ServiceStage\V3\Model\ComponentModifyCustomMetric',
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['runtimeStack'] === null) {
            $invalidProperties[] = "'runtimeStack' can't be null";
        }
    ...
    *  runtimeStack
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V3\Model\RuntimeStack
    */
    ...
    * Sets runtimeStack
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V3\Model\RuntimeStack $runtimeStack runtimeStack
    *
    * @return $this
    */
    ...
    *  tomcatOpts
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V3\Model\ComponentModifyTomcatOpts|null
    */
    ...
    * Sets tomcatOpts
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V3\Model\ComponentModifyTomcatOpts|null $tomcatOpts tomcatOpts
    *
    * @return $this
    */
    ...
    *  customMetric
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V3\Model\ComponentModifyCustomMetric|null
    */
    ...
    * Sets customMetric
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V3\Model\ComponentModifyCustomMetric|null $customMetric customMetric
    *
    * @return $this
    */
    ...
    *  referResources
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V3\Model\ReferResourceCreate[]
    */
    ...
    * Sets referResources
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V3\Model\ReferResourceCreate[] $referResources referResources
    *
    * @return $this
    */
