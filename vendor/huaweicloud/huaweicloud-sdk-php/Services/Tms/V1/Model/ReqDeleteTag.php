...
class ReqDeleteTag implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReqDeleteTag';
    ...
    */
    protected static $openAPITypes = [
            ...
            'tags' => '\HuaweiCloud\SDK\Tms\V1\Model\DeleteTagRequest[]'
    ];
    ...
    *  标签列表
    *
    * @return \HuaweiCloud\SDK\Tms\V1\Model\DeleteTagRequest[]
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Tms\V1\Model\DeleteTagRequest[] $tags 标签列表
    *
    * @return $this
    */
