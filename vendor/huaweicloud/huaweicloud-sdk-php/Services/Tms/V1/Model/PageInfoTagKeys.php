...
class PageInfoTagKeys implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PageInfoTagKeys';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nextMarker  分页位置标识（索引）
    * currentCount  当前页标签键的数量
    *
    * @var string[]
    */
    ...
    * Sets currentCount
    *
    * @param int $currentCount 当前页标签键的数量
    *
    * @return $this
    */
