...
class DeleteResourceTagRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'body' => '\HuaweiCloud\SDK\Tms\V1\Model\ReqDeleteTag'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Tms\V1\Model\ReqDeleteTag|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Tms\V1\Model\ReqDeleteTag|null $body body
    *
    * @return $this
    */
