...
class CreateResourceTagRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'body' => '\HuaweiCloud\SDK\Tms\V1\Model\ReqCreateTag'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Tms\V1\Model\ReqCreateTag|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Tms\V1\Model\ReqCreateTag|null $body body
    *
    * @return $this
    */
