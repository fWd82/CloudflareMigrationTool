...
class ShowTagQuotaResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'quotas' => '\HuaweiCloud\SDK\Tms\V1\Model\TagQuota[]'
    ];
    ...
    *  配额列表
    *
    * @return \HuaweiCloud\SDK\Tms\V1\Model\TagQuota[]|null
    */
    ...
    * Sets quotas
    *
    * @param \HuaweiCloud\SDK\Tms\V1\Model\TagQuota[]|null $quotas 配额列表
    *
    * @return $this
    */
