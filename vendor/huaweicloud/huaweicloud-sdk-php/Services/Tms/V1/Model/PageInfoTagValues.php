...
class PageInfoTagValues implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PageInfoTagValues';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nextMarker  分页位置标识（索引）
    * currentCount  当前页标签值的数量
    *
    * @var string[]
    */
    ...
    * Sets nextMarker
    *
    * @param string $nextMarker 分页位置标识（索引）
    *
    * @return $this
    */
    ...
    * Sets currentCount
    *
    * @param int $currentCount 当前页标签值的数量
    *
    * @return $this
    */
