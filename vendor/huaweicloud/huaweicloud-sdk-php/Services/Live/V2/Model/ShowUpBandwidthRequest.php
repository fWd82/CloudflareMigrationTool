...
class ShowUpBandwidthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowUpBandwidthRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['publishDomains'] === null) {
            ...
            if (!is_null($this->container['stream']) && (mb_strlen($this->container['stream']) > 64)) {
    ...
    * Sets endTime
    *
    * @param string|null $endTime 结束时间。日期格式按照ISO8601表示法，并使用UTC时间。 格式为：YYYY-MM-DDThh:mm:ssZ。  若参数为空，默认为当前时间，最大查询跨度31天，最大查询周期1年。结束时间需大于起始时间。
    *
    * @return $this
    */
