...
class ShowStreamCountResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowStreamCountResponse';
    ...
    */
    protected static $openAPITypes = [
            'dataList' => '\HuaweiCloud\SDK\Live\V2\Model\StreamCountData[]',
            'xRequestId' => 'string'
    ];
