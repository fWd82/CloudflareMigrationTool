...
class ModifyOttChannelInfoEncoderSettingsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyOttChannelInfoEncoderSettingsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Live\V1\Model\ModifyOttChannelEncoderSettings'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Live\V1\Model\ModifyOttChannelEncoderSettings|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\ModifyOttChannelEncoderSettings|null $body body
    *
    * @return $this
    */
