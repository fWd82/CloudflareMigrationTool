...
class HlsPackageItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HlsPackageItem';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['url'] === null) {
            ...
            if (!is_null($this->container['hlsVersion']) && (mb_strlen($this->container['hlsVersion']) > 10)) {
                $invalidProperties[] = "invalid value for 'hlsVersion', the character length must be smaller than or equal to 10.";
            }
            if (!is_null($this->container['hlsVersion']) && (mb_strlen($this->container['hlsVersion']) < 0)) {
                $invalidProperties[] = "invalid value for 'hlsVersion', the character length must be bigger than or equal to 0.";
            }
    ...
    * @return string|null
    */
    public function getHlsVersion()
    {
        return $this->container['hlsVersion'];
    }

    /**
    * Sets hlsVersion
    *
    * @param string|null $hlsVersion HLS版本号
    *
    * @return $this
    */
    public function setHlsVersion($hlsVersion)
    {
        $this->container['hlsVersion'] = $hlsVersion;
        return $this;
    }
