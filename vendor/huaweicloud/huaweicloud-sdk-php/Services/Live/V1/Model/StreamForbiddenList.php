...
class StreamForbiddenList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StreamForbiddenList';
    ...
    * Sets resumeTime
    *
    * @param string|null $resumeTime 恢复流时间，格式：yyyy-mm-ddThh:mm:ssZ，UTC时间，不指定则默认7天，最大禁推为90天
    *
    * @return $this
    */
