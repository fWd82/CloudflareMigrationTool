...
class CreateOttChannelInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateOttChannelInfoRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Live\V1\Model\CreateOttChannelInfoReq'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\CreateOttChannelInfoReq|null $body body
    *
    * @return $this
    */
