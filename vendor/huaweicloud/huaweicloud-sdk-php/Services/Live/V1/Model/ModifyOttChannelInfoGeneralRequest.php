...
class ModifyOttChannelInfoGeneralRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyOttChannelInfoGeneralRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Live\V1\Model\ModifyOttChannelGeneral'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Live\V1\Model\ModifyOttChannelGeneral|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\ModifyOttChannelGeneral|null $body body
    *
    * @return $this
    */
