...
class UpdatePublishTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePublishTemplateRequest';
    ...
    */
    protected static $openAPITypes = [
            'domain' => 'string',
            'body' => '\HuaweiCloud\SDK\Live\V1\Model\CallbackUrl'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Live\V1\Model\CallbackUrl|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\CallbackUrl|null $body body
    *
    * @return $this
    */
