...
class ListRecordCallbackConfigsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRecordCallbackConfigsResponse';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'callbackConfig' => '\HuaweiCloud\SDK\Live\V1\Model\RecordCallbackConfig[]'
    ];
    ...
    *  回调配置
    *
    * @return \HuaweiCloud\SDK\Live\V1\Model\RecordCallbackConfig[]|null
    */
    ...
    * Sets callbackConfig
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\RecordCallbackConfig[]|null $callbackConfig 回调配置
    *
    * @return $this
    */
