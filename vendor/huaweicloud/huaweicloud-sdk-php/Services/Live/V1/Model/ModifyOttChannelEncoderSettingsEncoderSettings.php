...
class ModifyOttChannelEncoderSettingsEncoderSettings implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyOttChannelEncoderSettings_encoder_settings';
    ...
    * Sets templateId
    *
    * @param string|null $templateId 转码模板ID
    *
    * @return $this
    */
