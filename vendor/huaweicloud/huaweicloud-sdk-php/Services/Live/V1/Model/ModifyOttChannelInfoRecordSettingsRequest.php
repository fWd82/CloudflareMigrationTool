...
class ModifyOttChannelInfoRecordSettingsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyOttChannelInfoRecordSettingsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Live\V1\Model\ModifyOttChannelRecordSettings'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Live\V1\Model\ModifyOttChannelRecordSettings|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\ModifyOttChannelRecordSettings|null $body body
    *
    * @return $this
    */
