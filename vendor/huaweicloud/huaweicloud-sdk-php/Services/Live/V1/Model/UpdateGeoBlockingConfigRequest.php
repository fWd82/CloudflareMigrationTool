...
class UpdateGeoBlockingConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGeoBlockingConfigRequest';
    ...
    */
    protected static $openAPITypes = [
            'playDomain' => 'string',
            'body' => '\HuaweiCloud\SDK\Live\V1\Model\GeoBlockingConfigInfo'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\GeoBlockingConfigInfo|null $body body
    *
    * @return $this
    */
