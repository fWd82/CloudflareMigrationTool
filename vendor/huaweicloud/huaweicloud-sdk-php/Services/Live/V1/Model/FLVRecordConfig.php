...
class FLVRecordConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FLVRecordConfig';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * recordCycle  单位为秒，周期录制时长，最小1分钟，最大12小时。如果为0则整个流录制一个文件。
    * recordPrefix  录制FLV文件含路径和文件名的前缀， 默认Record/{publish_domain}/{app}/{record_type}/{record_format}/{stream}_{file_start_time}/{file_start_time}
    * recordMaxDurationToMergeFile  录制flv拼接时长，如果流中断超过该时间，则生成新文件。单位秒。如果为0表示流中断就生成新文件。默认为0。
    *
    * @var string[]
    */
    ...
    * Sets recordPrefix
    *
    * @param string|null $recordPrefix 录制FLV文件含路径和文件名的前缀， 默认Record/{publish_domain}/{app}/{record_type}/{record_format}/{stream}_{file_start_time}/{file_start_time}
    *
    * @return $this
    */
    ...
    *
    * @param int|null $recordMaxDurationToMergeFile 录制flv拼接时长，如果流中断超过该时间，则生成新文件。单位秒。如果为0表示流中断就生成新文件。默认为0。
    *
    * @return $this
    */
