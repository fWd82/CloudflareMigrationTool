...
class CreateDomainMappingResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDomainMappingResponse';
    ...
    * Sets pullDomain
    *
    * @param string|null $pullDomain 直播播放域名
    *
    * @return $this
    */
    ...
    * Sets pushDomain
    *
    * @param string|null $pushDomain 直播播放域名关联的推流域名
    *
    * @return $this
    */
