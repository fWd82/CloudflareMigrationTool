...
class ModifyOttChannelInfoEncoderSettingsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyOttChannelInfoEncoderSettingsResponse';
