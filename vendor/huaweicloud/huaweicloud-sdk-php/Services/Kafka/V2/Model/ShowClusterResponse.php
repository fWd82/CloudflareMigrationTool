...
class ShowClusterResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'cluster' => '\HuaweiCloud\SDK\Kafka\V2\Model\ShowClusterRespCluster'
    ];
    ...
    *  cluster
    *
    * @return \HuaweiCloud\SDK\Kafka\V2\Model\ShowClusterRespCluster|null
    */
    ...
    * Sets cluster
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\ShowClusterRespCluster|null $cluster cluster
    *
    * @return $this
    */
