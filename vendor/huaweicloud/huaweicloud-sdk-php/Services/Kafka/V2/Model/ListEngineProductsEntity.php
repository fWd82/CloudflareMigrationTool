...
class ListEngineProductsEntity implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'archTypes' => 'string[]',
            'chargingMode' => 'string[]',
            'ios' => '\HuaweiCloud\SDK\Kafka\V2\Model\ListEngineIosEntity[]',
            'supportFeatures' => '\HuaweiCloud\SDK\Kafka\V2\Model\ListEngineSupportFeaturesEntity[]',
            'properties' => '\HuaweiCloud\SDK\Kafka\V2\Model\ListEnginePropertiesEntity'
    ];
    ...
    *  properties
    *
    * @return \HuaweiCloud\SDK\Kafka\V2\Model\ListEnginePropertiesEntity|null
    */
    ...
    * Sets properties
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\ListEnginePropertiesEntity|null $properties properties
    *
    * @return $this
    */
