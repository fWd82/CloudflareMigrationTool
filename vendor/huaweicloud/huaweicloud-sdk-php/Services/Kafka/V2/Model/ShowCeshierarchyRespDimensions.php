...
class ShowCeshierarchyRespDimensions implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'keyName' => 'string[]',
            'dimRouter' => 'string[]',
            'children' => '\HuaweiCloud\SDK\Kafka\V2\Model\ShowCeshierarchyRespChildren[]'
    ];
    ...
    *  子维度列表。
    *
    * @return \HuaweiCloud\SDK\Kafka\V2\Model\ShowCeshierarchyRespChildren[]|null
    */
    ...
    * Sets children
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\ShowCeshierarchyRespChildren[]|null $children 子维度列表。
    *
    * @return $this
    */
