...
class BatchDeleteMessageDiagnosisReportsReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteMessageDiagnosisReportsReq';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['reportIdList'] === null) {
            $invalidProperties[] = "'reportIdList' can't be null";
        }
