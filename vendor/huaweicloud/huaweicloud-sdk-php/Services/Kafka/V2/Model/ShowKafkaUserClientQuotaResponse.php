...
class ShowKafkaUserClientQuotaResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowKafkaUserClientQuotaResponse';
    ...
    * Sets count
    *
    * @param int|null $count 用户/客户端流控配置数目。
    *
    * @return $this
    */
