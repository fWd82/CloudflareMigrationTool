...
class CreateInstanceTopicReq implements ModelInterface, ArrayAccess
{
    ...
    * partition  topic分区数，设置消费的并发数。 取值范围：[1-100](tag:hws,hws_hk,dt,hws_ocb,ocb,ctc,sbc,hk_sbc,g42,tm,hk_g42,hk_tm)[1-20](tag:cmcc)。
    * syncReplication  是否开启同步复制，开启后，客户端生产消息时相应的也要设置acks=-1，否则不生效，默认关闭。
    * retentionTime  消息老化时间。默认值为72。 取值范围[1~168](tag:hws,hws_hk,ctc,sbc,hk_sbc,hws_eu,g42,tm,hk_g42,hk_tm)[1-720](tag:ocb,dt,hws_ocb)，单位小时。
    ...
    * Sets partition
    *
    * @param int|null $partition topic分区数，设置消费的并发数。 取值范围：[1-100](tag:hws,hws_hk,dt,hws_ocb,ocb,ctc,sbc,hk_sbc,g42,tm,hk_g42,hk_tm)[1-20](tag:cmcc)。
    *
    * @return $this
    */
    ...
    * Sets retentionTime
    *
    * @param int|null $retentionTime 消息老化时间。默认值为72。 取值范围[1~168](tag:hws,hws_hk,ctc,sbc,hk_sbc,hws_eu,g42,tm,hk_g42,hk_tm)[1-720](tag:ocb,dt,hws_ocb)，单位小时。
    *
    * @return $this
    */
