...
class ShowInstanceExtendProductInfoRespValues implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowInstanceExtendProductInfoResp_values';
    ...
    */
    protected static $openAPITypes = [
            'detail' => '\HuaweiCloud\SDK\Kafka\V2\Model\ShowInstanceExtendProductInfoRespDetail[]',
            'name' => 'string',
    ...
    *  规格详情。
    *
    * @return \HuaweiCloud\SDK\Kafka\V2\Model\ShowInstanceExtendProductInfoRespDetail[]|null
    */
    ...
    * Sets detail
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\ShowInstanceExtendProductInfoRespDetail[]|null $detail 规格详情。
    *
    * @return $this
    */
