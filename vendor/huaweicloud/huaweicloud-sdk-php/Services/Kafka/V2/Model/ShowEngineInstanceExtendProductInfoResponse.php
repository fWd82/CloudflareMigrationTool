...
class ShowEngineInstanceExtendProductInfoResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'engine' => 'string',
            'versions' => 'string[]',
            'products' => '\HuaweiCloud\SDK\Kafka\V2\Model\ExtendProductInfoEntity[]'
    ];
    ...
    * Sets engine
    *
    * @param string|null $engine 消息引擎类型:kafka。
    *
    * @return $this
    */
    ...
    *  规格变更的产品信息。
    *
    * @return \HuaweiCloud\SDK\Kafka\V2\Model\ExtendProductInfoEntity[]|null
    */
    ...
    * Sets products
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\ExtendProductInfoEntity[]|null $products 规格变更的产品信息。
    *
    * @return $this
    */
