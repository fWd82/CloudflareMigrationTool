...
class ResizeEngineInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'engine' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Kafka\V2\Model\ResizeEngineInstanceReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Kafka\V2\Model\ResizeEngineInstanceReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\ResizeEngineInstanceReq|null $body body
    *
    * @return $this
    */
