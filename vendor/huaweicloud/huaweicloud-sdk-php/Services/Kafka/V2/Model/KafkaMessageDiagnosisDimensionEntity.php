...
class KafkaMessageDiagnosisDimensionEntity implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KafkaMessageDiagnosisDimensionEntity';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  诊断维度名称
    * abnormalNum  该诊断维度下，异常的诊断项总数
    * failedNum  该诊断维度下，诊断失败的诊断项总和
    ...
    */
    protected static $openAPITypes = [
            ...
            'abnormalNum' => 'int',
            'failedNum' => 'int',
            'diagnosisItemList' => '\HuaweiCloud\SDK\Kafka\V2\Model\KafkaMessageDiagnosisItemEntity[]'
    ];
    ...
    * Sets abnormalNum
    *
    * @param int $abnormalNum 该诊断维度下，异常的诊断项总数
    *
    * @return $this
    */
    ...
    * Sets failedNum
    *
    * @param int $failedNum 该诊断维度下，诊断失败的诊断项总和
    *
    * @return $this
    */
    ...
    *  诊断项列表
    *
    * @return \HuaweiCloud\SDK\Kafka\V2\Model\KafkaMessageDiagnosisItemEntity[]
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\KafkaMessageDiagnosisItemEntity[] $diagnosisItemList 诊断项列表
    *
    * @return $this
    */
