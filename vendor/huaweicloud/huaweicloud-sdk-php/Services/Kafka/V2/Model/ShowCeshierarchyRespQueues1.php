...
class ShowCeshierarchyRespQueues1 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCeshierarchyResp_queues_1';
    ...
    * Sets partitions
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\ShowCeshierarchyRespPartitions[]|null $partitions 分区信息。
    *
    * @return $this
    */
