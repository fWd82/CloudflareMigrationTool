...
class ListProductsRespValues implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'detail' => '\HuaweiCloud\SDK\Kafka\V2\Model\ListProductsRespDetail[]',
            'name' => 'string',
    ...
    *  规格详情。
    *
    * @return \HuaweiCloud\SDK\Kafka\V2\Model\ListProductsRespDetail[]|null
    */
    ...
    * Sets detail
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\ListProductsRespDetail[]|null $detail 规格详情。
    *
    * @return $this
    */
