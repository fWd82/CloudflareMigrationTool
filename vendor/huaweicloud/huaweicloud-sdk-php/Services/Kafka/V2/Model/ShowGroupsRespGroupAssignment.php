...
class ShowGroupsRespGroupAssignment implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowGroupsResp_group_assignment';
    ...
    * Sets partitions
    *
    * @param int[]|null $partitions 分区列表。
    *
    * @return $this
    */
