...
class ShowInstanceExtendProductInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowInstanceExtendProductInfoResponse';
    ...
    */
    protected static $openAPITypes = [
            'hourly' => '\HuaweiCloud\SDK\Kafka\V2\Model\ShowInstanceExtendProductInfoRespHourly[]',
            'monthly' => '\HuaweiCloud\SDK\Kafka\V2\Model\ShowInstanceExtendProductInfoRespHourly[]'
    ];
    ...
    * Sets monthly
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\ShowInstanceExtendProductInfoRespHourly[]|null $monthly 表示包年包月的产品列表。当前暂不支持通过API创建包年包月的Kafka实例。
    *
    * @return $this
    */
