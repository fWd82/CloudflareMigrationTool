...
class ShowPartitionBeginningMessageRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPartitionBeginningMessageRequest';
