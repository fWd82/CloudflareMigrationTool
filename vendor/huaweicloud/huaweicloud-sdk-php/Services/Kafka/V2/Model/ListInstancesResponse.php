...
class ListInstancesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'instances' => '\HuaweiCloud\SDK\Kafka\V2\Model\ShowInstanceResp[]',
            'instanceNum' => 'int'
    ];
    ...
    *  实例列表
    *
    * @return \HuaweiCloud\SDK\Kafka\V2\Model\ShowInstanceResp[]|null
    */
    ...
    * Sets instances
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\ShowInstanceResp[]|null $instances 实例列表
    *
    * @return $this
    */
