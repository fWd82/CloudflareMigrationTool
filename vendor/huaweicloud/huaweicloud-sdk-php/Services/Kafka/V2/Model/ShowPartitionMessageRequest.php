...
class ShowPartitionMessageRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPartitionMessageRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['messageOffset'] === null) {
            $invalidProperties[] = "'messageOffset' can't be null";
        }
