...
class InstanceConfig implements ModelInterface, ArrayAccess
{
    ...
    */
    ...
    const CONFIG_TYPE__STATIC = 'static';
    const CONFIG_TYPE_DYNAMIC = 'dynamic';
    ...
    */
    ...
    {
        return [
            self::CONFIG_TYPE__STATIC,
            self::CONFIG_TYPE_DYNAMIC,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            $allowedValues = $this->getConfigTypeAllowableValues();
                if (!is_null($this->container['configType']) && !in_array($this->container['configType'], $allowedValues, true)) {
                $invalidProperties[] = sprintf(
                "invalid value for 'configType', must be one of '%s'",
    ...
    * Sets validValues
    *
    * @param string|null $validValues 有效值。
    *
    * @return $this
    */
