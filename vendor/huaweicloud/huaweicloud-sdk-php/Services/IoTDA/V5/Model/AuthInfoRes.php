...
class AuthInfoRes implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AuthInfoRes';
    ...
    * secondarySecret  **参数说明**：设备备用密钥，认证类型使用密钥认证接入(SECRET)该字段有效，当主密钥校验不通过时，会启用辅密钥校验，辅密钥与主密钥有相同的效力；辅密钥对coap协议接入的设备不生效。注意：NB设备密钥由于协议特殊性，只支持十六进制密钥接入；查询设备列表接口不返回该参数。 **取值范围**：长度不低于8不超过32，只允许字母、数字、下划线（_）、连接符（-）的组合。
    * fingerprint  **参数说明**：证书指纹，认证类型使用证书认证接入(CERTIFICATES)该字段有效，注册设备时不填写该字段则取第一次设备接入时的证书指纹。 **取值范围**：长度为40的十六进制字符串或者长度为64的十六进制字符串。
    * secondaryFingerprint  **参数说明**：证书备用指纹，认证类型使用证书认证接入(CERTIFICATES)该字段有效，当主指纹校验不通过时，会启用辅指纹校验，辅指纹与主指纹有相同的效力。 **取值范围**：长度为40的十六进制字符串或者长度为64的十六进制字符串。
    * secureAccess  **参数说明**：指设备是否通过安全协议方式接入。 **取值范围**： - true：通过安全协议方式接入。 - false：通过非安全协议方式接入。非安全接入的设备存在被仿冒等安全风险，请谨慎使用。
    * timeout  **参数说明**：设备接入的有效时间，单位：秒，默认值：0 若设备在有效时间内未接入物联网平台并激活，则平台会删除该设备的注册信息。若设置为“0”，则表示平台不会删除该设备的注册信息（建议填写为“0”）。 注意：该参数只对直连设备生效。
    *
    * @var string[]
    */
    ...
    */
    protected static $attributeMap = [
            ...
            'secondaryFingerprint' => 'secondary_fingerprint',
    ...
    */
    protected static $setters = [
            ...
            'secret' => 'setSecret',
            'secondarySecret' => 'setSecondarySecret',
            'fingerprint' => 'setFingerprint',
            'secondaryFingerprint' => 'setSecondaryFingerprint',
    ...
    */
    protected static $getters = [
            ...
            'secret' => 'getSecret',
            'secondarySecret' => 'getSecondarySecret',
            'fingerprint' => 'getFingerprint',
            'secondaryFingerprint' => 'getSecondaryFingerprint',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['secondarySecret'] = isset($data['secondarySecret']) ? $data['secondarySecret'] : null;
        $this->container['fingerprint'] = isset($data['fingerprint']) ? $data['fingerprint'] : null;
        $this->container['secondaryFingerprint'] = isset($data['secondaryFingerprint']) ? $data['secondaryFingerprint'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['secondarySecret']) && (mb_strlen($this->container['secondarySecret']) > 32)) {
                $invalidProperties[] = "invalid value for 'secondarySecret', the character length must be smaller than or equal to 32.";
            }
            if (!is_null($this->container['secondarySecret']) && (mb_strlen($this->container['secondarySecret']) < 8)) {
                $invalidProperties[] = "invalid value for 'secondarySecret', the character length must be bigger than or equal to 8.";
            }
            if (!is_null($this->container['secondarySecret']) && !preg_match("/^[a-zA-Z0-9_-]*$/", $this->container['secondarySecret'])) {
                $invalidProperties[] = "invalid value for 'secondarySecret', must be conform to the pattern /^[a-zA-Z0-9_-]*$/.";
            }
            ...
            if (!is_null($this->container['secondaryFingerprint']) && !preg_match("/^[a-fA-F0-9]{40}$|^[a-fA-F0-9]{64}$/", $this->container['secondaryFingerprint'])) {
                $invalidProperties[] = "invalid value for 'secondaryFingerprint', must be conform to the pattern /^[a-fA-F0-9]{40}$|^[a-fA-F0-9]{64}$/.";
            }
    ...
    */
    ...
    {
        return $this->container['secondarySecret'];
    }

    /**
    * Sets secondarySecret
    *
    * @param string|null $secondarySecret **参数说明**：设备备用密钥，认证类型使用密钥认证接入(SECRET)该字段有效，当主密钥校验不通过时，会启用辅密钥校验，辅密钥与主密钥有相同的效力；辅密钥对coap协议接入的设备不生效。注意：NB设备密钥由于协议特殊性，只支持十六进制密钥接入；查询设备列表接口不返回该参数。 **取值范围**：长度不低于8不超过32，只允许字母、数字、下划线（_）、连接符（-）的组合。
    *
    * @return $this
    */
    public function setSecondarySecret($secondarySecret)
    {
        $this->container['secondarySecret'] = $secondarySecret;
        return $this;
    }
    ...
    * Sets fingerprint
    *
    * @param string|null $fingerprint **参数说明**：证书指纹，认证类型使用证书认证接入(CERTIFICATES)该字段有效，注册设备时不填写该字段则取第一次设备接入时的证书指纹。 **取值范围**：长度为40的十六进制字符串或者长度为64的十六进制字符串。
    *
    * @return $this
    */
    ...
    /**
    * Gets secondaryFingerprint
    *  **参数说明**：证书备用指纹，认证类型使用证书认证接入(CERTIFICATES)该字段有效，当主指纹校验不通过时，会启用辅指纹校验，辅指纹与主指纹有相同的效力。 **取值范围**：长度为40的十六进制字符串或者长度为64的十六进制字符串。
    *
    * @return string|null
    */
    public function getSecondaryFingerprint()
    {
        return $this->container['secondaryFingerprint'];
    }

    /**
    * Sets secondaryFingerprint
    *
    * @param string|null $secondaryFingerprint **参数说明**：证书备用指纹，认证类型使用证书认证接入(CERTIFICATES)该字段有效，当主指纹校验不通过时，会启用辅指纹校验，辅指纹与主指纹有相同的效力。 **取值范围**：长度为40的十六进制字符串或者长度为64的十六进制字符串。
    *
    * @return $this
    */
    public function setSecondaryFingerprint($secondaryFingerprint)
    {
        $this->container['secondaryFingerprint'] = $secondaryFingerprint;
        return $this;
    }
    ...
    * Sets timeout
    *
    * @param int|null $timeout **参数说明**：设备接入的有效时间，单位：秒，默认值：0 若设备在有效时间内未接入物联网平台并激活，则平台会删除该设备的注册信息。若设置为“0”，则表示平台不会删除该设备的注册信息（建议填写为“0”）。 注意：该参数只对直连设备生效。
    *
    * @return $this
    */
