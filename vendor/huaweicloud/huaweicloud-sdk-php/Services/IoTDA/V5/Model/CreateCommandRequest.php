...
class CreateCommandRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCommandRequest';
    ...
    */
    protected static $openAPITypes = [
            'deviceId' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\DeviceCommandRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\DeviceCommandRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\DeviceCommandRequest|null $body body
    *
    * @return $this
    */
