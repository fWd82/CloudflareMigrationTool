...
class RetryBatchTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RetryBatchTaskRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'taskId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\BatchTargets'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\BatchTargets|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\BatchTargets|null $body body
    *
    * @return $this
    */
