...
class UpdateDeviceGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDeviceGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDeviceGroupDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDeviceGroupDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDeviceGroupDTO|null $body body
    *
    * @return $this
    */
