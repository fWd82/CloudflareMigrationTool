...
class ResetFingerprintRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResetFingerprintRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'deviceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\ResetFingerprint'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\ResetFingerprint|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\ResetFingerprint|null $body body
    *
    * @return $this
    */
