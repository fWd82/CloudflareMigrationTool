...
class UpdateDeviceShadowDesiredDataResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDeviceShadowDesiredDataResponse';
    ...
    */
    protected static $openAPITypes = [
            'deviceId' => 'string',
            'shadow' => '\HuaweiCloud\SDK\IoTDA\V5\Model\DeviceShadowData[]'
    ];
    ...
    * Sets shadow
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\DeviceShadowData[]|null $shadow 设备影子数据结构体。
    *
    * @return $this
    */
