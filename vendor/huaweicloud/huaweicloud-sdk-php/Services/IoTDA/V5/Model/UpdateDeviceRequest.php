...
class UpdateDeviceRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'deviceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDevice'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDevice|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDevice|null $body body
    *
    * @return $this
    */
