...
class ListCertificatesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'certificates' => '\HuaweiCloud\SDK\IoTDA\V5\Model\CertificatesRspDTO[]',
    ...
    *  证书列表。
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\CertificatesRspDTO[]|null
    */
    ...
    * Sets certificates
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\CertificatesRspDTO[]|null $certificates 证书列表。
    *
    * @return $this
    */
