...
class DeleteDeviceTunnelRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDeviceTunnelRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tunnelId'] === null) {
            $invalidProperties[] = "'tunnelId' can't be null";
        }
            if ((mb_strlen($this->container['tunnelId']) > 128)) {
                $invalidProperties[] = "invalid value for 'tunnelId', the character length must be smaller than or equal to 128.";
            }
            if ((mb_strlen($this->container['tunnelId']) < 1)) {
                $invalidProperties[] = "invalid value for 'tunnelId', the character length must be bigger than or equal to 1.";
            }
            if (!preg_match("/^[a-zA-Z0-9_-]{1,128}$/", $this->container['tunnelId'])) {
                $invalidProperties[] = "invalid value for 'tunnelId', must be conform to the pattern /^[a-zA-Z0-9_-]{1,128}$/.";
            }
