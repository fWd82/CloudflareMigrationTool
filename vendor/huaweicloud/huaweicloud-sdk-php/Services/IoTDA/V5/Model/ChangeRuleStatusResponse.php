...
class ChangeRuleStatusResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeRuleStatusResponse';
    ...
    * Sets status
    *
    * @param string|null $status **参数说明**：规则的激活状态。 **取值范围**： - active：激活。 - inactive：未激活。
    *
    * @return $this
    */
