...
class ResetFingerprintResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResetFingerprintResponse';
    ...
    * Sets fingerprint
    *
    * @param string|null $fingerprint 设备指纹。
    *
    * @return $this
    */
