...
class ListResourcesByTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'marker' => 'string',
            'offset' => 'int',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\QueryResourceByTagsDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\QueryResourceByTagsDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\QueryResourceByTagsDTO|null $body body
    *
    * @return $this
    */
