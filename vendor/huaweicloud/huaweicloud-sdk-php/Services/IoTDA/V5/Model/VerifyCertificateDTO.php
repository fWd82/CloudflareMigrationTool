...
class VerifyCertificateDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VerifyCertificateDTO';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['verifyContent'] === null) {
            $invalidProperties[] = "'verifyContent' can't be null";
        }
            if ((mb_strlen($this->container['verifyContent']) > 65535)) {
                $invalidProperties[] = "invalid value for 'verifyContent', the character length must be smaller than or equal to 65535.";
            }
            if ((mb_strlen($this->container['verifyContent']) < 1)) {
    ...
    * Sets verifyContent
    *
    * @param string $verifyContent 验证证书的内容信息。
    *
    * @return $this
    */
