...
class UpdateRuleActionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRuleActionRequest';
    ...
    * actionId  **参数说明**：规则动作ID。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'actionId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateActionReq'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['actionId'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9_-]{1,36}$/", $this->container['actionId'])) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateActionReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateActionReq|null $body body
    *
    * @return $this
    */
