...
class UpdatePropertiesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePropertiesRequest';
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\DevicePropertiesRequest|null $body body
    *
    * @return $this
    */
