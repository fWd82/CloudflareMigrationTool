...
class UpdateDeviceShadowDesiredDataRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDeviceShadowDesiredDataRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'deviceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDesireds'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDesireds|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDesireds|null $body body
    *
    * @return $this
    */
