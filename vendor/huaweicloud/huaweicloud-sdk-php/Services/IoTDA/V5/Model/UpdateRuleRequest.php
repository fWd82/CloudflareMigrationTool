...
class UpdateRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * ruleId  **参数说明**：规则ID，用于唯一标识一条规则，在创建规则时由物联网平台分配获得。 **取值范围**：长度不超过32，只允许字母、数字的组合。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'ruleId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\Rule'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\Rule|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\Rule|null $body body
    *
    * @return $this
    */
