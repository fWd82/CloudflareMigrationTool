...
class BroadcastMessageRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BroadcastMessageRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\DeviceBroadcastRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\DeviceBroadcastRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\DeviceBroadcastRequest|null $body body
    *
    * @return $this
    */
