...
class UpdateProductRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'productId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateProduct'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateProduct|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateProduct|null $body body
    *
    * @return $this
    */
