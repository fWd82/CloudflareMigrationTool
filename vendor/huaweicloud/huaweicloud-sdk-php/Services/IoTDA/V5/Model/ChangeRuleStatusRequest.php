...
class ChangeRuleStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeRuleStatusRequest';
    ...
    * ruleId  **参数说明**：规则Id。 **取值范围**：长度不超过32，只允许字母、数字的组合。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'ruleId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\RuleStatus'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ruleId'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9]{1,32}$/", $this->container['ruleId'])) {
                $invalidProperties[] = "invalid value for 'ruleId', must be conform to the pattern /^[a-zA-Z0-9]{1,32}$/.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\RuleStatus|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\RuleStatus|null $body body
    *
    * @return $this
    */
