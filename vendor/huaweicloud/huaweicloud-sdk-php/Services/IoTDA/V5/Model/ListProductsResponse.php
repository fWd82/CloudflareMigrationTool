...
class ListProductsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'products' => '\HuaweiCloud\SDK\IoTDA\V5\Model\ProductSummary[]',
    ...
    *  产品信息列表。
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\ProductSummary[]|null
    */
    ...
    * Sets products
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\ProductSummary[]|null $products 产品信息列表。
    *
    * @return $this
    */
