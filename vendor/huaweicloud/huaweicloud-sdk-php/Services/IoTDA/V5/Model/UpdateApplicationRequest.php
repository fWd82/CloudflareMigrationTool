...
class UpdateApplicationRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'appId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateApplicationDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateApplicationDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateApplicationDTO|null $body body
    *
    * @return $this
    */
