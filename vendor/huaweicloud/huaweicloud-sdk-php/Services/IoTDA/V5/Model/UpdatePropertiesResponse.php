...
class UpdatePropertiesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePropertiesResponse';
    ...
    * Sets errorCode
    *
    * @param string|null $errorCode 属性更新异常错误码。
    *
    * @return $this
    */
    ...
    * Sets errorMsg
    *
    * @param object|null $errorMsg 属性更新异常错误信息。
    *
    * @return $this
    */
