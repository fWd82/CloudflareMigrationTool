...
class ResetDeviceSecretRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResetDeviceSecretRequest';
    ...
    * deviceId  **参数说明**：设备ID，用于唯一标识一个设备。在注册设备时直接指定，或者由物联网平台分配获得。由物联网平台分配时，生成规则为\"product_id\" + \"_\" + \"node_id\"拼接而成。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）的组合。
    * actionId  **参数说明**：对设备执行的操作。 **取值范围**： - resetSecret: 重置密钥。注意：NB设备密钥由于协议特殊性，只支持十六进制密钥接入。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'deviceId' => 'string',
            'actionId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\ResetDeviceSecret'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['actionId'] === null) {
            ...
            if (!preg_match("/(resetSecret)/", $this->container['actionId'])) {
                $invalidProperties[] = "invalid value for 'actionId', must be conform to the pattern /(resetSecret)/.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\ResetDeviceSecret|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\ResetDeviceSecret|null $body body
    *
    * @return $this
    */
