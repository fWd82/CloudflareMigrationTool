...
class ListDeviceTunnelsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDeviceTunnelsRequest';
    ...
    * Sets deviceId
    *
    * @param string|null $deviceId **参数说明**：设备ID
    *
    * @return $this
    */
