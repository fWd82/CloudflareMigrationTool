...
class ListDeviceGroupsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDeviceGroupsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * deviceGroups  设备组信息列表。
    * page  page
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $this->container['deviceGroups'] = isset($data['deviceGroups']) ? $data['deviceGroups'] : null;
    ...
    */
    ...
    {
        return $this->container['deviceGroups'];
    }
    ...
    */
    ...
    {
        $this->container['deviceGroups'] = $deviceGroups;
        return $this;
    }
