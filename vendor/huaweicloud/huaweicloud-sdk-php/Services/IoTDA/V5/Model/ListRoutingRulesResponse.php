...
class ListRoutingRulesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRoutingRulesResponse';
    ...
    */
    protected static $openAPITypes = [
            'rules' => '\HuaweiCloud\SDK\IoTDA\V5\Model\RoutingRule[]',
            'count' => 'int',
            'marker' => 'string'
    ];
    ...
    * Sets rules
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\RoutingRule[]|null $rules 规则条件信息列表。
    *
    * @return $this
    */
