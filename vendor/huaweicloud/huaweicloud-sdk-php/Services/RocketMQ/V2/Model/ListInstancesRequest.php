...
class ListInstancesRequest implements ModelInterface, ArrayAccess
{
    ...
    * Sets status
    *
    * @param string|null $status 实例状态，[详细状态说明请参考[实例状态说明](hrm-api-0010.xml)。](tag:hws,hws_hk,ctc,hws_eu,ocb,g42,hk_g42,tm,cmcc,hk_tm)[详细状态说明请参考[实例状态说明](kafka-api-180514012.xml)。](tag:hcs)
    *
    * @return $this
    */
