...
class SendDlqMessageRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SendDlqMessageRequest';
    ...
    */
    protected static $openAPITypes = [
            'engine' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\RocketMQ\V2\Model\DeadletterResendReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\RocketMQ\V2\Model\DeadletterResendReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\DeadletterResendReq|null $body body
    *
    * @return $this
    */
