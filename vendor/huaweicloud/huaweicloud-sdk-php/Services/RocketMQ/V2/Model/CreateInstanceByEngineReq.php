...
class CreateInstanceByEngineReq implements ModelInterface, ArrayAccess
{
    ...
    * engineVersion  消息引擎的版本。取值填写为：[4.8.0](tag:hws,hws_eu,hws_hk,ocb,hws_ocb,ctc,g42,hk_g42,tm,hk_tm)[5.x](tag:hcs)。
    * storageSpace  存储空间。
    ...
    */
    protected static $openAPITypes = [
            ...
            'publicipId' => 'string',
            'brokerNum' => 'int',
            'bssParam' => '\HuaweiCloud\SDK\RocketMQ\V2\Model\BssParam'
    ];
    ...
    */
    ...
    const ENGINE_VERSION__4_8_0_TAGHWSHWS_EUHWS_HKOCBHWS_OCBCTCG42HK_G42TMHK_TM_5_X_TAGHCS = '[4.8.0](tag:hws,hws_eu,hws_hk,ocb,hws_ocb,ctc,g42,hk_g42,tm,hk_tm)[5.x](tag:hcs)';
    const PRODUCT_ID_C6_4U8G_CLUSTER_SMALL_TAGHWSHWS_EUHWS_HKOCBHWS_OCBCTCG42HK_G42TMHK_TM_C6_2U8G_SINGLE_X86_TAGHCS = '[c6.4u8g.cluster.small](tag:hws,hws_eu,hws_hk,ocb,hws_ocb,ctc,g42,hk_g42,tm,hk_tm)[c6.2u8g.single.x86](tag:hcs)';
    const PRODUCT_ID_C6_4U8G_CLUSTER_TAGHWSHWS_EUHWS_HKOCBHWS_OCBCTCG42HK_G42TMHK_TM_C6_4U16G_CLUSTER_X86_TAGHCS = '[c6.4u8g.cluster](tag:hws,hws_eu,hws_hk,ocb,hws_ocb,ctc,g42,hk_g42,tm,hk_tm)[c6.4u16g.cluster.x86](tag:hcs)';
    const PRODUCT_ID_C6_8U16G_CLUSTER_TAGHWSHWS_EUHWS_HKOCBHWS_OCBCTCG42HK_G42TMHK_TM_C6_8U32G_CLUSTER_X86_TAGHCS = '[c6.8u16g.cluster](tag:hws,hws_eu,hws_hk,ocb,hws_ocb,ctc,g42,hk_g42,tm,hk_tm)[c6.8u32g.cluster.x86](tag:hcs)';
    const PRODUCT_ID_C6_12U24G_CLUSTER_TAGHWSHWS_EUHWS_HKOCBHWS_OCBCTCG42HK_G42TMHK_TM_C6_16U64G_CLUSTER_X86_TAGHCS = '[c6.12u24g.cluster](tag:hws,hws_eu,hws_hk,ocb,hws_ocb,ctc,g42,hk_g42,tm,hk_tm)[c6.16u64g.cluster.x86](tag:hcs)';
    const PRODUCT_ID_C6_16U32G_CLUSTER_TAGHWSHWS_EUHWS_HKOCBHWS_OCBCTCG42HK_G42TMHK_TM_C6_32U128G_CLUSTER_X86_TAGHCS = '[c6.16u32g.cluster](tag:hws,hws_eu,hws_hk,ocb,hws_ocb,ctc,g42,hk_g42,tm,hk_tm)[c6.32u128g.cluster.x86](tag:hcs)';
    const PRODUCT_ID_C6_2U8G_SINGLE_ARM_TAGHCS = '[c6.2u8g.single.arm](tag:hcs)';
    const PRODUCT_ID_C6_4U16G_CLUSTER_ARM_TAGHCS = '[c6.4u16g.cluster.arm](tag:hcs)';
    const PRODUCT_ID_C6_8U32G_CLUSTER_ARM_TAGHCS = '[c6.8u32g.cluster.arm](tag:hcs)';
    const PRODUCT_ID_C6_16U64G_CLUSTER_ARM_TAGHCS = '[c6.16u64g.cluster.arm](tag:hcs)';
    const PRODUCT_ID_C6_32U128G_CLUSTER_ARM_TAGHCS = '[c6.32u128g.cluster.arm](tag:hcs)';
    ...
    */
    ...
    {
        return [
            self::ENGINE_VERSION__4_8_0_TAGHWSHWS_EUHWS_HKOCBHWS_OCBCTCG42HK_G42TMHK_TM_5_X_TAGHCS,
        ];
    }
    ...
    */
    ...
    {
        return [
            self::PRODUCT_ID_C6_4U8G_CLUSTER_SMALL_TAGHWSHWS_EUHWS_HKOCBHWS_OCBCTCG42HK_G42TMHK_TM_C6_2U8G_SINGLE_X86_TAGHCS,
            self::PRODUCT_ID_C6_4U8G_CLUSTER_TAGHWSHWS_EUHWS_HKOCBHWS_OCBCTCG42HK_G42TMHK_TM_C6_4U16G_CLUSTER_X86_TAGHCS,
            self::PRODUCT_ID_C6_8U16G_CLUSTER_TAGHWSHWS_EUHWS_HKOCBHWS_OCBCTCG42HK_G42TMHK_TM_C6_8U32G_CLUSTER_X86_TAGHCS,
            self::PRODUCT_ID_C6_12U24G_CLUSTER_TAGHWSHWS_EUHWS_HKOCBHWS_OCBCTCG42HK_G42TMHK_TM_C6_16U64G_CLUSTER_X86_TAGHCS,
            self::PRODUCT_ID_C6_16U32G_CLUSTER_TAGHWSHWS_EUHWS_HKOCBHWS_OCBCTCG42HK_G42TMHK_TM_C6_32U128G_CLUSTER_X86_TAGHCS,
            self::PRODUCT_ID_C6_2U8G_SINGLE_ARM_TAGHCS,
            self::PRODUCT_ID_C6_4U16G_CLUSTER_ARM_TAGHCS,
            self::PRODUCT_ID_C6_8U32G_CLUSTER_ARM_TAGHCS,
            self::PRODUCT_ID_C6_16U64G_CLUSTER_ARM_TAGHCS,
            self::PRODUCT_ID_C6_32U128G_CLUSTER_ARM_TAGHCS,
        ];
    }
    ...
    * Sets engineVersion
    *
    * @param string $engineVersion 消息引擎的版本。取值填写为：[4.8.0](tag:hws,hws_eu,hws_hk,ocb,hws_ocb,ctc,g42,hk_g42,tm,hk_tm)[5.x](tag:hcs)。
    *
    * @return $this
    */
    ...
    *  bssParam
    *
    * @return \HuaweiCloud\SDK\RocketMQ\V2\Model\BssParam|null
    */
    ...
    * Sets bssParam
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\BssParam|null $bssParam bssParam
    *
    * @return $this
    */
