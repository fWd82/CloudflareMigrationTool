...
class CreateInstanceByEngineRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateInstanceByEngineRequest';
    ...
    */
    protected static $openAPITypes = [
            'engine' => 'string',
            'body' => '\HuaweiCloud\SDK\RocketMQ\V2\Model\CreateInstanceByEngineReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\RocketMQ\V2\Model\CreateInstanceByEngineReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\CreateInstanceByEngineReq|null $body body
    *
    * @return $this
    */
