...
class ValidateConsumedMessageRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ValidateConsumedMessageRequest';
    ...
    */
    protected static $openAPITypes = [
            'engine' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\RocketMQ\V2\Model\ResendReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\RocketMQ\V2\Model\ResendReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\ResendReq|null $body body
    *
    * @return $this
    */
